...
// Functions for enum EORDERBY for ObjectEzmaxmaillinglistAPI_ezmaxmaillinglistGetListV1

static char* ezmaxmaillinglistGetListV1_EORDERBY_ToString(ezmax_api_definition__full_ezmaxmaillinglistGetListV1_eOrderBy_e EORDERBY){
    char *EORDERBYArray[] =  { "NULL", "pkiEzmaxmaillinglistID_ASC", "pkiEzmaxmaillinglistID_DESC", "sEzmaxmaillinglistNameX_ASC", "sEzmaxmaillinglistNameX_DESC", "sEzmaxmaillinglistDescriptionX_ASC", "sEzmaxmaillinglistDescriptionX_DESC" };
    return EORDERBYArray[EORDERBY];
}

static ezmax_api_definition__full_ezmaxmaillinglistGetListV1_eOrderBy_e ezmaxmaillinglistGetListV1_EORDERBY_FromString(char* EORDERBY){
...
/*
// Function ezmaxmaillinglistGetListV1_EORDERBY_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *ezmaxmaillinglistGetListV1_EORDERBY_convertToJSON(ezmax_api_definition__full_ezmaxmaillinglistGetListV1_eOrderBy_e EORDERBY) {
    cJSON *item = cJSON_CreateObject();
    if(cJSON_AddStringToObject(item, "eOrderBy", ezmaxmaillinglistGetListV1_EORDERBY_ToString(EORDERBY)) == NULL) {
        goto fail;
    }
    return item;
    fail:
...
// Function ezmaxmaillinglistGetListV1_EORDERBY_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_ezmaxmaillinglistGetListV1_eOrderBy_e ezmaxmaillinglistGetListV1_EORDERBY_parseFromJSON(cJSON* EORDERBYJSON) {
    ezmax_api_definition__full_ezmaxmaillinglistGetListV1_eOrderBy_e EORDERBYVariable = 0;
    ...
    EORDERBYVariable = ezmaxmaillinglistGetListV1_EORDERBY_FromString(EORDERBYVar->valuestring);
...
// Functions for enum  for ObjectEzmaxmaillinglistAPI_ezmaxmaillinglistGetListV1

static char* ezmaxmaillinglistGetListV1__ToString(ezmax_api_definition__full_ezmaxmaillinglistGetListV1_Accept-Language_e ){
    char *Array[] =  { "NULL", "*", "en", "fr" };
    return Array[];
}

static ezmax_api_definition__full_ezmaxmaillinglistGetListV1_Accept-Language_e ezmaxmaillinglistGetListV1__FromString(char* ){
    int stringToReturn = 0;
    char *Array[] =  { "NULL", "*", "en", "fr" };
...
/*
// Function ezmaxmaillinglistGetListV1__convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *ezmaxmaillinglistGetListV1__convertToJSON(ezmax_api_definition__full_ezmaxmaillinglistGetListV1_Accept-Language_e ) {
    cJSON *item = cJSON_CreateObject();
    return item;
    fail:
    cJSON_Delete(item);
...
// Function ezmaxmaillinglistGetListV1__parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_ezmaxmaillinglistGetListV1_Accept-Language_e ezmaxmaillinglistGetListV1__parseFromJSON(cJSON* JSON) {
    ezmax_api_definition__full_ezmaxmaillinglistGetListV1_Accept-Language_e Variable = 0;
    return Variable;
end:
    return 0;
}
...
ObjectEzmaxmaillinglistAPI_ezmaxmaillinglistGetListV1(apiClient_t *apiClient, ezmax_api_definition__full_ezmaxmaillinglistGetListV1_eOrderBy_e eOrderBy, int *iRowMax, int *iRowOffset, header_accept_language_e Accept_Language, char *sFilter)
{
    ...
    // create the path
    char *localVarPath = strdup("/1/object/ezmaxmaillinglist/getList");
    ...
    ezmax_api_definition__full_ezmaxmaillinglistGetListV1_eOrderBy_e valueQuery_eOrderBy ;
    keyValuePair_t *keyPairQuery_eOrderBy = 0;
    if (eOrderBy)
    {
        keyQuery_eOrderBy = strdup("eOrderBy");
        valueQuery_eOrderBy = (eOrderBy);
        keyPairQuery_eOrderBy = keyValuePair_create(keyQuery_eOrderBy, strdup(ezmaxmaillinglistGetListV1_EORDERBY_ToString(
        valueQuery_eOrderBy)));
    ...
    ezmaxmaillinglist_get_list_v1_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ObjectEzmaxmaillinglistAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = ezmaxmaillinglist_get_list_v1_response_parseFromJSON(ObjectEzmaxmaillinglistAPIlocalVarJSON);
        cJSON_Delete(ObjectEzmaxmaillinglistAPIlocalVarJSON);
