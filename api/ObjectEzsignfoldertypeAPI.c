...
static char* ezsignfoldertypeGetAutocompleteV2_SSELECTOR_ToString(ezmax_api_definition__full_ezsignfoldertypeGetAutocompleteV2_sSelector_e SSELECTOR){
    char *SSELECTORArray[] =  { "NULL", "Active", "All", "EzsigntemplateEdit", "EzsigntemplateUsergroup" };
...
ObjectEzsignfoldertypeAPI_ezsignfoldertypeCreateObjectV3(apiClient_t *apiClient, ezsignfoldertype_create_object_v3_request_t *ezsignfoldertype_create_object_v3_request)
{
    ...
    // create the path
    char *localVarPath = strdup("/3/object/ezsignfoldertype");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_ezsignfoldertype_create_object_v3_request = NULL;
    if (ezsignfoldertype_create_object_v3_request != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_ezsignfoldertype_create_object_v3_request = ezsignfoldertype_create_object_v3_request_convertToJSON(ezsignfoldertype_create_object_v3_request);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_ezsignfoldertype_create_object_v3_request);
    ...
    ezsignfoldertype_create_object_v3_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ObjectEzsignfoldertypeAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = ezsignfoldertype_create_object_v3_response_parseFromJSON(ObjectEzsignfoldertypeAPIlocalVarJSON);
    ...
    free(localVarPath);
    if (localVarSingleItemJSON_ezsignfoldertype_create_object_v3_request) {
        cJSON_Delete(localVarSingleItemJSON_ezsignfoldertype_create_object_v3_request);
        localVarSingleItemJSON_ezsignfoldertype_create_object_v3_request = NULL;
    }
...
ObjectEzsignfoldertypeAPI_ezsignfoldertypeCreateObjectV4(apiClient_t *apiClient, ezsignfoldertype_create_object_v4_request_t *ezsignfoldertype_create_object_v4_request)
{
    ...
    // create the path
    char *localVarPath = strdup("/4/object/ezsignfoldertype");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_ezsignfoldertype_create_object_v4_request = NULL;
    if (ezsignfoldertype_create_object_v4_request != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_ezsignfoldertype_create_object_v4_request = ezsignfoldertype_create_object_v4_request_convertToJSON(ezsignfoldertype_create_object_v4_request);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_ezsignfoldertype_create_object_v4_request);
        localVarBodyLength = strlen(localVarBodyParameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //}
    //nonprimitive not container
    ezsignfoldertype_create_object_v4_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ObjectEzsignfoldertypeAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = ezsignfoldertype_create_object_v4_response_parseFromJSON(ObjectEzsignfoldertypeAPIlocalVarJSON);
        cJSON_Delete(ObjectEzsignfoldertypeAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
    ...
    list_freeList(localVarContentType);
    free(localVarPath);
    if (localVarSingleItemJSON_ezsignfoldertype_create_object_v4_request) {
        cJSON_Delete(localVarSingleItemJSON_ezsignfoldertype_create_object_v4_request);
        localVarSingleItemJSON_ezsignfoldertype_create_object_v4_request = NULL;
    }
    free(localVarBodyParameters);
    return elementToReturn;
end:
...
ObjectEzsignfoldertypeAPI_ezsignfoldertypeEditObjectV3(apiClient_t *apiClient, int *pkiEzsignfoldertypeID, ezsignfoldertype_edit_object_v3_request_t *ezsignfoldertype_edit_object_v3_request)
{
    ...
    // create the path
    char *localVarPath = strdup("/3/object/ezsignfoldertype/{pkiEzsignfoldertypeID}");



    // Path Params
    long sizeOfPathParams_pkiEzsignfoldertypeID =  + sizeof("{ pkiEzsignfoldertypeID }") - 1;
    ...
    snprintf(localVarBuff_pkiEzsignfoldertypeID, sizeof localVarBuff_pkiEzsignfoldertypeID, "%ld", (long)*pkiEzsignfoldertypeID);
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_ezsignfoldertype_edit_object_v3_request = NULL;
    if (ezsignfoldertype_edit_object_v3_request != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_ezsignfoldertype_edit_object_v3_request = ezsignfoldertype_edit_object_v3_request_convertToJSON(ezsignfoldertype_edit_object_v3_request);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_ezsignfoldertype_edit_object_v3_request);
        localVarBodyLength = strlen(localVarBodyParameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //}
    //nonprimitive not container
    ezsignfoldertype_edit_object_v3_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ObjectEzsignfoldertypeAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = ezsignfoldertype_edit_object_v3_response_parseFromJSON(ObjectEzsignfoldertypeAPIlocalVarJSON);
        cJSON_Delete(ObjectEzsignfoldertypeAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
    ...
    if (localVarSingleItemJSON_ezsignfoldertype_edit_object_v3_request) {
        cJSON_Delete(localVarSingleItemJSON_ezsignfoldertype_edit_object_v3_request);
        localVarSingleItemJSON_ezsignfoldertype_edit_object_v3_request = NULL;
    }
    free(localVarBodyParameters);
    return elementToReturn;
end:
...
ObjectEzsignfoldertypeAPI_ezsignfoldertypeEditObjectV4(apiClient_t *apiClient, int *pkiEzsignfoldertypeID, ezsignfoldertype_edit_object_v4_request_t *ezsignfoldertype_edit_object_v4_request)
{
    ...
    // create the path
    char *localVarPath = strdup("/4/object/ezsignfoldertype/{pkiEzsignfoldertypeID}");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_ezsignfoldertype_edit_object_v4_request = NULL;
    if (ezsignfoldertype_edit_object_v4_request != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_ezsignfoldertype_edit_object_v4_request = ezsignfoldertype_edit_object_v4_request_convertToJSON(ezsignfoldertype_edit_object_v4_request);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_ezsignfoldertype_edit_object_v4_request);
        localVarBodyLength = strlen(localVarBodyParameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //}
    //nonprimitive not container
    ezsignfoldertype_edit_object_v4_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ObjectEzsignfoldertypeAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = ezsignfoldertype_edit_object_v4_response_parseFromJSON(ObjectEzsignfoldertypeAPIlocalVarJSON);
        cJSON_Delete(ObjectEzsignfoldertypeAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
    ...
    free(localVarPath);
    free(localVarToReplace_pkiEzsignfoldertypeID);
    if (localVarSingleItemJSON_ezsignfoldertype_edit_object_v4_request) {
        cJSON_Delete(localVarSingleItemJSON_ezsignfoldertype_edit_object_v4_request);
        localVarSingleItemJSON_ezsignfoldertype_edit_object_v4_request = NULL;
    }
    free(localVarBodyParameters);
    return elementToReturn;
end:
...
ObjectEzsignfoldertypeAPI_ezsignfoldertypeGetAutocompleteV2(apiClient_t *apiClient, ezmax_api_definition__full_ezsignfoldertypeGetAutocompleteV2_sSelector_e sSelector, ezmax_api_definition__full_ezsignfoldertypeGetAutocompleteV2_eFilterActive_e eFilterActive, char *sQuery, header_accept_language_e Accept_Language)
{
    ...
    // create the path
    char *localVarPath = strdup("/2/object/ezsignfoldertype/getAutocomplete/{sSelector}");
    ...
    // Path Params
    long sizeOfPathParams_sSelector = strlen(ezsignfoldertypeGetAutocompleteV2_SSELECTOR_ToString(sSelector))+3 + sizeof("{ sSelector }") - 1;
    if(sSelector == 0) {
        goto end;
    }
    ...
    localVarPath = strReplace(localVarPath, localVarToReplace_sSelector, ezsignfoldertypeGetAutocompleteV2_SSELECTOR_ToString(sSelector));
    ...
    if (eFilterActive)
    {
        ...
        keyPairQuery_eFilterActive = keyValuePair_create(keyQuery_eFilterActive, strdup(ezsignfoldertypeGetAutocompleteV2_EFILTERACTIVE_ToString(
    ...
    //}
    //nonprimitive not container
    ezsignfoldertype_get_autocomplete_v2_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ObjectEzsignfoldertypeAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = ezsignfoldertype_get_autocomplete_v2_response_parseFromJSON(ObjectEzsignfoldertypeAPIlocalVarJSON);
        cJSON_Delete(ObjectEzsignfoldertypeAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
ObjectEzsignfoldertypeAPI_ezsignfoldertypeGetListV1(apiClient_t *apiClient, ezmax_api_definition__full_ezsignfoldertypeGetListV1_eOrderBy_e eOrderBy, int *iRowMax, int *iRowOffset, header_accept_language_e Accept_Language, char *sFilter)
{
    ...
    // create the path
    char *localVarPath = strdup("/1/object/ezsignfoldertype/getList");
    ...
    if (eOrderBy)
    {
        ...
        keyPairQuery_eOrderBy = keyValuePair_create(keyQuery_eOrderBy, strdup(ezsignfoldertypeGetListV1_EORDERBY_ToString(
        valueQuery_eOrderBy)));
    ...
    //}
    //nonprimitive not container
    ezsignfoldertype_get_list_v1_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ObjectEzsignfoldertypeAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = ezsignfoldertype_get_list_v1_response_parseFromJSON(ObjectEzsignfoldertypeAPIlocalVarJSON);
        cJSON_Delete(ObjectEzsignfoldertypeAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
ObjectEzsignfoldertypeAPI_ezsignfoldertypeGetObjectV2(apiClient_t *apiClient, int *pkiEzsignfoldertypeID)
{
    ...
    // create the path
    char *localVarPath = strdup("/2/object/ezsignfoldertype/{pkiEzsignfoldertypeID}");
    ...
    //}
    //nonprimitive not container
    ezsignfoldertype_get_object_v2_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ObjectEzsignfoldertypeAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = ezsignfoldertype_get_object_v2_response_parseFromJSON(ObjectEzsignfoldertypeAPIlocalVarJSON);
        cJSON_Delete(ObjectEzsignfoldertypeAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
ObjectEzsignfoldertypeAPI_ezsignfoldertypeGetObjectV4(apiClient_t *apiClient, int *pkiEzsignfoldertypeID)
{
    ...
    //}
    //nonprimitive not container
    ezsignfoldertype_get_object_v4_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ObjectEzsignfoldertypeAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = ezsignfoldertype_get_object_v4_response_parseFromJSON(ObjectEzsignfoldertypeAPIlocalVarJSON);
        cJSON_Delete(ObjectEzsignfoldertypeAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
