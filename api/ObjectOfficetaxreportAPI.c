...
// Functions for enum EORDERBY for ObjectOfficetaxreportAPI_officetaxreportGetListV1

static char* officetaxreportGetListV1_EORDERBY_ToString(ezmax_api_definition__full_officetaxreportGetListV1_eOrderBy_e EORDERBY){
    char *EORDERBYArray[] =  { "NULL", "pkiOfficetaxreportID_ASC", "pkiOfficetaxreportID_DESC", "fkiPeriodID_ASC", "fkiPeriodID_DESC", "sPeriodYYYYMM_ASC", "sPeriodYYYYMM_DESC", "sUserLoginname_ASC", "sUserLoginname_DESC", "dtCreatedDate_ASC", "dtCreatedDate_DESC" };
    return EORDERBYArray[EORDERBY];
}

static ezmax_api_definition__full_officetaxreportGetListV1_eOrderBy_e officetaxreportGetListV1_EORDERBY_FromString(char* EORDERBY){
...
/*
// Function officetaxreportGetListV1_EORDERBY_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *officetaxreportGetListV1_EORDERBY_convertToJSON(ezmax_api_definition__full_officetaxreportGetListV1_eOrderBy_e EORDERBY) {
    cJSON *item = cJSON_CreateObject();
    if(cJSON_AddStringToObject(item, "eOrderBy", officetaxreportGetListV1_EORDERBY_ToString(EORDERBY)) == NULL) {
        goto fail;
    }
    return item;
    fail:
...
// Function officetaxreportGetListV1_EORDERBY_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_officetaxreportGetListV1_eOrderBy_e officetaxreportGetListV1_EORDERBY_parseFromJSON(cJSON* EORDERBYJSON) {
    ezmax_api_definition__full_officetaxreportGetListV1_eOrderBy_e EORDERBYVariable = 0;
    ...
    EORDERBYVariable = officetaxreportGetListV1_EORDERBY_FromString(EORDERBYVar->valuestring);
...
// Functions for enum  for ObjectOfficetaxreportAPI_officetaxreportGetListV1

static char* officetaxreportGetListV1__ToString(ezmax_api_definition__full_officetaxreportGetListV1_Accept-Language_e ){
    char *Array[] =  { "NULL", "*", "en", "fr" };
    return Array[];
}

static ezmax_api_definition__full_officetaxreportGetListV1_Accept-Language_e officetaxreportGetListV1__FromString(char* ){
    int stringToReturn = 0;
    char *Array[] =  { "NULL", "*", "en", "fr" };
...
/*
// Function officetaxreportGetListV1__convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *officetaxreportGetListV1__convertToJSON(ezmax_api_definition__full_officetaxreportGetListV1_Accept-Language_e ) {
    cJSON *item = cJSON_CreateObject();
    return item;
    fail:
    cJSON_Delete(item);
...
// Function officetaxreportGetListV1__parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_officetaxreportGetListV1_Accept-Language_e officetaxreportGetListV1__parseFromJSON(cJSON* JSON) {
    ezmax_api_definition__full_officetaxreportGetListV1_Accept-Language_e Variable = 0;
    return Variable;
end:
    return 0;
}
...
ObjectOfficetaxreportAPI_officetaxreportGetCommunicationCountV1(apiClient_t *apiClient, int *pkiOfficetaxreportID)
{
    ...
    // create the path
    char *localVarPath = strdup("/1/object/officetaxreport/{pkiOfficetaxreportID}/getCommunicationCount");
    ...
    //}
    //nonprimitive not container
    officetaxreport_get_communication_count_v1_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ObjectOfficetaxreportAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = officetaxreport_get_communication_count_v1_response_parseFromJSON(ObjectOfficetaxreportAPIlocalVarJSON);
        cJSON_Delete(ObjectOfficetaxreportAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
ObjectOfficetaxreportAPI_officetaxreportGetCommunicationListV1(apiClient_t *apiClient, int *pkiOfficetaxreportID)
{
    ...
    // create the path
    char *localVarPath = strdup("/1/object/officetaxreport/{pkiOfficetaxreportID}/getCommunicationList");
    ...
    //}
    //nonprimitive not container
    officetaxreport_get_communication_list_v1_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ObjectOfficetaxreportAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = officetaxreport_get_communication_list_v1_response_parseFromJSON(ObjectOfficetaxreportAPIlocalVarJSON);
        cJSON_Delete(ObjectOfficetaxreportAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
ObjectOfficetaxreportAPI_officetaxreportGetCommunicationrecipientsV1(apiClient_t *apiClient, int *pkiOfficetaxreportID)
{
    ...
    // create the path
    char *localVarPath = strdup("/1/object/officetaxreport/{pkiOfficetaxreportID}/getCommunicationrecipients");
    ...
    //}
    //nonprimitive not container
    officetaxreport_get_communicationrecipients_v1_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ObjectOfficetaxreportAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = officetaxreport_get_communicationrecipients_v1_response_parseFromJSON(ObjectOfficetaxreportAPIlocalVarJSON);
        cJSON_Delete(ObjectOfficetaxreportAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
ObjectOfficetaxreportAPI_officetaxreportGetCommunicationsendersV1(apiClient_t *apiClient, int *pkiOfficetaxreportID)
{
    ...
    // create the path
    char *localVarPath = strdup("/1/object/officetaxreport/{pkiOfficetaxreportID}/getCommunicationsenders");
    ...
    //}
    //nonprimitive not container
    officetaxreport_get_communicationsenders_v1_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ObjectOfficetaxreportAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = officetaxreport_get_communicationsenders_v1_response_parseFromJSON(ObjectOfficetaxreportAPIlocalVarJSON);
        cJSON_Delete(ObjectOfficetaxreportAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
ObjectOfficetaxreportAPI_officetaxreportGetListV1(apiClient_t *apiClient, ezmax_api_definition__full_officetaxreportGetListV1_eOrderBy_e eOrderBy, int *iRowMax, int *iRowOffset, header_accept_language_e Accept_Language, char *sFilter)
{
    ...
    // create the path
    char *localVarPath = strdup("/1/object/officetaxreport/getList");
    ...
    ezmax_api_definition__full_officetaxreportGetListV1_eOrderBy_e valueQuery_eOrderBy ;
    keyValuePair_t *keyPairQuery_eOrderBy = 0;
    if (eOrderBy)
    {
        keyQuery_eOrderBy = strdup("eOrderBy");
        valueQuery_eOrderBy = (eOrderBy);
        keyPairQuery_eOrderBy = keyValuePair_create(keyQuery_eOrderBy, strdup(officetaxreportGetListV1_EORDERBY_ToString(
        valueQuery_eOrderBy)));
    ...
    //}
    //nonprimitive not container
    officetaxreport_get_list_v1_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ObjectOfficetaxreportAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = officetaxreport_get_list_v1_response_parseFromJSON(ObjectOfficetaxreportAPIlocalVarJSON);
        cJSON_Delete(ObjectOfficetaxreportAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
