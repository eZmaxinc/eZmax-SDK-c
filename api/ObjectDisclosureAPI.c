...
// Functions for enum EORDERBY for ObjectDisclosureAPI_disclosureGetListV1

static char* disclosureGetListV1_EORDERBY_ToString(ezmax_api_definition__full_disclosureGetListV1_eOrderBy_e EORDERBY){
    char *EORDERBYArray[] =  { "NULL", "pkiDisclosureID_ASC", "pkiDisclosureID_DESC", "fkiAgentID_ASC", "fkiAgentID_DESC", "fkiBrokerID_ASC", "fkiBrokerID_DESC", "eDisclosureInteresttype_ASC", "eDisclosureInteresttype_DESC", "sDisclosureRelation_ASC", "sDisclosureRelation_DESC", "dtDisclosureRedactiondate_ASC", "dtDisclosureRedactiondate_DESC", "dtDisclosureAcceptationdate_ASC", "dtDisclosureAcceptationdate_DESC", "dtDisclosureReceptiondate_ASC", "dtDisclosureReceptiondate_DESC", "bDisclosureIsactive_ASC", "bDisclosureIsactive_DESC", "sDisclosureNumber_ASC", "sDisclosureNumber_DESC", "sContactFirstname_ASC", "sContactFirstname_DESC", "sContactLastname_ASC", "sContactLastname_DESC", "sBrokerName_ASC", "sBrokerName_DESC" };
    return EORDERBYArray[EORDERBY];
}

static ezmax_api_definition__full_disclosureGetListV1_eOrderBy_e disclosureGetListV1_EORDERBY_FromString(char* EORDERBY){
...
/*
// Function disclosureGetListV1_EORDERBY_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *disclosureGetListV1_EORDERBY_convertToJSON(ezmax_api_definition__full_disclosureGetListV1_eOrderBy_e EORDERBY) {
    cJSON *item = cJSON_CreateObject();
    if(cJSON_AddStringToObject(item, "eOrderBy", disclosureGetListV1_EORDERBY_ToString(EORDERBY)) == NULL) {
        goto fail;
    }
    return item;
    fail:
...
// Function disclosureGetListV1_EORDERBY_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_disclosureGetListV1_eOrderBy_e disclosureGetListV1_EORDERBY_parseFromJSON(cJSON* EORDERBYJSON) {
    ezmax_api_definition__full_disclosureGetListV1_eOrderBy_e EORDERBYVariable = 0;
    ...
    EORDERBYVariable = disclosureGetListV1_EORDERBY_FromString(EORDERBYVar->valuestring);
...
// Functions for enum  for ObjectDisclosureAPI_disclosureGetListV1

static char* disclosureGetListV1__ToString(ezmax_api_definition__full_disclosureGetListV1_Accept-Language_e ){
    char *Array[] =  { "NULL", "*", "en", "fr" };
    return Array[];
}

static ezmax_api_definition__full_disclosureGetListV1_Accept-Language_e disclosureGetListV1__FromString(char* ){
    int stringToReturn = 0;
    char *Array[] =  { "NULL", "*", "en", "fr" };
...
/*
// Function disclosureGetListV1__convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *disclosureGetListV1__convertToJSON(ezmax_api_definition__full_disclosureGetListV1_Accept-Language_e ) {
    cJSON *item = cJSON_CreateObject();
    return item;
    fail:
    cJSON_Delete(item);
...
// Function disclosureGetListV1__parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_disclosureGetListV1_Accept-Language_e disclosureGetListV1__parseFromJSON(cJSON* JSON) {
    ezmax_api_definition__full_disclosureGetListV1_Accept-Language_e Variable = 0;
    return Variable;
end:
    return 0;
}
...
ObjectDisclosureAPI_disclosureGetListV1(apiClient_t *apiClient, ezmax_api_definition__full_disclosureGetListV1_eOrderBy_e eOrderBy, int *iRowMax, int *iRowOffset, header_accept_language_e Accept_Language, char *sFilter)
{
    ...
    // create the path
    char *localVarPath = strdup("/1/object/disclosure/getList");
    ...
    ezmax_api_definition__full_disclosureGetListV1_eOrderBy_e valueQuery_eOrderBy ;
    keyValuePair_t *keyPairQuery_eOrderBy = 0;
    if (eOrderBy)
    {
        keyQuery_eOrderBy = strdup("eOrderBy");
        valueQuery_eOrderBy = (eOrderBy);
        keyPairQuery_eOrderBy = keyValuePair_create(keyQuery_eOrderBy, strdup(disclosureGetListV1_EORDERBY_ToString(
        valueQuery_eOrderBy)));
    ...
    //}
    //nonprimitive not container
    disclosure_get_list_v1_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ObjectDisclosureAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = disclosure_get_list_v1_response_parseFromJSON(ObjectDisclosureAPIlocalVarJSON);
        cJSON_Delete(ObjectDisclosureAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
