...
// Functions for enum SSELECTOR for ObjectEzsigntemplatepackageAPI_ezsigntemplatepackageGetAutocompleteV1

static char* ezsigntemplatepackageGetAutocompleteV1_SSELECTOR_ToString(ezmax_api_definition__full_ezsigntemplatepackageGetAutocompleteV1_sSelector_e SSELECTOR){
    char *SSELECTORArray[] =  { "NULL", "All", "AllMultipleCopiesDisabled" };
    return SSELECTORArray[SSELECTOR];
}

static ezmax_api_definition__full_ezsigntemplatepackageGetAutocompleteV1_sSelector_e ezsigntemplatepackageGetAutocompleteV1_SSELECTOR_FromString(char* SSELECTOR){
...
/*
// Function ezsigntemplatepackageGetAutocompleteV1_SSELECTOR_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *ezsigntemplatepackageGetAutocompleteV1_SSELECTOR_convertToJSON(ezmax_api_definition__full_ezsigntemplatepackageGetAutocompleteV1_sSelector_e SSELECTOR) {
    cJSON *item = cJSON_CreateObject();
    if(cJSON_AddStringToObject(item, "sSelector", ezsigntemplatepackageGetAutocompleteV1_SSELECTOR_ToString(SSELECTOR)) == NULL) {
        goto fail;
    }
    return item;
    fail:
...
// Function ezsigntemplatepackageGetAutocompleteV1_SSELECTOR_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_ezsigntemplatepackageGetAutocompleteV1_sSelector_e ezsigntemplatepackageGetAutocompleteV1_SSELECTOR_parseFromJSON(cJSON* SSELECTORJSON) {
    ezmax_api_definition__full_ezsigntemplatepackageGetAutocompleteV1_sSelector_e SSELECTORVariable = 0;
    ...
    SSELECTORVariable = ezsigntemplatepackageGetAutocompleteV1_SSELECTOR_FromString(SSELECTORVar->valuestring);
...
static ezmax_api_definition__full_ezsigntemplatepackageGetAutocompleteV1_Accept-Language_e ezsigntemplatepackageGetAutocompleteV1__FromString(char* ){
    int stringToReturn = 0;
    char *Array[] =  { "NULL", "*", "en", "fr" };
...
/*
// Function ezsigntemplatepackageGetAutocompleteV1__convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *ezsigntemplatepackageGetAutocompleteV1__convertToJSON(ezmax_api_definition__full_ezsigntemplatepackageGetAutocompleteV1_Accept-Language_e ) {
    cJSON *item = cJSON_CreateObject();
    return item;
    fail:
    cJSON_Delete(item);
...
// Function ezsigntemplatepackageGetAutocompleteV1__parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_ezsigntemplatepackageGetAutocompleteV1_Accept-Language_e ezsigntemplatepackageGetAutocompleteV1__parseFromJSON(cJSON* JSON) {
    ezmax_api_definition__full_ezsigntemplatepackageGetAutocompleteV1_Accept-Language_e Variable = 0;
    return Variable;
end:
    return 0;
}
...
ObjectEzsigntemplatepackageAPI_ezsigntemplatepackageCreateObjectV1(apiClient_t *apiClient, ezsigntemplatepackage_create_object_v1_request_t * ezsigntemplatepackage_create_object_v1_request )
{
    ...
    // create the path
    long sizeOfPath = strlen("/1/object/ezsigntemplatepackage")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/1/object/ezsigntemplatepackage");
    ...
    ezsigntemplatepackage_create_object_v1_response_t *elementToReturn = ezsigntemplatepackage_create_object_v1_response_parseFromJSON(ObjectEzsigntemplatepackageAPIlocalVarJSON);
...
ObjectEzsigntemplatepackageAPI_ezsigntemplatepackageDeleteObjectV1(apiClient_t *apiClient, int pkiEzsigntemplatepackageID )
{
    ...
    // create the path
    long sizeOfPath = strlen("/1/object/ezsigntemplatepackage/{pkiEzsigntemplatepackageID}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/1/object/ezsigntemplatepackage/{pkiEzsigntemplatepackageID}");


    // Path Params
    long sizeOfPathParams_pkiEzsigntemplatepackageID =  + strlen("{ pkiEzsigntemplatepackageID }");
    ...
    //nonprimitive not container
    cJSON *ObjectEzsigntemplatepackageAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    ezsigntemplatepackage_delete_object_v1_response_t *elementToReturn = ezsigntemplatepackage_delete_object_v1_response_parseFromJSON(ObjectEzsigntemplatepackageAPIlocalVarJSON);
    cJSON_Delete(ObjectEzsigntemplatepackageAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ObjectEzsigntemplatepackageAPI_ezsigntemplatepackageEditEzsigntemplatepackagesignersV1(apiClient_t *apiClient, int pkiEzsigntemplatepackageID , ezsigntemplatepackage_edit_ezsigntemplatepackagesigners_v1_request_t * ezsigntemplatepackage_edit_ezsigntemplatepackagesigners_v1_request )
{
    ...
    // create the path
    long sizeOfPath = strlen("/1/object/ezsigntemplatepackage/{pkiEzsigntemplatepackageID}/editEzsigntemplatepackagesigners")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/1/object/ezsigntemplatepackage/{pkiEzsigntemplatepackageID}/editEzsigntemplatepackagesigners");
    ...
    //nonprimitive not container
    cJSON *ObjectEzsigntemplatepackageAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    ezsigntemplatepackage_edit_ezsigntemplatepackagesigners_v1_response_t *elementToReturn = ezsigntemplatepackage_edit_ezsigntemplatepackagesigners_v1_response_parseFromJSON(ObjectEzsigntemplatepackageAPIlocalVarJSON);
    cJSON_Delete(ObjectEzsigntemplatepackageAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ObjectEzsigntemplatepackageAPI_ezsigntemplatepackageEditObjectV1(apiClient_t *apiClient, int pkiEzsigntemplatepackageID , ezsigntemplatepackage_edit_object_v1_request_t * ezsigntemplatepackage_edit_object_v1_request )
{
    ...
    //nonprimitive not container
    cJSON *ObjectEzsigntemplatepackageAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    ezsigntemplatepackage_edit_object_v1_response_t *elementToReturn = ezsigntemplatepackage_edit_object_v1_response_parseFromJSON(ObjectEzsigntemplatepackageAPIlocalVarJSON);
    cJSON_Delete(ObjectEzsigntemplatepackageAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ObjectEzsigntemplatepackageAPI_ezsigntemplatepackageGetAutocompleteV1(apiClient_t *apiClient, ezmax_api_definition__full_ezsigntemplatepackageGetAutocompleteV1_sSelector_e sSelector , ezmax_api_definition__full_ezsigntemplatepackageGetAutocompleteV1_eFilterActive_e eFilterActive , char * sQuery , header_accept_language_e Accept_Language )
{
    ...
    // create the path
    long sizeOfPath = strlen("/1/object/ezsigntemplatepackage/getAutocomplete/{sSelector}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/1/object/ezsigntemplatepackage/getAutocomplete/{sSelector}");
    ...
    //nonprimitive not container
    cJSON *ObjectEzsigntemplatepackageAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    common_get_autocomplete_disabled_v1_response_t *elementToReturn = common_get_autocomplete_disabled_v1_response_parseFromJSON(ObjectEzsigntemplatepackageAPIlocalVarJSON);
    cJSON_Delete(ObjectEzsigntemplatepackageAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ObjectEzsigntemplatepackageAPI_ezsigntemplatepackageGetAutocompleteV2(apiClient_t *apiClient, ezmax_api_definition__full_ezsigntemplatepackageGetAutocompleteV2_sSelector_e sSelector , ezmax_api_definition__full_ezsigntemplatepackageGetAutocompleteV2_eFilterActive_e eFilterActive , char * sQuery , header_accept_language_e Accept_Language )
{
    ...
    // create the path
    long sizeOfPath = strlen("/2/object/ezsigntemplatepackage/getAutocomplete/{sSelector}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/2/object/ezsigntemplatepackage/getAutocomplete/{sSelector}");
    ...
    //nonprimitive not container
    cJSON *ObjectEzsigntemplatepackageAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    ezsigntemplatepackage_get_autocomplete_v2_response_t *elementToReturn = ezsigntemplatepackage_get_autocomplete_v2_response_parseFromJSON(ObjectEzsigntemplatepackageAPIlocalVarJSON);
    cJSON_Delete(ObjectEzsigntemplatepackageAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ObjectEzsigntemplatepackageAPI_ezsigntemplatepackageGetObjectV1(apiClient_t *apiClient, int pkiEzsigntemplatepackageID )
{
    ...
    //nonprimitive not container
    cJSON *ObjectEzsigntemplatepackageAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    ezsigntemplatepackage_get_object_v1_response_t *elementToReturn = ezsigntemplatepackage_get_object_v1_response_parseFromJSON(ObjectEzsigntemplatepackageAPIlocalVarJSON);
    cJSON_Delete(ObjectEzsigntemplatepackageAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ObjectEzsigntemplatepackageAPI_ezsigntemplatepackageGetObjectV2(apiClient_t *apiClient, int pkiEzsigntemplatepackageID )
{
    ...
    // create the path
    long sizeOfPath = strlen("/2/object/ezsigntemplatepackage/{pkiEzsigntemplatepackageID}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/2/object/ezsigntemplatepackage/{pkiEzsigntemplatepackageID}");
    ...
    //nonprimitive not container
    cJSON *ObjectEzsigntemplatepackageAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    ezsigntemplatepackage_get_object_v2_response_t *elementToReturn = ezsigntemplatepackage_get_object_v2_response_parseFromJSON(ObjectEzsigntemplatepackageAPIlocalVarJSON);
    cJSON_Delete(ObjectEzsigntemplatepackageAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
