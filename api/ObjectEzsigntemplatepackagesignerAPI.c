...
ObjectEzsigntemplatepackagesignerAPI_ezsigntemplatepackagesignerGetObjectV1(apiClient_t *apiClient, int pkiEzsigntemplatepackagesignerID )
{
    ...
    //nonprimitive not container
    cJSON *ObjectEzsigntemplatepackagesignerAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    ezsigntemplatepackagesigner_get_object_v1_response_t *elementToReturn = ezsigntemplatepackagesigner_get_object_v1_response_parseFromJSON(ObjectEzsigntemplatepackagesignerAPIlocalVarJSON);
    cJSON_Delete(ObjectEzsigntemplatepackagesignerAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
