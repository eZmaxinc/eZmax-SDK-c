...
// The endpoint allows to create one or many elements at once.
//
ezsigntemplatepackagesigner_create_object_v2_response_t*
ObjectEzsigntemplatepackagesignerAPI_ezsigntemplatepackagesignerCreateObjectV2(apiClient_t *apiClient, ezsigntemplatepackagesigner_create_object_v2_request_t *ezsigntemplatepackagesigner_create_object_v2_request)
{
    list_t    *localVarQueryParameters = NULL;
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    char *localVarPath = strdup("/2/object/ezsigntemplatepackagesigner");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_ezsigntemplatepackagesigner_create_object_v2_request = NULL;
    if (ezsigntemplatepackagesigner_create_object_v2_request != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_ezsigntemplatepackagesigner_create_object_v2_request = ezsigntemplatepackagesigner_create_object_v2_request_convertToJSON(ezsigntemplatepackagesigner_create_object_v2_request);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_ezsigntemplatepackagesigner_create_object_v2_request);
        localVarBodyLength = strlen(localVarBodyParameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //}
    //nonprimitive not container
    ezsigntemplatepackagesigner_create_object_v2_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ObjectEzsigntemplatepackagesignerAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = ezsigntemplatepackagesigner_create_object_v2_response_parseFromJSON(ObjectEzsigntemplatepackagesignerAPIlocalVarJSON);
        cJSON_Delete(ObjectEzsigntemplatepackagesignerAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
    ...
    list_freeList(localVarContentType);
    free(localVarPath);
    if (localVarSingleItemJSON_ezsigntemplatepackagesigner_create_object_v2_request) {
        cJSON_Delete(localVarSingleItemJSON_ezsigntemplatepackagesigner_create_object_v2_request);
        localVarSingleItemJSON_ezsigntemplatepackagesigner_create_object_v2_request = NULL;
    }
    free(localVarBodyParameters);
    return elementToReturn;
end:
...
// 
//
ezsigntemplatepackagesigner_edit_object_v2_response_t*
ObjectEzsigntemplatepackagesignerAPI_ezsigntemplatepackagesignerEditObjectV2(apiClient_t *apiClient, int *pkiEzsigntemplatepackagesignerID, ezsigntemplatepackagesigner_edit_object_v2_request_t *ezsigntemplatepackagesigner_edit_object_v2_request)
{
    list_t    *localVarQueryParameters = NULL;
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_ezsigntemplatepackagesigner_edit_object_v2_request = NULL;
    if (ezsigntemplatepackagesigner_edit_object_v2_request != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_ezsigntemplatepackagesigner_edit_object_v2_request = ezsigntemplatepackagesigner_edit_object_v2_request_convertToJSON(ezsigntemplatepackagesigner_edit_object_v2_request);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_ezsigntemplatepackagesigner_edit_object_v2_request);
        localVarBodyLength = strlen(localVarBodyParameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //}
    //nonprimitive not container
    ezsigntemplatepackagesigner_edit_object_v2_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ObjectEzsigntemplatepackagesignerAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = ezsigntemplatepackagesigner_edit_object_v2_response_parseFromJSON(ObjectEzsigntemplatepackagesignerAPIlocalVarJSON);
        cJSON_Delete(ObjectEzsigntemplatepackagesignerAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
    ...
    free(localVarPath);
    free(localVarToReplace_pkiEzsigntemplatepackagesignerID);
    if (localVarSingleItemJSON_ezsigntemplatepackagesigner_edit_object_v2_request) {
        cJSON_Delete(localVarSingleItemJSON_ezsigntemplatepackagesigner_edit_object_v2_request);
        localVarSingleItemJSON_ezsigntemplatepackagesigner_edit_object_v2_request = NULL;
    }
    free(localVarBodyParameters);
    return elementToReturn;
end:
...
// 
//
ezsigntemplatepackagesigner_get_object_v3_response_t*
ObjectEzsigntemplatepackagesignerAPI_ezsigntemplatepackagesignerGetObjectV3(apiClient_t *apiClient, int *pkiEzsigntemplatepackagesignerID)
{
    list_t    *localVarQueryParameters = NULL;
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    char *localVarPath = strdup("/3/object/ezsigntemplatepackagesigner/{pkiEzsigntemplatepackagesignerID}");
    ...
    //}
    //nonprimitive not container
    ezsigntemplatepackagesigner_get_object_v3_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ObjectEzsigntemplatepackagesignerAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = ezsigntemplatepackagesigner_get_object_v3_response_parseFromJSON(ObjectEzsigntemplatepackagesignerAPIlocalVarJSON);
        cJSON_Delete(ObjectEzsigntemplatepackagesignerAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
