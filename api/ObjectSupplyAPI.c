...
static char* supplyGetAutocompleteV2_SSELECTOR_ToString(ezmax_api_definition__full_supplyGetAutocompleteV2_sSelector_e SSELECTOR){
    char *SSELECTORArray[] =  { "NULL", "All" };
    return SSELECTORArray[SSELECTOR];
}

static ezmax_api_definition__full_supplyGetAutocompleteV2_sSelector_e supplyGetAutocompleteV2_SSELECTOR_FromString(char* SSELECTOR){
...
/*
// Function supplyGetAutocompleteV2_SSELECTOR_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *supplyGetAutocompleteV2_SSELECTOR_convertToJSON(ezmax_api_definition__full_supplyGetAutocompleteV2_sSelector_e SSELECTOR) {
    cJSON *item = cJSON_CreateObject();
    if(cJSON_AddStringToObject(item, "sSelector", supplyGetAutocompleteV2_SSELECTOR_ToString(SSELECTOR)) == NULL) {
        goto fail;
    }
    return item;
    fail:
...
// Function supplyGetAutocompleteV2_SSELECTOR_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_supplyGetAutocompleteV2_sSelector_e supplyGetAutocompleteV2_SSELECTOR_parseFromJSON(cJSON* SSELECTORJSON) {
    ezmax_api_definition__full_supplyGetAutocompleteV2_sSelector_e SSELECTORVariable = 0;
    ...
    SSELECTORVariable = supplyGetAutocompleteV2_SSELECTOR_FromString(SSELECTORVar->valuestring);
...
// Functions for enum EFILTERACTIVE for ObjectSupplyAPI_supplyGetAutocompleteV2

static char* supplyGetAutocompleteV2_EFILTERACTIVE_ToString(ezmax_api_definition__full_supplyGetAutocompleteV2_eFilterActive_e EFILTERACTIVE){
    char *EFILTERACTIVEArray[] =  { "NULL", "All", "Active", "Inactive" };
    return EFILTERACTIVEArray[EFILTERACTIVE];
}

static ezmax_api_definition__full_supplyGetAutocompleteV2_eFilterActive_e supplyGetAutocompleteV2_EFILTERACTIVE_FromString(char* EFILTERACTIVE){
    int stringToReturn = 0;
    char *EFILTERACTIVEArray[] =  { "NULL", "All", "Active", "Inactive" };
...
/*
// Function supplyGetAutocompleteV2_EFILTERACTIVE_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *supplyGetAutocompleteV2_EFILTERACTIVE_convertToJSON(ezmax_api_definition__full_supplyGetAutocompleteV2_eFilterActive_e EFILTERACTIVE) {
    cJSON *item = cJSON_CreateObject();
    if(cJSON_AddStringToObject(item, "eFilterActive", supplyGetAutocompleteV2_EFILTERACTIVE_ToString(EFILTERACTIVE)) == NULL) {
        goto fail;
    }
    return item;
    fail:
...
// Function supplyGetAutocompleteV2_EFILTERACTIVE_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_supplyGetAutocompleteV2_eFilterActive_e supplyGetAutocompleteV2_EFILTERACTIVE_parseFromJSON(cJSON* EFILTERACTIVEJSON) {
    ezmax_api_definition__full_supplyGetAutocompleteV2_eFilterActive_e EFILTERACTIVEVariable = 0;
    ...
    EFILTERACTIVEVariable = supplyGetAutocompleteV2_EFILTERACTIVE_FromString(EFILTERACTIVEVar->valuestring);
...
// Functions for enum  for ObjectSupplyAPI_supplyGetAutocompleteV2

static char* supplyGetAutocompleteV2__ToString(ezmax_api_definition__full_supplyGetAutocompleteV2_Accept-Language_e ){
    char *Array[] =  { "NULL", "*", "en", "fr" };
    return Array[];
}

static ezmax_api_definition__full_supplyGetAutocompleteV2_Accept-Language_e supplyGetAutocompleteV2__FromString(char* ){
    int stringToReturn = 0;
    char *Array[] =  { "NULL", "*", "en", "fr" };
...
/*
// Function supplyGetAutocompleteV2__convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *supplyGetAutocompleteV2__convertToJSON(ezmax_api_definition__full_supplyGetAutocompleteV2_Accept-Language_e ) {
    cJSON *item = cJSON_CreateObject();
    return item;
    fail:
    cJSON_Delete(item);
...
// Function supplyGetAutocompleteV2__parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_supplyGetAutocompleteV2_Accept-Language_e supplyGetAutocompleteV2__parseFromJSON(cJSON* JSON) {
    ezmax_api_definition__full_supplyGetAutocompleteV2_Accept-Language_e Variable = 0;
    return Variable;
end:
    return 0;
}
...
/*
// Function supplyGetListV1_EORDERBY_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *supplyGetListV1_EORDERBY_convertToJSON(ezmax_api_definition__full_supplyGetListV1_eOrderBy_e EORDERBY) {
    cJSON *item = cJSON_CreateObject();
    if(cJSON_AddStringToObject(item, "eOrderBy", supplyGetListV1_EORDERBY_ToString(EORDERBY)) == NULL) {
        goto fail;
    }
    return item;
    fail:
...
// Function supplyGetListV1_EORDERBY_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_supplyGetListV1_eOrderBy_e supplyGetListV1_EORDERBY_parseFromJSON(cJSON* EORDERBYJSON) {
    ezmax_api_definition__full_supplyGetListV1_eOrderBy_e EORDERBYVariable = 0;
    ...
    EORDERBYVariable = supplyGetListV1_EORDERBY_FromString(EORDERBYVar->valuestring);
...
// Functions for enum  for ObjectSupplyAPI_supplyGetListV1

static char* supplyGetListV1__ToString(ezmax_api_definition__full_supplyGetListV1_Accept-Language_e ){
    char *Array[] =  { "NULL", "*", "en", "fr" };
    return Array[];
}

static ezmax_api_definition__full_supplyGetListV1_Accept-Language_e supplyGetListV1__FromString(char* ){
    int stringToReturn = 0;
    char *Array[] =  { "NULL", "*", "en", "fr" };
    size_t sizeofArray = sizeof(Array) / sizeof(Array[0]);
    while(stringToReturn < sizeofArray) {
...
/*
// Function supplyGetListV1__convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *supplyGetListV1__convertToJSON(ezmax_api_definition__full_supplyGetListV1_Accept-Language_e ) {
    cJSON *item = cJSON_CreateObject();
    return item;
    fail:
    cJSON_Delete(item);
...
// Function supplyGetListV1__parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_supplyGetListV1_Accept-Language_e supplyGetListV1__parseFromJSON(cJSON* JSON) {
    ezmax_api_definition__full_supplyGetListV1_Accept-Language_e Variable = 0;
    return Variable;
end:
    return 0;
}
...
ObjectSupplyAPI_supplyCreateObjectV1(apiClient_t *apiClient, supply_create_object_v1_request_t *supply_create_object_v1_request)
{
    ...
    free(localVarPath);
    if (localVarSingleItemJSON_supply_create_object_v1_request) {
        cJSON_Delete(localVarSingleItemJSON_supply_create_object_v1_request);
        localVarSingleItemJSON_supply_create_object_v1_request = NULL;
    }
...
ObjectSupplyAPI_supplyDeleteObjectV1(apiClient_t *apiClient, int *pkiSupplyID)
{
    ...
    char* localVarToReplace_pkiSupplyID = malloc(sizeOfPathParams_pkiSupplyID);
    ...
    free(localVarPath);
    free(localVarToReplace_pkiSupplyID);
    return elementToReturn;
end:
    free(localVarPath);
    return NULL;
...
ObjectSupplyAPI_supplyEditObjectV1(apiClient_t *apiClient, int *pkiSupplyID, supply_edit_object_v1_request_t *supply_edit_object_v1_request)
{
    ...
    free(localVarPath);
    free(localVarToReplace_pkiSupplyID);
    if (localVarSingleItemJSON_supply_edit_object_v1_request) {
        cJSON_Delete(localVarSingleItemJSON_supply_edit_object_v1_request);
        localVarSingleItemJSON_supply_edit_object_v1_request = NULL;
    }
    free(localVarBodyParameters);
    return elementToReturn;
end:
...
ObjectSupplyAPI_supplyGetAutocompleteV2(apiClient_t *apiClient, ezmax_api_definition__full_supplyGetAutocompleteV2_sSelector_e sSelector, ezmax_api_definition__full_supplyGetAutocompleteV2_eFilterActive_e eFilterActive, char *sQuery, header_accept_language_e Accept_Language)
{
    ...
    ezmax_api_definition__full_supplyGetAutocompleteV2_eFilterActive_e valueQuery_eFilterActive ;
...
ObjectSupplyAPI_supplyGetListV1(apiClient_t *apiClient, ezmax_api_definition__full_supplyGetListV1_eOrderBy_e eOrderBy, int *iRowMax, int *iRowOffset, header_accept_language_e Accept_Language, char *sFilter)
{
    ...
    ezmax_api_definition__full_supplyGetListV1_eOrderBy_e valueQuery_eOrderBy ;
