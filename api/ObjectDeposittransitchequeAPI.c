...
// Functions for enum EORDERBY for ObjectDeposittransitchequeAPI_deposittransitchequeGetListV1

static char* deposittransitchequeGetListV1_EORDERBY_ToString(ezmax_api_definition__full_deposittransitchequeGetListV1_eOrderBy_e EORDERBY){
    char *EORDERBYArray[] =  { "NULL", "pkiDeposittransitchequeID_ASC", "pkiDeposittransitchequeID_DESC", "fkiBankaccountID_ASC", "fkiBankaccountID_DESC", "fkiDepositID_ASC", "fkiDepositID_DESC", "sDeposittransitchequeNumber_ASC", "sDeposittransitchequeNumber_DESC", "dtDeposittransitchequeDate_ASC", "dtDeposittransitchequeDate_DESC", "dDeposittransitchequeAmount_ASC", "dDeposittransitchequeAmount_DESC", "sBankaccountBankname_ASC", "sBankaccountBankname_DESC", "sPeriodYYYYMM_ASC", "sPeriodYYYYMM_DESC", "sCustomerName_ASC", "sCustomerName_DESC" };
    return EORDERBYArray[EORDERBY];
}

static ezmax_api_definition__full_deposittransitchequeGetListV1_eOrderBy_e deposittransitchequeGetListV1_EORDERBY_FromString(char* EORDERBY){
...
/*
// Function deposittransitchequeGetListV1_EORDERBY_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *deposittransitchequeGetListV1_EORDERBY_convertToJSON(ezmax_api_definition__full_deposittransitchequeGetListV1_eOrderBy_e EORDERBY) {
    cJSON *item = cJSON_CreateObject();
    if(cJSON_AddStringToObject(item, "eOrderBy", deposittransitchequeGetListV1_EORDERBY_ToString(EORDERBY)) == NULL) {
        goto fail;
    }
    return item;
    fail:
...
// Function deposittransitchequeGetListV1_EORDERBY_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_deposittransitchequeGetListV1_eOrderBy_e deposittransitchequeGetListV1_EORDERBY_parseFromJSON(cJSON* EORDERBYJSON) {
    ezmax_api_definition__full_deposittransitchequeGetListV1_eOrderBy_e EORDERBYVariable = 0;
    ...
    EORDERBYVariable = deposittransitchequeGetListV1_EORDERBY_FromString(EORDERBYVar->valuestring);
...
// Functions for enum  for ObjectDeposittransitchequeAPI_deposittransitchequeGetListV1

static char* deposittransitchequeGetListV1__ToString(ezmax_api_definition__full_deposittransitchequeGetListV1_Accept-Language_e ){
    char *Array[] =  { "NULL", "*", "en", "fr" };
    return Array[];
}

static ezmax_api_definition__full_deposittransitchequeGetListV1_Accept-Language_e deposittransitchequeGetListV1__FromString(char* ){
    int stringToReturn = 0;
    char *Array[] =  { "NULL", "*", "en", "fr" };
...
/*
// Function deposittransitchequeGetListV1__convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *deposittransitchequeGetListV1__convertToJSON(ezmax_api_definition__full_deposittransitchequeGetListV1_Accept-Language_e ) {
    cJSON *item = cJSON_CreateObject();
    return item;
    fail:
    cJSON_Delete(item);
...
// Function deposittransitchequeGetListV1__parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_deposittransitchequeGetListV1_Accept-Language_e deposittransitchequeGetListV1__parseFromJSON(cJSON* JSON) {
    ezmax_api_definition__full_deposittransitchequeGetListV1_Accept-Language_e Variable = 0;
    return Variable;
end:
    return 0;
}
...
ObjectDeposittransitchequeAPI_deposittransitchequeGetCommunicationCountV1(apiClient_t *apiClient, int *pkiDeposittransitchequeID)
{
    ...
    // create the path
    char *localVarPath = strdup("/1/object/deposittransitcheque/{pkiDeposittransitchequeID}/getCommunicationCount");
    ...
    //}
    //nonprimitive not container
    deposittransitcheque_get_communication_count_v1_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ObjectDeposittransitchequeAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = deposittransitcheque_get_communication_count_v1_response_parseFromJSON(ObjectDeposittransitchequeAPIlocalVarJSON);
        cJSON_Delete(ObjectDeposittransitchequeAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
ObjectDeposittransitchequeAPI_deposittransitchequeGetCommunicationListV1(apiClient_t *apiClient, int *pkiDeposittransitchequeID)
{
    ...
    // create the path
    char *localVarPath = strdup("/1/object/deposittransitcheque/{pkiDeposittransitchequeID}/getCommunicationList");
    ...
    //}
    //nonprimitive not container
    deposittransitcheque_get_communication_list_v1_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ObjectDeposittransitchequeAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = deposittransitcheque_get_communication_list_v1_response_parseFromJSON(ObjectDeposittransitchequeAPIlocalVarJSON);
        cJSON_Delete(ObjectDeposittransitchequeAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
ObjectDeposittransitchequeAPI_deposittransitchequeGetCommunicationrecipientsV1(apiClient_t *apiClient, int *pkiDeposittransitchequeID)
{
    ...
    // create the path
    char *localVarPath = strdup("/1/object/deposittransitcheque/{pkiDeposittransitchequeID}/getCommunicationrecipients");
    ...
    //}
    //nonprimitive not container
    deposittransitcheque_get_communicationrecipients_v1_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ObjectDeposittransitchequeAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = deposittransitcheque_get_communicationrecipients_v1_response_parseFromJSON(ObjectDeposittransitchequeAPIlocalVarJSON);
        cJSON_Delete(ObjectDeposittransitchequeAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
ObjectDeposittransitchequeAPI_deposittransitchequeGetCommunicationsendersV1(apiClient_t *apiClient, int *pkiDeposittransitchequeID)
{
    ...
    // create the path
    char *localVarPath = strdup("/1/object/deposittransitcheque/{pkiDeposittransitchequeID}/getCommunicationsenders");
    ...
    //}
    //nonprimitive not container
    deposittransitcheque_get_communicationsenders_v1_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ObjectDeposittransitchequeAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = deposittransitcheque_get_communicationsenders_v1_response_parseFromJSON(ObjectDeposittransitchequeAPIlocalVarJSON);
        cJSON_Delete(ObjectDeposittransitchequeAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
ObjectDeposittransitchequeAPI_deposittransitchequeGetListV1(apiClient_t *apiClient, ezmax_api_definition__full_deposittransitchequeGetListV1_eOrderBy_e eOrderBy, int *iRowMax, int *iRowOffset, header_accept_language_e Accept_Language, char *sFilter)
{
    ...
    // create the path
    char *localVarPath = strdup("/1/object/deposittransitcheque/getList");
    ...
    ezmax_api_definition__full_deposittransitchequeGetListV1_eOrderBy_e valueQuery_eOrderBy ;
    keyValuePair_t *keyPairQuery_eOrderBy = 0;
    if (eOrderBy)
    {
        keyQuery_eOrderBy = strdup("eOrderBy");
        valueQuery_eOrderBy = (eOrderBy);
        keyPairQuery_eOrderBy = keyValuePair_create(keyQuery_eOrderBy, strdup(deposittransitchequeGetListV1_EORDERBY_ToString(
        valueQuery_eOrderBy)));
    ...
    //}
    //nonprimitive not container
    deposittransitcheque_get_list_v1_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ObjectDeposittransitchequeAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = deposittransitcheque_get_list_v1_response_parseFromJSON(ObjectDeposittransitchequeAPIlocalVarJSON);
        cJSON_Delete(ObjectDeposittransitchequeAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
