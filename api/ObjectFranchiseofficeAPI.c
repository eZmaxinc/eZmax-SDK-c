...
static char* franchiseofficeGetAutocompleteV1_SSELECTOR_ToString(ezmax_api_definition_franchiseofficeGetAutocompleteV1_sSelector_e SSELECTOR){
    char *SSELECTORArray[] =  { "NULL", "Active", "All" };
    return SSELECTORArray[SSELECTOR];
}

static ezmax_api_definition_franchiseofficeGetAutocompleteV1_sSelector_e franchiseofficeGetAutocompleteV1_SSELECTOR_FromString(char* SSELECTOR){
...
//
static cJSON *franchiseofficeGetAutocompleteV1_SSELECTOR_convertToJSON(ezmax_api_definition_franchiseofficeGetAutocompleteV1_sSelector_e SSELECTOR) {
...
//
static ezmax_api_definition_franchiseofficeGetAutocompleteV1_sSelector_e franchiseofficeGetAutocompleteV1_SSELECTOR_parseFromJSON(cJSON* SSELECTORJSON) {
    ezmax_api_definition_franchiseofficeGetAutocompleteV1_sSelector_e SSELECTORVariable = 0;
