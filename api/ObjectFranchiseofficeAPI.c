...
// Functions for enum EFILTERACTIVE for ObjectFranchiseofficeAPI_franchiseofficeGetAutocompleteV1

static char* franchiseofficeGetAutocompleteV1_EFILTERACTIVE_ToString(ezmax_api_definition__full_franchiseofficeGetAutocompleteV1_eFilterActive_e EFILTERACTIVE){
    char *EFILTERACTIVEArray[] =  { "NULL", "All", "Active", "Inactive" };
    return EFILTERACTIVEArray[EFILTERACTIVE];
}

static ezmax_api_definition__full_franchiseofficeGetAutocompleteV1_eFilterActive_e franchiseofficeGetAutocompleteV1_EFILTERACTIVE_FromString(char* EFILTERACTIVE){
    int stringToReturn = 0;
    char *EFILTERACTIVEArray[] =  { "NULL", "All", "Active", "Inactive" };
...
/*
// Function franchiseofficeGetAutocompleteV1_EFILTERACTIVE_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *franchiseofficeGetAutocompleteV1_EFILTERACTIVE_convertToJSON(ezmax_api_definition__full_franchiseofficeGetAutocompleteV1_eFilterActive_e EFILTERACTIVE) {
    cJSON *item = cJSON_CreateObject();
    if(cJSON_AddStringToObject(item, "eFilterActive", franchiseofficeGetAutocompleteV1_EFILTERACTIVE_ToString(EFILTERACTIVE)) == NULL) {
        goto fail;
    }
    return item;
    fail:
...
// Function franchiseofficeGetAutocompleteV1_EFILTERACTIVE_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_franchiseofficeGetAutocompleteV1_eFilterActive_e franchiseofficeGetAutocompleteV1_EFILTERACTIVE_parseFromJSON(cJSON* EFILTERACTIVEJSON) {
    ezmax_api_definition__full_franchiseofficeGetAutocompleteV1_eFilterActive_e EFILTERACTIVEVariable = 0;
    ...
    EFILTERACTIVEVariable = franchiseofficeGetAutocompleteV1_EFILTERACTIVE_FromString(EFILTERACTIVEVar->valuestring);
...
// Functions for enum SSELECTOR for ObjectFranchiseofficeAPI_franchiseofficeGetAutocompleteV2

static char* franchiseofficeGetAutocompleteV2_SSELECTOR_ToString(ezmax_api_definition__full_franchiseofficeGetAutocompleteV2_sSelector_e SSELECTOR){
    char *SSELECTORArray[] =  { "NULL", "All" };
    return SSELECTORArray[SSELECTOR];
}

static ezmax_api_definition__full_franchiseofficeGetAutocompleteV2_sSelector_e franchiseofficeGetAutocompleteV2_SSELECTOR_FromString(char* SSELECTOR){
    int stringToReturn = 0;
    char *SSELECTORArray[] =  { "NULL", "All" };
    size_t sizeofArray = sizeof(SSELECTORArray) / sizeof(SSELECTORArray[0]);
    while(stringToReturn < sizeofArray) {
...
/*
// Function franchiseofficeGetAutocompleteV2_SSELECTOR_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *franchiseofficeGetAutocompleteV2_SSELECTOR_convertToJSON(ezmax_api_definition__full_franchiseofficeGetAutocompleteV2_sSelector_e SSELECTOR) {
    cJSON *item = cJSON_CreateObject();
    if(cJSON_AddStringToObject(item, "sSelector", franchiseofficeGetAutocompleteV2_SSELECTOR_ToString(SSELECTOR)) == NULL) {
        goto fail;
    }
    return item;
    fail:
...
// Function franchiseofficeGetAutocompleteV2_SSELECTOR_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_franchiseofficeGetAutocompleteV2_sSelector_e franchiseofficeGetAutocompleteV2_SSELECTOR_parseFromJSON(cJSON* SSELECTORJSON) {
    ezmax_api_definition__full_franchiseofficeGetAutocompleteV2_sSelector_e SSELECTORVariable = 0;
    cJSON *SSELECTORVar = cJSON_GetObjectItemCaseSensitive(SSELECTORJSON, "sSelector");
    if(!cJSON_IsString(SSELECTORVar) || (SSELECTORVar->valuestring == NULL))
    {
        goto end;
    }
    SSELECTORVariable = franchiseofficeGetAutocompleteV2_SSELECTOR_FromString(SSELECTORVar->valuestring);
    return SSELECTORVariable;
end:
    return 0;
}
...
// Functions for enum EFILTERACTIVE for ObjectFranchiseofficeAPI_franchiseofficeGetAutocompleteV2

static char* franchiseofficeGetAutocompleteV2_EFILTERACTIVE_ToString(ezmax_api_definition__full_franchiseofficeGetAutocompleteV2_eFilterActive_e EFILTERACTIVE){
    char *EFILTERACTIVEArray[] =  { "NULL", "All", "Active", "Inactive" };
    return EFILTERACTIVEArray[EFILTERACTIVE];
}

static ezmax_api_definition__full_franchiseofficeGetAutocompleteV2_eFilterActive_e franchiseofficeGetAutocompleteV2_EFILTERACTIVE_FromString(char* EFILTERACTIVE){
    int stringToReturn = 0;
    char *EFILTERACTIVEArray[] =  { "NULL", "All", "Active", "Inactive" };
    size_t sizeofArray = sizeof(EFILTERACTIVEArray) / sizeof(EFILTERACTIVEArray[0]);
    while(stringToReturn < sizeofArray) {
...
/*
// Function franchiseofficeGetAutocompleteV2_EFILTERACTIVE_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *franchiseofficeGetAutocompleteV2_EFILTERACTIVE_convertToJSON(ezmax_api_definition__full_franchiseofficeGetAutocompleteV2_eFilterActive_e EFILTERACTIVE) {
    cJSON *item = cJSON_CreateObject();
    if(cJSON_AddStringToObject(item, "eFilterActive", franchiseofficeGetAutocompleteV2_EFILTERACTIVE_ToString(EFILTERACTIVE)) == NULL) {
        goto fail;
    }
    return item;
    fail:
...
// Function franchiseofficeGetAutocompleteV2_EFILTERACTIVE_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_franchiseofficeGetAutocompleteV2_eFilterActive_e franchiseofficeGetAutocompleteV2_EFILTERACTIVE_parseFromJSON(cJSON* EFILTERACTIVEJSON) {
    ezmax_api_definition__full_franchiseofficeGetAutocompleteV2_eFilterActive_e EFILTERACTIVEVariable = 0;
    cJSON *EFILTERACTIVEVar = cJSON_GetObjectItemCaseSensitive(EFILTERACTIVEJSON, "eFilterActive");
    if(!cJSON_IsString(EFILTERACTIVEVar) || (EFILTERACTIVEVar->valuestring == NULL))
    {
        goto end;
    }
    EFILTERACTIVEVariable = franchiseofficeGetAutocompleteV2_EFILTERACTIVE_FromString(EFILTERACTIVEVar->valuestring);
    return EFILTERACTIVEVariable;
end:
    return 0;
}
...
// Functions for enum  for ObjectFranchiseofficeAPI_franchiseofficeGetAutocompleteV2

static char* franchiseofficeGetAutocompleteV2__ToString(ezmax_api_definition__full_franchiseofficeGetAutocompleteV2_Accept-Language_e ){
    char *Array[] =  { "NULL", "*", "en", "fr" };
    return Array[];
}

static ezmax_api_definition__full_franchiseofficeGetAutocompleteV2_Accept-Language_e franchiseofficeGetAutocompleteV2__FromString(char* ){
    int stringToReturn = 0;
    char *Array[] =  { "NULL", "*", "en", "fr" };
    size_t sizeofArray = sizeof(Array) / sizeof(Array[0]);
    while(stringToReturn < sizeofArray) {
...
/*
// Function franchiseofficeGetAutocompleteV2__convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *franchiseofficeGetAutocompleteV2__convertToJSON(ezmax_api_definition__full_franchiseofficeGetAutocompleteV2_Accept-Language_e ) {
    cJSON *item = cJSON_CreateObject();
    return item;
    fail:
    cJSON_Delete(item);
...
// Function franchiseofficeGetAutocompleteV2__parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_franchiseofficeGetAutocompleteV2_Accept-Language_e franchiseofficeGetAutocompleteV2__parseFromJSON(cJSON* JSON) {
    ezmax_api_definition__full_franchiseofficeGetAutocompleteV2_Accept-Language_e Variable = 0;
    return Variable;
end:
    return 0;
}
...
ObjectFranchiseofficeAPI_franchiseofficeGetAutocompleteV1(apiClient_t *apiClient, ezmax_api_definition__full_franchiseofficeGetAutocompleteV1_sSelector_e sSelector , ezmax_api_definition__full_franchiseofficeGetAutocompleteV1_eFilterActive_e eFilterActive , char * sQuery , header_accept_language_e Accept_Language )
{
    ...
    ezmax_api_definition__full_franchiseofficeGetAutocompleteV1_eFilterActive_e valueQuery_eFilterActive ;
    ...
    if (eFilterActive)
    {
        ...
        keyPairQuery_eFilterActive = keyValuePair_create(keyQuery_eFilterActive, (void *)strdup(franchiseofficeGetAutocompleteV1_EFILTERACTIVE_ToString(
...
ObjectFranchiseofficeAPI_franchiseofficeGetAutocompleteV2(apiClient_t *apiClient, ezmax_api_definition__full_franchiseofficeGetAutocompleteV2_sSelector_e sSelector , ezmax_api_definition__full_franchiseofficeGetAutocompleteV2_eFilterActive_e eFilterActive , char * sQuery , header_accept_language_e Accept_Language )
{
    ...
    // create the path
    long sizeOfPath = strlen("/2/object/franchiseoffice/getAutocomplete/{sSelector}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/2/object/franchiseoffice/getAutocomplete/{sSelector}");
    ...
    // query parameters
    char *keyQuery_eFilterActive = NULL;
    ezmax_api_definition__full_franchiseofficeGetAutocompleteV2_eFilterActive_e valueQuery_eFilterActive ;
    keyValuePair_t *keyPairQuery_eFilterActive = 0;
    if (eFilterActive)
    {
        keyQuery_eFilterActive = strdup("eFilterActive");
    ...
    //nonprimitive not container
    cJSON *ObjectFranchiseofficeAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    franchiseoffice_get_autocomplete_v2_response_t *elementToReturn = franchiseoffice_get_autocomplete_v2_response_parseFromJSON(ObjectFranchiseofficeAPIlocalVarJSON);
    cJSON_Delete(ObjectFranchiseofficeAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
