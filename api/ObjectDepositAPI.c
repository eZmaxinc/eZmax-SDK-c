...
// Functions for enum EORDERBY for ObjectDepositAPI_depositGetListV1

static char* depositGetListV1_EORDERBY_ToString(ezmax_api_definition__full_depositGetListV1_eOrderBy_e EORDERBY){
    char *EORDERBYArray[] =  { "NULL", "pkiDepositID_ASC", "pkiDepositID_DESC", "fkiPeriodID_ASC", "fkiPeriodID_DESC", "fkiBankaccountID_ASC", "fkiBankaccountID_DESC", "fkiUserIDCreated_ASC", "fkiUserIDCreated_DESC", "sDepositNumber_ASC", "sDepositNumber_DESC", "dtDepositDate_ASC", "dtDepositDate_DESC", "dDepositTotal_ASC", "dDepositTotal_DESC", "dtCreatedDate_ASC", "dtCreatedDate_DESC", "bDepositDraft_ASC", "bDepositDraft_DESC", "bDepositReconciled_ASC", "bDepositReconciled_DESC", "fkiReconciliationID_ASC", "fkiReconciliationID_DESC", "sBankaccountBankname_ASC", "sBankaccountBankname_DESC", "sPeriodYYYYMM_ASC", "sPeriodYYYYMM_DESC", "sUserLoginname_ASC", "sUserLoginname_DESC" };
    return EORDERBYArray[EORDERBY];
}

static ezmax_api_definition__full_depositGetListV1_eOrderBy_e depositGetListV1_EORDERBY_FromString(char* EORDERBY){
...
/*
// Function depositGetListV1_EORDERBY_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *depositGetListV1_EORDERBY_convertToJSON(ezmax_api_definition__full_depositGetListV1_eOrderBy_e EORDERBY) {
    cJSON *item = cJSON_CreateObject();
    if(cJSON_AddStringToObject(item, "eOrderBy", depositGetListV1_EORDERBY_ToString(EORDERBY)) == NULL) {
        goto fail;
    }
    return item;
    fail:
...
// Function depositGetListV1_EORDERBY_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_depositGetListV1_eOrderBy_e depositGetListV1_EORDERBY_parseFromJSON(cJSON* EORDERBYJSON) {
    ezmax_api_definition__full_depositGetListV1_eOrderBy_e EORDERBYVariable = 0;
    ...
    EORDERBYVariable = depositGetListV1_EORDERBY_FromString(EORDERBYVar->valuestring);
...
// Functions for enum  for ObjectDepositAPI_depositGetListV1

static char* depositGetListV1__ToString(ezmax_api_definition__full_depositGetListV1_Accept-Language_e ){
    char *Array[] =  { "NULL", "*", "en", "fr" };
    return Array[];
}

static ezmax_api_definition__full_depositGetListV1_Accept-Language_e depositGetListV1__FromString(char* ){
    int stringToReturn = 0;
    char *Array[] =  { "NULL", "*", "en", "fr" };
...
/*
// Function depositGetListV1__convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *depositGetListV1__convertToJSON(ezmax_api_definition__full_depositGetListV1_Accept-Language_e ) {
    cJSON *item = cJSON_CreateObject();
    return item;
    fail:
    cJSON_Delete(item);
...
// Function depositGetListV1__parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_depositGetListV1_Accept-Language_e depositGetListV1__parseFromJSON(cJSON* JSON) {
    ezmax_api_definition__full_depositGetListV1_Accept-Language_e Variable = 0;
    return Variable;
end:
    return 0;
}
...
ObjectDepositAPI_depositBatchDownloadV1(apiClient_t *apiClient, int *pkiDepositID, deposit_batch_download_v1_request_t *deposit_batch_download_v1_request)
{
    ...
    // create the path
    char *localVarPath = strdup("/1/object/deposit/{pkiDepositID}/batchDownload");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_deposit_batch_download_v1_request = NULL;
    if (deposit_batch_download_v1_request != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_deposit_batch_download_v1_request = deposit_batch_download_v1_request_convertToJSON(deposit_batch_download_v1_request);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_deposit_batch_download_v1_request);
    ...
    if (localVarSingleItemJSON_deposit_batch_download_v1_request) {
        cJSON_Delete(localVarSingleItemJSON_deposit_batch_download_v1_request);
        localVarSingleItemJSON_deposit_batch_download_v1_request = NULL;
    }
...
ObjectDepositAPI_depositGetAttachmentsV1(apiClient_t *apiClient, int *pkiDepositID)
{
    ...
    // create the path
    char *localVarPath = strdup("/1/object/deposit/{pkiDepositID}/getAttachments");
    ...
    deposit_get_attachments_v1_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ObjectDepositAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = deposit_get_attachments_v1_response_parseFromJSON(ObjectDepositAPIlocalVarJSON);
...
ObjectDepositAPI_depositGetListV1(apiClient_t *apiClient, ezmax_api_definition__full_depositGetListV1_eOrderBy_e eOrderBy, int *iRowMax, int *iRowOffset, header_accept_language_e Accept_Language, char *sFilter)
{
    ...
    // create the path
    char *localVarPath = strdup("/1/object/deposit/getList");
    ...
    ezmax_api_definition__full_depositGetListV1_eOrderBy_e valueQuery_eOrderBy ;
    keyValuePair_t *keyPairQuery_eOrderBy = 0;
    if (eOrderBy)
    {
        keyQuery_eOrderBy = strdup("eOrderBy");
        valueQuery_eOrderBy = (eOrderBy);
        keyPairQuery_eOrderBy = keyValuePair_create(keyQuery_eOrderBy, strdup(depositGetListV1_EORDERBY_ToString(
        valueQuery_eOrderBy)));
    ...
    //}
    //nonprimitive not container
    deposit_get_list_v1_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ObjectDepositAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = deposit_get_list_v1_response_parseFromJSON(ObjectDepositAPIlocalVarJSON);
        cJSON_Delete(ObjectDepositAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
ObjectDepositAPI_depositImportIntoEDMV1(apiClient_t *apiClient, int *pkiDepositID, deposit_import_into_edm_v1_request_t *deposit_import_into_edm_v1_request)
{
    ...
    // create the path
    char *localVarPath = strdup("/1/object/deposit/{pkiDepositID}/importIntoEDM");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_deposit_import_into_edm_v1_request = NULL;
    if (deposit_import_into_edm_v1_request != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_deposit_import_into_edm_v1_request = deposit_import_into_edm_v1_request_convertToJSON(deposit_import_into_edm_v1_request);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_deposit_import_into_edm_v1_request);
        localVarBodyLength = strlen(localVarBodyParameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //}
    //nonprimitive not container
    deposit_import_into_edm_v1_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ObjectDepositAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = deposit_import_into_edm_v1_response_parseFromJSON(ObjectDepositAPIlocalVarJSON);
        cJSON_Delete(ObjectDepositAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
    ...
    free(localVarPath);
    free(localVarToReplace_pkiDepositID);
    if (localVarSingleItemJSON_deposit_import_into_edm_v1_request) {
        cJSON_Delete(localVarSingleItemJSON_deposit_import_into_edm_v1_request);
        localVarSingleItemJSON_deposit_import_into_edm_v1_request = NULL;
    }
    free(localVarBodyParameters);
    return elementToReturn;
end:
