...
ObjectInscriptionnotauthenticatedAPI_inscriptionnotauthenticatedBatchDownloadV1(apiClient_t *apiClient, int *pkiInscriptionnotauthenticatedID, inscriptionnotauthenticated_batch_download_v1_request_t *inscriptionnotauthenticated_batch_download_v1_request)
{
    ...
    // create the path
    char *localVarPath = strdup("/1/object/inscriptionnotauthenticated/{pkiInscriptionnotauthenticatedID}/batchDownload");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_inscriptionnotauthenticated_batch_download_v1_request = NULL;
    if (inscriptionnotauthenticated_batch_download_v1_request != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_inscriptionnotauthenticated_batch_download_v1_request = inscriptionnotauthenticated_batch_download_v1_request_convertToJSON(inscriptionnotauthenticated_batch_download_v1_request);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_inscriptionnotauthenticated_batch_download_v1_request);
    ...
    if (localVarSingleItemJSON_inscriptionnotauthenticated_batch_download_v1_request) {
        cJSON_Delete(localVarSingleItemJSON_inscriptionnotauthenticated_batch_download_v1_request);
        localVarSingleItemJSON_inscriptionnotauthenticated_batch_download_v1_request = NULL;
    }
...
ObjectInscriptionnotauthenticatedAPI_inscriptionnotauthenticatedGetAttachmentsV1(apiClient_t *apiClient, int *pkiInscriptionnotauthenticatedID)
{
    ...
    // create the path
    char *localVarPath = strdup("/1/object/inscriptionnotauthenticated/{pkiInscriptionnotauthenticatedID}/getAttachments");
    ...
    //}
    //nonprimitive not container
    inscriptionnotauthenticated_get_attachments_v1_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ObjectInscriptionnotauthenticatedAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = inscriptionnotauthenticated_get_attachments_v1_response_parseFromJSON(ObjectInscriptionnotauthenticatedAPIlocalVarJSON);
        cJSON_Delete(ObjectInscriptionnotauthenticatedAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
