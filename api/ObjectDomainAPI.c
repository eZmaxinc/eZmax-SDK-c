...
// Functions for enum SSELECTOR for ObjectDomainAPI_domainGetAutocompleteV2

static char* domainGetAutocompleteV2_SSELECTOR_ToString(ezmax_api_definition__full_domainGetAutocompleteV2_sSelector_e SSELECTOR){
    char *SSELECTORArray[] =  { "NULL", "All", "ValidEmail" };
    return SSELECTORArray[SSELECTOR];
}

static ezmax_api_definition__full_domainGetAutocompleteV2_sSelector_e domainGetAutocompleteV2_SSELECTOR_FromString(char* SSELECTOR){
...
/*
// Function domainGetAutocompleteV2_SSELECTOR_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *domainGetAutocompleteV2_SSELECTOR_convertToJSON(ezmax_api_definition__full_domainGetAutocompleteV2_sSelector_e SSELECTOR) {
    cJSON *item = cJSON_CreateObject();
    if(cJSON_AddStringToObject(item, "sSelector", domainGetAutocompleteV2_SSELECTOR_ToString(SSELECTOR)) == NULL) {
        goto fail;
    }
    return item;
    fail:
...
// Function domainGetAutocompleteV2_SSELECTOR_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_domainGetAutocompleteV2_sSelector_e domainGetAutocompleteV2_SSELECTOR_parseFromJSON(cJSON* SSELECTORJSON) {
    ezmax_api_definition__full_domainGetAutocompleteV2_sSelector_e SSELECTORVariable = 0;
    ...
    SSELECTORVariable = domainGetAutocompleteV2_SSELECTOR_FromString(SSELECTORVar->valuestring);
...
// Functions for enum EFILTERACTIVE for ObjectDomainAPI_domainGetAutocompleteV2

static char* domainGetAutocompleteV2_EFILTERACTIVE_ToString(ezmax_api_definition__full_domainGetAutocompleteV2_eFilterActive_e EFILTERACTIVE){
    char *EFILTERACTIVEArray[] =  { "NULL", "All", "Active", "Inactive" };
    return EFILTERACTIVEArray[EFILTERACTIVE];
}

static ezmax_api_definition__full_domainGetAutocompleteV2_eFilterActive_e domainGetAutocompleteV2_EFILTERACTIVE_FromString(char* EFILTERACTIVE){
    int stringToReturn = 0;
    char *EFILTERACTIVEArray[] =  { "NULL", "All", "Active", "Inactive" };
...
/*
// Function domainGetAutocompleteV2_EFILTERACTIVE_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *domainGetAutocompleteV2_EFILTERACTIVE_convertToJSON(ezmax_api_definition__full_domainGetAutocompleteV2_eFilterActive_e EFILTERACTIVE) {
    cJSON *item = cJSON_CreateObject();
    if(cJSON_AddStringToObject(item, "eFilterActive", domainGetAutocompleteV2_EFILTERACTIVE_ToString(EFILTERACTIVE)) == NULL) {
        goto fail;
    }
    return item;
    fail:
...
// Function domainGetAutocompleteV2_EFILTERACTIVE_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_domainGetAutocompleteV2_eFilterActive_e domainGetAutocompleteV2_EFILTERACTIVE_parseFromJSON(cJSON* EFILTERACTIVEJSON) {
    ezmax_api_definition__full_domainGetAutocompleteV2_eFilterActive_e EFILTERACTIVEVariable = 0;
    ...
    EFILTERACTIVEVariable = domainGetAutocompleteV2_EFILTERACTIVE_FromString(EFILTERACTIVEVar->valuestring);
...
// Functions for enum  for ObjectDomainAPI_domainGetAutocompleteV2

static char* domainGetAutocompleteV2__ToString(ezmax_api_definition__full_domainGetAutocompleteV2_Accept-Language_e ){
    char *Array[] =  { "NULL", "*", "en", "fr" };
    return Array[];
}

static ezmax_api_definition__full_domainGetAutocompleteV2_Accept-Language_e domainGetAutocompleteV2__FromString(char* ){
    int stringToReturn = 0;
    char *Array[] =  { "NULL", "*", "en", "fr" };
...
/*
// Function domainGetAutocompleteV2__convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *domainGetAutocompleteV2__convertToJSON(ezmax_api_definition__full_domainGetAutocompleteV2_Accept-Language_e ) {
    cJSON *item = cJSON_CreateObject();
    return item;
    fail:
    cJSON_Delete(item);
...
// Function domainGetAutocompleteV2__parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_domainGetAutocompleteV2_Accept-Language_e domainGetAutocompleteV2__parseFromJSON(cJSON* JSON) {
    ezmax_api_definition__full_domainGetAutocompleteV2_Accept-Language_e Variable = 0;
    return Variable;
end:
    return 0;
}
...
ObjectDomainAPI_domainGetAutocompleteV2(apiClient_t *apiClient, ezmax_api_definition__full_domainGetAutocompleteV2_sSelector_e sSelector, ezmax_api_definition__full_domainGetAutocompleteV2_eFilterActive_e eFilterActive, char *sQuery, header_accept_language_e Accept_Language)
{
    ...
    // create the path
    char *localVarPath = strdup("/2/object/domain/getAutocomplete/{sSelector}");
    ...
    // Path Params
    long sizeOfPathParams_sSelector = strlen(domainGetAutocompleteV2_SSELECTOR_ToString(sSelector))+3 + sizeof("{ sSelector }") - 1;
    if(sSelector == 0) {
        goto end;
    }
    ...
    localVarPath = strReplace(localVarPath, localVarToReplace_sSelector, domainGetAutocompleteV2_SSELECTOR_ToString(sSelector));
    ...
    ezmax_api_definition__full_domainGetAutocompleteV2_eFilterActive_e valueQuery_eFilterActive ;
    ...
    if (eFilterActive)
    {
        ...
        keyPairQuery_eFilterActive = keyValuePair_create(keyQuery_eFilterActive, strdup(domainGetAutocompleteV2_EFILTERACTIVE_ToString(
    ...
    //}
    //nonprimitive not container
    domain_get_autocomplete_v2_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ObjectDomainAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = domain_get_autocomplete_v2_response_parseFromJSON(ObjectDomainAPIlocalVarJSON);
        cJSON_Delete(ObjectDomainAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
