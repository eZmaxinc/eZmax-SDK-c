...
// Functions for enum SSELECTOR for ObjectEzsigntsarequirementAPI_ezsigntsarequirementGetAutocompleteV1

static char* ezsigntsarequirementGetAutocompleteV1_SSELECTOR_ToString(ezmax_api_definition__full_ezsigntsarequirementGetAutocompleteV1_sSelector_e SSELECTOR){
    char *SSELECTORArray[] =  { "NULL", "User", "Usergroup" };
    return SSELECTORArray[SSELECTOR];
}

static ezmax_api_definition__full_ezsigntsarequirementGetAutocompleteV1_sSelector_e ezsigntsarequirementGetAutocompleteV1_SSELECTOR_FromString(char* SSELECTOR){
...
/*
// Function ezsigntsarequirementGetAutocompleteV1_SSELECTOR_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *ezsigntsarequirementGetAutocompleteV1_SSELECTOR_convertToJSON(ezmax_api_definition__full_ezsigntsarequirementGetAutocompleteV1_sSelector_e SSELECTOR) {
    cJSON *item = cJSON_CreateObject();
    if(cJSON_AddStringToObject(item, "sSelector", ezsigntsarequirementGetAutocompleteV1_SSELECTOR_ToString(SSELECTOR)) == NULL) {
        goto fail;
    }
    return item;
    fail:
...
// Function ezsigntsarequirementGetAutocompleteV1_SSELECTOR_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_ezsigntsarequirementGetAutocompleteV1_sSelector_e ezsigntsarequirementGetAutocompleteV1_SSELECTOR_parseFromJSON(cJSON* SSELECTORJSON) {
    ezmax_api_definition__full_ezsigntsarequirementGetAutocompleteV1_sSelector_e SSELECTORVariable = 0;
    ...
    SSELECTORVariable = ezsigntsarequirementGetAutocompleteV1_SSELECTOR_FromString(SSELECTORVar->valuestring);
...
// Functions for enum EFILTERACTIVE for ObjectEzsigntsarequirementAPI_ezsigntsarequirementGetAutocompleteV1

static char* ezsigntsarequirementGetAutocompleteV1_EFILTERACTIVE_ToString(ezmax_api_definition__full_ezsigntsarequirementGetAutocompleteV1_eFilterActive_e EFILTERACTIVE){
    char *EFILTERACTIVEArray[] =  { "NULL", "All", "Active", "Inactive" };
    return EFILTERACTIVEArray[EFILTERACTIVE];
}

static ezmax_api_definition__full_ezsigntsarequirementGetAutocompleteV1_eFilterActive_e ezsigntsarequirementGetAutocompleteV1_EFILTERACTIVE_FromString(char* EFILTERACTIVE){
    int stringToReturn = 0;
    char *EFILTERACTIVEArray[] =  { "NULL", "All", "Active", "Inactive" };
...
/*
// Function ezsigntsarequirementGetAutocompleteV1_EFILTERACTIVE_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *ezsigntsarequirementGetAutocompleteV1_EFILTERACTIVE_convertToJSON(ezmax_api_definition__full_ezsigntsarequirementGetAutocompleteV1_eFilterActive_e EFILTERACTIVE) {
    cJSON *item = cJSON_CreateObject();
    if(cJSON_AddStringToObject(item, "eFilterActive", ezsigntsarequirementGetAutocompleteV1_EFILTERACTIVE_ToString(EFILTERACTIVE)) == NULL) {
        goto fail;
    }
    return item;
    fail:
...
// Function ezsigntsarequirementGetAutocompleteV1_EFILTERACTIVE_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_ezsigntsarequirementGetAutocompleteV1_eFilterActive_e ezsigntsarequirementGetAutocompleteV1_EFILTERACTIVE_parseFromJSON(cJSON* EFILTERACTIVEJSON) {
    ezmax_api_definition__full_ezsigntsarequirementGetAutocompleteV1_eFilterActive_e EFILTERACTIVEVariable = 0;
    ...
    EFILTERACTIVEVariable = ezsigntsarequirementGetAutocompleteV1_EFILTERACTIVE_FromString(EFILTERACTIVEVar->valuestring);
...
// Functions for enum  for ObjectEzsigntsarequirementAPI_ezsigntsarequirementGetAutocompleteV1

static char* ezsigntsarequirementGetAutocompleteV1__ToString(ezmax_api_definition__full_ezsigntsarequirementGetAutocompleteV1_Accept-Language_e ){
    char *Array[] =  { "NULL", "*", "en", "fr" };
    return Array[];
}

static ezmax_api_definition__full_ezsigntsarequirementGetAutocompleteV1_Accept-Language_e ezsigntsarequirementGetAutocompleteV1__FromString(char* ){
    int stringToReturn = 0;
    char *Array[] =  { "NULL", "*", "en", "fr" };
...
/*
// Function ezsigntsarequirementGetAutocompleteV1__convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *ezsigntsarequirementGetAutocompleteV1__convertToJSON(ezmax_api_definition__full_ezsigntsarequirementGetAutocompleteV1_Accept-Language_e ) {
    cJSON *item = cJSON_CreateObject();
    return item;
    fail:
    cJSON_Delete(item);
...
// Function ezsigntsarequirementGetAutocompleteV1__parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_ezsigntsarequirementGetAutocompleteV1_Accept-Language_e ezsigntsarequirementGetAutocompleteV1__parseFromJSON(cJSON* JSON) {
    ezmax_api_definition__full_ezsigntsarequirementGetAutocompleteV1_Accept-Language_e Variable = 0;
    return Variable;
end:
    return 0;
}
...
ObjectEzsigntsarequirementAPI_ezsigntsarequirementGetAutocompleteV1(apiClient_t *apiClient, ezmax_api_definition__full_ezsigntsarequirementGetAutocompleteV1_sSelector_e sSelector , int fkiEzsignfoldertypeID , ezmax_api_definition__full_ezsigntsarequirementGetAutocompleteV1_eFilterActive_e eFilterActive , char * sQuery , header_accept_language_e Accept_Language )
{
    ...
    // create the path
    long sizeOfPath = strlen("/1/object/ezsigntsarequirement/getAutocomplete/{sSelector}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/1/object/ezsigntsarequirement/getAutocomplete/{sSelector}");
    ...
    ezmax_api_definition__full_ezsigntsarequirementGetAutocompleteV1_eFilterActive_e valueQuery_eFilterActive ;
    ...
    if (eFilterActive)
    {
        ...
        keyPairQuery_eFilterActive = keyValuePair_create(keyQuery_eFilterActive, (void *)strdup(ezsigntsarequirementGetAutocompleteV1_EFILTERACTIVE_ToString(
    ...
    common_get_autocomplete_disabled_v1_response_t *elementToReturn = common_get_autocomplete_disabled_v1_response_parseFromJSON(ObjectEzsigntsarequirementAPIlocalVarJSON);
...
ObjectEzsigntsarequirementAPI_ezsigntsarequirementGetAutocompleteV2(apiClient_t *apiClient, ezmax_api_definition__full_ezsigntsarequirementGetAutocompleteV2_sSelector_e sSelector , int fkiEzsignfoldertypeID , ezmax_api_definition__full_ezsigntsarequirementGetAutocompleteV2_eFilterActive_e eFilterActive , char * sQuery , header_accept_language_e Accept_Language )
{
    ...
    // create the path
    long sizeOfPath = strlen("/2/object/ezsigntsarequirement/getAutocomplete/{sSelector}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/2/object/ezsigntsarequirement/getAutocomplete/{sSelector}");
    ...
    //nonprimitive not container
    cJSON *ObjectEzsigntsarequirementAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    ezsigntsarequirement_get_autocomplete_v2_response_t *elementToReturn = ezsigntsarequirement_get_autocomplete_v2_response_parseFromJSON(ObjectEzsigntsarequirementAPIlocalVarJSON);
    cJSON_Delete(ObjectEzsigntsarequirementAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
