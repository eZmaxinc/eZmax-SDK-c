...
static char* paymenttermGetAutocompleteV2_SSELECTOR_ToString(ezmax_api_definition__full_paymenttermGetAutocompleteV2_sSelector_e SSELECTOR){
    char *SSELECTORArray[] =  { "NULL", "All" };
    return SSELECTORArray[SSELECTOR];
}

static ezmax_api_definition__full_paymenttermGetAutocompleteV2_sSelector_e paymenttermGetAutocompleteV2_SSELECTOR_FromString(char* SSELECTOR){
...
/*
// Function paymenttermGetAutocompleteV2_SSELECTOR_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *paymenttermGetAutocompleteV2_SSELECTOR_convertToJSON(ezmax_api_definition__full_paymenttermGetAutocompleteV2_sSelector_e SSELECTOR) {
    cJSON *item = cJSON_CreateObject();
    if(cJSON_AddStringToObject(item, "sSelector", paymenttermGetAutocompleteV2_SSELECTOR_ToString(SSELECTOR)) == NULL) {
        goto fail;
    }
    return item;
    fail:
...
// Function paymenttermGetAutocompleteV2_SSELECTOR_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_paymenttermGetAutocompleteV2_sSelector_e paymenttermGetAutocompleteV2_SSELECTOR_parseFromJSON(cJSON* SSELECTORJSON) {
    ezmax_api_definition__full_paymenttermGetAutocompleteV2_sSelector_e SSELECTORVariable = 0;
    ...
    SSELECTORVariable = paymenttermGetAutocompleteV2_SSELECTOR_FromString(SSELECTORVar->valuestring);
...
// Functions for enum EFILTERACTIVE for ObjectPaymenttermAPI_paymenttermGetAutocompleteV2

static char* paymenttermGetAutocompleteV2_EFILTERACTIVE_ToString(ezmax_api_definition__full_paymenttermGetAutocompleteV2_eFilterActive_e EFILTERACTIVE){
    char *EFILTERACTIVEArray[] =  { "NULL", "All", "Active", "Inactive" };
    return EFILTERACTIVEArray[EFILTERACTIVE];
}

static ezmax_api_definition__full_paymenttermGetAutocompleteV2_eFilterActive_e paymenttermGetAutocompleteV2_EFILTERACTIVE_FromString(char* EFILTERACTIVE){
    int stringToReturn = 0;
    char *EFILTERACTIVEArray[] =  { "NULL", "All", "Active", "Inactive" };
...
/*
// Function paymenttermGetAutocompleteV2_EFILTERACTIVE_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *paymenttermGetAutocompleteV2_EFILTERACTIVE_convertToJSON(ezmax_api_definition__full_paymenttermGetAutocompleteV2_eFilterActive_e EFILTERACTIVE) {
    cJSON *item = cJSON_CreateObject();
    if(cJSON_AddStringToObject(item, "eFilterActive", paymenttermGetAutocompleteV2_EFILTERACTIVE_ToString(EFILTERACTIVE)) == NULL) {
        goto fail;
    }
    return item;
    fail:
...
// Function paymenttermGetAutocompleteV2_EFILTERACTIVE_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_paymenttermGetAutocompleteV2_eFilterActive_e paymenttermGetAutocompleteV2_EFILTERACTIVE_parseFromJSON(cJSON* EFILTERACTIVEJSON) {
    ezmax_api_definition__full_paymenttermGetAutocompleteV2_eFilterActive_e EFILTERACTIVEVariable = 0;
    ...
    EFILTERACTIVEVariable = paymenttermGetAutocompleteV2_EFILTERACTIVE_FromString(EFILTERACTIVEVar->valuestring);
...
// Functions for enum  for ObjectPaymenttermAPI_paymenttermGetAutocompleteV2

static char* paymenttermGetAutocompleteV2__ToString(ezmax_api_definition__full_paymenttermGetAutocompleteV2_Accept-Language_e ){
    char *Array[] =  { "NULL", "*", "en", "fr" };
    return Array[];
}

static ezmax_api_definition__full_paymenttermGetAutocompleteV2_Accept-Language_e paymenttermGetAutocompleteV2__FromString(char* ){
    int stringToReturn = 0;
    char *Array[] =  { "NULL", "*", "en", "fr" };
...
/*
// Function paymenttermGetAutocompleteV2__convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *paymenttermGetAutocompleteV2__convertToJSON(ezmax_api_definition__full_paymenttermGetAutocompleteV2_Accept-Language_e ) {
    cJSON *item = cJSON_CreateObject();
    return item;
    fail:
    cJSON_Delete(item);
...
// Function paymenttermGetAutocompleteV2__parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_paymenttermGetAutocompleteV2_Accept-Language_e paymenttermGetAutocompleteV2__parseFromJSON(cJSON* JSON) {
    ezmax_api_definition__full_paymenttermGetAutocompleteV2_Accept-Language_e Variable = 0;
    return Variable;
end:
    return 0;
}
...
/*
// Function paymenttermGetListV1_EORDERBY_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *paymenttermGetListV1_EORDERBY_convertToJSON(ezmax_api_definition__full_paymenttermGetListV1_eOrderBy_e EORDERBY) {
    cJSON *item = cJSON_CreateObject();
    if(cJSON_AddStringToObject(item, "eOrderBy", paymenttermGetListV1_EORDERBY_ToString(EORDERBY)) == NULL) {
        goto fail;
    }
    return item;
    fail:
...
// Function paymenttermGetListV1_EORDERBY_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_paymenttermGetListV1_eOrderBy_e paymenttermGetListV1_EORDERBY_parseFromJSON(cJSON* EORDERBYJSON) {
    ezmax_api_definition__full_paymenttermGetListV1_eOrderBy_e EORDERBYVariable = 0;
    ...
    EORDERBYVariable = paymenttermGetListV1_EORDERBY_FromString(EORDERBYVar->valuestring);
...
// Functions for enum  for ObjectPaymenttermAPI_paymenttermGetListV1

static char* paymenttermGetListV1__ToString(ezmax_api_definition__full_paymenttermGetListV1_Accept-Language_e ){
    char *Array[] =  { "NULL", "*", "en", "fr" };
    return Array[];
}

static ezmax_api_definition__full_paymenttermGetListV1_Accept-Language_e paymenttermGetListV1__FromString(char* ){
    int stringToReturn = 0;
    char *Array[] =  { "NULL", "*", "en", "fr" };
    size_t sizeofArray = sizeof(Array) / sizeof(Array[0]);
    while(stringToReturn < sizeofArray) {
...
/*
// Function paymenttermGetListV1__convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *paymenttermGetListV1__convertToJSON(ezmax_api_definition__full_paymenttermGetListV1_Accept-Language_e ) {
    cJSON *item = cJSON_CreateObject();
    return item;
    fail:
    cJSON_Delete(item);
...
// Function paymenttermGetListV1__parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_paymenttermGetListV1_Accept-Language_e paymenttermGetListV1__parseFromJSON(cJSON* JSON) {
    ezmax_api_definition__full_paymenttermGetListV1_Accept-Language_e Variable = 0;
    return Variable;
end:
    return 0;
}
...
ObjectPaymenttermAPI_paymenttermCreateObjectV1(apiClient_t *apiClient, paymentterm_create_object_v1_request_t * paymentterm_create_object_v1_request )
{
    ...
    free(localVarPath);
    if (localVarSingleItemJSON_paymentterm_create_object_v1_request) {
        cJSON_Delete(localVarSingleItemJSON_paymentterm_create_object_v1_request);
        localVarSingleItemJSON_paymentterm_create_object_v1_request = NULL;
    }
...
ObjectPaymenttermAPI_paymenttermDeleteObjectV1(apiClient_t *apiClient, int pkiPaymenttermID )
{
    ...
    char* localVarToReplace_pkiPaymenttermID = malloc(sizeOfPathParams_pkiPaymenttermID);
    ...
    //nonprimitive not container
    cJSON *ObjectPaymenttermAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    paymentterm_delete_object_v1_response_t *elementToReturn = paymentterm_delete_object_v1_response_parseFromJSON(ObjectPaymenttermAPIlocalVarJSON);
    cJSON_Delete(ObjectPaymenttermAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(localVarPath);
    free(localVarToReplace_pkiPaymenttermID);
    return elementToReturn;
end:
    free(localVarPath);
    return NULL;
...
ObjectPaymenttermAPI_paymenttermEditObjectV1(apiClient_t *apiClient, int pkiPaymenttermID , paymentterm_edit_object_v1_request_t * paymentterm_edit_object_v1_request )
{
    ...
    free(localVarPath);
    free(localVarToReplace_pkiPaymenttermID);
    if (localVarSingleItemJSON_paymentterm_edit_object_v1_request) {
        cJSON_Delete(localVarSingleItemJSON_paymentterm_edit_object_v1_request);
        localVarSingleItemJSON_paymentterm_edit_object_v1_request = NULL;
    }
    free(localVarBodyParameters);
    return elementToReturn;
end:
...
ObjectPaymenttermAPI_paymenttermGetAutocompleteV2(apiClient_t *apiClient, ezmax_api_definition__full_paymenttermGetAutocompleteV2_sSelector_e sSelector , ezmax_api_definition__full_paymenttermGetAutocompleteV2_eFilterActive_e eFilterActive , char * sQuery , header_accept_language_e Accept_Language )
{
    ...
    ezmax_api_definition__full_paymenttermGetAutocompleteV2_eFilterActive_e valueQuery_eFilterActive ;
...
ObjectPaymenttermAPI_paymenttermGetListV1(apiClient_t *apiClient, ezmax_api_definition__full_paymenttermGetListV1_eOrderBy_e eOrderBy , int iRowMax , int iRowOffset , header_accept_language_e Accept_Language , char * sFilter )
{
    ...
    ezmax_api_definition__full_paymenttermGetListV1_eOrderBy_e valueQuery_eOrderBy ;
