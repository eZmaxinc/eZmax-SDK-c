...
ObjectEmployeeAPI_employeeBatchDownloadV1(apiClient_t *apiClient, int *pkiEmployeeID, employee_batch_download_v1_request_t *employee_batch_download_v1_request)
{
    ...
    // create the path
    char *localVarPath = strdup("/1/object/employee/{pkiEmployeeID}/batchDownload");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_employee_batch_download_v1_request = NULL;
    if (employee_batch_download_v1_request != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_employee_batch_download_v1_request = employee_batch_download_v1_request_convertToJSON(employee_batch_download_v1_request);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_employee_batch_download_v1_request);
    ...
    if (localVarSingleItemJSON_employee_batch_download_v1_request) {
        cJSON_Delete(localVarSingleItemJSON_employee_batch_download_v1_request);
        localVarSingleItemJSON_employee_batch_download_v1_request = NULL;
    }
...
ObjectEmployeeAPI_employeeGetAttachmentsV1(apiClient_t *apiClient, int *pkiEmployeeID)
{
    ...
    // create the path
    char *localVarPath = strdup("/1/object/employee/{pkiEmployeeID}/getAttachments");
    ...
    employee_get_attachments_v1_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ObjectEmployeeAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = employee_get_attachments_v1_response_parseFromJSON(ObjectEmployeeAPIlocalVarJSON);
