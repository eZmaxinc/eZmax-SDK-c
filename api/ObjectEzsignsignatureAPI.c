...
ObjectEzsignsignatureAPI_ezsignsignatureGetChildrenV1(apiClient_t *apiClient, int pkiEzsignsignatureID )
{
    ...
    // create the path
    long sizeOfPath = strlen("/1/object/ezsignsignature/{pkiEzsignsignatureID}/getChildren")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/1/object/ezsignsignature/{pkiEzsignsignatureID}/getChildren");
