...
ObjectNotificationtestAPI_notificationtestGetElementsV2(apiClient_t *apiClient, int *pkiNotificationtestID)
{
    ...
    // create the path
    char *localVarPath = strdup("/2/object/notificationtest/{pkiNotificationtestID}/getElements");
    ...
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        ...
        elementToReturn = notificationtest_get_elements_v2_response_parseFromJSON(ObjectNotificationtestAPIlocalVarJSON);
