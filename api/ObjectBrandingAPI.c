...
// Functions for enum SSELECTOR for ObjectBrandingAPI_brandingGetAutocompleteV1

static char* brandingGetAutocompleteV1_SSELECTOR_ToString(ezmax_api_definition__full_brandingGetAutocompleteV1_sSelector_e SSELECTOR){
    char *SSELECTORArray[] =  { "NULL", "All" };
    return SSELECTORArray[SSELECTOR];
}

static ezmax_api_definition__full_brandingGetAutocompleteV1_sSelector_e brandingGetAutocompleteV1_SSELECTOR_FromString(char* SSELECTOR){
...
/*
// Function brandingGetAutocompleteV1_SSELECTOR_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *brandingGetAutocompleteV1_SSELECTOR_convertToJSON(ezmax_api_definition__full_brandingGetAutocompleteV1_sSelector_e SSELECTOR) {
    cJSON *item = cJSON_CreateObject();
    if(cJSON_AddStringToObject(item, "sSelector", brandingGetAutocompleteV1_SSELECTOR_ToString(SSELECTOR)) == NULL) {
        goto fail;
    }
    return item;
    fail:
...
// Function brandingGetAutocompleteV1_SSELECTOR_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_brandingGetAutocompleteV1_sSelector_e brandingGetAutocompleteV1_SSELECTOR_parseFromJSON(cJSON* SSELECTORJSON) {
    ezmax_api_definition__full_brandingGetAutocompleteV1_sSelector_e SSELECTORVariable = 0;
    ...
    SSELECTORVariable = brandingGetAutocompleteV1_SSELECTOR_FromString(SSELECTORVar->valuestring);
...
// Functions for enum EFILTERACTIVE for ObjectBrandingAPI_brandingGetAutocompleteV1

static char* brandingGetAutocompleteV1_EFILTERACTIVE_ToString(ezmax_api_definition__full_brandingGetAutocompleteV1_eFilterActive_e EFILTERACTIVE){
    char *EFILTERACTIVEArray[] =  { "NULL", "All", "Active", "Inactive" };
    return EFILTERACTIVEArray[EFILTERACTIVE];
}

static ezmax_api_definition__full_brandingGetAutocompleteV1_eFilterActive_e brandingGetAutocompleteV1_EFILTERACTIVE_FromString(char* EFILTERACTIVE){
    int stringToReturn = 0;
    char *EFILTERACTIVEArray[] =  { "NULL", "All", "Active", "Inactive" };
...
/*
// Function brandingGetAutocompleteV1_EFILTERACTIVE_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *brandingGetAutocompleteV1_EFILTERACTIVE_convertToJSON(ezmax_api_definition__full_brandingGetAutocompleteV1_eFilterActive_e EFILTERACTIVE) {
    cJSON *item = cJSON_CreateObject();
    if(cJSON_AddStringToObject(item, "eFilterActive", brandingGetAutocompleteV1_EFILTERACTIVE_ToString(EFILTERACTIVE)) == NULL) {
        goto fail;
    }
    return item;
    fail:
...
// Function brandingGetAutocompleteV1_EFILTERACTIVE_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_brandingGetAutocompleteV1_eFilterActive_e brandingGetAutocompleteV1_EFILTERACTIVE_parseFromJSON(cJSON* EFILTERACTIVEJSON) {
    ezmax_api_definition__full_brandingGetAutocompleteV1_eFilterActive_e EFILTERACTIVEVariable = 0;
    ...
    EFILTERACTIVEVariable = brandingGetAutocompleteV1_EFILTERACTIVE_FromString(EFILTERACTIVEVar->valuestring);
...
// Functions for enum  for ObjectBrandingAPI_brandingGetAutocompleteV1

static char* brandingGetAutocompleteV1__ToString(ezmax_api_definition__full_brandingGetAutocompleteV1_Accept-Language_e ){
    char *Array[] =  { "NULL", "*", "en", "fr" };
    return Array[];
}

static ezmax_api_definition__full_brandingGetAutocompleteV1_Accept-Language_e brandingGetAutocompleteV1__FromString(char* ){
    int stringToReturn = 0;
    char *Array[] =  { "NULL", "*", "en", "fr" };
...
/*
// Function brandingGetAutocompleteV1__convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *brandingGetAutocompleteV1__convertToJSON(ezmax_api_definition__full_brandingGetAutocompleteV1_Accept-Language_e ) {
    cJSON *item = cJSON_CreateObject();
    return item;
    fail:
    cJSON_Delete(item);
...
// Function brandingGetAutocompleteV1__parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_brandingGetAutocompleteV1_Accept-Language_e brandingGetAutocompleteV1__parseFromJSON(cJSON* JSON) {
    ezmax_api_definition__full_brandingGetAutocompleteV1_Accept-Language_e Variable = 0;
    return Variable;
end:
    return 0;
}
...
ObjectBrandingAPI_brandingGetAutocompleteV1(apiClient_t *apiClient, ezmax_api_definition__full_brandingGetAutocompleteV1_sSelector_e sSelector , ezmax_api_definition__full_brandingGetAutocompleteV1_eFilterActive_e eFilterActive , char * sQuery , header_accept_language_e Accept_Language )
{
    ...
    // create the path
    long sizeOfPath = strlen("/1/object/branding/getAutocomplete/{sSelector}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/1/object/branding/getAutocomplete/{sSelector}");
    ...
    ezmax_api_definition__full_brandingGetAutocompleteV1_eFilterActive_e valueQuery_eFilterActive ;
    ...
    if (eFilterActive)
    {
        ...
        keyPairQuery_eFilterActive = keyValuePair_create(keyQuery_eFilterActive, (void *)strdup(brandingGetAutocompleteV1_EFILTERACTIVE_ToString(
    ...
    //nonprimitive not container
    cJSON *ObjectBrandingAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    common_get_autocomplete_v1_response_t *elementToReturn = common_get_autocomplete_v1_response_parseFromJSON(ObjectBrandingAPIlocalVarJSON);
    cJSON_Delete(ObjectBrandingAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ObjectBrandingAPI_brandingGetObjectV1(apiClient_t *apiClient, int pkiBrandingID )
{
    ...
    //nonprimitive not container
    cJSON *ObjectBrandingAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    branding_get_object_v1_response_t *elementToReturn = branding_get_object_v1_response_parseFromJSON(ObjectBrandingAPIlocalVarJSON);
    cJSON_Delete(ObjectBrandingAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
