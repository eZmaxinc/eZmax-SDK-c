...
ObjectWebhookAPI_webhookCreateObjectV1(apiClient_t *apiClient, webhook_create_object_v1_request_t * webhook_create_object_v1_request )
{
    ...
    // create the path
    long sizeOfPath = strlen("/1/object/webhook")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/1/object/webhook");




    // Body Param
    cJSON *localVarSingleItemJSON_webhook_create_object_v1_request = NULL;
    if (webhook_create_object_v1_request != NULL)
    {
        //string
        localVarSingleItemJSON_webhook_create_object_v1_request = webhook_create_object_v1_request_convertToJSON(webhook_create_object_v1_request);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_webhook_create_object_v1_request);
    }
    ...
    webhook_create_object_v1_response_t *elementToReturn = webhook_create_object_v1_response_parseFromJSON(ObjectWebhookAPIlocalVarJSON);
    ...
    free(localVarPath);
    if (localVarSingleItemJSON_webhook_create_object_v1_request) {
        cJSON_Delete(localVarSingleItemJSON_webhook_create_object_v1_request);
        localVarSingleItemJSON_webhook_create_object_v1_request = NULL;
    }
...
ObjectWebhookAPI_webhookGetObjectV1(apiClient_t *apiClient, int pkiWebhookID )
{
    ...
    //nonprimitive not container
    cJSON *ObjectWebhookAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    webhook_get_object_v1_response_t *elementToReturn = webhook_get_object_v1_response_parseFromJSON(ObjectWebhookAPIlocalVarJSON);
    cJSON_Delete(ObjectWebhookAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
