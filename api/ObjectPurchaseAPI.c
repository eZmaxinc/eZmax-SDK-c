...
// Functions for enum EORDERBY for ObjectPurchaseAPI_purchaseGetListV1

static char* purchaseGetListV1_EORDERBY_ToString(ezmax_api_definition__full_purchaseGetListV1_eOrderBy_e EORDERBY){
    char *EORDERBYArray[] =  { "NULL", "pkiPurchaseID_ASC", "pkiPurchaseID_DESC", "fkiFranchiseofficeID_ASC", "fkiFranchiseofficeID_DESC", "fkiSupplierID_ASC", "fkiSupplierID_DESC", "fkiPeriodID_ASC", "fkiPeriodID_DESC", "sPurchaseBillnumber_ASC", "sPurchaseBillnumber_DESC", "dtPurchaseDate_ASC", "dtPurchaseDate_DESC", "dtPurchasePaydate_ASC", "dtPurchasePaydate_DESC", "dPurchaseTotal_ASC", "dPurchaseTotal_DESC", "bPurchaseIsfinanced_ASC", "bPurchaseIsfinanced_DESC", "bPurchaseIspaid_ASC", "bPurchaseIspaid_DESC", "sFranchiseagenceName_ASC", "sFranchiseagenceName_DESC", "iFranchiseofficeCode_ASC", "iFranchiseofficeCode_DESC", "sSupplierName_ASC", "sSupplierName_DESC" };
    return EORDERBYArray[EORDERBY];
}

static ezmax_api_definition__full_purchaseGetListV1_eOrderBy_e purchaseGetListV1_EORDERBY_FromString(char* EORDERBY){
...
/*
// Function purchaseGetListV1_EORDERBY_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *purchaseGetListV1_EORDERBY_convertToJSON(ezmax_api_definition__full_purchaseGetListV1_eOrderBy_e EORDERBY) {
    cJSON *item = cJSON_CreateObject();
    if(cJSON_AddStringToObject(item, "eOrderBy", purchaseGetListV1_EORDERBY_ToString(EORDERBY)) == NULL) {
        goto fail;
    }
    return item;
    fail:
...
// Function purchaseGetListV1_EORDERBY_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_purchaseGetListV1_eOrderBy_e purchaseGetListV1_EORDERBY_parseFromJSON(cJSON* EORDERBYJSON) {
    ezmax_api_definition__full_purchaseGetListV1_eOrderBy_e EORDERBYVariable = 0;
    ...
    EORDERBYVariable = purchaseGetListV1_EORDERBY_FromString(EORDERBYVar->valuestring);
...
// Functions for enum  for ObjectPurchaseAPI_purchaseGetListV1

static char* purchaseGetListV1__ToString(ezmax_api_definition__full_purchaseGetListV1_Accept-Language_e ){
    char *Array[] =  { "NULL", "*", "en", "fr" };
    return Array[];
}

static ezmax_api_definition__full_purchaseGetListV1_Accept-Language_e purchaseGetListV1__FromString(char* ){
    int stringToReturn = 0;
    char *Array[] =  { "NULL", "*", "en", "fr" };
...
/*
// Function purchaseGetListV1__convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *purchaseGetListV1__convertToJSON(ezmax_api_definition__full_purchaseGetListV1_Accept-Language_e ) {
    cJSON *item = cJSON_CreateObject();
    return item;
    fail:
    cJSON_Delete(item);
...
// Function purchaseGetListV1__parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_purchaseGetListV1_Accept-Language_e purchaseGetListV1__parseFromJSON(cJSON* JSON) {
    ezmax_api_definition__full_purchaseGetListV1_Accept-Language_e Variable = 0;
    return Variable;
end:
    return 0;
}
...
ObjectPurchaseAPI_purchaseGetListV1(apiClient_t *apiClient, ezmax_api_definition__full_purchaseGetListV1_eOrderBy_e eOrderBy, int *iRowMax, int *iRowOffset, header_accept_language_e Accept_Language, char *sFilter)
{
    ...
    // create the path
    char *localVarPath = strdup("/1/object/purchase/getList");
    ...
    ezmax_api_definition__full_purchaseGetListV1_eOrderBy_e valueQuery_eOrderBy ;
    keyValuePair_t *keyPairQuery_eOrderBy = 0;
    if (eOrderBy)
    {
        keyQuery_eOrderBy = strdup("eOrderBy");
        valueQuery_eOrderBy = (eOrderBy);
        keyPairQuery_eOrderBy = keyValuePair_create(keyQuery_eOrderBy, strdup(purchaseGetListV1_EORDERBY_ToString(
        valueQuery_eOrderBy)));
    ...
    //}
    //nonprimitive not container
    purchase_get_list_v1_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ObjectPurchaseAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = purchase_get_list_v1_response_parseFromJSON(ObjectPurchaseAPIlocalVarJSON);
        cJSON_Delete(ObjectPurchaseAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
