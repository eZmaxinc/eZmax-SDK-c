...
typedef enum  { ezmax_api_definition_ezsignfoldertypeGetListV1_EORDERBY_NULL = 0, ezmax_api_definition_ezsignfoldertypeGetListV1_EORDERBY_sEzsignfoldertypeNameX, ezmax_api_definition_ezsignfoldertypeGetListV1_EORDERBY_sEzsignfoldertypeNameX desc } ezmax_api_definition_ezsignfoldertypeGetListV1_eOrderBy_e;
