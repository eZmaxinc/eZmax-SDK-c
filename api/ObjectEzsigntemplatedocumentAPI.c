...
ObjectEzsigntemplatedocumentAPI_ezsigntemplatedocumentGetObjectV1(apiClient_t *apiClient, int pkiEzsigntemplatedocumentID )
{
    ...
    //nonprimitive not container
    cJSON *ObjectEzsigntemplatedocumentAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    ezsigntemplatedocument_get_object_v1_response_t *elementToReturn = ezsigntemplatedocument_get_object_v1_response_parseFromJSON(ObjectEzsigntemplatedocumentAPIlocalVarJSON);
    cJSON_Delete(ObjectEzsigntemplatedocumentAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
