...
ObjectEzsigntemplatepackagesignermembershipAPI_ezsigntemplatepackagesignermembershipGetObjectV1(apiClient_t *apiClient, int pkiEzsigntemplatepackagesignermembershipID )
{
    ...
    //nonprimitive not container
    cJSON *ObjectEzsigntemplatepackagesignermembershipAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    ezsigntemplatepackagesignermembership_get_object_v1_response_t *elementToReturn = ezsigntemplatepackagesignermembership_get_object_v1_response_parseFromJSON(ObjectEzsigntemplatepackagesignermembershipAPIlocalVarJSON);
    cJSON_Delete(ObjectEzsigntemplatepackagesignermembershipAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
