...
ObjectEzsigntemplateformfieldgroupAPI_ezsigntemplateformfieldgroupGetObjectV1(apiClient_t *apiClient, int pkiEzsigntemplateformfieldgroupID )
{
    ...
    //nonprimitive not container
    cJSON *ObjectEzsigntemplateformfieldgroupAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    ezsigntemplateformfieldgroup_get_object_v1_response_t *elementToReturn = ezsigntemplateformfieldgroup_get_object_v1_response_parseFromJSON(ObjectEzsigntemplateformfieldgroupAPIlocalVarJSON);
    cJSON_Delete(ObjectEzsigntemplateformfieldgroupAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
