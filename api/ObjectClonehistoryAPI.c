...
/*
// Function clonehistoryGetListV1_EORDERBY_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *clonehistoryGetListV1_EORDERBY_convertToJSON(ezmax_api_definition__full_clonehistoryGetListV1_eOrderBy_e EORDERBY) {
    cJSON *item = cJSON_CreateObject();
    if(cJSON_AddStringToObject(item, "eOrderBy", clonehistoryGetListV1_EORDERBY_ToString(EORDERBY)) == NULL) {
        goto fail;
    }
    return item;
    fail:
...
// Function clonehistoryGetListV1_EORDERBY_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_clonehistoryGetListV1_eOrderBy_e clonehistoryGetListV1_EORDERBY_parseFromJSON(cJSON* EORDERBYJSON) {
    ezmax_api_definition__full_clonehistoryGetListV1_eOrderBy_e EORDERBYVariable = 0;
    ...
    EORDERBYVariable = clonehistoryGetListV1_EORDERBY_FromString(EORDERBYVar->valuestring);
...
// Functions for enum  for ObjectClonehistoryAPI_clonehistoryGetListV1

static char* clonehistoryGetListV1__ToString(ezmax_api_definition__full_clonehistoryGetListV1_Accept-Language_e ){
    char *Array[] =  { "NULL", "*", "en", "fr" };
    return Array[];
}

static ezmax_api_definition__full_clonehistoryGetListV1_Accept-Language_e clonehistoryGetListV1__FromString(char* ){
    int stringToReturn = 0;
    char *Array[] =  { "NULL", "*", "en", "fr" };
...
/*
// Function clonehistoryGetListV1__convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *clonehistoryGetListV1__convertToJSON(ezmax_api_definition__full_clonehistoryGetListV1_Accept-Language_e ) {
    cJSON *item = cJSON_CreateObject();
    return item;
    fail:
    cJSON_Delete(item);
...
// Function clonehistoryGetListV1__parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_clonehistoryGetListV1_Accept-Language_e clonehistoryGetListV1__parseFromJSON(cJSON* JSON) {
    ezmax_api_definition__full_clonehistoryGetListV1_Accept-Language_e Variable = 0;
    return Variable;
end:
    return 0;
}
...
ObjectClonehistoryAPI_clonehistoryGetListV1(apiClient_t *apiClient, ezmax_api_definition__full_clonehistoryGetListV1_eOrderBy_e eOrderBy , int iRowMax , int iRowOffset , header_accept_language_e Accept_Language , char * sFilter )
{
    ...
    ezmax_api_definition__full_clonehistoryGetListV1_eOrderBy_e valueQuery_eOrderBy ;
