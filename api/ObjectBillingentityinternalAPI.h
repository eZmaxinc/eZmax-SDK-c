...
// Enum EFILTERACTIVE for ObjectBillingentityinternalAPI_billingentityinternalGetAutocompleteV1
typedef enum  { ezmax_api_definition__full_billingentityinternalGetAutocompleteV1_EFILTERACTIVE_NULL = 0, ezmax_api_definition__full_billingentityinternalGetAutocompleteV1_EFILTERACTIVE_All, ezmax_api_definition__full_billingentityinternalGetAutocompleteV1_EFILTERACTIVE_Active, ezmax_api_definition__full_billingentityinternalGetAutocompleteV1_EFILTERACTIVE_Inactive } ezmax_api_definition__full_billingentityinternalGetAutocompleteV1_eFilterActive_e;
