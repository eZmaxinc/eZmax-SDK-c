...
// Functions for enum SSELECTOR for ObjectAgentAPI_agentGetAutocompleteV2

static char* agentGetAutocompleteV2_SSELECTOR_ToString(ezmax_api_definition__full_agentGetAutocompleteV2_sSelector_e SSELECTOR){
    char *SSELECTORArray[] =  { "NULL", "All" };
    return SSELECTORArray[SSELECTOR];
}

static ezmax_api_definition__full_agentGetAutocompleteV2_sSelector_e agentGetAutocompleteV2_SSELECTOR_FromString(char* SSELECTOR){
...
/*
// Function agentGetAutocompleteV2_SSELECTOR_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *agentGetAutocompleteV2_SSELECTOR_convertToJSON(ezmax_api_definition__full_agentGetAutocompleteV2_sSelector_e SSELECTOR) {
    cJSON *item = cJSON_CreateObject();
    if(cJSON_AddStringToObject(item, "sSelector", agentGetAutocompleteV2_SSELECTOR_ToString(SSELECTOR)) == NULL) {
        goto fail;
    }
    return item;
    fail:
...
// Function agentGetAutocompleteV2_SSELECTOR_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_agentGetAutocompleteV2_sSelector_e agentGetAutocompleteV2_SSELECTOR_parseFromJSON(cJSON* SSELECTORJSON) {
    ezmax_api_definition__full_agentGetAutocompleteV2_sSelector_e SSELECTORVariable = 0;
    ...
    SSELECTORVariable = agentGetAutocompleteV2_SSELECTOR_FromString(SSELECTORVar->valuestring);
...
// Functions for enum EFILTERACTIVE for ObjectAgentAPI_agentGetAutocompleteV2

static char* agentGetAutocompleteV2_EFILTERACTIVE_ToString(ezmax_api_definition__full_agentGetAutocompleteV2_eFilterActive_e EFILTERACTIVE){
    char *EFILTERACTIVEArray[] =  { "NULL", "All", "Active", "Inactive" };
    return EFILTERACTIVEArray[EFILTERACTIVE];
}

static ezmax_api_definition__full_agentGetAutocompleteV2_eFilterActive_e agentGetAutocompleteV2_EFILTERACTIVE_FromString(char* EFILTERACTIVE){
    int stringToReturn = 0;
    char *EFILTERACTIVEArray[] =  { "NULL", "All", "Active", "Inactive" };
...
/*
// Function agentGetAutocompleteV2_EFILTERACTIVE_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *agentGetAutocompleteV2_EFILTERACTIVE_convertToJSON(ezmax_api_definition__full_agentGetAutocompleteV2_eFilterActive_e EFILTERACTIVE) {
    cJSON *item = cJSON_CreateObject();
    if(cJSON_AddStringToObject(item, "eFilterActive", agentGetAutocompleteV2_EFILTERACTIVE_ToString(EFILTERACTIVE)) == NULL) {
        goto fail;
    }
    return item;
    fail:
...
// Function agentGetAutocompleteV2_EFILTERACTIVE_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_agentGetAutocompleteV2_eFilterActive_e agentGetAutocompleteV2_EFILTERACTIVE_parseFromJSON(cJSON* EFILTERACTIVEJSON) {
    ezmax_api_definition__full_agentGetAutocompleteV2_eFilterActive_e EFILTERACTIVEVariable = 0;
    ...
    EFILTERACTIVEVariable = agentGetAutocompleteV2_EFILTERACTIVE_FromString(EFILTERACTIVEVar->valuestring);
...
// Functions for enum  for ObjectAgentAPI_agentGetAutocompleteV2

static char* agentGetAutocompleteV2__ToString(ezmax_api_definition__full_agentGetAutocompleteV2_Accept-Language_e ){
    char *Array[] =  { "NULL", "*", "en", "fr" };
    return Array[];
}

static ezmax_api_definition__full_agentGetAutocompleteV2_Accept-Language_e agentGetAutocompleteV2__FromString(char* ){
    int stringToReturn = 0;
    char *Array[] =  { "NULL", "*", "en", "fr" };
...
/*
// Function agentGetAutocompleteV2__convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *agentGetAutocompleteV2__convertToJSON(ezmax_api_definition__full_agentGetAutocompleteV2_Accept-Language_e ) {
    cJSON *item = cJSON_CreateObject();
    return item;
    fail:
    cJSON_Delete(item);
...
// Function agentGetAutocompleteV2__parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_agentGetAutocompleteV2_Accept-Language_e agentGetAutocompleteV2__parseFromJSON(cJSON* JSON) {
    ezmax_api_definition__full_agentGetAutocompleteV2_Accept-Language_e Variable = 0;
    return Variable;
end:
    return 0;
}
...
/*
// Function agentGetListV1_EORDERBY_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *agentGetListV1_EORDERBY_convertToJSON(ezmax_api_definition__full_agentGetListV1_eOrderBy_e EORDERBY) {
    cJSON *item = cJSON_CreateObject();
    if(cJSON_AddStringToObject(item, "eOrderBy", agentGetListV1_EORDERBY_ToString(EORDERBY)) == NULL) {
        goto fail;
    }
    return item;
    fail:
...
// Function agentGetListV1_EORDERBY_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_agentGetListV1_eOrderBy_e agentGetListV1_EORDERBY_parseFromJSON(cJSON* EORDERBYJSON) {
    ezmax_api_definition__full_agentGetListV1_eOrderBy_e EORDERBYVariable = 0;
    ...
    EORDERBYVariable = agentGetListV1_EORDERBY_FromString(EORDERBYVar->valuestring);
...
// Functions for enum  for ObjectAgentAPI_agentGetListV1

static char* agentGetListV1__ToString(ezmax_api_definition__full_agentGetListV1_Accept-Language_e ){
    char *Array[] =  { "NULL", "*", "en", "fr" };
    return Array[];
}

static ezmax_api_definition__full_agentGetListV1_Accept-Language_e agentGetListV1__FromString(char* ){
    int stringToReturn = 0;
    char *Array[] =  { "NULL", "*", "en", "fr" };
    size_t sizeofArray = sizeof(Array) / sizeof(Array[0]);
    while(stringToReturn < sizeofArray) {
...
/*
// Function agentGetListV1__convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *agentGetListV1__convertToJSON(ezmax_api_definition__full_agentGetListV1_Accept-Language_e ) {
    cJSON *item = cJSON_CreateObject();
    return item;
    fail:
    cJSON_Delete(item);
...
// Function agentGetListV1__parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_agentGetListV1_Accept-Language_e agentGetListV1__parseFromJSON(cJSON* JSON) {
    ezmax_api_definition__full_agentGetListV1_Accept-Language_e Variable = 0;
    return Variable;
end:
    return 0;
}
...
ObjectAgentAPI_agentGetAutocompleteV2(apiClient_t *apiClient, ezmax_api_definition__full_agentGetAutocompleteV2_sSelector_e sSelector, ezmax_api_definition__full_agentGetAutocompleteV2_eFilterActive_e eFilterActive, char *sQuery, header_accept_language_e Accept_Language)
{
    ...
    // create the path
    char *localVarPath = strdup("/2/object/agent/getAutocomplete/{sSelector}");
    ...
    // Path Params
    long sizeOfPathParams_sSelector = strlen(agentGetAutocompleteV2_SSELECTOR_ToString(sSelector))+3 + sizeof("{ sSelector }") - 1;
    if(sSelector == 0) {
        goto end;
    }
    ...
    localVarPath = strReplace(localVarPath, localVarToReplace_sSelector, agentGetAutocompleteV2_SSELECTOR_ToString(sSelector));
    ...
    ezmax_api_definition__full_agentGetAutocompleteV2_eFilterActive_e valueQuery_eFilterActive ;
    ...
    if (eFilterActive)
    {
        ...
        keyPairQuery_eFilterActive = keyValuePair_create(keyQuery_eFilterActive, strdup(agentGetAutocompleteV2_EFILTERACTIVE_ToString(
    ...
    agent_get_autocomplete_v2_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ObjectAgentAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = agent_get_autocomplete_v2_response_parseFromJSON(ObjectAgentAPIlocalVarJSON);
...
ObjectAgentAPI_agentGetListV1(apiClient_t *apiClient, ezmax_api_definition__full_agentGetListV1_eOrderBy_e eOrderBy, int *iRowMax, int *iRowOffset, header_accept_language_e Accept_Language, char *sFilter)
{
    ...
    // create the path
    char *localVarPath = strdup("/1/object/agent/getList");
    ...
    ezmax_api_definition__full_agentGetListV1_eOrderBy_e valueQuery_eOrderBy ;
    keyValuePair_t *keyPairQuery_eOrderBy = 0;
    if (eOrderBy)
    {
        keyQuery_eOrderBy = strdup("eOrderBy");
        valueQuery_eOrderBy = (eOrderBy);
        keyPairQuery_eOrderBy = keyValuePair_create(keyQuery_eOrderBy, strdup(agentGetListV1_EORDERBY_ToString(
        valueQuery_eOrderBy)));
    ...
    //}
    //nonprimitive not container
    agent_get_list_v1_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ObjectAgentAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = agent_get_list_v1_response_parseFromJSON(ObjectAgentAPIlocalVarJSON);
        cJSON_Delete(ObjectAgentAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
ObjectAgentAPI_agentImportIntoEDMV1(apiClient_t *apiClient, int *pkiAgentID, agent_import_into_edm_v1_request_t *agent_import_into_edm_v1_request)
{
    ...
    // create the path
    char *localVarPath = strdup("/1/object/agent/{pkiAgentID}/importIntoEDM");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_agent_import_into_edm_v1_request = NULL;
    if (agent_import_into_edm_v1_request != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_agent_import_into_edm_v1_request = agent_import_into_edm_v1_request_convertToJSON(agent_import_into_edm_v1_request);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_agent_import_into_edm_v1_request);
    ...
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ObjectAgentAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = agent_import_into_edm_v1_response_parseFromJSON(ObjectAgentAPIlocalVarJSON);
        cJSON_Delete(ObjectAgentAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
    ...
    if (localVarSingleItemJSON_agent_import_into_edm_v1_request) {
        cJSON_Delete(localVarSingleItemJSON_agent_import_into_edm_v1_request);
        localVarSingleItemJSON_agent_import_into_edm_v1_request = NULL;
    }
