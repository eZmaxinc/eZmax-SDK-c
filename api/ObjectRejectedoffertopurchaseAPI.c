...
ObjectRejectedoffertopurchaseAPI_rejectedoffertopurchaseBatchDownloadV1(apiClient_t *apiClient, int *pkiRejectedoffertopurchaseID, rejectedoffertopurchase_batch_download_v1_request_t *rejectedoffertopurchase_batch_download_v1_request)
{
    ...
    // create the path
    char *localVarPath = strdup("/1/object/rejectedoffertopurchase/{pkiRejectedoffertopurchaseID}/batchDownload");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_rejectedoffertopurchase_batch_download_v1_request = NULL;
    if (rejectedoffertopurchase_batch_download_v1_request != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_rejectedoffertopurchase_batch_download_v1_request = rejectedoffertopurchase_batch_download_v1_request_convertToJSON(rejectedoffertopurchase_batch_download_v1_request);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_rejectedoffertopurchase_batch_download_v1_request);
    ...
    if (localVarSingleItemJSON_rejectedoffertopurchase_batch_download_v1_request) {
        cJSON_Delete(localVarSingleItemJSON_rejectedoffertopurchase_batch_download_v1_request);
        localVarSingleItemJSON_rejectedoffertopurchase_batch_download_v1_request = NULL;
    }
...
ObjectRejectedoffertopurchaseAPI_rejectedoffertopurchaseGetAttachmentsV1(apiClient_t *apiClient, int *pkiRejectedoffertopurchaseID)
{
    ...
    // create the path
    char *localVarPath = strdup("/1/object/rejectedoffertopurchase/{pkiRejectedoffertopurchaseID}/getAttachments");
    ...
    rejectedoffertopurchase_get_attachments_v1_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ObjectRejectedoffertopurchaseAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = rejectedoffertopurchase_get_attachments_v1_response_parseFromJSON(ObjectRejectedoffertopurchaseAPIlocalVarJSON);
