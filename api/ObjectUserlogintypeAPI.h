...
typedef enum  { ezmax_api_definition__full_userlogintypeGetAutocompleteV2_SSELECTOR_NULL = 0, ezmax_api_definition__full_userlogintypeGetAutocompleteV2_SSELECTOR_All, ezmax_api_definition__full_userlogintypeGetAutocompleteV2_SSELECTOR_Ezsignfoldertype } ezmax_api_definition__full_userlogintypeGetAutocompleteV2_sSelector_e;
