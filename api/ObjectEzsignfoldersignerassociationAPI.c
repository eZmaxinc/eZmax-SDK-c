...
ObjectEzsignfoldersignerassociationAPI_ezsignfoldersignerassociationCreateObjectV3(apiClient_t *apiClient, ezsignfoldersignerassociation_create_object_v3_request_t *ezsignfoldersignerassociation_create_object_v3_request)
{
    ...
    // create the path
    char *localVarPath = strdup("/3/object/ezsignfoldersignerassociation");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_ezsignfoldersignerassociation_create_object_v3_request = NULL;
    if (ezsignfoldersignerassociation_create_object_v3_request != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_ezsignfoldersignerassociation_create_object_v3_request = ezsignfoldersignerassociation_create_object_v3_request_convertToJSON(ezsignfoldersignerassociation_create_object_v3_request);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_ezsignfoldersignerassociation_create_object_v3_request);
        localVarBodyLength = strlen(localVarBodyParameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //}
    //nonprimitive not container
    ezsignfoldersignerassociation_create_object_v3_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ObjectEzsignfoldersignerassociationAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = ezsignfoldersignerassociation_create_object_v3_response_parseFromJSON(ObjectEzsignfoldersignerassociationAPIlocalVarJSON);
        cJSON_Delete(ObjectEzsignfoldersignerassociationAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
    ...
    list_freeList(localVarContentType);
    free(localVarPath);
    if (localVarSingleItemJSON_ezsignfoldersignerassociation_create_object_v3_request) {
        cJSON_Delete(localVarSingleItemJSON_ezsignfoldersignerassociation_create_object_v3_request);
        localVarSingleItemJSON_ezsignfoldersignerassociation_create_object_v3_request = NULL;
    }
    free(localVarBodyParameters);
    return elementToReturn;
end:
...
ObjectEzsignfoldersignerassociationAPI_ezsignfoldersignerassociationEditObjectV2(apiClient_t *apiClient, int *pkiEzsignfoldersignerassociationID, ezsignfoldersignerassociation_edit_object_v2_request_t *ezsignfoldersignerassociation_edit_object_v2_request)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_ezsignfoldersignerassociation_edit_object_v2_request = NULL;
    if (ezsignfoldersignerassociation_edit_object_v2_request != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_ezsignfoldersignerassociation_edit_object_v2_request = ezsignfoldersignerassociation_edit_object_v2_request_convertToJSON(ezsignfoldersignerassociation_edit_object_v2_request);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_ezsignfoldersignerassociation_edit_object_v2_request);
        localVarBodyLength = strlen(localVarBodyParameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //}
    //nonprimitive not container
    ezsignfoldersignerassociation_edit_object_v2_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ObjectEzsignfoldersignerassociationAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = ezsignfoldersignerassociation_edit_object_v2_response_parseFromJSON(ObjectEzsignfoldersignerassociationAPIlocalVarJSON);
        cJSON_Delete(ObjectEzsignfoldersignerassociationAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
    ...
    free(localVarPath);
    free(localVarToReplace_pkiEzsignfoldersignerassociationID);
    if (localVarSingleItemJSON_ezsignfoldersignerassociation_edit_object_v2_request) {
        cJSON_Delete(localVarSingleItemJSON_ezsignfoldersignerassociation_edit_object_v2_request);
        localVarSingleItemJSON_ezsignfoldersignerassociation_edit_object_v2_request = NULL;
    }
    free(localVarBodyParameters);
    return elementToReturn;
end:
...
ObjectEzsignfoldersignerassociationAPI_ezsignfoldersignerassociationGetObjectV3(apiClient_t *apiClient, int *pkiEzsignfoldersignerassociationID)
{
    ...
    // create the path
    char *localVarPath = strdup("/3/object/ezsignfoldersignerassociation/{pkiEzsignfoldersignerassociationID}");
    ...
    //}
    //nonprimitive not container
    ezsignfoldersignerassociation_get_object_v3_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ObjectEzsignfoldersignerassociationAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = ezsignfoldersignerassociation_get_object_v3_response_parseFromJSON(ObjectEzsignfoldersignerassociationAPIlocalVarJSON);
        cJSON_Delete(ObjectEzsignfoldersignerassociationAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
