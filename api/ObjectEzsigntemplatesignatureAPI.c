...
ObjectEzsigntemplatesignatureAPI_ezsigntemplatesignatureGetObjectV1(apiClient_t *apiClient, int pkiEzsigntemplatesignatureID )
{
    ...
    //nonprimitive not container
    cJSON *ObjectEzsigntemplatesignatureAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    ezsigntemplatesignature_get_object_v1_response_t *elementToReturn = ezsigntemplatesignature_get_object_v1_response_parseFromJSON(ObjectEzsigntemplatesignatureAPIlocalVarJSON);
    cJSON_Delete(ObjectEzsigntemplatesignatureAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
