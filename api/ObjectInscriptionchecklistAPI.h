...
#include "../model/inscriptionchecklist_get_autocomplete_v2_response.h"
#include "../model/inscriptionchecklist_get_autocomplete_v3_response.h"

// Enum SSELECTOR for ObjectInscriptionchecklistAPI_inscriptionchecklistGetAutocompleteV2
typedef enum  { ezmax_api_definition__full_inscriptionchecklistGetAutocompleteV2_SSELECTOR_NULL = 0, ezmax_api_definition__full_inscriptionchecklistGetAutocompleteV2_SSELECTOR_All } ezmax_api_definition__full_inscriptionchecklistGetAutocompleteV2_sSelector_e;

// Enum ETYPE for ObjectInscriptionchecklistAPI_inscriptionchecklistGetAutocompleteV2
typedef enum  { ezmax_api_definition__full_inscriptionchecklistGetAutocompleteV2_ETYPE_NULL = 0, ezmax_api_definition__full_inscriptionchecklistGetAutocompleteV2_ETYPE_Buyercontract, ezmax_api_definition__full_inscriptionchecklistGetAutocompleteV2_ETYPE_Inscription, ezmax_api_definition__full_inscriptionchecklistGetAutocompleteV2_ETYPE_Inscriptionnotauthenticated, ezmax_api_definition__full_inscriptionchecklistGetAutocompleteV2_ETYPE_Inscriptiontemp, ezmax_api_definition__full_inscriptionchecklistGetAutocompleteV2_ETYPE_Agent, ezmax_api_definition__full_inscriptionchecklistGetAutocompleteV2_ETYPE_Broker, ezmax_api_definition__full_inscriptionchecklistGetAutocompleteV2_ETYPE_Otherincome, ezmax_api_definition__full_inscriptionchecklistGetAutocompleteV2_ETYPE_Rejectedoffertopurchase } ezmax_api_definition__full_inscriptionchecklistGetAutocompleteV2_eType_e;

// Enum EFILTERACTIVE for ObjectInscriptionchecklistAPI_inscriptionchecklistGetAutocompleteV2
typedef enum  { ezmax_api_definition__full_inscriptionchecklistGetAutocompleteV2_EFILTERACTIVE_NULL = 0, ezmax_api_definition__full_inscriptionchecklistGetAutocompleteV2_EFILTERACTIVE_All, ezmax_api_definition__full_inscriptionchecklistGetAutocompleteV2_EFILTERACTIVE_Active, ezmax_api_definition__full_inscriptionchecklistGetAutocompleteV2_EFILTERACTIVE_Inactive } ezmax_api_definition__full_inscriptionchecklistGetAutocompleteV2_eFilterActive_e;

// Enum  for ObjectInscriptionchecklistAPI_inscriptionchecklistGetAutocompleteV2
typedef enum  { ezmax_api_definition__full_inscriptionchecklistGetAutocompleteV2__NULL = 0, ezmax_api_definition__full_inscriptionchecklistGetAutocompleteV2__*, ezmax_api_definition__full_inscriptionchecklistGetAutocompleteV2__en, ezmax_api_definition__full_inscriptionchecklistGetAutocompleteV2__fr } ezmax_api_definition__full_inscriptionchecklistGetAutocompleteV2_Accept-Language_e;
