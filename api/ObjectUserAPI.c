...
/*
// Function userGetAutocompleteV2_SSELECTOR_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *userGetAutocompleteV2_SSELECTOR_convertToJSON(ezmax_api_definition__full_userGetAutocompleteV2_sSelector_e SSELECTOR) {
    cJSON *item = cJSON_CreateObject();
    if(cJSON_AddStringToObject(item, "sSelector", userGetAutocompleteV2_SSELECTOR_ToString(SSELECTOR)) == NULL) {
        goto fail;
    }
    return item;
    fail:
...
// Function userGetAutocompleteV2_SSELECTOR_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_userGetAutocompleteV2_sSelector_e userGetAutocompleteV2_SSELECTOR_parseFromJSON(cJSON* SSELECTORJSON) {
    ezmax_api_definition__full_userGetAutocompleteV2_sSelector_e SSELECTORVariable = 0;
    ...
    SSELECTORVariable = userGetAutocompleteV2_SSELECTOR_FromString(SSELECTORVar->valuestring);
...
// Functions for enum EFILTERACTIVE for ObjectUserAPI_userGetAutocompleteV2

static char* userGetAutocompleteV2_EFILTERACTIVE_ToString(ezmax_api_definition__full_userGetAutocompleteV2_eFilterActive_e EFILTERACTIVE){
    char *EFILTERACTIVEArray[] =  { "NULL", "All", "Active", "Inactive" };
    return EFILTERACTIVEArray[EFILTERACTIVE];
}

static ezmax_api_definition__full_userGetAutocompleteV2_eFilterActive_e userGetAutocompleteV2_EFILTERACTIVE_FromString(char* EFILTERACTIVE){
    int stringToReturn = 0;
    char *EFILTERACTIVEArray[] =  { "NULL", "All", "Active", "Inactive" };
...
/*
// Function userGetAutocompleteV2_EFILTERACTIVE_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *userGetAutocompleteV2_EFILTERACTIVE_convertToJSON(ezmax_api_definition__full_userGetAutocompleteV2_eFilterActive_e EFILTERACTIVE) {
    cJSON *item = cJSON_CreateObject();
    if(cJSON_AddStringToObject(item, "eFilterActive", userGetAutocompleteV2_EFILTERACTIVE_ToString(EFILTERACTIVE)) == NULL) {
        goto fail;
    }
    return item;
    fail:
...
// Function userGetAutocompleteV2_EFILTERACTIVE_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_userGetAutocompleteV2_eFilterActive_e userGetAutocompleteV2_EFILTERACTIVE_parseFromJSON(cJSON* EFILTERACTIVEJSON) {
    ezmax_api_definition__full_userGetAutocompleteV2_eFilterActive_e EFILTERACTIVEVariable = 0;
    ...
    EFILTERACTIVEVariable = userGetAutocompleteV2_EFILTERACTIVE_FromString(EFILTERACTIVEVar->valuestring);
...
// Functions for enum  for ObjectUserAPI_userGetAutocompleteV2

static char* userGetAutocompleteV2__ToString(ezmax_api_definition__full_userGetAutocompleteV2_Accept-Language_e ){
    char *Array[] =  { "NULL", "*", "en", "fr" };
    return Array[];
}

static ezmax_api_definition__full_userGetAutocompleteV2_Accept-Language_e userGetAutocompleteV2__FromString(char* ){
    int stringToReturn = 0;
    char *Array[] =  { "NULL", "*", "en", "fr" };
...
/*
// Function userGetAutocompleteV2__convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *userGetAutocompleteV2__convertToJSON(ezmax_api_definition__full_userGetAutocompleteV2_Accept-Language_e ) {
    cJSON *item = cJSON_CreateObject();
    return item;
    fail:
    cJSON_Delete(item);
...
// Function userGetAutocompleteV2__parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_userGetAutocompleteV2_Accept-Language_e userGetAutocompleteV2__parseFromJSON(cJSON* JSON) {
    ezmax_api_definition__full_userGetAutocompleteV2_Accept-Language_e Variable = 0;
    return Variable;
end:
    return 0;
}
...
/*
// Function userGetListV1_EORDERBY_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *userGetListV1_EORDERBY_convertToJSON(ezmax_api_definition__full_userGetListV1_eOrderBy_e EORDERBY) {
    cJSON *item = cJSON_CreateObject();
    if(cJSON_AddStringToObject(item, "eOrderBy", userGetListV1_EORDERBY_ToString(EORDERBY)) == NULL) {
        goto fail;
    }
    return item;
    fail:
...
// Function userGetListV1_EORDERBY_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_userGetListV1_eOrderBy_e userGetListV1_EORDERBY_parseFromJSON(cJSON* EORDERBYJSON) {
    ezmax_api_definition__full_userGetListV1_eOrderBy_e EORDERBYVariable = 0;
    ...
    EORDERBYVariable = userGetListV1_EORDERBY_FromString(EORDERBYVar->valuestring);
...
// Functions for enum  for ObjectUserAPI_userGetListV1

static char* userGetListV1__ToString(ezmax_api_definition__full_userGetListV1_Accept-Language_e ){
    char *Array[] =  { "NULL", "*", "en", "fr" };
    return Array[];
}

static ezmax_api_definition__full_userGetListV1_Accept-Language_e userGetListV1__FromString(char* ){
    int stringToReturn = 0;
    char *Array[] =  { "NULL", "*", "en", "fr" };
    size_t sizeofArray = sizeof(Array) / sizeof(Array[0]);
    while(stringToReturn < sizeofArray) {
...
/*
// Function userGetListV1__convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *userGetListV1__convertToJSON(ezmax_api_definition__full_userGetListV1_Accept-Language_e ) {
    cJSON *item = cJSON_CreateObject();
    return item;
    fail:
    cJSON_Delete(item);
...
// Function userGetListV1__parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static ezmax_api_definition__full_userGetListV1_Accept-Language_e userGetListV1__parseFromJSON(cJSON* JSON) {
    ezmax_api_definition__full_userGetListV1_Accept-Language_e Variable = 0;
    return Variable;
end:
    return 0;
}
...
ObjectUserAPI_userCreateObjectV1(apiClient_t *apiClient, user_create_object_v1_request_t *user_create_object_v1_request)
{
    ...
    // create the path
    long sizeOfPath = strlen("/1/object/user")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/1/object/user");




    // Body Param
    cJSON *localVarSingleItemJSON_user_create_object_v1_request = NULL;
    if (user_create_object_v1_request != NULL)
    {
        //string
        localVarSingleItemJSON_user_create_object_v1_request = user_create_object_v1_request_convertToJSON(user_create_object_v1_request);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_user_create_object_v1_request);
    }
    ...
    user_create_object_v1_response_t *elementToReturn = user_create_object_v1_response_parseFromJSON(ObjectUserAPIlocalVarJSON);
    ...
    free(localVarPath);
    if (localVarSingleItemJSON_user_create_object_v1_request) {
        cJSON_Delete(localVarSingleItemJSON_user_create_object_v1_request);
        localVarSingleItemJSON_user_create_object_v1_request = NULL;
    }
...
ObjectUserAPI_userCreateObjectV2(apiClient_t *apiClient, user_create_object_v2_request_t *user_create_object_v2_request)
{
    ...
    // create the path
    long sizeOfPath = strlen("/2/object/user")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/2/object/user");




    // Body Param
    cJSON *localVarSingleItemJSON_user_create_object_v2_request = NULL;
    if (user_create_object_v2_request != NULL)
    {
        //string
        localVarSingleItemJSON_user_create_object_v2_request = user_create_object_v2_request_convertToJSON(user_create_object_v2_request);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_user_create_object_v2_request);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    apiClient_invoke(apiClient,
    ...
    //nonprimitive not container
    cJSON *ObjectUserAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    user_create_object_v2_response_t *elementToReturn = user_create_object_v2_response_parseFromJSON(ObjectUserAPIlocalVarJSON);
    cJSON_Delete(ObjectUserAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ObjectUserAPI_userEditObjectV1(apiClient_t *apiClient, int *pkiUserID, user_edit_object_v1_request_t *user_edit_object_v1_request)
{
    ...
    // create the path
    long sizeOfPath = strlen("/1/object/user/{pkiUserID}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/1/object/user/{pkiUserID}");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_user_edit_object_v1_request = NULL;
    if (user_edit_object_v1_request != NULL)
    {
        //string
        localVarSingleItemJSON_user_edit_object_v1_request = user_edit_object_v1_request_convertToJSON(user_edit_object_v1_request);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_user_edit_object_v1_request);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    apiClient_invoke(apiClient,
    ...
    if (localVarSingleItemJSON_user_edit_object_v1_request) {
        cJSON_Delete(localVarSingleItemJSON_user_edit_object_v1_request);
        localVarSingleItemJSON_user_edit_object_v1_request = NULL;
    }
    free(localVarBodyParameters);
    return elementToReturn;
end:
...
ObjectUserAPI_userEditPermissionsV1(apiClient_t *apiClient, int *pkiUserID, user_edit_permissions_v1_request_t *user_edit_permissions_v1_request)
{
    ...
    // create the path
    long sizeOfPath = strlen("/1/object/user/{pkiUserID}/editPermissions")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/1/object/user/{pkiUserID}/editPermissions");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_user_edit_permissions_v1_request = NULL;
    if (user_edit_permissions_v1_request != NULL)
    {
        //string
        localVarSingleItemJSON_user_edit_permissions_v1_request = user_edit_permissions_v1_request_convertToJSON(user_edit_permissions_v1_request);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_user_edit_permissions_v1_request);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    apiClient_invoke(apiClient,
    ...
    //nonprimitive not container
    cJSON *ObjectUserAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    user_edit_permissions_v1_response_t *elementToReturn = user_edit_permissions_v1_response_parseFromJSON(ObjectUserAPIlocalVarJSON);
    cJSON_Delete(ObjectUserAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
    ...
    free(localVarPath);
    free(localVarToReplace_pkiUserID);
    if (localVarSingleItemJSON_user_edit_permissions_v1_request) {
        cJSON_Delete(localVarSingleItemJSON_user_edit_permissions_v1_request);
        localVarSingleItemJSON_user_edit_permissions_v1_request = NULL;
    }
    free(localVarBodyParameters);
    return elementToReturn;
end:
...
ObjectUserAPI_userGetApikeysV1(apiClient_t *apiClient, int *pkiUserID)
{
    ...
    // create the path
    long sizeOfPath = strlen("/1/object/user/{pkiUserID}/getApikeys")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/1/object/user/{pkiUserID}/getApikeys");
    ...
    //nonprimitive not container
    cJSON *ObjectUserAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    user_get_apikeys_v1_response_t *elementToReturn = user_get_apikeys_v1_response_parseFromJSON(ObjectUserAPIlocalVarJSON);
    cJSON_Delete(ObjectUserAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ObjectUserAPI_userGetAutocompleteV2(apiClient_t *apiClient, ezmax_api_definition__full_userGetAutocompleteV2_sSelector_e sSelector, ezmax_api_definition__full_userGetAutocompleteV2_eFilterActive_e eFilterActive, char *sQuery, header_accept_language_e Accept_Language)
{
    ...
    // create the path
    long sizeOfPath = strlen("/2/object/user/getAutocomplete/{sSelector}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/2/object/user/getAutocomplete/{sSelector}");
    ...
    ezmax_api_definition__full_userGetAutocompleteV2_eFilterActive_e valueQuery_eFilterActive ;
    ...
    //nonprimitive not container
    cJSON *ObjectUserAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    user_get_autocomplete_v2_response_t *elementToReturn = user_get_autocomplete_v2_response_parseFromJSON(ObjectUserAPIlocalVarJSON);
    cJSON_Delete(ObjectUserAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ObjectUserAPI_userGetEffectivePermissionsV1(apiClient_t *apiClient, int *pkiUserID)
{
    ...
    // create the path
    long sizeOfPath = strlen("/1/object/user/{pkiUserID}/getEffectivePermissions")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/1/object/user/{pkiUserID}/getEffectivePermissions");
    ...
    //nonprimitive not container
    cJSON *ObjectUserAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    user_get_effective_permissions_v1_response_t *elementToReturn = user_get_effective_permissions_v1_response_parseFromJSON(ObjectUserAPIlocalVarJSON);
    cJSON_Delete(ObjectUserAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ObjectUserAPI_userGetListV1(apiClient_t *apiClient, ezmax_api_definition__full_userGetListV1_eOrderBy_e eOrderBy, int *iRowMax, int *iRowOffset, header_accept_language_e Accept_Language, char *sFilter)
{
    ...
    // create the path
    long sizeOfPath = strlen("/1/object/user/getList")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/1/object/user/getList");
    ...
    ezmax_api_definition__full_userGetListV1_eOrderBy_e valueQuery_eOrderBy ;
    ...
    //nonprimitive not container
    cJSON *ObjectUserAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    user_get_list_v1_response_t *elementToReturn = user_get_list_v1_response_parseFromJSON(ObjectUserAPIlocalVarJSON);
    cJSON_Delete(ObjectUserAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ObjectUserAPI_userGetObjectV2(apiClient_t *apiClient, int *pkiUserID)
{
    ...
    // create the path
    long sizeOfPath = strlen("/2/object/user/{pkiUserID}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/2/object/user/{pkiUserID}");
    ...
    //nonprimitive not container
    cJSON *ObjectUserAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    user_get_object_v2_response_t *elementToReturn = user_get_object_v2_response_parseFromJSON(ObjectUserAPIlocalVarJSON);
    cJSON_Delete(ObjectUserAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ObjectUserAPI_userGetPermissionsV1(apiClient_t *apiClient, int *pkiUserID)
{
    ...
    // create the path
    long sizeOfPath = strlen("/1/object/user/{pkiUserID}/getPermissions")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/1/object/user/{pkiUserID}/getPermissions");
    ...
    //nonprimitive not container
    cJSON *ObjectUserAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    user_get_permissions_v1_response_t *elementToReturn = user_get_permissions_v1_response_parseFromJSON(ObjectUserAPIlocalVarJSON);
    cJSON_Delete(ObjectUserAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ObjectUserAPI_userGetSubnetsV1(apiClient_t *apiClient, int *pkiUserID)
{
    ...
    // create the path
    long sizeOfPath = strlen("/1/object/user/{pkiUserID}/getSubnets")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/1/object/user/{pkiUserID}/getSubnets");
    ...
    //nonprimitive not container
    cJSON *ObjectUserAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    user_get_subnets_v1_response_t *elementToReturn = user_get_subnets_v1_response_parseFromJSON(ObjectUserAPIlocalVarJSON);
    cJSON_Delete(ObjectUserAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ObjectUserAPI_userGetUsergroupexternalsV1(apiClient_t *apiClient, int *pkiUserID)
{
    ...
    // create the path
    long sizeOfPath = strlen("/1/object/user/{pkiUserID}/getUsergroupexternals")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/1/object/user/{pkiUserID}/getUsergroupexternals");
    ...
    //nonprimitive not container
    cJSON *ObjectUserAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    user_get_usergroupexternals_v1_response_t *elementToReturn = user_get_usergroupexternals_v1_response_parseFromJSON(ObjectUserAPIlocalVarJSON);
    cJSON_Delete(ObjectUserAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ObjectUserAPI_userGetUsergroupsV1(apiClient_t *apiClient, int *pkiUserID)
{
    ...
    // create the path
    long sizeOfPath = strlen("/1/object/user/{pkiUserID}/getUsergroups")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/1/object/user/{pkiUserID}/getUsergroups");
    ...
    //nonprimitive not container
    cJSON *ObjectUserAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    user_get_usergroups_v1_response_t *elementToReturn = user_get_usergroups_v1_response_parseFromJSON(ObjectUserAPIlocalVarJSON);
    cJSON_Delete(ObjectUserAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ObjectUserAPI_userSendPasswordResetV1(apiClient_t *apiClient, int *pkiUserID, object_t *body)
{
    ...
    // create the path
    long sizeOfPath = strlen("/1/object/user/{pkiUserID}/sendPasswordReset")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/1/object/user/{pkiUserID}/sendPasswordReset");
