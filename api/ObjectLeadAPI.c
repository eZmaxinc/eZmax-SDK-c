...
ObjectLeadAPI_leadBatchDownloadV1(apiClient_t *apiClient, int *pkiLeadID, lead_batch_download_v1_request_t *lead_batch_download_v1_request)
{
    ...
    // create the path
    char *localVarPath = strdup("/1/object/lead/{pkiLeadID}/batchDownload");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_lead_batch_download_v1_request = NULL;
    if (lead_batch_download_v1_request != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_lead_batch_download_v1_request = lead_batch_download_v1_request_convertToJSON(lead_batch_download_v1_request);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_lead_batch_download_v1_request);
    ...
    if (localVarSingleItemJSON_lead_batch_download_v1_request) {
        cJSON_Delete(localVarSingleItemJSON_lead_batch_download_v1_request);
        localVarSingleItemJSON_lead_batch_download_v1_request = NULL;
    }
...
ObjectLeadAPI_leadGetAttachmentsV1(apiClient_t *apiClient, int *pkiLeadID)
{
    ...
    // create the path
    char *localVarPath = strdup("/1/object/lead/{pkiLeadID}/getAttachments");
    ...
    lead_get_attachments_v1_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ObjectLeadAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = lead_get_attachments_v1_response_parseFromJSON(ObjectLeadAPIlocalVarJSON);
