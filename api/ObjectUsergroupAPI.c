...
ObjectUsergroupAPI_usergroupDeleteObjectV1(apiClient_t *apiClient, int pkiUsergroupID )
{
    ...
    //nonprimitive not container
    cJSON *ObjectUsergroupAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    usergroup_delete_object_v1_response_t *elementToReturn = usergroup_delete_object_v1_response_parseFromJSON(ObjectUsergroupAPIlocalVarJSON);
    cJSON_Delete(ObjectUsergroupAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
ObjectUsergroupAPI_usergroupGetMembersV1(apiClient_t *apiClient, int pkiUsergroupID )
{
    ...
    // create the path
    long sizeOfPath = strlen("/1/object/usergroup/{pkiUsergroupID}/getMembers")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/1/object/usergroup/{pkiUsergroupID}/getMembers");
    ...
    //nonprimitive not container
    cJSON *ObjectUsergroupAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    usergroup_get_members_v1_response_t *elementToReturn = usergroup_get_members_v1_response_parseFromJSON(ObjectUsergroupAPIlocalVarJSON);
    cJSON_Delete(ObjectUsergroupAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
