...
ObjectEzsignbulksendsignermappingAPI_ezsignbulksendsignermappingGetObjectV1(apiClient_t *apiClient, int pkiEzsignbulksendsignermappingID )
{
    ...
    //nonprimitive not container
    cJSON *ObjectEzsignbulksendsignermappingAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    ezsignbulksendsignermapping_get_object_v1_response_t *elementToReturn = ezsignbulksendsignermapping_get_object_v1_response_parseFromJSON(ObjectEzsignbulksendsignermappingAPIlocalVarJSON);
    cJSON_Delete(ObjectEzsignbulksendsignermappingAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
