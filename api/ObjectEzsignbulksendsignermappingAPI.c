...
// The endpoint allows to create one or many elements at once.
//
ezsignbulksendsignermapping_create_object_v2_response_t*
ObjectEzsignbulksendsignermappingAPI_ezsignbulksendsignermappingCreateObjectV2(apiClient_t *apiClient, ezsignbulksendsignermapping_create_object_v2_request_t *ezsignbulksendsignermapping_create_object_v2_request)
{
    list_t    *localVarQueryParameters = NULL;
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    char *localVarPath = strdup("/2/object/ezsignbulksendsignermapping");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_ezsignbulksendsignermapping_create_object_v2_request = NULL;
    if (ezsignbulksendsignermapping_create_object_v2_request != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_ezsignbulksendsignermapping_create_object_v2_request = ezsignbulksendsignermapping_create_object_v2_request_convertToJSON(ezsignbulksendsignermapping_create_object_v2_request);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_ezsignbulksendsignermapping_create_object_v2_request);
        localVarBodyLength = strlen(localVarBodyParameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //}
    //nonprimitive not container
    ezsignbulksendsignermapping_create_object_v2_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ObjectEzsignbulksendsignermappingAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = ezsignbulksendsignermapping_create_object_v2_response_parseFromJSON(ObjectEzsignbulksendsignermappingAPIlocalVarJSON);
        cJSON_Delete(ObjectEzsignbulksendsignermappingAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
    ...
    list_freeList(localVarContentType);
    free(localVarPath);
    if (localVarSingleItemJSON_ezsignbulksendsignermapping_create_object_v2_request) {
        cJSON_Delete(localVarSingleItemJSON_ezsignbulksendsignermapping_create_object_v2_request);
        localVarSingleItemJSON_ezsignbulksendsignermapping_create_object_v2_request = NULL;
    }
    free(localVarBodyParameters);
    return elementToReturn;
end:
...
// 
//
ezsignbulksendsignermapping_get_object_v3_response_t*
ObjectEzsignbulksendsignermappingAPI_ezsignbulksendsignermappingGetObjectV3(apiClient_t *apiClient, int *pkiEzsignbulksendsignermappingID)
{
    list_t    *localVarQueryParameters = NULL;
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    char *localVarPath = strdup("/3/object/ezsignbulksendsignermapping/{pkiEzsignbulksendsignermappingID}");
    ...
    //}
    //nonprimitive not container
    ezsignbulksendsignermapping_get_object_v3_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ObjectEzsignbulksendsignermappingAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = ezsignbulksendsignermapping_get_object_v3_response_parseFromJSON(ObjectEzsignbulksendsignermappingAPIlocalVarJSON);
        cJSON_Delete(ObjectEzsignbulksendsignermappingAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
