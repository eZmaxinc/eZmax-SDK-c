...
ObjectEzsignbulksenddocumentmappingAPI_ezsignbulksenddocumentmappingGetObjectV3(apiClient_t *apiClient, int *pkiEzsignbulksenddocumentmappingID)
{
    list_t    *localVarQueryParameters = NULL;
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    char *localVarPath = strdup("/3/object/ezsignbulksenddocumentmapping/{pkiEzsignbulksenddocumentmappingID}");
    ...
    //}
    //nonprimitive not container
    ezsignbulksenddocumentmapping_get_object_v3_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ObjectEzsignbulksenddocumentmappingAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = ezsignbulksenddocumentmapping_get_object_v3_response_parseFromJSON(ObjectEzsignbulksenddocumentmappingAPIlocalVarJSON);
        cJSON_Delete(ObjectEzsignbulksenddocumentmappingAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
