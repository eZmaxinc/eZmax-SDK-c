...
rejectedoffertopurchase_get_communication_list_v1_response_m_payload_t *rejectedoffertopurchase_get_communication_list_v1_response_m_payload_create(
...
rejectedoffertopurchase_get_communication_list_v1_response_m_payload_t *rejectedoffertopurchase_get_communication_list_v1_response_m_payload_parseFromJSON(cJSON *rejectedoffertopurchase_get_communication_list_v1_response_m_payloadJSON){
    ...
    rejectedoffertopurchase_get_communication_list_v1_response_m_payload_local_var = rejectedoffertopurchase_get_communication_list_v1_response_m_payload_create (
