...
static ezsigndocument_patch_object_v1_response_t *ezsigndocument_patch_object_v1_response_create_internal(
    ...
    memset(ezsigndocument_patch_object_v1_response_local_var, 0, sizeof(ezsigndocument_patch_object_v1_response_t));
...
__attribute__((deprecated)) ezsigndocument_patch_object_v1_response_t *ezsigndocument_patch_object_v1_response_create(
    ...
    ezsigndocument_patch_object_v1_response_t *result = ezsigndocument_patch_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug
        );
    if (!result) {
