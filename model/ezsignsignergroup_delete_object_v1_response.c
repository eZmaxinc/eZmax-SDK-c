...
static ezsignsignergroup_delete_object_v1_response_t *ezsignsignergroup_delete_object_v1_response_create_internal(
    ...
    memset(ezsignsignergroup_delete_object_v1_response_local_var, 0, sizeof(ezsignsignergroup_delete_object_v1_response_t));
    ezsignsignergroup_delete_object_v1_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezsignsignergroup_delete_object_v1_response_t *ezsignsignergroup_delete_object_v1_response_create(
    ...
    ezsignsignergroup_delete_object_v1_response_t *result = ezsignsignergroup_delete_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug
        );
    if (!result) {
...
void ezsignsignergroup_delete_object_v1_response_free(ezsignsignergroup_delete_object_v1_response_t *ezsignsignergroup_delete_object_v1_response) {
    ...
    if(ezsignsignergroup_delete_object_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsignsignergroup_delete_object_v1_response_free");
        return ;
    }
...
ezsignsignergroup_delete_object_v1_response_t *ezsignsignergroup_delete_object_v1_response_parseFromJSON(cJSON *ezsignsignergroup_delete_object_v1_responseJSON){
    ...
    ezsignsignergroup_delete_object_v1_response_local_var = ezsignsignergroup_delete_object_v1_response_create_internal (
