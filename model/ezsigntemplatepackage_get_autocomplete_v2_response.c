...
static ezsigntemplatepackage_get_autocomplete_v2_response_t *ezsigntemplatepackage_get_autocomplete_v2_response_create_internal(
    ...
    memset(ezsigntemplatepackage_get_autocomplete_v2_response_local_var, 0, sizeof(ezsigntemplatepackage_get_autocomplete_v2_response_t));
...
__attribute__((deprecated)) ezsigntemplatepackage_get_autocomplete_v2_response_t *ezsigntemplatepackage_get_autocomplete_v2_response_create(
    ...
    ezsigntemplatepackage_get_autocomplete_v2_response_t *result = ezsigntemplatepackage_get_autocomplete_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
