/*
 * agent_get_communication_count_v1_response_m_payload.h
 *
 * Response for GET /1/object/agent/{pkiAgentID}/getCommunicationCount
 */

#ifndef _agent_get_communication_count_v1_response_m_payload_H_
#define _agent_get_communication_count_v1_response_m_payload_H_
...
typedef struct agent_get_communication_count_v1_response_m_payload_t agent_get_communication_count_v1_response_m_payload_t;




typedef struct agent_get_communication_count_v1_response_m_payload_t {
    int *i_communication_count; //numeric

    int _library_owned; // Is the library responsible for freeing this object?
} agent_get_communication_count_v1_response_m_payload_t;
...
#endif /* _agent_get_communication_count_v1_response_m_payload_H_ */
