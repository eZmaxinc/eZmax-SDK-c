/*
 * ezsignfoldersignerassociation_edit_object_v2_request.h
 *
 * Request for PUT /2/object/ezsignfoldersignerassociation/{pkiEzsignfoldersignerassociationID}
 */

#ifndef _ezsignfoldersignerassociation_edit_object_v2_request_H_
#define _ezsignfoldersignerassociation_edit_object_v2_request_H_
...
typedef struct ezsignfoldersignerassociation_edit_object_v2_request_t ezsignfoldersignerassociation_edit_object_v2_request_t;

#include "ezsignfoldersignerassociation_request_compound_v2.h"



typedef struct ezsignfoldersignerassociation_edit_object_v2_request_t {
    struct ezsignfoldersignerassociation_request_compound_v2_t *obj_ezsignfoldersignerassociation; //model

    int _library_owned; // Is the library responsible for freeing this object?
} ezsignfoldersignerassociation_edit_object_v2_request_t;
...
#endif /* _ezsignfoldersignerassociation_edit_object_v2_request_H_ */
