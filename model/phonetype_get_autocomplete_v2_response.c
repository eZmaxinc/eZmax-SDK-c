...
static phonetype_get_autocomplete_v2_response_t *phonetype_get_autocomplete_v2_response_create_internal(
    ...
    memset(phonetype_get_autocomplete_v2_response_local_var, 0, sizeof(phonetype_get_autocomplete_v2_response_t));
...
__attribute__((deprecated)) phonetype_get_autocomplete_v2_response_t *phonetype_get_autocomplete_v2_response_create(
    ...
    phonetype_get_autocomplete_v2_response_t *result = phonetype_get_autocomplete_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
