...
static domain_get_object_v2_response_t *domain_get_object_v2_response_create_internal(
    ...
    memset(domain_get_object_v2_response_local_var, 0, sizeof(domain_get_object_v2_response_t));
    domain_get_object_v2_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) domain_get_object_v2_response_t *domain_get_object_v2_response_create(
    common_response_obj_debug_payload_t *obj_debug_payload,
    common_response_obj_debug_t *obj_debug,
    domain_get_object_v2_response_m_payload_t *m_payload
    ) {
    domain_get_object_v2_response_t *result = domain_get_object_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void domain_get_object_v2_response_free(domain_get_object_v2_response_t *domain_get_object_v2_response) {
    ...
    if(domain_get_object_v2_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "domain_get_object_v2_response_free");
        return ;
    }
...
domain_get_object_v2_response_t *domain_get_object_v2_response_parseFromJSON(cJSON *domain_get_object_v2_responseJSON){
    ...
    domain_get_object_v2_response_local_var = domain_get_object_v2_response_create_internal (
