...
typedef enum { ezmax_api_definition_field_e_phone_type__NULL = 0, ezmax_api_definition_field_e_phone_type__Local, ezmax_api_definition_field_e_phone_type__International } ezmax_api_definition_field_e_phone_type__e;
