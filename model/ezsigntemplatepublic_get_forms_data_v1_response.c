...
static ezsigntemplatepublic_get_forms_data_v1_response_t *ezsigntemplatepublic_get_forms_data_v1_response_create_internal(
    ...
    memset(ezsigntemplatepublic_get_forms_data_v1_response_local_var, 0, sizeof(ezsigntemplatepublic_get_forms_data_v1_response_t));
...
__attribute__((deprecated)) ezsigntemplatepublic_get_forms_data_v1_response_t *ezsigntemplatepublic_get_forms_data_v1_response_create(
    ...
    ezsigntemplatepublic_get_forms_data_v1_response_t *result = ezsigntemplatepublic_get_forms_data_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
