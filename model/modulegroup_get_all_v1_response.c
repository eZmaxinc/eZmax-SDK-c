...
static modulegroup_get_all_v1_response_t *modulegroup_get_all_v1_response_create_internal(
    ...
    memset(modulegroup_get_all_v1_response_local_var, 0, sizeof(modulegroup_get_all_v1_response_t));
    modulegroup_get_all_v1_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) modulegroup_get_all_v1_response_t *modulegroup_get_all_v1_response_create(
    common_response_obj_debug_payload_t *obj_debug_payload,
    common_response_obj_debug_t *obj_debug,
    modulegroup_get_all_v1_response_m_payload_t *m_payload
    ) {
    modulegroup_get_all_v1_response_t *result = modulegroup_get_all_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void modulegroup_get_all_v1_response_free(modulegroup_get_all_v1_response_t *modulegroup_get_all_v1_response) {
    ...
    if(modulegroup_get_all_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "modulegroup_get_all_v1_response_free");
        return ;
    }
...
modulegroup_get_all_v1_response_t *modulegroup_get_all_v1_response_parseFromJSON(cJSON *modulegroup_get_all_v1_responseJSON){
    ...
    modulegroup_get_all_v1_response_local_var = modulegroup_get_all_v1_response_create_internal (
