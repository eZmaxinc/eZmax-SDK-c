/*
 * bankaccount_get_communication_count_v1_response_m_payload.h
 *
 * Response for GET /1/object/bankaccount/{pkiBankaccountID}/getCommunicationCount
 */

#ifndef _bankaccount_get_communication_count_v1_response_m_payload_H_
#define _bankaccount_get_communication_count_v1_response_m_payload_H_
...
typedef struct bankaccount_get_communication_count_v1_response_m_payload_t bankaccount_get_communication_count_v1_response_m_payload_t;




typedef struct bankaccount_get_communication_count_v1_response_m_payload_t {
    int *i_communication_count; //numeric

    int _library_owned; // Is the library responsible for freeing this object?
} bankaccount_get_communication_count_v1_response_m_payload_t;
...
#endif /* _bankaccount_get_communication_count_v1_response_m_payload_H_ */
