...
static ezsignsigningreason_edit_object_v1_response_t *ezsignsigningreason_edit_object_v1_response_create_internal(
    ...
    memset(ezsignsigningreason_edit_object_v1_response_local_var, 0, sizeof(ezsignsigningreason_edit_object_v1_response_t));
    ezsignsigningreason_edit_object_v1_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezsignsigningreason_edit_object_v1_response_t *ezsignsigningreason_edit_object_v1_response_create(
    ...
    ezsignsigningreason_edit_object_v1_response_t *result = ezsignsigningreason_edit_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug
        );
    if (!result) {
...
void ezsignsigningreason_edit_object_v1_response_free(ezsignsigningreason_edit_object_v1_response_t *ezsignsigningreason_edit_object_v1_response) {
    ...
    if(ezsignsigningreason_edit_object_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsignsigningreason_edit_object_v1_response_free");
        return ;
    }
...
ezsignsigningreason_edit_object_v1_response_t *ezsignsigningreason_edit_object_v1_response_parseFromJSON(cJSON *ezsignsigningreason_edit_object_v1_responseJSON){
    ...
    ezsignsigningreason_edit_object_v1_response_local_var = ezsignsigningreason_edit_object_v1_response_create_internal (
