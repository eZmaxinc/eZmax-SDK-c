...
static billingentityexternal_generate_federation_token_v1_response_t *billingentityexternal_generate_federation_token_v1_response_create_internal(
    ...
    memset(billingentityexternal_generate_federation_token_v1_response_local_var, 0, sizeof(billingentityexternal_generate_federation_token_v1_response_t));
    billingentityexternal_generate_federation_token_v1_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) billingentityexternal_generate_federation_token_v1_response_t *billingentityexternal_generate_federation_token_v1_response_create(
    common_response_obj_debug_payload_t *obj_debug_payload,
    common_response_obj_debug_t *obj_debug,
    billingentityexternal_generate_federation_token_v1_response_m_payload_t *m_payload
    ) {
    billingentityexternal_generate_federation_token_v1_response_t *result = billingentityexternal_generate_federation_token_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void billingentityexternal_generate_federation_token_v1_response_free(billingentityexternal_generate_federation_token_v1_response_t *billingentityexternal_generate_federation_token_v1_response) {
    ...
    if(billingentityexternal_generate_federation_token_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "billingentityexternal_generate_federation_token_v1_response_free");
        return ;
    }
...
billingentityexternal_generate_federation_token_v1_response_t *billingentityexternal_generate_federation_token_v1_response_parseFromJSON(cJSON *billingentityexternal_generate_federation_token_v1_responseJSON){
    ...
    billingentityexternal_generate_federation_token_v1_response_local_var = billingentityexternal_generate_federation_token_v1_response_create_internal (
