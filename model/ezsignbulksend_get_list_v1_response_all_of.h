/*
 * ezsignbulksend_get_list_v1_response_all_of.h
 *
 * 
 */

#ifndef _ezsignbulksend_get_list_v1_response_all_of_H_
#define _ezsignbulksend_get_list_v1_response_all_of_H_
...
typedef struct ezsignbulksend_get_list_v1_response_all_of_t ezsignbulksend_get_list_v1_response_all_of_t;

#include "ezsignbulksend_get_list_v1_response_m_payload.h"



typedef struct ezsignbulksend_get_list_v1_response_all_of_t {
    struct ezsignbulksend_get_list_v1_response_m_payload_t *m_payload; //model

} ezsignbulksend_get_list_v1_response_all_of_t;
...
#endif /* _ezsignbulksend_get_list_v1_response_all_of_H_ */
