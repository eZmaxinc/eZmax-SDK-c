/*
 * purchase_get_attachments_v1_response_m_payload.h
 *
 * Response for GET /1/object/purchase/{pkiPurchaseID}/getAttachments
 */

#ifndef _purchase_get_attachments_v1_response_m_payload_H_
#define _purchase_get_attachments_v1_response_m_payload_H_
...
typedef struct purchase_get_attachments_v1_response_m_payload_t purchase_get_attachments_v1_response_m_payload_t;

#include "custom_attachmentdocumenttype_response.h"



typedef struct purchase_get_attachments_v1_response_m_payload_t {
    list_t *a_obj_attachmentdocumenttype; //nonprimitive container

    int _library_owned; // Is the library responsible for freeing this object?
} purchase_get_attachments_v1_response_m_payload_t;
...
#endif /* _purchase_get_attachments_v1_response_m_payload_H_ */
