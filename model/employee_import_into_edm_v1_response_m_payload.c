...
static employee_import_into_edm_v1_response_m_payload_t *employee_import_into_edm_v1_response_m_payload_create_internal(
    ...
    memset(employee_import_into_edm_v1_response_m_payload_local_var, 0, sizeof(employee_import_into_edm_v1_response_m_payload_t));
...
__attribute__((deprecated)) employee_import_into_edm_v1_response_m_payload_t *employee_import_into_edm_v1_response_m_payload_create(
    ...
    employee_import_into_edm_v1_response_m_payload_t *result = employee_import_into_edm_v1_response_m_payload_create_internal (
        a_obj_attachment
        );
    if (!result) {
    }
