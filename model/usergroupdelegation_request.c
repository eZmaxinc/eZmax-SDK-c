...
static usergroupdelegation_request_t *usergroupdelegation_request_create_internal(
    ...
    memset(usergroupdelegation_request_local_var, 0, sizeof(usergroupdelegation_request_t));
...
__attribute__((deprecated)) usergroupdelegation_request_t *usergroupdelegation_request_create(
    ...
    usergroupdelegation_request_t *result = usergroupdelegation_request_create_internal (
...
void usergroupdelegation_request_free(usergroupdelegation_request_t *usergroupdelegation_request) {
    ...
    if (usergroupdelegation_request->pki_usergroupdelegation_id) {
        free(usergroupdelegation_request->pki_usergroupdelegation_id);
        usergroupdelegation_request->pki_usergroupdelegation_id = NULL;
    }
    if (usergroupdelegation_request->fki_usergroup_id) {
        free(usergroupdelegation_request->fki_usergroup_id);
        usergroupdelegation_request->fki_usergroup_id = NULL;
    }
    if (usergroupdelegation_request->fki_user_id) {
        free(usergroupdelegation_request->fki_user_id);
        usergroupdelegation_request->fki_user_id = NULL;
    }
...
usergroupdelegation_request_t *usergroupdelegation_request_parseFromJSON(cJSON *usergroupdelegation_requestJSON){
    ...
    // define the local variable for usergroupdelegation_request->pki_usergroupdelegation_id
    int *pki_usergroupdelegation_id_local_var = NULL;

    // define the local variable for usergroupdelegation_request->fki_usergroup_id
    int *fki_usergroup_id_local_var = NULL;

    // define the local variable for usergroupdelegation_request->fki_user_id
