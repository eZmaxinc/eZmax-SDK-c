/*
 * supplier_get_list_v1_response.h
 *
 * Response for GET /1/object/supplier/getList
 */

#ifndef _supplier_get_list_v1_response_H_
#define _supplier_get_list_v1_response_H_
...
typedef struct supplier_get_list_v1_response_t supplier_get_list_v1_response_t;
...
typedef struct supplier_get_list_v1_response_t {
    struct common_response_obj_debug_payload_get_list_t *obj_debug_payload; //model
    struct common_response_obj_debug_t *obj_debug; //model
    struct supplier_get_list_v1_response_m_payload_t *m_payload; //model
...
#endif /* _supplier_get_list_v1_response_H_ */
