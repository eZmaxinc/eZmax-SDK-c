...
static ezsignsigner_request_compound_contact_t *ezsignsigner_request_compound_contact_create_internal(
    ...
    memset(ezsignsigner_request_compound_contact_local_var, 0, sizeof(ezsignsigner_request_compound_contact_t));
    ezsignsigner_request_compound_contact_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezsignsigner_request_compound_contact_t *ezsignsigner_request_compound_contact_create(
    ...
    ezsignsigner_request_compound_contact_t *result = ezsignsigner_request_compound_contact_create_internal (
        s_contact_firstname,
        s_contact_lastname,
...
void ezsignsigner_request_compound_contact_free(ezsignsigner_request_compound_contact_t *ezsignsigner_request_compound_contact) {
    ...
    if(ezsignsigner_request_compound_contact->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsignsigner_request_compound_contact_free");
        return ;
    }
    ...
    if (ezsignsigner_request_compound_contact->fki_language_id) {
        free(ezsignsigner_request_compound_contact->fki_language_id);
        ezsignsigner_request_compound_contact->fki_language_id = NULL;
    }
...
ezsignsigner_request_compound_contact_t *ezsignsigner_request_compound_contact_parseFromJSON(cJSON *ezsignsigner_request_compound_contactJSON){
    ...
    // define the local variable for ezsignsigner_request_compound_contact->fki_language_id
    ...
    char *s_phone_number_cell_local_str = NULL;
    ...
    *fki_language_id_local_var = fki_language_id->valuedouble;
    ...
    if (cJSON_IsNull(s_phone_number_cell)) {
        s_phone_number_cell = NULL;
    }
    if (s_phone_number_cell) { 
    if(!cJSON_IsString(s_phone_number_cell) && !cJSON_IsNull(s_phone_number_cell))
    {
    goto end; //String
    }
    }
    ...
    if (s_phone_number_cell && !cJSON_IsNull(s_phone_number_cell)) s_phone_number_cell_local_str = strdup(s_phone_number_cell->valuestring);

    ezsignsigner_request_compound_contact_local_var = ezsignsigner_request_compound_contact_create_internal (
    ...
    if (s_phone_number_cell_local_str) {
        free(s_phone_number_cell_local_str);
        s_phone_number_cell_local_str = NULL;
    }
    return NULL;
