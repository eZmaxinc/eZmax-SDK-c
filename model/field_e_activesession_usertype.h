...
typedef enum { ezmax_api_definition__full_field_e_activesession_usertype__NULL = 0, ezmax_api_definition__full_field_e_activesession_usertype__AgentBroker, ezmax_api_definition__full_field_e_activesession_usertype__Assistant, ezmax_api_definition__full_field_e_activesession_usertype__Employee, ezmax_api_definition__full_field_e_activesession_usertype__EzsignSigner, ezmax_api_definition__full_field_e_activesession_usertype__EzsignUser, ezmax_api_definition__full_field_e_activesession_usertype__Normal } ezmax_api_definition__full_field_e_activesession_usertype__e;
