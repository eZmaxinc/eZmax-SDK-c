...
static apikey_get_permissions_v1_response_m_payload_t *apikey_get_permissions_v1_response_m_payload_create_internal(
    ...
    memset(apikey_get_permissions_v1_response_m_payload_local_var, 0, sizeof(apikey_get_permissions_v1_response_m_payload_t));
    apikey_get_permissions_v1_response_m_payload_local_var->_library_owned = 1;
...
__attribute__((deprecated)) apikey_get_permissions_v1_response_m_payload_t *apikey_get_permissions_v1_response_m_payload_create(
    list_t *a_obj_modulegroup
    ) {
    apikey_get_permissions_v1_response_m_payload_t *result = apikey_get_permissions_v1_response_m_payload_create_internal (
        a_obj_modulegroup
        );
    if (!result) {
    }
...
void apikey_get_permissions_v1_response_m_payload_free(apikey_get_permissions_v1_response_m_payload_t *apikey_get_permissions_v1_response_m_payload) {
    ...
    if(apikey_get_permissions_v1_response_m_payload->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "apikey_get_permissions_v1_response_m_payload_free");
        return ;
    }
...
apikey_get_permissions_v1_response_m_payload_t *apikey_get_permissions_v1_response_m_payload_parseFromJSON(cJSON *apikey_get_permissions_v1_response_m_payloadJSON){
    ...
    apikey_get_permissions_v1_response_m_payload_local_var = apikey_get_permissions_v1_response_m_payload_create_internal (
