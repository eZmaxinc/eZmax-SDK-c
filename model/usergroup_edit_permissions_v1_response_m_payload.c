...
usergroup_edit_permissions_v1_response_m_payload_t *usergroup_edit_permissions_v1_response_m_payload_create(
...
usergroup_edit_permissions_v1_response_m_payload_t *usergroup_edit_permissions_v1_response_m_payload_parseFromJSON(cJSON *usergroup_edit_permissions_v1_response_m_payloadJSON){
    ...
    usergroup_edit_permissions_v1_response_m_payload_local_var = usergroup_edit_permissions_v1_response_m_payload_create (
