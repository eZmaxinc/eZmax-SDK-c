...
static branding_edit_object_v2_response_t *branding_edit_object_v2_response_create_internal(
    ...
    memset(branding_edit_object_v2_response_local_var, 0, sizeof(branding_edit_object_v2_response_t));
...
__attribute__((deprecated)) branding_edit_object_v2_response_t *branding_edit_object_v2_response_create(
    ...
    branding_edit_object_v2_response_t *result = branding_edit_object_v2_response_create_internal (
        obj_debug_payload,
        obj_debug
        );
    if (!result) {
