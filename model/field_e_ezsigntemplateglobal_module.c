...
cJSON *field_e_ezsigntemplateglobal_module_convertToJSON(ezmax_api_definition__full_field_e_ezsigntemplateglobal_module__e field_e_ezsigntemplateglobal_module) {
...
ezmax_api_definition__full_field_e_ezsigntemplateglobal_module__e field_e_ezsigntemplateglobal_module_parseFromJSON(cJSON *field_e_ezsigntemplateglobal_moduleJSON) {
    if(!cJSON_IsString(field_e_ezsigntemplateglobal_moduleJSON) || (field_e_ezsigntemplateglobal_moduleJSON->valuestring == NULL)) {
        return 0;
    }
    return field_e_ezsigntemplateglobal_module_field_e_ezsigntemplateglobal_module_FromString(field_e_ezsigntemplateglobal_moduleJSON->valuestring);
}
