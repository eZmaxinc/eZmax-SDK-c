...
char* e_ezsigntemplateformfieldgroup_typeezsigntemplateformfieldgroup_request_compound_ToString(ezmax_api_definition__full_ezsigntemplateformfieldgroup_request_compound__e e_ezsigntemplateformfieldgroup_type) {
...
ezmax_api_definition__full_ezsigntemplateformfieldgroup_request_compound__e e_ezsigntemplateformfieldgroup_typeezsigntemplateformfieldgroup_request_compound_FromString(char* e_ezsigntemplateformfieldgroup_type){
...
char* e_ezsigntemplateformfieldgroup_signerrequirementezsigntemplateformfieldgroup_request_compound_ToString(ezmax_api_definition__full_ezsigntemplateformfieldgroup_request_compound__e e_ezsigntemplateformfieldgroup_signerrequirement) {
...
ezmax_api_definition__full_ezsigntemplateformfieldgroup_request_compound__e e_ezsigntemplateformfieldgroup_signerrequirementezsigntemplateformfieldgroup_request_compound_FromString(char* e_ezsigntemplateformfieldgroup_signerrequirement){
    int stringToReturn = 0;
    char *e_ezsigntemplateformfieldgroup_signerrequirementArray[] =  { "NULL", "All", "One" };
...
char* e_ezsigntemplateformfieldgroup_textvalidationezsigntemplateformfieldgroup_request_compound_ToString(ezmax_api_definition__full_ezsigntemplateformfieldgroup_request_compound__e e_ezsigntemplateformfieldgroup_textvalidation) {
...
ezmax_api_definition__full_ezsigntemplateformfieldgroup_request_compound__e e_ezsigntemplateformfieldgroup_textvalidationezsigntemplateformfieldgroup_request_compound_FromString(char* e_ezsigntemplateformfieldgroup_textvalidation){
    int stringToReturn = 0;
    char *e_ezsigntemplateformfieldgroup_textvalidationArray[] =  { "NULL", "None", "Date (YYYY-MM-DD)", "Date (MM/DD/YYYY)", "Date (MM/DD/YY)", "Date (DD/MM/YYYY)", "Date (DD/MM/YY)", "Email", "Letters", "Numbers", "Zip", "Zip+4", "PostalCode", "Custom" };
...
char* e_ezsigntemplateformfieldgroup_tooltippositionezsigntemplateformfieldgroup_request_compound_ToString(ezmax_api_definition__full_ezsigntemplateformfieldgroup_request_compound__e e_ezsigntemplateformfieldgroup_tooltipposition) {
...
ezmax_api_definition__full_ezsigntemplateformfieldgroup_request_compound__e e_ezsigntemplateformfieldgroup_tooltippositionezsigntemplateformfieldgroup_request_compound_FromString(char* e_ezsigntemplateformfieldgroup_tooltipposition){
    int stringToReturn = 0;
    char *e_ezsigntemplateformfieldgroup_tooltippositionArray[] =  { "NULL", "TopLeft", "TopCenter", "TopRight", "MiddleLeft", "MiddleRight", "BottomLeft", "BottomCenter", "BottomRight" };
...
cJSON *ezsigntemplateformfieldgroup_request_compound_convertToJSON(ezsigntemplateformfieldgroup_request_compound_t *ezsigntemplateformfieldgroup_request_compound) {
    ...
    if (ezmax_api_definition__full_ezsigntemplateformfieldgroup_request_compound__NULL == ezsigntemplateformfieldgroup_request_compound->e_ezsigntemplateformfieldgroup_signerrequirement) {
        goto fail;
    }
