...
static ezdoctemplatedocument_edit_object_v1_response_t *ezdoctemplatedocument_edit_object_v1_response_create_internal(
    ...
    memset(ezdoctemplatedocument_edit_object_v1_response_local_var, 0, sizeof(ezdoctemplatedocument_edit_object_v1_response_t));
...
__attribute__((deprecated)) ezdoctemplatedocument_edit_object_v1_response_t *ezdoctemplatedocument_edit_object_v1_response_create(
    ...
    ezdoctemplatedocument_edit_object_v1_response_t *result = ezdoctemplatedocument_edit_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug
        );
    if (!result) {
