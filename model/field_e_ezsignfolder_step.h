...
typedef enum { ezmax_api_definition__full_field_e_ezsignfolder_step__NULL = 0, ezmax_api_definition__full_field_e_ezsignfolder_step__Unsent, ezmax_api_definition__full_field_e_ezsignfolder_step__Sent, ezmax_api_definition__full_field_e_ezsignfolder_step__PartiallySigned, ezmax_api_definition__full_field_e_ezsignfolder_step__Expired, ezmax_api_definition__full_field_e_ezsignfolder_step__Completed, ezmax_api_definition__full_field_e_ezsignfolder_step__Archived, ezmax_api_definition__full_field_e_ezsignfolder_step__Disposed } ezmax_api_definition__full_field_e_ezsignfolder_step__e;
