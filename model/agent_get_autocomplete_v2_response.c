...
static agent_get_autocomplete_v2_response_t *agent_get_autocomplete_v2_response_create_internal(
    ...
    memset(agent_get_autocomplete_v2_response_local_var, 0, sizeof(agent_get_autocomplete_v2_response_t));
...
__attribute__((deprecated)) agent_get_autocomplete_v2_response_t *agent_get_autocomplete_v2_response_create(
    ...
    agent_get_autocomplete_v2_response_t *result = agent_get_autocomplete_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
