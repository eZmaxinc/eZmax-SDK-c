...
static user_create_object_v2_request_t *user_create_object_v2_request_create_internal(
    list_t *a_obj_user
    ) {
    ...
    memset(user_create_object_v2_request_local_var, 0, sizeof(user_create_object_v2_request_t));
    user_create_object_v2_request_local_var->_library_owned = 1;
    user_create_object_v2_request_local_var->a_obj_user = a_obj_user;
    return user_create_object_v2_request_local_var;
}

__attribute__((deprecated)) user_create_object_v2_request_t *user_create_object_v2_request_create(
    list_t *a_obj_user
    ) {
    user_create_object_v2_request_t *result = user_create_object_v2_request_create_internal (
        a_obj_user
        );
    if (!result) {
    }
...
void user_create_object_v2_request_free(user_create_object_v2_request_t *user_create_object_v2_request) {
    ...
    if(user_create_object_v2_request->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "user_create_object_v2_request_free");
        return ;
    }
...
user_create_object_v2_request_t *user_create_object_v2_request_parseFromJSON(cJSON *user_create_object_v2_requestJSON){
    ...
    user_create_object_v2_request_local_var = user_create_object_v2_request_create_internal (
        a_obj_userList
        );
