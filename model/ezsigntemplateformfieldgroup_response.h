...
typedef enum  { ezmax_api_definition__full_ezsigntemplateformfieldgroup_response__NULL = 0, ezmax_api_definition__full_ezsigntemplateformfieldgroup_response__Text, ezmax_api_definition__full_ezsigntemplateformfieldgroup_response__Textarea, ezmax_api_definition__full_ezsigntemplateformfieldgroup_response__Dropdown, ezmax_api_definition__full_ezsigntemplateformfieldgroup_response__Radio, ezmax_api_definition__full_ezsigntemplateformfieldgroup_response__Checkbox, ezmax_api_definition__full_ezsigntemplateformfieldgroup_response__Number, ezmax_api_definition__full_ezsigntemplateformfieldgroup_response__Date } ezmax_api_definition__full_ezsigntemplateformfieldgroup_response__e;
