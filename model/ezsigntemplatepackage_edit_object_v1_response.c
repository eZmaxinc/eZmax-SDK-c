...
static ezsigntemplatepackage_edit_object_v1_response_t *ezsigntemplatepackage_edit_object_v1_response_create_internal(
    ...
    memset(ezsigntemplatepackage_edit_object_v1_response_local_var, 0, sizeof(ezsigntemplatepackage_edit_object_v1_response_t));
    ezsigntemplatepackage_edit_object_v1_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezsigntemplatepackage_edit_object_v1_response_t *ezsigntemplatepackage_edit_object_v1_response_create(
    common_response_obj_debug_payload_t *obj_debug_payload,
    common_response_obj_debug_t *obj_debug
    ) {
    ezsigntemplatepackage_edit_object_v1_response_t *result = ezsigntemplatepackage_edit_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug
        );
    if (!result) {
...
void ezsigntemplatepackage_edit_object_v1_response_free(ezsigntemplatepackage_edit_object_v1_response_t *ezsigntemplatepackage_edit_object_v1_response) {
    ...
    if(ezsigntemplatepackage_edit_object_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsigntemplatepackage_edit_object_v1_response_free");
        return ;
    }
...
ezsigntemplatepackage_edit_object_v1_response_t *ezsigntemplatepackage_edit_object_v1_response_parseFromJSON(cJSON *ezsigntemplatepackage_edit_object_v1_responseJSON){
    ...
    ezsigntemplatepackage_edit_object_v1_response_local_var = ezsigntemplatepackage_edit_object_v1_response_create_internal (
