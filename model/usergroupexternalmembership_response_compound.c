...
static usergroupexternalmembership_response_compound_t *usergroupexternalmembership_response_compound_create_internal(
    ...
    memset(usergroupexternalmembership_response_compound_local_var, 0, sizeof(usergroupexternalmembership_response_compound_t));
...
__attribute__((deprecated)) usergroupexternalmembership_response_compound_t *usergroupexternalmembership_response_compound_create(
    ...
    usergroupexternalmembership_response_compound_t *result = usergroupexternalmembership_response_compound_create_internal (
...
void usergroupexternalmembership_response_compound_free(usergroupexternalmembership_response_compound_t *usergroupexternalmembership_response_compound) {
    ...
    if (usergroupexternalmembership_response_compound->pki_usergroupexternalmembership_id) {
        free(usergroupexternalmembership_response_compound->pki_usergroupexternalmembership_id);
        usergroupexternalmembership_response_compound->pki_usergroupexternalmembership_id = NULL;
    }
    if (usergroupexternalmembership_response_compound->fki_usergroupexternal_id) {
        free(usergroupexternalmembership_response_compound->fki_usergroupexternal_id);
        usergroupexternalmembership_response_compound->fki_usergroupexternal_id = NULL;
    }
    if (usergroupexternalmembership_response_compound->fki_user_id) {
        free(usergroupexternalmembership_response_compound->fki_user_id);
        usergroupexternalmembership_response_compound->fki_user_id = NULL;
    }
...
usergroupexternalmembership_response_compound_t *usergroupexternalmembership_response_compound_parseFromJSON(cJSON *usergroupexternalmembership_response_compoundJSON){
    ...
    // define the local variable for usergroupexternalmembership_response_compound->pki_usergroupexternalmembership_id
    int *pki_usergroupexternalmembership_id_local_var = NULL;

    // define the local variable for usergroupexternalmembership_response_compound->fki_usergroupexternal_id
    int *fki_usergroupexternal_id_local_var = NULL;

    // define the local variable for usergroupexternalmembership_response_compound->fki_user_id
