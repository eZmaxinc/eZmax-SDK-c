...
// Enum  for ezsigntemplatedocumentpagerecognition_response_compound

typedef enum  { ezmax_api_definition__full_ezsigntemplatedocumentpagerecognition_response_compound__NULL = 0, ezmax_api_definition__full_ezsigntemplatedocumentpagerecognition_response_compound__eq, ezmax_api_definition__full_ezsigntemplatedocumentpagerecognition_response_compound__in, ezmax_api_definition__full_ezsigntemplatedocumentpagerecognition_response_compound__similar } ezmax_api_definition__full_ezsigntemplatedocumentpagerecognition_response_compound__e;
...
typedef enum  { ezmax_api_definition__full_ezsigntemplatedocumentpagerecognition_response_compound__NULL = 0, ezmax_api_definition__full_ezsigntemplatedocumentpagerecognition_response_compound__FirstLine, ezmax_api_definition__full_ezsigntemplatedocumentpagerecognition_response_compound__LastLine, ezmax_api_definition__full_ezsigntemplatedocumentpagerecognition_response_compound__Page, ezmax_api_definition__full_ezsigntemplatedocumentpagerecognition_response_compound__Region } ezmax_api_definition__full_ezsigntemplatedocumentpagerecognition_response_compound__e;
