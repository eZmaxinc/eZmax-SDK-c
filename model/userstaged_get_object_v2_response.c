...
static userstaged_get_object_v2_response_t *userstaged_get_object_v2_response_create_internal(
    ...
    memset(userstaged_get_object_v2_response_local_var, 0, sizeof(userstaged_get_object_v2_response_t));
    userstaged_get_object_v2_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) userstaged_get_object_v2_response_t *userstaged_get_object_v2_response_create(
    common_response_obj_debug_payload_t *obj_debug_payload,
    common_response_obj_debug_t *obj_debug,
    userstaged_get_object_v2_response_m_payload_t *m_payload
    ) {
    userstaged_get_object_v2_response_t *result = userstaged_get_object_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void userstaged_get_object_v2_response_free(userstaged_get_object_v2_response_t *userstaged_get_object_v2_response) {
    ...
    if(userstaged_get_object_v2_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "userstaged_get_object_v2_response_free");
        return ;
    }
...
userstaged_get_object_v2_response_t *userstaged_get_object_v2_response_parseFromJSON(cJSON *userstaged_get_object_v2_responseJSON){
    ...
    userstaged_get_object_v2_response_local_var = userstaged_get_object_v2_response_create_internal (
