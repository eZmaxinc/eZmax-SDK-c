/*
 * creditcardclient_get_object_v2_response.h
 *
 * Response for GET /2/object/creditcardclient/{pkiCreditcardclientID}
 */

#ifndef _creditcardclient_get_object_v2_response_H_
#define _creditcardclient_get_object_v2_response_H_
...
typedef struct creditcardclient_get_object_v2_response_t creditcardclient_get_object_v2_response_t;
...
typedef struct creditcardclient_get_object_v2_response_t {
    struct common_response_obj_debug_payload_t *obj_debug_payload; //model
    struct common_response_obj_debug_t *obj_debug; //model
    struct creditcardclient_get_object_v2_response_m_payload_t *m_payload; //model
...
#endif /* _creditcardclient_get_object_v2_response_H_ */
