/*
 * inscriptionchecklist_get_autocomplete_v3_response.h
 *
 * Response for GET /3/object/inscriptionchecklist/getAutocomplete
 */

#ifndef _inscriptionchecklist_get_autocomplete_v3_response_H_
#define _inscriptionchecklist_get_autocomplete_v3_response_H_
...
typedef struct inscriptionchecklist_get_autocomplete_v3_response_t inscriptionchecklist_get_autocomplete_v3_response_t;
...
typedef struct inscriptionchecklist_get_autocomplete_v3_response_t {
    struct common_response_obj_debug_payload_t *obj_debug_payload; //model
    struct common_response_obj_debug_t *obj_debug; //model
    struct inscriptionchecklist_get_autocomplete_v3_response_m_payload_t *m_payload; //model
...
#endif /* _inscriptionchecklist_get_autocomplete_v3_response_H_ */
