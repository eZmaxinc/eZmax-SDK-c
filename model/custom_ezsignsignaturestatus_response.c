...
char* e_ezsignsignaturestatus_steptypecustom_ezsignsignaturestatus_response_ToString(ezmax_api_definition_custom_ezsignsignaturestatus_response_EEZSIGNSIGNATURESTATUSSTEPTYPE_e e_ezsignsignaturestatus_steptype) {
...
ezmax_api_definition_custom_ezsignsignaturestatus_response_EEZSIGNSIGNATURESTATUSSTEPTYPE_e e_ezsignsignaturestatus_steptypecustom_ezsignsignaturestatus_response_FromString(char* e_ezsignsignaturestatus_steptype){
...
custom_ezsignsignaturestatus_response_t *custom_ezsignsignaturestatus_response_parseFromJSON(cJSON *custom_ezsignsignaturestatus_responseJSON){
    ...
    ezmax_api_definition_custom_ezsignsignaturestatus_response_EEZSIGNSIGNATURESTATUSSTEPTYPE_e e_ezsignsignaturestatus_steptypeVariable;
