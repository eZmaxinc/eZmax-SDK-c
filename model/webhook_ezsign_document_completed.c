...
static webhook_ezsign_document_completed_t *webhook_ezsign_document_completed_create_internal(
    ...
    memset(webhook_ezsign_document_completed_local_var, 0, sizeof(webhook_ezsign_document_completed_t));
...
__attribute__((deprecated)) webhook_ezsign_document_completed_t *webhook_ezsign_document_completed_create(
    ...
    webhook_ezsign_document_completed_t *result = webhook_ezsign_document_completed_create_internal (
        obj_webhook,
        a_obj_attempt,
        obj_ezsigndocument
        );
