...
static user_create_object_v1_response_t *user_create_object_v1_response_create_internal(
    ...
    memset(user_create_object_v1_response_local_var, 0, sizeof(user_create_object_v1_response_t));
    user_create_object_v1_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) user_create_object_v1_response_t *user_create_object_v1_response_create(
    ...
    user_create_object_v1_response_t *result = user_create_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void user_create_object_v1_response_free(user_create_object_v1_response_t *user_create_object_v1_response) {
    ...
    if(user_create_object_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "user_create_object_v1_response_free");
        return ;
    }
...
user_create_object_v1_response_t *user_create_object_v1_response_parseFromJSON(cJSON *user_create_object_v1_responseJSON){
    ...
    user_create_object_v1_response_local_var = user_create_object_v1_response_create_internal (
