...
static ezsignsignature_create_object_v2_request_t *ezsignsignature_create_object_v2_request_create_internal(
    ...
    memset(ezsignsignature_create_object_v2_request_local_var, 0, sizeof(ezsignsignature_create_object_v2_request_t));
    ezsignsignature_create_object_v2_request_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezsignsignature_create_object_v2_request_t *ezsignsignature_create_object_v2_request_create(
    list_t *a_obj_ezsignsignature
    ) {
    ezsignsignature_create_object_v2_request_t *result = ezsignsignature_create_object_v2_request_create_internal (
...
void ezsignsignature_create_object_v2_request_free(ezsignsignature_create_object_v2_request_t *ezsignsignature_create_object_v2_request) {
    ...
    if(ezsignsignature_create_object_v2_request->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsignsignature_create_object_v2_request_free");
        return ;
    }
...
ezsignsignature_create_object_v2_request_t *ezsignsignature_create_object_v2_request_parseFromJSON(cJSON *ezsignsignature_create_object_v2_requestJSON){
    ...
    ezsignsignature_create_object_v2_request_local_var = ezsignsignature_create_object_v2_request_create_internal (
