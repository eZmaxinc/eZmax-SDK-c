...
static ezsigntemplate_response_compound_t *ezsigntemplate_response_compound_create_internal(
    ...
    memset(ezsigntemplate_response_compound_local_var, 0, sizeof(ezsigntemplate_response_compound_t));
    ...
    ezsigntemplate_response_compound_local_var->a_obj_ezsigntemplateannotation = a_obj_ezsigntemplateannotation;
...
__attribute__((deprecated)) ezsigntemplate_response_compound_t *ezsigntemplate_response_compound_create(
    ...
    ezsigntemplate_response_compound_t *result = ezsigntemplate_response_compound_create_internal (
...
void ezsigntemplate_response_compound_free(ezsigntemplate_response_compound_t *ezsigntemplate_response_compound) {
    ...
    if (ezsigntemplate_response_compound->pki_ezsigntemplate_id) {
        free(ezsigntemplate_response_compound->pki_ezsigntemplate_id);
        ezsigntemplate_response_compound->pki_ezsigntemplate_id = NULL;
    }
    if (ezsigntemplate_response_compound->fki_ezsigntemplatedocument_id) {
        free(ezsigntemplate_response_compound->fki_ezsigntemplatedocument_id);
        ezsigntemplate_response_compound->fki_ezsigntemplatedocument_id = NULL;
    }
    if (ezsigntemplate_response_compound->fki_ezsignfoldertype_id) {
        free(ezsigntemplate_response_compound->fki_ezsignfoldertype_id);
        ezsigntemplate_response_compound->fki_ezsignfoldertype_id = NULL;
    }
    if (ezsigntemplate_response_compound->fki_language_id) {
        free(ezsigntemplate_response_compound->fki_language_id);
        ezsigntemplate_response_compound->fki_language_id = NULL;
    }
    if (ezsigntemplate_response_compound->fki_ezdoctemplatedocument_id) {
        free(ezsigntemplate_response_compound->fki_ezdoctemplatedocument_id);
        ezsigntemplate_response_compound->fki_ezdoctemplatedocument_id = NULL;
    }
    ...
    if (ezsigntemplate_response_compound->b_ezsigntemplate_adminonly) {
        free(ezsigntemplate_response_compound->b_ezsigntemplate_adminonly);
        ezsigntemplate_response_compound->b_ezsigntemplate_adminonly = NULL;
    }
    ...
    if (ezsigntemplate_response_compound->b_ezsigntemplate_editallowed) {
        free(ezsigntemplate_response_compound->b_ezsigntemplate_editallowed);
        ezsigntemplate_response_compound->b_ezsigntemplate_editallowed = NULL;
    }
    ...
    if (ezsigntemplate_response_compound->a_obj_ezsigntemplateannotation) {
        list_ForEach(listEntry, ezsigntemplate_response_compound->a_obj_ezsigntemplateannotation) {
            ezsigntemplateannotation_response_compound_free(listEntry->data);
        }
        list_freeList(ezsigntemplate_response_compound->a_obj_ezsigntemplateannotation);
        ezsigntemplate_response_compound->a_obj_ezsigntemplateannotation = NULL;
    }
...
cJSON *ezsigntemplate_response_compound_convertToJSON(ezsigntemplate_response_compound_t *ezsigntemplate_response_compound) {
    ...
    // ezsigntemplate_response_compound->a_obj_ezsigntemplateannotation
    if(ezsigntemplate_response_compound->a_obj_ezsigntemplateannotation) {
    ...
    if (ezsigntemplate_response_compound->a_obj_ezsigntemplateannotation) {
    list_ForEach(a_obj_ezsigntemplateannotationListEntry, ezsigntemplate_response_compound->a_obj_ezsigntemplateannotation) {
...
ezsigntemplate_response_compound_t *ezsigntemplate_response_compound_parseFromJSON(cJSON *ezsigntemplate_response_compoundJSON){
    ...
    // define the local variable for ezsigntemplate_response_compound->pki_ezsigntemplate_id
    int *pki_ezsigntemplate_id_local_var = NULL;

    // define the local variable for ezsigntemplate_response_compound->fki_ezsigntemplatedocument_id
    int *fki_ezsigntemplatedocument_id_local_var = NULL;

    // define the local variable for ezsigntemplate_response_compound->fki_ezsignfoldertype_id
    int *fki_ezsignfoldertype_id_local_var = NULL;

    // define the local variable for ezsigntemplate_response_compound->fki_language_id
    int *fki_language_id_local_var = NULL;

    // define the local variable for ezsigntemplate_response_compound->fki_ezdoctemplatedocument_id
    ...
    // define the local variable for ezsigntemplate_response_compound->b_ezsigntemplate_adminonly
    ...
    // define the local variable for ezsigntemplate_response_compound->b_ezsigntemplate_editallowed
    ...
    // define the local list for ezsigntemplate_response_compound->a_obj_ezsigntemplateannotation
    ...
    *b_ezsigntemplate_editallowed_local_var = b_ezsigntemplate_editallowed->valueint;
    ...
    // ezsigntemplate_response_compound->a_obj_ezsigntemplateannotation
    cJSON *a_obj_ezsigntemplateannotation = cJSON_GetObjectItemCaseSensitive(ezsigntemplate_response_compoundJSON, "a_objEzsigntemplateannotation");
