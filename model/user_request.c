...
char* e_user_typeuser_request_ToString(ezmax_api_definition__full_user_request__e e_user_type) {
    char* e_user_typeArray[] =  { "NULL", "AgentBroker", "Assistant", "Employee", "EzsignUser", "Normal" };
    return e_user_typeArray[e_user_type];
}

ezmax_api_definition__full_user_request__e e_user_typeuser_request_FromString(char* e_user_type){
...
char* e_user_logintypeuser_request_ToString(ezmax_api_definition__full_user_request__e e_user_logintype) {
    char* e_user_logintypeArray[] =  { "NULL", "Password", "PasswordPhone", "PasswordQuestion" };
    return e_user_logintypeArray[e_user_logintype];
}

ezmax_api_definition__full_user_request__e e_user_logintypeuser_request_FromString(char* e_user_logintype){
    int stringToReturn = 0;
    char *e_user_logintypeArray[] =  { "NULL", "Password", "PasswordPhone", "PasswordQuestion" };
...
char* e_user_ezsignaccessuser_request_ToString(ezmax_api_definition__full_user_request__e e_user_ezsignaccess) {
...
ezmax_api_definition__full_user_request__e e_user_ezsignaccessuser_request_FromString(char* e_user_ezsignaccess){
    int stringToReturn = 0;
    char *e_user_ezsignaccessArray[] =  { "NULL", "No", "PaidByOffice", "PerDocument", "Prepaid" };
