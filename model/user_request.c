...
void user_request_free(user_request_t *user_request) {
    ...
    if (user_request->obj_email) {
        email_request_free(user_request->obj_email);
        user_request->obj_email = NULL;
    }
    if (user_request->obj_phone_home) {
        phone_request_free(user_request->obj_phone_home);
        user_request->obj_phone_home = NULL;
    }
    if (user_request->obj_phone_sms) {
        phone_request_free(user_request->obj_phone_sms);
...
cJSON *user_request_convertToJSON(user_request_t *user_request) {
    ...
    cJSON *obj_email_local_JSON = email_request_convertToJSON(user_request->obj_email);
    ...
    if(user_request->obj_phone_home) {
    cJSON *obj_phone_home_local_JSON = phone_request_convertToJSON(user_request->obj_phone_home);
    ...
    if(user_request->obj_phone_sms) {
    cJSON *obj_phone_sms_local_JSON = phone_request_convertToJSON(user_request->obj_phone_sms);
