...
ezsignsignature_delete_object_v1_response_t *ezsignsignature_delete_object_v1_response_create(
...
ezsignsignature_delete_object_v1_response_t *ezsignsignature_delete_object_v1_response_parseFromJSON(cJSON *ezsignsignature_delete_object_v1_responseJSON){
    ...
    ezsignsignature_delete_object_v1_response_local_var = ezsignsignature_delete_object_v1_response_create (
