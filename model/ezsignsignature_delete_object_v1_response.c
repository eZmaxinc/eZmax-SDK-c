...
static ezsignsignature_delete_object_v1_response_t *ezsignsignature_delete_object_v1_response_create_internal(
    ...
    memset(ezsignsignature_delete_object_v1_response_local_var, 0, sizeof(ezsignsignature_delete_object_v1_response_t));
...
__attribute__((deprecated)) ezsignsignature_delete_object_v1_response_t *ezsignsignature_delete_object_v1_response_create(
    ...
    ezsignsignature_delete_object_v1_response_t *result = ezsignsignature_delete_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug
        );
    if (!result) {
