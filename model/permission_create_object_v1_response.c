...
static permission_create_object_v1_response_t *permission_create_object_v1_response_create_internal(
    ...
    memset(permission_create_object_v1_response_local_var, 0, sizeof(permission_create_object_v1_response_t));
...
__attribute__((deprecated)) permission_create_object_v1_response_t *permission_create_object_v1_response_create(
    ...
    permission_create_object_v1_response_t *result = permission_create_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
