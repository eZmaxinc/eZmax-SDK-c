...
static ezsigndiscussion_request_t *ezsigndiscussion_request_create_internal(
    ...
    memset(ezsigndiscussion_request_local_var, 0, sizeof(ezsigndiscussion_request_t));
...
__attribute__((deprecated)) ezsigndiscussion_request_t *ezsigndiscussion_request_create(
    ...
    ezsigndiscussion_request_t *result = ezsigndiscussion_request_create_internal (
...
void ezsigndiscussion_request_free(ezsigndiscussion_request_t *ezsigndiscussion_request) {
    ...
    if (ezsigndiscussion_request->pki_ezsigndiscussion_id) {
        free(ezsigndiscussion_request->pki_ezsigndiscussion_id);
        ezsigndiscussion_request->pki_ezsigndiscussion_id = NULL;
    }
    if (ezsigndiscussion_request->fki_ezsigndocument_id) {
        free(ezsigndiscussion_request->fki_ezsigndocument_id);
        ezsigndiscussion_request->fki_ezsigndocument_id = NULL;
    }
    if (ezsigndiscussion_request->i_ezsigndiscussion_pagenumber) {
        free(ezsigndiscussion_request->i_ezsigndiscussion_pagenumber);
        ezsigndiscussion_request->i_ezsigndiscussion_pagenumber = NULL;
    }
    if (ezsigndiscussion_request->i_ezsigndiscussion_x) {
        free(ezsigndiscussion_request->i_ezsigndiscussion_x);
        ezsigndiscussion_request->i_ezsigndiscussion_x = NULL;
    }
    if (ezsigndiscussion_request->i_ezsigndiscussion_y) {
        free(ezsigndiscussion_request->i_ezsigndiscussion_y);
        ezsigndiscussion_request->i_ezsigndiscussion_y = NULL;
    }
...
ezsigndiscussion_request_t *ezsigndiscussion_request_parseFromJSON(cJSON *ezsigndiscussion_requestJSON){
    ...
    // define the local variable for ezsigndiscussion_request->pki_ezsigndiscussion_id
    int *pki_ezsigndiscussion_id_local_var = NULL;

    // define the local variable for ezsigndiscussion_request->fki_ezsigndocument_id
    int *fki_ezsigndocument_id_local_var = NULL;

    // define the local variable for ezsigndiscussion_request->i_ezsigndiscussion_pagenumber
    int *i_ezsigndiscussion_pagenumber_local_var = NULL;

    // define the local variable for ezsigndiscussion_request->i_ezsigndiscussion_x
    int *i_ezsigndiscussion_x_local_var = NULL;

    // define the local variable for ezsigndiscussion_request->i_ezsigndiscussion_y
