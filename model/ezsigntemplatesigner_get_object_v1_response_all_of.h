/*
 * ezsigntemplatesigner_get_object_v1_response_all_of.h
 *
 * 
 */

#ifndef _ezsigntemplatesigner_get_object_v1_response_all_of_H_
#define _ezsigntemplatesigner_get_object_v1_response_all_of_H_
...
typedef struct ezsigntemplatesigner_get_object_v1_response_all_of_t ezsigntemplatesigner_get_object_v1_response_all_of_t;

#include "ezsigntemplatesigner_get_object_v1_response_m_payload.h"



typedef struct ezsigntemplatesigner_get_object_v1_response_all_of_t {
    struct ezsigntemplatesigner_get_object_v1_response_m_payload_t *m_payload; //model

} ezsigntemplatesigner_get_object_v1_response_all_of_t;
...
#endif /* _ezsigntemplatesigner_get_object_v1_response_all_of_H_ */
