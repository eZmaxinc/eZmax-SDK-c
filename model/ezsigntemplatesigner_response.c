...
static ezsigntemplatesigner_response_t *ezsigntemplatesigner_response_create_internal(
    ...
    memset(ezsigntemplatesigner_response_local_var, 0, sizeof(ezsigntemplatesigner_response_t));
...
__attribute__((deprecated)) ezsigntemplatesigner_response_t *ezsigntemplatesigner_response_create(
    ...
    ezsigntemplatesigner_response_t *result = ezsigntemplatesigner_response_create_internal (
...
void ezsigntemplatesigner_response_free(ezsigntemplatesigner_response_t *ezsigntemplatesigner_response) {
    ...
    if (ezsigntemplatesigner_response->pki_ezsigntemplatesigner_id) {
        free(ezsigntemplatesigner_response->pki_ezsigntemplatesigner_id);
        ezsigntemplatesigner_response->pki_ezsigntemplatesigner_id = NULL;
    }
    if (ezsigntemplatesigner_response->fki_ezsigntemplate_id) {
        free(ezsigntemplatesigner_response->fki_ezsigntemplate_id);
        ezsigntemplatesigner_response->fki_ezsigntemplate_id = NULL;
    }
    if (ezsigntemplatesigner_response->fki_user_id) {
        free(ezsigntemplatesigner_response->fki_user_id);
        ezsigntemplatesigner_response->fki_user_id = NULL;
    }
    if (ezsigntemplatesigner_response->fki_usergroup_id) {
        free(ezsigntemplatesigner_response->fki_usergroup_id);
        ezsigntemplatesigner_response->fki_usergroup_id = NULL;
    }
    if (ezsigntemplatesigner_response->fki_ezdoctemplatedocument_id) {
        free(ezsigntemplatesigner_response->fki_ezdoctemplatedocument_id);
        ezsigntemplatesigner_response->fki_ezdoctemplatedocument_id = NULL;
    }
    if (ezsigntemplatesigner_response->b_ezsigntemplatesigner_receivecopy) {
        free(ezsigntemplatesigner_response->b_ezsigntemplatesigner_receivecopy);
        ezsigntemplatesigner_response->b_ezsigntemplatesigner_receivecopy = NULL;
    }
...
ezsigntemplatesigner_response_t *ezsigntemplatesigner_response_parseFromJSON(cJSON *ezsigntemplatesigner_responseJSON){
    ...
    // define the local variable for ezsigntemplatesigner_response->pki_ezsigntemplatesigner_id
    int *pki_ezsigntemplatesigner_id_local_var = NULL;

    // define the local variable for ezsigntemplatesigner_response->fki_ezsigntemplate_id
    int *fki_ezsigntemplate_id_local_var = NULL;

    // define the local variable for ezsigntemplatesigner_response->fki_user_id
    int *fki_user_id_local_var = NULL;

    // define the local variable for ezsigntemplatesigner_response->fki_usergroup_id
    int *fki_usergroup_id_local_var = NULL;

    // define the local variable for ezsigntemplatesigner_response->fki_ezdoctemplatedocument_id
    int *fki_ezdoctemplatedocument_id_local_var = NULL;

    // define the local variable for ezsigntemplatesigner_response->b_ezsigntemplatesigner_receivecopy
