...
static discussion_get_object_v2_response_t *discussion_get_object_v2_response_create_internal(
    ...
    memset(discussion_get_object_v2_response_local_var, 0, sizeof(discussion_get_object_v2_response_t));
...
__attribute__((deprecated)) discussion_get_object_v2_response_t *discussion_get_object_v2_response_create(
    ...
    discussion_get_object_v2_response_t *result = discussion_get_object_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
