...
static ezsigntemplate_get_autocomplete_v2_response_t *ezsigntemplate_get_autocomplete_v2_response_create_internal(
    ...
    memset(ezsigntemplate_get_autocomplete_v2_response_local_var, 0, sizeof(ezsigntemplate_get_autocomplete_v2_response_t));
...
__attribute__((deprecated)) ezsigntemplate_get_autocomplete_v2_response_t *ezsigntemplate_get_autocomplete_v2_response_create(
    ...
    ezsigntemplate_get_autocomplete_v2_response_t *result = ezsigntemplate_get_autocomplete_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
