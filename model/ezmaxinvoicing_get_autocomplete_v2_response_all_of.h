/*
 * ezmaxinvoicing_get_autocomplete_v2_response_all_of.h
 *
 * 
 */

#ifndef _ezmaxinvoicing_get_autocomplete_v2_response_all_of_H_
#define _ezmaxinvoicing_get_autocomplete_v2_response_all_of_H_
...
typedef struct ezmaxinvoicing_get_autocomplete_v2_response_all_of_t ezmaxinvoicing_get_autocomplete_v2_response_all_of_t;

#include "ezmaxinvoicing_get_autocomplete_v2_response_m_payload.h"



typedef struct ezmaxinvoicing_get_autocomplete_v2_response_all_of_t {
    struct ezmaxinvoicing_get_autocomplete_v2_response_m_payload_t *m_payload; //model

} ezmaxinvoicing_get_autocomplete_v2_response_all_of_t;
...
#endif /* _ezmaxinvoicing_get_autocomplete_v2_response_all_of_H_ */
