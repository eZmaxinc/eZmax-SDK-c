...
typedef enum { ezmax_api_definition__full_field_e_user_ezsignprepaid__NULL = 0, ezmax_api_definition__full_field_e_user_ezsignprepaid__No, ezmax_api_definition__full_field_e_user_ezsignprepaid__Basic, ezmax_api_definition__full_field_e_user_ezsignprepaid__Standard, ezmax_api_definition__full_field_e_user_ezsignprepaid__Pro } ezmax_api_definition__full_field_e_user_ezsignprepaid__e;
