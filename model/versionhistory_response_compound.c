...
char* e_versionhistory_usertypeversionhistory_response_compound_ToString(ezmax_api_definition__full_versionhistory_response_compound__e e_versionhistory_usertype) {
...
ezmax_api_definition__full_versionhistory_response_compound__e e_versionhistory_usertypeversionhistory_response_compound_FromString(char* e_versionhistory_usertype){
...
char* e_versionhistory_typeversionhistory_response_compound_ToString(ezmax_api_definition__full_versionhistory_response_compound__e e_versionhistory_type) {
...
ezmax_api_definition__full_versionhistory_response_compound__e e_versionhistory_typeversionhistory_response_compound_FromString(char* e_versionhistory_type){
    int stringToReturn = 0;
    char *e_versionhistory_typeArray[] =  { "NULL", "AgentBroker", "NewFeature", "Correction", "Modification", "ImportantMessage" };
...
void versionhistory_response_compound_free(versionhistory_response_compound_t *versionhistory_response_compound) {
    ...
    if (versionhistory_response_compound->e_versionhistory_usertype) {
        field_e_versionhistory_usertype_free(versionhistory_response_compound->e_versionhistory_usertype);
        versionhistory_response_compound->e_versionhistory_usertype = NULL;
    }
    ...
    if (versionhistory_response_compound->e_versionhistory_type) {
        field_e_versionhistory_type_free(versionhistory_response_compound->e_versionhistory_type);
        versionhistory_response_compound->e_versionhistory_type = NULL;
    }
...
cJSON *versionhistory_response_compound_convertToJSON(versionhistory_response_compound_t *versionhistory_response_compound) {
    ...
    if(versionhistory_response_compound->e_versionhistory_usertype != ezmax_api_definition__full_versionhistory_response_compound__NULL) {
    ...
    if (ezmax_api_definition__full_versionhistory_response_compound__NULL == versionhistory_response_compound->e_versionhistory_type) {
        goto fail;
    }
...
versionhistory_response_compound_t *versionhistory_response_compound_parseFromJSON(cJSON *versionhistory_response_compoundJSON){
    ...
    versionhistory_response_compound_local_var = versionhistory_response_compound_create (
