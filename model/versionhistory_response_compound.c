...
static versionhistory_response_compound_t *versionhistory_response_compound_create_internal(
    ...
    memset(versionhistory_response_compound_local_var, 0, sizeof(versionhistory_response_compound_t));
...
__attribute__((deprecated)) versionhistory_response_compound_t *versionhistory_response_compound_create(
    ...
    versionhistory_response_compound_t *result = versionhistory_response_compound_create_internal (
...
void versionhistory_response_compound_free(versionhistory_response_compound_t *versionhistory_response_compound) {
    ...
    if (versionhistory_response_compound->pki_versionhistory_id) {
        free(versionhistory_response_compound->pki_versionhistory_id);
        versionhistory_response_compound->pki_versionhistory_id = NULL;
    }
    if (versionhistory_response_compound->fki_module_id) {
        free(versionhistory_response_compound->fki_module_id);
        versionhistory_response_compound->fki_module_id = NULL;
    }
    if (versionhistory_response_compound->fki_modulesection_id) {
        free(versionhistory_response_compound->fki_modulesection_id);
        versionhistory_response_compound->fki_modulesection_id = NULL;
    }
    ...
    if (versionhistory_response_compound->b_versionhistory_draft) {
        free(versionhistory_response_compound->b_versionhistory_draft);
        versionhistory_response_compound->b_versionhistory_draft = NULL;
    }
...
versionhistory_response_compound_t *versionhistory_response_compound_parseFromJSON(cJSON *versionhistory_response_compoundJSON){
    ...
    // define the local variable for versionhistory_response_compound->pki_versionhistory_id
    int *pki_versionhistory_id_local_var = NULL;

    // define the local variable for versionhistory_response_compound->fki_module_id
    int *fki_module_id_local_var = NULL;

    // define the local variable for versionhistory_response_compound->fki_modulesection_id
    ...
    // define the local variable for versionhistory_response_compound->b_versionhistory_draft
