...
static ezsigntemplateglobalannotation_response_compound_t *ezsigntemplateglobalannotation_response_compound_create_internal(
    ...
    memset(ezsigntemplateglobalannotation_response_compound_local_var, 0, sizeof(ezsigntemplateglobalannotation_response_compound_t));
    ...
    ezsigntemplateglobalannotation_response_compound_local_var->obj_textstylestatic = obj_textstylestatic;
    ...
    ezsigntemplateglobalannotation_response_compound_local_var->i_ezsigntemplateglobaldocumentpage_pagenumber = i_ezsigntemplateglobaldocumentpage_pagenumber;
...
__attribute__((deprecated)) ezsigntemplateglobalannotation_response_compound_t *ezsigntemplateglobalannotation_response_compound_create(
    ...
    ezsigntemplateglobalannotation_response_compound_t *result = ezsigntemplateglobalannotation_response_compound_create_internal (
...
void ezsigntemplateglobalannotation_response_compound_free(ezsigntemplateglobalannotation_response_compound_t *ezsigntemplateglobalannotation_response_compound) {
    ...
    if (ezsigntemplateglobalannotation_response_compound->pki_ezsigntemplateglobalannotation_id) {
        free(ezsigntemplateglobalannotation_response_compound->pki_ezsigntemplateglobalannotation_id);
        ezsigntemplateglobalannotation_response_compound->pki_ezsigntemplateglobalannotation_id = NULL;
    }
    if (ezsigntemplateglobalannotation_response_compound->fki_textstylestatic_id) {
        free(ezsigntemplateglobalannotation_response_compound->fki_textstylestatic_id);
        ezsigntemplateglobalannotation_response_compound->fki_textstylestatic_id = NULL;
    }
    if (ezsigntemplateglobalannotation_response_compound->obj_textstylestatic) {
        textstylestatic_request_compound_free(ezsigntemplateglobalannotation_response_compound->obj_textstylestatic);
        ezsigntemplateglobalannotation_response_compound->obj_textstylestatic = NULL;
    }
    if (ezsigntemplateglobalannotation_response_compound->i_ezsigntemplateglobalannotation_x) {
        free(ezsigntemplateglobalannotation_response_compound->i_ezsigntemplateglobalannotation_x);
        ezsigntemplateglobalannotation_response_compound->i_ezsigntemplateglobalannotation_x = NULL;
    }
    if (ezsigntemplateglobalannotation_response_compound->i_ezsigntemplateglobalannotation_y) {
        free(ezsigntemplateglobalannotation_response_compound->i_ezsigntemplateglobalannotation_y);
        ezsigntemplateglobalannotation_response_compound->i_ezsigntemplateglobalannotation_y = NULL;
    }
    if (ezsigntemplateglobalannotation_response_compound->i_ezsigntemplateglobalannotation_width) {
        free(ezsigntemplateglobalannotation_response_compound->i_ezsigntemplateglobalannotation_width);
        ezsigntemplateglobalannotation_response_compound->i_ezsigntemplateglobalannotation_width = NULL;
    }
    if (ezsigntemplateglobalannotation_response_compound->i_ezsigntemplateglobalannotation_height) {
        free(ezsigntemplateglobalannotation_response_compound->i_ezsigntemplateglobalannotation_height);
        ezsigntemplateglobalannotation_response_compound->i_ezsigntemplateglobalannotation_height = NULL;
    }
    if (ezsigntemplateglobalannotation_response_compound->i_ezsigntemplateglobaldocumentpage_pagenumber) {
        free(ezsigntemplateglobalannotation_response_compound->i_ezsigntemplateglobaldocumentpage_pagenumber);
        ezsigntemplateglobalannotation_response_compound->i_ezsigntemplateglobaldocumentpage_pagenumber = NULL;
    }
...
cJSON *ezsigntemplateglobalannotation_response_compound_convertToJSON(ezsigntemplateglobalannotation_response_compound_t *ezsigntemplateglobalannotation_response_compound) {
    ...
    // ezsigntemplateglobalannotation_response_compound->obj_textstylestatic
    if(ezsigntemplateglobalannotation_response_compound->obj_textstylestatic) {
    cJSON *obj_textstylestatic_local_JSON = textstylestatic_request_compound_convertToJSON(ezsigntemplateglobalannotation_response_compound->obj_textstylestatic);
    ...
    // ezsigntemplateglobalannotation_response_compound->i_ezsigntemplateglobaldocumentpage_pagenumber
    if (!ezsigntemplateglobalannotation_response_compound->i_ezsigntemplateglobaldocumentpage_pagenumber) {
        goto fail;
    }
    if(cJSON_AddNumberToObject(item, "iEzsigntemplateglobaldocumentpagePagenumber", *ezsigntemplateglobalannotation_response_compound->i_ezsigntemplateglobaldocumentpage_pagenumber) == NULL) {
    goto fail; //Numeric
    }
...
ezsigntemplateglobalannotation_response_compound_t *ezsigntemplateglobalannotation_response_compound_parseFromJSON(cJSON *ezsigntemplateglobalannotation_response_compoundJSON){
    ...
    // define the local variable for ezsigntemplateglobalannotation_response_compound->pki_ezsigntemplateglobalannotation_id
    int *pki_ezsigntemplateglobalannotation_id_local_var = NULL;

    // define the local variable for ezsigntemplateglobalannotation_response_compound->fki_textstylestatic_id
    int *fki_textstylestatic_id_local_var = NULL;

    // define the local variable for ezsigntemplateglobalannotation_response_compound->obj_textstylestatic
    ...
    // define the local variable for ezsigntemplateglobalannotation_response_compound->i_ezsigntemplateglobalannotation_x
    int *i_ezsigntemplateglobalannotation_x_local_var = NULL;

    // define the local variable for ezsigntemplateglobalannotation_response_compound->i_ezsigntemplateglobalannotation_y
    int *i_ezsigntemplateglobalannotation_y_local_var = NULL;

    // define the local variable for ezsigntemplateglobalannotation_response_compound->i_ezsigntemplateglobalannotation_width
    int *i_ezsigntemplateglobalannotation_width_local_var = NULL;

    // define the local variable for ezsigntemplateglobalannotation_response_compound->i_ezsigntemplateglobalannotation_height
    int *i_ezsigntemplateglobalannotation_height_local_var = NULL;

    // define the local variable for ezsigntemplateglobalannotation_response_compound->i_ezsigntemplateglobaldocumentpage_pagenumber
    ...
    *fki_textstylestatic_id_local_var = fki_textstylestatic_id->valuedouble;
    ...
    // ezsigntemplateglobalannotation_response_compound->obj_textstylestatic
    cJSON *obj_textstylestatic = cJSON_GetObjectItemCaseSensitive(ezsigntemplateglobalannotation_response_compoundJSON, "objTextstylestatic");
    ...
    *i_ezsigntemplateglobalannotation_height_local_var = i_ezsigntemplateglobalannotation_height->valuedouble;
    ...
    // ezsigntemplateglobalannotation_response_compound->i_ezsigntemplateglobaldocumentpage_pagenumber
    cJSON *i_ezsigntemplateglobaldocumentpage_pagenumber = cJSON_GetObjectItemCaseSensitive(ezsigntemplateglobalannotation_response_compoundJSON, "iEzsigntemplateglobaldocumentpagePagenumber");
