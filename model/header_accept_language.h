...
typedef enum { ezmax_api_definition__full_header_accept_language__NULL = 0, ezmax_api_definition__full_header_accept_language__*, ezmax_api_definition__full_header_accept_language__en, ezmax_api_definition__full_header_accept_language__fr } ezmax_api_definition__full_header_accept_language__e;
