...
char* a_e_ezsignsignature_typeezsignsignature_get_ezsignsignatures_automatic_v1_response_m_payload_ToString(ezmax_api_definition__full_ezsignsignature_get_ezsignsignatures_automatic_v1_response_m_payload__e a_e_ezsignsignature_type) {
...
ezmax_api_definition__full_ezsignsignature_get_ezsignsignatures_automatic_v1_response_m_payload__e a_e_ezsignsignature_typeezsignsignature_get_ezsignsignatures_automatic_v1_response_m_payload_FromString(char* a_e_ezsignsignature_type) {
...
cJSON *ezsignsignature_get_ezsignsignatures_automatic_v1_response_m_payload_convertToJSON(ezsignsignature_get_ezsignsignatures_automatic_v1_response_m_payload_t *ezsignsignature_get_ezsignsignatures_automatic_v1_response_m_payload) {
    ...
    if (ezmax_api_definition__full_ezsignsignature_get_ezsignsignatures_automatic_v1_response_m_payload_AEEZSIGNSIGNATURETYPE_NULL == ezsignsignature_get_ezsignsignatures_automatic_v1_response_m_payload->a_e_ezsignsignature_type) {
        goto fail;
    }
...
ezsignsignature_get_ezsignsignatures_automatic_v1_response_m_payload_t *ezsignsignature_get_ezsignsignatures_automatic_v1_response_m_payload_parseFromJSON(cJSON *ezsignsignature_get_ezsignsignatures_automatic_v1_response_m_payloadJSON){
    ...
    ezsignsignature_get_ezsignsignatures_automatic_v1_response_m_payload_local_var = ezsignsignature_get_ezsignsignatures_automatic_v1_response_m_payload_create (
