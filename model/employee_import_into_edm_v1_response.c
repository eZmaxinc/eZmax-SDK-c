...
static employee_import_into_edm_v1_response_t *employee_import_into_edm_v1_response_create_internal(
    ...
    memset(employee_import_into_edm_v1_response_local_var, 0, sizeof(employee_import_into_edm_v1_response_t));
...
__attribute__((deprecated)) employee_import_into_edm_v1_response_t *employee_import_into_edm_v1_response_create(
    ...
    employee_import_into_edm_v1_response_t *result = employee_import_into_edm_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
