...
typedef enum  { ezmax_api_definition__full_ezsigntemplate_response_compound__NULL = 0, ezmax_api_definition__full_ezsigntemplate_response_compound__User, ezmax_api_definition__full_ezsigntemplate_response_compound__Usergroup, ezmax_api_definition__full_ezsigntemplate_response_compound__Company } ezmax_api_definition__full_ezsigntemplate_response_compound__e;
