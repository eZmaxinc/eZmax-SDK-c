...
static customer_import_into_edm_v1_request_t *customer_import_into_edm_v1_request_create_internal(
    ...
    memset(customer_import_into_edm_v1_request_local_var, 0, sizeof(customer_import_into_edm_v1_request_t));
...
__attribute__((deprecated)) customer_import_into_edm_v1_request_t *customer_import_into_edm_v1_request_create(
    ...
    customer_import_into_edm_v1_request_t *result = customer_import_into_edm_v1_request_create_internal (
        a_obj_attachment
        );
    if (!result) {
    }
