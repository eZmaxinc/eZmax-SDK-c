...
static ezsignformfield_request_t *ezsignformfield_request_create_internal(
    ...
    memset(ezsignformfield_request_local_var, 0, sizeof(ezsignformfield_request_t));
...
__attribute__((deprecated)) ezsignformfield_request_t *ezsignformfield_request_create(
    ...
    ezsignformfield_request_t *result = ezsignformfield_request_create_internal (
...
void ezsignformfield_request_free(ezsignformfield_request_t *ezsignformfield_request) {
    ...
    if (ezsignformfield_request->pki_ezsignformfield_id) {
        free(ezsignformfield_request->pki_ezsignformfield_id);
        ezsignformfield_request->pki_ezsignformfield_id = NULL;
    }
    if (ezsignformfield_request->i_ezsignpage_pagenumber) {
        free(ezsignformfield_request->i_ezsignpage_pagenumber);
        ezsignformfield_request->i_ezsignpage_pagenumber = NULL;
    }
    ...
    if (ezsignformfield_request->i_ezsignformfield_x) {
        free(ezsignformfield_request->i_ezsignformfield_x);
        ezsignformfield_request->i_ezsignformfield_x = NULL;
    }
    if (ezsignformfield_request->i_ezsignformfield_y) {
        free(ezsignformfield_request->i_ezsignformfield_y);
        ezsignformfield_request->i_ezsignformfield_y = NULL;
    }
    if (ezsignformfield_request->i_ezsignformfield_width) {
        free(ezsignformfield_request->i_ezsignformfield_width);
        ezsignformfield_request->i_ezsignformfield_width = NULL;
    }
    if (ezsignformfield_request->i_ezsignformfield_height) {
        free(ezsignformfield_request->i_ezsignformfield_height);
        ezsignformfield_request->i_ezsignformfield_height = NULL;
    }
    if (ezsignformfield_request->b_ezsignformfield_autocomplete) {
        free(ezsignformfield_request->b_ezsignformfield_autocomplete);
        ezsignformfield_request->b_ezsignformfield_autocomplete = NULL;
    }
    if (ezsignformfield_request->b_ezsignformfield_selected) {
        free(ezsignformfield_request->b_ezsignformfield_selected);
        ezsignformfield_request->b_ezsignformfield_selected = NULL;
    }
...
ezsignformfield_request_t *ezsignformfield_request_parseFromJSON(cJSON *ezsignformfield_requestJSON){
    ...
    // define the local variable for ezsignformfield_request->pki_ezsignformfield_id
    int *pki_ezsignformfield_id_local_var = NULL;

    // define the local variable for ezsignformfield_request->i_ezsignpage_pagenumber
    ...
    // define the local variable for ezsignformfield_request->i_ezsignformfield_x
    int *i_ezsignformfield_x_local_var = NULL;

    // define the local variable for ezsignformfield_request->i_ezsignformfield_y
    int *i_ezsignformfield_y_local_var = NULL;

    // define the local variable for ezsignformfield_request->i_ezsignformfield_width
    int *i_ezsignformfield_width_local_var = NULL;

    // define the local variable for ezsignformfield_request->i_ezsignformfield_height
    int *i_ezsignformfield_height_local_var = NULL;

    // define the local variable for ezsignformfield_request->b_ezsignformfield_autocomplete
    int *b_ezsignformfield_autocomplete_local_var = NULL;

    // define the local variable for ezsignformfield_request->b_ezsignformfield_selected
