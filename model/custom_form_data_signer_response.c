...
static custom_form_data_signer_response_t *custom_form_data_signer_response_create_internal(
    ...
    memset(custom_form_data_signer_response_local_var, 0, sizeof(custom_form_data_signer_response_t));
...
__attribute__((deprecated)) custom_form_data_signer_response_t *custom_form_data_signer_response_create(
    ...
    custom_form_data_signer_response_t *result = custom_form_data_signer_response_create_internal (
...
void custom_form_data_signer_response_free(custom_form_data_signer_response_t *custom_form_data_signer_response) {
    ...
    if (custom_form_data_signer_response->fki_ezsignfoldersignerassociation_id) {
        free(custom_form_data_signer_response->fki_ezsignfoldersignerassociation_id);
        custom_form_data_signer_response->fki_ezsignfoldersignerassociation_id = NULL;
    }
    if (custom_form_data_signer_response->fki_user_id) {
        free(custom_form_data_signer_response->fki_user_id);
        custom_form_data_signer_response->fki_user_id = NULL;
    }
...
custom_form_data_signer_response_t *custom_form_data_signer_response_parseFromJSON(cJSON *custom_form_data_signer_responseJSON){
    ...
    // define the local variable for custom_form_data_signer_response->fki_ezsignfoldersignerassociation_id
    int *fki_ezsignfoldersignerassociation_id_local_var = NULL;

    // define the local variable for custom_form_data_signer_response->fki_user_id
