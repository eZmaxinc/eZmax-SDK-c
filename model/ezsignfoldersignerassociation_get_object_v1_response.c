...
static ezsignfoldersignerassociation_get_object_v1_response_t *ezsignfoldersignerassociation_get_object_v1_response_create_internal(
    ...
    memset(ezsignfoldersignerassociation_get_object_v1_response_local_var, 0, sizeof(ezsignfoldersignerassociation_get_object_v1_response_t));
...
__attribute__((deprecated)) ezsignfoldersignerassociation_get_object_v1_response_t *ezsignfoldersignerassociation_get_object_v1_response_create(
    ...
    ezsignfoldersignerassociation_get_object_v1_response_t *result = ezsignfoldersignerassociation_get_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
