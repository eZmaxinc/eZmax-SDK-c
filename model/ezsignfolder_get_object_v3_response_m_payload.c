...
static ezsignfolder_get_object_v3_response_m_payload_t *ezsignfolder_get_object_v3_response_m_payload_create_internal(
    ...
    memset(ezsignfolder_get_object_v3_response_m_payload_local_var, 0, sizeof(ezsignfolder_get_object_v3_response_m_payload_t));
    ezsignfolder_get_object_v3_response_m_payload_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezsignfolder_get_object_v3_response_m_payload_t *ezsignfolder_get_object_v3_response_m_payload_create(
    ...
    ezsignfolder_get_object_v3_response_m_payload_t *result = ezsignfolder_get_object_v3_response_m_payload_create_internal (
        obj_ezsignfolder
        );
    if (!result) {
    }
...
void ezsignfolder_get_object_v3_response_m_payload_free(ezsignfolder_get_object_v3_response_m_payload_t *ezsignfolder_get_object_v3_response_m_payload) {
    ...
    if(ezsignfolder_get_object_v3_response_m_payload->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsignfolder_get_object_v3_response_m_payload_free");
        return ;
    }
...
ezsignfolder_get_object_v3_response_m_payload_t *ezsignfolder_get_object_v3_response_m_payload_parseFromJSON(cJSON *ezsignfolder_get_object_v3_response_m_payloadJSON){
    ...
    ezsignfolder_get_object_v3_response_m_payload_local_var = ezsignfolder_get_object_v3_response_m_payload_create_internal (
