...
#include <string.h>
#include <stdio.h>
#include "ezsignfolder_get_actionable_elements_v1_response.h"



static ezsignfolder_get_actionable_elements_v1_response_t *ezsignfolder_get_actionable_elements_v1_response_create_internal(
    ...
    memset(ezsignfolder_get_actionable_elements_v1_response_local_var, 0, sizeof(ezsignfolder_get_actionable_elements_v1_response_t));
    ezsignfolder_get_actionable_elements_v1_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezsignfolder_get_actionable_elements_v1_response_t *ezsignfolder_get_actionable_elements_v1_response_create(
    ...
    ezsignfolder_get_actionable_elements_v1_response_t *result = ezsignfolder_get_actionable_elements_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void ezsignfolder_get_actionable_elements_v1_response_free(ezsignfolder_get_actionable_elements_v1_response_t *ezsignfolder_get_actionable_elements_v1_response) {
    if(NULL == ezsignfolder_get_actionable_elements_v1_response){
        return ;
    }
    if(ezsignfolder_get_actionable_elements_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsignfolder_get_actionable_elements_v1_response_free");
        return ;
    }
    ...
    if (ezsignfolder_get_actionable_elements_v1_response->obj_debug) {
...
cJSON *ezsignfolder_get_actionable_elements_v1_response_convertToJSON(ezsignfolder_get_actionable_elements_v1_response_t *ezsignfolder_get_actionable_elements_v1_response) {
    ...
    if(ezsignfolder_get_actionable_elements_v1_response->obj_debug) {
    cJSON *obj_debug_local_JSON = common_response_obj_debug_convertToJSON(ezsignfolder_get_actionable_elements_v1_response->obj_debug);
...
ezsignfolder_get_actionable_elements_v1_response_t *ezsignfolder_get_actionable_elements_v1_response_parseFromJSON(cJSON *ezsignfolder_get_actionable_elements_v1_responseJSON){
    ...
    ezsignfolder_get_actionable_elements_v1_response_local_var = ezsignfolder_get_actionable_elements_v1_response_create_internal (
