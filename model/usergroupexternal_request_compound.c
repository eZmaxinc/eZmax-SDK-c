...
usergroupexternal_request_compound_t *usergroupexternal_request_compound_create(
...
usergroupexternal_request_compound_t *usergroupexternal_request_compound_parseFromJSON(cJSON *usergroupexternal_request_compoundJSON){
    ...
    usergroupexternal_request_compound_local_var = usergroupexternal_request_compound_create (
