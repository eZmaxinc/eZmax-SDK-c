...
static custom_dropdown_element_response_compound_t *custom_dropdown_element_response_compound_create_internal(
    ...
    memset(custom_dropdown_element_response_compound_local_var, 0, sizeof(custom_dropdown_element_response_compound_t));
...
__attribute__((deprecated)) custom_dropdown_element_response_compound_t *custom_dropdown_element_response_compound_create(
    ...
    custom_dropdown_element_response_compound_t *result = custom_dropdown_element_response_compound_create_internal (
        s_label,
        s_value
        );
    if (!result) {
