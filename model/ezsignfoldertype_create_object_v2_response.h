/*
 * ezsignfoldertype_create_object_v2_response.h
 *
 * Response for POST /2/object/ezsignfoldertype
 */

#ifndef _ezsignfoldertype_create_object_v2_response_H_
#define _ezsignfoldertype_create_object_v2_response_H_
...
typedef struct ezsignfoldertype_create_object_v2_response_t ezsignfoldertype_create_object_v2_response_t;
...
typedef struct ezsignfoldertype_create_object_v2_response_t {
    struct common_response_obj_debug_payload_t *obj_debug_payload; //model
    struct common_response_obj_debug_t *obj_debug; //model
    struct ezsignfoldertype_create_object_v2_response_m_payload_t *m_payload; //model
...
#endif /* _ezsignfoldertype_create_object_v2_response_H_ */
