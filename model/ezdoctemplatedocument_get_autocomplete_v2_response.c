...
static ezdoctemplatedocument_get_autocomplete_v2_response_t *ezdoctemplatedocument_get_autocomplete_v2_response_create_internal(
    ...
    memset(ezdoctemplatedocument_get_autocomplete_v2_response_local_var, 0, sizeof(ezdoctemplatedocument_get_autocomplete_v2_response_t));
    ezdoctemplatedocument_get_autocomplete_v2_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezdoctemplatedocument_get_autocomplete_v2_response_t *ezdoctemplatedocument_get_autocomplete_v2_response_create(
    ...
    ezdoctemplatedocument_get_autocomplete_v2_response_t *result = ezdoctemplatedocument_get_autocomplete_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void ezdoctemplatedocument_get_autocomplete_v2_response_free(ezdoctemplatedocument_get_autocomplete_v2_response_t *ezdoctemplatedocument_get_autocomplete_v2_response) {
    ...
    if(ezdoctemplatedocument_get_autocomplete_v2_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezdoctemplatedocument_get_autocomplete_v2_response_free");
        return ;
    }
...
ezdoctemplatedocument_get_autocomplete_v2_response_t *ezdoctemplatedocument_get_autocomplete_v2_response_parseFromJSON(cJSON *ezdoctemplatedocument_get_autocomplete_v2_responseJSON){
    ...
    ezdoctemplatedocument_get_autocomplete_v2_response_local_var = ezdoctemplatedocument_get_autocomplete_v2_response_create_internal (
