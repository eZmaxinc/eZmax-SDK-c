...
static usergroupmembership_delete_object_v1_response_t *usergroupmembership_delete_object_v1_response_create_internal(
    ...
    memset(usergroupmembership_delete_object_v1_response_local_var, 0, sizeof(usergroupmembership_delete_object_v1_response_t));
...
__attribute__((deprecated)) usergroupmembership_delete_object_v1_response_t *usergroupmembership_delete_object_v1_response_create(
    ...
    usergroupmembership_delete_object_v1_response_t *result = usergroupmembership_delete_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug
        );
    if (!result) {
