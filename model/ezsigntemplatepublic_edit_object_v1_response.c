...
static ezsigntemplatepublic_edit_object_v1_response_t *ezsigntemplatepublic_edit_object_v1_response_create_internal(
    ...
    memset(ezsigntemplatepublic_edit_object_v1_response_local_var, 0, sizeof(ezsigntemplatepublic_edit_object_v1_response_t));
...
__attribute__((deprecated)) ezsigntemplatepublic_edit_object_v1_response_t *ezsigntemplatepublic_edit_object_v1_response_create(
    ...
    ezsigntemplatepublic_edit_object_v1_response_t *result = ezsigntemplatepublic_edit_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug
        );
    if (!result) {
