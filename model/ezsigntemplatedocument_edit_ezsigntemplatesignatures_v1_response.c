...
static ezsigntemplatedocument_edit_ezsigntemplatesignatures_v1_response_t *ezsigntemplatedocument_edit_ezsigntemplatesignatures_v1_response_create_internal(
    ...
    memset(ezsigntemplatedocument_edit_ezsigntemplatesignatures_v1_response_local_var, 0, sizeof(ezsigntemplatedocument_edit_ezsigntemplatesignatures_v1_response_t));
    ezsigntemplatedocument_edit_ezsigntemplatesignatures_v1_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezsigntemplatedocument_edit_ezsigntemplatesignatures_v1_response_t *ezsigntemplatedocument_edit_ezsigntemplatesignatures_v1_response_create(
    common_response_obj_debug_payload_t *obj_debug_payload,
    common_response_obj_debug_t *obj_debug,
    ezsigntemplatedocument_edit_ezsigntemplatesignatures_v1_response_m_payload_t *m_payload
    ) {
    ezsigntemplatedocument_edit_ezsigntemplatesignatures_v1_response_t *result = ezsigntemplatedocument_edit_ezsigntemplatesignatures_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void ezsigntemplatedocument_edit_ezsigntemplatesignatures_v1_response_free(ezsigntemplatedocument_edit_ezsigntemplatesignatures_v1_response_t *ezsigntemplatedocument_edit_ezsigntemplatesignatures_v1_response) {
    ...
    if(ezsigntemplatedocument_edit_ezsigntemplatesignatures_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsigntemplatedocument_edit_ezsigntemplatesignatures_v1_response_free");
        return ;
    }
...
ezsigntemplatedocument_edit_ezsigntemplatesignatures_v1_response_t *ezsigntemplatedocument_edit_ezsigntemplatesignatures_v1_response_parseFromJSON(cJSON *ezsigntemplatedocument_edit_ezsigntemplatesignatures_v1_responseJSON){
    ...
    ezsigntemplatedocument_edit_ezsigntemplatesignatures_v1_response_local_var = ezsigntemplatedocument_edit_ezsigntemplatesignatures_v1_response_create_internal (
