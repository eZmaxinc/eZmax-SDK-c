...
static permission_get_object_v2_response_t *permission_get_object_v2_response_create_internal(
    ...
    memset(permission_get_object_v2_response_local_var, 0, sizeof(permission_get_object_v2_response_t));
    permission_get_object_v2_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) permission_get_object_v2_response_t *permission_get_object_v2_response_create(
    common_response_obj_debug_payload_t *obj_debug_payload,
    common_response_obj_debug_t *obj_debug,
    permission_get_object_v2_response_m_payload_t *m_payload
    ) {
    permission_get_object_v2_response_t *result = permission_get_object_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void permission_get_object_v2_response_free(permission_get_object_v2_response_t *permission_get_object_v2_response) {
    ...
    if(permission_get_object_v2_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "permission_get_object_v2_response_free");
        return ;
    }
...
permission_get_object_v2_response_t *permission_get_object_v2_response_parseFromJSON(cJSON *permission_get_object_v2_responseJSON){
    ...
    permission_get_object_v2_response_local_var = permission_get_object_v2_response_create_internal (
