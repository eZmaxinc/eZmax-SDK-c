...
static branding_response_compound_v3_t *branding_response_compound_v3_create_internal(
    ...
    memset(branding_response_compound_v3_local_var, 0, sizeof(branding_response_compound_v3_t));
...
__attribute__((deprecated)) branding_response_compound_v3_t *branding_response_compound_v3_create(
    ...
    branding_response_compound_v3_t *result = branding_response_compound_v3_create_internal (
...
void branding_response_compound_v3_free(branding_response_compound_v3_t *branding_response_compound_v3) {
    ...
    if (branding_response_compound_v3->pki_branding_id) {
        free(branding_response_compound_v3->pki_branding_id);
        branding_response_compound_v3->pki_branding_id = NULL;
    }
    if (branding_response_compound_v3->fki_domain_id) {
        free(branding_response_compound_v3->fki_domain_id);
        branding_response_compound_v3->fki_domain_id = NULL;
    }
    ...
    if (branding_response_compound_v3->fki_email_id) {
        free(branding_response_compound_v3->fki_email_id);
        branding_response_compound_v3->fki_email_id = NULL;
    }
    ...
    if (branding_response_compound_v3->i_branding_color) {
        free(branding_response_compound_v3->i_branding_color);
        branding_response_compound_v3->i_branding_color = NULL;
    }
    if (branding_response_compound_v3->b_branding_isactive) {
        free(branding_response_compound_v3->b_branding_isactive);
        branding_response_compound_v3->b_branding_isactive = NULL;
    }
...
branding_response_compound_v3_t *branding_response_compound_v3_parseFromJSON(cJSON *branding_response_compound_v3JSON){
    ...
    // define the local variable for branding_response_compound_v3->pki_branding_id
    int *pki_branding_id_local_var = NULL;

    // define the local variable for branding_response_compound_v3->fki_domain_id
    int *fki_domain_id_local_var = NULL;

    char *s_domain_name_local_str = NULL;

    // define the local variable for branding_response_compound_v3->fki_email_id
    ...
    // define the local variable for branding_response_compound_v3->i_branding_color
    int *i_branding_color_local_var = NULL;

    // define the local variable for branding_response_compound_v3->b_branding_isactive
    int *b_branding_isactive_local_var = NULL;

    char *s_branding_logourl_local_str = NULL;

    char *s_branding_logoemailurl_local_str = NULL;
    ...
    *b_branding_isactive_local_var = b_branding_isactive->valueint;
    ...
    if (s_branding_logourl && !cJSON_IsNull(s_branding_logourl)) s_branding_logourl_local_str = strdup(s_branding_logourl->valuestring);
    if (s_branding_logoemailurl && !cJSON_IsNull(s_branding_logoemailurl)) s_branding_logoemailurl_local_str = strdup(s_branding_logoemailurl->valuestring);
    ...
    branding_response_compound_v3_local_var = branding_response_compound_v3_create_internal (
        ...
        s_branding_logourl_local_str,
        s_branding_logoemailurl_local_str,
    ...
    if (s_branding_logourl_local_str) {
        free(s_branding_logourl_local_str);
        s_branding_logourl_local_str = NULL;
    }
    if (s_branding_logoemailurl_local_str) {
        free(s_branding_logoemailurl_local_str);
        s_branding_logoemailurl_local_str = NULL;
    }
