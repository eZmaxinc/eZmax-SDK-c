...
void branding_response_compound_v3_free(branding_response_compound_v3_t *branding_response_compound_v3) {
    ...
    if (branding_response_compound_v3->e_branding_logo) {
        field_e_branding_logo_free(branding_response_compound_v3->e_branding_logo);
        branding_response_compound_v3->e_branding_logo = NULL;
    }
    if (branding_response_compound_v3->e_branding_alignlogo) {
        field_e_branding_alignlogo_free(branding_response_compound_v3->e_branding_alignlogo);
        branding_response_compound_v3->e_branding_alignlogo = NULL;
    }
...
cJSON *branding_response_compound_v3_convertToJSON(branding_response_compound_v3_t *branding_response_compound_v3) {
    ...
    if (ezmax_api_definition__full_branding_response_compound_v3__NULL == branding_response_compound_v3->e_branding_logo) {
        goto fail;
    }
    ...
    if (ezmax_api_definition__full_branding_response_compound_v3__NULL == branding_response_compound_v3->e_branding_alignlogo) {
        goto fail;
    }
...
branding_response_compound_v3_t *branding_response_compound_v3_parseFromJSON(cJSON *branding_response_compound_v3JSON){
    ...
    branding_response_compound_v3_local_var = branding_response_compound_v3_create (
