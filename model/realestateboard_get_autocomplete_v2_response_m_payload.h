/*
 * realestateboard_get_autocomplete_v2_response_m_payload.h
 *
 * Payload for POST /2/object/realestateboard/getAutocomplete
 */

#ifndef _realestateboard_get_autocomplete_v2_response_m_payload_H_
#define _realestateboard_get_autocomplete_v2_response_m_payload_H_
...
typedef struct realestateboard_get_autocomplete_v2_response_m_payload_t realestateboard_get_autocomplete_v2_response_m_payload_t;

#include "realestateboard_autocomplete_element_response.h"



typedef struct realestateboard_get_autocomplete_v2_response_m_payload_t {
    list_t *a_obj_realestateboard; //nonprimitive container

    int _library_owned; // Is the library responsible for freeing this object?
} realestateboard_get_autocomplete_v2_response_m_payload_t;
...
#endif /* _realestateboard_get_autocomplete_v2_response_m_payload_H_ */
