...
static buyercontract_import_into_edm_v1_response_m_payload_t *buyercontract_import_into_edm_v1_response_m_payload_create_internal(
    ...
    memset(buyercontract_import_into_edm_v1_response_m_payload_local_var, 0, sizeof(buyercontract_import_into_edm_v1_response_m_payload_t));
...
__attribute__((deprecated)) buyercontract_import_into_edm_v1_response_m_payload_t *buyercontract_import_into_edm_v1_response_m_payload_create(
    ...
    buyercontract_import_into_edm_v1_response_m_payload_t *result = buyercontract_import_into_edm_v1_response_m_payload_create_internal (
        a_obj_attachment
        );
    if (!result) {
    }
