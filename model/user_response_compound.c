...
char* e_user_typeuser_response_compound_ToString(ezmax_api_definition_user_response_compound__e e_user_type) {
...
ezmax_api_definition_user_response_compound__e e_user_typeuser_response_compound_FromString(char* e_user_type){
