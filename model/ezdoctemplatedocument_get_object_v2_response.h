/*
 * ezdoctemplatedocument_get_object_v2_response.h
 *
 * Response for GET /2/object/ezdoctemplatedocument/{pkiEzdoctemplatedocumentID}
 */

#ifndef _ezdoctemplatedocument_get_object_v2_response_H_
#define _ezdoctemplatedocument_get_object_v2_response_H_
...
typedef struct ezdoctemplatedocument_get_object_v2_response_t ezdoctemplatedocument_get_object_v2_response_t;
...
typedef struct ezdoctemplatedocument_get_object_v2_response_t {
    struct common_response_obj_debug_payload_t *obj_debug_payload; //model
    struct common_response_obj_debug_t *obj_debug; //model
    struct ezdoctemplatedocument_get_object_v2_response_m_payload_t *m_payload; //model

} ezdoctemplatedocument_get_object_v2_response_t;

ezdoctemplatedocument_get_object_v2_response_t *ezdoctemplatedocument_get_object_v2_response_create(
...
#endif /* _ezdoctemplatedocument_get_object_v2_response_H_ */
