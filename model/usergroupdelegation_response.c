...
static usergroupdelegation_response_t *usergroupdelegation_response_create_internal(
    ...
    memset(usergroupdelegation_response_local_var, 0, sizeof(usergroupdelegation_response_t));
...
__attribute__((deprecated)) usergroupdelegation_response_t *usergroupdelegation_response_create(
    ...
    usergroupdelegation_response_t *result = usergroupdelegation_response_create_internal (
...
void usergroupdelegation_response_free(usergroupdelegation_response_t *usergroupdelegation_response) {
    ...
    if (usergroupdelegation_response->pki_usergroupdelegation_id) {
        free(usergroupdelegation_response->pki_usergroupdelegation_id);
        usergroupdelegation_response->pki_usergroupdelegation_id = NULL;
    }
    if (usergroupdelegation_response->fki_usergroup_id) {
        free(usergroupdelegation_response->fki_usergroup_id);
        usergroupdelegation_response->fki_usergroup_id = NULL;
    }
    if (usergroupdelegation_response->fki_user_id) {
        free(usergroupdelegation_response->fki_user_id);
        usergroupdelegation_response->fki_user_id = NULL;
    }
    ...
    if (usergroupdelegation_response->b_user_isactive) {
        free(usergroupdelegation_response->b_user_isactive);
        usergroupdelegation_response->b_user_isactive = NULL;
    }
...
usergroupdelegation_response_t *usergroupdelegation_response_parseFromJSON(cJSON *usergroupdelegation_responseJSON){
    ...
    // define the local variable for usergroupdelegation_response->pki_usergroupdelegation_id
    int *pki_usergroupdelegation_id_local_var = NULL;

    // define the local variable for usergroupdelegation_response->fki_usergroup_id
    int *fki_usergroup_id_local_var = NULL;

    // define the local variable for usergroupdelegation_response->fki_user_id
    ...
    // define the local variable for usergroupdelegation_response->b_user_isactive
