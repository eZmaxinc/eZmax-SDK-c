/*
 * ezsignformfieldgroup_get_object_v2_response_all_of.h
 *
 * 
 */

#ifndef _ezsignformfieldgroup_get_object_v2_response_all_of_H_
#define _ezsignformfieldgroup_get_object_v2_response_all_of_H_
...
typedef struct ezsignformfieldgroup_get_object_v2_response_all_of_t ezsignformfieldgroup_get_object_v2_response_all_of_t;

#include "ezsignformfieldgroup_get_object_v2_response_m_payload.h"



typedef struct ezsignformfieldgroup_get_object_v2_response_all_of_t {
    struct ezsignformfieldgroup_get_object_v2_response_m_payload_t *m_payload; //model

} ezsignformfieldgroup_get_object_v2_response_all_of_t;
...
#endif /* _ezsignformfieldgroup_get_object_v2_response_all_of_H_ */
