...
static otherincome_get_list_v1_response_m_payload_t *otherincome_get_list_v1_response_m_payload_create_internal(
    ...
    memset(otherincome_get_list_v1_response_m_payload_local_var, 0, sizeof(otherincome_get_list_v1_response_m_payload_t));
...
__attribute__((deprecated)) otherincome_get_list_v1_response_m_payload_t *otherincome_get_list_v1_response_m_payload_create(
    ...
    otherincome_get_list_v1_response_m_payload_t *result = otherincome_get_list_v1_response_m_payload_create_internal (
        i_row_returned_copy,
        i_row_filtered_copy,
        a_obj_otherincome
        );
...
void otherincome_get_list_v1_response_m_payload_free(otherincome_get_list_v1_response_m_payload_t *otherincome_get_list_v1_response_m_payload) {
    ...
    if (otherincome_get_list_v1_response_m_payload->i_row_returned) {
        free(otherincome_get_list_v1_response_m_payload->i_row_returned);
        otherincome_get_list_v1_response_m_payload->i_row_returned = NULL;
    }
    if (otherincome_get_list_v1_response_m_payload->i_row_filtered) {
        free(otherincome_get_list_v1_response_m_payload->i_row_filtered);
        otherincome_get_list_v1_response_m_payload->i_row_filtered = NULL;
    }
...
otherincome_get_list_v1_response_m_payload_t *otherincome_get_list_v1_response_m_payload_parseFromJSON(cJSON *otherincome_get_list_v1_response_m_payloadJSON){
    ...
    // define the local variable for otherincome_get_list_v1_response_m_payload->i_row_returned
    int *i_row_returned_local_var = NULL;

    // define the local variable for otherincome_get_list_v1_response_m_payload->i_row_filtered
