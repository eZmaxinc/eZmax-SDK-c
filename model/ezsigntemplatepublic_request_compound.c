...
static ezsigntemplatepublic_request_compound_t *ezsigntemplatepublic_request_compound_create_internal(
    ...
    memset(ezsigntemplatepublic_request_compound_local_var, 0, sizeof(ezsigntemplatepublic_request_compound_t));
...
__attribute__((deprecated)) ezsigntemplatepublic_request_compound_t *ezsigntemplatepublic_request_compound_create(
    ...
    ezsigntemplatepublic_request_compound_t *result = ezsigntemplatepublic_request_compound_create_internal (
...
void ezsigntemplatepublic_request_compound_free(ezsigntemplatepublic_request_compound_t *ezsigntemplatepublic_request_compound) {
    ...
    if (ezsigntemplatepublic_request_compound->pki_ezsigntemplatepublic_id) {
        free(ezsigntemplatepublic_request_compound->pki_ezsigntemplatepublic_id);
        ezsigntemplatepublic_request_compound->pki_ezsigntemplatepublic_id = NULL;
    }
    if (ezsigntemplatepublic_request_compound->fki_ezsignfoldertype_id) {
        free(ezsigntemplatepublic_request_compound->fki_ezsignfoldertype_id);
        ezsigntemplatepublic_request_compound->fki_ezsignfoldertype_id = NULL;
    }
    if (ezsigntemplatepublic_request_compound->fki_userlogintype_id) {
        free(ezsigntemplatepublic_request_compound->fki_userlogintype_id);
        ezsigntemplatepublic_request_compound->fki_userlogintype_id = NULL;
    }
    if (ezsigntemplatepublic_request_compound->fki_ezsigntemplate_id) {
        free(ezsigntemplatepublic_request_compound->fki_ezsigntemplate_id);
        ezsigntemplatepublic_request_compound->fki_ezsigntemplate_id = NULL;
    }
    if (ezsigntemplatepublic_request_compound->fki_ezsigntemplatepackage_id) {
        free(ezsigntemplatepublic_request_compound->fki_ezsigntemplatepackage_id);
        ezsigntemplatepublic_request_compound->fki_ezsigntemplatepackage_id = NULL;
    }
    ...
    if (ezsigntemplatepublic_request_compound->b_ezsigntemplatepublic_isactive) {
        free(ezsigntemplatepublic_request_compound->b_ezsigntemplatepublic_isactive);
        ezsigntemplatepublic_request_compound->b_ezsigntemplatepublic_isactive = NULL;
    }
    ...
    if (ezsigntemplatepublic_request_compound->i_ezsigntemplatepublic_limit) {
        free(ezsigntemplatepublic_request_compound->i_ezsigntemplatepublic_limit);
        ezsigntemplatepublic_request_compound->i_ezsigntemplatepublic_limit = NULL;
    }
...
ezsigntemplatepublic_request_compound_t *ezsigntemplatepublic_request_compound_parseFromJSON(cJSON *ezsigntemplatepublic_request_compoundJSON){
    ...
    // define the local variable for ezsigntemplatepublic_request_compound->pki_ezsigntemplatepublic_id
    int *pki_ezsigntemplatepublic_id_local_var = NULL;

    // define the local variable for ezsigntemplatepublic_request_compound->fki_ezsignfoldertype_id
    int *fki_ezsignfoldertype_id_local_var = NULL;

    // define the local variable for ezsigntemplatepublic_request_compound->fki_userlogintype_id
    int *fki_userlogintype_id_local_var = NULL;

    // define the local variable for ezsigntemplatepublic_request_compound->fki_ezsigntemplate_id
    int *fki_ezsigntemplate_id_local_var = NULL;

    // define the local variable for ezsigntemplatepublic_request_compound->fki_ezsigntemplatepackage_id
    int *fki_ezsigntemplatepackage_id_local_var = NULL;

    char *s_ezsigntemplatepublic_description_local_str = NULL;

    // define the local variable for ezsigntemplatepublic_request_compound->b_ezsigntemplatepublic_isactive
    ...
    // define the local variable for ezsigntemplatepublic_request_compound->i_ezsigntemplatepublic_limit
