...
ezsignsignature_response_compound_t *ezsignsignature_response_compound_create(
    ...
    ezsignsignature_response_compound_local_var->fki_user_id = fki_user_id;
...
cJSON *ezsignsignature_response_compound_convertToJSON(ezsignsignature_response_compound_t *ezsignsignature_response_compound) {
    ...
    // ezsignsignature_response_compound->fki_user_id
    if(ezsignsignature_response_compound->fki_user_id) {
    if(cJSON_AddNumberToObject(item, "fkiUserID", ezsignsignature_response_compound->fki_user_id) == NULL) {
    goto fail; //Numeric
    }
    }
...
ezsignsignature_response_compound_t *ezsignsignature_response_compound_parseFromJSON(cJSON *ezsignsignature_response_compoundJSON){
    ...
    // ezsignsignature_response_compound->fki_user_id
    cJSON *fki_user_id = cJSON_GetObjectItemCaseSensitive(ezsignsignature_response_compoundJSON, "fkiUserID");
    if (fki_user_id) { 
