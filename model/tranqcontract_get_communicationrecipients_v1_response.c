...
static tranqcontract_get_communicationrecipients_v1_response_t *tranqcontract_get_communicationrecipients_v1_response_create_internal(
    ...
    memset(tranqcontract_get_communicationrecipients_v1_response_local_var, 0, sizeof(tranqcontract_get_communicationrecipients_v1_response_t));
    tranqcontract_get_communicationrecipients_v1_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) tranqcontract_get_communicationrecipients_v1_response_t *tranqcontract_get_communicationrecipients_v1_response_create(
    common_response_obj_debug_payload_t *obj_debug_payload,
    common_response_obj_debug_t *obj_debug,
    tranqcontract_get_communicationrecipients_v1_response_m_payload_t *m_payload
    ) {
    tranqcontract_get_communicationrecipients_v1_response_t *result = tranqcontract_get_communicationrecipients_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void tranqcontract_get_communicationrecipients_v1_response_free(tranqcontract_get_communicationrecipients_v1_response_t *tranqcontract_get_communicationrecipients_v1_response) {
    ...
    if(tranqcontract_get_communicationrecipients_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "tranqcontract_get_communicationrecipients_v1_response_free");
        return ;
    }
...
tranqcontract_get_communicationrecipients_v1_response_t *tranqcontract_get_communicationrecipients_v1_response_parseFromJSON(cJSON *tranqcontract_get_communicationrecipients_v1_responseJSON){
    ...
    tranqcontract_get_communicationrecipients_v1_response_local_var = tranqcontract_get_communicationrecipients_v1_response_create_internal (
