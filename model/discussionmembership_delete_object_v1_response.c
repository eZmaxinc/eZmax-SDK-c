...
discussionmembership_delete_object_v1_response_t *discussionmembership_delete_object_v1_response_create(
...
discussionmembership_delete_object_v1_response_t *discussionmembership_delete_object_v1_response_parseFromJSON(cJSON *discussionmembership_delete_object_v1_responseJSON){
    ...
    discussionmembership_delete_object_v1_response_local_var = discussionmembership_delete_object_v1_response_create (
