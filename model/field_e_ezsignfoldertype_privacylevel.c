...
ezmax_api_definition_field_e_ezsignfoldertype_privacylevel__e field_e_ezsignfoldertype_privacylevel_field_e_ezsignfoldertype_privacylevel_parseFromJSON(cJSON *field_e_ezsignfoldertype_privacylevelJSON) {
    ezmax_api_definition_field_e_ezsignfoldertype_privacylevel__e *field_e_ezsignfoldertype_privacylevel = NULL;
    ezmax_api_definition_field_e_ezsignfoldertype_privacylevel__e field_e_ezsignfoldertype_privacylevelVariable;
