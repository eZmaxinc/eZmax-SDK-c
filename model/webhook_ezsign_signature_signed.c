...
static webhook_ezsign_signature_signed_t *webhook_ezsign_signature_signed_create_internal(
...
__attribute__((deprecated)) webhook_ezsign_signature_signed_t *webhook_ezsign_signature_signed_create(
    custom_webhook_response_t *obj_webhook,
    list_t *a_obj_attempt,
    ezsignsignature_response_t *obj_ezsignsignature
    ) {
...
void webhook_ezsign_signature_signed_free(webhook_ezsign_signature_signed_t *webhook_ezsign_signature_signed) {
    ...
    if(webhook_ezsign_signature_signed->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "webhook_ezsign_signature_signed_free");
        return ;
    }
