...
static ezsignsignaturepaymentdetail_request_compound_t *ezsignsignaturepaymentdetail_request_compound_create_internal(
    ...
    memset(ezsignsignaturepaymentdetail_request_compound_local_var, 0, sizeof(ezsignsignaturepaymentdetail_request_compound_t));
...
__attribute__((deprecated)) ezsignsignaturepaymentdetail_request_compound_t *ezsignsignaturepaymentdetail_request_compound_create(
    ...
    ezsignsignaturepaymentdetail_request_compound_t *result = ezsignsignaturepaymentdetail_request_compound_create_internal (
...
void ezsignsignaturepaymentdetail_request_compound_free(ezsignsignaturepaymentdetail_request_compound_t *ezsignsignaturepaymentdetail_request_compound) {
    ...
    if (ezsignsignaturepaymentdetail_request_compound->pki_ezsignsignaturepaymentdetail_id) {
        free(ezsignsignaturepaymentdetail_request_compound->pki_ezsignsignaturepaymentdetail_id);
        ezsignsignaturepaymentdetail_request_compound->pki_ezsignsignaturepaymentdetail_id = NULL;
    }
    if (ezsignsignaturepaymentdetail_request_compound->fki_glaccountcontainer_id) {
        free(ezsignsignaturepaymentdetail_request_compound->fki_glaccountcontainer_id);
        ezsignsignaturepaymentdetail_request_compound->fki_glaccountcontainer_id = NULL;
    }
...
ezsignsignaturepaymentdetail_request_compound_t *ezsignsignaturepaymentdetail_request_compound_parseFromJSON(cJSON *ezsignsignaturepaymentdetail_request_compoundJSON){
    ...
    // define the local variable for ezsignsignaturepaymentdetail_request_compound->pki_ezsignsignaturepaymentdetail_id
    int *pki_ezsignsignaturepaymentdetail_id_local_var = NULL;

    // define the local variable for ezsignsignaturepaymentdetail_request_compound->fki_glaccountcontainer_id
