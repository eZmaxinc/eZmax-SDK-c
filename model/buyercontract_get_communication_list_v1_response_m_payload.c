...
static buyercontract_get_communication_list_v1_response_m_payload_t *buyercontract_get_communication_list_v1_response_m_payload_create_internal(
    ...
    memset(buyercontract_get_communication_list_v1_response_m_payload_local_var, 0, sizeof(buyercontract_get_communication_list_v1_response_m_payload_t));
...
__attribute__((deprecated)) buyercontract_get_communication_list_v1_response_m_payload_t *buyercontract_get_communication_list_v1_response_m_payload_create(
    ...
    buyercontract_get_communication_list_v1_response_m_payload_t *result = buyercontract_get_communication_list_v1_response_m_payload_create_internal (
        a_obj_communication
        );
    if (!result) {
    }
