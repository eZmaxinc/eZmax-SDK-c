...
static ezsigntemplatepackagemembership_response_compound_t *ezsigntemplatepackagemembership_response_compound_create_internal(
    ...
    memset(ezsigntemplatepackagemembership_response_compound_local_var, 0, sizeof(ezsigntemplatepackagemembership_response_compound_t));
    ezsigntemplatepackagemembership_response_compound_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezsigntemplatepackagemembership_response_compound_t *ezsigntemplatepackagemembership_response_compound_create(
    ...
    ezsigntemplatepackagemembership_response_compound_t *result = ezsigntemplatepackagemembership_response_compound_create_internal (
...
void ezsigntemplatepackagemembership_response_compound_free(ezsigntemplatepackagemembership_response_compound_t *ezsigntemplatepackagemembership_response_compound) {
    ...
    if(ezsigntemplatepackagemembership_response_compound->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsigntemplatepackagemembership_response_compound_free");
        return ;
    }
    listEntry_t *listEntry;
    if (ezsigntemplatepackagemembership_response_compound->pki_ezsigntemplatepackagemembership_id) {
        free(ezsigntemplatepackagemembership_response_compound->pki_ezsigntemplatepackagemembership_id);
        ezsigntemplatepackagemembership_response_compound->pki_ezsigntemplatepackagemembership_id = NULL;
    }
    if (ezsigntemplatepackagemembership_response_compound->fki_ezsigntemplatepackage_id) {
        free(ezsigntemplatepackagemembership_response_compound->fki_ezsigntemplatepackage_id);
        ezsigntemplatepackagemembership_response_compound->fki_ezsigntemplatepackage_id = NULL;
    }
    if (ezsigntemplatepackagemembership_response_compound->fki_ezsigntemplate_id) {
        free(ezsigntemplatepackagemembership_response_compound->fki_ezsigntemplate_id);
        ezsigntemplatepackagemembership_response_compound->fki_ezsigntemplate_id = NULL;
    }
    if (ezsigntemplatepackagemembership_response_compound->i_ezsigntemplatepackagemembership_order) {
        free(ezsigntemplatepackagemembership_response_compound->i_ezsigntemplatepackagemembership_order);
        ezsigntemplatepackagemembership_response_compound->i_ezsigntemplatepackagemembership_order = NULL;
    }
...
ezsigntemplatepackagemembership_response_compound_t *ezsigntemplatepackagemembership_response_compound_parseFromJSON(cJSON *ezsigntemplatepackagemembership_response_compoundJSON){
    ...
    // define the local variable for ezsigntemplatepackagemembership_response_compound->pki_ezsigntemplatepackagemembership_id
    int *pki_ezsigntemplatepackagemembership_id_local_var = NULL;

    // define the local variable for ezsigntemplatepackagemembership_response_compound->fki_ezsigntemplatepackage_id
    int *fki_ezsigntemplatepackage_id_local_var = NULL;

    // define the local variable for ezsigntemplatepackagemembership_response_compound->fki_ezsigntemplate_id
    int *fki_ezsigntemplate_id_local_var = NULL;

    // define the local variable for ezsigntemplatepackagemembership_response_compound->i_ezsigntemplatepackagemembership_order
    ...
    *i_ezsigntemplatepackagemembership_order_local_var = i_ezsigntemplatepackagemembership_order->valuedouble;
    ...
    ezsigntemplatepackagemembership_response_compound_local_var = ezsigntemplatepackagemembership_response_compound_create_internal (
