...
static customer_create_object_v1_response_t *customer_create_object_v1_response_create_internal(
    ...
    customer_create_object_v1_response_local_var->_library_owned = 1;
    return customer_create_object_v1_response_local_var;
}

__attribute__((deprecated)) customer_create_object_v1_response_t *customer_create_object_v1_response_create(
    common_response_obj_debug_payload_t *obj_debug_payload,
    common_response_obj_debug_t *obj_debug,
    customer_create_object_v1_response_m_payload_t *m_payload
    ) {
    return customer_create_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void customer_create_object_v1_response_free(customer_create_object_v1_response_t *customer_create_object_v1_response) {
    ...
    if(customer_create_object_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "customer_create_object_v1_response_free");
        return ;
    }
...
customer_create_object_v1_response_t *customer_create_object_v1_response_parseFromJSON(cJSON *customer_create_object_v1_responseJSON){
    ...
    customer_create_object_v1_response_local_var = customer_create_object_v1_response_create_internal (
