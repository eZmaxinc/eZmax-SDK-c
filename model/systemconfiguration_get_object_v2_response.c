...
static systemconfiguration_get_object_v2_response_t *systemconfiguration_get_object_v2_response_create_internal(
    ...
    memset(systemconfiguration_get_object_v2_response_local_var, 0, sizeof(systemconfiguration_get_object_v2_response_t));
    systemconfiguration_get_object_v2_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) systemconfiguration_get_object_v2_response_t *systemconfiguration_get_object_v2_response_create(
    common_response_obj_debug_payload_t *obj_debug_payload,
    common_response_obj_debug_t *obj_debug,
    systemconfiguration_get_object_v2_response_m_payload_t *m_payload
    ) {
    systemconfiguration_get_object_v2_response_t *result = systemconfiguration_get_object_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void systemconfiguration_get_object_v2_response_free(systemconfiguration_get_object_v2_response_t *systemconfiguration_get_object_v2_response) {
    ...
    if(systemconfiguration_get_object_v2_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "systemconfiguration_get_object_v2_response_free");
        return ;
    }
...
systemconfiguration_get_object_v2_response_t *systemconfiguration_get_object_v2_response_parseFromJSON(cJSON *systemconfiguration_get_object_v2_responseJSON){
    ...
    systemconfiguration_get_object_v2_response_local_var = systemconfiguration_get_object_v2_response_create_internal (
