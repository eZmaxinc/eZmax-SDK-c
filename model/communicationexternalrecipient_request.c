...
char* e_communicationexternalrecipient_typecommunicationexternalrecipient_request_ToString(ezmax_api_definition__full_communicationexternalrecipient_request__e e_communicationexternalrecipient_type) {
...
ezmax_api_definition__full_communicationexternalrecipient_request__e e_communicationexternalrecipient_typecommunicationexternalrecipient_request_FromString(char* e_communicationexternalrecipient_type){
...
void communicationexternalrecipient_request_free(communicationexternalrecipient_request_t *communicationexternalrecipient_request) {
    ...
    if (communicationexternalrecipient_request->e_communicationexternalrecipient_type) {
        field_e_communicationexternalrecipient_type_free(communicationexternalrecipient_request->e_communicationexternalrecipient_type);
        communicationexternalrecipient_request->e_communicationexternalrecipient_type = NULL;
    }
...
cJSON *communicationexternalrecipient_request_convertToJSON(communicationexternalrecipient_request_t *communicationexternalrecipient_request) {
    ...
    if(communicationexternalrecipient_request->e_communicationexternalrecipient_type != ezmax_api_definition__full_communicationexternalrecipient_request__NULL) {
...
communicationexternalrecipient_request_t *communicationexternalrecipient_request_parseFromJSON(cJSON *communicationexternalrecipient_requestJSON){
    ...
    communicationexternalrecipient_request_local_var = communicationexternalrecipient_request_create (
