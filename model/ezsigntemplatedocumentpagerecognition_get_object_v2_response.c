...
static ezsigntemplatedocumentpagerecognition_get_object_v2_response_t *ezsigntemplatedocumentpagerecognition_get_object_v2_response_create_internal(
    ...
    memset(ezsigntemplatedocumentpagerecognition_get_object_v2_response_local_var, 0, sizeof(ezsigntemplatedocumentpagerecognition_get_object_v2_response_t));
...
__attribute__((deprecated)) ezsigntemplatedocumentpagerecognition_get_object_v2_response_t *ezsigntemplatedocumentpagerecognition_get_object_v2_response_create(
    ...
    ezsigntemplatedocumentpagerecognition_get_object_v2_response_t *result = ezsigntemplatedocumentpagerecognition_get_object_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
