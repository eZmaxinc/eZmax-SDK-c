...
static ezsignfoldertype_get_object_v4_response_t *ezsignfoldertype_get_object_v4_response_create_internal(
    ...
    memset(ezsignfoldertype_get_object_v4_response_local_var, 0, sizeof(ezsignfoldertype_get_object_v4_response_t));
    ezsignfoldertype_get_object_v4_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezsignfoldertype_get_object_v4_response_t *ezsignfoldertype_get_object_v4_response_create(
    common_response_obj_debug_payload_t *obj_debug_payload,
    common_response_obj_debug_t *obj_debug,
    ezsignfoldertype_get_object_v4_response_m_payload_t *m_payload
    ) {
    ezsignfoldertype_get_object_v4_response_t *result = ezsignfoldertype_get_object_v4_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void ezsignfoldertype_get_object_v4_response_free(ezsignfoldertype_get_object_v4_response_t *ezsignfoldertype_get_object_v4_response) {
    ...
    if(ezsignfoldertype_get_object_v4_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsignfoldertype_get_object_v4_response_free");
        return ;
    }
...
ezsignfoldertype_get_object_v4_response_t *ezsignfoldertype_get_object_v4_response_parseFromJSON(cJSON *ezsignfoldertype_get_object_v4_responseJSON){
    ...
    ezsignfoldertype_get_object_v4_response_local_var = ezsignfoldertype_get_object_v4_response_create_internal (
