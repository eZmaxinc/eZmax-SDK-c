...
static realestateassociation_get_autocomplete_v2_response_t *realestateassociation_get_autocomplete_v2_response_create_internal(
    ...
    memset(realestateassociation_get_autocomplete_v2_response_local_var, 0, sizeof(realestateassociation_get_autocomplete_v2_response_t));
...
__attribute__((deprecated)) realestateassociation_get_autocomplete_v2_response_t *realestateassociation_get_autocomplete_v2_response_create(
    ...
    realestateassociation_get_autocomplete_v2_response_t *result = realestateassociation_get_autocomplete_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
