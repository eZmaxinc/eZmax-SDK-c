...
static ezsignbulksend_get_ezsignbulksendtransmissions_v1_response_t *ezsignbulksend_get_ezsignbulksendtransmissions_v1_response_create_internal(
    ...
    memset(ezsignbulksend_get_ezsignbulksendtransmissions_v1_response_local_var, 0, sizeof(ezsignbulksend_get_ezsignbulksendtransmissions_v1_response_t));
    ezsignbulksend_get_ezsignbulksendtransmissions_v1_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezsignbulksend_get_ezsignbulksendtransmissions_v1_response_t *ezsignbulksend_get_ezsignbulksendtransmissions_v1_response_create(
    common_response_obj_debug_payload_t *obj_debug_payload,
    common_response_obj_debug_t *obj_debug,
    ezsignbulksend_get_ezsignbulksendtransmissions_v1_response_m_payload_t *m_payload
    ) {
    ezsignbulksend_get_ezsignbulksendtransmissions_v1_response_t *result = ezsignbulksend_get_ezsignbulksendtransmissions_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void ezsignbulksend_get_ezsignbulksendtransmissions_v1_response_free(ezsignbulksend_get_ezsignbulksendtransmissions_v1_response_t *ezsignbulksend_get_ezsignbulksendtransmissions_v1_response) {
    ...
    if(ezsignbulksend_get_ezsignbulksendtransmissions_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsignbulksend_get_ezsignbulksendtransmissions_v1_response_free");
        return ;
    }
...
ezsignbulksend_get_ezsignbulksendtransmissions_v1_response_t *ezsignbulksend_get_ezsignbulksendtransmissions_v1_response_parseFromJSON(cJSON *ezsignbulksend_get_ezsignbulksendtransmissions_v1_responseJSON){
    ...
    ezsignbulksend_get_ezsignbulksendtransmissions_v1_response_local_var = ezsignbulksend_get_ezsignbulksendtransmissions_v1_response_create_internal (
