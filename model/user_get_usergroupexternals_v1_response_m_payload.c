...
static user_get_usergroupexternals_v1_response_m_payload_t *user_get_usergroupexternals_v1_response_m_payload_create_internal(
    ...
    memset(user_get_usergroupexternals_v1_response_m_payload_local_var, 0, sizeof(user_get_usergroupexternals_v1_response_m_payload_t));
    user_get_usergroupexternals_v1_response_m_payload_local_var->_library_owned = 1;
...
__attribute__((deprecated)) user_get_usergroupexternals_v1_response_m_payload_t *user_get_usergroupexternals_v1_response_m_payload_create(
    list_t *a_obj_usergroupexternal
    ) {
    user_get_usergroupexternals_v1_response_m_payload_t *result = user_get_usergroupexternals_v1_response_m_payload_create_internal (
...
void user_get_usergroupexternals_v1_response_m_payload_free(user_get_usergroupexternals_v1_response_m_payload_t *user_get_usergroupexternals_v1_response_m_payload) {
    ...
    if(user_get_usergroupexternals_v1_response_m_payload->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "user_get_usergroupexternals_v1_response_m_payload_free");
        return ;
    }
...
user_get_usergroupexternals_v1_response_m_payload_t *user_get_usergroupexternals_v1_response_m_payload_parseFromJSON(cJSON *user_get_usergroupexternals_v1_response_m_payloadJSON){
    ...
    user_get_usergroupexternals_v1_response_m_payload_local_var = user_get_usergroupexternals_v1_response_m_payload_create_internal (
