...
typedef enum  { ezmax_api_definition__full_custom_webhook_response__NULL = 0, ezmax_api_definition__full_custom_webhook_response__DocumentCompleted, ezmax_api_definition__full_custom_webhook_response__FolderCompleted } ezmax_api_definition__full_custom_webhook_response__e;
...
typedef enum  { ezmax_api_definition__full_custom_webhook_response__NULL = 0, ezmax_api_definition__full_custom_webhook_response__UserCreated } ezmax_api_definition__full_custom_webhook_response__e;
