...
static paymentterm_get_list_v1_response_m_payload_t *paymentterm_get_list_v1_response_m_payload_create_internal(
    ...
    memset(paymentterm_get_list_v1_response_m_payload_local_var, 0, sizeof(paymentterm_get_list_v1_response_m_payload_t));
...
__attribute__((deprecated)) paymentterm_get_list_v1_response_m_payload_t *paymentterm_get_list_v1_response_m_payload_create(
    ...
    paymentterm_get_list_v1_response_m_payload_t *result = paymentterm_get_list_v1_response_m_payload_create_internal (
        i_row_returned_copy,
        i_row_filtered_copy,
        a_obj_paymentterm
        );
...
void paymentterm_get_list_v1_response_m_payload_free(paymentterm_get_list_v1_response_m_payload_t *paymentterm_get_list_v1_response_m_payload) {
    ...
    if (paymentterm_get_list_v1_response_m_payload->i_row_returned) {
        free(paymentterm_get_list_v1_response_m_payload->i_row_returned);
        paymentterm_get_list_v1_response_m_payload->i_row_returned = NULL;
    }
    if (paymentterm_get_list_v1_response_m_payload->i_row_filtered) {
        free(paymentterm_get_list_v1_response_m_payload->i_row_filtered);
        paymentterm_get_list_v1_response_m_payload->i_row_filtered = NULL;
    }
...
paymentterm_get_list_v1_response_m_payload_t *paymentterm_get_list_v1_response_m_payload_parseFromJSON(cJSON *paymentterm_get_list_v1_response_m_payloadJSON){
    ...
    // define the local variable for paymentterm_get_list_v1_response_m_payload->i_row_returned
    int *i_row_returned_local_var = NULL;

    // define the local variable for paymentterm_get_list_v1_response_m_payload->i_row_filtered
