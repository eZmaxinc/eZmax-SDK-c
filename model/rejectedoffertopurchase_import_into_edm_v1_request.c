...
#include <string.h>
#include <stdio.h>
#include "rejectedoffertopurchase_import_into_edm_v1_request.h"



static rejectedoffertopurchase_import_into_edm_v1_request_t *rejectedoffertopurchase_import_into_edm_v1_request_create_internal(
    list_t *a_obj_attachment
    ) {
    rejectedoffertopurchase_import_into_edm_v1_request_t *rejectedoffertopurchase_import_into_edm_v1_request_local_var = malloc(sizeof(rejectedoffertopurchase_import_into_edm_v1_request_t));
...
void rejectedoffertopurchase_import_into_edm_v1_request_free(rejectedoffertopurchase_import_into_edm_v1_request_t *rejectedoffertopurchase_import_into_edm_v1_request) {
    if(NULL == rejectedoffertopurchase_import_into_edm_v1_request){
        return ;
    }
    if(rejectedoffertopurchase_import_into_edm_v1_request->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "rejectedoffertopurchase_import_into_edm_v1_request_free");
        return ;
    }
    listEntry_t *listEntry;
    if (rejectedoffertopurchase_import_into_edm_v1_request->a_obj_attachment) {
        list_ForEach(listEntry, rejectedoffertopurchase_import_into_edm_v1_request->a_obj_attachment) {
            custom_attachment_import_into_edm_request_free(listEntry->data);
        }
        list_freeList(rejectedoffertopurchase_import_into_edm_v1_request->a_obj_attachment);
        rejectedoffertopurchase_import_into_edm_v1_request->a_obj_attachment = NULL;
    }
    free(rejectedoffertopurchase_import_into_edm_v1_request);
}
...
cJSON *rejectedoffertopurchase_import_into_edm_v1_request_convertToJSON(rejectedoffertopurchase_import_into_edm_v1_request_t *rejectedoffertopurchase_import_into_edm_v1_request) {
    ...
    // rejectedoffertopurchase_import_into_edm_v1_request->a_obj_attachment
    if (!rejectedoffertopurchase_import_into_edm_v1_request->a_obj_attachment) {
        goto fail;
    }
    ...
    if (rejectedoffertopurchase_import_into_edm_v1_request->a_obj_attachment) {
    list_ForEach(a_obj_attachmentListEntry, rejectedoffertopurchase_import_into_edm_v1_request->a_obj_attachment) {
...
rejectedoffertopurchase_import_into_edm_v1_request_t *rejectedoffertopurchase_import_into_edm_v1_request_parseFromJSON(cJSON *rejectedoffertopurchase_import_into_edm_v1_requestJSON){
    ...
    rejectedoffertopurchase_import_into_edm_v1_request_t *rejectedoffertopurchase_import_into_edm_v1_request_local_var = NULL;

    // define the local list for rejectedoffertopurchase_import_into_edm_v1_request->a_obj_attachment
    list_t *a_obj_attachmentList = NULL;

    // rejectedoffertopurchase_import_into_edm_v1_request->a_obj_attachment
    cJSON *a_obj_attachment = cJSON_GetObjectItemCaseSensitive(rejectedoffertopurchase_import_into_edm_v1_requestJSON, "a_objAttachment");
