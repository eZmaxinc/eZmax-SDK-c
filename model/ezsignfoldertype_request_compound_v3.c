...
void ezsignfoldertype_request_compound_v3_free(ezsignfoldertype_request_compound_v3_t *ezsignfoldertype_request_compound_v3) {
    ...
    if (ezsignfoldertype_request_compound_v3->e_ezsignfoldertype_documentdependency) {
        field_e_ezsignfoldertype_documentdependency_free(ezsignfoldertype_request_compound_v3->e_ezsignfoldertype_documentdependency);
        ezsignfoldertype_request_compound_v3->e_ezsignfoldertype_documentdependency = NULL;
    }
    ...
    if (ezsignfoldertype_request_compound_v3->e_ezsignfoldertype_pdfarequirement) {
        field_e_ezsignfoldertype_pdfarequirement_free(ezsignfoldertype_request_compound_v3->e_ezsignfoldertype_pdfarequirement);
        ezsignfoldertype_request_compound_v3->e_ezsignfoldertype_pdfarequirement = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->e_ezsignfoldertype_pdfanoncompliantaction) {
        field_e_ezsignfoldertype_pdfanoncompliantaction_free(ezsignfoldertype_request_compound_v3->e_ezsignfoldertype_pdfanoncompliantaction);
        ezsignfoldertype_request_compound_v3->e_ezsignfoldertype_pdfanoncompliantaction = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->e_ezsignfoldertype_privacylevel) {
        field_e_ezsignfoldertype_privacylevel_free(ezsignfoldertype_request_compound_v3->e_ezsignfoldertype_privacylevel);
        ezsignfoldertype_request_compound_v3->e_ezsignfoldertype_privacylevel = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->e_ezsignfoldertype_disposal) {
        field_e_ezsignfoldertype_disposal_free(ezsignfoldertype_request_compound_v3->e_ezsignfoldertype_disposal);
        ezsignfoldertype_request_compound_v3->e_ezsignfoldertype_disposal = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->e_ezsignfoldertype_completion) {
        field_e_ezsignfoldertype_completion_free(ezsignfoldertype_request_compound_v3->e_ezsignfoldertype_completion);
        ezsignfoldertype_request_compound_v3->e_ezsignfoldertype_completion = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->e_ezsignfoldertype_signeraccess) {
        field_e_ezsignfoldertype_signeraccess_free(ezsignfoldertype_request_compound_v3->e_ezsignfoldertype_signeraccess);
        ezsignfoldertype_request_compound_v3->e_ezsignfoldertype_signeraccess = NULL;
    }
...
cJSON *ezsignfoldertype_request_compound_v3_convertToJSON(ezsignfoldertype_request_compound_v3_t *ezsignfoldertype_request_compound_v3) {
    ...
    if(ezsignfoldertype_request_compound_v3->e_ezsignfoldertype_documentdependency != ezmax_api_definition__full_ezsignfoldertype_request_compound_v3__NULL) {
    ...
    if(ezsignfoldertype_request_compound_v3->e_ezsignfoldertype_pdfarequirement != ezmax_api_definition__full_ezsignfoldertype_request_compound_v3__NULL) {
    ...
    if(ezsignfoldertype_request_compound_v3->e_ezsignfoldertype_pdfanoncompliantaction != ezmax_api_definition__full_ezsignfoldertype_request_compound_v3__NULL) {
    ...
    if (ezmax_api_definition__full_ezsignfoldertype_request_compound_v3__NULL == ezsignfoldertype_request_compound_v3->e_ezsignfoldertype_privacylevel) {
        goto fail;
    }
    ...
    if (ezmax_api_definition__full_ezsignfoldertype_request_compound_v3__NULL == ezsignfoldertype_request_compound_v3->e_ezsignfoldertype_disposal) {
        goto fail;
    }
    ...
    if (ezmax_api_definition__full_ezsignfoldertype_request_compound_v3__NULL == ezsignfoldertype_request_compound_v3->e_ezsignfoldertype_completion) {
        goto fail;
    }
    ...
    if(ezsignfoldertype_request_compound_v3->e_ezsignfoldertype_signeraccess != ezmax_api_definition__full_ezsignfoldertype_request_compound_v3__NULL) {
...
ezsignfoldertype_request_compound_v3_t *ezsignfoldertype_request_compound_v3_parseFromJSON(cJSON *ezsignfoldertype_request_compound_v3JSON){
    ...
    ezsignfoldertype_request_compound_v3_local_var = ezsignfoldertype_request_compound_v3_create (
