...
static ezsignfoldertype_request_compound_v3_t *ezsignfoldertype_request_compound_v3_create_internal(
    ...
    memset(ezsignfoldertype_request_compound_v3_local_var, 0, sizeof(ezsignfoldertype_request_compound_v3_t));
    ...
    ezsignfoldertype_request_compound_v3_local_var->b_ezsignfoldertype_senddocumentmergetoemail = b_ezsignfoldertype_senddocumentmergetoemail;
    ezsignfoldertype_request_compound_v3_local_var->b_ezsignfoldertype_senddocumentmergetoezsignsigner = b_ezsignfoldertype_senddocumentmergetoezsignsigner;
    ezsignfoldertype_request_compound_v3_local_var->b_ezsignfoldertype_senddocumentmergetoreceivealldocument = b_ezsignfoldertype_senddocumentmergetoreceivealldocument;
    ezsignfoldertype_request_compound_v3_local_var->b_ezsignfoldertype_senddocumentmergetouser = b_ezsignfoldertype_senddocumentmergetouser;
...
__attribute__((deprecated)) ezsignfoldertype_request_compound_v3_t *ezsignfoldertype_request_compound_v3_create(
    ...
    ezsignfoldertype_request_compound_v3_t *result = ezsignfoldertype_request_compound_v3_create_internal (
...
void ezsignfoldertype_request_compound_v3_free(ezsignfoldertype_request_compound_v3_t *ezsignfoldertype_request_compound_v3) {
    ...
    if (ezsignfoldertype_request_compound_v3->pki_ezsignfoldertype_id) {
        free(ezsignfoldertype_request_compound_v3->pki_ezsignfoldertype_id);
        ezsignfoldertype_request_compound_v3->pki_ezsignfoldertype_id = NULL;
    }
    ...
    if (ezsignfoldertype_request_compound_v3->fki_branding_id) {
        free(ezsignfoldertype_request_compound_v3->fki_branding_id);
        ezsignfoldertype_request_compound_v3->fki_branding_id = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->fki_billingentityinternal_id) {
        free(ezsignfoldertype_request_compound_v3->fki_billingentityinternal_id);
        ezsignfoldertype_request_compound_v3->fki_billingentityinternal_id = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->fki_ezsigntsarequirement_id) {
        free(ezsignfoldertype_request_compound_v3->fki_ezsigntsarequirement_id);
        ezsignfoldertype_request_compound_v3->fki_ezsigntsarequirement_id = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->fki_font_id_annotation) {
        free(ezsignfoldertype_request_compound_v3->fki_font_id_annotation);
        ezsignfoldertype_request_compound_v3->fki_font_id_annotation = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->fki_font_id_formfield) {
        free(ezsignfoldertype_request_compound_v3->fki_font_id_formfield);
        ezsignfoldertype_request_compound_v3->fki_font_id_formfield = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->fki_font_id_signature) {
        free(ezsignfoldertype_request_compound_v3->fki_font_id_signature);
        ezsignfoldertype_request_compound_v3->fki_font_id_signature = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->fki_pdfalevel_id_convert) {
        free(ezsignfoldertype_request_compound_v3->fki_pdfalevel_id_convert);
        ezsignfoldertype_request_compound_v3->fki_pdfalevel_id_convert = NULL;
    }
    ...
    if (ezsignfoldertype_request_compound_v3->i_ezsignfoldertype_fontsizeannotation) {
        free(ezsignfoldertype_request_compound_v3->i_ezsignfoldertype_fontsizeannotation);
        ezsignfoldertype_request_compound_v3->i_ezsignfoldertype_fontsizeannotation = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->i_ezsignfoldertype_fontsizeformfield) {
        free(ezsignfoldertype_request_compound_v3->i_ezsignfoldertype_fontsizeformfield);
        ezsignfoldertype_request_compound_v3->i_ezsignfoldertype_fontsizeformfield = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->i_ezsignfoldertype_sendreminderfirstdays) {
        free(ezsignfoldertype_request_compound_v3->i_ezsignfoldertype_sendreminderfirstdays);
        ezsignfoldertype_request_compound_v3->i_ezsignfoldertype_sendreminderfirstdays = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->i_ezsignfoldertype_sendreminderotherdays) {
        free(ezsignfoldertype_request_compound_v3->i_ezsignfoldertype_sendreminderotherdays);
        ezsignfoldertype_request_compound_v3->i_ezsignfoldertype_sendreminderotherdays = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->i_ezsignfoldertype_archivaldays) {
        free(ezsignfoldertype_request_compound_v3->i_ezsignfoldertype_archivaldays);
        ezsignfoldertype_request_compound_v3->i_ezsignfoldertype_archivaldays = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->i_ezsignfoldertype_disposaldays) {
        free(ezsignfoldertype_request_compound_v3->i_ezsignfoldertype_disposaldays);
        ezsignfoldertype_request_compound_v3->i_ezsignfoldertype_disposaldays = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->i_ezsignfoldertype_deadlinedays) {
        free(ezsignfoldertype_request_compound_v3->i_ezsignfoldertype_deadlinedays);
        ezsignfoldertype_request_compound_v3->i_ezsignfoldertype_deadlinedays = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_prematurelyendautomatically) {
        free(ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_prematurelyendautomatically);
        ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_prematurelyendautomatically = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->i_ezsignfoldertype_prematurelyendautomaticallydays) {
        free(ezsignfoldertype_request_compound_v3->i_ezsignfoldertype_prematurelyendautomaticallydays);
        ezsignfoldertype_request_compound_v3->i_ezsignfoldertype_prematurelyendautomaticallydays = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_automaticsignature) {
        free(ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_automaticsignature);
        ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_automaticsignature = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_delegate) {
        free(ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_delegate);
        ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_delegate = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_discussion) {
        free(ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_discussion);
        ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_discussion = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_logrecipientinproof) {
        free(ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_logrecipientinproof);
        ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_logrecipientinproof = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_reassignezsignsigner) {
        free(ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_reassignezsignsigner);
        ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_reassignezsignsigner = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_reassignuser) {
        free(ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_reassignuser);
        ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_reassignuser = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_reassigngroup) {
        free(ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_reassigngroup);
        ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_reassigngroup = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_senddocumentmergetoemail) {
        free(ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_senddocumentmergetoemail);
        ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_senddocumentmergetoemail = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_senddocumentmergetoezsignsigner) {
        free(ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_senddocumentmergetoezsignsigner);
        ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_senddocumentmergetoezsignsigner = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_senddocumentmergetoreceivealldocument) {
        free(ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_senddocumentmergetoreceivealldocument);
        ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_senddocumentmergetoreceivealldocument = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_senddocumentmergetouser) {
        free(ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_senddocumentmergetouser);
        ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_senddocumentmergetouser = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsignedtoezsignsigner) {
        free(ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsignedtoezsignsigner);
        ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsignedtoezsignsigner = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsignedtouser) {
        free(ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsignedtouser);
        ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsignedtouser = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendattachmentezsignsigner) {
        free(ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendattachmentezsignsigner);
        ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendattachmentezsignsigner = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsignatureattachmentezsignsigner) {
        free(ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsignatureattachmentezsignsigner);
        ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsignatureattachmentezsignsigner = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsignatureattachment) {
        free(ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsignatureattachment);
        ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsignatureattachment = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendproofezsignsigner) {
        free(ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendproofezsignsigner);
        ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendproofezsignsigner = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendattachmentuser) {
        free(ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendattachmentuser);
        ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendattachmentuser = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsignatureattachmentuser) {
        free(ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsignatureattachmentuser);
        ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsignatureattachmentuser = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendproofuser) {
        free(ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendproofuser);
        ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendproofuser = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendproofemail) {
        free(ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendproofemail);
        ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendproofemail = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_allowdownloadattachmentezsignsigner) {
        free(ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_allowdownloadattachmentezsignsigner);
        ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_allowdownloadattachmentezsignsigner = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_allowdownloadsignatureattachmentezsignsigner) {
        free(ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_allowdownloadsignatureattachmentezsignsigner);
        ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_allowdownloadsignatureattachmentezsignsigner = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_allowdownloadproofezsignsigner) {
        free(ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_allowdownloadproofezsignsigner);
        ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_allowdownloadproofezsignsigner = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendproofreceivealldocument) {
        free(ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendproofreceivealldocument);
        ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendproofreceivealldocument = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsignatureattachmentreceivealldocument) {
        free(ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsignatureattachmentreceivealldocument);
        ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsignatureattachmentreceivealldocument = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsignedtodocumentowner) {
        free(ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsignedtodocumentowner);
        ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsignedtodocumentowner = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsignedtofolderowner) {
        free(ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsignedtofolderowner);
        ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsignedtofolderowner = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsignedtofullgroup) {
        free(ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsignedtofullgroup);
        ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsignedtofullgroup = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsignedtolimitedgroup) {
        free(ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsignedtolimitedgroup);
        ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsignedtolimitedgroup = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsignedtocolleague) {
        free(ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsignedtocolleague);
        ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsignedtocolleague = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsummarytodocumentowner) {
        free(ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsummarytodocumentowner);
        ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsummarytodocumentowner = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsummarytofolderowner) {
        free(ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsummarytofolderowner);
        ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsummarytofolderowner = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsummarytofullgroup) {
        free(ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsummarytofullgroup);
        ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsummarytofullgroup = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsummarytolimitedgroup) {
        free(ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsummarytolimitedgroup);
        ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsummarytolimitedgroup = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsummarytocolleague) {
        free(ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsummarytocolleague);
        ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsummarytocolleague = NULL;
    }
    if (ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_isactive) {
        free(ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_isactive);
        ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_isactive = NULL;
    }
...
cJSON *ezsignfoldertype_request_compound_v3_convertToJSON(ezsignfoldertype_request_compound_v3_t *ezsignfoldertype_request_compound_v3) {
    ...
    // ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_senddocumentmergetoemail
    if(ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_senddocumentmergetoemail) {
    if(cJSON_AddBoolToObject(item, "bEzsignfoldertypeSenddocumentmergetoemail", *ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_senddocumentmergetoemail) == NULL) {
    goto fail; //Bool
    }
    }


    // ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_senddocumentmergetoezsignsigner
    if(ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_senddocumentmergetoezsignsigner) {
    if(cJSON_AddBoolToObject(item, "bEzsignfoldertypeSenddocumentmergetoezsignsigner", *ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_senddocumentmergetoezsignsigner) == NULL) {
    goto fail; //Bool
    }
    }


    // ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_senddocumentmergetoreceivealldocument
    if(ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_senddocumentmergetoreceivealldocument) {
    if(cJSON_AddBoolToObject(item, "bEzsignfoldertypeSenddocumentmergetoreceivealldocument", *ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_senddocumentmergetoreceivealldocument) == NULL) {
    goto fail; //Bool
    }
    }


    // ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_senddocumentmergetouser
    if(ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_senddocumentmergetouser) {
    if(cJSON_AddBoolToObject(item, "bEzsignfoldertypeSenddocumentmergetouser", *ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_senddocumentmergetouser) == NULL) {
    goto fail; //Bool
    }
    }
...
ezsignfoldertype_request_compound_v3_t *ezsignfoldertype_request_compound_v3_parseFromJSON(cJSON *ezsignfoldertype_request_compound_v3JSON){
    ...
    // define the local variable for ezsignfoldertype_request_compound_v3->pki_ezsignfoldertype_id
    ...
    // define the local variable for ezsignfoldertype_request_compound_v3->fki_branding_id
    int *fki_branding_id_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->fki_billingentityinternal_id
    int *fki_billingentityinternal_id_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->fki_ezsigntsarequirement_id
    int *fki_ezsigntsarequirement_id_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->fki_font_id_annotation
    int *fki_font_id_annotation_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->fki_font_id_formfield
    int *fki_font_id_formfield_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->fki_font_id_signature
    int *fki_font_id_signature_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->fki_pdfalevel_id_convert
    ...
    // define the local variable for ezsignfoldertype_request_compound_v3->i_ezsignfoldertype_fontsizeannotation
    int *i_ezsignfoldertype_fontsizeannotation_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->i_ezsignfoldertype_fontsizeformfield
    int *i_ezsignfoldertype_fontsizeformfield_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->i_ezsignfoldertype_sendreminderfirstdays
    int *i_ezsignfoldertype_sendreminderfirstdays_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->i_ezsignfoldertype_sendreminderotherdays
    int *i_ezsignfoldertype_sendreminderotherdays_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->i_ezsignfoldertype_archivaldays
    ...
    // define the local variable for ezsignfoldertype_request_compound_v3->i_ezsignfoldertype_disposaldays
    int *i_ezsignfoldertype_disposaldays_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->i_ezsignfoldertype_deadlinedays
    int *i_ezsignfoldertype_deadlinedays_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_prematurelyendautomatically
    int *b_ezsignfoldertype_prematurelyendautomatically_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->i_ezsignfoldertype_prematurelyendautomaticallydays
    int *i_ezsignfoldertype_prematurelyendautomaticallydays_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_automaticsignature
    int *b_ezsignfoldertype_automaticsignature_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_delegate
    int *b_ezsignfoldertype_delegate_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_discussion
    int *b_ezsignfoldertype_discussion_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_logrecipientinproof
    int *b_ezsignfoldertype_logrecipientinproof_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_reassignezsignsigner
    int *b_ezsignfoldertype_reassignezsignsigner_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_reassignuser
    int *b_ezsignfoldertype_reassignuser_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_reassigngroup
    int *b_ezsignfoldertype_reassigngroup_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_senddocumentmergetoemail
    int *b_ezsignfoldertype_senddocumentmergetoemail_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_senddocumentmergetoezsignsigner
    int *b_ezsignfoldertype_senddocumentmergetoezsignsigner_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_senddocumentmergetoreceivealldocument
    int *b_ezsignfoldertype_senddocumentmergetoreceivealldocument_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_senddocumentmergetouser
    int *b_ezsignfoldertype_senddocumentmergetouser_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsignedtoezsignsigner
    int *b_ezsignfoldertype_sendsignedtoezsignsigner_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsignedtouser
    int *b_ezsignfoldertype_sendsignedtouser_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendattachmentezsignsigner
    int *b_ezsignfoldertype_sendattachmentezsignsigner_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsignatureattachmentezsignsigner
    int *b_ezsignfoldertype_sendsignatureattachmentezsignsigner_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsignatureattachment
    int *b_ezsignfoldertype_sendsignatureattachment_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendproofezsignsigner
    int *b_ezsignfoldertype_sendproofezsignsigner_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendattachmentuser
    int *b_ezsignfoldertype_sendattachmentuser_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsignatureattachmentuser
    int *b_ezsignfoldertype_sendsignatureattachmentuser_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendproofuser
    int *b_ezsignfoldertype_sendproofuser_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendproofemail
    int *b_ezsignfoldertype_sendproofemail_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_allowdownloadattachmentezsignsigner
    int *b_ezsignfoldertype_allowdownloadattachmentezsignsigner_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_allowdownloadsignatureattachmentezsignsigner
    int *b_ezsignfoldertype_allowdownloadsignatureattachmentezsignsigner_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_allowdownloadproofezsignsigner
    int *b_ezsignfoldertype_allowdownloadproofezsignsigner_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendproofreceivealldocument
    int *b_ezsignfoldertype_sendproofreceivealldocument_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsignatureattachmentreceivealldocument
    int *b_ezsignfoldertype_sendsignatureattachmentreceivealldocument_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsignedtodocumentowner
    int *b_ezsignfoldertype_sendsignedtodocumentowner_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsignedtofolderowner
    int *b_ezsignfoldertype_sendsignedtofolderowner_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsignedtofullgroup
    int *b_ezsignfoldertype_sendsignedtofullgroup_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsignedtolimitedgroup
    int *b_ezsignfoldertype_sendsignedtolimitedgroup_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsignedtocolleague
    int *b_ezsignfoldertype_sendsignedtocolleague_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsummarytodocumentowner
    int *b_ezsignfoldertype_sendsummarytodocumentowner_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsummarytofolderowner
    int *b_ezsignfoldertype_sendsummarytofolderowner_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsummarytofullgroup
    int *b_ezsignfoldertype_sendsummarytofullgroup_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsummarytolimitedgroup
    int *b_ezsignfoldertype_sendsummarytolimitedgroup_local_var = NULL;

    // define the local variable for ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_sendsummarytocolleague
    ...
    // define the local variable for ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_isactive
    ...
    *b_ezsignfoldertype_reassigngroup_local_var = b_ezsignfoldertype_reassigngroup->valueint;
    ...
    // ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_senddocumentmergetoemail
    cJSON *b_ezsignfoldertype_senddocumentmergetoemail = cJSON_GetObjectItemCaseSensitive(ezsignfoldertype_request_compound_v3JSON, "bEzsignfoldertypeSenddocumentmergetoemail");
    ...
    *b_ezsignfoldertype_senddocumentmergetoemail_local_var = b_ezsignfoldertype_senddocumentmergetoemail->valueint;
    ...
    // ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_senddocumentmergetoezsignsigner
    cJSON *b_ezsignfoldertype_senddocumentmergetoezsignsigner = cJSON_GetObjectItemCaseSensitive(ezsignfoldertype_request_compound_v3JSON, "bEzsignfoldertypeSenddocumentmergetoezsignsigner");
    ...
    *b_ezsignfoldertype_senddocumentmergetoezsignsigner_local_var = b_ezsignfoldertype_senddocumentmergetoezsignsigner->valueint;
    ...
    // ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_senddocumentmergetoreceivealldocument
    cJSON *b_ezsignfoldertype_senddocumentmergetoreceivealldocument = cJSON_GetObjectItemCaseSensitive(ezsignfoldertype_request_compound_v3JSON, "bEzsignfoldertypeSenddocumentmergetoreceivealldocument");
    ...
    *b_ezsignfoldertype_senddocumentmergetoreceivealldocument_local_var = b_ezsignfoldertype_senddocumentmergetoreceivealldocument->valueint;
    ...
    // ezsignfoldertype_request_compound_v3->b_ezsignfoldertype_senddocumentmergetouser
    cJSON *b_ezsignfoldertype_senddocumentmergetouser = cJSON_GetObjectItemCaseSensitive(ezsignfoldertype_request_compound_v3JSON, "bEzsignfoldertypeSenddocumentmergetouser");
