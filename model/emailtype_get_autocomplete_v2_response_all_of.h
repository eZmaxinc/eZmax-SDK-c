/*
 * emailtype_get_autocomplete_v2_response_all_of.h
 *
 * 
 */

#ifndef _emailtype_get_autocomplete_v2_response_all_of_H_
#define _emailtype_get_autocomplete_v2_response_all_of_H_
...
typedef struct emailtype_get_autocomplete_v2_response_all_of_t emailtype_get_autocomplete_v2_response_all_of_t;

#include "emailtype_get_autocomplete_v2_response_m_payload.h"



typedef struct emailtype_get_autocomplete_v2_response_all_of_t {
    struct emailtype_get_autocomplete_v2_response_m_payload_t *m_payload; //model

} emailtype_get_autocomplete_v2_response_all_of_t;
...
#endif /* _emailtype_get_autocomplete_v2_response_all_of_H_ */
