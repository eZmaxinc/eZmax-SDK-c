...
void ezsignsignature_edit_object_v1_request_free(ezsignsignature_edit_object_v1_request_t *ezsignsignature_edit_object_v1_request) {
    ...
    if (ezsignsignature_edit_object_v1_request->obj_ezsignsignature) {
        ezsignsignature_request_compound_free(ezsignsignature_edit_object_v1_request->obj_ezsignsignature);
...
ezsignsignature_edit_object_v1_request_t *ezsignsignature_edit_object_v1_request_parseFromJSON(cJSON *ezsignsignature_edit_object_v1_requestJSON){
    ...
    // define the local variable for ezsignsignature_edit_object_v1_request->obj_ezsignsignature
    ezsignsignature_request_compound_t *obj_ezsignsignature_local_nonprim = NULL;
    ...
    obj_ezsignsignature_local_nonprim = ezsignsignature_request_compound_parseFromJSON(obj_ezsignsignature); //nonprimitive
    ...
    if (obj_ezsignsignature_local_nonprim) {
        ezsignsignature_request_compound_free(obj_ezsignsignature_local_nonprim);
