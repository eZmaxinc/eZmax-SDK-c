...
static ezsignfolder_get_communication_list_v1_response_m_payload_t *ezsignfolder_get_communication_list_v1_response_m_payload_create_internal(
    ...
    memset(ezsignfolder_get_communication_list_v1_response_m_payload_local_var, 0, sizeof(ezsignfolder_get_communication_list_v1_response_m_payload_t));
...
__attribute__((deprecated)) ezsignfolder_get_communication_list_v1_response_m_payload_t *ezsignfolder_get_communication_list_v1_response_m_payload_create(
    ...
    ezsignfolder_get_communication_list_v1_response_m_payload_t *result = ezsignfolder_get_communication_list_v1_response_m_payload_create_internal (
        a_obj_communication
        );
    if (!result) {
    }
