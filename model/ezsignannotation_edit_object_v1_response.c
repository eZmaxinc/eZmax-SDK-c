...
static ezsignannotation_edit_object_v1_response_t *ezsignannotation_edit_object_v1_response_create_internal(
    ...
    memset(ezsignannotation_edit_object_v1_response_local_var, 0, sizeof(ezsignannotation_edit_object_v1_response_t));
...
__attribute__((deprecated)) ezsignannotation_edit_object_v1_response_t *ezsignannotation_edit_object_v1_response_create(
    ...
    ezsignannotation_edit_object_v1_response_t *result = ezsignannotation_edit_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug
        );
    if (!result) {
