...
static supply_edit_object_v1_response_t *supply_edit_object_v1_response_create_internal(
    ...
    memset(supply_edit_object_v1_response_local_var, 0, sizeof(supply_edit_object_v1_response_t));
...
__attribute__((deprecated)) supply_edit_object_v1_response_t *supply_edit_object_v1_response_create(
    ...
    supply_edit_object_v1_response_t *result = supply_edit_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug
        );
    if (!result) {
