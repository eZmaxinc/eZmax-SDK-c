...
static signature_delete_object_v1_response_t *signature_delete_object_v1_response_create_internal(
    ...
    memset(signature_delete_object_v1_response_local_var, 0, sizeof(signature_delete_object_v1_response_t));
...
__attribute__((deprecated)) signature_delete_object_v1_response_t *signature_delete_object_v1_response_create(
    ...
    signature_delete_object_v1_response_t *result = signature_delete_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug
        );
    if (!result) {
