...
ezsignuser_edit_object_v1_response_t *ezsignuser_edit_object_v1_response_create(
...
ezsignuser_edit_object_v1_response_t *ezsignuser_edit_object_v1_response_parseFromJSON(cJSON *ezsignuser_edit_object_v1_responseJSON){
    ...
    ezsignuser_edit_object_v1_response_local_var = ezsignuser_edit_object_v1_response_create (
