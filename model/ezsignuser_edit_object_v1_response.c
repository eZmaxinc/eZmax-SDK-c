...
static ezsignuser_edit_object_v1_response_t *ezsignuser_edit_object_v1_response_create_internal(
    ...
    memset(ezsignuser_edit_object_v1_response_local_var, 0, sizeof(ezsignuser_edit_object_v1_response_t));
...
__attribute__((deprecated)) ezsignuser_edit_object_v1_response_t *ezsignuser_edit_object_v1_response_create(
    ...
    ezsignuser_edit_object_v1_response_t *result = ezsignuser_edit_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug
        );
    if (!result) {
