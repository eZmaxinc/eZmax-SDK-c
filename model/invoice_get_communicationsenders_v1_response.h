/*
 * invoice_get_communicationsenders_v1_response.h
 *
 * Response for GET /1/object/invoice/{pkiInvoiceID}/getCommunicationrecipients
 */

#ifndef _invoice_get_communicationsenders_v1_response_H_
#define _invoice_get_communicationsenders_v1_response_H_
...
typedef struct invoice_get_communicationsenders_v1_response_t invoice_get_communicationsenders_v1_response_t;
...
typedef struct invoice_get_communicationsenders_v1_response_t {
    struct common_response_obj_debug_payload_t *obj_debug_payload; //model
    struct common_response_obj_debug_t *obj_debug; //model
    struct invoice_get_communicationsenders_v1_response_m_payload_t *m_payload; //model

} invoice_get_communicationsenders_v1_response_t;

invoice_get_communicationsenders_v1_response_t *invoice_get_communicationsenders_v1_response_create(
...
#endif /* _invoice_get_communicationsenders_v1_response_H_ */
