...
char* e_ezsignsignature_textvalidationezsignsignature_request_compound_ToString(ezmax_api_definition__full_ezsignsignature_request_compound__e e_ezsignsignature_textvalidation) {
...
ezmax_api_definition__full_ezsignsignature_request_compound__e e_ezsignsignature_textvalidationezsignsignature_request_compound_FromString(char* e_ezsignsignature_textvalidation){
    int stringToReturn = 0;
    char *e_ezsignsignature_textvalidationArray[] =  { "NULL", "None", "Date (YYYY-MM-DD)", "Date (MM/DD/YYYY)", "Date (MM/DD/YY)", "Date (DD/MM/YYYY)", "Date (DD/MM/YY)", "Email", "Letters", "Numbers", "Zip", "Zip+4", "PostalCode", "Custom" };
...
char* e_ezsignsignature_dependencyrequirementezsignsignature_request_compound_ToString(ezmax_api_definition__full_ezsignsignature_request_compound__e e_ezsignsignature_dependencyrequirement) {
...
ezmax_api_definition__full_ezsignsignature_request_compound__e e_ezsignsignature_dependencyrequirementezsignsignature_request_compound_FromString(char* e_ezsignsignature_dependencyrequirement){
    int stringToReturn = 0;
    char *e_ezsignsignature_dependencyrequirementArray[] =  { "NULL", "AllOf", "AnyOf" };
...
void ezsignsignature_request_compound_free(ezsignsignature_request_compound_t *ezsignsignature_request_compound) {
    ...
    if (ezsignsignature_request_compound->e_ezsignsignature_textvalidation) {
        enum_textvalidation_free(ezsignsignature_request_compound->e_ezsignsignature_textvalidation);
        ezsignsignature_request_compound->e_ezsignsignature_textvalidation = NULL;
    }
    ...
    if (ezsignsignature_request_compound->e_ezsignsignature_dependencyrequirement) {
        field_e_ezsignsignature_dependencyrequirement_free(ezsignsignature_request_compound->e_ezsignsignature_dependencyrequirement);
        ezsignsignature_request_compound->e_ezsignsignature_dependencyrequirement = NULL;
    }
...
cJSON *ezsignsignature_request_compound_convertToJSON(ezsignsignature_request_compound_t *ezsignsignature_request_compound) {
    ...
    if(ezsignsignature_request_compound->e_ezsignsignature_textvalidation != ezmax_api_definition__full_ezsignsignature_request_compound__NULL) {
    ...
    if(ezsignsignature_request_compound->e_ezsignsignature_dependencyrequirement != ezmax_api_definition__full_ezsignsignature_request_compound__NULL) {
