...
void ezsignsignature_request_compound_free(ezsignsignature_request_compound_t *ezsignsignature_request_compound) {
    ...
    if (ezsignsignature_request_compound->e_ezsignsignature_consultationtrigger) {
        field_e_ezsignsignature_consultationtrigger_free(ezsignsignature_request_compound->e_ezsignsignature_consultationtrigger);
        ezsignsignature_request_compound->e_ezsignsignature_consultationtrigger = NULL;
    }
...
cJSON *ezsignsignature_request_compound_convertToJSON(ezsignsignature_request_compound_t *ezsignsignature_request_compound) {
    ...
    if(ezsignsignature_request_compound->e_ezsignsignature_consultationtrigger != ezmax_api_definition__full_ezsignsignature_request_compound__NULL) {
