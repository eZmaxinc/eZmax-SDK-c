...
static externalbroker_import_into_edm_v1_request_t *externalbroker_import_into_edm_v1_request_create_internal(
    ...
    memset(externalbroker_import_into_edm_v1_request_local_var, 0, sizeof(externalbroker_import_into_edm_v1_request_t));
...
__attribute__((deprecated)) externalbroker_import_into_edm_v1_request_t *externalbroker_import_into_edm_v1_request_create(
    ...
    externalbroker_import_into_edm_v1_request_t *result = externalbroker_import_into_edm_v1_request_create_internal (
        a_obj_attachment
        );
    if (!result) {
    }
