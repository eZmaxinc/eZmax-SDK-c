...
char* e_ezsignfolder_sendreminderfrequencyezsignfolder_get_object_v1_response_m_payload_ToString(ezmax_api_definition__full_ezsignfolder_get_object_v1_response_m_payload__e e_ezsignfolder_sendreminderfrequency) {
...
ezmax_api_definition__full_ezsignfolder_get_object_v1_response_m_payload__e e_ezsignfolder_sendreminderfrequencyezsignfolder_get_object_v1_response_m_payload_FromString(char* e_ezsignfolder_sendreminderfrequency){
...
ezsignfolder_get_object_v1_response_m_payload_t *ezsignfolder_get_object_v1_response_m_payload_create(
    ...
    ezsignfolder_get_object_v1_response_m_payload_local_var->dt_ezsignfolder_scheduleddestruction = dt_ezsignfolder_scheduleddestruction;
...
void ezsignfolder_get_object_v1_response_m_payload_free(ezsignfolder_get_object_v1_response_m_payload_t *ezsignfolder_get_object_v1_response_m_payload) {
    ...
    if (ezsignfolder_get_object_v1_response_m_payload->dt_ezsignfolder_scheduleddestruction) {
        free(ezsignfolder_get_object_v1_response_m_payload->dt_ezsignfolder_scheduleddestruction);
        ezsignfolder_get_object_v1_response_m_payload->dt_ezsignfolder_scheduleddestruction = NULL;
    }
...
cJSON *ezsignfolder_get_object_v1_response_m_payload_convertToJSON(ezsignfolder_get_object_v1_response_m_payload_t *ezsignfolder_get_object_v1_response_m_payload) {
    ...
    if (ezmax_api_definition__full_ezsignfolder_get_object_v1_response_m_payload__NULL == ezsignfolder_get_object_v1_response_m_payload->e_ezsignfolder_sendreminderfrequency) {
        goto fail;
    }
    ...
    // ezsignfolder_get_object_v1_response_m_payload->dt_ezsignfolder_scheduleddestruction
    if (!ezsignfolder_get_object_v1_response_m_payload->dt_ezsignfolder_scheduleddestruction) {
        goto fail;
    }
    if(cJSON_AddStringToObject(item, "dtEzsignfolderScheduleddestruction", ezsignfolder_get_object_v1_response_m_payload->dt_ezsignfolder_scheduleddestruction) == NULL) {
    goto fail; //String
    }


    // ezsignfolder_get_object_v1_response_m_payload->e_ezsignfolder_step
    if (ezmax_api_definition__full_ezsignfolder_get_object_v1_response_m_payload__NULL == ezsignfolder_get_object_v1_response_m_payload->e_ezsignfolder_step) {
        goto fail;
    }
...
ezsignfolder_get_object_v1_response_m_payload_t *ezsignfolder_get_object_v1_response_m_payload_parseFromJSON(cJSON *ezsignfolder_get_object_v1_response_m_payloadJSON){
    ...
    // ezsignfolder_get_object_v1_response_m_payload->dt_ezsignfolder_scheduleddestruction
    cJSON *dt_ezsignfolder_scheduleddestruction = cJSON_GetObjectItemCaseSensitive(ezsignfolder_get_object_v1_response_m_payloadJSON, "dtEzsignfolderScheduleddestruction");
