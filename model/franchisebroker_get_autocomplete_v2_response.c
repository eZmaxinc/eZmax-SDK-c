...
static franchisebroker_get_autocomplete_v2_response_t *franchisebroker_get_autocomplete_v2_response_create_internal(
    ...
    memset(franchisebroker_get_autocomplete_v2_response_local_var, 0, sizeof(franchisebroker_get_autocomplete_v2_response_t));
...
__attribute__((deprecated)) franchisebroker_get_autocomplete_v2_response_t *franchisebroker_get_autocomplete_v2_response_create(
    ...
    franchisebroker_get_autocomplete_v2_response_t *result = franchisebroker_get_autocomplete_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
