...
static billingentityinternal_edit_object_v1_response_t *billingentityinternal_edit_object_v1_response_create_internal(
    ...
    memset(billingentityinternal_edit_object_v1_response_local_var, 0, sizeof(billingentityinternal_edit_object_v1_response_t));
...
__attribute__((deprecated)) billingentityinternal_edit_object_v1_response_t *billingentityinternal_edit_object_v1_response_create(
    ...
    billingentityinternal_edit_object_v1_response_t *result = billingentityinternal_edit_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug
        );
    if (!result) {
