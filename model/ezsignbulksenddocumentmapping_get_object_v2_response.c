...
static ezsignbulksenddocumentmapping_get_object_v2_response_t *ezsignbulksenddocumentmapping_get_object_v2_response_create_internal(
    ...
    memset(ezsignbulksenddocumentmapping_get_object_v2_response_local_var, 0, sizeof(ezsignbulksenddocumentmapping_get_object_v2_response_t));
...
__attribute__((deprecated)) ezsignbulksenddocumentmapping_get_object_v2_response_t *ezsignbulksenddocumentmapping_get_object_v2_response_create(
    ...
    ezsignbulksenddocumentmapping_get_object_v2_response_t *result = ezsignbulksenddocumentmapping_get_object_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
