...
static period_get_autocomplete_v2_response_t *period_get_autocomplete_v2_response_create_internal(
    ...
    memset(period_get_autocomplete_v2_response_local_var, 0, sizeof(period_get_autocomplete_v2_response_t));
...
__attribute__((deprecated)) period_get_autocomplete_v2_response_t *period_get_autocomplete_v2_response_create(
    ...
    period_get_autocomplete_v2_response_t *result = period_get_autocomplete_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
