...
ezmax_api_definition_field_e_activesession_weekdaystart__e field_e_activesession_weekdaystart_field_e_activesession_weekdaystart_parseFromJSON(cJSON *field_e_activesession_weekdaystartJSON) {
    ezmax_api_definition_field_e_activesession_weekdaystart__e *field_e_activesession_weekdaystart = NULL;
    ezmax_api_definition_field_e_activesession_weekdaystart__e field_e_activesession_weekdaystartVariable;
