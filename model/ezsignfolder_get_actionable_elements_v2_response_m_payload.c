...
#include <string.h>
#include <stdio.h>
#include "ezsignfolder_get_actionable_elements_v2_response_m_payload.h"



static ezsignfolder_get_actionable_elements_v2_response_m_payload_t *ezsignfolder_get_actionable_elements_v2_response_m_payload_create_internal(
    list_t *a_obj_ezsignsignature,
    list_t *a_obj_ezsignformfieldgroup
    ) {
    ezsignfolder_get_actionable_elements_v2_response_m_payload_t *ezsignfolder_get_actionable_elements_v2_response_m_payload_local_var = malloc(sizeof(ezsignfolder_get_actionable_elements_v2_response_m_payload_t));
...
__attribute__((deprecated)) ezsignfolder_get_actionable_elements_v2_response_m_payload_t *ezsignfolder_get_actionable_elements_v2_response_m_payload_create(
    list_t *a_obj_ezsignsignature,
    list_t *a_obj_ezsignformfieldgroup
    ) {
...
void ezsignfolder_get_actionable_elements_v2_response_m_payload_free(ezsignfolder_get_actionable_elements_v2_response_m_payload_t *ezsignfolder_get_actionable_elements_v2_response_m_payload) {
    if(NULL == ezsignfolder_get_actionable_elements_v2_response_m_payload){
        return ;
    }
    if(ezsignfolder_get_actionable_elements_v2_response_m_payload->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsignfolder_get_actionable_elements_v2_response_m_payload_free");
        return ;
    }
    listEntry_t *listEntry;
    if (ezsignfolder_get_actionable_elements_v2_response_m_payload->a_obj_ezsignsignature) {
        list_ForEach(listEntry, ezsignfolder_get_actionable_elements_v2_response_m_payload->a_obj_ezsignsignature) {
            ezsignsignature_response_compound_free(listEntry->data);
        }
        list_freeList(ezsignfolder_get_actionable_elements_v2_response_m_payload->a_obj_ezsignsignature);
        ezsignfolder_get_actionable_elements_v2_response_m_payload->a_obj_ezsignsignature = NULL;
    }
    if (ezsignfolder_get_actionable_elements_v2_response_m_payload->a_obj_ezsignformfieldgroup) {
        list_ForEach(listEntry, ezsignfolder_get_actionable_elements_v2_response_m_payload->a_obj_ezsignformfieldgroup) {
            ezsignformfieldgroup_response_compound_free(listEntry->data);
        }
        list_freeList(ezsignfolder_get_actionable_elements_v2_response_m_payload->a_obj_ezsignformfieldgroup);
        ezsignfolder_get_actionable_elements_v2_response_m_payload->a_obj_ezsignformfieldgroup = NULL;
    }
    free(ezsignfolder_get_actionable_elements_v2_response_m_payload);
}

cJSON *ezsignfolder_get_actionable_elements_v2_response_m_payload_convertToJSON(ezsignfolder_get_actionable_elements_v2_response_m_payload_t *ezsignfolder_get_actionable_elements_v2_response_m_payload) {
    cJSON *item = cJSON_CreateObject();

    // ezsignfolder_get_actionable_elements_v2_response_m_payload->a_obj_ezsignsignature
    if (!ezsignfolder_get_actionable_elements_v2_response_m_payload->a_obj_ezsignsignature) {
        goto fail;
    }
    ...
    if (ezsignfolder_get_actionable_elements_v2_response_m_payload->a_obj_ezsignsignature) {
    list_ForEach(a_obj_ezsignsignatureListEntry, ezsignfolder_get_actionable_elements_v2_response_m_payload->a_obj_ezsignsignature) {
    ...
    // ezsignfolder_get_actionable_elements_v2_response_m_payload->a_obj_ezsignformfieldgroup
    if (!ezsignfolder_get_actionable_elements_v2_response_m_payload->a_obj_ezsignformfieldgroup) {
        goto fail;
    }
    ...
    if (ezsignfolder_get_actionable_elements_v2_response_m_payload->a_obj_ezsignformfieldgroup) {
    list_ForEach(a_obj_ezsignformfieldgroupListEntry, ezsignfolder_get_actionable_elements_v2_response_m_payload->a_obj_ezsignformfieldgroup) {
...
ezsignfolder_get_actionable_elements_v2_response_m_payload_t *ezsignfolder_get_actionable_elements_v2_response_m_payload_parseFromJSON(cJSON *ezsignfolder_get_actionable_elements_v2_response_m_payloadJSON){

    ezsignfolder_get_actionable_elements_v2_response_m_payload_t *ezsignfolder_get_actionable_elements_v2_response_m_payload_local_var = NULL;

    // define the local list for ezsignfolder_get_actionable_elements_v2_response_m_payload->a_obj_ezsignsignature
    list_t *a_obj_ezsignsignatureList = NULL;

    // define the local list for ezsignfolder_get_actionable_elements_v2_response_m_payload->a_obj_ezsignformfieldgroup
    list_t *a_obj_ezsignformfieldgroupList = NULL;

    // ezsignfolder_get_actionable_elements_v2_response_m_payload->a_obj_ezsignsignature
    cJSON *a_obj_ezsignsignature = cJSON_GetObjectItemCaseSensitive(ezsignfolder_get_actionable_elements_v2_response_m_payloadJSON, "a_objEzsignsignature");
    ...
    // ezsignfolder_get_actionable_elements_v2_response_m_payload->a_obj_ezsignformfieldgroup
    cJSON *a_obj_ezsignformfieldgroup = cJSON_GetObjectItemCaseSensitive(ezsignfolder_get_actionable_elements_v2_response_m_payloadJSON, "a_objEzsignformfieldgroup");
