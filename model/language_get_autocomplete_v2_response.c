...
static language_get_autocomplete_v2_response_t *language_get_autocomplete_v2_response_create_internal(
    ...
    memset(language_get_autocomplete_v2_response_local_var, 0, sizeof(language_get_autocomplete_v2_response_t));
...
__attribute__((deprecated)) language_get_autocomplete_v2_response_t *language_get_autocomplete_v2_response_create(
    ...
    language_get_autocomplete_v2_response_t *result = language_get_autocomplete_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
