...
static versionhistory_get_object_v2_response_t *versionhistory_get_object_v2_response_create_internal(
    ...
    memset(versionhistory_get_object_v2_response_local_var, 0, sizeof(versionhistory_get_object_v2_response_t));
...
__attribute__((deprecated)) versionhistory_get_object_v2_response_t *versionhistory_get_object_v2_response_create(
    ...
    versionhistory_get_object_v2_response_t *result = versionhistory_get_object_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
