/*
 * customer_get_communicationsenders_v1_response_m_payload.h
 *
 * Response for GET /1/object/customer/{pkiCustomerID}/getCommunicationsenders
 */

#ifndef _customer_get_communicationsenders_v1_response_m_payload_H_
#define _customer_get_communicationsenders_v1_response_m_payload_H_
...
typedef struct customer_get_communicationsenders_v1_response_m_payload_t customer_get_communicationsenders_v1_response_m_payload_t;

#include "custom_communicationsender_response.h"



typedef struct customer_get_communicationsenders_v1_response_m_payload_t {
    list_t *a_obj_communicationsenders; //nonprimitive container

    int _library_owned; // Is the library responsible for freeing this object?
} customer_get_communicationsenders_v1_response_m_payload_t;
...
#endif /* _customer_get_communicationsenders_v1_response_m_payload_H_ */
