...
char* ezsignbulksendtransmission_get_ezsignsignatures_automatic_v1_response_m_payload_a_e_ezsignsignature_type_ToString(ezmax_api_definition__full_ezsignbulksendtransmission_get_ezsignsignatures_automatic_v1_response_m_payload__e a_e_ezsignsignature_type) {
    char *a_e_ezsignsignature_typeArray[] =  { "NULL", "Acknowledgement", "Attachments", "AttachmentsConfirmation", "City", "Consultation", "Creditcard", "FieldText", "FieldTextarea", "Handwritten", "Initials", "Name", "NameReason", "Signature" };
...
static ezsignbulksendtransmission_get_ezsignsignatures_automatic_v1_response_m_payload_t *ezsignbulksendtransmission_get_ezsignsignatures_automatic_v1_response_m_payload_create_internal(
    ...
    memset(ezsignbulksendtransmission_get_ezsignsignatures_automatic_v1_response_m_payload_local_var, 0, sizeof(ezsignbulksendtransmission_get_ezsignsignatures_automatic_v1_response_m_payload_t));
    ezsignbulksendtransmission_get_ezsignsignatures_automatic_v1_response_m_payload_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezsignbulksendtransmission_get_ezsignsignatures_automatic_v1_response_m_payload_t *ezsignbulksendtransmission_get_ezsignsignatures_automatic_v1_response_m_payload_create(
    ...
    ezsignbulksendtransmission_get_ezsignsignatures_automatic_v1_response_m_payload_t *result = ezsignbulksendtransmission_get_ezsignsignatures_automatic_v1_response_m_payload_create_internal (
...
void ezsignbulksendtransmission_get_ezsignsignatures_automatic_v1_response_m_payload_free(ezsignbulksendtransmission_get_ezsignsignatures_automatic_v1_response_m_payload_t *ezsignbulksendtransmission_get_ezsignsignatures_automatic_v1_response_m_payload) {
    ...
    if(ezsignbulksendtransmission_get_ezsignsignatures_automatic_v1_response_m_payload->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsignbulksendtransmission_get_ezsignsignatures_automatic_v1_response_m_payload_free");
        return ;
    }
...
cJSON *ezsignbulksendtransmission_get_ezsignsignatures_automatic_v1_response_m_payload_convertToJSON(ezsignbulksendtransmission_get_ezsignsignatures_automatic_v1_response_m_payload_t *ezsignbulksendtransmission_get_ezsignsignatures_automatic_v1_response_m_payload) {
    ...
    if (ezmax_api_definition__full_list_AEEZSIGNSIGNATURETYPE_NULL == ezsignbulksendtransmission_get_ezsignsignatures_automatic_v1_response_m_payload->a_e_ezsignsignature_type) {
        goto fail;
    }
...
ezsignbulksendtransmission_get_ezsignsignatures_automatic_v1_response_m_payload_t *ezsignbulksendtransmission_get_ezsignsignatures_automatic_v1_response_m_payload_parseFromJSON(cJSON *ezsignbulksendtransmission_get_ezsignsignatures_automatic_v1_response_m_payloadJSON){
    ...
    ezsignbulksendtransmission_get_ezsignsignatures_automatic_v1_response_m_payload_local_var = ezsignbulksendtransmission_get_ezsignsignatures_automatic_v1_response_m_payload_create_internal (
