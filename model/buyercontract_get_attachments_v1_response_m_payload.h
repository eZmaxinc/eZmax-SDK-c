/*
 * buyercontract_get_attachments_v1_response_m_payload.h
 *
 * Response for GET /1/object/buyercontract/{pkiBuyercontractID}/getAttachments
 */

#ifndef _buyercontract_get_attachments_v1_response_m_payload_H_
#define _buyercontract_get_attachments_v1_response_m_payload_H_
...
typedef struct buyercontract_get_attachments_v1_response_m_payload_t buyercontract_get_attachments_v1_response_m_payload_t;

#include "custom_attachmentdocumenttype_response.h"



typedef struct buyercontract_get_attachments_v1_response_m_payload_t {
    list_t *a_obj_attachmentdocumenttype; //nonprimitive container

    int _library_owned; // Is the library responsible for freeing this object?
} buyercontract_get_attachments_v1_response_m_payload_t;
...
#endif /* _buyercontract_get_attachments_v1_response_m_payload_H_ */
