...
char* e_ezsigntemplatesignature_positioningezsigntemplatesignature_response_compound_ToString(ezmax_api_definition__full_ezsigntemplatesignature_response_compound__e e_ezsigntemplatesignature_positioning) {
...
ezmax_api_definition__full_ezsigntemplatesignature_response_compound__e e_ezsigntemplatesignature_positioningezsigntemplatesignature_response_compound_FromString(char* e_ezsigntemplatesignature_positioning){
...
char* e_ezsigntemplatesignature_textvalidationezsigntemplatesignature_response_compound_ToString(ezmax_api_definition__full_ezsigntemplatesignature_response_compound__e e_ezsigntemplatesignature_textvalidation) {
...
ezmax_api_definition__full_ezsigntemplatesignature_response_compound__e e_ezsigntemplatesignature_textvalidationezsigntemplatesignature_response_compound_FromString(char* e_ezsigntemplatesignature_textvalidation){
    int stringToReturn = 0;
    char *e_ezsigntemplatesignature_textvalidationArray[] =  { "NULL", "None", "Date (YYYY-MM-DD)", "Date (MM/DD/YYYY)", "Date (MM/DD/YY)", "Date (DD/MM/YYYY)", "Date (DD/MM/YY)", "Email", "Letters", "Numbers", "Zip", "Zip+4", "PostalCode", "Custom" };
...
char* e_ezsigntemplatesignature_dependencyrequirementezsigntemplatesignature_response_compound_ToString(ezmax_api_definition__full_ezsigntemplatesignature_response_compound__e e_ezsigntemplatesignature_dependencyrequirement) {
...
ezmax_api_definition__full_ezsigntemplatesignature_response_compound__e e_ezsigntemplatesignature_dependencyrequirementezsigntemplatesignature_response_compound_FromString(char* e_ezsigntemplatesignature_dependencyrequirement){
    int stringToReturn = 0;
    char *e_ezsigntemplatesignature_dependencyrequirementArray[] =  { "NULL", "AllOf", "AnyOf" };
...
char* e_ezsigntemplatesignature_positioningoccurenceezsigntemplatesignature_response_compound_ToString(ezmax_api_definition__full_ezsigntemplatesignature_response_compound__e e_ezsigntemplatesignature_positioningoccurence) {
...
ezmax_api_definition__full_ezsigntemplatesignature_response_compound__e e_ezsigntemplatesignature_positioningoccurenceezsigntemplatesignature_response_compound_FromString(char* e_ezsigntemplatesignature_positioningoccurence){
    int stringToReturn = 0;
    char *e_ezsigntemplatesignature_positioningoccurenceArray[] =  { "NULL", "All", "First", "Last" };
