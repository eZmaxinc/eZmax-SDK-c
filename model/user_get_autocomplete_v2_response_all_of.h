/*
 * user_get_autocomplete_v2_response_all_of.h
 *
 * 
 */

#ifndef _user_get_autocomplete_v2_response_all_of_H_
#define _user_get_autocomplete_v2_response_all_of_H_
...
typedef struct user_get_autocomplete_v2_response_all_of_t user_get_autocomplete_v2_response_all_of_t;

#include "user_get_autocomplete_v2_response_m_payload.h"



typedef struct user_get_autocomplete_v2_response_all_of_t {
    struct user_get_autocomplete_v2_response_m_payload_t *m_payload; //model

} user_get_autocomplete_v2_response_all_of_t;
...
#endif /* _user_get_autocomplete_v2_response_all_of_H_ */
