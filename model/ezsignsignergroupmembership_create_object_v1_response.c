...
static ezsignsignergroupmembership_create_object_v1_response_t *ezsignsignergroupmembership_create_object_v1_response_create_internal(
    ...
    memset(ezsignsignergroupmembership_create_object_v1_response_local_var, 0, sizeof(ezsignsignergroupmembership_create_object_v1_response_t));
    ezsignsignergroupmembership_create_object_v1_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezsignsignergroupmembership_create_object_v1_response_t *ezsignsignergroupmembership_create_object_v1_response_create(
    ...
    ezsignsignergroupmembership_create_object_v1_response_t *result = ezsignsignergroupmembership_create_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void ezsignsignergroupmembership_create_object_v1_response_free(ezsignsignergroupmembership_create_object_v1_response_t *ezsignsignergroupmembership_create_object_v1_response) {
    ...
    if(ezsignsignergroupmembership_create_object_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsignsignergroupmembership_create_object_v1_response_free");
        return ;
    }
...
ezsignsignergroupmembership_create_object_v1_response_t *ezsignsignergroupmembership_create_object_v1_response_parseFromJSON(cJSON *ezsignsignergroupmembership_create_object_v1_responseJSON){
    ...
    ezsignsignergroupmembership_create_object_v1_response_local_var = ezsignsignergroupmembership_create_object_v1_response_create_internal (
