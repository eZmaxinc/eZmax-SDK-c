...
char* e_websocket_messagetypewebsocket_response_error_v1_ToString(ezmax_api_definition__full_websocket_response_error_v1_EWEBSOCKETMESSAGETYPE_e e_websocket_messagetype) {
    char* e_websocket_messagetypeArray[] =  { "NULL", "Response-Error-V1" };
    return e_websocket_messagetypeArray[e_websocket_messagetype];
}

ezmax_api_definition__full_websocket_response_error_v1_EWEBSOCKETMESSAGETYPE_e e_websocket_messagetypewebsocket_response_error_v1_FromString(char* e_websocket_messagetype){
...
websocket_response_error_v1_t *websocket_response_error_v1_parseFromJSON(cJSON *websocket_response_error_v1JSON){
    ...
    e_websocket_messagetypeVariable = e_websocket_messagetypewebsocket_response_error_v1_FromString(e_websocket_messagetype->valuestring);
