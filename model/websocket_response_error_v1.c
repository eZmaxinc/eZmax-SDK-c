...
char* websocket_response_error_v1_e_websocket_messagetype_ToString(ezmax_api_definition__full_websocket_response_error_v1_EWEBSOCKETMESSAGETYPE_e e_websocket_messagetype) {
    char* e_websocket_messagetypeArray[] =  { "NULL", "Response-Error-V1" };
    return e_websocket_messagetypeArray[e_websocket_messagetype];
}

ezmax_api_definition__full_websocket_response_error_v1_EWEBSOCKETMESSAGETYPE_e websocket_response_error_v1_e_websocket_messagetype_FromString(char* e_websocket_messagetype){
...
static websocket_response_error_v1_t *websocket_response_error_v1_create_internal(
    ...
    websocket_response_error_v1_t *websocket_response_error_v1_local_var = malloc(sizeof(websocket_response_error_v1_t));
...
void websocket_response_error_v1_free(websocket_response_error_v1_t *websocket_response_error_v1) {
    ...
    if (websocket_response_error_v1->s_websocket_channel) {
        free(websocket_response_error_v1->s_websocket_channel);
        websocket_response_error_v1->s_websocket_channel = NULL;
    }
    if (websocket_response_error_v1->m_payload) {
        websocket_response_error_v1_m_payload_free(websocket_response_error_v1->m_payload);
        websocket_response_error_v1->m_payload = NULL;
    }
    free(websocket_response_error_v1);
}

cJSON *websocket_response_error_v1_convertToJSON(websocket_response_error_v1_t *websocket_response_error_v1) {
    ...
    if(cJSON_AddStringToObject(item, "sWebsocketChannel", websocket_response_error_v1->s_websocket_channel) == NULL) {
    goto fail; //String
    }
    ...
    cJSON *m_payload_local_JSON = websocket_response_error_v1_m_payload_convertToJSON(websocket_response_error_v1->m_payload);
...
websocket_response_error_v1_t *websocket_response_error_v1_parseFromJSON(cJSON *websocket_response_error_v1JSON){
    ...
    ezmax_api_definition__full_websocket_response_error_v1_EWEBSOCKETMESSAGETYPE_e e_websocket_messagetypeVariable;
    
    if(!cJSON_IsString(e_websocket_messagetype))
    {
    goto end; //Enum
    }
    e_websocket_messagetypeVariable = websocket_response_error_v1_e_websocket_messagetype_FromString(e_websocket_messagetype->valuestring);
