...
static ezmaxproduct_get_autocomplete_v2_response_t *ezmaxproduct_get_autocomplete_v2_response_create_internal(
    ...
    memset(ezmaxproduct_get_autocomplete_v2_response_local_var, 0, sizeof(ezmaxproduct_get_autocomplete_v2_response_t));
...
__attribute__((deprecated)) ezmaxproduct_get_autocomplete_v2_response_t *ezmaxproduct_get_autocomplete_v2_response_create(
    ...
    ezmaxproduct_get_autocomplete_v2_response_t *result = ezmaxproduct_get_autocomplete_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
