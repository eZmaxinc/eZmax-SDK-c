...
ezmax_api_definition__full_field_e_ezsignfoldertype_signeraccess__e field_e_ezsignfoldertype_signeraccess_parseFromJSON(cJSON *field_e_ezsignfoldertype_signeraccessJSON) {
    if(!cJSON_IsString(field_e_ezsignfoldertype_signeraccessJSON) || (field_e_ezsignfoldertype_signeraccessJSON->valuestring == NULL)) {
        return 0;
    }
    return field_e_ezsignfoldertype_signeraccess_field_e_ezsignfoldertype_signeraccess_FromString(field_e_ezsignfoldertype_signeraccessJSON->valuestring);
}
