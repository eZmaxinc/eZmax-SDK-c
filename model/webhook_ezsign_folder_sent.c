...
static webhook_ezsign_folder_sent_t *webhook_ezsign_folder_sent_create_internal(
    ...
    memset(webhook_ezsign_folder_sent_local_var, 0, sizeof(webhook_ezsign_folder_sent_t));
    webhook_ezsign_folder_sent_local_var->_library_owned = 1;
...
__attribute__((deprecated)) webhook_ezsign_folder_sent_t *webhook_ezsign_folder_sent_create(
    ...
    webhook_ezsign_folder_sent_t *result = webhook_ezsign_folder_sent_create_internal (
        obj_webhook,
        a_obj_attempt,
        obj_ezsignfolder
        );
...
void webhook_ezsign_folder_sent_free(webhook_ezsign_folder_sent_t *webhook_ezsign_folder_sent) {
    ...
    if(webhook_ezsign_folder_sent->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "webhook_ezsign_folder_sent_free");
        return ;
    }
...
webhook_ezsign_folder_sent_t *webhook_ezsign_folder_sent_parseFromJSON(cJSON *webhook_ezsign_folder_sentJSON){
    ...
    webhook_ezsign_folder_sent_local_var = webhook_ezsign_folder_sent_create_internal (
