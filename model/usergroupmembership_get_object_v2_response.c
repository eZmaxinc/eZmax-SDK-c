...
static usergroupmembership_get_object_v2_response_t *usergroupmembership_get_object_v2_response_create_internal(
    ...
    memset(usergroupmembership_get_object_v2_response_local_var, 0, sizeof(usergroupmembership_get_object_v2_response_t));
    usergroupmembership_get_object_v2_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) usergroupmembership_get_object_v2_response_t *usergroupmembership_get_object_v2_response_create(
    common_response_obj_debug_payload_t *obj_debug_payload,
    common_response_obj_debug_t *obj_debug,
    usergroupmembership_get_object_v2_response_m_payload_t *m_payload
    ) {
    usergroupmembership_get_object_v2_response_t *result = usergroupmembership_get_object_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void usergroupmembership_get_object_v2_response_free(usergroupmembership_get_object_v2_response_t *usergroupmembership_get_object_v2_response) {
    ...
    if(usergroupmembership_get_object_v2_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "usergroupmembership_get_object_v2_response_free");
        return ;
    }
...
usergroupmembership_get_object_v2_response_t *usergroupmembership_get_object_v2_response_parseFromJSON(cJSON *usergroupmembership_get_object_v2_responseJSON){
    ...
    usergroupmembership_get_object_v2_response_local_var = usergroupmembership_get_object_v2_response_create_internal (
