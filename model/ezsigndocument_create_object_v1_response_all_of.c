...
#include <string.h>
#include <stdio.h>
#include "ezsigndocument_create_object_v1_response_all_of.h"
...
ezsigndocument_create_object_v1_response_all_of_t *ezsigndocument_create_object_v1_response_all_of_create(
    ...
    ezsigndocument_create_object_v1_response_all_of_t *ezsigndocument_create_object_v1_response_all_of_local_var = malloc(sizeof(ezsigndocument_create_object_v1_response_all_of_t));
    if (!ezsigndocument_create_object_v1_response_all_of_local_var) {
        return NULL;
    }
    ezsigndocument_create_object_v1_response_all_of_local_var->m_payload = m_payload;

    return ezsigndocument_create_object_v1_response_all_of_local_var;
}
...
void ezsigndocument_create_object_v1_response_all_of_free(ezsigndocument_create_object_v1_response_all_of_t *ezsigndocument_create_object_v1_response_all_of) {
    if(NULL == ezsigndocument_create_object_v1_response_all_of){
        return ;
    }
    listEntry_t *listEntry;
    if (ezsigndocument_create_object_v1_response_all_of->m_payload) {
        ezsigndocument_create_object_v1_response_m_payload_free(ezsigndocument_create_object_v1_response_all_of->m_payload);
        ezsigndocument_create_object_v1_response_all_of->m_payload = NULL;
    }
    free(ezsigndocument_create_object_v1_response_all_of);
}
...
cJSON *ezsigndocument_create_object_v1_response_all_of_convertToJSON(ezsigndocument_create_object_v1_response_all_of_t *ezsigndocument_create_object_v1_response_all_of) {
    ...
    cJSON *m_payload_local_JSON = ezsigndocument_create_object_v1_response_m_payload_convertToJSON(ezsigndocument_create_object_v1_response_all_of->m_payload);
...
ezsigndocument_create_object_v1_response_all_of_t *ezsigndocument_create_object_v1_response_all_of_parseFromJSON(cJSON *ezsigndocument_create_object_v1_response_all_ofJSON){
    ...
    ezsigndocument_create_object_v1_response_all_of_local_var = ezsigndocument_create_object_v1_response_all_of_create (
