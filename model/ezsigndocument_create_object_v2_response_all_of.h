/*
 * ezsigndocument_create_object_v2_response_all_of.h
 *
 * 
 */

#ifndef _ezsigndocument_create_object_v2_response_all_of_H_
#define _ezsigndocument_create_object_v2_response_all_of_H_
...
typedef struct ezsigndocument_create_object_v2_response_all_of_t ezsigndocument_create_object_v2_response_all_of_t;

#include "ezsigndocument_create_object_v2_response_m_payload.h"



typedef struct ezsigndocument_create_object_v2_response_all_of_t {
    struct ezsigndocument_create_object_v2_response_m_payload_t *m_payload; //model

} ezsigndocument_create_object_v2_response_all_of_t;
...
#endif /* _ezsigndocument_create_object_v2_response_all_of_H_ */
