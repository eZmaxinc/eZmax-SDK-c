...
ezmax_api_definition__full_field_e_communication_type__e field_e_communication_type_field_e_communication_type_parseFromJSON(cJSON *field_e_communication_typeJSON) {
    ezmax_api_definition__full_field_e_communication_type__e *field_e_communication_type = NULL;
    ezmax_api_definition__full_field_e_communication_type__e field_e_communication_typeVariable;
    cJSON *field_e_communication_typeVar = cJSON_GetObjectItemCaseSensitive(field_e_communication_typeJSON, "field_e_communication_type");
    if(!cJSON_IsString(field_e_communication_typeVar) || (field_e_communication_typeVar->valuestring == NULL)){
        goto end;
    }
    field_e_communication_typeVariable = field_e_communication_type_field_e_communication_type_FromString(field_e_communication_typeVar->valuestring);
    return field_e_communication_typeVariable;
end:
    return 0;
}
