...
static address_request_t *address_request_create_internal(
    ...
    memset(address_request_local_var, 0, sizeof(address_request_t));
...
__attribute__((deprecated)) address_request_t *address_request_create(
    ...
    address_request_t *result = address_request_create_internal (
        pki_address_id_copy,
...
void address_request_free(address_request_t *address_request) {
    ...
    if (address_request->pki_address_id) {
        free(address_request->pki_address_id);
        address_request->pki_address_id = NULL;
    }
    if (address_request->fki_addresstype_id) {
        free(address_request->fki_addresstype_id);
        address_request->fki_addresstype_id = NULL;
    }
    ...
    if (address_request->fki_province_id) {
        free(address_request->fki_province_id);
        address_request->fki_province_id = NULL;
    }
    if (address_request->fki_country_id) {
        free(address_request->fki_country_id);
        address_request->fki_country_id = NULL;
    }
...
address_request_t *address_request_parseFromJSON(cJSON *address_requestJSON){
    ...
    // define the local variable for address_request->pki_address_id
    int *pki_address_id_local_var = NULL;

    // define the local variable for address_request->fki_addresstype_id
    ...
    // define the local variable for address_request->fki_province_id
    int *fki_province_id_local_var = NULL;

    // define the local variable for address_request->fki_country_id
