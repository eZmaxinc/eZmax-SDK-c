/*
 * user_get_effective_permissions_v1_response_m_payload.h
 *
 * Response for GET /1/object/user/{pkiUserID}/getEffectivePermissions
 */

#ifndef _user_get_effective_permissions_v1_response_m_payload_H_
#define _user_get_effective_permissions_v1_response_m_payload_H_
...
typedef struct user_get_effective_permissions_v1_response_m_payload_t user_get_effective_permissions_v1_response_m_payload_t;

#include "modulegroup_response_compound.h"



typedef struct user_get_effective_permissions_v1_response_m_payload_t {
    list_t *a_obj_modulegroup; //nonprimitive container

    int _library_owned; // Is the library responsible for freeing this object?
} user_get_effective_permissions_v1_response_m_payload_t;
...
#endif /* _user_get_effective_permissions_v1_response_m_payload_H_ */
