...
static ezdoctemplatetype_get_autocomplete_v2_response_t *ezdoctemplatetype_get_autocomplete_v2_response_create_internal(
    ...
    memset(ezdoctemplatetype_get_autocomplete_v2_response_local_var, 0, sizeof(ezdoctemplatetype_get_autocomplete_v2_response_t));
    ezdoctemplatetype_get_autocomplete_v2_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezdoctemplatetype_get_autocomplete_v2_response_t *ezdoctemplatetype_get_autocomplete_v2_response_create(
    common_response_obj_debug_payload_t *obj_debug_payload,
    common_response_obj_debug_t *obj_debug,
    ezdoctemplatetype_get_autocomplete_v2_response_m_payload_t *m_payload
    ) {
    ezdoctemplatetype_get_autocomplete_v2_response_t *result = ezdoctemplatetype_get_autocomplete_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void ezdoctemplatetype_get_autocomplete_v2_response_free(ezdoctemplatetype_get_autocomplete_v2_response_t *ezdoctemplatetype_get_autocomplete_v2_response) {
    ...
    if(ezdoctemplatetype_get_autocomplete_v2_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezdoctemplatetype_get_autocomplete_v2_response_free");
        return ;
    }
...
ezdoctemplatetype_get_autocomplete_v2_response_t *ezdoctemplatetype_get_autocomplete_v2_response_parseFromJSON(cJSON *ezdoctemplatetype_get_autocomplete_v2_responseJSON){
    ...
    ezdoctemplatetype_get_autocomplete_v2_response_local_var = ezdoctemplatetype_get_autocomplete_v2_response_create_internal (
