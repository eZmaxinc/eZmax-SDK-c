...
static ezsignbulksendsignermapping_delete_object_v1_response_t *ezsignbulksendsignermapping_delete_object_v1_response_create_internal(
...
__attribute__((deprecated)) ezsignbulksendsignermapping_delete_object_v1_response_t *ezsignbulksendsignermapping_delete_object_v1_response_create(
    common_response_obj_debug_payload_t *obj_debug_payload,
    common_response_obj_debug_t *obj_debug
    ) {
...
void ezsignbulksendsignermapping_delete_object_v1_response_free(ezsignbulksendsignermapping_delete_object_v1_response_t *ezsignbulksendsignermapping_delete_object_v1_response) {
    ...
    if(ezsignbulksendsignermapping_delete_object_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsignbulksendsignermapping_delete_object_v1_response_free");
        return ;
    }
