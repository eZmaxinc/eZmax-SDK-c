...
ezsignsignature_get_object_v1_response_m_payload_t *ezsignsignature_get_object_v1_response_m_payload_create(
    ...
    ezsignsignature_get_object_v1_response_m_payload_local_var->fki_user_id = fki_user_id;
...
cJSON *ezsignsignature_get_object_v1_response_m_payload_convertToJSON(ezsignsignature_get_object_v1_response_m_payload_t *ezsignsignature_get_object_v1_response_m_payload) {
    ...
    // ezsignsignature_get_object_v1_response_m_payload->fki_user_id
    if(ezsignsignature_get_object_v1_response_m_payload->fki_user_id) {
    if(cJSON_AddNumberToObject(item, "fkiUserID", ezsignsignature_get_object_v1_response_m_payload->fki_user_id) == NULL) {
    goto fail; //Numeric
    }
    }
...
ezsignsignature_get_object_v1_response_m_payload_t *ezsignsignature_get_object_v1_response_m_payload_parseFromJSON(cJSON *ezsignsignature_get_object_v1_response_m_payloadJSON){
    ...
    // ezsignsignature_get_object_v1_response_m_payload->fki_user_id
    cJSON *fki_user_id = cJSON_GetObjectItemCaseSensitive(ezsignsignature_get_object_v1_response_m_payloadJSON, "fkiUserID");
    if (fki_user_id) { 
