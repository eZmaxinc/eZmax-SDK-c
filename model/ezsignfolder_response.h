...
typedef enum  { ezmax_api_definition_ezsignfolder_response__NULL = 0, ezmax_api_definition_ezsignfolder_response__Unsent, ezmax_api_definition_ezsignfolder_response__Sent, ezmax_api_definition_ezsignfolder_response__PartiallySigned, ezmax_api_definition_ezsignfolder_response__Expired, ezmax_api_definition_ezsignfolder_response___Signed, ezmax_api_definition_ezsignfolder_response__Completed, ezmax_api_definition_ezsignfolder_response__Archived } ezmax_api_definition_ezsignfolder_response__e;
