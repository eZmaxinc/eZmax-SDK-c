/*
 * user_create_object_v2_response_m_payload.h
 *
 * Payload for POST /1/object/user
 */

#ifndef _user_create_object_v2_response_m_payload_H_
#define _user_create_object_v2_response_m_payload_H_
...
typedef struct user_create_object_v2_response_m_payload_t user_create_object_v2_response_m_payload_t;




typedef struct user_create_object_v2_response_m_payload_t {
    list_t *a_pki_user_id; //primitive container

    int _library_owned; // Is the library responsible for freeing this object?
} user_create_object_v2_response_m_payload_t;
...
#endif /* _user_create_object_v2_response_m_payload_H_ */
