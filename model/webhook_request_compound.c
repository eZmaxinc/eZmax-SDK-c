...
static webhook_request_compound_t *webhook_request_compound_create_internal(
    ...
    webhook_request_compound_local_var->e_webhook_realestateevent = e_webhook_realestateevent;
...
cJSON *webhook_request_compound_convertToJSON(webhook_request_compound_t *webhook_request_compound) {
    ...
    // webhook_request_compound->e_webhook_realestateevent
    if(webhook_request_compound->e_webhook_realestateevent != ezmax_api_definition__full_field_e_webhook_realestateevent__NULL) {
    cJSON *e_webhook_realestateevent_local_JSON = field_e_webhook_realestateevent_convertToJSON(webhook_request_compound->e_webhook_realestateevent);
...
webhook_request_compound_t *webhook_request_compound_parseFromJSON(cJSON *webhook_request_compoundJSON){
    ...
    // define the local variable for webhook_request_compound->e_webhook_realestateevent
    ...
    *fki_ezsignfoldertype_id_local_var = fki_ezsignfoldertype_id->valuedouble;
    ...
    // webhook_request_compound->e_webhook_realestateevent
    cJSON *e_webhook_realestateevent = cJSON_GetObjectItemCaseSensitive(webhook_request_compoundJSON, "eWebhookRealestateevent");
