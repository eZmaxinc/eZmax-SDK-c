/*
 * commissionadvance_get_communicationsenders_v1_response_m_payload.h
 *
 * Response for GET /1/object/commissionadvance/{pkiCommissionadvanceID}/getCommunicationsenders
 */

#ifndef _commissionadvance_get_communicationsenders_v1_response_m_payload_H_
#define _commissionadvance_get_communicationsenders_v1_response_m_payload_H_
...
typedef struct commissionadvance_get_communicationsenders_v1_response_m_payload_t commissionadvance_get_communicationsenders_v1_response_m_payload_t;

#include "custom_communicationsender_response.h"



typedef struct commissionadvance_get_communicationsenders_v1_response_m_payload_t {
    list_t *a_obj_communicationsenders; //nonprimitive container

    int _library_owned; // Is the library responsible for freeing this object?
} commissionadvance_get_communicationsenders_v1_response_m_payload_t;
...
#endif /* _commissionadvance_get_communicationsenders_v1_response_m_payload_H_ */
