/*
 * ezsignfoldertype_response_v3.h
 *
 * A Ezsignfoldertype Object
 */

#ifndef _ezsignfoldertype_response_v3_H_
#define _ezsignfoldertype_response_v3_H_
...
typedef struct ezsignfoldertype_response_v3_t ezsignfoldertype_response_v3_t;
...
// Enum  for ezsignfoldertype_response_v3

typedef enum  { ezmax_api_definition__full_ezsignfoldertype_response_v3__NULL = 0, ezmax_api_definition__full_ezsignfoldertype_response_v3__User, ezmax_api_definition__full_ezsignfoldertype_response_v3__Usergroup } ezmax_api_definition__full_ezsignfoldertype_response_v3__e;
...
typedef enum  { ezmax_api_definition__full_ezsignfoldertype_response_v3__NULL = 0, ezmax_api_definition__full_ezsignfoldertype_response_v3__None, ezmax_api_definition__full_ezsignfoldertype_response_v3__Daily, ezmax_api_definition__full_ezsignfoldertype_response_v3__Weekly } ezmax_api_definition__full_ezsignfoldertype_response_v3__e;
...
typedef enum  { ezmax_api_definition__full_ezsignfoldertype_response_v3__NULL = 0, ezmax_api_definition__full_ezsignfoldertype_response_v3__No, ezmax_api_definition__full_ezsignfoldertype_response_v3__Manual, ezmax_api_definition__full_ezsignfoldertype_response_v3__Automatic } ezmax_api_definition__full_ezsignfoldertype_response_v3__e;
...
typedef enum  { ezmax_api_definition__full_ezsignfoldertype_response_v3__NULL = 0, ezmax_api_definition__full_ezsignfoldertype_response_v3__PerEzsigndocument, ezmax_api_definition__full_ezsignfoldertype_response_v3__PerEzsignfolder } ezmax_api_definition__full_ezsignfoldertype_response_v3__e;
...
typedef struct ezsignfoldertype_response_v3_t {
...
} ezsignfoldertype_response_v3_t;
...
#endif /* _ezsignfoldertype_response_v3_H_ */
