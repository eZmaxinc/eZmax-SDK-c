...
static ezsignannotation_get_object_v2_response_t *ezsignannotation_get_object_v2_response_create_internal(
...
__attribute__((deprecated)) ezsignannotation_get_object_v2_response_t *ezsignannotation_get_object_v2_response_create(
    common_response_obj_debug_payload_t *obj_debug_payload,
    common_response_obj_debug_t *obj_debug,
    ezsignannotation_get_object_v2_response_m_payload_t *m_payload
    ) {
...
void ezsignannotation_get_object_v2_response_free(ezsignannotation_get_object_v2_response_t *ezsignannotation_get_object_v2_response) {
    ...
    if(ezsignannotation_get_object_v2_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsignannotation_get_object_v2_response_free");
        return ;
    }
