...
char* field_e_ezsigndocument_step_field_e_ezsigndocument_step_ToString(ezmax_api_definition__full_field_e_ezsigndocument_step__e field_e_ezsigndocument_step) {
    char *field_e_ezsigndocument_stepArray[] =  { "NULL", "Unsent", "Unsigned", "PartiallySigned", "DeclinedToSign", "PendingPrematurelyEnded", "PrematurelyEnded", "PendingCompletion", "Completed", "Disposed" };
