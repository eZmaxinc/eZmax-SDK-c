...
static creditcardmerchant_get_autocomplete_v2_response_t *creditcardmerchant_get_autocomplete_v2_response_create_internal(
    ...
    memset(creditcardmerchant_get_autocomplete_v2_response_local_var, 0, sizeof(creditcardmerchant_get_autocomplete_v2_response_t));
...
__attribute__((deprecated)) creditcardmerchant_get_autocomplete_v2_response_t *creditcardmerchant_get_autocomplete_v2_response_create(
    ...
    creditcardmerchant_get_autocomplete_v2_response_t *result = creditcardmerchant_get_autocomplete_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
