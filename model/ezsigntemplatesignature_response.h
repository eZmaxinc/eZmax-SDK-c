...
typedef enum  { ezmax_api_definition__full_ezsigntemplatesignature_response__NULL = 0, ezmax_api_definition__full_ezsigntemplatesignature_response__PerCoordinates, ezmax_api_definition__full_ezsigntemplatesignature_response__PerPositioningPattern } ezmax_api_definition__full_ezsigntemplatesignature_response__e;
...
typedef enum  { ezmax_api_definition__full_ezsigntemplatesignature_response__NULL = 0, ezmax_api_definition__full_ezsigntemplatesignature_response__Acknowledgement, ezmax_api_definition__full_ezsigntemplatesignature_response__City, ezmax_api_definition__full_ezsigntemplatesignature_response__Handwritten, ezmax_api_definition__full_ezsigntemplatesignature_response__Initials, ezmax_api_definition__full_ezsigntemplatesignature_response__Name, ezmax_api_definition__full_ezsigntemplatesignature_response__NameReason, ezmax_api_definition__full_ezsigntemplatesignature_response__Attachments, ezmax_api_definition__full_ezsigntemplatesignature_response__FieldText, ezmax_api_definition__full_ezsigntemplatesignature_response__FieldTextarea, ezmax_api_definition__full_ezsigntemplatesignature_response__Consultation, ezmax_api_definition__full_ezsigntemplatesignature_response__Signature } ezmax_api_definition__full_ezsigntemplatesignature_response__e;
...
typedef enum  { ezmax_api_definition__full_ezsigntemplatesignature_response__NULL = 0, ezmax_api_definition__full_ezsigntemplatesignature_response__Automatic, ezmax_api_definition__full_ezsigntemplatesignature_response__Manual } ezmax_api_definition__full_ezsigntemplatesignature_response__e;
...
typedef enum  { ezmax_api_definition__full_ezsigntemplatesignature_response__NULL = 0, ezmax_api_definition__full_ezsigntemplatesignature_response__All, ezmax_api_definition__full_ezsigntemplatesignature_response__First, ezmax_api_definition__full_ezsigntemplatesignature_response__Last } ezmax_api_definition__full_ezsigntemplatesignature_response__e;
