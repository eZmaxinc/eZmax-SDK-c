...
static ezsigntemplatepackagesignermembership_get_object_v2_response_t *ezsigntemplatepackagesignermembership_get_object_v2_response_create_internal(
    ...
    memset(ezsigntemplatepackagesignermembership_get_object_v2_response_local_var, 0, sizeof(ezsigntemplatepackagesignermembership_get_object_v2_response_t));
...
__attribute__((deprecated)) ezsigntemplatepackagesignermembership_get_object_v2_response_t *ezsigntemplatepackagesignermembership_get_object_v2_response_create(
    ...
    ezsigntemplatepackagesignermembership_get_object_v2_response_t *result = ezsigntemplatepackagesignermembership_get_object_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
