...
static domain_create_object_v1_response_t *domain_create_object_v1_response_create_internal(
    ...
    memset(domain_create_object_v1_response_local_var, 0, sizeof(domain_create_object_v1_response_t));
...
__attribute__((deprecated)) domain_create_object_v1_response_t *domain_create_object_v1_response_create(
    ...
    domain_create_object_v1_response_t *result = domain_create_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
