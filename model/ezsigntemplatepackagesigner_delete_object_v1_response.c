...
static ezsigntemplatepackagesigner_delete_object_v1_response_t *ezsigntemplatepackagesigner_delete_object_v1_response_create_internal(
    ...
    memset(ezsigntemplatepackagesigner_delete_object_v1_response_local_var, 0, sizeof(ezsigntemplatepackagesigner_delete_object_v1_response_t));
...
__attribute__((deprecated)) ezsigntemplatepackagesigner_delete_object_v1_response_t *ezsigntemplatepackagesigner_delete_object_v1_response_create(
    ...
    ezsigntemplatepackagesigner_delete_object_v1_response_t *result = ezsigntemplatepackagesigner_delete_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
