/*
 * ezsignsignature_get_object_v2_response_m_payload.h
 *
 * Payload for GET /2/object/ezsignsignature/{pkiEzsignsignatureID}
 */

#ifndef _ezsignsignature_get_object_v2_response_m_payload_H_
#define _ezsignsignature_get_object_v2_response_m_payload_H_
...
typedef struct ezsignsignature_get_object_v2_response_m_payload_t ezsignsignature_get_object_v2_response_m_payload_t;

#include "ezsignsignature_response_compound.h"



typedef struct ezsignsignature_get_object_v2_response_m_payload_t {
    struct ezsignsignature_response_compound_t *obj_ezsignsignature; //model

} ezsignsignature_get_object_v2_response_m_payload_t;
...
#endif /* _ezsignsignature_get_object_v2_response_m_payload_H_ */
