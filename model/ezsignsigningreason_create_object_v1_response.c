...
ezsignsigningreason_create_object_v1_response_t *ezsignsigningreason_create_object_v1_response_create(
...
ezsignsigningreason_create_object_v1_response_t *ezsignsigningreason_create_object_v1_response_parseFromJSON(cJSON *ezsignsigningreason_create_object_v1_responseJSON){
    ...
    ezsignsigningreason_create_object_v1_response_local_var = ezsignsigningreason_create_object_v1_response_create (
