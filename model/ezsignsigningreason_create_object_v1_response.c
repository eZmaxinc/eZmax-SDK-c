...
static ezsignsigningreason_create_object_v1_response_t *ezsignsigningreason_create_object_v1_response_create_internal(
    ...
    memset(ezsignsigningreason_create_object_v1_response_local_var, 0, sizeof(ezsignsigningreason_create_object_v1_response_t));
...
__attribute__((deprecated)) ezsignsigningreason_create_object_v1_response_t *ezsignsigningreason_create_object_v1_response_create(
    ...
    ezsignsigningreason_create_object_v1_response_t *result = ezsignsigningreason_create_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
