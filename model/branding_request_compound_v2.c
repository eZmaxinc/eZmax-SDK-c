...
static branding_request_compound_v2_t *branding_request_compound_v2_create_internal(
    ...
    memset(branding_request_compound_v2_local_var, 0, sizeof(branding_request_compound_v2_t));
    ...
    branding_request_compound_v2_local_var->fki_domain_id = fki_domain_id;
...
__attribute__((deprecated)) branding_request_compound_v2_t *branding_request_compound_v2_create(
    ...
    branding_request_compound_v2_t *result = branding_request_compound_v2_create_internal (
...
void branding_request_compound_v2_free(branding_request_compound_v2_t *branding_request_compound_v2) {
    ...
    if (branding_request_compound_v2->pki_branding_id) {
        free(branding_request_compound_v2->pki_branding_id);
        branding_request_compound_v2->pki_branding_id = NULL;
    }
    if (branding_request_compound_v2->fki_domain_id) {
        free(branding_request_compound_v2->fki_domain_id);
        branding_request_compound_v2->fki_domain_id = NULL;
    }
    ...
    if (branding_request_compound_v2->i_branding_color) {
        free(branding_request_compound_v2->i_branding_color);
        branding_request_compound_v2->i_branding_color = NULL;
    }
    ...
    if (branding_request_compound_v2->b_branding_isactive) {
        free(branding_request_compound_v2->b_branding_isactive);
        branding_request_compound_v2->b_branding_isactive = NULL;
    }
...
cJSON *branding_request_compound_v2_convertToJSON(branding_request_compound_v2_t *branding_request_compound_v2) {
    ...
    // branding_request_compound_v2->fki_domain_id
    if(branding_request_compound_v2->fki_domain_id) {
    if(cJSON_AddNumberToObject(item, "fkiDomainID", *branding_request_compound_v2->fki_domain_id) == NULL) {
    goto fail; //Numeric
    }
    }
...
branding_request_compound_v2_t *branding_request_compound_v2_parseFromJSON(cJSON *branding_request_compound_v2JSON){
    ...
    // define the local variable for branding_request_compound_v2->pki_branding_id
    int *pki_branding_id_local_var = NULL;

    // define the local variable for branding_request_compound_v2->fki_domain_id
    ...
    // define the local variable for branding_request_compound_v2->i_branding_color
    ...
    // define the local variable for branding_request_compound_v2->b_branding_isactive
    ...
    *pki_branding_id_local_var = pki_branding_id->valuedouble;
    ...
    // branding_request_compound_v2->fki_domain_id
    cJSON *fki_domain_id = cJSON_GetObjectItemCaseSensitive(branding_request_compound_v2JSON, "fkiDomainID");
