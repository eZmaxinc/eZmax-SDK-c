...
char* e_ezmaxinvoicingcontract_paymenttypeezmaxinvoicingcontract_response_compound_ToString(ezmax_api_definition__full_ezmaxinvoicingcontract_response_compound__e e_ezmaxinvoicingcontract_paymenttype) {
...
ezmax_api_definition__full_ezmaxinvoicingcontract_response_compound__e e_ezmaxinvoicingcontract_paymenttypeezmaxinvoicingcontract_response_compound_FromString(char* e_ezmaxinvoicingcontract_paymenttype){
...
ezmaxinvoicingcontract_response_compound_t *ezmaxinvoicingcontract_response_compound_create(
    ...
    ezmaxinvoicingcontract_response_compound_local_var->dt_ezmaxinvoicingcontract_start = dt_ezmaxinvoicingcontract_start;
    ezmaxinvoicingcontract_response_compound_local_var->dt_ezmaxinvoicingcontract_end = dt_ezmaxinvoicingcontract_end;
    ezmaxinvoicingcontract_response_compound_local_var->d_ezmaxinvoicingcontract_license = d_ezmaxinvoicingcontract_license;
...
void ezmaxinvoicingcontract_response_compound_free(ezmaxinvoicingcontract_response_compound_t *ezmaxinvoicingcontract_response_compound) {
    if(NULL == ezmaxinvoicingcontract_response_compound){
        return ;
    }
    listEntry_t *listEntry;
    if (ezmaxinvoicingcontract_response_compound->e_ezmaxinvoicingcontract_paymenttype) {
        field_e_ezmaxinvoicingcontract_paymenttype_free(ezmaxinvoicingcontract_response_compound->e_ezmaxinvoicingcontract_paymenttype);
        ezmaxinvoicingcontract_response_compound->e_ezmaxinvoicingcontract_paymenttype = NULL;
    }
    ...
    if (ezmaxinvoicingcontract_response_compound->dt_ezmaxinvoicingcontract_end) {
        free(ezmaxinvoicingcontract_response_compound->dt_ezmaxinvoicingcontract_end);
        ezmaxinvoicingcontract_response_compound->dt_ezmaxinvoicingcontract_end = NULL;
    }
    if (ezmaxinvoicingcontract_response_compound->d_ezmaxinvoicingcontract_license) {
        free(ezmaxinvoicingcontract_response_compound->d_ezmaxinvoicingcontract_license);
        ezmaxinvoicingcontract_response_compound->d_ezmaxinvoicingcontract_license = NULL;
    }
    if (ezmaxinvoicingcontract_response_compound->d_ezmaxinvoicingcontract121qa) {
    ...
    free(ezmaxinvoicingcontract_response_compound);
}
...
cJSON *ezmaxinvoicingcontract_response_compound_convertToJSON(ezmaxinvoicingcontract_response_compound_t *ezmaxinvoicingcontract_response_compound) {
    ...
    // ezmaxinvoicingcontract_response_compound->pki_ezmaxinvoicingcontract_id
    ...
    if (ezmax_api_definition__full_ezmaxinvoicingcontract_response_compound__NULL == ezmaxinvoicingcontract_response_compound->e_ezmaxinvoicingcontract_paymenttype) {
        goto fail;
    }
    cJSON *e_ezmaxinvoicingcontract_paymenttype_local_JSON = field_e_ezmaxinvoicingcontract_paymenttype_convertToJSON(ezmaxinvoicingcontract_response_compound->e_ezmaxinvoicingcontract_paymenttype);
    ...
    // ezmaxinvoicingcontract_response_compound->i_ezmaxinvoicingcontract_length
    ...
    if(cJSON_AddStringToObject(item, "dtEzmaxinvoicingcontractStart", ezmaxinvoicingcontract_response_compound->dt_ezmaxinvoicingcontract_start) == NULL) {
    goto fail; //String
    }


    // ezmaxinvoicingcontract_response_compound->dt_ezmaxinvoicingcontract_end
    if (!ezmaxinvoicingcontract_response_compound->dt_ezmaxinvoicingcontract_end) {
        goto fail;
    }
    if(cJSON_AddStringToObject(item, "dtEzmaxinvoicingcontractEnd", ezmaxinvoicingcontract_response_compound->dt_ezmaxinvoicingcontract_end) == NULL) {
    goto fail; //String
    }


    // ezmaxinvoicingcontract_response_compound->d_ezmaxinvoicingcontract_license
    if (!ezmaxinvoicingcontract_response_compound->d_ezmaxinvoicingcontract_license) {
        goto fail;
    }
    if(cJSON_AddStringToObject(item, "dEzmaxinvoicingcontractLicense", ezmaxinvoicingcontract_response_compound->d_ezmaxinvoicingcontract_license) == NULL) {
    goto fail; //String
    }


    // ezmaxinvoicingcontract_response_compound->d_ezmaxinvoicingcontract121qa
    if (!ezmaxinvoicingcontract_response_compound->d_ezmaxinvoicingcontract121qa) {
        goto fail;
    }
    if(cJSON_AddStringToObject(item, "dEzmaxinvoicingcontract121qa", ezmaxinvoicingcontract_response_compound->d_ezmaxinvoicingcontract121qa) == NULL) {
    goto fail; //String
    }


    // ezmaxinvoicingcontract_response_compound->b_ezmaxinvoicingcontract_ezsignallagents
    ...
    cJSON *obj_audit_local_JSON = common_audit_convertToJSON(ezmaxinvoicingcontract_response_compound->obj_audit);
...
ezmaxinvoicingcontract_response_compound_t *ezmaxinvoicingcontract_response_compound_parseFromJSON(cJSON *ezmaxinvoicingcontract_response_compoundJSON){
    ...
    // ezmaxinvoicingcontract_response_compound->pki_ezmaxinvoicingcontract_id
    cJSON *pki_ezmaxinvoicingcontract_id = cJSON_GetObjectItemCaseSensitive(ezmaxinvoicingcontract_response_compoundJSON, "pkiEzmaxinvoicingcontractID");
    ...
    // ezmaxinvoicingcontract_response_compound->i_ezmaxinvoicingcontract_length
    cJSON *i_ezmaxinvoicingcontract_length = cJSON_GetObjectItemCaseSensitive(ezmaxinvoicingcontract_response_compoundJSON, "iEzmaxinvoicingcontractLength");
    ...
    // ezmaxinvoicingcontract_response_compound->dt_ezmaxinvoicingcontract_end
    cJSON *dt_ezmaxinvoicingcontract_end = cJSON_GetObjectItemCaseSensitive(ezmaxinvoicingcontract_response_compoundJSON, "dtEzmaxinvoicingcontractEnd");
    ...
    // ezmaxinvoicingcontract_response_compound->d_ezmaxinvoicingcontract_license
    cJSON *d_ezmaxinvoicingcontract_license = cJSON_GetObjectItemCaseSensitive(ezmaxinvoicingcontract_response_compoundJSON, "dEzmaxinvoicingcontractLicense");
    ...
    // ezmaxinvoicingcontract_response_compound->d_ezmaxinvoicingcontract121qa
    cJSON *d_ezmaxinvoicingcontract121qa = cJSON_GetObjectItemCaseSensitive(ezmaxinvoicingcontract_response_compoundJSON, "dEzmaxinvoicingcontract121qa");
    ...
    // ezmaxinvoicingcontract_response_compound->b_ezmaxinvoicingcontract_ezsignallagents
    cJSON *b_ezmaxinvoicingcontract_ezsignallagents = cJSON_GetObjectItemCaseSensitive(ezmaxinvoicingcontract_response_compoundJSON, "bEzmaxinvoicingcontractEzsignallagents");
    ...
    ezmaxinvoicingcontract_response_compound_local_var = ezmaxinvoicingcontract_response_compound_create (
