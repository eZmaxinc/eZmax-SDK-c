/*
 * field_e_ezsigntemplatesignature_positioning.h
 *
 * How the positioning of the Ezsigntemplatesignature will be done
 */

#ifndef _field_e_ezsigntemplatesignature_positioning_H_
#define _field_e_ezsigntemplatesignature_positioning_H_
...
typedef struct field_e_ezsigntemplatesignature_positioning_t field_e_ezsigntemplatesignature_positioning_t;


// Enum  for field_e_ezsigntemplatesignature_positioning

typedef enum { ezmax_api_definition__full_field_e_ezsigntemplatesignature_positioning__NULL = 0, ezmax_api_definition__full_field_e_ezsigntemplatesignature_positioning__PerCoordinates, ezmax_api_definition__full_field_e_ezsigntemplatesignature_positioning__PerPositioningPattern } ezmax_api_definition__full_field_e_ezsigntemplatesignature_positioning__e;
...
#endif /* _field_e_ezsigntemplatesignature_positioning_H_ */
