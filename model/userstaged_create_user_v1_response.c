...
static userstaged_create_user_v1_response_t *userstaged_create_user_v1_response_create_internal(
    ...
    memset(userstaged_create_user_v1_response_local_var, 0, sizeof(userstaged_create_user_v1_response_t));
    userstaged_create_user_v1_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) userstaged_create_user_v1_response_t *userstaged_create_user_v1_response_create(
    ...
    userstaged_create_user_v1_response_t *result = userstaged_create_user_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void userstaged_create_user_v1_response_free(userstaged_create_user_v1_response_t *userstaged_create_user_v1_response) {
    ...
    if(userstaged_create_user_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "userstaged_create_user_v1_response_free");
        return ;
    }
...
userstaged_create_user_v1_response_t *userstaged_create_user_v1_response_parseFromJSON(cJSON *userstaged_create_user_v1_responseJSON){
    ...
    userstaged_create_user_v1_response_local_var = userstaged_create_user_v1_response_create_internal (
