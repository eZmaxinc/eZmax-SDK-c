...
ezsignbulksend_edit_object_v1_response_t *ezsignbulksend_edit_object_v1_response_create(
...
ezsignbulksend_edit_object_v1_response_t *ezsignbulksend_edit_object_v1_response_parseFromJSON(cJSON *ezsignbulksend_edit_object_v1_responseJSON){
    ...
    ezsignbulksend_edit_object_v1_response_local_var = ezsignbulksend_edit_object_v1_response_create (
