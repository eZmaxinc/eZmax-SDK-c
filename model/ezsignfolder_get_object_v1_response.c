...
static ezsignfolder_get_object_v1_response_t *ezsignfolder_get_object_v1_response_create_internal(
    ...
    memset(ezsignfolder_get_object_v1_response_local_var, 0, sizeof(ezsignfolder_get_object_v1_response_t));
...
__attribute__((deprecated)) ezsignfolder_get_object_v1_response_t *ezsignfolder_get_object_v1_response_create(
    ...
    ezsignfolder_get_object_v1_response_t *result = ezsignfolder_get_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
