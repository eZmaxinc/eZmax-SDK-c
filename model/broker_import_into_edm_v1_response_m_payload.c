...
static broker_import_into_edm_v1_response_m_payload_t *broker_import_into_edm_v1_response_m_payload_create_internal(
    ...
    memset(broker_import_into_edm_v1_response_m_payload_local_var, 0, sizeof(broker_import_into_edm_v1_response_m_payload_t));
...
__attribute__((deprecated)) broker_import_into_edm_v1_response_m_payload_t *broker_import_into_edm_v1_response_m_payload_create(
    ...
    broker_import_into_edm_v1_response_m_payload_t *result = broker_import_into_edm_v1_response_m_payload_create_internal (
        a_obj_attachment
        );
    if (!result) {
    }
