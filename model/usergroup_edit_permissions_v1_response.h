/*
 * usergroup_edit_permissions_v1_response.h
 *
 * Response for PUT /1/object/usergroup/{pkiUsergroupID}/editPermissions
 */

#ifndef _usergroup_edit_permissions_v1_response_H_
#define _usergroup_edit_permissions_v1_response_H_
...
typedef struct usergroup_edit_permissions_v1_response_t usergroup_edit_permissions_v1_response_t;
...
typedef struct usergroup_edit_permissions_v1_response_t {
    struct common_response_obj_debug_payload_t *obj_debug_payload; //model
    struct common_response_obj_debug_t *obj_debug; //model
    struct usergroup_edit_permissions_v1_response_m_payload_t *m_payload; //model
...
#endif /* _usergroup_edit_permissions_v1_response_H_ */
