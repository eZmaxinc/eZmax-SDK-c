...
char* field_e_ezsignsignature_type_field_e_ezsignsignature_type_ToString(ezmax_api_definition__full_field_e_ezsignsignature_type__e field_e_ezsignsignature_type) {
    char *field_e_ezsignsignature_typeArray[] =  { "NULL", "Acknowledgement", "Attachments", "AttachmentsConfirmation", "City", "Consultation", "Creditcard", "FieldText", "FieldTextarea", "Handwritten", "Initials", "Name", "NameReason", "Signature" };
