...
static ezsignsignergroupmembership_response_compound_t *ezsignsignergroupmembership_response_compound_create_internal(
    ...
    memset(ezsignsignergroupmembership_response_compound_local_var, 0, sizeof(ezsignsignergroupmembership_response_compound_t));
    ezsignsignergroupmembership_response_compound_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezsignsignergroupmembership_response_compound_t *ezsignsignergroupmembership_response_compound_create(
    int *pki_ezsignsignergroupmembership_id,
    int *fki_ezsignsignergroup_id,
    int *fki_ezsignsigner_id,
    int *fki_user_id,
    ...
    ezsignsignergroupmembership_response_compound_t *result = ezsignsignergroupmembership_response_compound_create_internal (
...
void ezsignsignergroupmembership_response_compound_free(ezsignsignergroupmembership_response_compound_t *ezsignsignergroupmembership_response_compound) {
    ...
    if(ezsignsignergroupmembership_response_compound->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsignsignergroupmembership_response_compound_free");
        return ;
    }
    listEntry_t *listEntry;
    if (ezsignsignergroupmembership_response_compound->pki_ezsignsignergroupmembership_id) {
        free(ezsignsignergroupmembership_response_compound->pki_ezsignsignergroupmembership_id);
        ezsignsignergroupmembership_response_compound->pki_ezsignsignergroupmembership_id = NULL;
    }
    if (ezsignsignergroupmembership_response_compound->fki_ezsignsignergroup_id) {
        free(ezsignsignergroupmembership_response_compound->fki_ezsignsignergroup_id);
        ezsignsignergroupmembership_response_compound->fki_ezsignsignergroup_id = NULL;
    }
    if (ezsignsignergroupmembership_response_compound->fki_ezsignsigner_id) {
        free(ezsignsignergroupmembership_response_compound->fki_ezsignsigner_id);
        ezsignsignergroupmembership_response_compound->fki_ezsignsigner_id = NULL;
    }
    if (ezsignsignergroupmembership_response_compound->fki_user_id) {
        free(ezsignsignergroupmembership_response_compound->fki_user_id);
        ezsignsignergroupmembership_response_compound->fki_user_id = NULL;
    }
    if (ezsignsignergroupmembership_response_compound->fki_usergroup_id) {
        free(ezsignsignergroupmembership_response_compound->fki_usergroup_id);
        ezsignsignergroupmembership_response_compound->fki_usergroup_id = NULL;
    }
...
ezsignsignergroupmembership_response_compound_t *ezsignsignergroupmembership_response_compound_parseFromJSON(cJSON *ezsignsignergroupmembership_response_compoundJSON){
    ...
    // define the local variable for ezsignsignergroupmembership_response_compound->pki_ezsignsignergroupmembership_id
    int *pki_ezsignsignergroupmembership_id_local_var = NULL;

    // define the local variable for ezsignsignergroupmembership_response_compound->fki_ezsignsignergroup_id
    int *fki_ezsignsignergroup_id_local_var = NULL;

    // define the local variable for ezsignsignergroupmembership_response_compound->fki_ezsignsigner_id
    int *fki_ezsignsigner_id_local_var = NULL;

    // define the local variable for ezsignsignergroupmembership_response_compound->fki_user_id
    int *fki_user_id_local_var = NULL;

    // define the local variable for ezsignsignergroupmembership_response_compound->fki_usergroup_id
    ...
    *fki_usergroup_id_local_var = fki_usergroup_id->valuedouble;
    ...
    ezsignsignergroupmembership_response_compound_local_var = ezsignsignergroupmembership_response_compound_create_internal (
