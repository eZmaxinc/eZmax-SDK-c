...
static usergroupdelegation_get_object_v2_response_t *usergroupdelegation_get_object_v2_response_create_internal(
    ...
    memset(usergroupdelegation_get_object_v2_response_local_var, 0, sizeof(usergroupdelegation_get_object_v2_response_t));
    usergroupdelegation_get_object_v2_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) usergroupdelegation_get_object_v2_response_t *usergroupdelegation_get_object_v2_response_create(
    common_response_obj_debug_payload_t *obj_debug_payload,
    common_response_obj_debug_t *obj_debug,
    usergroupdelegation_get_object_v2_response_m_payload_t *m_payload
    ) {
    usergroupdelegation_get_object_v2_response_t *result = usergroupdelegation_get_object_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void usergroupdelegation_get_object_v2_response_free(usergroupdelegation_get_object_v2_response_t *usergroupdelegation_get_object_v2_response) {
    ...
    if(usergroupdelegation_get_object_v2_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "usergroupdelegation_get_object_v2_response_free");
        return ;
    }
...
usergroupdelegation_get_object_v2_response_t *usergroupdelegation_get_object_v2_response_parseFromJSON(cJSON *usergroupdelegation_get_object_v2_responseJSON){
    ...
    usergroupdelegation_get_object_v2_response_local_var = usergroupdelegation_get_object_v2_response_create_internal (
