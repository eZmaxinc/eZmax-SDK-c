...
#ifndef _phone_request_v2_H_
#define _phone_request_v2_H_
...
typedef struct phone_request_v2_t phone_request_v2_t;




typedef struct phone_request_v2_t {
