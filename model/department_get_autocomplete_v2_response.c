...
static department_get_autocomplete_v2_response_t *department_get_autocomplete_v2_response_create_internal(
    ...
    memset(department_get_autocomplete_v2_response_local_var, 0, sizeof(department_get_autocomplete_v2_response_t));
...
__attribute__((deprecated)) department_get_autocomplete_v2_response_t *department_get_autocomplete_v2_response_create(
    ...
    department_get_autocomplete_v2_response_t *result = department_get_autocomplete_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
