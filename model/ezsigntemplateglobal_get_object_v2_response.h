/*
 * ezsigntemplateglobal_get_object_v2_response.h
 *
 * Response for GET /2/object/ezsigntemplateglobal/{pkiEzsigntemplateglobalID}
 */

#ifndef _ezsigntemplateglobal_get_object_v2_response_H_
#define _ezsigntemplateglobal_get_object_v2_response_H_
...
typedef struct ezsigntemplateglobal_get_object_v2_response_t ezsigntemplateglobal_get_object_v2_response_t;
...
typedef struct ezsigntemplateglobal_get_object_v2_response_t {
    struct common_response_obj_debug_payload_t *obj_debug_payload; //model
    struct common_response_obj_debug_t *obj_debug; //model
    struct ezsigntemplateglobal_get_object_v2_response_m_payload_t *m_payload; //model

} ezsigntemplateglobal_get_object_v2_response_t;

ezsigntemplateglobal_get_object_v2_response_t *ezsigntemplateglobal_get_object_v2_response_create(
...
#endif /* _ezsigntemplateglobal_get_object_v2_response_H_ */
