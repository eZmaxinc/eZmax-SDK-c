...
typedef enum  { ezmax_api_definition_ezsignformfieldgroup_response_compound__NULL = 0, ezmax_api_definition_ezsignformfieldgroup_response_compound__Text, ezmax_api_definition_ezsignformfieldgroup_response_compound__Textarea, ezmax_api_definition_ezsignformfieldgroup_response_compound__Dropdown, ezmax_api_definition_ezsignformfieldgroup_response_compound__Radio, ezmax_api_definition_ezsignformfieldgroup_response_compound__Checkbox } ezmax_api_definition_ezsignformfieldgroup_response_compound__e;

char* ezsignformfieldgroup_response_compound_e_ezsignformfieldgroup_type_ToString(ezmax_api_definition_ezsignformfieldgroup_response_compound__e e_ezsignformfieldgroup_type);

ezmax_api_definition_ezsignformfieldgroup_response_compound__e ezsignformfieldgroup_response_compound_e_ezsignformfieldgroup_type_FromString(char* e_ezsignformfieldgroup_type);

// Enum  for ezsignformfieldgroup_response_compound

typedef enum  { ezmax_api_definition_ezsignformfieldgroup_response_compound__NULL = 0, ezmax_api_definition_ezsignformfieldgroup_response_compound__All, ezmax_api_definition_ezsignformfieldgroup_response_compound__One } ezmax_api_definition_ezsignformfieldgroup_response_compound__e;

char* ezsignformfieldgroup_response_compound_e_ezsignformfieldgroup_signerrequirement_ToString(ezmax_api_definition_ezsignformfieldgroup_response_compound__e e_ezsignformfieldgroup_signerrequirement);

ezmax_api_definition_ezsignformfieldgroup_response_compound__e ezsignformfieldgroup_response_compound_e_ezsignformfieldgroup_signerrequirement_FromString(char* e_ezsignformfieldgroup_signerrequirement);

// Enum  for ezsignformfieldgroup_response_compound

typedef enum  { ezmax_api_definition_ezsignformfieldgroup_response_compound__NULL = 0, ezmax_api_definition_ezsignformfieldgroup_response_compound__TopLeft, ezmax_api_definition_ezsignformfieldgroup_response_compound__TopCenter, ezmax_api_definition_ezsignformfieldgroup_response_compound__TopRight, ezmax_api_definition_ezsignformfieldgroup_response_compound__MiddleLeft, ezmax_api_definition_ezsignformfieldgroup_response_compound__MiddleCenter, ezmax_api_definition_ezsignformfieldgroup_response_compound__MiddleRight, ezmax_api_definition_ezsignformfieldgroup_response_compound__BottomLeft, ezmax_api_definition_ezsignformfieldgroup_response_compound__BottomCenter, ezmax_api_definition_ezsignformfieldgroup_response_compound__BottomRight } ezmax_api_definition_ezsignformfieldgroup_response_compound__e;

char* ezsignformfieldgroup_response_compound_e_ezsignformfieldgroup_tooltipposition_ToString(ezmax_api_definition_ezsignformfieldgroup_response_compound__e e_ezsignformfieldgroup_tooltipposition);

ezmax_api_definition_ezsignformfieldgroup_response_compound__e ezsignformfieldgroup_response_compound_e_ezsignformfieldgroup_tooltipposition_FromString(char* e_ezsignformfieldgroup_tooltipposition);
