...
static ezsignfolder_create_object_v2_request_t *ezsignfolder_create_object_v2_request_create_internal(
    ...
    memset(ezsignfolder_create_object_v2_request_local_var, 0, sizeof(ezsignfolder_create_object_v2_request_t));
    ezsignfolder_create_object_v2_request_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezsignfolder_create_object_v2_request_t *ezsignfolder_create_object_v2_request_create(
    ...
    ezsignfolder_create_object_v2_request_t *result = ezsignfolder_create_object_v2_request_create_internal (
        a_obj_ezsignfolder
        );
    if (!result) {
    }
...
void ezsignfolder_create_object_v2_request_free(ezsignfolder_create_object_v2_request_t *ezsignfolder_create_object_v2_request) {
    ...
    if(ezsignfolder_create_object_v2_request->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsignfolder_create_object_v2_request_free");
        return ;
    }
...
ezsignfolder_create_object_v2_request_t *ezsignfolder_create_object_v2_request_parseFromJSON(cJSON *ezsignfolder_create_object_v2_requestJSON){
    ...
    // define the local list for ezsignfolder_create_object_v2_request->a_obj_ezsignfolder
    ...
    ezsignfolder_create_object_v2_request_local_var = ezsignfolder_create_object_v2_request_create_internal (
