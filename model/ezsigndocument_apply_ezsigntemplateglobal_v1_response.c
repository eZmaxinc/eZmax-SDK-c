...
static ezsigndocument_apply_ezsigntemplateglobal_v1_response_t *ezsigndocument_apply_ezsigntemplateglobal_v1_response_create_internal(
    ...
    memset(ezsigndocument_apply_ezsigntemplateglobal_v1_response_local_var, 0, sizeof(ezsigndocument_apply_ezsigntemplateglobal_v1_response_t));
...
__attribute__((deprecated)) ezsigndocument_apply_ezsigntemplateglobal_v1_response_t *ezsigndocument_apply_ezsigntemplateglobal_v1_response_create(
    ...
    ezsigndocument_apply_ezsigntemplateglobal_v1_response_t *result = ezsigndocument_apply_ezsigntemplateglobal_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        a_obj_warning
        );
