...
char* e_ezsigntemplateformfieldgroup_typeezsigntemplateformfieldgroup_response_ToString(ezmax_api_definition__full_ezsigntemplateformfieldgroup_response__e e_ezsigntemplateformfieldgroup_type) {
...
ezmax_api_definition__full_ezsigntemplateformfieldgroup_response__e e_ezsigntemplateformfieldgroup_typeezsigntemplateformfieldgroup_response_FromString(char* e_ezsigntemplateformfieldgroup_type){
...
char* e_ezsigntemplateformfieldgroup_signerrequirementezsigntemplateformfieldgroup_response_ToString(ezmax_api_definition__full_ezsigntemplateformfieldgroup_response__e e_ezsigntemplateformfieldgroup_signerrequirement) {
...
ezmax_api_definition__full_ezsigntemplateformfieldgroup_response__e e_ezsigntemplateformfieldgroup_signerrequirementezsigntemplateformfieldgroup_response_FromString(char* e_ezsigntemplateformfieldgroup_signerrequirement){
    int stringToReturn = 0;
    char *e_ezsigntemplateformfieldgroup_signerrequirementArray[] =  { "NULL", "All", "One" };
...
char* e_ezsigntemplateformfieldgroup_textvalidationezsigntemplateformfieldgroup_response_ToString(ezmax_api_definition__full_ezsigntemplateformfieldgroup_response__e e_ezsigntemplateformfieldgroup_textvalidation) {
...
ezmax_api_definition__full_ezsigntemplateformfieldgroup_response__e e_ezsigntemplateformfieldgroup_textvalidationezsigntemplateformfieldgroup_response_FromString(char* e_ezsigntemplateformfieldgroup_textvalidation){
    int stringToReturn = 0;
    char *e_ezsigntemplateformfieldgroup_textvalidationArray[] =  { "NULL", "None", "Date (YYYY-MM-DD)", "Date (MM/DD/YYYY)", "Date (MM/DD/YY)", "Date (DD/MM/YYYY)", "Date (DD/MM/YY)", "Email", "Letters", "Numbers", "Zip", "Zip+4", "PostalCode", "Custom" };
...
char* e_ezsigntemplateformfieldgroup_tooltippositionezsigntemplateformfieldgroup_response_ToString(ezmax_api_definition__full_ezsigntemplateformfieldgroup_response__e e_ezsigntemplateformfieldgroup_tooltipposition) {
...
ezmax_api_definition__full_ezsigntemplateformfieldgroup_response__e e_ezsigntemplateformfieldgroup_tooltippositionezsigntemplateformfieldgroup_response_FromString(char* e_ezsigntemplateformfieldgroup_tooltipposition){
    int stringToReturn = 0;
    char *e_ezsigntemplateformfieldgroup_tooltippositionArray[] =  { "NULL", "TopLeft", "TopCenter", "TopRight", "MiddleLeft", "MiddleRight", "BottomLeft", "BottomCenter", "BottomRight" };
...
cJSON *ezsigntemplateformfieldgroup_response_convertToJSON(ezsigntemplateformfieldgroup_response_t *ezsigntemplateformfieldgroup_response) {
    ...
    if (ezmax_api_definition__full_ezsigntemplateformfieldgroup_response__NULL == ezsigntemplateformfieldgroup_response->e_ezsigntemplateformfieldgroup_signerrequirement) {
        goto fail;
    }
