...
typedef enum  { ezmax_api_definition_phone_request_compound__NULL = 0, ezmax_api_definition_phone_request_compound__Local, ezmax_api_definition_phone_request_compound__International } ezmax_api_definition_phone_request_compound__e;

char* phone_request_compound_e_phone_type_ToString(ezmax_api_definition_phone_request_compound__e e_phone_type);

ezmax_api_definition_phone_request_compound__e phone_request_compound_e_phone_type_FromString(char* e_phone_type);
