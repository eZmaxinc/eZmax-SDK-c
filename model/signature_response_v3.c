...
void signature_response_v3_free(signature_response_v3_t *signature_response_v3) {
    ...
    if (signature_response_v3->e_signature_preference) {
        field_e_signature_preference_free(signature_response_v3->e_signature_preference);
        signature_response_v3->e_signature_preference = NULL;
    }
...
cJSON *signature_response_v3_convertToJSON(signature_response_v3_t *signature_response_v3) {
    ...
    if (ezmax_api_definition__full_signature_response_v3__NULL == signature_response_v3->e_signature_preference) {
        goto fail;
    }
...
signature_response_v3_t *signature_response_v3_parseFromJSON(cJSON *signature_response_v3JSON){
    ...
    signature_response_v3_local_var = signature_response_v3_create (
