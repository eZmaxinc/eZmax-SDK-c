...
static signature_response_v3_t *signature_response_v3_create_internal(
    ...
    memset(signature_response_v3_local_var, 0, sizeof(signature_response_v3_t));
...
__attribute__((deprecated)) signature_response_v3_t *signature_response_v3_create(
    ...
    signature_response_v3_t *result = signature_response_v3_create_internal (
...
void signature_response_v3_free(signature_response_v3_t *signature_response_v3) {
    ...
    if (signature_response_v3->pki_signature_id) {
        free(signature_response_v3->pki_signature_id);
        signature_response_v3->pki_signature_id = NULL;
    }
    if (signature_response_v3->fki_font_id) {
        free(signature_response_v3->fki_font_id);
        signature_response_v3->fki_font_id = NULL;
    }
    if (signature_response_v3->b_signature_svg) {
        free(signature_response_v3->b_signature_svg);
        signature_response_v3->b_signature_svg = NULL;
    }
    if (signature_response_v3->b_signature_svginitials) {
        free(signature_response_v3->b_signature_svginitials);
        signature_response_v3->b_signature_svginitials = NULL;
    }
...
signature_response_v3_t *signature_response_v3_parseFromJSON(cJSON *signature_response_v3JSON){
    ...
    // define the local variable for signature_response_v3->pki_signature_id
    int *pki_signature_id_local_var = NULL;

    // define the local variable for signature_response_v3->fki_font_id
    ...
    // define the local variable for signature_response_v3->b_signature_svg
    int *b_signature_svg_local_var = NULL;

    // define the local variable for signature_response_v3->b_signature_svginitials
