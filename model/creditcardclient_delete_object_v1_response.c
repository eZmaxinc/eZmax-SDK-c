...
creditcardclient_delete_object_v1_response_t *creditcardclient_delete_object_v1_response_create(
...
creditcardclient_delete_object_v1_response_t *creditcardclient_delete_object_v1_response_parseFromJSON(cJSON *creditcardclient_delete_object_v1_responseJSON){
    ...
    creditcardclient_delete_object_v1_response_local_var = creditcardclient_delete_object_v1_response_create (
