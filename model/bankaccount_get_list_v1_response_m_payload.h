/*
 * bankaccount_get_list_v1_response_m_payload.h
 *
 * Payload for GET /1/object/bankaccount/getList
 */

#ifndef _bankaccount_get_list_v1_response_m_payload_H_
#define _bankaccount_get_list_v1_response_m_payload_H_
...
typedef struct bankaccount_get_list_v1_response_m_payload_t bankaccount_get_list_v1_response_m_payload_t;

#include "bankaccount_list_element.h"



typedef struct bankaccount_get_list_v1_response_m_payload_t {
    int *i_row_returned; //numeric
    int *i_row_filtered; //numeric
    list_t *a_obj_bankaccount; //nonprimitive container

    int _library_owned; // Is the library responsible for freeing this object?
} bankaccount_get_list_v1_response_m_payload_t;
...
#endif /* _bankaccount_get_list_v1_response_m_payload_H_ */
