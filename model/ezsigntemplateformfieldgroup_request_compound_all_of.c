...
ezsigntemplateformfieldgroup_request_compound_all_of_t *ezsigntemplateformfieldgroup_request_compound_all_of_create(
    ...
    ezsigntemplateformfieldgroup_request_compound_all_of_t *ezsigntemplateformfieldgroup_request_compound_all_of_local_var = malloc(sizeof(ezsigntemplateformfieldgroup_request_compound_all_of_t));
    if (!ezsigntemplateformfieldgroup_request_compound_all_of_local_var) {
        return NULL;
    }
    ezsigntemplateformfieldgroup_request_compound_all_of_local_var->a_obj_ezsigntemplateformfieldgroupsigner = a_obj_ezsigntemplateformfieldgroupsigner;
    ezsigntemplateformfieldgroup_request_compound_all_of_local_var->a_obj_dropdown_element = a_obj_dropdown_element;
    ezsigntemplateformfieldgroup_request_compound_all_of_local_var->a_obj_ezsigntemplateformfield = a_obj_ezsigntemplateformfield;

    return ezsigntemplateformfieldgroup_request_compound_all_of_local_var;
}
...
void ezsigntemplateformfieldgroup_request_compound_all_of_free(ezsigntemplateformfieldgroup_request_compound_all_of_t *ezsigntemplateformfieldgroup_request_compound_all_of) {
    if(NULL == ezsigntemplateformfieldgroup_request_compound_all_of){
        return ;
    }
    listEntry_t *listEntry;
    if (ezsigntemplateformfieldgroup_request_compound_all_of->a_obj_ezsigntemplateformfieldgroupsigner) {
        list_ForEach(listEntry, ezsigntemplateformfieldgroup_request_compound_all_of->a_obj_ezsigntemplateformfieldgroupsigner) {
            ezsigntemplateformfieldgroupsigner_request_compound_free(listEntry->data);
        }
        list_freeList(ezsigntemplateformfieldgroup_request_compound_all_of->a_obj_ezsigntemplateformfieldgroupsigner);
        ezsigntemplateformfieldgroup_request_compound_all_of->a_obj_ezsigntemplateformfieldgroupsigner = NULL;
    }
    if (ezsigntemplateformfieldgroup_request_compound_all_of->a_obj_dropdown_element) {
        list_ForEach(listEntry, ezsigntemplateformfieldgroup_request_compound_all_of->a_obj_dropdown_element) {
            custom_dropdown_element_request_compound_free(listEntry->data);
        }
        list_freeList(ezsigntemplateformfieldgroup_request_compound_all_of->a_obj_dropdown_element);
        ezsigntemplateformfieldgroup_request_compound_all_of->a_obj_dropdown_element = NULL;
    }
    if (ezsigntemplateformfieldgroup_request_compound_all_of->a_obj_ezsigntemplateformfield) {
        list_ForEach(listEntry, ezsigntemplateformfieldgroup_request_compound_all_of->a_obj_ezsigntemplateformfield) {
            ezsigntemplateformfield_request_compound_free(listEntry->data);
        }
        list_freeList(ezsigntemplateformfieldgroup_request_compound_all_of->a_obj_ezsigntemplateformfield);
        ezsigntemplateformfieldgroup_request_compound_all_of->a_obj_ezsigntemplateformfield = NULL;
    }
    free(ezsigntemplateformfieldgroup_request_compound_all_of);
}
...
cJSON *ezsigntemplateformfieldgroup_request_compound_all_of_convertToJSON(ezsigntemplateformfieldgroup_request_compound_all_of_t *ezsigntemplateformfieldgroup_request_compound_all_of) {
    ...
    // ezsigntemplateformfieldgroup_request_compound_all_of->a_obj_ezsigntemplateformfieldgroupsigner
    if (!ezsigntemplateformfieldgroup_request_compound_all_of->a_obj_ezsigntemplateformfieldgroupsigner) {
        goto fail;
    }
    ...
    if (ezsigntemplateformfieldgroup_request_compound_all_of->a_obj_ezsigntemplateformfieldgroupsigner) {
    list_ForEach(a_obj_ezsigntemplateformfieldgroupsignerListEntry, ezsigntemplateformfieldgroup_request_compound_all_of->a_obj_ezsigntemplateformfieldgroupsigner) {
    ...
    // ezsigntemplateformfieldgroup_request_compound_all_of->a_obj_dropdown_element
    if(ezsigntemplateformfieldgroup_request_compound_all_of->a_obj_dropdown_element) {
    ...
    if (ezsigntemplateformfieldgroup_request_compound_all_of->a_obj_dropdown_element) {
    list_ForEach(a_obj_dropdown_elementListEntry, ezsigntemplateformfieldgroup_request_compound_all_of->a_obj_dropdown_element) {
    ...
    // ezsigntemplateformfieldgroup_request_compound_all_of->a_obj_ezsigntemplateformfield
    if (!ezsigntemplateformfieldgroup_request_compound_all_of->a_obj_ezsigntemplateformfield) {
        goto fail;
    }
    ...
    if (ezsigntemplateformfieldgroup_request_compound_all_of->a_obj_ezsigntemplateformfield) {
    list_ForEach(a_obj_ezsigntemplateformfieldListEntry, ezsigntemplateformfieldgroup_request_compound_all_of->a_obj_ezsigntemplateformfield) {
...
ezsigntemplateformfieldgroup_request_compound_all_of_t *ezsigntemplateformfieldgroup_request_compound_all_of_parseFromJSON(cJSON *ezsigntemplateformfieldgroup_request_compound_all_ofJSON){
    ...
    ezsigntemplateformfieldgroup_request_compound_all_of_t *ezsigntemplateformfieldgroup_request_compound_all_of_local_var = NULL;

    // define the local list for ezsigntemplateformfieldgroup_request_compound_all_of->a_obj_ezsigntemplateformfieldgroupsigner
    list_t *a_obj_ezsigntemplateformfieldgroupsignerList = NULL;

    // define the local list for ezsigntemplateformfieldgroup_request_compound_all_of->a_obj_dropdown_element
    list_t *a_obj_dropdown_elementList = NULL;

    // define the local list for ezsigntemplateformfieldgroup_request_compound_all_of->a_obj_ezsigntemplateformfield
    list_t *a_obj_ezsigntemplateformfieldList = NULL;

    // ezsigntemplateformfieldgroup_request_compound_all_of->a_obj_ezsigntemplateformfieldgroupsigner
    cJSON *a_obj_ezsigntemplateformfieldgroupsigner = cJSON_GetObjectItemCaseSensitive(ezsigntemplateformfieldgroup_request_compound_all_ofJSON, "a_objEzsigntemplateformfieldgroupsigner");
    ...
    // ezsigntemplateformfieldgroup_request_compound_all_of->a_obj_dropdown_element
    cJSON *a_obj_dropdown_element = cJSON_GetObjectItemCaseSensitive(ezsigntemplateformfieldgroup_request_compound_all_ofJSON, "a_objDropdownElement");
    ...
    // ezsigntemplateformfieldgroup_request_compound_all_of->a_obj_ezsigntemplateformfield
    cJSON *a_obj_ezsigntemplateformfield = cJSON_GetObjectItemCaseSensitive(ezsigntemplateformfieldgroup_request_compound_all_ofJSON, "a_objEzsigntemplateformfield");
    ...
    ezsigntemplateformfieldgroup_request_compound_all_of_local_var = ezsigntemplateformfieldgroup_request_compound_all_of_create (
