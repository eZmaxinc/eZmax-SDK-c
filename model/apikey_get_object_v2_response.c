...
static apikey_get_object_v2_response_t *apikey_get_object_v2_response_create_internal(
    ...
    memset(apikey_get_object_v2_response_local_var, 0, sizeof(apikey_get_object_v2_response_t));
    apikey_get_object_v2_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) apikey_get_object_v2_response_t *apikey_get_object_v2_response_create(
    common_response_obj_debug_payload_t *obj_debug_payload,
    common_response_obj_debug_t *obj_debug,
    apikey_get_object_v2_response_m_payload_t *m_payload
    ) {
    apikey_get_object_v2_response_t *result = apikey_get_object_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void apikey_get_object_v2_response_free(apikey_get_object_v2_response_t *apikey_get_object_v2_response) {
    ...
    if(apikey_get_object_v2_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "apikey_get_object_v2_response_free");
        return ;
    }
...
apikey_get_object_v2_response_t *apikey_get_object_v2_response_parseFromJSON(cJSON *apikey_get_object_v2_responseJSON){
    ...
    apikey_get_object_v2_response_local_var = apikey_get_object_v2_response_create_internal (
