...
static ezsigndocument_get_ezsignsignatures_automatic_v1_response_t *ezsigndocument_get_ezsignsignatures_automatic_v1_response_create_internal(
    ...
    memset(ezsigndocument_get_ezsignsignatures_automatic_v1_response_local_var, 0, sizeof(ezsigndocument_get_ezsignsignatures_automatic_v1_response_t));
    ezsigndocument_get_ezsignsignatures_automatic_v1_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezsigndocument_get_ezsignsignatures_automatic_v1_response_t *ezsigndocument_get_ezsignsignatures_automatic_v1_response_create(
    common_response_obj_debug_payload_t *obj_debug_payload,
    common_response_obj_debug_t *obj_debug,
    ezsigndocument_get_ezsignsignatures_automatic_v1_response_m_payload_t *m_payload
    ) {
    ezsigndocument_get_ezsignsignatures_automatic_v1_response_t *result = ezsigndocument_get_ezsignsignatures_automatic_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void ezsigndocument_get_ezsignsignatures_automatic_v1_response_free(ezsigndocument_get_ezsignsignatures_automatic_v1_response_t *ezsigndocument_get_ezsignsignatures_automatic_v1_response) {
    ...
    if(ezsigndocument_get_ezsignsignatures_automatic_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsigndocument_get_ezsignsignatures_automatic_v1_response_free");
        return ;
    }
...
ezsigndocument_get_ezsignsignatures_automatic_v1_response_t *ezsigndocument_get_ezsignsignatures_automatic_v1_response_parseFromJSON(cJSON *ezsigndocument_get_ezsignsignatures_automatic_v1_responseJSON){
    ...
    ezsigndocument_get_ezsignsignatures_automatic_v1_response_local_var = ezsigndocument_get_ezsignsignatures_automatic_v1_response_create_internal (
