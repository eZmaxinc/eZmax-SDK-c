...
static cors_edit_object_v1_response_t *cors_edit_object_v1_response_create_internal(
    ...
    memset(cors_edit_object_v1_response_local_var, 0, sizeof(cors_edit_object_v1_response_t));
...
__attribute__((deprecated)) cors_edit_object_v1_response_t *cors_edit_object_v1_response_create(
    ...
    cors_edit_object_v1_response_t *result = cors_edit_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug
        );
    if (!result) {
