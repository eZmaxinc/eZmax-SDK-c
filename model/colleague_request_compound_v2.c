...
void colleague_request_compound_v2_free(colleague_request_compound_v2_t *colleague_request_compound_v2) {
    ...
    if (colleague_request_compound_v2->e_colleague_ezsign) {
        field_e_colleague_ezsign_free(colleague_request_compound_v2->e_colleague_ezsign);
        colleague_request_compound_v2->e_colleague_ezsign = NULL;
    }
    if (colleague_request_compound_v2->e_colleague_realestateinprogress) {
        field_e_colleague_realestateinprogess_free(colleague_request_compound_v2->e_colleague_realestateinprogress);
        colleague_request_compound_v2->e_colleague_realestateinprogress = NULL;
    }
...
cJSON *colleague_request_compound_v2_convertToJSON(colleague_request_compound_v2_t *colleague_request_compound_v2) {
    ...
    if (ezmax_api_definition__full_colleague_request_compound_v2__NULL == colleague_request_compound_v2->e_colleague_ezsign) {
        goto fail;
    }
    ...
    if (ezmax_api_definition__full_colleague_request_compound_v2__NULL == colleague_request_compound_v2->e_colleague_realestateinprogress) {
        goto fail;
    }
...
colleague_request_compound_v2_t *colleague_request_compound_v2_parseFromJSON(cJSON *colleague_request_compound_v2JSON){
    ...
    colleague_request_compound_v2_local_var = colleague_request_compound_v2_create (
