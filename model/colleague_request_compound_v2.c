...
static colleague_request_compound_v2_t *colleague_request_compound_v2_create_internal(
    ...
    memset(colleague_request_compound_v2_local_var, 0, sizeof(colleague_request_compound_v2_t));
...
__attribute__((deprecated)) colleague_request_compound_v2_t *colleague_request_compound_v2_create(
    ...
    colleague_request_compound_v2_t *result = colleague_request_compound_v2_create_internal (
...
void colleague_request_compound_v2_free(colleague_request_compound_v2_t *colleague_request_compound_v2) {
    ...
    if (colleague_request_compound_v2->pki_colleague_id) {
        free(colleague_request_compound_v2->pki_colleague_id);
        colleague_request_compound_v2->pki_colleague_id = NULL;
    }
    if (colleague_request_compound_v2->fki_user_id) {
        free(colleague_request_compound_v2->fki_user_id);
        colleague_request_compound_v2->fki_user_id = NULL;
    }
    if (colleague_request_compound_v2->fki_user_id_colleague) {
        free(colleague_request_compound_v2->fki_user_id_colleague);
        colleague_request_compound_v2->fki_user_id_colleague = NULL;
    }
    if (colleague_request_compound_v2->b_colleague_ezsignemail) {
        free(colleague_request_compound_v2->b_colleague_ezsignemail);
        colleague_request_compound_v2->b_colleague_ezsignemail = NULL;
    }
    if (colleague_request_compound_v2->b_colleague_financial) {
        free(colleague_request_compound_v2->b_colleague_financial);
        colleague_request_compound_v2->b_colleague_financial = NULL;
    }
    if (colleague_request_compound_v2->b_colleague_usecloneemail) {
        free(colleague_request_compound_v2->b_colleague_usecloneemail);
        colleague_request_compound_v2->b_colleague_usecloneemail = NULL;
    }
    if (colleague_request_compound_v2->b_colleague_attachment) {
        free(colleague_request_compound_v2->b_colleague_attachment);
        colleague_request_compound_v2->b_colleague_attachment = NULL;
    }
    if (colleague_request_compound_v2->b_colleague_canafe) {
        free(colleague_request_compound_v2->b_colleague_canafe);
        colleague_request_compound_v2->b_colleague_canafe = NULL;
    }
    if (colleague_request_compound_v2->b_colleague_permission) {
        free(colleague_request_compound_v2->b_colleague_permission);
        colleague_request_compound_v2->b_colleague_permission = NULL;
    }
    if (colleague_request_compound_v2->b_colleague_realestatecompleted) {
        free(colleague_request_compound_v2->b_colleague_realestatecompleted);
        colleague_request_compound_v2->b_colleague_realestatecompleted = NULL;
    }
...
colleague_request_compound_v2_t *colleague_request_compound_v2_parseFromJSON(cJSON *colleague_request_compound_v2JSON){
    ...
    // define the local variable for colleague_request_compound_v2->pki_colleague_id
    int *pki_colleague_id_local_var = NULL;

    // define the local variable for colleague_request_compound_v2->fki_user_id
    int *fki_user_id_local_var = NULL;

    // define the local variable for colleague_request_compound_v2->fki_user_id_colleague
    int *fki_user_id_colleague_local_var = NULL;

    // define the local variable for colleague_request_compound_v2->b_colleague_ezsignemail
    int *b_colleague_ezsignemail_local_var = NULL;

    // define the local variable for colleague_request_compound_v2->b_colleague_financial
    int *b_colleague_financial_local_var = NULL;

    // define the local variable for colleague_request_compound_v2->b_colleague_usecloneemail
    int *b_colleague_usecloneemail_local_var = NULL;

    // define the local variable for colleague_request_compound_v2->b_colleague_attachment
    int *b_colleague_attachment_local_var = NULL;

    // define the local variable for colleague_request_compound_v2->b_colleague_canafe
    int *b_colleague_canafe_local_var = NULL;

    // define the local variable for colleague_request_compound_v2->b_colleague_permission
    int *b_colleague_permission_local_var = NULL;

    // define the local variable for colleague_request_compound_v2->b_colleague_realestatecompleted
