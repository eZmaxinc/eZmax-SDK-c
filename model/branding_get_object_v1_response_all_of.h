/*
 * branding_get_object_v1_response_all_of.h
 *
 * 
 */

#ifndef _branding_get_object_v1_response_all_of_H_
#define _branding_get_object_v1_response_all_of_H_
...
typedef struct branding_get_object_v1_response_all_of_t branding_get_object_v1_response_all_of_t;

#include "branding_get_object_v1_response_m_payload.h"



typedef struct branding_get_object_v1_response_all_of_t {
    struct branding_get_object_v1_response_m_payload_t *m_payload; //model

} branding_get_object_v1_response_all_of_t;
...
#endif /* _branding_get_object_v1_response_all_of_H_ */
