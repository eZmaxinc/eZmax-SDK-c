/*
 * inscriptionnotauthenticated_get_communicationrecipients_v1_response.h
 *
 * Response for GET /1/object/inscriptionnotauthenticated/{pkiInscriptionnotauthenticatedID}/getCommunicationrecipients
 */

#ifndef _inscriptionnotauthenticated_get_communicationrecipients_v1_response_H_
#define _inscriptionnotauthenticated_get_communicationrecipients_v1_response_H_
...
typedef struct inscriptionnotauthenticated_get_communicationrecipients_v1_response_t inscriptionnotauthenticated_get_communicationrecipients_v1_response_t;
...
typedef struct inscriptionnotauthenticated_get_communicationrecipients_v1_response_t {
    struct common_response_obj_debug_payload_t *obj_debug_payload; //model
    struct common_response_obj_debug_t *obj_debug; //model
    struct inscriptionnotauthenticated_get_communicationrecipients_v1_response_m_payload_t *m_payload; //model
...
#endif /* _inscriptionnotauthenticated_get_communicationrecipients_v1_response_H_ */
