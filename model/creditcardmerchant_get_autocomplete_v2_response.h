/*
 * creditcardmerchant_get_autocomplete_v2_response.h
 *
 * Response for GET /2/object/creditcardmerchant/getAutocomplete
 */

#ifndef _creditcardmerchant_get_autocomplete_v2_response_H_
#define _creditcardmerchant_get_autocomplete_v2_response_H_
...
typedef struct creditcardmerchant_get_autocomplete_v2_response_t creditcardmerchant_get_autocomplete_v2_response_t;
...
typedef struct creditcardmerchant_get_autocomplete_v2_response_t {
    struct common_response_obj_debug_payload_t *obj_debug_payload; //model
    struct common_response_obj_debug_t *obj_debug; //model
    struct creditcardmerchant_get_autocomplete_v2_response_m_payload_t *m_payload; //model
...
#endif /* _creditcardmerchant_get_autocomplete_v2_response_H_ */
