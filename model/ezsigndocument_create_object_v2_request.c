...
#include <string.h>
#include <stdio.h>
#include "ezsigndocument_create_object_v2_request.h"



static ezsigndocument_create_object_v2_request_t *ezsigndocument_create_object_v2_request_create_internal(
    list_t *a_obj_ezsigndocument
    ) {
    ezsigndocument_create_object_v2_request_t *ezsigndocument_create_object_v2_request_local_var = malloc(sizeof(ezsigndocument_create_object_v2_request_t));
    if (!ezsigndocument_create_object_v2_request_local_var) {
        return NULL;
    }
    memset(ezsigndocument_create_object_v2_request_local_var, 0, sizeof(ezsigndocument_create_object_v2_request_t));
    ezsigndocument_create_object_v2_request_local_var->_library_owned = 1;
    ezsigndocument_create_object_v2_request_local_var->a_obj_ezsigndocument = a_obj_ezsigndocument;
...
__attribute__((deprecated)) ezsigndocument_create_object_v2_request_t *ezsigndocument_create_object_v2_request_create(
    ...
    ezsigndocument_create_object_v2_request_t *result = ezsigndocument_create_object_v2_request_create_internal (
...
void ezsigndocument_create_object_v2_request_free(ezsigndocument_create_object_v2_request_t *ezsigndocument_create_object_v2_request) {
    if(NULL == ezsigndocument_create_object_v2_request){
        return ;
    }
    if(ezsigndocument_create_object_v2_request->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsigndocument_create_object_v2_request_free");
        return ;
    }
    listEntry_t *listEntry;
    if (ezsigndocument_create_object_v2_request->a_obj_ezsigndocument) {
        list_ForEach(listEntry, ezsigndocument_create_object_v2_request->a_obj_ezsigndocument) {
            ezsigndocument_request_compound_free(listEntry->data);
        }
        list_freeList(ezsigndocument_create_object_v2_request->a_obj_ezsigndocument);
        ezsigndocument_create_object_v2_request->a_obj_ezsigndocument = NULL;
    }
    free(ezsigndocument_create_object_v2_request);
}
...
cJSON *ezsigndocument_create_object_v2_request_convertToJSON(ezsigndocument_create_object_v2_request_t *ezsigndocument_create_object_v2_request) {
    ...
    if (ezsigndocument_create_object_v2_request->a_obj_ezsigndocument) {
    list_ForEach(a_obj_ezsigndocumentListEntry, ezsigndocument_create_object_v2_request->a_obj_ezsigndocument) {
...
ezsigndocument_create_object_v2_request_t *ezsigndocument_create_object_v2_request_parseFromJSON(cJSON *ezsigndocument_create_object_v2_requestJSON){
    ...
    ezsigndocument_create_object_v2_request_local_var = ezsigndocument_create_object_v2_request_create_internal (
