...
ezsigndocument_create_object_v2_request_t *ezsigndocument_create_object_v2_request_create(
...
ezsigndocument_create_object_v2_request_t *ezsigndocument_create_object_v2_request_parseFromJSON(cJSON *ezsigndocument_create_object_v2_requestJSON){
    ...
    ezsigndocument_create_object_v2_request_local_var = ezsigndocument_create_object_v2_request_create (
