...
void ezsigntemplatedocumentpagerecognition_request_compound_free(ezsigntemplatedocumentpagerecognition_request_compound_t *ezsigntemplatedocumentpagerecognition_request_compound) {
    ...
    if (ezsigntemplatedocumentpagerecognition_request_compound->e_ezsigntemplatedocumentpagerecognition_operator) {
        field_e_ezsigntemplatedocumentpagerecognition_operator_free(ezsigntemplatedocumentpagerecognition_request_compound->e_ezsigntemplatedocumentpagerecognition_operator);
        ezsigntemplatedocumentpagerecognition_request_compound->e_ezsigntemplatedocumentpagerecognition_operator = NULL;
    }
    if (ezsigntemplatedocumentpagerecognition_request_compound->e_ezsigntemplatedocumentpagerecognition_section) {
        field_e_ezsigntemplatedocumentpagerecognition_section_free(ezsigntemplatedocumentpagerecognition_request_compound->e_ezsigntemplatedocumentpagerecognition_section);
        ezsigntemplatedocumentpagerecognition_request_compound->e_ezsigntemplatedocumentpagerecognition_section = NULL;
    }
...
cJSON *ezsigntemplatedocumentpagerecognition_request_compound_convertToJSON(ezsigntemplatedocumentpagerecognition_request_compound_t *ezsigntemplatedocumentpagerecognition_request_compound) {
    ...
    if (ezmax_api_definition__full_ezsigntemplatedocumentpagerecognition_request_compound__NULL == ezsigntemplatedocumentpagerecognition_request_compound->e_ezsigntemplatedocumentpagerecognition_operator) {
        goto fail;
    }
    ...
    if (ezmax_api_definition__full_ezsigntemplatedocumentpagerecognition_request_compound__NULL == ezsigntemplatedocumentpagerecognition_request_compound->e_ezsigntemplatedocumentpagerecognition_section) {
        goto fail;
    }
...
ezsigntemplatedocumentpagerecognition_request_compound_t *ezsigntemplatedocumentpagerecognition_request_compound_parseFromJSON(cJSON *ezsigntemplatedocumentpagerecognition_request_compoundJSON){
    ...
    ezsigntemplatedocumentpagerecognition_request_compound_local_var = ezsigntemplatedocumentpagerecognition_request_compound_create (
