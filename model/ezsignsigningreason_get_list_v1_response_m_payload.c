...
static ezsignsigningreason_get_list_v1_response_m_payload_t *ezsignsigningreason_get_list_v1_response_m_payload_create_internal(
    int *i_row_returned,
    int *i_row_filtered,
    ...
    memset(ezsignsigningreason_get_list_v1_response_m_payload_local_var, 0, sizeof(ezsignsigningreason_get_list_v1_response_m_payload_t));
    ezsignsigningreason_get_list_v1_response_m_payload_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezsignsigningreason_get_list_v1_response_m_payload_t *ezsignsigningreason_get_list_v1_response_m_payload_create(
    ...
    ezsignsigningreason_get_list_v1_response_m_payload_t *result = ezsignsigningreason_get_list_v1_response_m_payload_create_internal (
        i_row_returned_copy,
        i_row_filtered_copy,
...
void ezsignsigningreason_get_list_v1_response_m_payload_free(ezsignsigningreason_get_list_v1_response_m_payload_t *ezsignsigningreason_get_list_v1_response_m_payload) {
    ...
    if(ezsignsigningreason_get_list_v1_response_m_payload->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsignsigningreason_get_list_v1_response_m_payload_free");
        return ;
    }
    listEntry_t *listEntry;
    if (ezsignsigningreason_get_list_v1_response_m_payload->i_row_returned) {
        free(ezsignsigningreason_get_list_v1_response_m_payload->i_row_returned);
        ezsignsigningreason_get_list_v1_response_m_payload->i_row_returned = NULL;
    }
    if (ezsignsigningreason_get_list_v1_response_m_payload->i_row_filtered) {
        free(ezsignsigningreason_get_list_v1_response_m_payload->i_row_filtered);
        ezsignsigningreason_get_list_v1_response_m_payload->i_row_filtered = NULL;
    }
...
ezsignsigningreason_get_list_v1_response_m_payload_t *ezsignsigningreason_get_list_v1_response_m_payload_parseFromJSON(cJSON *ezsignsigningreason_get_list_v1_response_m_payloadJSON){
    ...
    // define the local variable for ezsignsigningreason_get_list_v1_response_m_payload->i_row_returned
    int *i_row_returned_local_var = NULL;

    // define the local variable for ezsignsigningreason_get_list_v1_response_m_payload->i_row_filtered
    ...
    *i_row_filtered_local_var = i_row_filtered->valuedouble;
    ...
    ezsignsigningreason_get_list_v1_response_m_payload_local_var = ezsignsigningreason_get_list_v1_response_m_payload_create_internal (
