...
static notificationtest_get_elements_v1_response_t *notificationtest_get_elements_v1_response_create_internal(
    ...
    notificationtest_get_elements_v1_response_local_var->_library_owned = 1;
    return notificationtest_get_elements_v1_response_local_var;
}

__attribute__((deprecated)) notificationtest_get_elements_v1_response_t *notificationtest_get_elements_v1_response_create(
    common_response_obj_debug_payload_t *obj_debug_payload,
    common_response_obj_debug_t *obj_debug,
    notificationtest_get_elements_v1_response_m_payload_t *m_payload
    ) {
    return notificationtest_get_elements_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void notificationtest_get_elements_v1_response_free(notificationtest_get_elements_v1_response_t *notificationtest_get_elements_v1_response) {
    ...
    if(notificationtest_get_elements_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "notificationtest_get_elements_v1_response_free");
        return ;
    }
...
notificationtest_get_elements_v1_response_t *notificationtest_get_elements_v1_response_parseFromJSON(cJSON *notificationtest_get_elements_v1_responseJSON){
    ...
    notificationtest_get_elements_v1_response_local_var = notificationtest_get_elements_v1_response_create_internal (
