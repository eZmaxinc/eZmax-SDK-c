...
static ezsigntemplatepublic_response_compound_t *ezsigntemplatepublic_response_compound_create_internal(
    ...
    memset(ezsigntemplatepublic_response_compound_local_var, 0, sizeof(ezsigntemplatepublic_response_compound_t));
...
__attribute__((deprecated)) ezsigntemplatepublic_response_compound_t *ezsigntemplatepublic_response_compound_create(
    ...
    ezsigntemplatepublic_response_compound_t *result = ezsigntemplatepublic_response_compound_create_internal (
...
void ezsigntemplatepublic_response_compound_free(ezsigntemplatepublic_response_compound_t *ezsigntemplatepublic_response_compound) {
    ...
    if (ezsigntemplatepublic_response_compound->pki_ezsigntemplatepublic_id) {
        free(ezsigntemplatepublic_response_compound->pki_ezsigntemplatepublic_id);
        ezsigntemplatepublic_response_compound->pki_ezsigntemplatepublic_id = NULL;
    }
    if (ezsigntemplatepublic_response_compound->fki_ezsignfoldertype_id) {
        free(ezsigntemplatepublic_response_compound->fki_ezsignfoldertype_id);
        ezsigntemplatepublic_response_compound->fki_ezsignfoldertype_id = NULL;
    }
    ...
    if (ezsigntemplatepublic_response_compound->fki_userlogintype_id) {
        free(ezsigntemplatepublic_response_compound->fki_userlogintype_id);
        ezsigntemplatepublic_response_compound->fki_userlogintype_id = NULL;
    }
    ...
    if (ezsigntemplatepublic_response_compound->fki_ezsigntemplate_id) {
        free(ezsigntemplatepublic_response_compound->fki_ezsigntemplate_id);
        ezsigntemplatepublic_response_compound->fki_ezsigntemplate_id = NULL;
    }
    if (ezsigntemplatepublic_response_compound->fki_ezsigntemplatepackage_id) {
        free(ezsigntemplatepublic_response_compound->fki_ezsigntemplatepackage_id);
        ezsigntemplatepublic_response_compound->fki_ezsigntemplatepackage_id = NULL;
    }
    ...
    if (ezsigntemplatepublic_response_compound->b_ezsigntemplatepublic_isactive) {
        free(ezsigntemplatepublic_response_compound->b_ezsigntemplatepublic_isactive);
        ezsigntemplatepublic_response_compound->b_ezsigntemplatepublic_isactive = NULL;
    }
    ...
    if (ezsigntemplatepublic_response_compound->i_ezsigntemplatepublic_limit) {
        free(ezsigntemplatepublic_response_compound->i_ezsigntemplatepublic_limit);
        ezsigntemplatepublic_response_compound->i_ezsigntemplatepublic_limit = NULL;
    }
    if (ezsigntemplatepublic_response_compound->i_ezsigntemplatepublic_limitexceeded) {
        free(ezsigntemplatepublic_response_compound->i_ezsigntemplatepublic_limitexceeded);
        ezsigntemplatepublic_response_compound->i_ezsigntemplatepublic_limitexceeded = NULL;
    }
...
ezsigntemplatepublic_response_compound_t *ezsigntemplatepublic_response_compound_parseFromJSON(cJSON *ezsigntemplatepublic_response_compoundJSON){
    ...
    // define the local variable for ezsigntemplatepublic_response_compound->pki_ezsigntemplatepublic_id
    int *pki_ezsigntemplatepublic_id_local_var = NULL;

    // define the local variable for ezsigntemplatepublic_response_compound->fki_ezsignfoldertype_id
    int *fki_ezsignfoldertype_id_local_var = NULL;

    char *s_ezsignfoldertype_name_x_local_str = NULL;

    // define the local variable for ezsigntemplatepublic_response_compound->fki_userlogintype_id
    int *fki_userlogintype_id_local_var = NULL;

    char *s_userlogintype_description_x_local_str = NULL;

    // define the local variable for ezsigntemplatepublic_response_compound->fki_ezsigntemplate_id
    int *fki_ezsigntemplate_id_local_var = NULL;

    // define the local variable for ezsigntemplatepublic_response_compound->fki_ezsigntemplatepackage_id
    ...
    // define the local variable for ezsigntemplatepublic_response_compound->b_ezsigntemplatepublic_isactive
    ...
    // define the local variable for ezsigntemplatepublic_response_compound->i_ezsigntemplatepublic_limit
    int *i_ezsigntemplatepublic_limit_local_var = NULL;

    // define the local variable for ezsigntemplatepublic_response_compound->i_ezsigntemplatepublic_limitexceeded
