...
cJSON *field_e_ezsignannotation_type_convertToJSON(ezmax_api_definition__full_field_e_ezsignannotation_type__e field_e_ezsignannotation_type) {
...
ezmax_api_definition__full_field_e_ezsignannotation_type__e field_e_ezsignannotation_type_parseFromJSON(cJSON *field_e_ezsignannotation_typeJSON) {
    if(!cJSON_IsString(field_e_ezsignannotation_typeJSON) || (field_e_ezsignannotation_typeJSON->valuestring == NULL)) {
        return 0;
    }
    return field_e_ezsignannotation_type_field_e_ezsignannotation_type_FromString(field_e_ezsignannotation_typeJSON->valuestring);
}
