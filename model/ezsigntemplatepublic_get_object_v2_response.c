...
static ezsigntemplatepublic_get_object_v2_response_t *ezsigntemplatepublic_get_object_v2_response_create_internal(
    ...
    memset(ezsigntemplatepublic_get_object_v2_response_local_var, 0, sizeof(ezsigntemplatepublic_get_object_v2_response_t));
    ezsigntemplatepublic_get_object_v2_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezsigntemplatepublic_get_object_v2_response_t *ezsigntemplatepublic_get_object_v2_response_create(
    ...
    ezsigntemplatepublic_get_object_v2_response_t *result = ezsigntemplatepublic_get_object_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void ezsigntemplatepublic_get_object_v2_response_free(ezsigntemplatepublic_get_object_v2_response_t *ezsigntemplatepublic_get_object_v2_response) {
    ...
    if(ezsigntemplatepublic_get_object_v2_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsigntemplatepublic_get_object_v2_response_free");
        return ;
    }
...
ezsigntemplatepublic_get_object_v2_response_t *ezsigntemplatepublic_get_object_v2_response_parseFromJSON(cJSON *ezsigntemplatepublic_get_object_v2_responseJSON){
    ...
    ezsigntemplatepublic_get_object_v2_response_local_var = ezsigntemplatepublic_get_object_v2_response_create_internal (
