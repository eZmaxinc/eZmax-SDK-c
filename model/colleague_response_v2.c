...
char* colleague_response_v2_e_colleague_ezsign_ToString(ezmax_api_definition__full_colleague_response_v2__e e_colleague_ezsign) {
    char* e_colleague_ezsignArray[] =  { "NULL", "No", "Read", "Modify", "Full" };
    return e_colleague_ezsignArray[e_colleague_ezsign];
}

ezmax_api_definition__full_colleague_response_v2__e colleague_response_v2_e_colleague_ezsign_FromString(char* e_colleague_ezsign){
...
char* colleague_response_v2_e_colleague_realestateinprogress_ToString(ezmax_api_definition__full_colleague_response_v2__e e_colleague_realestateinprogress) {
...
ezmax_api_definition__full_colleague_response_v2__e colleague_response_v2_e_colleague_realestateinprogress_FromString(char* e_colleague_realestateinprogress){
    int stringToReturn = 0;
    char *e_colleague_realestateinprogressArray[] =  { "NULL", "No", "Read", "Modify", "Create" };
...
colleague_response_v2_t *colleague_response_v2_create(
    ...
    colleague_response_v2_t *colleague_response_v2_local_var = malloc(sizeof(colleague_response_v2_t));
    ...
    colleague_response_v2_local_var->b_colleague_ezsignemail = b_colleague_ezsignemail;
    colleague_response_v2_local_var->b_colleague_financial = b_colleague_financial;
    colleague_response_v2_local_var->b_colleague_usecloneemail = b_colleague_usecloneemail;
    colleague_response_v2_local_var->b_colleague_attachment = b_colleague_attachment;
    colleague_response_v2_local_var->b_colleague_canafe = b_colleague_canafe;
    colleague_response_v2_local_var->b_colleague_permission = b_colleague_permission;
    colleague_response_v2_local_var->b_colleague_realestatecompleted = b_colleague_realestatecompleted;
    colleague_response_v2_local_var->dt_colleague_from = dt_colleague_from;
    colleague_response_v2_local_var->dt_colleague_to = dt_colleague_to;
    colleague_response_v2_local_var->e_colleague_ezsign = e_colleague_ezsign;
...
void colleague_response_v2_free(colleague_response_v2_t *colleague_response_v2) {
    ...
    if (colleague_response_v2->dt_colleague_to) {
        free(colleague_response_v2->dt_colleague_to);
        colleague_response_v2->dt_colleague_to = NULL;
    }
    if (colleague_response_v2->e_colleague_ezsign) {
        field_e_colleague_ezsign_free(colleague_response_v2->e_colleague_ezsign);
        colleague_response_v2->e_colleague_ezsign = NULL;
    }
    if (colleague_response_v2->e_colleague_realestateinprogress) {
        field_e_colleague_realestateinprogess_free(colleague_response_v2->e_colleague_realestateinprogress);
        colleague_response_v2->e_colleague_realestateinprogress = NULL;
    }
    if (colleague_response_v2->obj_user_name) {
        custom_user_name_response_free(colleague_response_v2->obj_user_name);
        colleague_response_v2->obj_user_name = NULL;
    }
    if (colleague_response_v2->obj_audit) {
        common_audit_free(colleague_response_v2->obj_audit);
        colleague_response_v2->obj_audit = NULL;
    }
    free(colleague_response_v2);
}

cJSON *colleague_response_v2_convertToJSON(colleague_response_v2_t *colleague_response_v2) {
    cJSON *item = cJSON_CreateObject();

    // colleague_response_v2->pki_colleague_id
    ...
    if(colleague_response_v2->dt_colleague_from) {
    if(cJSON_AddStringToObject(item, "dtColleagueFrom", colleague_response_v2->dt_colleague_from) == NULL) {
    goto fail; //String
    }
    }


    // colleague_response_v2->dt_colleague_to
    if(colleague_response_v2->dt_colleague_to) {
    if(cJSON_AddStringToObject(item, "dtColleagueTo", colleague_response_v2->dt_colleague_to) == NULL) {
    goto fail; //String
    }
    }


    // colleague_response_v2->e_colleague_ezsign
    if (ezmax_api_definition__full_colleague_response_v2__NULL == colleague_response_v2->e_colleague_ezsign) {
        goto fail;
    }
    cJSON *e_colleague_ezsign_local_JSON = field_e_colleague_ezsign_convertToJSON(colleague_response_v2->e_colleague_ezsign);
    ...
    // colleague_response_v2->e_colleague_realestateinprogress
    if (ezmax_api_definition__full_colleague_response_v2__NULL == colleague_response_v2->e_colleague_realestateinprogress) {
        goto fail;
    }
    cJSON *e_colleague_realestateinprogress_local_JSON = field_e_colleague_realestateinprogess_convertToJSON(colleague_response_v2->e_colleague_realestateinprogress);
    ...
    // colleague_response_v2->obj_user_name
    if (!colleague_response_v2->obj_user_name) {
        goto fail;
    }
    cJSON *obj_user_name_local_JSON = custom_user_name_response_convertToJSON(colleague_response_v2->obj_user_name);
    ...
    // colleague_response_v2->obj_audit
    if (!colleague_response_v2->obj_audit) {
        goto fail;
    }
    cJSON *obj_audit_local_JSON = common_audit_convertToJSON(colleague_response_v2->obj_audit);
...
colleague_response_v2_t *colleague_response_v2_parseFromJSON(cJSON *colleague_response_v2JSON){
    ...
    // define the local variable for colleague_response_v2->e_colleague_realestateinprogress
    field_e_colleague_realestateinprogess_t *e_colleague_realestateinprogress_local_nonprim = NULL;

    // define the local variable for colleague_response_v2->obj_user_name
    custom_user_name_response_t *obj_user_name_local_nonprim = NULL;

    // define the local variable for colleague_response_v2->obj_audit
    common_audit_t *obj_audit_local_nonprim = NULL;

    // colleague_response_v2->pki_colleague_id
    cJSON *pki_colleague_id = cJSON_GetObjectItemCaseSensitive(colleague_response_v2JSON, "pkiColleagueID");
    if (!pki_colleague_id) {
        goto end;
    }
    ...
    // colleague_response_v2->dt_colleague_to
    cJSON *dt_colleague_to = cJSON_GetObjectItemCaseSensitive(colleague_response_v2JSON, "dtColleagueTo");
    if (dt_colleague_to) { 
    ...
    // colleague_response_v2->e_colleague_ezsign
    cJSON *e_colleague_ezsign = cJSON_GetObjectItemCaseSensitive(colleague_response_v2JSON, "eColleagueEzsign");
    ...
    // colleague_response_v2->e_colleague_realestateinprogress
    cJSON *e_colleague_realestateinprogress = cJSON_GetObjectItemCaseSensitive(colleague_response_v2JSON, "eColleagueRealestateinprogress");
    ...
    // colleague_response_v2->obj_user_name
    cJSON *obj_user_name = cJSON_GetObjectItemCaseSensitive(colleague_response_v2JSON, "objUserName");
    if (!obj_user_name) {
        goto end;
    }
    ...
    // colleague_response_v2->obj_audit
    cJSON *obj_audit = cJSON_GetObjectItemCaseSensitive(colleague_response_v2JSON, "objAudit");
    if (!obj_audit) {
        goto end;
    }
    ...
    colleague_response_v2_local_var = colleague_response_v2_create (
