...
void colleague_response_v2_free(colleague_response_v2_t *colleague_response_v2) {
    ...
    if(colleague_response_v2->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "colleague_response_v2_free");
        return ;
    }
...
cJSON *colleague_response_v2_convertToJSON(colleague_response_v2_t *colleague_response_v2) {
    ...
    if (ezmax_api_definition__full_field_e_colleague_ezsign__NULL == colleague_response_v2->e_colleague_ezsign) {
        goto fail;
    }
    ...
    if (ezmax_api_definition__full_field_e_colleague_realestateinprogess__NULL == colleague_response_v2->e_colleague_realestateinprogress) {
        goto fail;
    }
