...
static usergroupexternal_delete_object_v1_response_t *usergroupexternal_delete_object_v1_response_create_internal(
    ...
    memset(usergroupexternal_delete_object_v1_response_local_var, 0, sizeof(usergroupexternal_delete_object_v1_response_t));
...
__attribute__((deprecated)) usergroupexternal_delete_object_v1_response_t *usergroupexternal_delete_object_v1_response_create(
    ...
    usergroupexternal_delete_object_v1_response_t *result = usergroupexternal_delete_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug
        );
    if (!result) {
