...
static supply_create_object_v1_response_t *supply_create_object_v1_response_create_internal(
    ...
    memset(supply_create_object_v1_response_local_var, 0, sizeof(supply_create_object_v1_response_t));
    supply_create_object_v1_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) supply_create_object_v1_response_t *supply_create_object_v1_response_create(
    ...
    supply_create_object_v1_response_t *result = supply_create_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void supply_create_object_v1_response_free(supply_create_object_v1_response_t *supply_create_object_v1_response) {
    ...
    if(supply_create_object_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "supply_create_object_v1_response_free");
        return ;
    }
...
supply_create_object_v1_response_t *supply_create_object_v1_response_parseFromJSON(cJSON *supply_create_object_v1_responseJSON){
    ...
    supply_create_object_v1_response_local_var = supply_create_object_v1_response_create_internal (
