/*
 * ezsignfoldersignerassociation_create_embedded_url_v2_request.h
 *
 * Request for POST /2/object/ezsignfoldersignerassociation/createEmbeddedUrl
 */

#ifndef _ezsignfoldersignerassociation_create_embedded_url_v2_request_H_
#define _ezsignfoldersignerassociation_create_embedded_url_v2_request_H_
...
typedef struct ezsignfoldersignerassociation_create_embedded_url_v2_request_t ezsignfoldersignerassociation_create_embedded_url_v2_request_t;




typedef struct ezsignfoldersignerassociation_create_embedded_url_v2_request_t {
    char *s_return_url; // string
    char *s_iframe_origin; // string

    int _library_owned; // Is the library responsible for freeing this object?
} ezsignfoldersignerassociation_create_embedded_url_v2_request_t;
...
#endif /* _ezsignfoldersignerassociation_create_embedded_url_v2_request_H_ */
