...
static ezsigndocumentlog_response_compound_t *ezsigndocumentlog_response_compound_create_internal(
    ...
    memset(ezsigndocumentlog_response_compound_local_var, 0, sizeof(ezsigndocumentlog_response_compound_t));
...
__attribute__((deprecated)) ezsigndocumentlog_response_compound_t *ezsigndocumentlog_response_compound_create(
    ...
    ezsigndocumentlog_response_compound_t *result = ezsigndocumentlog_response_compound_create_internal (
        fki_user_id_copy,
...
void ezsigndocumentlog_response_compound_free(ezsigndocumentlog_response_compound_t *ezsigndocumentlog_response_compound) {
    ...
    if (ezsigndocumentlog_response_compound->fki_user_id) {
        free(ezsigndocumentlog_response_compound->fki_user_id);
        ezsigndocumentlog_response_compound->fki_user_id = NULL;
    }
    if (ezsigndocumentlog_response_compound->fki_ezsignsigner_id) {
        free(ezsigndocumentlog_response_compound->fki_ezsignsigner_id);
        ezsigndocumentlog_response_compound->fki_ezsignsigner_id = NULL;
    }
...
ezsigndocumentlog_response_compound_t *ezsigndocumentlog_response_compound_parseFromJSON(cJSON *ezsigndocumentlog_response_compoundJSON){
    ...
    // define the local variable for ezsigndocumentlog_response_compound->fki_user_id
    int *fki_user_id_local_var = NULL;

    // define the local variable for ezsigndocumentlog_response_compound->fki_ezsignsigner_id
