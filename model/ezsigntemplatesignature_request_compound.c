...
static ezsigntemplatesignature_request_compound_t *ezsigntemplatesignature_request_compound_create_internal(
    ...
    memset(ezsigntemplatesignature_request_compound_local_var, 0, sizeof(ezsigntemplatesignature_request_compound_t));
    ezsigntemplatesignature_request_compound_local_var->_library_owned = 1;
    ...
    ezsigntemplatesignature_request_compound_local_var->e_ezsigntemplatesignature_signaturepad = e_ezsigntemplatesignature_signaturepad;
    ezsigntemplatesignature_request_compound_local_var->e_ezsigntemplatesignature_signaturepadrequired = e_ezsigntemplatesignature_signaturepadrequired;
    ezsigntemplatesignature_request_compound_local_var->e_ezsigntemplatesignature_consultationtrigger = e_ezsigntemplatesignature_consultationtrigger;
    ...
    ezsigntemplatesignature_request_compound_local_var->s_ezsigntemplatesignature_defaultvalue = s_ezsigntemplatesignature_defaultvalue;
    ...
    ezsigntemplatesignature_request_compound_local_var->s_ezsigntemplatesignature_textvalidationcustommessage = s_ezsigntemplatesignature_textvalidationcustommessage;
    ...
    ezsigntemplatesignature_request_compound_local_var->s_ezsigntemplatesignature_positioningpattern = s_ezsigntemplatesignature_positioningpattern;
    ezsigntemplatesignature_request_compound_local_var->i_ezsigntemplatesignature_positioningoffsetx = i_ezsigntemplatesignature_positioningoffsetx;
    ezsigntemplatesignature_request_compound_local_var->i_ezsigntemplatesignature_positioningoffsety = i_ezsigntemplatesignature_positioningoffsety;
    ezsigntemplatesignature_request_compound_local_var->e_ezsigntemplatesignature_positioningoccurence = e_ezsigntemplatesignature_positioningoccurence;
    ezsigntemplatesignature_request_compound_local_var->s_ezsigntemplatesignature_creditcardamountdescription = s_ezsigntemplatesignature_creditcardamountdescription;
    ezsigntemplatesignature_request_compound_local_var->d_ezsigntemplatesignature_creditcardamount = d_ezsigntemplatesignature_creditcardamount;
    ...
    ezsigntemplatesignature_request_compound_local_var->a_obj_ezsigntemplatesignaturepaymentdetail = a_obj_ezsigntemplatesignaturepaymentdetail;
    return ezsigntemplatesignature_request_compound_local_var;
}

__attribute__((deprecated)) ezsigntemplatesignature_request_compound_t *ezsigntemplatesignature_request_compound_create(
    int *pki_ezsigntemplatesignature_id,
    int *fki_ezsigntemplatedocument_id,
    int *fki_ezsigntemplatesigner_id,
    int *fki_ezsigntemplatesigner_id_validation,
    ...
    ezsigntemplatesignature_request_compound_t *result = ezsigntemplatesignature_request_compound_create_internal (
...
void ezsigntemplatesignature_request_compound_free(ezsigntemplatesignature_request_compound_t *ezsigntemplatesignature_request_compound) {
    ...
    if(ezsigntemplatesignature_request_compound->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsigntemplatesignature_request_compound_free");
        return ;
    }
    listEntry_t *listEntry;
    if (ezsigntemplatesignature_request_compound->pki_ezsigntemplatesignature_id) {
        free(ezsigntemplatesignature_request_compound->pki_ezsigntemplatesignature_id);
        ezsigntemplatesignature_request_compound->pki_ezsigntemplatesignature_id = NULL;
    }
    if (ezsigntemplatesignature_request_compound->fki_ezsigntemplatedocument_id) {
        free(ezsigntemplatesignature_request_compound->fki_ezsigntemplatedocument_id);
        ezsigntemplatesignature_request_compound->fki_ezsigntemplatedocument_id = NULL;
    }
    if (ezsigntemplatesignature_request_compound->fki_ezsigntemplatesigner_id) {
        free(ezsigntemplatesignature_request_compound->fki_ezsigntemplatesigner_id);
        ezsigntemplatesignature_request_compound->fki_ezsigntemplatesigner_id = NULL;
    }
    if (ezsigntemplatesignature_request_compound->fki_ezsigntemplatesigner_id_validation) {
        free(ezsigntemplatesignature_request_compound->fki_ezsigntemplatesigner_id_validation);
        ezsigntemplatesignature_request_compound->fki_ezsigntemplatesigner_id_validation = NULL;
    }
    if (ezsigntemplatesignature_request_compound->fki_paymentgateway_id) {
        free(ezsigntemplatesignature_request_compound->fki_paymentgateway_id);
        ezsigntemplatesignature_request_compound->fki_paymentgateway_id = NULL;
    }
    if (ezsigntemplatesignature_request_compound->b_ezsigntemplatesignature_handwritten) {
        free(ezsigntemplatesignature_request_compound->b_ezsigntemplatesignature_handwritten);
        ezsigntemplatesignature_request_compound->b_ezsigntemplatesignature_handwritten = NULL;
    }
    ...
    if (ezsigntemplatesignature_request_compound->i_ezsigntemplatedocumentpage_pagenumber) {
        ...
        ezsigntemplatesignature_request_compound->i_ezsigntemplatedocumentpage_pagenumber = NULL;
    }
    if (ezsigntemplatesignature_request_compound->i_ezsigntemplatesignature_x) {
        free(ezsigntemplatesignature_request_compound->i_ezsigntemplatesignature_x);
        ezsigntemplatesignature_request_compound->i_ezsigntemplatesignature_x = NULL;
    }
    if (ezsigntemplatesignature_request_compound->i_ezsigntemplatesignature_y) {
        free(ezsigntemplatesignature_request_compound->i_ezsigntemplatesignature_y);
        ezsigntemplatesignature_request_compound->i_ezsigntemplatesignature_y = NULL;
    }
    if (ezsigntemplatesignature_request_compound->i_ezsigntemplatesignature_width) {
        free(ezsigntemplatesignature_request_compound->i_ezsigntemplatesignature_width);
        ezsigntemplatesignature_request_compound->i_ezsigntemplatesignature_width = NULL;
    }
    if (ezsigntemplatesignature_request_compound->i_ezsigntemplatesignature_height) {
        free(ezsigntemplatesignature_request_compound->i_ezsigntemplatesignature_height);
        ezsigntemplatesignature_request_compound->i_ezsigntemplatesignature_height = NULL;
    }
    if (ezsigntemplatesignature_request_compound->i_ezsigntemplatesignature_step) {
        free(ezsigntemplatesignature_request_compound->i_ezsigntemplatesignature_step);
        ezsigntemplatesignature_request_compound->i_ezsigntemplatesignature_step = NULL;
    }
    ...
    if (ezsigntemplatesignature_request_compound->b_ezsigntemplatesignature_required) {
        free(ezsigntemplatesignature_request_compound->b_ezsigntemplatesignature_required);
        ezsigntemplatesignature_request_compound->b_ezsigntemplatesignature_required = NULL;
    }
    ...
    if (ezsigntemplatesignature_request_compound->i_ezsigntemplatesignature_validationstep) {
        free(ezsigntemplatesignature_request_compound->i_ezsigntemplatesignature_validationstep);
        ezsigntemplatesignature_request_compound->i_ezsigntemplatesignature_validationstep = NULL;
    }
    if (ezsigntemplatesignature_request_compound->i_ezsigntemplatesignature_maxlength) {
        free(ezsigntemplatesignature_request_compound->i_ezsigntemplatesignature_maxlength);
        ezsigntemplatesignature_request_compound->i_ezsigntemplatesignature_maxlength = NULL;
    }
    if (ezsigntemplatesignature_request_compound->s_ezsigntemplatesignature_defaultvalue) {
        free(ezsigntemplatesignature_request_compound->s_ezsigntemplatesignature_defaultvalue);
        ezsigntemplatesignature_request_compound->s_ezsigntemplatesignature_defaultvalue = NULL;
    }
    ...
    if (ezsigntemplatesignature_request_compound->s_ezsigntemplatesignature_textvalidationcustommessage) {
        free(ezsigntemplatesignature_request_compound->s_ezsigntemplatesignature_textvalidationcustommessage);
        ezsigntemplatesignature_request_compound->s_ezsigntemplatesignature_textvalidationcustommessage = NULL;
    }
    if (ezsigntemplatesignature_request_compound->s_ezsigntemplatesignature_positioningpattern) {
        free(ezsigntemplatesignature_request_compound->s_ezsigntemplatesignature_positioningpattern);
        ezsigntemplatesignature_request_compound->s_ezsigntemplatesignature_positioningpattern = NULL;
    }
    if (ezsigntemplatesignature_request_compound->i_ezsigntemplatesignature_positioningoffsetx) {
        free(ezsigntemplatesignature_request_compound->i_ezsigntemplatesignature_positioningoffsetx);
        ezsigntemplatesignature_request_compound->i_ezsigntemplatesignature_positioningoffsetx = NULL;
    }
    if (ezsigntemplatesignature_request_compound->i_ezsigntemplatesignature_positioningoffsety) {
        free(ezsigntemplatesignature_request_compound->i_ezsigntemplatesignature_positioningoffsety);
        ezsigntemplatesignature_request_compound->i_ezsigntemplatesignature_positioningoffsety = NULL;
    }
    if (ezsigntemplatesignature_request_compound->s_ezsigntemplatesignature_creditcardamountdescription) {
        free(ezsigntemplatesignature_request_compound->s_ezsigntemplatesignature_creditcardamountdescription);
        ezsigntemplatesignature_request_compound->s_ezsigntemplatesignature_creditcardamountdescription = NULL;
    }
    if (ezsigntemplatesignature_request_compound->d_ezsigntemplatesignature_creditcardamount) {
        free(ezsigntemplatesignature_request_compound->d_ezsigntemplatesignature_creditcardamount);
        ezsigntemplatesignature_request_compound->d_ezsigntemplatesignature_creditcardamount = NULL;
    }
    if (ezsigntemplatesignature_request_compound->b_ezsigntemplatesignature_customdate) {
        free(ezsigntemplatesignature_request_compound->b_ezsigntemplatesignature_customdate);
        ezsigntemplatesignature_request_compound->b_ezsigntemplatesignature_customdate = NULL;
    }
    ...
    if (ezsigntemplatesignature_request_compound->a_obj_ezsigntemplatesignaturepaymentdetail) {
        list_ForEach(listEntry, ezsigntemplatesignature_request_compound->a_obj_ezsigntemplatesignaturepaymentdetail) {
            ezsigntemplatesignaturepaymentdetail_request_compound_free(listEntry->data);
        }
        list_freeList(ezsigntemplatesignature_request_compound->a_obj_ezsigntemplatesignaturepaymentdetail);
        ezsigntemplatesignature_request_compound->a_obj_ezsigntemplatesignaturepaymentdetail = NULL;
    }
...
cJSON *ezsigntemplatesignature_request_compound_convertToJSON(ezsigntemplatesignature_request_compound_t *ezsigntemplatesignature_request_compound) {
    ...
    // ezsigntemplatesignature_request_compound->fki_paymentgateway_id
    if(ezsigntemplatesignature_request_compound->fki_paymentgateway_id) {
    if(cJSON_AddNumberToObject(item, "fkiPaymentgatewayID", *ezsigntemplatesignature_request_compound->fki_paymentgateway_id) == NULL) {
    goto fail; //Numeric
    }
    }


    // ezsigntemplatesignature_request_compound->b_ezsigntemplatesignature_handwritten
    if(ezsigntemplatesignature_request_compound->b_ezsigntemplatesignature_handwritten) {
    if(cJSON_AddBoolToObject(item, "bEzsigntemplatesignatureHandwritten", *ezsigntemplatesignature_request_compound->b_ezsigntemplatesignature_handwritten) == NULL) {
    goto fail; //Bool
    }
    }
    ...
    if(ezsigntemplatesignature_request_compound->e_ezsigntemplatesignature_positioning != ezmax_api_definition__full_field_e_ezsigntemplatesignature_positioning__NULL) {
    cJSON *e_ezsigntemplatesignature_positioning_local_JSON = field_e_ezsigntemplatesignature_positioning_convertToJSON(ezsigntemplatesignature_request_compound->e_ezsigntemplatesignature_positioning);
    ...
    if (ezmax_api_definition__full_field_e_ezsigntemplatesignature_type__NULL == ezsigntemplatesignature_request_compound->e_ezsigntemplatesignature_type) {
        goto fail;
    }
    ...
    // ezsigntemplatesignature_request_compound->e_ezsigntemplatesignature_signaturepad
    if(ezsigntemplatesignature_request_compound->e_ezsigntemplatesignature_signaturepad != ezmax_api_definition__full_field_e_ezsigntemplatesignature_signaturepad__NULL) {
    cJSON *e_ezsigntemplatesignature_signaturepad_local_JSON = field_e_ezsigntemplatesignature_signaturepad_convertToJSON(ezsigntemplatesignature_request_compound->e_ezsigntemplatesignature_signaturepad);
    ...
    // ezsigntemplatesignature_request_compound->e_ezsigntemplatesignature_signaturepadrequired
    if(ezsigntemplatesignature_request_compound->e_ezsigntemplatesignature_signaturepadrequired != ezmax_api_definition__full_field_e_ezsigntemplatesignature_signaturepadrequired__NULL) {
    cJSON *e_ezsigntemplatesignature_signaturepadrequired_local_JSON = field_e_ezsigntemplatesignature_signaturepadrequired_convertToJSON(ezsigntemplatesignature_request_compound->e_ezsigntemplatesignature_signaturepadrequired);
    ...
    // ezsigntemplatesignature_request_compound->e_ezsigntemplatesignature_consultationtrigger
    if(ezsigntemplatesignature_request_compound->e_ezsigntemplatesignature_consultationtrigger != ezmax_api_definition__full_field_e_ezsigntemplatesignature_consultationtrigger__NULL) {
    cJSON *e_ezsigntemplatesignature_consultationtrigger_local_JSON = field_e_ezsigntemplatesignature_consultationtrigger_convertToJSON(ezsigntemplatesignature_request_compound->e_ezsigntemplatesignature_consultationtrigger);
    ...
    if(ezsigntemplatesignature_request_compound->e_ezsigntemplatesignature_tooltipposition != ezmax_api_definition__full_field_e_ezsigntemplatesignature_tooltipposition__NULL) {
    ...
    if(ezsigntemplatesignature_request_compound->e_ezsigntemplatesignature_font != ezmax_api_definition__full_field_e_ezsigntemplatesignature_font__NULL) {
    ...
    if(ezsigntemplatesignature_request_compound->e_ezsigntemplatesignature_attachmentnamesource != ezmax_api_definition__full_field_e_ezsigntemplatesignature_attachmentnamesource__NULL) {
    ...
    // ezsigntemplatesignature_request_compound->s_ezsigntemplatesignature_defaultvalue
    if(ezsigntemplatesignature_request_compound->s_ezsigntemplatesignature_defaultvalue) {
    if(cJSON_AddStringToObject(item, "sEzsigntemplatesignatureDefaultvalue", ezsigntemplatesignature_request_compound->s_ezsigntemplatesignature_defaultvalue) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(ezsigntemplatesignature_request_compound->e_ezsigntemplatesignature_textvalidation != ezmax_api_definition__full_enum_textvalidation__NULL) {
    ...
    // ezsigntemplatesignature_request_compound->s_ezsigntemplatesignature_textvalidationcustommessage
    if(ezsigntemplatesignature_request_compound->s_ezsigntemplatesignature_textvalidationcustommessage) {
    if(cJSON_AddStringToObject(item, "sEzsigntemplatesignatureTextvalidationcustommessage", ezsigntemplatesignature_request_compound->s_ezsigntemplatesignature_textvalidationcustommessage) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(ezsigntemplatesignature_request_compound->e_ezsigntemplatesignature_dependencyrequirement != ezmax_api_definition__full_field_e_ezsigntemplatesignature_dependencyrequirement__NULL) {
    ...
    // ezsigntemplatesignature_request_compound->s_ezsigntemplatesignature_positioningpattern
    if(ezsigntemplatesignature_request_compound->s_ezsigntemplatesignature_positioningpattern) {
    if(cJSON_AddStringToObject(item, "sEzsigntemplatesignaturePositioningpattern", ezsigntemplatesignature_request_compound->s_ezsigntemplatesignature_positioningpattern) == NULL) {
    goto fail; //String
    }
    }


    // ezsigntemplatesignature_request_compound->i_ezsigntemplatesignature_positioningoffsetx
    if(ezsigntemplatesignature_request_compound->i_ezsigntemplatesignature_positioningoffsetx) {
    if(cJSON_AddNumberToObject(item, "iEzsigntemplatesignaturePositioningoffsetx", *ezsigntemplatesignature_request_compound->i_ezsigntemplatesignature_positioningoffsetx) == NULL) {
    goto fail; //Numeric
    }
    }


    // ezsigntemplatesignature_request_compound->i_ezsigntemplatesignature_positioningoffsety
    if(ezsigntemplatesignature_request_compound->i_ezsigntemplatesignature_positioningoffsety) {
    if(cJSON_AddNumberToObject(item, "iEzsigntemplatesignaturePositioningoffsety", *ezsigntemplatesignature_request_compound->i_ezsigntemplatesignature_positioningoffsety) == NULL) {
    goto fail; //Numeric
    }
    }


    // ezsigntemplatesignature_request_compound->e_ezsigntemplatesignature_positioningoccurence
    if(ezsigntemplatesignature_request_compound->e_ezsigntemplatesignature_positioningoccurence != ezmax_api_definition__full_field_e_ezsigntemplatesignature_positioningoccurence__NULL) {
    cJSON *e_ezsigntemplatesignature_positioningoccurence_local_JSON = field_e_ezsigntemplatesignature_positioningoccurence_convertToJSON(ezsigntemplatesignature_request_compound->e_ezsigntemplatesignature_positioningoccurence);
    ...
    // ezsigntemplatesignature_request_compound->s_ezsigntemplatesignature_creditcardamountdescription
    if(ezsigntemplatesignature_request_compound->s_ezsigntemplatesignature_creditcardamountdescription) {
    if(cJSON_AddStringToObject(item, "sEzsigntemplatesignatureCreditcardamountdescription", ezsigntemplatesignature_request_compound->s_ezsigntemplatesignature_creditcardamountdescription) == NULL) {
    goto fail; //String
    }
    }


    // ezsigntemplatesignature_request_compound->d_ezsigntemplatesignature_creditcardamount
    if(ezsigntemplatesignature_request_compound->d_ezsigntemplatesignature_creditcardamount) {
    if(cJSON_AddStringToObject(item, "dEzsigntemplatesignatureCreditcardamount", ezsigntemplatesignature_request_compound->d_ezsigntemplatesignature_creditcardamount) == NULL) {
    goto fail; //String
    }
    }
    ...
    // ezsigntemplatesignature_request_compound->a_obj_ezsigntemplatesignaturepaymentdetail
    if(ezsigntemplatesignature_request_compound->a_obj_ezsigntemplatesignaturepaymentdetail) {
    ...
    if (ezsigntemplatesignature_request_compound->a_obj_ezsigntemplatesignaturepaymentdetail) {
    list_ForEach(a_obj_ezsigntemplatesignaturepaymentdetailListEntry, ezsigntemplatesignature_request_compound->a_obj_ezsigntemplatesignaturepaymentdetail) {
    cJSON *itemLocal = ezsigntemplatesignaturepaymentdetail_request_compound_convertToJSON(a_obj_ezsigntemplatesignaturepaymentdetailListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
...
ezsigntemplatesignature_request_compound_t *ezsigntemplatesignature_request_compound_parseFromJSON(cJSON *ezsigntemplatesignature_request_compoundJSON){
    ...
    // define the local variable for ezsigntemplatesignature_request_compound->pki_ezsigntemplatesignature_id
    int *pki_ezsigntemplatesignature_id_local_var = NULL;

    // define the local variable for ezsigntemplatesignature_request_compound->fki_ezsigntemplatedocument_id
    int *fki_ezsigntemplatedocument_id_local_var = NULL;

    // define the local variable for ezsigntemplatesignature_request_compound->fki_ezsigntemplatesigner_id
    int *fki_ezsigntemplatesigner_id_local_var = NULL;

    // define the local variable for ezsigntemplatesignature_request_compound->fki_ezsigntemplatesigner_id_validation
    int *fki_ezsigntemplatesigner_id_validation_local_var = NULL;

    // define the local variable for ezsigntemplatesignature_request_compound->fki_paymentgateway_id
    int *fki_paymentgateway_id_local_var = NULL;

    // define the local variable for ezsigntemplatesignature_request_compound->b_ezsigntemplatesignature_handwritten
    ...
    // define the local variable for ezsigntemplatesignature_request_compound->i_ezsigntemplatedocumentpage_pagenumber
    int *i_ezsigntemplatedocumentpage_pagenumber_local_var = NULL;

    // define the local variable for ezsigntemplatesignature_request_compound->i_ezsigntemplatesignature_x
    int *i_ezsigntemplatesignature_x_local_var = NULL;

    // define the local variable for ezsigntemplatesignature_request_compound->i_ezsigntemplatesignature_y
    int *i_ezsigntemplatesignature_y_local_var = NULL;

    // define the local variable for ezsigntemplatesignature_request_compound->i_ezsigntemplatesignature_width
    int *i_ezsigntemplatesignature_width_local_var = NULL;

    // define the local variable for ezsigntemplatesignature_request_compound->i_ezsigntemplatesignature_height
    int *i_ezsigntemplatesignature_height_local_var = NULL;

    // define the local variable for ezsigntemplatesignature_request_compound->i_ezsigntemplatesignature_step
    ...
    // define the local variable for ezsigntemplatesignature_request_compound->e_ezsigntemplatesignature_signaturepad
    ...
    // define the local variable for ezsigntemplatesignature_request_compound->e_ezsigntemplatesignature_signaturepadrequired
    ...
    // define the local variable for ezsigntemplatesignature_request_compound->e_ezsigntemplatesignature_consultationtrigger
    ...
    // define the local variable for ezsigntemplatesignature_request_compound->b_ezsigntemplatesignature_required
    ...
    // define the local variable for ezsigntemplatesignature_request_compound->i_ezsigntemplatesignature_validationstep
    int *i_ezsigntemplatesignature_validationstep_local_var = NULL;

    // define the local variable for ezsigntemplatesignature_request_compound->i_ezsigntemplatesignature_maxlength
    ...
    // define the local variable for ezsigntemplatesignature_request_compound->i_ezsigntemplatesignature_positioningoffsetx
    int *i_ezsigntemplatesignature_positioningoffsetx_local_var = NULL;

    // define the local variable for ezsigntemplatesignature_request_compound->i_ezsigntemplatesignature_positioningoffsety
    int *i_ezsigntemplatesignature_positioningoffsety_local_var = NULL;

    // define the local variable for ezsigntemplatesignature_request_compound->e_ezsigntemplatesignature_positioningoccurence
    ...
    // define the local variable for ezsigntemplatesignature_request_compound->b_ezsigntemplatesignature_customdate
    ...
    // define the local list for ezsigntemplatesignature_request_compound->a_obj_ezsigntemplatesignaturepaymentdetail
    ...
    *fki_ezsigntemplatesigner_id_validation_local_var = fki_ezsigntemplatesigner_id_validation->valuedouble;
    ...
    // ezsigntemplatesignature_request_compound->fki_paymentgateway_id
    cJSON *fki_paymentgateway_id = cJSON_GetObjectItemCaseSensitive(ezsigntemplatesignature_request_compoundJSON, "fkiPaymentgatewayID");
    ...
    *fki_paymentgateway_id_local_var = fki_paymentgateway_id->valuedouble;
    ...
    // ezsigntemplatesignature_request_compound->b_ezsigntemplatesignature_handwritten
    cJSON *b_ezsigntemplatesignature_handwritten = cJSON_GetObjectItemCaseSensitive(ezsigntemplatesignature_request_compoundJSON, "bEzsigntemplatesignatureHandwritten");
    ...
    *b_ezsigntemplatesignature_handwritten_local_var = b_ezsigntemplatesignature_handwritten->valueint;
    ...
    // ezsigntemplatesignature_request_compound->b_ezsigntemplatesignature_reason
    cJSON *b_ezsigntemplatesignature_reason = cJSON_GetObjectItemCaseSensitive(ezsigntemplatesignature_request_compoundJSON, "bEzsigntemplatesignatureReason");
    ...
    *b_ezsigntemplatesignature_creditcardcustomamount_local_var = b_ezsigntemplatesignature_creditcardcustomamount->valueint;
    ...
    // ezsigntemplatesignature_request_compound->e_ezsigntemplatesignature_positioning
    cJSON *e_ezsigntemplatesignature_positioning = cJSON_GetObjectItemCaseSensitive(ezsigntemplatesignature_request_compoundJSON, "eEzsigntemplatesignaturePositioning");
    ...
    *i_ezsigntemplatesignature_step_local_var = i_ezsigntemplatesignature_step->valuedouble;
    ...
    // ezsigntemplatesignature_request_compound->e_ezsigntemplatesignature_signaturepad
    cJSON *e_ezsigntemplatesignature_signaturepad = cJSON_GetObjectItemCaseSensitive(ezsigntemplatesignature_request_compoundJSON, "eEzsigntemplatesignatureSignaturepad");
    ...
    // ezsigntemplatesignature_request_compound->e_ezsigntemplatesignature_signaturepadrequired
    cJSON *e_ezsigntemplatesignature_signaturepadrequired = cJSON_GetObjectItemCaseSensitive(ezsigntemplatesignature_request_compoundJSON, "eEzsigntemplatesignatureSignaturepadrequired");
    ...
    // ezsigntemplatesignature_request_compound->e_ezsigntemplatesignature_consultationtrigger
    cJSON *e_ezsigntemplatesignature_consultationtrigger = cJSON_GetObjectItemCaseSensitive(ezsigntemplatesignature_request_compoundJSON, "eEzsigntemplatesignatureConsultationtrigger");
    ...
    *i_ezsigntemplatesignature_maxlength_local_var = i_ezsigntemplatesignature_maxlength->valuedouble;
    ...
    // ezsigntemplatesignature_request_compound->s_ezsigntemplatesignature_defaultvalue
    cJSON *s_ezsigntemplatesignature_defaultvalue = cJSON_GetObjectItemCaseSensitive(ezsigntemplatesignature_request_compoundJSON, "sEzsigntemplatesignatureDefaultvalue");
    ...
    // ezsigntemplatesignature_request_compound->s_ezsigntemplatesignature_textvalidationcustommessage
    cJSON *s_ezsigntemplatesignature_textvalidationcustommessage = cJSON_GetObjectItemCaseSensitive(ezsigntemplatesignature_request_compoundJSON, "sEzsigntemplatesignatureTextvalidationcustommessage");
    ...
    // ezsigntemplatesignature_request_compound->s_ezsigntemplatesignature_positioningpattern
    cJSON *s_ezsigntemplatesignature_positioningpattern = cJSON_GetObjectItemCaseSensitive(ezsigntemplatesignature_request_compoundJSON, "sEzsigntemplatesignaturePositioningpattern");
    ...
    // ezsigntemplatesignature_request_compound->i_ezsigntemplatesignature_positioningoffsetx
    cJSON *i_ezsigntemplatesignature_positioningoffsetx = cJSON_GetObjectItemCaseSensitive(ezsigntemplatesignature_request_compoundJSON, "iEzsigntemplatesignaturePositioningoffsetx");
    ...
    *i_ezsigntemplatesignature_positioningoffsetx_local_var = i_ezsigntemplatesignature_positioningoffsetx->valuedouble;
    ...
    // ezsigntemplatesignature_request_compound->i_ezsigntemplatesignature_positioningoffsety
    cJSON *i_ezsigntemplatesignature_positioningoffsety = cJSON_GetObjectItemCaseSensitive(ezsigntemplatesignature_request_compoundJSON, "iEzsigntemplatesignaturePositioningoffsety");
    ...
    *i_ezsigntemplatesignature_positioningoffsety_local_var = i_ezsigntemplatesignature_positioningoffsety->valuedouble;
    ...
    // ezsigntemplatesignature_request_compound->e_ezsigntemplatesignature_positioningoccurence
    cJSON *e_ezsigntemplatesignature_positioningoccurence = cJSON_GetObjectItemCaseSensitive(ezsigntemplatesignature_request_compoundJSON, "eEzsigntemplatesignaturePositioningoccurence");
    ...
    // ezsigntemplatesignature_request_compound->s_ezsigntemplatesignature_creditcardamountdescription
    cJSON *s_ezsigntemplatesignature_creditcardamountdescription = cJSON_GetObjectItemCaseSensitive(ezsigntemplatesignature_request_compoundJSON, "sEzsigntemplatesignatureCreditcardamountdescription");
    ...
    // ezsigntemplatesignature_request_compound->d_ezsigntemplatesignature_creditcardamount
    cJSON *d_ezsigntemplatesignature_creditcardamount = cJSON_GetObjectItemCaseSensitive(ezsigntemplatesignature_request_compoundJSON, "dEzsigntemplatesignatureCreditcardamount");
    ...
    *b_ezsigntemplatesignature_customdate_local_var = b_ezsigntemplatesignature_customdate->valueint;
    ...
    // ezsigntemplatesignature_request_compound->a_obj_ezsigntemplatesignaturepaymentdetail
    cJSON *a_obj_ezsigntemplatesignaturepaymentdetail = cJSON_GetObjectItemCaseSensitive(ezsigntemplatesignature_request_compoundJSON, "a_objEzsigntemplatesignaturepaymentdetail");
    ...
    cJSON_ArrayForEach(a_obj_ezsigntemplatesignaturepaymentdetail_local_nonprimitive,a_obj_ezsigntemplatesignaturepaymentdetail )
    {
        ...
        ezsigntemplatesignaturepaymentdetail_request_compound_t *a_obj_ezsigntemplatesignaturepaymentdetailItem = ezsigntemplatesignaturepaymentdetail_request_compound_parseFromJSON(a_obj_ezsigntemplatesignaturepaymentdetail_local_nonprimitive);
    ...
    ezsigntemplatesignature_request_compound_local_var = ezsigntemplatesignature_request_compound_create_internal (
