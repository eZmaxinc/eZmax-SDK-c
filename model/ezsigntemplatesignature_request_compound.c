...
char* ezsigntemplatesignature_request_compound_e_ezsigntemplatesignature_positioning_ToString(ezmax_api_definition__full_ezsigntemplatesignature_request_compound__e e_ezsigntemplatesignature_positioning) {
...
ezmax_api_definition__full_ezsigntemplatesignature_request_compound__e ezsigntemplatesignature_request_compound_e_ezsigntemplatesignature_positioning_FromString(char* e_ezsigntemplatesignature_positioning){
...
char* ezsigntemplatesignature_request_compound_e_ezsigntemplatesignature_consultationtrigger_ToString(ezmax_api_definition__full_ezsigntemplatesignature_request_compound__e e_ezsigntemplatesignature_consultationtrigger) {
...
ezmax_api_definition__full_ezsigntemplatesignature_request_compound__e ezsigntemplatesignature_request_compound_e_ezsigntemplatesignature_consultationtrigger_FromString(char* e_ezsigntemplatesignature_consultationtrigger){
    int stringToReturn = 0;
    char *e_ezsigntemplatesignature_consultationtriggerArray[] =  { "NULL", "Automatic", "Manual" };
...
char* ezsigntemplatesignature_request_compound_e_ezsigntemplatesignature_textvalidation_ToString(ezmax_api_definition__full_ezsigntemplatesignature_request_compound__e e_ezsigntemplatesignature_textvalidation) {
...
ezmax_api_definition__full_ezsigntemplatesignature_request_compound__e ezsigntemplatesignature_request_compound_e_ezsigntemplatesignature_textvalidation_FromString(char* e_ezsigntemplatesignature_textvalidation){
    int stringToReturn = 0;
    char *e_ezsigntemplatesignature_textvalidationArray[] =  { "NULL", "None", "Date (YYYY-MM-DD)", "Date (MM/DD/YYYY)", "Date (MM/DD/YY)", "Date (DD/MM/YYYY)", "Date (DD/MM/YY)", "Email", "Letters", "Numbers", "Zip", "Zip+4", "PostalCode", "Custom" };
...
char* ezsigntemplatesignature_request_compound_e_ezsigntemplatesignature_dependencyrequirement_ToString(ezmax_api_definition__full_ezsigntemplatesignature_request_compound__e e_ezsigntemplatesignature_dependencyrequirement) {
...
ezmax_api_definition__full_ezsigntemplatesignature_request_compound__e ezsigntemplatesignature_request_compound_e_ezsigntemplatesignature_dependencyrequirement_FromString(char* e_ezsigntemplatesignature_dependencyrequirement){
    int stringToReturn = 0;
    char *e_ezsigntemplatesignature_dependencyrequirementArray[] =  { "NULL", "AllOf", "AnyOf" };
...
char* ezsigntemplatesignature_request_compound_e_ezsigntemplatesignature_positioningoccurence_ToString(ezmax_api_definition__full_ezsigntemplatesignature_request_compound__e e_ezsigntemplatesignature_positioningoccurence) {
...
ezmax_api_definition__full_ezsigntemplatesignature_request_compound__e ezsigntemplatesignature_request_compound_e_ezsigntemplatesignature_positioningoccurence_FromString(char* e_ezsigntemplatesignature_positioningoccurence){
    int stringToReturn = 0;
    char *e_ezsigntemplatesignature_positioningoccurenceArray[] =  { "NULL", "All", "First", "Last" };
...
void ezsigntemplatesignature_request_compound_free(ezsigntemplatesignature_request_compound_t *ezsigntemplatesignature_request_compound) {
    ...
    if (ezsigntemplatesignature_request_compound->e_ezsigntemplatesignature_positioning) {
        field_e_ezsigntemplatesignature_positioning_free(ezsigntemplatesignature_request_compound->e_ezsigntemplatesignature_positioning);
        ezsigntemplatesignature_request_compound->e_ezsigntemplatesignature_positioning = NULL;
    }
    ...
    if (ezsigntemplatesignature_request_compound->e_ezsigntemplatesignature_consultationtrigger) {
        field_e_ezsigntemplatesignature_consultationtrigger_free(ezsigntemplatesignature_request_compound->e_ezsigntemplatesignature_consultationtrigger);
        ezsigntemplatesignature_request_compound->e_ezsigntemplatesignature_consultationtrigger = NULL;
    }
    ...
    if (ezsigntemplatesignature_request_compound->e_ezsigntemplatesignature_positioningoccurence) {
        field_e_ezsigntemplatesignature_positioningoccurence_free(ezsigntemplatesignature_request_compound->e_ezsigntemplatesignature_positioningoccurence);
        ezsigntemplatesignature_request_compound->e_ezsigntemplatesignature_positioningoccurence = NULL;
    }
    if (ezsigntemplatesignature_request_compound->a_obj_ezsigntemplatesignaturecustomdate) {
        list_ForEach(listEntry, ezsigntemplatesignature_request_compound->a_obj_ezsigntemplatesignaturecustomdate) {
            ezsigntemplatesignaturecustomdate_request_free(listEntry->data);
        }
...
cJSON *ezsigntemplatesignature_request_compound_convertToJSON(ezsigntemplatesignature_request_compound_t *ezsigntemplatesignature_request_compound) {
    ...
    if(ezsigntemplatesignature_request_compound->e_ezsigntemplatesignature_positioning != ezmax_api_definition__full_ezsigntemplatesignature_request_compound__NULL) {
    ...
    if(ezsigntemplatesignature_request_compound->e_ezsigntemplatesignature_consultationtrigger != ezmax_api_definition__full_ezsigntemplatesignature_request_compound__NULL) {
    ...
    if(ezsigntemplatesignature_request_compound->e_ezsigntemplatesignature_positioningoccurence != ezmax_api_definition__full_ezsigntemplatesignature_request_compound__NULL) {
    ...
    cJSON *itemLocal = ezsigntemplatesignaturecustomdate_request_convertToJSON(a_obj_ezsigntemplatesignaturecustomdateListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
...
ezsigntemplatesignature_request_compound_t *ezsigntemplatesignature_request_compound_parseFromJSON(cJSON *ezsigntemplatesignature_request_compoundJSON){
    ...
    cJSON_ArrayForEach(a_obj_ezsigntemplatesignaturecustomdate_local_nonprimitive,a_obj_ezsigntemplatesignaturecustomdate )
    {
        ...
        ezsigntemplatesignaturecustomdate_request_t *a_obj_ezsigntemplatesignaturecustomdateItem = ezsigntemplatesignaturecustomdate_request_parseFromJSON(a_obj_ezsigntemplatesignaturecustomdate_local_nonprimitive);
