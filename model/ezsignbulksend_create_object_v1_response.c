...
#include <string.h>
#include <stdio.h>
#include "ezsignbulksend_create_object_v1_response.h"



static ezsignbulksend_create_object_v1_response_t *ezsignbulksend_create_object_v1_response_create_internal(
    ...
    memset(ezsignbulksend_create_object_v1_response_local_var, 0, sizeof(ezsignbulksend_create_object_v1_response_t));
    ezsignbulksend_create_object_v1_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezsignbulksend_create_object_v1_response_t *ezsignbulksend_create_object_v1_response_create(
    ...
    ezsignbulksend_create_object_v1_response_t *result = ezsignbulksend_create_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void ezsignbulksend_create_object_v1_response_free(ezsignbulksend_create_object_v1_response_t *ezsignbulksend_create_object_v1_response) {
    if(NULL == ezsignbulksend_create_object_v1_response){
        return ;
    }
    if(ezsignbulksend_create_object_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsignbulksend_create_object_v1_response_free");
        return ;
    }
    ...
    if (ezsignbulksend_create_object_v1_response->obj_debug) {
...
cJSON *ezsignbulksend_create_object_v1_response_convertToJSON(ezsignbulksend_create_object_v1_response_t *ezsignbulksend_create_object_v1_response) {
    ...
    if(ezsignbulksend_create_object_v1_response->obj_debug) {
    cJSON *obj_debug_local_JSON = common_response_obj_debug_convertToJSON(ezsignbulksend_create_object_v1_response->obj_debug);
...
ezsignbulksend_create_object_v1_response_t *ezsignbulksend_create_object_v1_response_parseFromJSON(cJSON *ezsignbulksend_create_object_v1_responseJSON){
    ...
    ezsignbulksend_create_object_v1_response_local_var = ezsignbulksend_create_object_v1_response_create_internal (
