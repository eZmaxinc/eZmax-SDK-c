/*
 * webhook_get_object_v2_response_all_of.h
 *
 * 
 */

#ifndef _webhook_get_object_v2_response_all_of_H_
#define _webhook_get_object_v2_response_all_of_H_
...
typedef struct webhook_get_object_v2_response_all_of_t webhook_get_object_v2_response_all_of_t;

#include "webhook_get_object_v2_response_m_payload.h"



typedef struct webhook_get_object_v2_response_all_of_t {
    struct webhook_get_object_v2_response_m_payload_t *m_payload; //model

} webhook_get_object_v2_response_all_of_t;
...
#endif /* _webhook_get_object_v2_response_all_of_H_ */
