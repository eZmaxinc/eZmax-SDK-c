/*
 * ezsignfoldertype_get_object_v3_response_m_payload.h
 *
 * Payload for GET /3/object/ezsignfoldertype/{pkiEzsignfoldertypeID}
 */

#ifndef _ezsignfoldertype_get_object_v3_response_m_payload_H_
#define _ezsignfoldertype_get_object_v3_response_m_payload_H_
...
typedef struct ezsignfoldertype_get_object_v3_response_m_payload_t ezsignfoldertype_get_object_v3_response_m_payload_t;

#include "ezsignfoldertype_response_compound_v3.h"



typedef struct ezsignfoldertype_get_object_v3_response_m_payload_t {
    struct ezsignfoldertype_response_compound_v3_t *obj_ezsignfoldertype; //model

} ezsignfoldertype_get_object_v3_response_m_payload_t;
...
#endif /* _ezsignfoldertype_get_object_v3_response_m_payload_H_ */
