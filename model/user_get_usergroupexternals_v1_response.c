...
static user_get_usergroupexternals_v1_response_t *user_get_usergroupexternals_v1_response_create_internal(
    ...
    memset(user_get_usergroupexternals_v1_response_local_var, 0, sizeof(user_get_usergroupexternals_v1_response_t));
...
__attribute__((deprecated)) user_get_usergroupexternals_v1_response_t *user_get_usergroupexternals_v1_response_create(
    ...
    user_get_usergroupexternals_v1_response_t *result = user_get_usergroupexternals_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
