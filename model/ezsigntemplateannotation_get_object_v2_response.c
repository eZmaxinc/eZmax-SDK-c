...
static ezsigntemplateannotation_get_object_v2_response_t *ezsigntemplateannotation_get_object_v2_response_create_internal(
    ...
    memset(ezsigntemplateannotation_get_object_v2_response_local_var, 0, sizeof(ezsigntemplateannotation_get_object_v2_response_t));
...
__attribute__((deprecated)) ezsigntemplateannotation_get_object_v2_response_t *ezsigntemplateannotation_get_object_v2_response_create(
    ...
    ezsigntemplateannotation_get_object_v2_response_t *result = ezsigntemplateannotation_get_object_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
