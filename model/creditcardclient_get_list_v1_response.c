...
static creditcardclient_get_list_v1_response_t *creditcardclient_get_list_v1_response_create_internal(
    ...
    memset(creditcardclient_get_list_v1_response_local_var, 0, sizeof(creditcardclient_get_list_v1_response_t));
...
__attribute__((deprecated)) creditcardclient_get_list_v1_response_t *creditcardclient_get_list_v1_response_create(
    ...
    creditcardclient_get_list_v1_response_t *result = creditcardclient_get_list_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
