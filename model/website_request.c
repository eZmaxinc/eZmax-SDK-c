...
static website_request_t *website_request_create_internal(
    ...
    memset(website_request_local_var, 0, sizeof(website_request_t));
...
__attribute__((deprecated)) website_request_t *website_request_create(
    ...
    website_request_t *result = website_request_create_internal (
        pki_website_id_copy,
...
void website_request_free(website_request_t *website_request) {
    ...
    if (website_request->pki_website_id) {
        free(website_request->pki_website_id);
        website_request->pki_website_id = NULL;
    }
    if (website_request->fki_websitetype_id) {
        free(website_request->fki_websitetype_id);
        website_request->fki_websitetype_id = NULL;
    }
...
website_request_t *website_request_parseFromJSON(cJSON *website_requestJSON){
    ...
    // define the local variable for website_request->pki_website_id
    int *pki_website_id_local_var = NULL;

    // define the local variable for website_request->fki_websitetype_id
