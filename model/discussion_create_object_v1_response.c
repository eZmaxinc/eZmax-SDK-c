...
static discussion_create_object_v1_response_t *discussion_create_object_v1_response_create_internal(
...
void discussion_create_object_v1_response_free(discussion_create_object_v1_response_t *discussion_create_object_v1_response) {
    ...
    if(discussion_create_object_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "discussion_create_object_v1_response_free");
        return ;
    }
