...
char* e_attachment_documenttypeattachment_response_ToString(ezmax_api_definition__full_attachment_response__e e_attachment_documenttype) {
...
ezmax_api_definition__full_attachment_response__e e_attachment_documenttypeattachment_response_FromString(char* e_attachment_documenttype){
...
char* e_attachment_privacyattachment_response_ToString(ezmax_api_definition__full_attachment_response__e e_attachment_privacy) {
...
ezmax_api_definition__full_attachment_response__e e_attachment_privacyattachment_response_FromString(char* e_attachment_privacy){
    int stringToReturn = 0;
    char *e_attachment_privacyArray[] =  { "NULL", "All", "Inscriptor", "Seller", "Administration", "Creator", "Specificuser" };
...
char* e_attachment_typeattachment_response_ToString(ezmax_api_definition__full_attachment_response__e e_attachment_type) {
    char* e_attachment_typeArray[] =  { "NULL", "Other", "Pdf", "PdfGenerated", "PdfScanned", "Ezsign" };
    return e_attachment_typeArray[e_attachment_type];
}

ezmax_api_definition__full_attachment_response__e e_attachment_typeattachment_response_FromString(char* e_attachment_type){
    int stringToReturn = 0;
    char *e_attachment_typeArray[] =  { "NULL", "Other", "Pdf", "PdfGenerated", "PdfScanned", "Ezsign" };
...
char* e_attachment_verifiedattachment_response_ToString(ezmax_api_definition__full_attachment_response__e e_attachment_verified) {
    char* e_attachment_verifiedArray[] =  { "NULL", "No", "Yes", "Rejected" };
    return e_attachment_verifiedArray[e_attachment_verified];
}

ezmax_api_definition__full_attachment_response__e e_attachment_verifiedattachment_response_FromString(char* e_attachment_verified){
    int stringToReturn = 0;
    char *e_attachment_verifiedArray[] =  { "NULL", "No", "Yes", "Rejected" };
