...
void attachment_response_free(attachment_response_t *attachment_response) {
    ...
    if (attachment_response->e_attachment_documenttype) {
        field_e_attachment_documenttype_free(attachment_response->e_attachment_documenttype);
        attachment_response->e_attachment_documenttype = NULL;
    }
    ...
    if (attachment_response->e_attachment_privacy) {
        field_e_attachment_privacy_free(attachment_response->e_attachment_privacy);
        attachment_response->e_attachment_privacy = NULL;
    }
    if (attachment_response->e_attachment_type) {
        field_e_attachment_type_free(attachment_response->e_attachment_type);
        attachment_response->e_attachment_type = NULL;
    }
    ...
    if (attachment_response->e_attachment_verified) {
        field_e_attachment_verified_free(attachment_response->e_attachment_verified);
        attachment_response->e_attachment_verified = NULL;
    }
...
cJSON *attachment_response_convertToJSON(attachment_response_t *attachment_response) {
    ...
    if (ezmax_api_definition__full_attachment_response__NULL == attachment_response->e_attachment_documenttype) {
        goto fail;
    }
    ...
    if (ezmax_api_definition__full_attachment_response__NULL == attachment_response->e_attachment_privacy) {
        goto fail;
    }
    ...
    if (ezmax_api_definition__full_attachment_response__NULL == attachment_response->e_attachment_type) {
        goto fail;
    }
    ...
    if (ezmax_api_definition__full_attachment_response__NULL == attachment_response->e_attachment_verified) {
        goto fail;
    }
...
attachment_response_t *attachment_response_parseFromJSON(cJSON *attachment_responseJSON){
    ...
    attachment_response_local_var = attachment_response_create (
