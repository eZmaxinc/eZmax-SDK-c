/*
 * adjustment_get_communication_list_v1_response.h
 *
 * Response for GET /1/object/adjustment/{pkiAdjustmentID}/getCommunicationList
 */

#ifndef _adjustment_get_communication_list_v1_response_H_
#define _adjustment_get_communication_list_v1_response_H_
...
typedef struct adjustment_get_communication_list_v1_response_t adjustment_get_communication_list_v1_response_t;
...
typedef struct adjustment_get_communication_list_v1_response_t {
    struct common_response_obj_debug_payload_get_list_t *obj_debug_payload; //model
    struct common_response_obj_debug_t *obj_debug; //model
    struct adjustment_get_communication_list_v1_response_m_payload_t *m_payload; //model
...
#endif /* _adjustment_get_communication_list_v1_response_H_ */
