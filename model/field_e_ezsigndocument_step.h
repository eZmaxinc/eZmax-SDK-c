...
typedef enum { ezmax_api_definition__full_field_e_ezsigndocument_step__NULL = 0, ezmax_api_definition__full_field_e_ezsigndocument_step__Unsent, ezmax_api_definition__full_field_e_ezsigndocument_step___Unsigned, ezmax_api_definition__full_field_e_ezsigndocument_step__PartiallySigned, ezmax_api_definition__full_field_e_ezsigndocument_step__DeclinedToSign, ezmax_api_definition__full_field_e_ezsigndocument_step__PendingPrematurelyEnded, ezmax_api_definition__full_field_e_ezsigndocument_step__PrematurelyEnded, ezmax_api_definition__full_field_e_ezsigndocument_step__PendingCompletion, ezmax_api_definition__full_field_e_ezsigndocument_step__Completed, ezmax_api_definition__full_field_e_ezsigndocument_step__Disposed } ezmax_api_definition__full_field_e_ezsigndocument_step__e;
