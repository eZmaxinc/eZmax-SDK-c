...
static discussionmembership_create_object_v1_response_t *discussionmembership_create_object_v1_response_create_internal(
    ...
    memset(discussionmembership_create_object_v1_response_local_var, 0, sizeof(discussionmembership_create_object_v1_response_t));
    discussionmembership_create_object_v1_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) discussionmembership_create_object_v1_response_t *discussionmembership_create_object_v1_response_create(
    common_response_obj_debug_payload_t *obj_debug_payload,
    common_response_obj_debug_t *obj_debug,
    discussionmembership_create_object_v1_response_m_payload_t *m_payload
    ) {
    discussionmembership_create_object_v1_response_t *result = discussionmembership_create_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void discussionmembership_create_object_v1_response_free(discussionmembership_create_object_v1_response_t *discussionmembership_create_object_v1_response) {
    ...
    if(discussionmembership_create_object_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "discussionmembership_create_object_v1_response_free");
        return ;
    }
...
discussionmembership_create_object_v1_response_t *discussionmembership_create_object_v1_response_parseFromJSON(cJSON *discussionmembership_create_object_v1_responseJSON){
    ...
    discussionmembership_create_object_v1_response_local_var = discussionmembership_create_object_v1_response_create_internal (
