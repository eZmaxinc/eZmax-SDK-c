...
static ezsigntemplatedocument_flatten_v1_response_t *ezsigntemplatedocument_flatten_v1_response_create_internal(
    ...
    memset(ezsigntemplatedocument_flatten_v1_response_local_var, 0, sizeof(ezsigntemplatedocument_flatten_v1_response_t));
...
__attribute__((deprecated)) ezsigntemplatedocument_flatten_v1_response_t *ezsigntemplatedocument_flatten_v1_response_create(
    ...
    ezsigntemplatedocument_flatten_v1_response_t *result = ezsigntemplatedocument_flatten_v1_response_create_internal (
        obj_debug_payload,
        obj_debug
        );
    if (!result) {
