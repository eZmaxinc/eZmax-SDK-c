...
void ezsigntemplatepackagesigner_response_compound_free(ezsigntemplatepackagesigner_response_compound_t *ezsigntemplatepackagesigner_response_compound) {
    ...
    if (ezsigntemplatepackagesigner_response_compound->e_ezsigntemplatepackagesigner_mapping) {
        field_e_ezsigntemplatepackagesigner_mapping_free(ezsigntemplatepackagesigner_response_compound->e_ezsigntemplatepackagesigner_mapping);
        ezsigntemplatepackagesigner_response_compound->e_ezsigntemplatepackagesigner_mapping = NULL;
    }
...
cJSON *ezsigntemplatepackagesigner_response_compound_convertToJSON(ezsigntemplatepackagesigner_response_compound_t *ezsigntemplatepackagesigner_response_compound) {
    ...
    if(ezsigntemplatepackagesigner_response_compound->e_ezsigntemplatepackagesigner_mapping != ezmax_api_definition__full_ezsigntemplatepackagesigner_response_compound__NULL) {
