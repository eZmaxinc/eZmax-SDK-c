...
static buyercontract_get_communication_list_v1_response_t *buyercontract_get_communication_list_v1_response_create_internal(
    ...
    memset(buyercontract_get_communication_list_v1_response_local_var, 0, sizeof(buyercontract_get_communication_list_v1_response_t));
    buyercontract_get_communication_list_v1_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) buyercontract_get_communication_list_v1_response_t *buyercontract_get_communication_list_v1_response_create(
    common_response_obj_debug_payload_get_list_t *obj_debug_payload,
    common_response_obj_debug_t *obj_debug,
    buyercontract_get_communication_list_v1_response_m_payload_t *m_payload
    ) {
    buyercontract_get_communication_list_v1_response_t *result = buyercontract_get_communication_list_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void buyercontract_get_communication_list_v1_response_free(buyercontract_get_communication_list_v1_response_t *buyercontract_get_communication_list_v1_response) {
    ...
    if(buyercontract_get_communication_list_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "buyercontract_get_communication_list_v1_response_free");
        return ;
    }
...
buyercontract_get_communication_list_v1_response_t *buyercontract_get_communication_list_v1_response_parseFromJSON(cJSON *buyercontract_get_communication_list_v1_responseJSON){
    ...
    buyercontract_get_communication_list_v1_response_local_var = buyercontract_get_communication_list_v1_response_create_internal (
