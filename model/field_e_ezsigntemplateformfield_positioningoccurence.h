...
typedef enum { ezmax_api_definition__full_field_e_ezsigntemplateformfield_positioningoccurence__NULL = 0, ezmax_api_definition__full_field_e_ezsigntemplateformfield_positioningoccurence__First, ezmax_api_definition__full_field_e_ezsigntemplateformfield_positioningoccurence__Last } ezmax_api_definition__full_field_e_ezsigntemplateformfield_positioningoccurence__e;
