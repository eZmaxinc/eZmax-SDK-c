...
ezsigndocument_create_object_v2_response_m_payload_t *ezsigndocument_create_object_v2_response_m_payload_create(
...
ezsigndocument_create_object_v2_response_m_payload_t *ezsigndocument_create_object_v2_response_m_payload_parseFromJSON(cJSON *ezsigndocument_create_object_v2_response_m_payloadJSON){
    ...
    ezsigndocument_create_object_v2_response_m_payload_local_var = ezsigndocument_create_object_v2_response_m_payload_create (
