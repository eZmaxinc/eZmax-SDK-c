...
contact_request_v2_t *contact_request_v2_create(
    ...
    contact_request_v2_local_var->s_contact_firstname = s_contact_firstname;
    contact_request_v2_local_var->s_contact_lastname = s_contact_lastname;
    contact_request_v2_local_var->s_contact_company = s_contact_company;
    contact_request_v2_local_var->dt_contact_birthdate = dt_contact_birthdate;
    contact_request_v2_local_var->s_contact_occupation = s_contact_occupation;
...
void contact_request_v2_free(contact_request_v2_t *contact_request_v2) {
    if(NULL == contact_request_v2){
        return ;
    }
    listEntry_t *listEntry;
    if (contact_request_v2->e_contact_type) {
        field_e_contact_type_free(contact_request_v2->e_contact_type);
        contact_request_v2->e_contact_type = NULL;
    }
    ...
    if (contact_request_v2->s_contact_lastname) {
        free(contact_request_v2->s_contact_lastname);
        contact_request_v2->s_contact_lastname = NULL;
    }
    if (contact_request_v2->s_contact_company) {
        free(contact_request_v2->s_contact_company);
        contact_request_v2->s_contact_company = NULL;
    }
    if (contact_request_v2->dt_contact_birthdate) {
        free(contact_request_v2->dt_contact_birthdate);
        contact_request_v2->dt_contact_birthdate = NULL;
    }
    if (contact_request_v2->s_contact_occupation) {
        free(contact_request_v2->s_contact_occupation);
        contact_request_v2->s_contact_occupation = NULL;
    }
    if (contact_request_v2->t_contact_note) {
...
cJSON *contact_request_v2_convertToJSON(contact_request_v2_t *contact_request_v2) {
    ...
    if (ezmax_api_definition__full_contact_request_v2__NULL == contact_request_v2->e_contact_type) {
        goto fail;
    }
    cJSON *e_contact_type_local_JSON = field_e_contact_type_convertToJSON(contact_request_v2->e_contact_type);
    ...
    // contact_request_v2->s_contact_firstname
    if (!contact_request_v2->s_contact_firstname) {
        goto fail;
    }
    if(cJSON_AddStringToObject(item, "sContactFirstname", contact_request_v2->s_contact_firstname) == NULL) {
    goto fail; //String
    }


    // contact_request_v2->s_contact_lastname
    if (!contact_request_v2->s_contact_lastname) {
        goto fail;
    }
    if(cJSON_AddStringToObject(item, "sContactLastname", contact_request_v2->s_contact_lastname) == NULL) {
    goto fail; //String
    }


    // contact_request_v2->s_contact_company
    if(contact_request_v2->s_contact_company) {
    if(cJSON_AddStringToObject(item, "sContactCompany", contact_request_v2->s_contact_company) == NULL) {
    goto fail; //String
    }
    }


    // contact_request_v2->dt_contact_birthdate
    if(contact_request_v2->dt_contact_birthdate) {
    if(cJSON_AddStringToObject(item, "dtContactBirthdate", contact_request_v2->dt_contact_birthdate) == NULL) {
    goto fail; //String
    }
    }


    // contact_request_v2->s_contact_occupation
    if(contact_request_v2->s_contact_occupation) {
    if(cJSON_AddStringToObject(item, "sContactOccupation", contact_request_v2->s_contact_occupation) == NULL) {
    goto fail; //String
    }
    }


    // contact_request_v2->t_contact_note
    if(contact_request_v2->t_contact_note) {
    if(cJSON_AddStringToObject(item, "tContactNote", contact_request_v2->t_contact_note) == NULL) {
    goto fail; //String
    }
    }
    ...
    cJSON *obj_contactinformations_local_JSON = contactinformations_request_compound_convertToJSON(contact_request_v2->obj_contactinformations);
...
contact_request_v2_t *contact_request_v2_parseFromJSON(cJSON *contact_request_v2JSON){
    ...
    // contact_request_v2->fki_contacttitle_id
    cJSON *fki_contacttitle_id = cJSON_GetObjectItemCaseSensitive(contact_request_v2JSON, "fkiContacttitleID");
    ...
    // contact_request_v2->s_contact_firstname
    cJSON *s_contact_firstname = cJSON_GetObjectItemCaseSensitive(contact_request_v2JSON, "sContactFirstname");
    ...
    // contact_request_v2->s_contact_lastname
    cJSON *s_contact_lastname = cJSON_GetObjectItemCaseSensitive(contact_request_v2JSON, "sContactLastname");
    ...
    // contact_request_v2->s_contact_company
    cJSON *s_contact_company = cJSON_GetObjectItemCaseSensitive(contact_request_v2JSON, "sContactCompany");
    ...
    // contact_request_v2->dt_contact_birthdate
    cJSON *dt_contact_birthdate = cJSON_GetObjectItemCaseSensitive(contact_request_v2JSON, "dtContactBirthdate");
    ...
    // contact_request_v2->s_contact_occupation
    cJSON *s_contact_occupation = cJSON_GetObjectItemCaseSensitive(contact_request_v2JSON, "sContactOccupation");
    ...
    // contact_request_v2->t_contact_note
    cJSON *t_contact_note = cJSON_GetObjectItemCaseSensitive(contact_request_v2JSON, "tContactNote");
    if (t_contact_note) { 
    ...
    // contact_request_v2->b_contact_isactive
    cJSON *b_contact_isactive = cJSON_GetObjectItemCaseSensitive(contact_request_v2JSON, "bContactIsactive");
    ...
    // contact_request_v2->obj_contactinformations
    cJSON *obj_contactinformations = cJSON_GetObjectItemCaseSensitive(contact_request_v2JSON, "objContactinformations");
    ...
    contact_request_v2_local_var = contact_request_v2_create (
