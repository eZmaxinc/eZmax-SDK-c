...
void contact_request_v2_free(contact_request_v2_t *contact_request_v2) {
    ...
    if(contact_request_v2->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "contact_request_v2_free");
        return ;
    }
...
cJSON *contact_request_v2_convertToJSON(contact_request_v2_t *contact_request_v2) {
    ...
    if (ezmax_api_definition__full_field_e_contact_type__NULL == contact_request_v2->e_contact_type) {
        goto fail;
    }
