/*
 * adjustment_get_communicationrecipients_v1_response_m_payload.h
 *
 * Response for GET /1/object/adjustment/{pkiAdjustmentID}/getCommunicationrecipients
 */

#ifndef _adjustment_get_communicationrecipients_v1_response_m_payload_H_
#define _adjustment_get_communicationrecipients_v1_response_m_payload_H_
...
typedef struct adjustment_get_communicationrecipients_v1_response_m_payload_t adjustment_get_communicationrecipients_v1_response_m_payload_t;

#include "custom_communicationrecipientsgroup_response.h"



typedef struct adjustment_get_communicationrecipients_v1_response_m_payload_t {
    list_t *a_obj_communicationrecipientsgroup; //nonprimitive container

    int _library_owned; // Is the library responsible for freeing this object?
} adjustment_get_communicationrecipients_v1_response_m_payload_t;
...
#endif /* _adjustment_get_communicationrecipients_v1_response_m_payload_H_ */
