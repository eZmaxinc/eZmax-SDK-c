...
static ezsignformfieldgroup_response_compound_t *ezsignformfieldgroup_response_compound_create_internal(
    ...
    memset(ezsignformfieldgroup_response_compound_local_var, 0, sizeof(ezsignformfieldgroup_response_compound_t));
    ...
    ezsignformfieldgroup_response_compound_local_var->dt_ezsignformfieldgroup_completed = dt_ezsignformfieldgroup_completed;
...
__attribute__((deprecated)) ezsignformfieldgroup_response_compound_t *ezsignformfieldgroup_response_compound_create(
    ...
    ezsignformfieldgroup_response_compound_t *result = ezsignformfieldgroup_response_compound_create_internal (
...
void ezsignformfieldgroup_response_compound_free(ezsignformfieldgroup_response_compound_t *ezsignformfieldgroup_response_compound) {
    ...
    if (ezsignformfieldgroup_response_compound->pki_ezsignformfieldgroup_id) {
        free(ezsignformfieldgroup_response_compound->pki_ezsignformfieldgroup_id);
        ezsignformfieldgroup_response_compound->pki_ezsignformfieldgroup_id = NULL;
    }
    if (ezsignformfieldgroup_response_compound->fki_ezsigndocument_id) {
        free(ezsignformfieldgroup_response_compound->fki_ezsigndocument_id);
        ezsignformfieldgroup_response_compound->fki_ezsigndocument_id = NULL;
    }
    ...
    if (ezsignformfieldgroup_response_compound->i_ezsignformfieldgroup_step) {
        free(ezsignformfieldgroup_response_compound->i_ezsignformfieldgroup_step);
        ezsignformfieldgroup_response_compound->i_ezsignformfieldgroup_step = NULL;
    }
    ...
    if (ezsignformfieldgroup_response_compound->i_ezsignformfieldgroup_filledmin) {
        free(ezsignformfieldgroup_response_compound->i_ezsignformfieldgroup_filledmin);
        ezsignformfieldgroup_response_compound->i_ezsignformfieldgroup_filledmin = NULL;
    }
    if (ezsignformfieldgroup_response_compound->i_ezsignformfieldgroup_filledmax) {
        free(ezsignformfieldgroup_response_compound->i_ezsignformfieldgroup_filledmax);
        ezsignformfieldgroup_response_compound->i_ezsignformfieldgroup_filledmax = NULL;
    }
    if (ezsignformfieldgroup_response_compound->b_ezsignformfieldgroup_readonly) {
        free(ezsignformfieldgroup_response_compound->b_ezsignformfieldgroup_readonly);
        ezsignformfieldgroup_response_compound->b_ezsignformfieldgroup_readonly = NULL;
    }
    if (ezsignformfieldgroup_response_compound->i_ezsignformfieldgroup_maxlength) {
        free(ezsignformfieldgroup_response_compound->i_ezsignformfieldgroup_maxlength);
        ezsignformfieldgroup_response_compound->i_ezsignformfieldgroup_maxlength = NULL;
    }
    if (ezsignformfieldgroup_response_compound->b_ezsignformfieldgroup_encrypted) {
        free(ezsignformfieldgroup_response_compound->b_ezsignformfieldgroup_encrypted);
        ezsignformfieldgroup_response_compound->b_ezsignformfieldgroup_encrypted = NULL;
    }
    ...
    if (ezsignformfieldgroup_response_compound->dt_ezsignformfieldgroup_completed) {
        free(ezsignformfieldgroup_response_compound->dt_ezsignformfieldgroup_completed);
        ezsignformfieldgroup_response_compound->dt_ezsignformfieldgroup_completed = NULL;
    }
...
cJSON *ezsignformfieldgroup_response_compound_convertToJSON(ezsignformfieldgroup_response_compound_t *ezsignformfieldgroup_response_compound) {
    ...
    // ezsignformfieldgroup_response_compound->dt_ezsignformfieldgroup_completed
    if(ezsignformfieldgroup_response_compound->dt_ezsignformfieldgroup_completed) {
    if(cJSON_AddStringToObject(item, "dtEzsignformfieldgroupCompleted", ezsignformfieldgroup_response_compound->dt_ezsignformfieldgroup_completed) == NULL) {
    goto fail; //String
    }
    }
...
ezsignformfieldgroup_response_compound_t *ezsignformfieldgroup_response_compound_parseFromJSON(cJSON *ezsignformfieldgroup_response_compoundJSON){
    ...
    // define the local variable for ezsignformfieldgroup_response_compound->pki_ezsignformfieldgroup_id
    int *pki_ezsignformfieldgroup_id_local_var = NULL;

    // define the local variable for ezsignformfieldgroup_response_compound->fki_ezsigndocument_id
    ...
    // define the local variable for ezsignformfieldgroup_response_compound->i_ezsignformfieldgroup_step
    int *i_ezsignformfieldgroup_step_local_var = NULL;

    char *s_ezsignformfieldgroup_defaultvalue_local_str = NULL;

    // define the local variable for ezsignformfieldgroup_response_compound->i_ezsignformfieldgroup_filledmin
    int *i_ezsignformfieldgroup_filledmin_local_var = NULL;

    // define the local variable for ezsignformfieldgroup_response_compound->i_ezsignformfieldgroup_filledmax
    int *i_ezsignformfieldgroup_filledmax_local_var = NULL;

    // define the local variable for ezsignformfieldgroup_response_compound->b_ezsignformfieldgroup_readonly
    int *b_ezsignformfieldgroup_readonly_local_var = NULL;

    // define the local variable for ezsignformfieldgroup_response_compound->i_ezsignformfieldgroup_maxlength
    int *i_ezsignformfieldgroup_maxlength_local_var = NULL;

    // define the local variable for ezsignformfieldgroup_response_compound->b_ezsignformfieldgroup_encrypted
    ...
    *b_ezsignformfieldgroup_encrypted_local_var = b_ezsignformfieldgroup_encrypted->valueint;
    ...
    // ezsignformfieldgroup_response_compound->dt_ezsignformfieldgroup_completed
    cJSON *dt_ezsignformfieldgroup_completed = cJSON_GetObjectItemCaseSensitive(ezsignformfieldgroup_response_compoundJSON, "dtEzsignformfieldgroupCompleted");
