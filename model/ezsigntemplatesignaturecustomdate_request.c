...
static ezsigntemplatesignaturecustomdate_request_t *ezsigntemplatesignaturecustomdate_request_create_internal(
    ...
    memset(ezsigntemplatesignaturecustomdate_request_local_var, 0, sizeof(ezsigntemplatesignaturecustomdate_request_t));
...
__attribute__((deprecated)) ezsigntemplatesignaturecustomdate_request_t *ezsigntemplatesignaturecustomdate_request_create(
    ...
    ezsigntemplatesignaturecustomdate_request_t *result = ezsigntemplatesignaturecustomdate_request_create_internal (
...
void ezsigntemplatesignaturecustomdate_request_free(ezsigntemplatesignaturecustomdate_request_t *ezsigntemplatesignaturecustomdate_request) {
    ...
    if (ezsigntemplatesignaturecustomdate_request->pki_ezsigntemplatesignaturecustomdate_id) {
        free(ezsigntemplatesignaturecustomdate_request->pki_ezsigntemplatesignaturecustomdate_id);
        ezsigntemplatesignaturecustomdate_request->pki_ezsigntemplatesignaturecustomdate_id = NULL;
    }
    if (ezsigntemplatesignaturecustomdate_request->i_ezsigntemplatesignaturecustomdate_x) {
        free(ezsigntemplatesignaturecustomdate_request->i_ezsigntemplatesignaturecustomdate_x);
        ezsigntemplatesignaturecustomdate_request->i_ezsigntemplatesignaturecustomdate_x = NULL;
    }
    if (ezsigntemplatesignaturecustomdate_request->i_ezsigntemplatesignaturecustomdate_y) {
        free(ezsigntemplatesignaturecustomdate_request->i_ezsigntemplatesignaturecustomdate_y);
        ezsigntemplatesignaturecustomdate_request->i_ezsigntemplatesignaturecustomdate_y = NULL;
    }
    if (ezsigntemplatesignaturecustomdate_request->i_ezsigntemplatesignaturecustomdate_offsetx) {
        free(ezsigntemplatesignaturecustomdate_request->i_ezsigntemplatesignaturecustomdate_offsetx);
        ezsigntemplatesignaturecustomdate_request->i_ezsigntemplatesignaturecustomdate_offsetx = NULL;
    }
    if (ezsigntemplatesignaturecustomdate_request->i_ezsigntemplatesignaturecustomdate_offsety) {
        free(ezsigntemplatesignaturecustomdate_request->i_ezsigntemplatesignaturecustomdate_offsety);
        ezsigntemplatesignaturecustomdate_request->i_ezsigntemplatesignaturecustomdate_offsety = NULL;
    }
...
ezsigntemplatesignaturecustomdate_request_t *ezsigntemplatesignaturecustomdate_request_parseFromJSON(cJSON *ezsigntemplatesignaturecustomdate_requestJSON){
    ...
    // define the local variable for ezsigntemplatesignaturecustomdate_request->pki_ezsigntemplatesignaturecustomdate_id
    int *pki_ezsigntemplatesignaturecustomdate_id_local_var = NULL;

    // define the local variable for ezsigntemplatesignaturecustomdate_request->i_ezsigntemplatesignaturecustomdate_x
    int *i_ezsigntemplatesignaturecustomdate_x_local_var = NULL;

    // define the local variable for ezsigntemplatesignaturecustomdate_request->i_ezsigntemplatesignaturecustomdate_y
    int *i_ezsigntemplatesignaturecustomdate_y_local_var = NULL;

    // define the local variable for ezsigntemplatesignaturecustomdate_request->i_ezsigntemplatesignaturecustomdate_offsetx
    int *i_ezsigntemplatesignaturecustomdate_offsetx_local_var = NULL;

    // define the local variable for ezsigntemplatesignaturecustomdate_request->i_ezsigntemplatesignaturecustomdate_offsety
