/*
 * variableexpense_get_object_v2_response_all_of.h
 *
 * 
 */

#ifndef _variableexpense_get_object_v2_response_all_of_H_
#define _variableexpense_get_object_v2_response_all_of_H_
...
typedef struct variableexpense_get_object_v2_response_all_of_t variableexpense_get_object_v2_response_all_of_t;

#include "variableexpense_get_object_v2_response_m_payload.h"



typedef struct variableexpense_get_object_v2_response_all_of_t {
    struct variableexpense_get_object_v2_response_m_payload_t *m_payload; //model

} variableexpense_get_object_v2_response_all_of_t;
...
#endif /* _variableexpense_get_object_v2_response_all_of_H_ */
