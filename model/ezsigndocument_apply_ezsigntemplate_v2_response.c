...
static ezsigndocument_apply_ezsigntemplate_v2_response_t *ezsigndocument_apply_ezsigntemplate_v2_response_create_internal(
    ...
    memset(ezsigndocument_apply_ezsigntemplate_v2_response_local_var, 0, sizeof(ezsigndocument_apply_ezsigntemplate_v2_response_t));
    ezsigndocument_apply_ezsigntemplate_v2_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezsigndocument_apply_ezsigntemplate_v2_response_t *ezsigndocument_apply_ezsigntemplate_v2_response_create(
    ...
    ezsigndocument_apply_ezsigntemplate_v2_response_t *result = ezsigndocument_apply_ezsigntemplate_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        a_obj_warning
        );
...
void ezsigndocument_apply_ezsigntemplate_v2_response_free(ezsigndocument_apply_ezsigntemplate_v2_response_t *ezsigndocument_apply_ezsigntemplate_v2_response) {
    ...
    if(ezsigndocument_apply_ezsigntemplate_v2_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsigndocument_apply_ezsigntemplate_v2_response_free");
        return ;
    }
...
ezsigndocument_apply_ezsigntemplate_v2_response_t *ezsigndocument_apply_ezsigntemplate_v2_response_parseFromJSON(cJSON *ezsigndocument_apply_ezsigntemplate_v2_responseJSON){
    ...
    ezsigndocument_apply_ezsigntemplate_v2_response_local_var = ezsigndocument_apply_ezsigntemplate_v2_response_create_internal (
