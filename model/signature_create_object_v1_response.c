...
static signature_create_object_v1_response_t *signature_create_object_v1_response_create_internal(
    ...
    memset(signature_create_object_v1_response_local_var, 0, sizeof(signature_create_object_v1_response_t));
...
__attribute__((deprecated)) signature_create_object_v1_response_t *signature_create_object_v1_response_create(
    ...
    signature_create_object_v1_response_t *result = signature_create_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
