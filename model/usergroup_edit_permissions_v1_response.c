...
static usergroup_edit_permissions_v1_response_t *usergroup_edit_permissions_v1_response_create_internal(
    ...
    memset(usergroup_edit_permissions_v1_response_local_var, 0, sizeof(usergroup_edit_permissions_v1_response_t));
    usergroup_edit_permissions_v1_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) usergroup_edit_permissions_v1_response_t *usergroup_edit_permissions_v1_response_create(
    common_response_obj_debug_payload_t *obj_debug_payload,
    common_response_obj_debug_t *obj_debug,
    usergroup_edit_permissions_v1_response_m_payload_t *m_payload
    ) {
    usergroup_edit_permissions_v1_response_t *result = usergroup_edit_permissions_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void usergroup_edit_permissions_v1_response_free(usergroup_edit_permissions_v1_response_t *usergroup_edit_permissions_v1_response) {
    ...
    if(usergroup_edit_permissions_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "usergroup_edit_permissions_v1_response_free");
        return ;
    }
...
usergroup_edit_permissions_v1_response_t *usergroup_edit_permissions_v1_response_parseFromJSON(cJSON *usergroup_edit_permissions_v1_responseJSON){
    ...
    usergroup_edit_permissions_v1_response_local_var = usergroup_edit_permissions_v1_response_create_internal (
