...
static ezmaxinvoicing_response_compound_t *ezmaxinvoicing_response_compound_create_internal(
    ...
    memset(ezmaxinvoicing_response_compound_local_var, 0, sizeof(ezmaxinvoicing_response_compound_t));
...
__attribute__((deprecated)) ezmaxinvoicing_response_compound_t *ezmaxinvoicing_response_compound_create(
    ...
    ezmaxinvoicing_response_compound_t *result = ezmaxinvoicing_response_compound_create_internal (
...
void ezmaxinvoicing_response_compound_free(ezmaxinvoicing_response_compound_t *ezmaxinvoicing_response_compound) {
    ...
    if (ezmaxinvoicing_response_compound->pki_ezmaxinvoicing_id) {
        free(ezmaxinvoicing_response_compound->pki_ezmaxinvoicing_id);
        ezmaxinvoicing_response_compound->pki_ezmaxinvoicing_id = NULL;
    }
    if (ezmaxinvoicing_response_compound->fki_ezmaxinvoicingcontract_id) {
        free(ezmaxinvoicing_response_compound->fki_ezmaxinvoicingcontract_id);
        ezmaxinvoicing_response_compound->fki_ezmaxinvoicingcontract_id = NULL;
    }
    if (ezmaxinvoicing_response_compound->fki_ezmaxpricing_id) {
        free(ezmaxinvoicing_response_compound->fki_ezmaxpricing_id);
        ezmaxinvoicing_response_compound->fki_ezmaxpricing_id = NULL;
    }
    if (ezmaxinvoicing_response_compound->fki_systemconfigurationtype_id) {
        free(ezmaxinvoicing_response_compound->fki_systemconfigurationtype_id);
        ezmaxinvoicing_response_compound->fki_systemconfigurationtype_id = NULL;
    }
    ...
    if (ezmaxinvoicing_response_compound->i_ezmaxinvoicing_days) {
        free(ezmaxinvoicing_response_compound->i_ezmaxinvoicing_days);
        ezmaxinvoicing_response_compound->i_ezmaxinvoicing_days = NULL;
    }
    ...
    if (ezmaxinvoicing_response_compound->i_ezmaxinvoicing_contractlength) {
        free(ezmaxinvoicing_response_compound->i_ezmaxinvoicing_contractlength);
        ezmaxinvoicing_response_compound->i_ezmaxinvoicing_contractlength = NULL;
    }
    ...
    if (ezmaxinvoicing_response_compound->b_ezmaxinvoicing_rebate_ezsignallagents) {
        free(ezmaxinvoicing_response_compound->b_ezmaxinvoicing_rebate_ezsignallagents);
        ezmaxinvoicing_response_compound->b_ezmaxinvoicing_rebate_ezsignallagents = NULL;
    }
...
ezmaxinvoicing_response_compound_t *ezmaxinvoicing_response_compound_parseFromJSON(cJSON *ezmaxinvoicing_response_compoundJSON){
    ...
    // define the local variable for ezmaxinvoicing_response_compound->pki_ezmaxinvoicing_id
    int *pki_ezmaxinvoicing_id_local_var = NULL;

    // define the local variable for ezmaxinvoicing_response_compound->fki_ezmaxinvoicingcontract_id
    int *fki_ezmaxinvoicingcontract_id_local_var = NULL;

    // define the local variable for ezmaxinvoicing_response_compound->fki_ezmaxpricing_id
    int *fki_ezmaxpricing_id_local_var = NULL;

    // define the local variable for ezmaxinvoicing_response_compound->fki_systemconfigurationtype_id
    ...
    // define the local variable for ezmaxinvoicing_response_compound->i_ezmaxinvoicing_days
    ...
    // define the local variable for ezmaxinvoicing_response_compound->i_ezmaxinvoicing_contractlength
    int *i_ezmaxinvoicing_contractlength_local_var = NULL;

    char *d_ezmaxinvoicing_rebatecontractlength_local_str = NULL;

    // define the local variable for ezmaxinvoicing_response_compound->b_ezmaxinvoicing_rebate_ezsignallagents
