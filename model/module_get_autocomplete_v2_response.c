...
static module_get_autocomplete_v2_response_t *module_get_autocomplete_v2_response_create_internal(
    ...
    memset(module_get_autocomplete_v2_response_local_var, 0, sizeof(module_get_autocomplete_v2_response_t));
    module_get_autocomplete_v2_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) module_get_autocomplete_v2_response_t *module_get_autocomplete_v2_response_create(
    common_response_obj_debug_payload_t *obj_debug_payload,
    common_response_obj_debug_t *obj_debug,
    module_get_autocomplete_v2_response_m_payload_t *m_payload
    ) {
    module_get_autocomplete_v2_response_t *result = module_get_autocomplete_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void module_get_autocomplete_v2_response_free(module_get_autocomplete_v2_response_t *module_get_autocomplete_v2_response) {
    ...
    if(module_get_autocomplete_v2_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "module_get_autocomplete_v2_response_free");
        return ;
    }
...
module_get_autocomplete_v2_response_t *module_get_autocomplete_v2_response_parseFromJSON(cJSON *module_get_autocomplete_v2_responseJSON){
    ...
    module_get_autocomplete_v2_response_local_var = module_get_autocomplete_v2_response_create_internal (
