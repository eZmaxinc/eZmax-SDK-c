...
static webhook_delete_object_v1_response_t *webhook_delete_object_v1_response_create_internal(
    ...
    memset(webhook_delete_object_v1_response_local_var, 0, sizeof(webhook_delete_object_v1_response_t));
...
__attribute__((deprecated)) webhook_delete_object_v1_response_t *webhook_delete_object_v1_response_create(
    ...
    webhook_delete_object_v1_response_t *result = webhook_delete_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug
        );
    if (!result) {
