...
char* e_ezsignformfieldgroup_typeezsignformfieldgroup_get_object_v1_response_m_payload_ToString(ezmax_api_definition__full_ezsignformfieldgroup_get_object_v1_response_m_payload__e e_ezsignformfieldgroup_type) {
...
ezmax_api_definition__full_ezsignformfieldgroup_get_object_v1_response_m_payload__e e_ezsignformfieldgroup_typeezsignformfieldgroup_get_object_v1_response_m_payload_FromString(char* e_ezsignformfieldgroup_type){
...
char* e_ezsignformfieldgroup_signerrequirementezsignformfieldgroup_get_object_v1_response_m_payload_ToString(ezmax_api_definition__full_ezsignformfieldgroup_get_object_v1_response_m_payload__e e_ezsignformfieldgroup_signerrequirement) {
...
ezmax_api_definition__full_ezsignformfieldgroup_get_object_v1_response_m_payload__e e_ezsignformfieldgroup_signerrequirementezsignformfieldgroup_get_object_v1_response_m_payload_FromString(char* e_ezsignformfieldgroup_signerrequirement){
    int stringToReturn = 0;
    char *e_ezsignformfieldgroup_signerrequirementArray[] =  { "NULL", "All", "One" };
...
char* e_ezsignformfieldgroup_tooltippositionezsignformfieldgroup_get_object_v1_response_m_payload_ToString(ezmax_api_definition__full_ezsignformfieldgroup_get_object_v1_response_m_payload__e e_ezsignformfieldgroup_tooltipposition) {
...
ezmax_api_definition__full_ezsignformfieldgroup_get_object_v1_response_m_payload__e e_ezsignformfieldgroup_tooltippositionezsignformfieldgroup_get_object_v1_response_m_payload_FromString(char* e_ezsignformfieldgroup_tooltipposition){
    int stringToReturn = 0;
    char *e_ezsignformfieldgroup_tooltippositionArray[] =  { "NULL", "TopLeft", "TopCenter", "TopRight", "MiddleLeft", "MiddleRight", "BottomLeft", "BottomCenter", "BottomRight" };
...
void ezsignformfieldgroup_get_object_v1_response_m_payload_free(ezsignformfieldgroup_get_object_v1_response_m_payload_t *ezsignformfieldgroup_get_object_v1_response_m_payload) {
    ...
    if (ezsignformfieldgroup_get_object_v1_response_m_payload->a_obj_ezsignformfieldgroupsigner) {
        list_ForEach(listEntry, ezsignformfieldgroup_get_object_v1_response_m_payload->a_obj_ezsignformfieldgroupsigner) {
            ezsignformfieldgroupsigner_response_compound_free(listEntry->data);
        }
        list_freeList(ezsignformfieldgroup_get_object_v1_response_m_payload->a_obj_ezsignformfieldgroupsigner);
...
cJSON *ezsignformfieldgroup_get_object_v1_response_m_payload_convertToJSON(ezsignformfieldgroup_get_object_v1_response_m_payload_t *ezsignformfieldgroup_get_object_v1_response_m_payload) {
    ...
    if (ezmax_api_definition__full_ezsignformfieldgroup_get_object_v1_response_m_payload__NULL == ezsignformfieldgroup_get_object_v1_response_m_payload->e_ezsignformfieldgroup_type) {
        goto fail;
    }
    ...
    if (ezmax_api_definition__full_ezsignformfieldgroup_get_object_v1_response_m_payload__NULL == ezsignformfieldgroup_get_object_v1_response_m_payload->e_ezsignformfieldgroup_signerrequirement) {
        goto fail;
    }
    ...
    if(ezsignformfieldgroup_get_object_v1_response_m_payload->e_ezsignformfieldgroup_tooltipposition != ezmax_api_definition__full_ezsignformfieldgroup_get_object_v1_response_m_payload__NULL) {
    ...
    if (ezsignformfieldgroup_get_object_v1_response_m_payload->a_obj_ezsignformfieldgroupsigner) {
    list_ForEach(a_obj_ezsignformfieldgroupsignerListEntry, ezsignformfieldgroup_get_object_v1_response_m_payload->a_obj_ezsignformfieldgroupsigner) {
...
ezsignformfieldgroup_get_object_v1_response_m_payload_t *ezsignformfieldgroup_get_object_v1_response_m_payload_parseFromJSON(cJSON *ezsignformfieldgroup_get_object_v1_response_m_payloadJSON){
    ...
    // define the local list for ezsignformfieldgroup_get_object_v1_response_m_payload->a_obj_ezsignformfield
    list_t *a_obj_ezsignformfieldList = NULL;

    // define the local list for ezsignformfieldgroup_get_object_v1_response_m_payload->a_obj_dropdown_element
    list_t *a_obj_dropdown_elementList = NULL;

    // define the local list for ezsignformfieldgroup_get_object_v1_response_m_payload->a_obj_ezsignformfieldgroupsigner
