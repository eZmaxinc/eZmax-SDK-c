/*
 * rejectedoffertopurchase_get_communicationrecipients_v1_response_m_payload.h
 *
 * Response for GET /1/object/rejectedoffertopurchase/{pkiRejectedoffertopurchaseID}/getCommunicationrecipients
 */

#ifndef _rejectedoffertopurchase_get_communicationrecipients_v1_response_m_payload_H_
#define _rejectedoffertopurchase_get_communicationrecipients_v1_response_m_payload_H_
...
typedef struct rejectedoffertopurchase_get_communicationrecipients_v1_response_m_payload_t rejectedoffertopurchase_get_communicationrecipients_v1_response_m_payload_t;

#include "custom_communicationrecipientsgroup_response.h"



typedef struct rejectedoffertopurchase_get_communicationrecipients_v1_response_m_payload_t {
    list_t *a_obj_communicationrecipientsgroup; //nonprimitive container

    int _library_owned; // Is the library responsible for freeing this object?
} rejectedoffertopurchase_get_communicationrecipients_v1_response_m_payload_t;
...
#endif /* _rejectedoffertopurchase_get_communicationrecipients_v1_response_m_payload_H_ */
