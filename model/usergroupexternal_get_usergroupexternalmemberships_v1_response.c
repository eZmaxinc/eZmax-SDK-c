...
static usergroupexternal_get_usergroupexternalmemberships_v1_response_t *usergroupexternal_get_usergroupexternalmemberships_v1_response_create_internal(
    ...
    memset(usergroupexternal_get_usergroupexternalmemberships_v1_response_local_var, 0, sizeof(usergroupexternal_get_usergroupexternalmemberships_v1_response_t));
...
__attribute__((deprecated)) usergroupexternal_get_usergroupexternalmemberships_v1_response_t *usergroupexternal_get_usergroupexternalmemberships_v1_response_create(
    ...
    usergroupexternal_get_usergroupexternalmemberships_v1_response_t *result = usergroupexternal_get_usergroupexternalmemberships_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
