...
static webhook_send_webhook_v1_response_t *webhook_send_webhook_v1_response_create_internal(
    ...
    memset(webhook_send_webhook_v1_response_local_var, 0, sizeof(webhook_send_webhook_v1_response_t));
...
__attribute__((deprecated)) webhook_send_webhook_v1_response_t *webhook_send_webhook_v1_response_create(
    ...
    webhook_send_webhook_v1_response_t *result = webhook_send_webhook_v1_response_create_internal (
        obj_debug_payload,
        obj_debug
        );
    if (!result) {
