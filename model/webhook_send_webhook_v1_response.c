...
webhook_send_webhook_v1_response_t *webhook_send_webhook_v1_response_create(
...
webhook_send_webhook_v1_response_t *webhook_send_webhook_v1_response_parseFromJSON(cJSON *webhook_send_webhook_v1_responseJSON){
    ...
    webhook_send_webhook_v1_response_local_var = webhook_send_webhook_v1_response_create (
