...
static apikey_create_object_v2_response_t *apikey_create_object_v2_response_create_internal(
    ...
    memset(apikey_create_object_v2_response_local_var, 0, sizeof(apikey_create_object_v2_response_t));
...
__attribute__((deprecated)) apikey_create_object_v2_response_t *apikey_create_object_v2_response_create(
    ...
    apikey_create_object_v2_response_t *result = apikey_create_object_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
