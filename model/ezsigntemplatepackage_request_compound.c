...
static ezsigntemplatepackage_request_compound_t *ezsigntemplatepackage_request_compound_create_internal(
    ...
    memset(ezsigntemplatepackage_request_compound_local_var, 0, sizeof(ezsigntemplatepackage_request_compound_t));
...
__attribute__((deprecated)) ezsigntemplatepackage_request_compound_t *ezsigntemplatepackage_request_compound_create(
    ...
    ezsigntemplatepackage_request_compound_t *result = ezsigntemplatepackage_request_compound_create_internal (
...
void ezsigntemplatepackage_request_compound_free(ezsigntemplatepackage_request_compound_t *ezsigntemplatepackage_request_compound) {
    ...
    if (ezsigntemplatepackage_request_compound->pki_ezsigntemplatepackage_id) {
        free(ezsigntemplatepackage_request_compound->pki_ezsigntemplatepackage_id);
        ezsigntemplatepackage_request_compound->pki_ezsigntemplatepackage_id = NULL;
    }
    if (ezsigntemplatepackage_request_compound->fki_ezsignfoldertype_id) {
        free(ezsigntemplatepackage_request_compound->fki_ezsignfoldertype_id);
        ezsigntemplatepackage_request_compound->fki_ezsignfoldertype_id = NULL;
    }
    if (ezsigntemplatepackage_request_compound->fki_ezdoctemplatedocument_id) {
        free(ezsigntemplatepackage_request_compound->fki_ezdoctemplatedocument_id);
        ezsigntemplatepackage_request_compound->fki_ezdoctemplatedocument_id = NULL;
    }
    if (ezsigntemplatepackage_request_compound->fki_language_id) {
        free(ezsigntemplatepackage_request_compound->fki_language_id);
        ezsigntemplatepackage_request_compound->fki_language_id = NULL;
    }
    ...
    if (ezsigntemplatepackage_request_compound->b_ezsigntemplatepackage_adminonly) {
        free(ezsigntemplatepackage_request_compound->b_ezsigntemplatepackage_adminonly);
        ezsigntemplatepackage_request_compound->b_ezsigntemplatepackage_adminonly = NULL;
    }
    if (ezsigntemplatepackage_request_compound->b_ezsigntemplatepackage_isactive) {
        free(ezsigntemplatepackage_request_compound->b_ezsigntemplatepackage_isactive);
        ezsigntemplatepackage_request_compound->b_ezsigntemplatepackage_isactive = NULL;
    }
...
ezsigntemplatepackage_request_compound_t *ezsigntemplatepackage_request_compound_parseFromJSON(cJSON *ezsigntemplatepackage_request_compoundJSON){
    ...
    // define the local variable for ezsigntemplatepackage_request_compound->pki_ezsigntemplatepackage_id
    int *pki_ezsigntemplatepackage_id_local_var = NULL;

    // define the local variable for ezsigntemplatepackage_request_compound->fki_ezsignfoldertype_id
    int *fki_ezsignfoldertype_id_local_var = NULL;

    // define the local variable for ezsigntemplatepackage_request_compound->fki_ezdoctemplatedocument_id
    int *fki_ezdoctemplatedocument_id_local_var = NULL;

    // define the local variable for ezsigntemplatepackage_request_compound->fki_language_id
    int *fki_language_id_local_var = NULL;

    char *s_ezsigntemplatepackage_description_local_str = NULL;

    // define the local variable for ezsigntemplatepackage_request_compound->b_ezsigntemplatepackage_adminonly
    int *b_ezsigntemplatepackage_adminonly_local_var = NULL;

    // define the local variable for ezsigntemplatepackage_request_compound->b_ezsigntemplatepackage_isactive
