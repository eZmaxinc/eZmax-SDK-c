...
static ezsigntemplatepackagesigner_get_object_v2_response_t *ezsigntemplatepackagesigner_get_object_v2_response_create_internal(
    ...
    memset(ezsigntemplatepackagesigner_get_object_v2_response_local_var, 0, sizeof(ezsigntemplatepackagesigner_get_object_v2_response_t));
...
__attribute__((deprecated)) ezsigntemplatepackagesigner_get_object_v2_response_t *ezsigntemplatepackagesigner_get_object_v2_response_create(
    ...
    ezsigntemplatepackagesigner_get_object_v2_response_t *result = ezsigntemplatepackagesigner_get_object_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
