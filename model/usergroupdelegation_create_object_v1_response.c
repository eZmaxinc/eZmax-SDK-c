...
static usergroupdelegation_create_object_v1_response_t *usergroupdelegation_create_object_v1_response_create_internal(
    ...
    memset(usergroupdelegation_create_object_v1_response_local_var, 0, sizeof(usergroupdelegation_create_object_v1_response_t));
...
__attribute__((deprecated)) usergroupdelegation_create_object_v1_response_t *usergroupdelegation_create_object_v1_response_create(
    ...
    usergroupdelegation_create_object_v1_response_t *result = usergroupdelegation_create_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
