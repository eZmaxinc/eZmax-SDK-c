/*
 * period_get_autocomplete_v2_response_all_of.h
 *
 * 
 */

#ifndef _period_get_autocomplete_v2_response_all_of_H_
#define _period_get_autocomplete_v2_response_all_of_H_
...
typedef struct period_get_autocomplete_v2_response_all_of_t period_get_autocomplete_v2_response_all_of_t;

#include "period_get_autocomplete_v2_response_m_payload.h"



typedef struct period_get_autocomplete_v2_response_all_of_t {
    struct period_get_autocomplete_v2_response_m_payload_t *m_payload; //model

} period_get_autocomplete_v2_response_all_of_t;
...
#endif /* _period_get_autocomplete_v2_response_all_of_H_ */
