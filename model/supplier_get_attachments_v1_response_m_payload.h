/*
 * supplier_get_attachments_v1_response_m_payload.h
 *
 * Response for GET /1/object/supplier/{pkiSupplierID}/getAttachments
 */

#ifndef _supplier_get_attachments_v1_response_m_payload_H_
#define _supplier_get_attachments_v1_response_m_payload_H_
...
typedef struct supplier_get_attachments_v1_response_m_payload_t supplier_get_attachments_v1_response_m_payload_t;

#include "custom_attachmentdocumenttype_response.h"



typedef struct supplier_get_attachments_v1_response_m_payload_t {
    list_t *a_obj_attachmentdocumenttype; //nonprimitive container

    int _library_owned; // Is the library responsible for freeing this object?
} supplier_get_attachments_v1_response_m_payload_t;
...
#endif /* _supplier_get_attachments_v1_response_m_payload_H_ */
