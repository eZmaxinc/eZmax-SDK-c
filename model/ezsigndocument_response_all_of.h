...
typedef enum  { ezmax_api_definition_ezsigndocument_response_all_of__NULL = 0, ezmax_api_definition_ezsigndocument_response_all_of__Unsent, ezmax_api_definition_ezsigndocument_response_all_of___Unsigned, ezmax_api_definition_ezsigndocument_response_all_of__PartiallySigned, ezmax_api_definition_ezsigndocument_response_all_of__DeclinedToSign, ezmax_api_definition_ezsigndocument_response_all_of__PrematurelyEnded, ezmax_api_definition_ezsigndocument_response_all_of__Completed } ezmax_api_definition_ezsigndocument_response_all_of__e;
