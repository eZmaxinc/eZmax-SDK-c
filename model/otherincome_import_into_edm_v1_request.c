...
static otherincome_import_into_edm_v1_request_t *otherincome_import_into_edm_v1_request_create_internal(
    ...
    memset(otherincome_import_into_edm_v1_request_local_var, 0, sizeof(otherincome_import_into_edm_v1_request_t));
...
__attribute__((deprecated)) otherincome_import_into_edm_v1_request_t *otherincome_import_into_edm_v1_request_create(
    ...
    otherincome_import_into_edm_v1_request_t *result = otherincome_import_into_edm_v1_request_create_internal (
        a_obj_attachment
        );
    if (!result) {
    }
