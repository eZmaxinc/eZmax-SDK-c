/*
 * creditcardclient_get_list_v1_response.h
 *
 * Response for GET /1/object/creditcardclient/getList
 */

#ifndef _creditcardclient_get_list_v1_response_H_
#define _creditcardclient_get_list_v1_response_H_
...
typedef struct creditcardclient_get_list_v1_response_t creditcardclient_get_list_v1_response_t;
...
typedef struct creditcardclient_get_list_v1_response_t {
    struct common_response_obj_debug_payload_get_list_t *obj_debug_payload; //model
    struct common_response_obj_debug_t *obj_debug; //model
    struct creditcardclient_get_list_v1_response_m_payload_t *m_payload; //model

} creditcardclient_get_list_v1_response_t;

creditcardclient_get_list_v1_response_t *creditcardclient_get_list_v1_response_create(
...
#endif /* _creditcardclient_get_list_v1_response_H_ */
