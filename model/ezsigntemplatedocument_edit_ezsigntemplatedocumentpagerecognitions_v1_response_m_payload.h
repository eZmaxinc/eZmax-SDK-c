/*
 * ezsigntemplatedocument_edit_ezsigntemplatedocumentpagerecognitions_v1_response_m_payload.h
 *
 * Response for PUT /1/object/ezsigntemplatedocument/{pkiEzsigntemplatedocumentID}/EditEzsigntemplatedocumentpagerecognitions
 */

#ifndef _ezsigntemplatedocument_edit_ezsigntemplatedocumentpagerecognitions_v1_response_m_payload_H_
#define _ezsigntemplatedocument_edit_ezsigntemplatedocumentpagerecognitions_v1_response_m_payload_H_
...
typedef struct ezsigntemplatedocument_edit_ezsigntemplatedocumentpagerecognitions_v1_response_m_payload_t ezsigntemplatedocument_edit_ezsigntemplatedocumentpagerecognitions_v1_response_m_payload_t;




typedef struct ezsigntemplatedocument_edit_ezsigntemplatedocumentpagerecognitions_v1_response_m_payload_t {
    list_t *a_pki_ezsigntemplatedocumentpagerecognition_id; //primitive container

} ezsigntemplatedocument_edit_ezsigntemplatedocumentpagerecognitions_v1_response_m_payload_t;
...
#endif /* _ezsigntemplatedocument_edit_ezsigntemplatedocumentpagerecognitions_v1_response_m_payload_H_ */
