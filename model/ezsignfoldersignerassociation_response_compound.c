...
static ezsignfoldersignerassociation_response_compound_t *ezsignfoldersignerassociation_response_compound_create_internal(
    ...
    memset(ezsignfoldersignerassociation_response_compound_local_var, 0, sizeof(ezsignfoldersignerassociation_response_compound_t));
...
__attribute__((deprecated)) ezsignfoldersignerassociation_response_compound_t *ezsignfoldersignerassociation_response_compound_create(
    ...
    ezsignfoldersignerassociation_response_compound_t *result = ezsignfoldersignerassociation_response_compound_create_internal (
...
void ezsignfoldersignerassociation_response_compound_free(ezsignfoldersignerassociation_response_compound_t *ezsignfoldersignerassociation_response_compound) {
    ...
    if (ezsignfoldersignerassociation_response_compound->pki_ezsignfoldersignerassociation_id) {
        free(ezsignfoldersignerassociation_response_compound->pki_ezsignfoldersignerassociation_id);
        ezsignfoldersignerassociation_response_compound->pki_ezsignfoldersignerassociation_id = NULL;
    }
    if (ezsignfoldersignerassociation_response_compound->fki_ezsignfolder_id) {
        free(ezsignfoldersignerassociation_response_compound->fki_ezsignfolder_id);
        ezsignfoldersignerassociation_response_compound->fki_ezsignfolder_id = NULL;
    }
    if (ezsignfoldersignerassociation_response_compound->b_ezsignfoldersignerassociation_delayedsend) {
        free(ezsignfoldersignerassociation_response_compound->b_ezsignfoldersignerassociation_delayedsend);
        ezsignfoldersignerassociation_response_compound->b_ezsignfoldersignerassociation_delayedsend = NULL;
    }
    if (ezsignfoldersignerassociation_response_compound->b_ezsignfoldersignerassociation_receivecopy) {
        free(ezsignfoldersignerassociation_response_compound->b_ezsignfoldersignerassociation_receivecopy);
        ezsignfoldersignerassociation_response_compound->b_ezsignfoldersignerassociation_receivecopy = NULL;
    }
    ...
    if (ezsignfoldersignerassociation_response_compound->b_ezsignfoldersignerassociation_allowsigninginperson) {
        free(ezsignfoldersignerassociation_response_compound->b_ezsignfoldersignerassociation_allowsigninginperson);
        ezsignfoldersignerassociation_response_compound->b_ezsignfoldersignerassociation_allowsigninginperson = NULL;
    }
...
ezsignfoldersignerassociation_response_compound_t *ezsignfoldersignerassociation_response_compound_parseFromJSON(cJSON *ezsignfoldersignerassociation_response_compoundJSON){
    ...
    // define the local variable for ezsignfoldersignerassociation_response_compound->pki_ezsignfoldersignerassociation_id
    int *pki_ezsignfoldersignerassociation_id_local_var = NULL;

    // define the local variable for ezsignfoldersignerassociation_response_compound->fki_ezsignfolder_id
    int *fki_ezsignfolder_id_local_var = NULL;

    // define the local variable for ezsignfoldersignerassociation_response_compound->b_ezsignfoldersignerassociation_delayedsend
    int *b_ezsignfoldersignerassociation_delayedsend_local_var = NULL;

    // define the local variable for ezsignfoldersignerassociation_response_compound->b_ezsignfoldersignerassociation_receivecopy
    ...
    // define the local variable for ezsignfoldersignerassociation_response_compound->b_ezsignfoldersignerassociation_allowsigninginperson
