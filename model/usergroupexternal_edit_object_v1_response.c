...
static usergroupexternal_edit_object_v1_response_t *usergroupexternal_edit_object_v1_response_create_internal(
    ...
    memset(usergroupexternal_edit_object_v1_response_local_var, 0, sizeof(usergroupexternal_edit_object_v1_response_t));
    usergroupexternal_edit_object_v1_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) usergroupexternal_edit_object_v1_response_t *usergroupexternal_edit_object_v1_response_create(
    common_response_obj_debug_payload_t *obj_debug_payload,
    common_response_obj_debug_t *obj_debug
    ) {
    usergroupexternal_edit_object_v1_response_t *result = usergroupexternal_edit_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug
        );
    if (!result) {
...
void usergroupexternal_edit_object_v1_response_free(usergroupexternal_edit_object_v1_response_t *usergroupexternal_edit_object_v1_response) {
    ...
    if(usergroupexternal_edit_object_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "usergroupexternal_edit_object_v1_response_free");
        return ;
    }
...
usergroupexternal_edit_object_v1_response_t *usergroupexternal_edit_object_v1_response_parseFromJSON(cJSON *usergroupexternal_edit_object_v1_responseJSON){
    ...
    usergroupexternal_edit_object_v1_response_local_var = usergroupexternal_edit_object_v1_response_create_internal (
