...
static userstaged_get_list_v1_response_t *userstaged_get_list_v1_response_create_internal(
    ...
    memset(userstaged_get_list_v1_response_local_var, 0, sizeof(userstaged_get_list_v1_response_t));
...
__attribute__((deprecated)) userstaged_get_list_v1_response_t *userstaged_get_list_v1_response_create(
    ...
    userstaged_get_list_v1_response_t *result = userstaged_get_list_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
