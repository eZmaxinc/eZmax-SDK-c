...
textstylestatic_request_compound_t *textstylestatic_request_compound_create(
    int fki_font_id,
...
textstylestatic_request_compound_t *textstylestatic_request_compound_parseFromJSON(cJSON *textstylestatic_request_compoundJSON){
    ...
    textstylestatic_request_compound_local_var = textstylestatic_request_compound_create (
