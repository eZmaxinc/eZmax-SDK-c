...
static paymentterm_get_autocomplete_v2_response_t *paymentterm_get_autocomplete_v2_response_create_internal(
...
void paymentterm_get_autocomplete_v2_response_free(paymentterm_get_autocomplete_v2_response_t *paymentterm_get_autocomplete_v2_response) {
    ...
    if(paymentterm_get_autocomplete_v2_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "paymentterm_get_autocomplete_v2_response_free");
        return ;
    }
