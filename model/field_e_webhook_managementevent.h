...
typedef enum { ezmax_api_definition__full_field_e_webhook_managementevent__NULL = 0, ezmax_api_definition__full_field_e_webhook_managementevent__UserCreated } ezmax_api_definition__full_field_e_webhook_managementevent__e;
