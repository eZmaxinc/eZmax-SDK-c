...
typedef enum { ezmax_api_definition__full_field_e_ezsignfolder_completion__NULL = 0, ezmax_api_definition__full_field_e_ezsignfolder_completion__PerEzsigndocument, ezmax_api_definition__full_field_e_ezsignfolder_completion__PerEzsignfolder, ezmax_api_definition__full_field_e_ezsignfolder_completion__PerEzsignfolderStepSync } ezmax_api_definition__full_field_e_ezsignfolder_completion__e;
