...
paymentterm_create_object_v1_response_m_payload_t *paymentterm_create_object_v1_response_m_payload_create(
...
paymentterm_create_object_v1_response_m_payload_t *paymentterm_create_object_v1_response_m_payload_parseFromJSON(cJSON *paymentterm_create_object_v1_response_m_payloadJSON){
    ...
    cJSON_ArrayForEach(a_pki_paymentterm_id_local, a_pki_paymentterm_id)
    {
        ...
        double *a_pki_paymentterm_id_local_value = (double *)calloc(1, sizeof(double));
    ...
    paymentterm_create_object_v1_response_m_payload_local_var = paymentterm_create_object_v1_response_m_payload_create (
