/*
 * notary_get_communication_count_v1_response_m_payload.h
 *
 * Response for GET /1/object/notary/{pkiNotaryID}/getCommunicationCount
 */

#ifndef _notary_get_communication_count_v1_response_m_payload_H_
#define _notary_get_communication_count_v1_response_m_payload_H_
...
typedef struct notary_get_communication_count_v1_response_m_payload_t notary_get_communication_count_v1_response_m_payload_t;




typedef struct notary_get_communication_count_v1_response_m_payload_t {
    int *i_communication_count; //numeric

    int _library_owned; // Is the library responsible for freeing this object?
} notary_get_communication_count_v1_response_m_payload_t;
...
#endif /* _notary_get_communication_count_v1_response_m_payload_H_ */
