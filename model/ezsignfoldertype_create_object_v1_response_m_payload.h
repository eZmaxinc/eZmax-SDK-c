/*
 * ezsignfoldertype_create_object_v1_response_m_payload.h
 *
 * Payload for POST /1/object/ezsignfoldertype
 */

#ifndef _ezsignfoldertype_create_object_v1_response_m_payload_H_
#define _ezsignfoldertype_create_object_v1_response_m_payload_H_
...
typedef struct ezsignfoldertype_create_object_v1_response_m_payload_t ezsignfoldertype_create_object_v1_response_m_payload_t;




typedef struct ezsignfoldertype_create_object_v1_response_m_payload_t {
    list_t *a_pki_ezsignfoldertype_id; //primitive container

} ezsignfoldertype_create_object_v1_response_m_payload_t;
...
#endif /* _ezsignfoldertype_create_object_v1_response_m_payload_H_ */
