...
static userstaged_get_list_v1_response_m_payload_t *userstaged_get_list_v1_response_m_payload_create_internal(
    ...
    memset(userstaged_get_list_v1_response_m_payload_local_var, 0, sizeof(userstaged_get_list_v1_response_m_payload_t));
...
__attribute__((deprecated)) userstaged_get_list_v1_response_m_payload_t *userstaged_get_list_v1_response_m_payload_create(
    ...
    userstaged_get_list_v1_response_m_payload_t *result = userstaged_get_list_v1_response_m_payload_create_internal (
        i_row_returned_copy,
        i_row_filtered_copy,
        a_obj_userstaged
        );
...
void userstaged_get_list_v1_response_m_payload_free(userstaged_get_list_v1_response_m_payload_t *userstaged_get_list_v1_response_m_payload) {
    ...
    if (userstaged_get_list_v1_response_m_payload->i_row_returned) {
        free(userstaged_get_list_v1_response_m_payload->i_row_returned);
        userstaged_get_list_v1_response_m_payload->i_row_returned = NULL;
    }
    if (userstaged_get_list_v1_response_m_payload->i_row_filtered) {
        free(userstaged_get_list_v1_response_m_payload->i_row_filtered);
        userstaged_get_list_v1_response_m_payload->i_row_filtered = NULL;
    }
...
userstaged_get_list_v1_response_m_payload_t *userstaged_get_list_v1_response_m_payload_parseFromJSON(cJSON *userstaged_get_list_v1_response_m_payloadJSON){
    ...
    // define the local variable for userstaged_get_list_v1_response_m_payload->i_row_returned
    int *i_row_returned_local_var = NULL;

    // define the local variable for userstaged_get_list_v1_response_m_payload->i_row_filtered
