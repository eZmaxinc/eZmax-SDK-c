/*
 * reconciliation_get_attachments_v1_response_m_payload.h
 *
 * Response for GET /1/object/reconciliation/{pkiReconciliationID}/getAttachments
 */

#ifndef _reconciliation_get_attachments_v1_response_m_payload_H_
#define _reconciliation_get_attachments_v1_response_m_payload_H_
...
typedef struct reconciliation_get_attachments_v1_response_m_payload_t reconciliation_get_attachments_v1_response_m_payload_t;

#include "custom_attachmentdocumenttype_response.h"



typedef struct reconciliation_get_attachments_v1_response_m_payload_t {
    list_t *a_obj_attachmentdocumenttype; //nonprimitive container

    int _library_owned; // Is the library responsible for freeing this object?
} reconciliation_get_attachments_v1_response_m_payload_t;
...
#endif /* _reconciliation_get_attachments_v1_response_m_payload_H_ */
