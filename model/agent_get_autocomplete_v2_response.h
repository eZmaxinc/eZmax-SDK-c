/*
 * agent_get_autocomplete_v2_response.h
 *
 * Response for GET /2/object/agent/getAutocomplete
 */

#ifndef _agent_get_autocomplete_v2_response_H_
#define _agent_get_autocomplete_v2_response_H_
...
typedef struct agent_get_autocomplete_v2_response_t agent_get_autocomplete_v2_response_t;
...
typedef struct agent_get_autocomplete_v2_response_t {
    struct common_response_obj_debug_payload_t *obj_debug_payload; //model
    struct common_response_obj_debug_t *obj_debug; //model
    struct agent_get_autocomplete_v2_response_m_payload_t *m_payload; //model
...
#endif /* _agent_get_autocomplete_v2_response_H_ */
