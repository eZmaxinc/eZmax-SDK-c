/*
 * ezsigntemplatepublic_reset_url_v1_response.h
 *
 * Response for POST /1/object/ezsigntemplatepublic/{pkiEzsigntemplatepublicID}/resetUrl
 */

#ifndef _ezsigntemplatepublic_reset_url_v1_response_H_
#define _ezsigntemplatepublic_reset_url_v1_response_H_
...
typedef struct ezsigntemplatepublic_reset_url_v1_response_t ezsigntemplatepublic_reset_url_v1_response_t;
...
typedef struct ezsigntemplatepublic_reset_url_v1_response_t {
    struct common_response_obj_debug_payload_t *obj_debug_payload; //model
    struct common_response_obj_debug_t *obj_debug; //model
    struct ezsigntemplatepublic_reset_url_v1_response_m_payload_t *m_payload; //model
...
#endif /* _ezsigntemplatepublic_reset_url_v1_response_H_ */
