...
typedef enum  { ezmax_api_definition__full_webhook_list_element__NULL = 0, ezmax_api_definition__full_webhook_list_element__DocumentCompleted, ezmax_api_definition__full_webhook_list_element__FolderCompleted } ezmax_api_definition__full_webhook_list_element__e;
...
typedef enum  { ezmax_api_definition__full_webhook_list_element__NULL = 0, ezmax_api_definition__full_webhook_list_element__UserCreated } ezmax_api_definition__full_webhook_list_element__e;
