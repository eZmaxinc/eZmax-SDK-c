...
static electronicfundstransfer_get_communicationrecipients_v1_response_t *electronicfundstransfer_get_communicationrecipients_v1_response_create_internal(
    ...
    memset(electronicfundstransfer_get_communicationrecipients_v1_response_local_var, 0, sizeof(electronicfundstransfer_get_communicationrecipients_v1_response_t));
...
__attribute__((deprecated)) electronicfundstransfer_get_communicationrecipients_v1_response_t *electronicfundstransfer_get_communicationrecipients_v1_response_create(
    ...
    electronicfundstransfer_get_communicationrecipients_v1_response_t *result = electronicfundstransfer_get_communicationrecipients_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
