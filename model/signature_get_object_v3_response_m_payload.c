...
static signature_get_object_v3_response_m_payload_t *signature_get_object_v3_response_m_payload_create_internal(
...
void signature_get_object_v3_response_m_payload_free(signature_get_object_v3_response_m_payload_t *signature_get_object_v3_response_m_payload) {
    ...
    if(signature_get_object_v3_response_m_payload->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "signature_get_object_v3_response_m_payload_free");
        return ;
    }
