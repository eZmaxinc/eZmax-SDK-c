...
static rejectedoffertopurchase_get_communicationrecipients_v1_response_m_payload_t *rejectedoffertopurchase_get_communicationrecipients_v1_response_m_payload_create_internal(
...
void rejectedoffertopurchase_get_communicationrecipients_v1_response_m_payload_free(rejectedoffertopurchase_get_communicationrecipients_v1_response_m_payload_t *rejectedoffertopurchase_get_communicationrecipients_v1_response_m_payload) {
    ...
    if(rejectedoffertopurchase_get_communicationrecipients_v1_response_m_payload->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "rejectedoffertopurchase_get_communicationrecipients_v1_response_m_payload_free");
        return ;
    }
