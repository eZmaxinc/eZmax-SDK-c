...
char* e_paymentterm_typepaymentterm_response_compound_ToString(ezmax_api_definition__full_paymentterm_response_compound__e e_paymentterm_type) {
    char* e_paymentterm_typeArray[] =  { "NULL", "Days", "Dayofthemonth" };
	return e_paymentterm_typeArray[e_paymentterm_type];
}

ezmax_api_definition__full_paymentterm_response_compound__e e_paymentterm_typepaymentterm_response_compound_FromString(char* e_paymentterm_type){
...
void paymentterm_response_compound_free(paymentterm_response_compound_t *paymentterm_response_compound) {
    ...
    if (paymentterm_response_compound->e_paymentterm_type) {
        field_e_paymentterm_type_free(paymentterm_response_compound->e_paymentterm_type);
        paymentterm_response_compound->e_paymentterm_type = NULL;
    }
...
cJSON *paymentterm_response_compound_convertToJSON(paymentterm_response_compound_t *paymentterm_response_compound) {
    ...
    if (ezmax_api_definition__full_paymentterm_response_compound__NULL == paymentterm_response_compound->e_paymentterm_type) {
        goto fail;
    }
...
paymentterm_response_compound_t *paymentterm_response_compound_parseFromJSON(cJSON *paymentterm_response_compoundJSON){
    ...
    paymentterm_response_compound_local_var = paymentterm_response_compound_create (
