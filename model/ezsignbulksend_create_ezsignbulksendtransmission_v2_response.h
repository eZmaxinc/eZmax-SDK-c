/*
 * ezsignbulksend_create_ezsignbulksendtransmission_v2_response.h
 *
 * Response for POST /2/object/ezsignbulksend/{pkiEzsignbulksendID}/createEzsignbulksendtransmission
 */

#ifndef _ezsignbulksend_create_ezsignbulksendtransmission_v2_response_H_
#define _ezsignbulksend_create_ezsignbulksendtransmission_v2_response_H_
...
typedef struct ezsignbulksend_create_ezsignbulksendtransmission_v2_response_t {
    struct common_response_obj_debug_payload_t *obj_debug_payload; //model
    struct common_response_obj_debug_t *obj_debug; //model
    struct ezsignbulksend_create_ezsignbulksendtransmission_v2_response_m_payload_t *m_payload; //model

} ezsignbulksend_create_ezsignbulksendtransmission_v2_response_t;

ezsignbulksend_create_ezsignbulksendtransmission_v2_response_t *ezsignbulksend_create_ezsignbulksendtransmission_v2_response_create(
...
#endif /* _ezsignbulksend_create_ezsignbulksendtransmission_v2_response_H_ */
