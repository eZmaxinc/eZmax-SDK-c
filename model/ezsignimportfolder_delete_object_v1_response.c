...
static ezsignimportfolder_delete_object_v1_response_t *ezsignimportfolder_delete_object_v1_response_create_internal(
    ...
    memset(ezsignimportfolder_delete_object_v1_response_local_var, 0, sizeof(ezsignimportfolder_delete_object_v1_response_t));
...
__attribute__((deprecated)) ezsignimportfolder_delete_object_v1_response_t *ezsignimportfolder_delete_object_v1_response_create(
    ...
    ezsignimportfolder_delete_object_v1_response_t *result = ezsignimportfolder_delete_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug
        );
    if (!result) {
