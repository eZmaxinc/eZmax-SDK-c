...
static ezsignsigningreason_get_object_v2_response_t *ezsignsigningreason_get_object_v2_response_create_internal(
    ...
    memset(ezsignsigningreason_get_object_v2_response_local_var, 0, sizeof(ezsignsigningreason_get_object_v2_response_t));
    ezsignsigningreason_get_object_v2_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezsignsigningreason_get_object_v2_response_t *ezsignsigningreason_get_object_v2_response_create(
    common_response_obj_debug_payload_t *obj_debug_payload,
    common_response_obj_debug_t *obj_debug,
    ezsignsigningreason_get_object_v2_response_m_payload_t *m_payload
    ) {
    ezsignsigningreason_get_object_v2_response_t *result = ezsignsigningreason_get_object_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void ezsignsigningreason_get_object_v2_response_free(ezsignsigningreason_get_object_v2_response_t *ezsignsigningreason_get_object_v2_response) {
    ...
    if(ezsignsigningreason_get_object_v2_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsignsigningreason_get_object_v2_response_free");
        return ;
    }
...
ezsignsigningreason_get_object_v2_response_t *ezsignsigningreason_get_object_v2_response_parseFromJSON(cJSON *ezsignsigningreason_get_object_v2_responseJSON){
    ...
    ezsignsigningreason_get_object_v2_response_local_var = ezsignsigningreason_get_object_v2_response_create_internal (
