/*
 * tranqcontract_get_communicationsenders_v1_response_m_payload.h
 *
 * Response for GET /1/object/tranqcontract/{pkiTranqcontractID}/getCommunicationsenders
 */

#ifndef _tranqcontract_get_communicationsenders_v1_response_m_payload_H_
#define _tranqcontract_get_communicationsenders_v1_response_m_payload_H_
...
typedef struct tranqcontract_get_communicationsenders_v1_response_m_payload_t tranqcontract_get_communicationsenders_v1_response_m_payload_t;

#include "custom_communicationsender_response.h"



typedef struct tranqcontract_get_communicationsenders_v1_response_m_payload_t {
    list_t *a_obj_communicationsenders; //nonprimitive container

    int _library_owned; // Is the library responsible for freeing this object?
} tranqcontract_get_communicationsenders_v1_response_m_payload_t;
...
#endif /* _tranqcontract_get_communicationsenders_v1_response_m_payload_H_ */
