/*
 * agent_get_communicationsenders_v1_response_m_payload.h
 *
 * Response for GET /1/object/agent/{pkiAgentID}/getCommunicationsenders
 */

#ifndef _agent_get_communicationsenders_v1_response_m_payload_H_
#define _agent_get_communicationsenders_v1_response_m_payload_H_
...
typedef struct agent_get_communicationsenders_v1_response_m_payload_t agent_get_communicationsenders_v1_response_m_payload_t;

#include "custom_communicationsender_response.h"



typedef struct agent_get_communicationsenders_v1_response_m_payload_t {
    list_t *a_obj_communicationsenders; //nonprimitive container

    int _library_owned; // Is the library responsible for freeing this object?
} agent_get_communicationsenders_v1_response_m_payload_t;
...
#endif /* _agent_get_communicationsenders_v1_response_m_payload_H_ */
