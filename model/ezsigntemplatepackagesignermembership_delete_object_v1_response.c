...
static ezsigntemplatepackagesignermembership_delete_object_v1_response_t *ezsigntemplatepackagesignermembership_delete_object_v1_response_create_internal(
    ...
    memset(ezsigntemplatepackagesignermembership_delete_object_v1_response_local_var, 0, sizeof(ezsigntemplatepackagesignermembership_delete_object_v1_response_t));
    ezsigntemplatepackagesignermembership_delete_object_v1_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezsigntemplatepackagesignermembership_delete_object_v1_response_t *ezsigntemplatepackagesignermembership_delete_object_v1_response_create(
    ...
    ezsigntemplatepackagesignermembership_delete_object_v1_response_t *result = ezsigntemplatepackagesignermembership_delete_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void ezsigntemplatepackagesignermembership_delete_object_v1_response_free(ezsigntemplatepackagesignermembership_delete_object_v1_response_t *ezsigntemplatepackagesignermembership_delete_object_v1_response) {
    ...
    if(ezsigntemplatepackagesignermembership_delete_object_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsigntemplatepackagesignermembership_delete_object_v1_response_free");
        return ;
    }
...
ezsigntemplatepackagesignermembership_delete_object_v1_response_t *ezsigntemplatepackagesignermembership_delete_object_v1_response_parseFromJSON(cJSON *ezsigntemplatepackagesignermembership_delete_object_v1_responseJSON){
    ...
    ezsigntemplatepackagesignermembership_delete_object_v1_response_local_var = ezsigntemplatepackagesignermembership_delete_object_v1_response_create_internal (
