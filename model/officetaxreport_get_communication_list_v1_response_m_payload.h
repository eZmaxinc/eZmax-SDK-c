/*
 * officetaxreport_get_communication_list_v1_response_m_payload.h
 *
 * Response for GET /1/object/officetaxreport/{pkiOfficetaxreportID}/getCommunicationList
 */

#ifndef _officetaxreport_get_communication_list_v1_response_m_payload_H_
#define _officetaxreport_get_communication_list_v1_response_m_payload_H_
...
typedef struct officetaxreport_get_communication_list_v1_response_m_payload_t officetaxreport_get_communication_list_v1_response_m_payload_t;

#include "custom_communication_list_element_response.h"



typedef struct officetaxreport_get_communication_list_v1_response_m_payload_t {
    list_t *a_obj_communication; //nonprimitive container

    int _library_owned; // Is the library responsible for freeing this object?
} officetaxreport_get_communication_list_v1_response_m_payload_t;
...
#endif /* _officetaxreport_get_communication_list_v1_response_m_payload_H_ */
