/*
 * customer_get_communication_count_v1_response_m_payload.h
 *
 * Response for GET /1/object/customer/{pkiCustomerID}/getCommunicationCount
 */

#ifndef _customer_get_communication_count_v1_response_m_payload_H_
#define _customer_get_communication_count_v1_response_m_payload_H_
...
typedef struct customer_get_communication_count_v1_response_m_payload_t customer_get_communication_count_v1_response_m_payload_t;




typedef struct customer_get_communication_count_v1_response_m_payload_t {
    int *i_communication_count; //numeric

    int _library_owned; // Is the library responsible for freeing this object?
} customer_get_communication_count_v1_response_m_payload_t;
...
#endif /* _customer_get_communication_count_v1_response_m_payload_H_ */
