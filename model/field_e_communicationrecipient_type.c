...
cJSON *field_e_communicationrecipient_type_convertToJSON(ezmax_api_definition__full_field_e_communicationrecipient_type__e field_e_communicationrecipient_type) {
...
ezmax_api_definition__full_field_e_communicationrecipient_type__e field_e_communicationrecipient_type_parseFromJSON(cJSON *field_e_communicationrecipient_typeJSON) {
    if(!cJSON_IsString(field_e_communicationrecipient_typeJSON) || (field_e_communicationrecipient_typeJSON->valuestring == NULL)) {
        return 0;
    }
    return field_e_communicationrecipient_type_field_e_communicationrecipient_type_FromString(field_e_communicationrecipient_typeJSON->valuestring);
}
