...
static ezsignformfieldgroup_response_t *ezsignformfieldgroup_response_create_internal(
    ...
    memset(ezsignformfieldgroup_response_local_var, 0, sizeof(ezsignformfieldgroup_response_t));
...
__attribute__((deprecated)) ezsignformfieldgroup_response_t *ezsignformfieldgroup_response_create(
    ...
    ezsignformfieldgroup_response_t *result = ezsignformfieldgroup_response_create_internal (
...
void ezsignformfieldgroup_response_free(ezsignformfieldgroup_response_t *ezsignformfieldgroup_response) {
    ...
    if (ezsignformfieldgroup_response->pki_ezsignformfieldgroup_id) {
        free(ezsignformfieldgroup_response->pki_ezsignformfieldgroup_id);
        ezsignformfieldgroup_response->pki_ezsignformfieldgroup_id = NULL;
    }
    if (ezsignformfieldgroup_response->fki_ezsigndocument_id) {
        free(ezsignformfieldgroup_response->fki_ezsigndocument_id);
        ezsignformfieldgroup_response->fki_ezsigndocument_id = NULL;
    }
    ...
    if (ezsignformfieldgroup_response->i_ezsignformfieldgroup_step) {
        free(ezsignformfieldgroup_response->i_ezsignformfieldgroup_step);
        ezsignformfieldgroup_response->i_ezsignformfieldgroup_step = NULL;
    }
    ...
    if (ezsignformfieldgroup_response->i_ezsignformfieldgroup_filledmin) {
        free(ezsignformfieldgroup_response->i_ezsignformfieldgroup_filledmin);
        ezsignformfieldgroup_response->i_ezsignformfieldgroup_filledmin = NULL;
    }
    if (ezsignformfieldgroup_response->i_ezsignformfieldgroup_filledmax) {
        free(ezsignformfieldgroup_response->i_ezsignformfieldgroup_filledmax);
        ezsignformfieldgroup_response->i_ezsignformfieldgroup_filledmax = NULL;
    }
    if (ezsignformfieldgroup_response->b_ezsignformfieldgroup_readonly) {
        free(ezsignformfieldgroup_response->b_ezsignformfieldgroup_readonly);
        ezsignformfieldgroup_response->b_ezsignformfieldgroup_readonly = NULL;
    }
    if (ezsignformfieldgroup_response->i_ezsignformfieldgroup_maxlength) {
        free(ezsignformfieldgroup_response->i_ezsignformfieldgroup_maxlength);
        ezsignformfieldgroup_response->i_ezsignformfieldgroup_maxlength = NULL;
    }
    if (ezsignformfieldgroup_response->b_ezsignformfieldgroup_encrypted) {
        free(ezsignformfieldgroup_response->b_ezsignformfieldgroup_encrypted);
        ezsignformfieldgroup_response->b_ezsignformfieldgroup_encrypted = NULL;
    }
...
ezsignformfieldgroup_response_t *ezsignformfieldgroup_response_parseFromJSON(cJSON *ezsignformfieldgroup_responseJSON){
    ...
    // define the local variable for ezsignformfieldgroup_response->pki_ezsignformfieldgroup_id
    int *pki_ezsignformfieldgroup_id_local_var = NULL;

    // define the local variable for ezsignformfieldgroup_response->fki_ezsigndocument_id
    ...
    // define the local variable for ezsignformfieldgroup_response->i_ezsignformfieldgroup_step
    int *i_ezsignformfieldgroup_step_local_var = NULL;

    char *s_ezsignformfieldgroup_defaultvalue_local_str = NULL;

    // define the local variable for ezsignformfieldgroup_response->i_ezsignformfieldgroup_filledmin
    int *i_ezsignformfieldgroup_filledmin_local_var = NULL;

    // define the local variable for ezsignformfieldgroup_response->i_ezsignformfieldgroup_filledmax
    int *i_ezsignformfieldgroup_filledmax_local_var = NULL;

    // define the local variable for ezsignformfieldgroup_response->b_ezsignformfieldgroup_readonly
    int *b_ezsignformfieldgroup_readonly_local_var = NULL;

    // define the local variable for ezsignformfieldgroup_response->i_ezsignformfieldgroup_maxlength
    int *i_ezsignformfieldgroup_maxlength_local_var = NULL;

    // define the local variable for ezsignformfieldgroup_response->b_ezsignformfieldgroup_encrypted
