...
void ezdoctemplatedocument_response_compound_free(ezdoctemplatedocument_response_compound_t *ezdoctemplatedocument_response_compound) {
    ...
    if (ezdoctemplatedocument_response_compound->e_ezdoctemplatedocument_privacylevel) {
        field_e_ezdoctemplatedocument_privacylevel_free(ezdoctemplatedocument_response_compound->e_ezdoctemplatedocument_privacylevel);
        ezdoctemplatedocument_response_compound->e_ezdoctemplatedocument_privacylevel = NULL;
    }
...
cJSON *ezdoctemplatedocument_response_compound_convertToJSON(ezdoctemplatedocument_response_compound_t *ezdoctemplatedocument_response_compound) {
    ...
    if(ezdoctemplatedocument_response_compound->e_ezdoctemplatedocument_privacylevel != ezmax_api_definition__full_ezdoctemplatedocument_response_compound__NULL) {
...
ezdoctemplatedocument_response_compound_t *ezdoctemplatedocument_response_compound_parseFromJSON(cJSON *ezdoctemplatedocument_response_compoundJSON){
    ...
    ezdoctemplatedocument_response_compound_local_var = ezdoctemplatedocument_response_compound_create (
