...
ezsignfoldertype_get_object_v4_response_m_payload_t *ezsignfoldertype_get_object_v4_response_m_payload_create(
...
ezsignfoldertype_get_object_v4_response_m_payload_t *ezsignfoldertype_get_object_v4_response_m_payload_parseFromJSON(cJSON *ezsignfoldertype_get_object_v4_response_m_payloadJSON){
    ...
    ezsignfoldertype_get_object_v4_response_m_payload_local_var = ezsignfoldertype_get_object_v4_response_m_payload_create (
