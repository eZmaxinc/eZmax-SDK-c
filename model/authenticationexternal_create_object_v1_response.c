...
static authenticationexternal_create_object_v1_response_t *authenticationexternal_create_object_v1_response_create_internal(
    ...
    memset(authenticationexternal_create_object_v1_response_local_var, 0, sizeof(authenticationexternal_create_object_v1_response_t));
    authenticationexternal_create_object_v1_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) authenticationexternal_create_object_v1_response_t *authenticationexternal_create_object_v1_response_create(
    common_response_obj_debug_payload_t *obj_debug_payload,
    common_response_obj_debug_t *obj_debug,
    authenticationexternal_create_object_v1_response_m_payload_t *m_payload
    ) {
    authenticationexternal_create_object_v1_response_t *result = authenticationexternal_create_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void authenticationexternal_create_object_v1_response_free(authenticationexternal_create_object_v1_response_t *authenticationexternal_create_object_v1_response) {
    ...
    if(authenticationexternal_create_object_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "authenticationexternal_create_object_v1_response_free");
        return ;
    }
...
authenticationexternal_create_object_v1_response_t *authenticationexternal_create_object_v1_response_parseFromJSON(cJSON *authenticationexternal_create_object_v1_responseJSON){
    ...
    authenticationexternal_create_object_v1_response_local_var = authenticationexternal_create_object_v1_response_create_internal (
