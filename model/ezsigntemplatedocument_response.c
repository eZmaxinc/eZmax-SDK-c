...
static ezsigntemplatedocument_response_t *ezsigntemplatedocument_response_create_internal(
    ...
    memset(ezsigntemplatedocument_response_local_var, 0, sizeof(ezsigntemplatedocument_response_t));
    ezsigntemplatedocument_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezsigntemplatedocument_response_t *ezsigntemplatedocument_response_create(
    ...
    ezsigntemplatedocument_response_t *result = ezsigntemplatedocument_response_create_internal (
...
void ezsigntemplatedocument_response_free(ezsigntemplatedocument_response_t *ezsigntemplatedocument_response) {
    ...
    if(ezsigntemplatedocument_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsigntemplatedocument_response_free");
        return ;
    }
    listEntry_t *listEntry;
    if (ezsigntemplatedocument_response->pki_ezsigntemplatedocument_id) {
        free(ezsigntemplatedocument_response->pki_ezsigntemplatedocument_id);
        ezsigntemplatedocument_response->pki_ezsigntemplatedocument_id = NULL;
    }
    if (ezsigntemplatedocument_response->fki_ezsigntemplate_id) {
        free(ezsigntemplatedocument_response->fki_ezsigntemplate_id);
        ezsigntemplatedocument_response->fki_ezsigntemplate_id = NULL;
    }
    ...
    if (ezsigntemplatedocument_response->i_ezsigntemplatedocument_pagetotal) {
        free(ezsigntemplatedocument_response->i_ezsigntemplatedocument_pagetotal);
        ezsigntemplatedocument_response->i_ezsigntemplatedocument_pagetotal = NULL;
    }
    if (ezsigntemplatedocument_response->i_ezsigntemplatedocument_signaturetotal) {
        free(ezsigntemplatedocument_response->i_ezsigntemplatedocument_signaturetotal);
        ezsigntemplatedocument_response->i_ezsigntemplatedocument_signaturetotal = NULL;
    }
    if (ezsigntemplatedocument_response->i_ezsigntemplatedocument_formfieldtotal) {
        free(ezsigntemplatedocument_response->i_ezsigntemplatedocument_formfieldtotal);
        ezsigntemplatedocument_response->i_ezsigntemplatedocument_formfieldtotal = NULL;
    }
    if (ezsigntemplatedocument_response->b_ezsigntemplatedocument_hassignedsignatures) {
        free(ezsigntemplatedocument_response->b_ezsigntemplatedocument_hassignedsignatures);
        ezsigntemplatedocument_response->b_ezsigntemplatedocument_hassignedsignatures = NULL;
    }
...
ezsigntemplatedocument_response_t *ezsigntemplatedocument_response_parseFromJSON(cJSON *ezsigntemplatedocument_responseJSON){
    ...
    // define the local variable for ezsigntemplatedocument_response->pki_ezsigntemplatedocument_id
    int *pki_ezsigntemplatedocument_id_local_var = NULL;

    // define the local variable for ezsigntemplatedocument_response->fki_ezsigntemplate_id
    int *fki_ezsigntemplate_id_local_var = NULL;

    char *s_ezsigntemplatedocument_name_local_str = NULL;

    // define the local variable for ezsigntemplatedocument_response->i_ezsigntemplatedocument_pagetotal
    int *i_ezsigntemplatedocument_pagetotal_local_var = NULL;

    // define the local variable for ezsigntemplatedocument_response->i_ezsigntemplatedocument_signaturetotal
    int *i_ezsigntemplatedocument_signaturetotal_local_var = NULL;

    // define the local variable for ezsigntemplatedocument_response->i_ezsigntemplatedocument_formfieldtotal
    int *i_ezsigntemplatedocument_formfieldtotal_local_var = NULL;

    // define the local variable for ezsigntemplatedocument_response->b_ezsigntemplatedocument_hassignedsignatures
    ...
    *b_ezsigntemplatedocument_hassignedsignatures_local_var = b_ezsigntemplatedocument_hassignedsignatures->valueint;
    ...
    ezsigntemplatedocument_response_local_var = ezsigntemplatedocument_response_create_internal (
