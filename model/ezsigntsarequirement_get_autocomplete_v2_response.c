...
static ezsigntsarequirement_get_autocomplete_v2_response_t *ezsigntsarequirement_get_autocomplete_v2_response_create_internal(
...
__attribute__((deprecated)) ezsigntsarequirement_get_autocomplete_v2_response_t *ezsigntsarequirement_get_autocomplete_v2_response_create(
    common_response_obj_debug_payload_t *obj_debug_payload,
    common_response_obj_debug_t *obj_debug,
    ezsigntsarequirement_get_autocomplete_v2_response_m_payload_t *m_payload
    ) {
...
void ezsigntsarequirement_get_autocomplete_v2_response_free(ezsigntsarequirement_get_autocomplete_v2_response_t *ezsigntsarequirement_get_autocomplete_v2_response) {
    ...
    if(ezsigntsarequirement_get_autocomplete_v2_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsigntsarequirement_get_autocomplete_v2_response_free");
        return ;
    }
