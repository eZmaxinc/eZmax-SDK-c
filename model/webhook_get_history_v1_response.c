...
static webhook_get_history_v1_response_t *webhook_get_history_v1_response_create_internal(
    ...
    memset(webhook_get_history_v1_response_local_var, 0, sizeof(webhook_get_history_v1_response_t));
    webhook_get_history_v1_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) webhook_get_history_v1_response_t *webhook_get_history_v1_response_create(
    common_response_obj_debug_payload_t *obj_debug_payload,
    common_response_obj_debug_t *obj_debug,
    webhook_get_history_v1_response_m_payload_t *m_payload
    ) {
    webhook_get_history_v1_response_t *result = webhook_get_history_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void webhook_get_history_v1_response_free(webhook_get_history_v1_response_t *webhook_get_history_v1_response) {
    ...
    if(webhook_get_history_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "webhook_get_history_v1_response_free");
        return ;
    }
...
webhook_get_history_v1_response_t *webhook_get_history_v1_response_parseFromJSON(cJSON *webhook_get_history_v1_responseJSON){
    ...
    webhook_get_history_v1_response_local_var = webhook_get_history_v1_response_create_internal (
