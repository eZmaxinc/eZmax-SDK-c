...
static ezsignfoldertype_get_list_v1_response_m_payload_t *ezsignfoldertype_get_list_v1_response_m_payload_create_internal(
    ...
    memset(ezsignfoldertype_get_list_v1_response_m_payload_local_var, 0, sizeof(ezsignfoldertype_get_list_v1_response_m_payload_t));
...
__attribute__((deprecated)) ezsignfoldertype_get_list_v1_response_m_payload_t *ezsignfoldertype_get_list_v1_response_m_payload_create(
    ...
    ezsignfoldertype_get_list_v1_response_m_payload_t *result = ezsignfoldertype_get_list_v1_response_m_payload_create_internal (
        i_row_returned_copy,
        i_row_filtered_copy,
...
void ezsignfoldertype_get_list_v1_response_m_payload_free(ezsignfoldertype_get_list_v1_response_m_payload_t *ezsignfoldertype_get_list_v1_response_m_payload) {
    ...
    if (ezsignfoldertype_get_list_v1_response_m_payload->i_row_returned) {
        free(ezsignfoldertype_get_list_v1_response_m_payload->i_row_returned);
        ezsignfoldertype_get_list_v1_response_m_payload->i_row_returned = NULL;
    }
    if (ezsignfoldertype_get_list_v1_response_m_payload->i_row_filtered) {
        free(ezsignfoldertype_get_list_v1_response_m_payload->i_row_filtered);
        ezsignfoldertype_get_list_v1_response_m_payload->i_row_filtered = NULL;
    }
...
ezsignfoldertype_get_list_v1_response_m_payload_t *ezsignfoldertype_get_list_v1_response_m_payload_parseFromJSON(cJSON *ezsignfoldertype_get_list_v1_response_m_payloadJSON){
    ...
    // define the local variable for ezsignfoldertype_get_list_v1_response_m_payload->i_row_returned
    int *i_row_returned_local_var = NULL;

    // define the local variable for ezsignfoldertype_get_list_v1_response_m_payload->i_row_filtered
