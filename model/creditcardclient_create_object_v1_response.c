...
static creditcardclient_create_object_v1_response_t *creditcardclient_create_object_v1_response_create_internal(
    ...
    memset(creditcardclient_create_object_v1_response_local_var, 0, sizeof(creditcardclient_create_object_v1_response_t));
    creditcardclient_create_object_v1_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) creditcardclient_create_object_v1_response_t *creditcardclient_create_object_v1_response_create(
    ...
    creditcardclient_create_object_v1_response_t *result = creditcardclient_create_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void creditcardclient_create_object_v1_response_free(creditcardclient_create_object_v1_response_t *creditcardclient_create_object_v1_response) {
    ...
    if(creditcardclient_create_object_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "creditcardclient_create_object_v1_response_free");
        return ;
    }
...
creditcardclient_create_object_v1_response_t *creditcardclient_create_object_v1_response_parseFromJSON(cJSON *creditcardclient_create_object_v1_responseJSON){
    ...
    creditcardclient_create_object_v1_response_local_var = creditcardclient_create_object_v1_response_create_internal (
