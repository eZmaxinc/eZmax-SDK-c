...
static ezsignbulksendsignermapping_get_object_v2_response_t *ezsignbulksendsignermapping_get_object_v2_response_create_internal(
    ...
    memset(ezsignbulksendsignermapping_get_object_v2_response_local_var, 0, sizeof(ezsignbulksendsignermapping_get_object_v2_response_t));
...
__attribute__((deprecated)) ezsignbulksendsignermapping_get_object_v2_response_t *ezsignbulksendsignermapping_get_object_v2_response_create(
    ...
    ezsignbulksendsignermapping_get_object_v2_response_t *result = ezsignbulksendsignermapping_get_object_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
