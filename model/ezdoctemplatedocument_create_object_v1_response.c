...
ezdoctemplatedocument_create_object_v1_response_t *ezdoctemplatedocument_create_object_v1_response_create(
...
ezdoctemplatedocument_create_object_v1_response_t *ezdoctemplatedocument_create_object_v1_response_parseFromJSON(cJSON *ezdoctemplatedocument_create_object_v1_responseJSON){
    ...
    ezdoctemplatedocument_create_object_v1_response_local_var = ezdoctemplatedocument_create_object_v1_response_create (
