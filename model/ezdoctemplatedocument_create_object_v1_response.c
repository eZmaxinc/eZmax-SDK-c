...
static ezdoctemplatedocument_create_object_v1_response_t *ezdoctemplatedocument_create_object_v1_response_create_internal(
    ...
    memset(ezdoctemplatedocument_create_object_v1_response_local_var, 0, sizeof(ezdoctemplatedocument_create_object_v1_response_t));
...
__attribute__((deprecated)) ezdoctemplatedocument_create_object_v1_response_t *ezdoctemplatedocument_create_object_v1_response_create(
    ...
    ezdoctemplatedocument_create_object_v1_response_t *result = ezdoctemplatedocument_create_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
