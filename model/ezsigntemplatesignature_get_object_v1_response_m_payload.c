...
char* e_ezsigntemplatesignature_attachmentnamesourceezsigntemplatesignature_get_object_v1_response_m_payload_ToString(ezmax_api_definition__full_ezsigntemplatesignature_get_object_v1_response_m_payload__e e_ezsigntemplatesignature_attachmentnamesource) {
...
ezmax_api_definition__full_ezsigntemplatesignature_get_object_v1_response_m_payload__e e_ezsigntemplatesignature_attachmentnamesourceezsigntemplatesignature_get_object_v1_response_m_payload_FromString(char* e_ezsigntemplatesignature_attachmentnamesource){
    int stringToReturn = 0;
    char *e_ezsigntemplatesignature_attachmentnamesourceArray[] =  { "NULL", "Description", "Customer", "DescriptionCustomer" };
...
ezsigntemplatesignature_get_object_v1_response_m_payload_t *ezsigntemplatesignature_get_object_v1_response_m_payload_create(
    ...
    ezsigntemplatesignature_get_object_v1_response_m_payload_local_var->fki_ezsigntemplatesigner_id_validation = fki_ezsigntemplatesigner_id_validation;
    ...
    ezsigntemplatesignature_get_object_v1_response_m_payload_local_var->i_ezsigntemplatesignature_validationstep = i_ezsigntemplatesignature_validationstep;
    ezsigntemplatesignature_get_object_v1_response_m_payload_local_var->s_ezsigntemplatesignature_attachmentdescription = s_ezsigntemplatesignature_attachmentdescription;
    ezsigntemplatesignature_get_object_v1_response_m_payload_local_var->e_ezsigntemplatesignature_attachmentnamesource = e_ezsigntemplatesignature_attachmentnamesource;
    ezsigntemplatesignature_get_object_v1_response_m_payload_local_var->b_ezsigntemplatesignature_required = b_ezsigntemplatesignature_required;
...
void ezsigntemplatesignature_get_object_v1_response_m_payload_free(ezsigntemplatesignature_get_object_v1_response_m_payload_t *ezsigntemplatesignature_get_object_v1_response_m_payload) {
    ...
    if (ezsigntemplatesignature_get_object_v1_response_m_payload->s_ezsigntemplatesignature_attachmentdescription) {
        free(ezsigntemplatesignature_get_object_v1_response_m_payload->s_ezsigntemplatesignature_attachmentdescription);
        ezsigntemplatesignature_get_object_v1_response_m_payload->s_ezsigntemplatesignature_attachmentdescription = NULL;
    }
    if (ezsigntemplatesignature_get_object_v1_response_m_payload->e_ezsigntemplatesignature_attachmentnamesource) {
        field_e_ezsigntemplatesignature_attachmentnamesource_free(ezsigntemplatesignature_get_object_v1_response_m_payload->e_ezsigntemplatesignature_attachmentnamesource);
        ezsigntemplatesignature_get_object_v1_response_m_payload->e_ezsigntemplatesignature_attachmentnamesource = NULL;
    }
...
cJSON *ezsigntemplatesignature_get_object_v1_response_m_payload_convertToJSON(ezsigntemplatesignature_get_object_v1_response_m_payload_t *ezsigntemplatesignature_get_object_v1_response_m_payload) {
    ...
    // ezsigntemplatesignature_get_object_v1_response_m_payload->fki_ezsigntemplatesigner_id_validation
    if(ezsigntemplatesignature_get_object_v1_response_m_payload->fki_ezsigntemplatesigner_id_validation) {
    if(cJSON_AddNumberToObject(item, "fkiEzsigntemplatesignerIDValidation", ezsigntemplatesignature_get_object_v1_response_m_payload->fki_ezsigntemplatesigner_id_validation) == NULL) {
    goto fail; //Numeric
    }
    }
    ...
    // ezsigntemplatesignature_get_object_v1_response_m_payload->i_ezsigntemplatesignature_validationstep
    if(ezsigntemplatesignature_get_object_v1_response_m_payload->i_ezsigntemplatesignature_validationstep) {
    if(cJSON_AddNumberToObject(item, "iEzsigntemplatesignatureValidationstep", ezsigntemplatesignature_get_object_v1_response_m_payload->i_ezsigntemplatesignature_validationstep) == NULL) {
    goto fail; //Numeric
    }
    }


    // ezsigntemplatesignature_get_object_v1_response_m_payload->s_ezsigntemplatesignature_attachmentdescription
    if(ezsigntemplatesignature_get_object_v1_response_m_payload->s_ezsigntemplatesignature_attachmentdescription) {
    if(cJSON_AddStringToObject(item, "sEzsigntemplatesignatureAttachmentdescription", ezsigntemplatesignature_get_object_v1_response_m_payload->s_ezsigntemplatesignature_attachmentdescription) == NULL) {
    goto fail; //String
    }
    }


    // ezsigntemplatesignature_get_object_v1_response_m_payload->e_ezsigntemplatesignature_attachmentnamesource
    if(ezsigntemplatesignature_get_object_v1_response_m_payload->e_ezsigntemplatesignature_attachmentnamesource != ezmax_api_definition__full_ezsigntemplatesignature_get_object_v1_response_m_payload__NULL) {
    cJSON *e_ezsigntemplatesignature_attachmentnamesource_local_JSON = field_e_ezsigntemplatesignature_attachmentnamesource_convertToJSON(ezsigntemplatesignature_get_object_v1_response_m_payload->e_ezsigntemplatesignature_attachmentnamesource);
    ...
    // ezsigntemplatesignature_get_object_v1_response_m_payload->b_ezsigntemplatesignature_required
    if(ezsigntemplatesignature_get_object_v1_response_m_payload->b_ezsigntemplatesignature_required) {
    if(cJSON_AddBoolToObject(item, "bEzsigntemplatesignatureRequired", ezsigntemplatesignature_get_object_v1_response_m_payload->b_ezsigntemplatesignature_required) == NULL) {
    goto fail; //Bool
    }
    }
...
ezsigntemplatesignature_get_object_v1_response_m_payload_t *ezsigntemplatesignature_get_object_v1_response_m_payload_parseFromJSON(cJSON *ezsigntemplatesignature_get_object_v1_response_m_payloadJSON){
    ...
    // define the local variable for ezsigntemplatesignature_get_object_v1_response_m_payload->e_ezsigntemplatesignature_attachmentnamesource
    ...
    // ezsigntemplatesignature_get_object_v1_response_m_payload->fki_ezsigntemplatesigner_id_validation
    cJSON *fki_ezsigntemplatesigner_id_validation = cJSON_GetObjectItemCaseSensitive(ezsigntemplatesignature_get_object_v1_response_m_payloadJSON, "fkiEzsigntemplatesignerIDValidation");
    ...
    // ezsigntemplatesignature_get_object_v1_response_m_payload->i_ezsigntemplatesignature_validationstep
    cJSON *i_ezsigntemplatesignature_validationstep = cJSON_GetObjectItemCaseSensitive(ezsigntemplatesignature_get_object_v1_response_m_payloadJSON, "iEzsigntemplatesignatureValidationstep");
    ...
    // ezsigntemplatesignature_get_object_v1_response_m_payload->s_ezsigntemplatesignature_attachmentdescription
    cJSON *s_ezsigntemplatesignature_attachmentdescription = cJSON_GetObjectItemCaseSensitive(ezsigntemplatesignature_get_object_v1_response_m_payloadJSON, "sEzsigntemplatesignatureAttachmentdescription");
    ...
    // ezsigntemplatesignature_get_object_v1_response_m_payload->e_ezsigntemplatesignature_attachmentnamesource
    cJSON *e_ezsigntemplatesignature_attachmentnamesource = cJSON_GetObjectItemCaseSensitive(ezsigntemplatesignature_get_object_v1_response_m_payloadJSON, "eEzsigntemplatesignatureAttachmentnamesource");
    ...
    // ezsigntemplatesignature_get_object_v1_response_m_payload->b_ezsigntemplatesignature_required
    cJSON *b_ezsigntemplatesignature_required = cJSON_GetObjectItemCaseSensitive(ezsigntemplatesignature_get_object_v1_response_m_payloadJSON, "bEzsigntemplatesignatureRequired");
