/*
 * deposit_get_communicationsenders_v1_response_m_payload.h
 *
 * Response for GET /1/object/deposit/{pkiDepositID}/getCommunicationsenders
 */

#ifndef _deposit_get_communicationsenders_v1_response_m_payload_H_
#define _deposit_get_communicationsenders_v1_response_m_payload_H_
...
typedef struct deposit_get_communicationsenders_v1_response_m_payload_t deposit_get_communicationsenders_v1_response_m_payload_t;

#include "custom_communicationsender_response.h"



typedef struct deposit_get_communicationsenders_v1_response_m_payload_t {
    list_t *a_obj_communicationsenders; //nonprimitive container

    int _library_owned; // Is the library responsible for freeing this object?
} deposit_get_communicationsenders_v1_response_m_payload_t;
...
#endif /* _deposit_get_communicationsenders_v1_response_m_payload_H_ */
