...
static ezmaxinvoicinguser_response_t *ezmaxinvoicinguser_response_create_internal(
    ...
    memset(ezmaxinvoicinguser_response_local_var, 0, sizeof(ezmaxinvoicinguser_response_t));
...
__attribute__((deprecated)) ezmaxinvoicinguser_response_t *ezmaxinvoicinguser_response_create(
    ...
    ezmaxinvoicinguser_response_t *result = ezmaxinvoicinguser_response_create_internal (
...
void ezmaxinvoicinguser_response_free(ezmaxinvoicinguser_response_t *ezmaxinvoicinguser_response) {
    ...
    if (ezmaxinvoicinguser_response->pki_ezmaxinvoicinguser_id) {
        free(ezmaxinvoicinguser_response->pki_ezmaxinvoicinguser_id);
        ezmaxinvoicinguser_response->pki_ezmaxinvoicinguser_id = NULL;
    }
    if (ezmaxinvoicinguser_response->fki_ezmaxinvoicing_id) {
        free(ezmaxinvoicinguser_response->fki_ezmaxinvoicing_id);
        ezmaxinvoicinguser_response->fki_ezmaxinvoicing_id = NULL;
    }
    if (ezmaxinvoicinguser_response->fki_billingentityinternal_id) {
        free(ezmaxinvoicinguser_response->fki_billingentityinternal_id);
        ezmaxinvoicinguser_response->fki_billingentityinternal_id = NULL;
    }
    ...
    if (ezmaxinvoicinguser_response->fki_user_id) {
        free(ezmaxinvoicinguser_response->fki_user_id);
        ezmaxinvoicinguser_response->fki_user_id = NULL;
    }
    if (ezmaxinvoicinguser_response->i_ezmaxinvoicinguser_ezsigndocument) {
        free(ezmaxinvoicinguser_response->i_ezmaxinvoicinguser_ezsigndocument);
        ezmaxinvoicinguser_response->i_ezmaxinvoicinguser_ezsigndocument = NULL;
    }
    if (ezmaxinvoicinguser_response->b_ezmaxinvoicinguser_ezsignaccount) {
        free(ezmaxinvoicinguser_response->b_ezmaxinvoicinguser_ezsignaccount);
        ezmaxinvoicinguser_response->b_ezmaxinvoicinguser_ezsignaccount = NULL;
    }
    if (ezmaxinvoicinguser_response->b_ezmaxinvoicinguser_billableezsign) {
        free(ezmaxinvoicinguser_response->b_ezmaxinvoicinguser_billableezsign);
        ezmaxinvoicinguser_response->b_ezmaxinvoicinguser_billableezsign = NULL;
    }
...
ezmaxinvoicinguser_response_t *ezmaxinvoicinguser_response_parseFromJSON(cJSON *ezmaxinvoicinguser_responseJSON){
    ...
    // define the local variable for ezmaxinvoicinguser_response->pki_ezmaxinvoicinguser_id
    int *pki_ezmaxinvoicinguser_id_local_var = NULL;

    // define the local variable for ezmaxinvoicinguser_response->fki_ezmaxinvoicing_id
    int *fki_ezmaxinvoicing_id_local_var = NULL;

    // define the local variable for ezmaxinvoicinguser_response->fki_billingentityinternal_id
    int *fki_billingentityinternal_id_local_var = NULL;

    char *s_billingentityinternal_description_x_local_str = NULL;

    // define the local variable for ezmaxinvoicinguser_response->fki_user_id
    int *fki_user_id_local_var = NULL;

    // define the local variable for ezmaxinvoicinguser_response->i_ezmaxinvoicinguser_ezsigndocument
    int *i_ezmaxinvoicinguser_ezsigndocument_local_var = NULL;

    // define the local variable for ezmaxinvoicinguser_response->b_ezmaxinvoicinguser_ezsignaccount
    int *b_ezmaxinvoicinguser_ezsignaccount_local_var = NULL;

    // define the local variable for ezmaxinvoicinguser_response->b_ezmaxinvoicinguser_billableezsign
