...
static ezsignsignergroupmembership_get_object_v2_response_t *ezsignsignergroupmembership_get_object_v2_response_create_internal(
    ...
    memset(ezsignsignergroupmembership_get_object_v2_response_local_var, 0, sizeof(ezsignsignergroupmembership_get_object_v2_response_t));
    ezsignsignergroupmembership_get_object_v2_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezsignsignergroupmembership_get_object_v2_response_t *ezsignsignergroupmembership_get_object_v2_response_create(
    ...
    ezsignsignergroupmembership_get_object_v2_response_t *result = ezsignsignergroupmembership_get_object_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void ezsignsignergroupmembership_get_object_v2_response_free(ezsignsignergroupmembership_get_object_v2_response_t *ezsignsignergroupmembership_get_object_v2_response) {
    ...
    if(ezsignsignergroupmembership_get_object_v2_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsignsignergroupmembership_get_object_v2_response_free");
        return ;
    }
...
ezsignsignergroupmembership_get_object_v2_response_t *ezsignsignergroupmembership_get_object_v2_response_parseFromJSON(cJSON *ezsignsignergroupmembership_get_object_v2_responseJSON){
    ...
    ezsignsignergroupmembership_get_object_v2_response_local_var = ezsignsignergroupmembership_get_object_v2_response_create_internal (
