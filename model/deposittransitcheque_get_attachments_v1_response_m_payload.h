/*
 * deposittransitcheque_get_attachments_v1_response_m_payload.h
 *
 * Response for GET /1/object/deposittransitcheque/{pkiDeposittransitchequeID}/getAttachments
 */

#ifndef _deposittransitcheque_get_attachments_v1_response_m_payload_H_
#define _deposittransitcheque_get_attachments_v1_response_m_payload_H_
...
typedef struct deposittransitcheque_get_attachments_v1_response_m_payload_t deposittransitcheque_get_attachments_v1_response_m_payload_t;

#include "custom_attachmentdocumenttype_response.h"



typedef struct deposittransitcheque_get_attachments_v1_response_m_payload_t {
    list_t *a_obj_attachmentdocumenttype; //nonprimitive container

    int _library_owned; // Is the library responsible for freeing this object?
} deposittransitcheque_get_attachments_v1_response_m_payload_t;
...
#endif /* _deposittransitcheque_get_attachments_v1_response_m_payload_H_ */
