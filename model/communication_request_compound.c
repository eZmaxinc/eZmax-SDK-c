...
char* e_communication_importancecommunication_request_compound_ToString(ezmax_api_definition__full_communication_request_compound__e e_communication_importance) {
...
ezmax_api_definition__full_communication_request_compound__e e_communication_importancecommunication_request_compound_FromString(char* e_communication_importance){
...
char* e_communication_typecommunication_request_compound_ToString(ezmax_api_definition__full_communication_request_compound__e e_communication_type) {
    char* e_communication_typeArray[] =  { "NULL", "Email", "Fax", "Sms" };
    return e_communication_typeArray[e_communication_type];
}

ezmax_api_definition__full_communication_request_compound__e e_communication_typecommunication_request_compound_FromString(char* e_communication_type){
    int stringToReturn = 0;
    char *e_communication_typeArray[] =  { "NULL", "Email", "Fax", "Sms" };
...
char* e_communication_attachmenttypecommunication_request_compound_ToString(ezmax_api_definition__full_communication_request_compound_ECOMMUNICATIONATTACHMENTTYPE_e e_communication_attachmenttype) {
...
ezmax_api_definition__full_communication_request_compound_ECOMMUNICATIONATTACHMENTTYPE_e e_communication_attachmenttypecommunication_request_compound_FromString(char* e_communication_attachmenttype){
    int stringToReturn = 0;
    char *e_communication_attachmenttypeArray[] =  { "NULL", "Attachment", "Url" };
...
communication_request_compound_t *communication_request_compound_parseFromJSON(cJSON *communication_request_compoundJSON){
    ...
    e_communication_attachmenttypeVariable = e_communication_attachmenttypecommunication_request_compound_FromString(e_communication_attachmenttype->valuestring);
    }
