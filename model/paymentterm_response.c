...
static paymentterm_response_t *paymentterm_response_create_internal(
    ...
    memset(paymentterm_response_local_var, 0, sizeof(paymentterm_response_t));
...
__attribute__((deprecated)) paymentterm_response_t *paymentterm_response_create(
    ...
    paymentterm_response_t *result = paymentterm_response_create_internal (
...
void paymentterm_response_free(paymentterm_response_t *paymentterm_response) {
    ...
    if (paymentterm_response->pki_paymentterm_id) {
        free(paymentterm_response->pki_paymentterm_id);
        paymentterm_response->pki_paymentterm_id = NULL;
    }
    ...
    if (paymentterm_response->i_paymentterm_day) {
        free(paymentterm_response->i_paymentterm_day);
        paymentterm_response->i_paymentterm_day = NULL;
    }
    ...
    if (paymentterm_response->b_paymentterm_isactive) {
        free(paymentterm_response->b_paymentterm_isactive);
        paymentterm_response->b_paymentterm_isactive = NULL;
    }
...
paymentterm_response_t *paymentterm_response_parseFromJSON(cJSON *paymentterm_responseJSON){
    ...
    // define the local variable for paymentterm_response->pki_paymentterm_id
    ...
    // define the local variable for paymentterm_response->i_paymentterm_day
    ...
    // define the local variable for paymentterm_response->b_paymentterm_isactive
