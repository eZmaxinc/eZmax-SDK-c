...
static webhook_get_list_v1_response_m_payload_t *webhook_get_list_v1_response_m_payload_create_internal(
    ...
    memset(webhook_get_list_v1_response_m_payload_local_var, 0, sizeof(webhook_get_list_v1_response_m_payload_t));
...
__attribute__((deprecated)) webhook_get_list_v1_response_m_payload_t *webhook_get_list_v1_response_m_payload_create(
    ...
    webhook_get_list_v1_response_m_payload_t *result = webhook_get_list_v1_response_m_payload_create_internal (
        i_row_returned_copy,
        i_row_filtered_copy,
        a_obj_webhook
        );
...
void webhook_get_list_v1_response_m_payload_free(webhook_get_list_v1_response_m_payload_t *webhook_get_list_v1_response_m_payload) {
    ...
    if (webhook_get_list_v1_response_m_payload->i_row_returned) {
        free(webhook_get_list_v1_response_m_payload->i_row_returned);
        webhook_get_list_v1_response_m_payload->i_row_returned = NULL;
    }
    if (webhook_get_list_v1_response_m_payload->i_row_filtered) {
        free(webhook_get_list_v1_response_m_payload->i_row_filtered);
        webhook_get_list_v1_response_m_payload->i_row_filtered = NULL;
    }
...
webhook_get_list_v1_response_m_payload_t *webhook_get_list_v1_response_m_payload_parseFromJSON(cJSON *webhook_get_list_v1_response_m_payloadJSON){
    ...
    // define the local variable for webhook_get_list_v1_response_m_payload->i_row_returned
    int *i_row_returned_local_var = NULL;

    // define the local variable for webhook_get_list_v1_response_m_payload->i_row_filtered
