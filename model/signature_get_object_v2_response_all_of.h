/*
 * signature_get_object_v2_response_all_of.h
 *
 * 
 */

#ifndef _signature_get_object_v2_response_all_of_H_
#define _signature_get_object_v2_response_all_of_H_
...
typedef struct signature_get_object_v2_response_all_of_t signature_get_object_v2_response_all_of_t;

#include "signature_get_object_v2_response_m_payload.h"



typedef struct signature_get_object_v2_response_all_of_t {
    struct signature_get_object_v2_response_m_payload_t *m_payload; //model

} signature_get_object_v2_response_all_of_t;
...
#endif /* _signature_get_object_v2_response_all_of_H_ */
