...
static websocket_response_information_v1_t *websocket_response_information_v1_create_internal(
    ...
    memset(websocket_response_information_v1_local_var, 0, sizeof(websocket_response_information_v1_t));
    websocket_response_information_v1_local_var->_library_owned = 1;
...
__attribute__((deprecated)) websocket_response_information_v1_t *websocket_response_information_v1_create(
    ezmax_api_definition__full_websocket_response_information_v1_EWEBSOCKETMESSAGETYPE_e e_websocket_messagetype,
    char *s_websocket_channel,
    websocket_response_information_v1_m_payload_t *m_payload
    ) {
    websocket_response_information_v1_t *result = websocket_response_information_v1_create_internal (
...
void websocket_response_information_v1_free(websocket_response_information_v1_t *websocket_response_information_v1) {
    ...
    if(websocket_response_information_v1->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "websocket_response_information_v1_free");
        return ;
    }
...
cJSON *websocket_response_information_v1_convertToJSON(websocket_response_information_v1_t *websocket_response_information_v1) {
    ...
    if(cJSON_AddStringToObject(item, "eWebsocketMessagetype", websocket_response_information_v1_e_websocket_messagetype_ToString(websocket_response_information_v1->e_websocket_messagetype)) == NULL)
    {
    goto fail; //Enum
    }
...
websocket_response_information_v1_t *websocket_response_information_v1_parseFromJSON(cJSON *websocket_response_information_v1JSON){
    ...
    websocket_response_information_v1_local_var = websocket_response_information_v1_create_internal (
