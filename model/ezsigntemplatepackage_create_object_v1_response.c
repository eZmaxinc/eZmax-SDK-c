...
static ezsigntemplatepackage_create_object_v1_response_t *ezsigntemplatepackage_create_object_v1_response_create_internal(
    ...
    memset(ezsigntemplatepackage_create_object_v1_response_local_var, 0, sizeof(ezsigntemplatepackage_create_object_v1_response_t));
...
__attribute__((deprecated)) ezsigntemplatepackage_create_object_v1_response_t *ezsigntemplatepackage_create_object_v1_response_create(
    ...
    ezsigntemplatepackage_create_object_v1_response_t *result = ezsigntemplatepackage_create_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
