...
char* ezsignfolder_response_v3_e_ezsignfolder_completion_ToString(ezmax_api_definition__full_ezsignfolder_response_v3__e e_ezsignfolder_completion) {
...
ezmax_api_definition__full_ezsignfolder_response_v3__e ezsignfolder_response_v3_e_ezsignfolder_completion_FromString(char* e_ezsignfolder_completion){
...
char* ezsignfolder_response_v3_e_ezsignfolder_documentdependency_ToString(ezmax_api_definition__full_ezsignfolder_response_v3__e e_ezsignfolder_documentdependency) {
...
ezmax_api_definition__full_ezsignfolder_response_v3__e ezsignfolder_response_v3_e_ezsignfolder_documentdependency_FromString(char* e_ezsignfolder_documentdependency){
    int stringToReturn = 0;
    char *e_ezsignfolder_documentdependencyArray[] =  { "NULL", "All", "EzsignsignerOnly" };
...
char* ezsignfolder_response_v3_e_ezsignfolder_step_ToString(ezmax_api_definition__full_ezsignfolder_response_v3__e e_ezsignfolder_step) {
...
ezmax_api_definition__full_ezsignfolder_response_v3__e ezsignfolder_response_v3_e_ezsignfolder_step_FromString(char* e_ezsignfolder_step){
    int stringToReturn = 0;
    char *e_ezsignfolder_stepArray[] =  { "NULL", "Unsent", "PendingSend", "Sent", "PartiallySigned", "Expired", "Completed", "Archived", "Disposed" };
...
char* ezsignfolder_response_v3_e_ezsignfolder_access_ToString(ezmax_api_definition__full_ezsignfolder_response_v3__e e_ezsignfolder_access) {
    char* e_ezsignfolder_accessArray[] =  { "NULL", "Signer", "Read", "Modify", "Full" };
    return e_ezsignfolder_accessArray[e_ezsignfolder_access];
}

ezmax_api_definition__full_ezsignfolder_response_v3__e ezsignfolder_response_v3_e_ezsignfolder_access_FromString(char* e_ezsignfolder_access){
    int stringToReturn = 0;
    char *e_ezsignfolder_accessArray[] =  { "NULL", "Signer", "Read", "Modify", "Full" };
...
ezsignfolder_response_v3_t *ezsignfolder_response_v3_create(
    ...
    ezsignfolder_response_v3_t *ezsignfolder_response_v3_local_var = malloc(sizeof(ezsignfolder_response_v3_t));
    ...
    ezsignfolder_response_v3_local_var->fki_timezone_id = fki_timezone_id;
    ezsignfolder_response_v3_local_var->e_ezsignfolder_completion = e_ezsignfolder_completion;
    ezsignfolder_response_v3_local_var->e_ezsignfolder_documentdependency = e_ezsignfolder_documentdependency;
    ezsignfolder_response_v3_local_var->s_ezsignfoldertype_name_x = s_ezsignfoldertype_name_x;
    ezsignfolder_response_v3_local_var->fki_billingentityinternal_id = fki_billingentityinternal_id;
    ezsignfolder_response_v3_local_var->s_billingentityinternal_description_x = s_billingentityinternal_description_x;
    ezsignfolder_response_v3_local_var->fki_ezsigntsarequirement_id = fki_ezsigntsarequirement_id;
    ezsignfolder_response_v3_local_var->s_ezsigntsarequirement_description_x = s_ezsigntsarequirement_description_x;
    ezsignfolder_response_v3_local_var->s_ezsignfolder_description = s_ezsignfolder_description;
    ezsignfolder_response_v3_local_var->t_ezsignfolder_note = t_ezsignfolder_note;
    ezsignfolder_response_v3_local_var->b_ezsignfolder_isdisposable = b_ezsignfolder_isdisposable;
    ezsignfolder_response_v3_local_var->i_ezsignfolder_sendreminderfirstdays = i_ezsignfolder_sendreminderfirstdays;
    ezsignfolder_response_v3_local_var->i_ezsignfolder_sendreminderotherdays = i_ezsignfolder_sendreminderotherdays;
    ezsignfolder_response_v3_local_var->dt_ezsignfolder_delayedsenddate = dt_ezsignfolder_delayedsenddate;
    ezsignfolder_response_v3_local_var->dt_ezsignfolder_duedate = dt_ezsignfolder_duedate;
    ezsignfolder_response_v3_local_var->dt_ezsignfolder_sentdate = dt_ezsignfolder_sentdate;
...
void ezsignfolder_response_v3_free(ezsignfolder_response_v3_t *ezsignfolder_response_v3) {
    if(NULL == ezsignfolder_response_v3){
        return ;
    }
    listEntry_t *listEntry;
    if (ezsignfolder_response_v3->obj_ezsignfoldertype) {
        object_free(ezsignfolder_response_v3->obj_ezsignfoldertype);
        ezsignfolder_response_v3->obj_ezsignfoldertype = NULL;
    }
    if (ezsignfolder_response_v3->e_ezsignfolder_completion) {
        field_e_ezsignfolder_completion_free(ezsignfolder_response_v3->e_ezsignfolder_completion);
        ezsignfolder_response_v3->e_ezsignfolder_completion = NULL;
    }
    if (ezsignfolder_response_v3->e_ezsignfolder_documentdependency) {
        field_e_ezsignfolder_documentdependency_free(ezsignfolder_response_v3->e_ezsignfolder_documentdependency);
        ezsignfolder_response_v3->e_ezsignfolder_documentdependency = NULL;
    }
    ...
    if (ezsignfolder_response_v3->s_ezsigntsarequirement_description_x) {
        ...
        ezsignfolder_response_v3->s_ezsigntsarequirement_description_x = NULL;
    }
    if (ezsignfolder_response_v3->s_ezsignfolder_description) {
        free(ezsignfolder_response_v3->s_ezsignfolder_description);
        ezsignfolder_response_v3->s_ezsignfolder_description = NULL;
    }
    ...
    if (ezsignfolder_response_v3->dt_ezsignfolder_delayedsenddate) {
        ...
        ezsignfolder_response_v3->dt_ezsignfolder_delayedsenddate = NULL;
    }
    if (ezsignfolder_response_v3->dt_ezsignfolder_duedate) {
        free(ezsignfolder_response_v3->dt_ezsignfolder_duedate);
        ezsignfolder_response_v3->dt_ezsignfolder_duedate = NULL;
    }
    if (ezsignfolder_response_v3->dt_ezsignfolder_sentdate) {
        free(ezsignfolder_response_v3->dt_ezsignfolder_sentdate);
        ezsignfolder_response_v3->dt_ezsignfolder_sentdate = NULL;
    }
    if (ezsignfolder_response_v3->dt_ezsignfolder_scheduledarchive) {
        free(ezsignfolder_response_v3->dt_ezsignfolder_scheduledarchive);
        ezsignfolder_response_v3->dt_ezsignfolder_scheduledarchive = NULL;
    }
    ...
    if (ezsignfolder_response_v3->e_ezsignfolder_step) {
        field_e_ezsignfolder_step_free(ezsignfolder_response_v3->e_ezsignfolder_step);
        ezsignfolder_response_v3->e_ezsignfolder_step = NULL;
    }
    if (ezsignfolder_response_v3->dt_ezsignfolder_close) {
        free(ezsignfolder_response_v3->dt_ezsignfolder_close);
        ezsignfolder_response_v3->dt_ezsignfolder_close = NULL;
    }
    if (ezsignfolder_response_v3->t_ezsignfolder_message) {
        free(ezsignfolder_response_v3->t_ezsignfolder_message);
        ezsignfolder_response_v3->t_ezsignfolder_message = NULL;
    }
    if (ezsignfolder_response_v3->obj_audit) {
        common_audit_free(ezsignfolder_response_v3->obj_audit);
        ezsignfolder_response_v3->obj_audit = NULL;
    }
    if (ezsignfolder_response_v3->s_ezsignfolder_externalid) {
        free(ezsignfolder_response_v3->s_ezsignfolder_externalid);
        ezsignfolder_response_v3->s_ezsignfolder_externalid = NULL;
    }
    if (ezsignfolder_response_v3->e_ezsignfolder_access) {
        computed_e_ezsignfolder_access_free(ezsignfolder_response_v3->e_ezsignfolder_access);
        ezsignfolder_response_v3->e_ezsignfolder_access = NULL;
    }
    free(ezsignfolder_response_v3);
}

cJSON *ezsignfolder_response_v3_convertToJSON(ezsignfolder_response_v3_t *ezsignfolder_response_v3) {
    cJSON *item = cJSON_CreateObject();

    // ezsignfolder_response_v3->pki_ezsignfolder_id
    ...
    if(ezsignfolder_response_v3->obj_ezsignfoldertype) {
    cJSON *obj_ezsignfoldertype_local_JSON = object_convertToJSON(ezsignfolder_response_v3->obj_ezsignfoldertype);
    ...
    if (ezmax_api_definition__full_ezsignfolder_response_v3__NULL == ezsignfolder_response_v3->e_ezsignfolder_completion) {
        goto fail;
    }
    cJSON *e_ezsignfolder_completion_local_JSON = field_e_ezsignfolder_completion_convertToJSON(ezsignfolder_response_v3->e_ezsignfolder_completion);
    ...
    // ezsignfolder_response_v3->e_ezsignfolder_documentdependency
    if(ezsignfolder_response_v3->e_ezsignfolder_documentdependency != ezmax_api_definition__full_ezsignfolder_response_v3__NULL) {
    cJSON *e_ezsignfolder_documentdependency_local_JSON = field_e_ezsignfolder_documentdependency_convertToJSON(ezsignfolder_response_v3->e_ezsignfolder_documentdependency);
    ...
    // ezsignfolder_response_v3->s_ezsignfoldertype_name_x
    if(ezsignfolder_response_v3->s_ezsignfoldertype_name_x) {
    if(cJSON_AddStringToObject(item, "sEzsignfoldertypeNameX", ezsignfolder_response_v3->s_ezsignfoldertype_name_x) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(ezsignfolder_response_v3->s_billingentityinternal_description_x) {
    if(cJSON_AddStringToObject(item, "sBillingentityinternalDescriptionX", ezsignfolder_response_v3->s_billingentityinternal_description_x) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(ezsignfolder_response_v3->s_ezsigntsarequirement_description_x) {
    if(cJSON_AddStringToObject(item, "sEzsigntsarequirementDescriptionX", ezsignfolder_response_v3->s_ezsigntsarequirement_description_x) == NULL) {
    goto fail; //String
    }
    }


    // ezsignfolder_response_v3->s_ezsignfolder_description
    if (!ezsignfolder_response_v3->s_ezsignfolder_description) {
        goto fail;
    }
    if(cJSON_AddStringToObject(item, "sEzsignfolderDescription", ezsignfolder_response_v3->s_ezsignfolder_description) == NULL) {
    goto fail; //String
    }


    // ezsignfolder_response_v3->t_ezsignfolder_note
    if(ezsignfolder_response_v3->t_ezsignfolder_note) {
    if(cJSON_AddStringToObject(item, "tEzsignfolderNote", ezsignfolder_response_v3->t_ezsignfolder_note) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(ezsignfolder_response_v3->dt_ezsignfolder_delayedsenddate) {
    if(cJSON_AddStringToObject(item, "dtEzsignfolderDelayedsenddate", ezsignfolder_response_v3->dt_ezsignfolder_delayedsenddate) == NULL) {
    goto fail; //String
    }
    }


    // ezsignfolder_response_v3->dt_ezsignfolder_duedate
    if(ezsignfolder_response_v3->dt_ezsignfolder_duedate) {
    if(cJSON_AddStringToObject(item, "dtEzsignfolderDuedate", ezsignfolder_response_v3->dt_ezsignfolder_duedate) == NULL) {
    goto fail; //String
    }
    }


    // ezsignfolder_response_v3->dt_ezsignfolder_sentdate
    if(ezsignfolder_response_v3->dt_ezsignfolder_sentdate) {
    if(cJSON_AddStringToObject(item, "dtEzsignfolderSentdate", ezsignfolder_response_v3->dt_ezsignfolder_sentdate) == NULL) {
    goto fail; //String
    }
    }


    // ezsignfolder_response_v3->dt_ezsignfolder_scheduledarchive
    if(ezsignfolder_response_v3->dt_ezsignfolder_scheduledarchive) {
    if(cJSON_AddStringToObject(item, "dtEzsignfolderScheduledarchive", ezsignfolder_response_v3->dt_ezsignfolder_scheduledarchive) == NULL) {
    goto fail; //String
    }
    }


    // ezsignfolder_response_v3->dt_ezsignfolder_scheduleddispose
    if(ezsignfolder_response_v3->dt_ezsignfolder_scheduleddispose) {
    if(cJSON_AddStringToObject(item, "dtEzsignfolderScheduleddispose", ezsignfolder_response_v3->dt_ezsignfolder_scheduleddispose) == NULL) {
    goto fail; //String
    }
    }


    // ezsignfolder_response_v3->e_ezsignfolder_step
    if(ezsignfolder_response_v3->e_ezsignfolder_step != ezmax_api_definition__full_ezsignfolder_response_v3__NULL) {
    cJSON *e_ezsignfolder_step_local_JSON = field_e_ezsignfolder_step_convertToJSON(ezsignfolder_response_v3->e_ezsignfolder_step);
    ...
    if(ezsignfolder_response_v3->dt_ezsignfolder_close) {
    if(cJSON_AddStringToObject(item, "dtEzsignfolderClose", ezsignfolder_response_v3->dt_ezsignfolder_close) == NULL) {
    goto fail; //String
    }
    }


    // ezsignfolder_response_v3->t_ezsignfolder_message
    if(ezsignfolder_response_v3->t_ezsignfolder_message) {
    if(cJSON_AddStringToObject(item, "tEzsignfolderMessage", ezsignfolder_response_v3->t_ezsignfolder_message) == NULL) {
    goto fail; //String
    }
    }
    ...
    // ezsignfolder_response_v3->s_ezsignfolder_externalid
    if(ezsignfolder_response_v3->s_ezsignfolder_externalid) {
    if(cJSON_AddStringToObject(item, "sEzsignfolderExternalid", ezsignfolder_response_v3->s_ezsignfolder_externalid) == NULL) {
    goto fail; //String
    }
    }


    // ezsignfolder_response_v3->e_ezsignfolder_access
    if(ezsignfolder_response_v3->e_ezsignfolder_access != ezmax_api_definition__full_ezsignfolder_response_v3__NULL) {
    cJSON *e_ezsignfolder_access_local_JSON = computed_e_ezsignfolder_access_convertToJSON(ezsignfolder_response_v3->e_ezsignfolder_access);
...
ezsignfolder_response_v3_t *ezsignfolder_response_v3_parseFromJSON(cJSON *ezsignfolder_response_v3JSON){
    ...
    // ezsignfolder_response_v3->pki_ezsignfolder_id
    cJSON *pki_ezsignfolder_id = cJSON_GetObjectItemCaseSensitive(ezsignfolder_response_v3JSON, "pkiEzsignfolderID");
    ...
    // ezsignfolder_response_v3->obj_ezsignfoldertype
    cJSON *obj_ezsignfoldertype = cJSON_GetObjectItemCaseSensitive(ezsignfolder_response_v3JSON, "objEzsignfoldertype");
    if (obj_ezsignfoldertype) { 
    obj_ezsignfoldertype_local_nonprim = object_parseFromJSON(obj_ezsignfoldertype); //nonprimitive
    }

    // ezsignfolder_response_v3->fki_timezone_id
    cJSON *fki_timezone_id = cJSON_GetObjectItemCaseSensitive(ezsignfolder_response_v3JSON, "fkiTimezoneID");
    if (fki_timezone_id) { 
    ...
    // ezsignfolder_response_v3->e_ezsignfolder_completion
    cJSON *e_ezsignfolder_completion = cJSON_GetObjectItemCaseSensitive(ezsignfolder_response_v3JSON, "eEzsignfolderCompletion");
    ...
    // ezsignfolder_response_v3->e_ezsignfolder_documentdependency
    cJSON *e_ezsignfolder_documentdependency = cJSON_GetObjectItemCaseSensitive(ezsignfolder_response_v3JSON, "eEzsignfolderDocumentdependency");
    ...
    // ezsignfolder_response_v3->s_ezsignfoldertype_name_x
    cJSON *s_ezsignfoldertype_name_x = cJSON_GetObjectItemCaseSensitive(ezsignfolder_response_v3JSON, "sEzsignfoldertypeNameX");
    ...
    // ezsignfolder_response_v3->fki_billingentityinternal_id
    cJSON *fki_billingentityinternal_id = cJSON_GetObjectItemCaseSensitive(ezsignfolder_response_v3JSON, "fkiBillingentityinternalID");
    ...
    // ezsignfolder_response_v3->s_billingentityinternal_description_x
    cJSON *s_billingentityinternal_description_x = cJSON_GetObjectItemCaseSensitive(ezsignfolder_response_v3JSON, "sBillingentityinternalDescriptionX");
    ...
    // ezsignfolder_response_v3->fki_ezsigntsarequirement_id
    cJSON *fki_ezsigntsarequirement_id = cJSON_GetObjectItemCaseSensitive(ezsignfolder_response_v3JSON, "fkiEzsigntsarequirementID");
    ...
    // ezsignfolder_response_v3->s_ezsigntsarequirement_description_x
    cJSON *s_ezsigntsarequirement_description_x = cJSON_GetObjectItemCaseSensitive(ezsignfolder_response_v3JSON, "sEzsigntsarequirementDescriptionX");
    ...
    // ezsignfolder_response_v3->s_ezsignfolder_description
    cJSON *s_ezsignfolder_description = cJSON_GetObjectItemCaseSensitive(ezsignfolder_response_v3JSON, "sEzsignfolderDescription");
    ...
    // ezsignfolder_response_v3->t_ezsignfolder_note
    cJSON *t_ezsignfolder_note = cJSON_GetObjectItemCaseSensitive(ezsignfolder_response_v3JSON, "tEzsignfolderNote");
    ...
    // ezsignfolder_response_v3->b_ezsignfolder_isdisposable
    cJSON *b_ezsignfolder_isdisposable = cJSON_GetObjectItemCaseSensitive(ezsignfolder_response_v3JSON, "bEzsignfolderIsdisposable");
    ...
    // ezsignfolder_response_v3->i_ezsignfolder_sendreminderfirstdays
    cJSON *i_ezsignfolder_sendreminderfirstdays = cJSON_GetObjectItemCaseSensitive(ezsignfolder_response_v3JSON, "iEzsignfolderSendreminderfirstdays");
    ...
    // ezsignfolder_response_v3->i_ezsignfolder_sendreminderotherdays
    cJSON *i_ezsignfolder_sendreminderotherdays = cJSON_GetObjectItemCaseSensitive(ezsignfolder_response_v3JSON, "iEzsignfolderSendreminderotherdays");
    ...
    // ezsignfolder_response_v3->dt_ezsignfolder_delayedsenddate
    cJSON *dt_ezsignfolder_delayedsenddate = cJSON_GetObjectItemCaseSensitive(ezsignfolder_response_v3JSON, "dtEzsignfolderDelayedsenddate");
    ...
    // ezsignfolder_response_v3->dt_ezsignfolder_duedate
    cJSON *dt_ezsignfolder_duedate = cJSON_GetObjectItemCaseSensitive(ezsignfolder_response_v3JSON, "dtEzsignfolderDuedate");
    ...
    // ezsignfolder_response_v3->dt_ezsignfolder_sentdate
    cJSON *dt_ezsignfolder_sentdate = cJSON_GetObjectItemCaseSensitive(ezsignfolder_response_v3JSON, "dtEzsignfolderSentdate");
    ...
    // ezsignfolder_response_v3->dt_ezsignfolder_scheduledarchive
    cJSON *dt_ezsignfolder_scheduledarchive = cJSON_GetObjectItemCaseSensitive(ezsignfolder_response_v3JSON, "dtEzsignfolderScheduledarchive");
    ...
    // ezsignfolder_response_v3->dt_ezsignfolder_scheduleddispose
    cJSON *dt_ezsignfolder_scheduleddispose = cJSON_GetObjectItemCaseSensitive(ezsignfolder_response_v3JSON, "dtEzsignfolderScheduleddispose");
    ...
    // ezsignfolder_response_v3->e_ezsignfolder_step
    cJSON *e_ezsignfolder_step = cJSON_GetObjectItemCaseSensitive(ezsignfolder_response_v3JSON, "eEzsignfolderStep");
    ...
    // ezsignfolder_response_v3->dt_ezsignfolder_close
    cJSON *dt_ezsignfolder_close = cJSON_GetObjectItemCaseSensitive(ezsignfolder_response_v3JSON, "dtEzsignfolderClose");
    ...
    // ezsignfolder_response_v3->t_ezsignfolder_message
    cJSON *t_ezsignfolder_message = cJSON_GetObjectItemCaseSensitive(ezsignfolder_response_v3JSON, "tEzsignfolderMessage");
    ...
    // ezsignfolder_response_v3->s_ezsignfolder_externalid
    cJSON *s_ezsignfolder_externalid = cJSON_GetObjectItemCaseSensitive(ezsignfolder_response_v3JSON, "sEzsignfolderExternalid");
    ...
    // ezsignfolder_response_v3->e_ezsignfolder_access
    cJSON *e_ezsignfolder_access = cJSON_GetObjectItemCaseSensitive(ezsignfolder_response_v3JSON, "eEzsignfolderAccess");
    ...
    ezsignfolder_response_v3_local_var = ezsignfolder_response_v3_create (
