...
void ezsignfolder_response_v3_free(ezsignfolder_response_v3_t *ezsignfolder_response_v3) {
    ...
    if(ezsignfolder_response_v3->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsignfolder_response_v3_free");
        return ;
    }
    ...
    if (ezsignfolder_response_v3->dt_ezsignfolder_archive) {
        free(ezsignfolder_response_v3->dt_ezsignfolder_archive);
        ezsignfolder_response_v3->dt_ezsignfolder_archive = NULL;
    }
    if (ezsignfolder_response_v3->dt_ezsignfolder_dispose) {
        free(ezsignfolder_response_v3->dt_ezsignfolder_dispose);
        ezsignfolder_response_v3->dt_ezsignfolder_dispose = NULL;
    }
...
cJSON *ezsignfolder_response_v3_convertToJSON(ezsignfolder_response_v3_t *ezsignfolder_response_v3) {
    ...
    if (ezmax_api_definition__full_field_e_ezsignfolder_completion__NULL == ezsignfolder_response_v3->e_ezsignfolder_completion) {
        goto fail;
    }
    ...
    if(ezsignfolder_response_v3->e_ezsignfolder_documentdependency != ezmax_api_definition__full_field_e_ezsignfolder_documentdependency__NULL) {
    ...
    if(ezsignfolder_response_v3->e_ezsignfolder_step != ezmax_api_definition__full_field_e_ezsignfolder_step__NULL) {
    ...
    // ezsignfolder_response_v3->dt_ezsignfolder_archive
    if(ezsignfolder_response_v3->dt_ezsignfolder_archive) {
    if(cJSON_AddStringToObject(item, "dtEzsignfolderArchive", ezsignfolder_response_v3->dt_ezsignfolder_archive) == NULL) {
    goto fail; //String
    }
    }


    // ezsignfolder_response_v3->dt_ezsignfolder_dispose
    if(ezsignfolder_response_v3->dt_ezsignfolder_dispose) {
    if(cJSON_AddStringToObject(item, "dtEzsignfolderDispose", ezsignfolder_response_v3->dt_ezsignfolder_dispose) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(ezsignfolder_response_v3->e_ezsignfolder_access != ezmax_api_definition__full_computed_e_ezsignfolder_access__NULL) {
...
ezsignfolder_response_v3_t *ezsignfolder_response_v3_parseFromJSON(cJSON *ezsignfolder_response_v3JSON){
    ...
    // ezsignfolder_response_v3->dt_ezsignfolder_archive
    cJSON *dt_ezsignfolder_archive = cJSON_GetObjectItemCaseSensitive(ezsignfolder_response_v3JSON, "dtEzsignfolderArchive");
    ...
    // ezsignfolder_response_v3->dt_ezsignfolder_dispose
    cJSON *dt_ezsignfolder_dispose = cJSON_GetObjectItemCaseSensitive(ezsignfolder_response_v3JSON, "dtEzsignfolderDispose");
