/*
 * disclosure_get_attachments_v1_response.h
 *
 * Response for GET /1/object/disclosure/{pkiDisclosureID}/getAttachments
 */

#ifndef _disclosure_get_attachments_v1_response_H_
#define _disclosure_get_attachments_v1_response_H_
...
typedef struct disclosure_get_attachments_v1_response_t disclosure_get_attachments_v1_response_t;
...
typedef struct disclosure_get_attachments_v1_response_t {
    struct common_response_obj_debug_payload_t *obj_debug_payload; //model
    struct common_response_obj_debug_t *obj_debug; //model
    struct disclosure_get_attachments_v1_response_m_payload_t *m_payload; //model
...
#endif /* _disclosure_get_attachments_v1_response_H_ */
