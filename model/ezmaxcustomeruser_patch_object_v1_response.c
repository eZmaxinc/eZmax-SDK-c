...
static ezmaxcustomeruser_patch_object_v1_response_t *ezmaxcustomeruser_patch_object_v1_response_create_internal(
    ...
    memset(ezmaxcustomeruser_patch_object_v1_response_local_var, 0, sizeof(ezmaxcustomeruser_patch_object_v1_response_t));
...
__attribute__((deprecated)) ezmaxcustomeruser_patch_object_v1_response_t *ezmaxcustomeruser_patch_object_v1_response_create(
    ...
    ezmaxcustomeruser_patch_object_v1_response_t *result = ezmaxcustomeruser_patch_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug
        );
    if (!result) {
