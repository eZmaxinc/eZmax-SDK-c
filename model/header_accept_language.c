...
ezmax_api_definition_header_accept_language__e header_accept_language_header_accept_language_parseFromJSON(cJSON *header_accept_languageJSON) {
    ezmax_api_definition_header_accept_language__e *header_accept_language = NULL;
    ezmax_api_definition_header_accept_language__e header_accept_languageVariable;
