...
static cors_create_object_v1_response_t *cors_create_object_v1_response_create_internal(
    ...
    memset(cors_create_object_v1_response_local_var, 0, sizeof(cors_create_object_v1_response_t));
    cors_create_object_v1_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) cors_create_object_v1_response_t *cors_create_object_v1_response_create(
    ...
    cors_create_object_v1_response_t *result = cors_create_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void cors_create_object_v1_response_free(cors_create_object_v1_response_t *cors_create_object_v1_response) {
    ...
    if(cors_create_object_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "cors_create_object_v1_response_free");
        return ;
    }
...
cors_create_object_v1_response_t *cors_create_object_v1_response_parseFromJSON(cJSON *cors_create_object_v1_responseJSON){
    ...
    cors_create_object_v1_response_local_var = cors_create_object_v1_response_create_internal (
