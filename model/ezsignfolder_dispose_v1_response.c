...
static ezsignfolder_dispose_v1_response_t *ezsignfolder_dispose_v1_response_create_internal(
    ...
    memset(ezsignfolder_dispose_v1_response_local_var, 0, sizeof(ezsignfolder_dispose_v1_response_t));
...
__attribute__((deprecated)) ezsignfolder_dispose_v1_response_t *ezsignfolder_dispose_v1_response_create(
    ...
    ezsignfolder_dispose_v1_response_t *result = ezsignfolder_dispose_v1_response_create_internal (
        obj_debug_payload,
        obj_debug
        );
    if (!result) {
