...
void branding_request_v2_free(branding_request_v2_t *branding_request_v2) {
    ...
    if(branding_request_v2->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "branding_request_v2_free");
        return ;
    }
...
cJSON *branding_request_v2_convertToJSON(branding_request_v2_t *branding_request_v2) {
    ...
    if (ezmax_api_definition__full_field_e_branding_logo__NULL == branding_request_v2->e_branding_logo) {
        goto fail;
    }
    ...
    if(branding_request_v2->e_branding_alignlogo != ezmax_api_definition__full_field_e_branding_alignlogo__NULL) {
...
branding_request_v2_t *branding_request_v2_parseFromJSON(cJSON *branding_request_v2JSON){
    ...
    *pki_branding_id_local_var = pki_branding_id->valuedouble;
    ...
    // branding_request_v2->fki_domain_id
    cJSON *fki_domain_id = cJSON_GetObjectItemCaseSensitive(branding_request_v2JSON, "fkiDomainID");
