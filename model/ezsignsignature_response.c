...
static ezsignsignature_response_t *ezsignsignature_response_create_internal(
    ...
    memset(ezsignsignature_response_local_var, 0, sizeof(ezsignsignature_response_t));
    ...
    ezsignsignature_response_local_var->fki_paymentgateway_id = fki_paymentgateway_id;
    ezsignsignature_response_local_var->s_currency_description_x = s_currency_description_x;
    ezsignsignature_response_local_var->d_ezsignsignature_creditcardamount = d_ezsignsignature_creditcardamount;
    ezsignsignature_response_local_var->s_ezsignsignature_creditcardamountdescription = s_ezsignsignature_creditcardamountdescription;
    ezsignsignature_response_local_var->b_ezsignsignature_creditcardcustomamount = b_ezsignsignature_creditcardcustomamount;
    ...
    ezsignsignature_response_local_var->e_ezsignsignature_signaturepad = e_ezsignsignature_signaturepad;
    ezsignsignature_response_local_var->e_ezsignsignature_signaturepadrequired = e_ezsignsignature_signaturepadrequired;
...
__attribute__((deprecated)) ezsignsignature_response_t *ezsignsignature_response_create(
    ...
    ezsignsignature_response_t *result = ezsignsignature_response_create_internal (
...
void ezsignsignature_response_free(ezsignsignature_response_t *ezsignsignature_response) {
    ...
    if (ezsignsignature_response->pki_ezsignsignature_id) {
        free(ezsignsignature_response->pki_ezsignsignature_id);
        ezsignsignature_response->pki_ezsignsignature_id = NULL;
    }
    if (ezsignsignature_response->fki_ezsigndocument_id) {
        free(ezsignsignature_response->fki_ezsigndocument_id);
        ezsignsignature_response->fki_ezsigndocument_id = NULL;
    }
    if (ezsignsignature_response->fki_ezsignfoldersignerassociation_id) {
        free(ezsignsignature_response->fki_ezsignfoldersignerassociation_id);
        ezsignsignature_response->fki_ezsignfoldersignerassociation_id = NULL;
    }
    if (ezsignsignature_response->fki_ezsignsigningreason_id) {
        free(ezsignsignature_response->fki_ezsignsigningreason_id);
        ezsignsignature_response->fki_ezsignsigningreason_id = NULL;
    }
    if (ezsignsignature_response->fki_font_id) {
        free(ezsignsignature_response->fki_font_id);
        ezsignsignature_response->fki_font_id = NULL;
    }
    if (ezsignsignature_response->fki_paymentgateway_id) {
        free(ezsignsignature_response->fki_paymentgateway_id);
        ezsignsignature_response->fki_paymentgateway_id = NULL;
    }
    ...
    if (ezsignsignature_response->d_ezsignsignature_creditcardamount) {
        free(ezsignsignature_response->d_ezsignsignature_creditcardamount);
        ezsignsignature_response->d_ezsignsignature_creditcardamount = NULL;
    }
    if (ezsignsignature_response->s_ezsignsignature_creditcardamountdescription) {
        free(ezsignsignature_response->s_ezsignsignature_creditcardamountdescription);
        ezsignsignature_response->s_ezsignsignature_creditcardamountdescription = NULL;
    }
    if (ezsignsignature_response->b_ezsignsignature_creditcardcustomamount) {
        free(ezsignsignature_response->b_ezsignsignature_creditcardcustomamount);
        ezsignsignature_response->b_ezsignsignature_creditcardcustomamount = NULL;
    }
    ...
    if (ezsignsignature_response->i_ezsignpage_pagenumber) {
        free(ezsignsignature_response->i_ezsignpage_pagenumber);
        ezsignsignature_response->i_ezsignpage_pagenumber = NULL;
    }
    if (ezsignsignature_response->i_ezsignsignature_x) {
        free(ezsignsignature_response->i_ezsignsignature_x);
        ezsignsignature_response->i_ezsignsignature_x = NULL;
    }
    if (ezsignsignature_response->i_ezsignsignature_y) {
        free(ezsignsignature_response->i_ezsignsignature_y);
        ezsignsignature_response->i_ezsignsignature_y = NULL;
    }
    if (ezsignsignature_response->i_ezsignsignature_height) {
        free(ezsignsignature_response->i_ezsignsignature_height);
        ezsignsignature_response->i_ezsignsignature_height = NULL;
    }
    if (ezsignsignature_response->i_ezsignsignature_width) {
        free(ezsignsignature_response->i_ezsignsignature_width);
        ezsignsignature_response->i_ezsignsignature_width = NULL;
    }
    if (ezsignsignature_response->i_ezsignsignature_step) {
        free(ezsignsignature_response->i_ezsignsignature_step);
        ezsignsignature_response->i_ezsignsignature_step = NULL;
    }
    if (ezsignsignature_response->i_ezsignsignature_stepadjusted) {
        free(ezsignsignature_response->i_ezsignsignature_stepadjusted);
        ezsignsignature_response->i_ezsignsignature_stepadjusted = NULL;
    }
    ...
    if (ezsignsignature_response->i_ezsignsignature_validationstep) {
        free(ezsignsignature_response->i_ezsignsignature_validationstep);
        ezsignsignature_response->i_ezsignsignature_validationstep = NULL;
    }
    ...
    if (ezsignsignature_response->b_ezsignsignature_handwritten) {
        free(ezsignsignature_response->b_ezsignsignature_handwritten);
        ezsignsignature_response->b_ezsignsignature_handwritten = NULL;
    }
    if (ezsignsignature_response->b_ezsignsignature_reason) {
        free(ezsignsignature_response->b_ezsignsignature_reason);
        ezsignsignature_response->b_ezsignsignature_reason = NULL;
    }
    if (ezsignsignature_response->b_ezsignsignature_required) {
        free(ezsignsignature_response->b_ezsignsignature_required);
        ezsignsignature_response->b_ezsignsignature_required = NULL;
    }
    if (ezsignsignature_response->fki_ezsignfoldersignerassociation_id_validation) {
        free(ezsignsignature_response->fki_ezsignfoldersignerassociation_id_validation);
        ezsignsignature_response->fki_ezsignfoldersignerassociation_id_validation = NULL;
    }
    ...
    if (ezsignsignature_response->i_ezsignsignatureattachment_count) {
        free(ezsignsignature_response->i_ezsignsignatureattachment_count);
        ezsignsignature_response->i_ezsignsignatureattachment_count = NULL;
    }
    ...
    if (ezsignsignature_response->i_ezsignsignature_maxlength) {
        free(ezsignsignature_response->i_ezsignsignature_maxlength);
        ezsignsignature_response->i_ezsignsignature_maxlength = NULL;
    }
...
cJSON *ezsignsignature_response_convertToJSON(ezsignsignature_response_t *ezsignsignature_response) {
    ...
    // ezsignsignature_response->fki_paymentgateway_id
    if(ezsignsignature_response->fki_paymentgateway_id) {
    if(cJSON_AddNumberToObject(item, "fkiPaymentgatewayID", *ezsignsignature_response->fki_paymentgateway_id) == NULL) {
    goto fail; //Numeric
    }
    }
    ...
    // ezsignsignature_response->d_ezsignsignature_creditcardamount
    if(ezsignsignature_response->d_ezsignsignature_creditcardamount) {
    if(cJSON_AddStringToObject(item, "dEzsignsignatureCreditcardamount", ezsignsignature_response->d_ezsignsignature_creditcardamount) == NULL) {
    goto fail; //String
    }
    }


    // ezsignsignature_response->s_ezsignsignature_creditcardamountdescription
    if(ezsignsignature_response->s_ezsignsignature_creditcardamountdescription) {
    if(cJSON_AddStringToObject(item, "sEzsignsignatureCreditcardamountdescription", ezsignsignature_response->s_ezsignsignature_creditcardamountdescription) == NULL) {
    goto fail; //String
    }
    }


    // ezsignsignature_response->b_ezsignsignature_creditcardcustomamount
    if(ezsignsignature_response->b_ezsignsignature_creditcardcustomamount) {
    if(cJSON_AddBoolToObject(item, "bEzsignsignatureCreditcardcustomamount", *ezsignsignature_response->b_ezsignsignature_creditcardcustomamount) == NULL) {
    goto fail; //Bool
    }
    }
    ...
    // ezsignsignature_response->e_ezsignsignature_signaturepad
    if(ezsignsignature_response->e_ezsignsignature_signaturepad != ezmax_api_definition__full_field_e_ezsignsignature_signaturepad__NULL) {
    cJSON *e_ezsignsignature_signaturepad_local_JSON = field_e_ezsignsignature_signaturepad_convertToJSON(ezsignsignature_response->e_ezsignsignature_signaturepad);
    ...
    // ezsignsignature_response->e_ezsignsignature_signaturepadrequired
    if(ezsignsignature_response->e_ezsignsignature_signaturepadrequired != ezmax_api_definition__full_field_e_ezsignsignature_signaturepadrequired__NULL) {
    cJSON *e_ezsignsignature_signaturepadrequired_local_JSON = field_e_ezsignsignature_signaturepadrequired_convertToJSON(ezsignsignature_response->e_ezsignsignature_signaturepadrequired);
...
ezsignsignature_response_t *ezsignsignature_response_parseFromJSON(cJSON *ezsignsignature_responseJSON){
    ...
    // define the local variable for ezsignsignature_response->pki_ezsignsignature_id
    int *pki_ezsignsignature_id_local_var = NULL;

    // define the local variable for ezsignsignature_response->fki_ezsigndocument_id
    int *fki_ezsigndocument_id_local_var = NULL;

    // define the local variable for ezsignsignature_response->fki_ezsignfoldersignerassociation_id
    int *fki_ezsignfoldersignerassociation_id_local_var = NULL;

    // define the local variable for ezsignsignature_response->fki_ezsignsigningreason_id
    int *fki_ezsignsigningreason_id_local_var = NULL;

    // define the local variable for ezsignsignature_response->fki_font_id
    int *fki_font_id_local_var = NULL;

    // define the local variable for ezsignsignature_response->fki_paymentgateway_id
    ...
    // define the local variable for ezsignsignature_response->b_ezsignsignature_creditcardcustomamount
    int *b_ezsignsignature_creditcardcustomamount_local_var = NULL;

    char *s_ezsignsigningreason_description_x_local_str = NULL;

    // define the local variable for ezsignsignature_response->i_ezsignpage_pagenumber
    int *i_ezsignpage_pagenumber_local_var = NULL;

    // define the local variable for ezsignsignature_response->i_ezsignsignature_x
    int *i_ezsignsignature_x_local_var = NULL;

    // define the local variable for ezsignsignature_response->i_ezsignsignature_y
    int *i_ezsignsignature_y_local_var = NULL;

    // define the local variable for ezsignsignature_response->i_ezsignsignature_height
    int *i_ezsignsignature_height_local_var = NULL;

    // define the local variable for ezsignsignature_response->i_ezsignsignature_width
    int *i_ezsignsignature_width_local_var = NULL;

    // define the local variable for ezsignsignature_response->i_ezsignsignature_step
    int *i_ezsignsignature_step_local_var = NULL;

    // define the local variable for ezsignsignature_response->i_ezsignsignature_stepadjusted
    ...
    // define the local variable for ezsignsignature_response->e_ezsignsignature_signaturepad
    ezmax_api_definition__full_field_e_ezsignsignature_signaturepad__e e_ezsignsignature_signaturepad_local_nonprim = 0;

    // define the local variable for ezsignsignature_response->e_ezsignsignature_signaturepadrequired
    ...
    // define the local variable for ezsignsignature_response->i_ezsignsignature_validationstep
    ...
    // define the local variable for ezsignsignature_response->b_ezsignsignature_handwritten
    int *b_ezsignsignature_handwritten_local_var = NULL;

    // define the local variable for ezsignsignature_response->b_ezsignsignature_reason
    int *b_ezsignsignature_reason_local_var = NULL;

    // define the local variable for ezsignsignature_response->b_ezsignsignature_required
    int *b_ezsignsignature_required_local_var = NULL;

    // define the local variable for ezsignsignature_response->fki_ezsignfoldersignerassociation_id_validation
    int *fki_ezsignfoldersignerassociation_id_validation_local_var = NULL;

    char *dt_ezsignsignature_date_local_str = NULL;

    // define the local variable for ezsignsignature_response->i_ezsignsignatureattachment_count
    int *i_ezsignsignatureattachment_count_local_var = NULL;

    char *s_ezsignsignature_description_local_str = NULL;

    // define the local variable for ezsignsignature_response->i_ezsignsignature_maxlength
    ...
    *fki_font_id_local_var = fki_font_id->valuedouble;
    ...
    // ezsignsignature_response->fki_paymentgateway_id
    cJSON *fki_paymentgateway_id = cJSON_GetObjectItemCaseSensitive(ezsignsignature_responseJSON, "fkiPaymentgatewayID");
    ...
    *fki_paymentgateway_id_local_var = fki_paymentgateway_id->valuedouble;
    ...
    // ezsignsignature_response->d_ezsignsignature_creditcardamount
    cJSON *d_ezsignsignature_creditcardamount = cJSON_GetObjectItemCaseSensitive(ezsignsignature_responseJSON, "dEzsignsignatureCreditcardamount");
    ...
    // ezsignsignature_response->s_ezsignsignature_creditcardamountdescription
    cJSON *s_ezsignsignature_creditcardamountdescription = cJSON_GetObjectItemCaseSensitive(ezsignsignature_responseJSON, "sEzsignsignatureCreditcardamountdescription");
    ...
    // ezsignsignature_response->b_ezsignsignature_creditcardcustomamount
    cJSON *b_ezsignsignature_creditcardcustomamount = cJSON_GetObjectItemCaseSensitive(ezsignsignature_responseJSON, "bEzsignsignatureCreditcardcustomamount");
    ...
    *i_ezsignsignature_stepadjusted_local_var = i_ezsignsignature_stepadjusted->valuedouble;
    ...
    // ezsignsignature_response->e_ezsignsignature_signaturepad
    cJSON *e_ezsignsignature_signaturepad = cJSON_GetObjectItemCaseSensitive(ezsignsignature_responseJSON, "eEzsignsignatureSignaturepad");
    ...
    // ezsignsignature_response->e_ezsignsignature_signaturepadrequired
    cJSON *e_ezsignsignature_signaturepadrequired = cJSON_GetObjectItemCaseSensitive(ezsignsignature_responseJSON, "eEzsignsignatureSignaturepadrequired");
