...
char* e_createezsignelementspositionedbyword_occurancecustom_create_ezsignelements_positioned_by_word_request_ToString(ezmax_api_definition__full_custom_create_ezsignelements_positioned_by_word_request_ECREATEEZSIGNELEMENTSPOSITIONEDBYWORDOCCURANCE_e e_createezsignelementspositionedbyword_occurance) {
...
ezmax_api_definition__full_custom_create_ezsignelements_positioned_by_word_request_ECREATEEZSIGNELEMENTSPOSITIONEDBYWORDOCCURANCE_e e_createezsignelementspositionedbyword_occurancecustom_create_ezsignelements_positioned_by_word_request_FromString(char* e_createezsignelementspositionedbyword_occurance){
...
custom_create_ezsignelements_positioned_by_word_request_t *custom_create_ezsignelements_positioned_by_word_request_parseFromJSON(cJSON *custom_create_ezsignelements_positioned_by_word_requestJSON){
    ...
    e_createezsignelementspositionedbyword_occuranceVariable = e_createezsignelementspositionedbyword_occurancecustom_create_ezsignelements_positioned_by_word_request_FromString(e_createezsignelementspositionedbyword_occurance->valuestring);
