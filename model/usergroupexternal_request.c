...
static usergroupexternal_request_t *usergroupexternal_request_create_internal(
    ...
    memset(usergroupexternal_request_local_var, 0, sizeof(usergroupexternal_request_t));
...
__attribute__((deprecated)) usergroupexternal_request_t *usergroupexternal_request_create(
    ...
    usergroupexternal_request_t *result = usergroupexternal_request_create_internal (
...
void usergroupexternal_request_free(usergroupexternal_request_t *usergroupexternal_request) {
    ...
    if (usergroupexternal_request->pki_usergroupexternal_id) {
        free(usergroupexternal_request->pki_usergroupexternal_id);
        usergroupexternal_request->pki_usergroupexternal_id = NULL;
    }
...
usergroupexternal_request_t *usergroupexternal_request_parseFromJSON(cJSON *usergroupexternal_requestJSON){
    ...
    // define the local variable for usergroupexternal_request->pki_usergroupexternal_id
