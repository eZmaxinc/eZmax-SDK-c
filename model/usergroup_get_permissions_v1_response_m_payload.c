...
static usergroup_get_permissions_v1_response_m_payload_t *usergroup_get_permissions_v1_response_m_payload_create_internal(
    ...
    memset(usergroup_get_permissions_v1_response_m_payload_local_var, 0, sizeof(usergroup_get_permissions_v1_response_m_payload_t));
...
__attribute__((deprecated)) usergroup_get_permissions_v1_response_m_payload_t *usergroup_get_permissions_v1_response_m_payload_create(
    ...
    usergroup_get_permissions_v1_response_m_payload_t *result = usergroup_get_permissions_v1_response_m_payload_create_internal (
        a_obj_modulegroup
        );
    if (!result) {
    }
