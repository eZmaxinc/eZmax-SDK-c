...
#include <string.h>
#include <stdio.h>
#include "ezsigntemplate_response_v4.h"



static ezsigntemplate_response_v4_t *ezsigntemplate_response_v4_create_internal(
    ...
    ezsigntemplate_response_v4_t *ezsigntemplate_response_v4_local_var = malloc(sizeof(ezsigntemplate_response_v4_t));
    if (!ezsigntemplate_response_v4_local_var) {
        return NULL;
    }
    memset(ezsigntemplate_response_v4_local_var, 0, sizeof(ezsigntemplate_response_v4_t));
    ezsigntemplate_response_v4_local_var->_library_owned = 1;
    ezsigntemplate_response_v4_local_var->pki_ezsigntemplate_id = pki_ezsigntemplate_id;
    ezsigntemplate_response_v4_local_var->fki_ezsigntemplatedocument_id = fki_ezsigntemplatedocument_id;
    ezsigntemplate_response_v4_local_var->fki_ezsignfoldertype_id = fki_ezsignfoldertype_id;
    ezsigntemplate_response_v4_local_var->obj_ezsignfoldertype = obj_ezsignfoldertype;
    ezsigntemplate_response_v4_local_var->fki_language_id = fki_language_id;
    ezsigntemplate_response_v4_local_var->fki_ezdoctemplatedocument_id = fki_ezdoctemplatedocument_id;
    ezsigntemplate_response_v4_local_var->s_ezdoctemplatedocument_name_x = s_ezdoctemplatedocument_name_x;
    ezsigntemplate_response_v4_local_var->s_language_name_x = s_language_name_x;
    ezsigntemplate_response_v4_local_var->s_ezsigntemplate_description = s_ezsigntemplate_description;
    ezsigntemplate_response_v4_local_var->s_ezsigntemplate_externaldescription = s_ezsigntemplate_externaldescription;
    ezsigntemplate_response_v4_local_var->t_ezsigntemplate_comment = t_ezsigntemplate_comment;
    ezsigntemplate_response_v4_local_var->e_ezsigntemplate_recognition = e_ezsigntemplate_recognition;
    ezsigntemplate_response_v4_local_var->s_ezsigntemplate_filenameregexp = s_ezsigntemplate_filenameregexp;
    ezsigntemplate_response_v4_local_var->b_ezsigntemplate_adminonly = b_ezsigntemplate_adminonly;
    ezsigntemplate_response_v4_local_var->s_ezsignfoldertype_name_x = s_ezsignfoldertype_name_x;
    ezsigntemplate_response_v4_local_var->obj_audit = obj_audit;
    ezsigntemplate_response_v4_local_var->b_ezsigntemplate_editallowed = b_ezsigntemplate_editallowed;
    ezsigntemplate_response_v4_local_var->e_ezsigntemplate_type = e_ezsigntemplate_type;
    return ezsigntemplate_response_v4_local_var;
}
...
__attribute__((deprecated)) ezsigntemplate_response_v4_t *ezsigntemplate_response_v4_create(
    ...
    ezsigntemplate_response_v4_t *result = ezsigntemplate_response_v4_create_internal (
...
void ezsigntemplate_response_v4_free(ezsigntemplate_response_v4_t *ezsigntemplate_response_v4) {
    if(NULL == ezsigntemplate_response_v4){
        return ;
    }
    if(ezsigntemplate_response_v4->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsigntemplate_response_v4_free");
        return ;
    }
    listEntry_t *listEntry;
    if (ezsigntemplate_response_v4->pki_ezsigntemplate_id) {
        free(ezsigntemplate_response_v4->pki_ezsigntemplate_id);
        ezsigntemplate_response_v4->pki_ezsigntemplate_id = NULL;
    }
    if (ezsigntemplate_response_v4->fki_ezsigntemplatedocument_id) {
        free(ezsigntemplate_response_v4->fki_ezsigntemplatedocument_id);
        ezsigntemplate_response_v4->fki_ezsigntemplatedocument_id = NULL;
    }
    if (ezsigntemplate_response_v4->fki_ezsignfoldertype_id) {
        free(ezsigntemplate_response_v4->fki_ezsignfoldertype_id);
        ezsigntemplate_response_v4->fki_ezsignfoldertype_id = NULL;
    }
    if (ezsigntemplate_response_v4->obj_ezsignfoldertype) {
        custom_ezsignfoldertype_template_response_free(ezsigntemplate_response_v4->obj_ezsignfoldertype);
        ezsigntemplate_response_v4->obj_ezsignfoldertype = NULL;
    }
    if (ezsigntemplate_response_v4->fki_language_id) {
        free(ezsigntemplate_response_v4->fki_language_id);
        ezsigntemplate_response_v4->fki_language_id = NULL;
    }
    if (ezsigntemplate_response_v4->fki_ezdoctemplatedocument_id) {
        free(ezsigntemplate_response_v4->fki_ezdoctemplatedocument_id);
        ezsigntemplate_response_v4->fki_ezdoctemplatedocument_id = NULL;
    }
    if (ezsigntemplate_response_v4->s_ezdoctemplatedocument_name_x) {
        free(ezsigntemplate_response_v4->s_ezdoctemplatedocument_name_x);
        ezsigntemplate_response_v4->s_ezdoctemplatedocument_name_x = NULL;
    }
    if (ezsigntemplate_response_v4->s_language_name_x) {
        free(ezsigntemplate_response_v4->s_language_name_x);
        ezsigntemplate_response_v4->s_language_name_x = NULL;
    }
    if (ezsigntemplate_response_v4->s_ezsigntemplate_description) {
        free(ezsigntemplate_response_v4->s_ezsigntemplate_description);
        ezsigntemplate_response_v4->s_ezsigntemplate_description = NULL;
    }
    if (ezsigntemplate_response_v4->s_ezsigntemplate_externaldescription) {
        free(ezsigntemplate_response_v4->s_ezsigntemplate_externaldescription);
        ezsigntemplate_response_v4->s_ezsigntemplate_externaldescription = NULL;
    }
    if (ezsigntemplate_response_v4->t_ezsigntemplate_comment) {
        free(ezsigntemplate_response_v4->t_ezsigntemplate_comment);
        ezsigntemplate_response_v4->t_ezsigntemplate_comment = NULL;
    }
    if (ezsigntemplate_response_v4->s_ezsigntemplate_filenameregexp) {
        free(ezsigntemplate_response_v4->s_ezsigntemplate_filenameregexp);
        ezsigntemplate_response_v4->s_ezsigntemplate_filenameregexp = NULL;
    }
    if (ezsigntemplate_response_v4->b_ezsigntemplate_adminonly) {
        free(ezsigntemplate_response_v4->b_ezsigntemplate_adminonly);
        ezsigntemplate_response_v4->b_ezsigntemplate_adminonly = NULL;
    }
    if (ezsigntemplate_response_v4->s_ezsignfoldertype_name_x) {
        free(ezsigntemplate_response_v4->s_ezsignfoldertype_name_x);
        ezsigntemplate_response_v4->s_ezsignfoldertype_name_x = NULL;
    }
    if (ezsigntemplate_response_v4->obj_audit) {
        common_audit_free(ezsigntemplate_response_v4->obj_audit);
        ezsigntemplate_response_v4->obj_audit = NULL;
    }
    if (ezsigntemplate_response_v4->b_ezsigntemplate_editallowed) {
        free(ezsigntemplate_response_v4->b_ezsigntemplate_editallowed);
        ezsigntemplate_response_v4->b_ezsigntemplate_editallowed = NULL;
    }
    free(ezsigntemplate_response_v4);
}

cJSON *ezsigntemplate_response_v4_convertToJSON(ezsigntemplate_response_v4_t *ezsigntemplate_response_v4) {
    cJSON *item = cJSON_CreateObject();

    // ezsigntemplate_response_v4->pki_ezsigntemplate_id
    if (!ezsigntemplate_response_v4->pki_ezsigntemplate_id) {
        goto fail;
    }
    if(cJSON_AddNumberToObject(item, "pkiEzsigntemplateID", *ezsigntemplate_response_v4->pki_ezsigntemplate_id) == NULL) {
    goto fail; //Numeric
    }


    // ezsigntemplate_response_v4->fki_ezsigntemplatedocument_id
    if(ezsigntemplate_response_v4->fki_ezsigntemplatedocument_id) {
    if(cJSON_AddNumberToObject(item, "fkiEzsigntemplatedocumentID", *ezsigntemplate_response_v4->fki_ezsigntemplatedocument_id) == NULL) {
    goto fail; //Numeric
    }
    }


    // ezsigntemplate_response_v4->fki_ezsignfoldertype_id
    if(ezsigntemplate_response_v4->fki_ezsignfoldertype_id) {
    if(cJSON_AddNumberToObject(item, "fkiEzsignfoldertypeID", *ezsigntemplate_response_v4->fki_ezsignfoldertype_id) == NULL) {
    goto fail; //Numeric
    }
    }


    // ezsigntemplate_response_v4->obj_ezsignfoldertype
    if(ezsigntemplate_response_v4->obj_ezsignfoldertype) {
    cJSON *obj_ezsignfoldertype_local_JSON = custom_ezsignfoldertype_template_response_convertToJSON(ezsigntemplate_response_v4->obj_ezsignfoldertype);
    ...
    // ezsigntemplate_response_v4->fki_language_id
    if (!ezsigntemplate_response_v4->fki_language_id) {
        goto fail;
    }
    if(cJSON_AddNumberToObject(item, "fkiLanguageID", *ezsigntemplate_response_v4->fki_language_id) == NULL) {
    goto fail; //Numeric
    }


    // ezsigntemplate_response_v4->fki_ezdoctemplatedocument_id
    if(ezsigntemplate_response_v4->fki_ezdoctemplatedocument_id) {
    if(cJSON_AddNumberToObject(item, "fkiEzdoctemplatedocumentID", *ezsigntemplate_response_v4->fki_ezdoctemplatedocument_id) == NULL) {
    goto fail; //Numeric
    }
    }


    // ezsigntemplate_response_v4->s_ezdoctemplatedocument_name_x
    if(ezsigntemplate_response_v4->s_ezdoctemplatedocument_name_x) {
    if(cJSON_AddStringToObject(item, "sEzdoctemplatedocumentNameX", ezsigntemplate_response_v4->s_ezdoctemplatedocument_name_x) == NULL) {
    goto fail; //String
    }
    }


    // ezsigntemplate_response_v4->s_language_name_x
    if (!ezsigntemplate_response_v4->s_language_name_x) {
        goto fail;
    }
    if(cJSON_AddStringToObject(item, "sLanguageNameX", ezsigntemplate_response_v4->s_language_name_x) == NULL) {
    goto fail; //String
    }


    // ezsigntemplate_response_v4->s_ezsigntemplate_description
    if (!ezsigntemplate_response_v4->s_ezsigntemplate_description) {
        goto fail;
    }
    if(cJSON_AddStringToObject(item, "sEzsigntemplateDescription", ezsigntemplate_response_v4->s_ezsigntemplate_description) == NULL) {
    goto fail; //String
    }


    // ezsigntemplate_response_v4->s_ezsigntemplate_externaldescription
    if(ezsigntemplate_response_v4->s_ezsigntemplate_externaldescription) {
    if(cJSON_AddStringToObject(item, "sEzsigntemplateExternaldescription", ezsigntemplate_response_v4->s_ezsigntemplate_externaldescription) == NULL) {
    goto fail; //String
    }
    }


    // ezsigntemplate_response_v4->t_ezsigntemplate_comment
    if(ezsigntemplate_response_v4->t_ezsigntemplate_comment) {
    if(cJSON_AddStringToObject(item, "tEzsigntemplateComment", ezsigntemplate_response_v4->t_ezsigntemplate_comment) == NULL) {
    goto fail; //String
    }
    }


    // ezsigntemplate_response_v4->e_ezsigntemplate_recognition
    if(ezsigntemplate_response_v4->e_ezsigntemplate_recognition != ezmax_api_definition__full_field_e_ezsigntemplate_recognition__NULL) {
    cJSON *e_ezsigntemplate_recognition_local_JSON = field_e_ezsigntemplate_recognition_convertToJSON(ezsigntemplate_response_v4->e_ezsigntemplate_recognition);
    ...
    // ezsigntemplate_response_v4->s_ezsigntemplate_filenameregexp
    if(ezsigntemplate_response_v4->s_ezsigntemplate_filenameregexp) {
    if(cJSON_AddStringToObject(item, "sEzsigntemplateFilenameregexp", ezsigntemplate_response_v4->s_ezsigntemplate_filenameregexp) == NULL) {
    goto fail; //String
    }
    }


    // ezsigntemplate_response_v4->b_ezsigntemplate_adminonly
    if (!ezsigntemplate_response_v4->b_ezsigntemplate_adminonly) {
        goto fail;
    }
    if(cJSON_AddBoolToObject(item, "bEzsigntemplateAdminonly", *ezsigntemplate_response_v4->b_ezsigntemplate_adminonly) == NULL) {
    goto fail; //Bool
    }


    // ezsigntemplate_response_v4->s_ezsignfoldertype_name_x
    if(ezsigntemplate_response_v4->s_ezsignfoldertype_name_x) {
    if(cJSON_AddStringToObject(item, "sEzsignfoldertypeNameX", ezsigntemplate_response_v4->s_ezsignfoldertype_name_x) == NULL) {
    goto fail; //String
    }
    }


    // ezsigntemplate_response_v4->obj_audit
    if (!ezsigntemplate_response_v4->obj_audit) {
        goto fail;
    }
    cJSON *obj_audit_local_JSON = common_audit_convertToJSON(ezsigntemplate_response_v4->obj_audit);
    ...
    // ezsigntemplate_response_v4->b_ezsigntemplate_editallowed
    if (!ezsigntemplate_response_v4->b_ezsigntemplate_editallowed) {
        goto fail;
    }
    if(cJSON_AddBoolToObject(item, "bEzsigntemplateEditallowed", *ezsigntemplate_response_v4->b_ezsigntemplate_editallowed) == NULL) {
    goto fail; //Bool
    }


    // ezsigntemplate_response_v4->e_ezsigntemplate_type
    if(ezsigntemplate_response_v4->e_ezsigntemplate_type != ezmax_api_definition__full_field_e_ezsigntemplate_type__NULL) {
    cJSON *e_ezsigntemplate_type_local_JSON = field_e_ezsigntemplate_type_convertToJSON(ezsigntemplate_response_v4->e_ezsigntemplate_type);
...
ezsigntemplate_response_v4_t *ezsigntemplate_response_v4_parseFromJSON(cJSON *ezsigntemplate_response_v4JSON){
    ...
    ezsigntemplate_response_v4_t *ezsigntemplate_response_v4_local_var = NULL;

    // define the local variable for ezsigntemplate_response_v4->pki_ezsigntemplate_id
    int *pki_ezsigntemplate_id_local_var = NULL;

    // define the local variable for ezsigntemplate_response_v4->fki_ezsigntemplatedocument_id
    int *fki_ezsigntemplatedocument_id_local_var = NULL;

    // define the local variable for ezsigntemplate_response_v4->fki_ezsignfoldertype_id
    int *fki_ezsignfoldertype_id_local_var = NULL;

    // define the local variable for ezsigntemplate_response_v4->obj_ezsignfoldertype
    custom_ezsignfoldertype_template_response_t *obj_ezsignfoldertype_local_nonprim = NULL;

    // define the local variable for ezsigntemplate_response_v4->fki_language_id
    int *fki_language_id_local_var = NULL;

    // define the local variable for ezsigntemplate_response_v4->fki_ezdoctemplatedocument_id
    ...
    // define the local variable for ezsigntemplate_response_v4->e_ezsigntemplate_recognition
    ...
    // define the local variable for ezsigntemplate_response_v4->b_ezsigntemplate_adminonly
    int *b_ezsigntemplate_adminonly_local_var = NULL;

    char *s_ezsignfoldertype_name_x_local_str = NULL;

    // define the local variable for ezsigntemplate_response_v4->obj_audit
    common_audit_t *obj_audit_local_nonprim = NULL;

    // define the local variable for ezsigntemplate_response_v4->b_ezsigntemplate_editallowed
    int *b_ezsigntemplate_editallowed_local_var = NULL;

    // define the local variable for ezsigntemplate_response_v4->e_ezsigntemplate_type
    ezmax_api_definition__full_field_e_ezsigntemplate_type__e e_ezsigntemplate_type_local_nonprim = 0;

    // ezsigntemplate_response_v4->pki_ezsigntemplate_id
    cJSON *pki_ezsigntemplate_id = cJSON_GetObjectItemCaseSensitive(ezsigntemplate_response_v4JSON, "pkiEzsigntemplateID");
    ...
    *pki_ezsigntemplate_id_local_var = pki_ezsigntemplate_id->valuedouble;
    ...
    // ezsigntemplate_response_v4->fki_ezsigntemplatedocument_id
    cJSON *fki_ezsigntemplatedocument_id = cJSON_GetObjectItemCaseSensitive(ezsigntemplate_response_v4JSON, "fkiEzsigntemplatedocumentID");
    ...
    *fki_ezsigntemplatedocument_id_local_var = fki_ezsigntemplatedocument_id->valuedouble;
    ...
    // ezsigntemplate_response_v4->fki_ezsignfoldertype_id
    cJSON *fki_ezsignfoldertype_id = cJSON_GetObjectItemCaseSensitive(ezsigntemplate_response_v4JSON, "fkiEzsignfoldertypeID");
    ...
    *fki_ezsignfoldertype_id_local_var = fki_ezsignfoldertype_id->valuedouble;
    ...
    // ezsigntemplate_response_v4->obj_ezsignfoldertype
    cJSON *obj_ezsignfoldertype = cJSON_GetObjectItemCaseSensitive(ezsigntemplate_response_v4JSON, "objEzsignfoldertype");
    ...
    // ezsigntemplate_response_v4->fki_language_id
    cJSON *fki_language_id = cJSON_GetObjectItemCaseSensitive(ezsigntemplate_response_v4JSON, "fkiLanguageID");
    ...
    *fki_language_id_local_var = fki_language_id->valuedouble;
    ...
    // ezsigntemplate_response_v4->fki_ezdoctemplatedocument_id
    cJSON *fki_ezdoctemplatedocument_id = cJSON_GetObjectItemCaseSensitive(ezsigntemplate_response_v4JSON, "fkiEzdoctemplatedocumentID");
    ...
    *fki_ezdoctemplatedocument_id_local_var = fki_ezdoctemplatedocument_id->valuedouble;
    ...
    // ezsigntemplate_response_v4->s_ezdoctemplatedocument_name_x
    cJSON *s_ezdoctemplatedocument_name_x = cJSON_GetObjectItemCaseSensitive(ezsigntemplate_response_v4JSON, "sEzdoctemplatedocumentNameX");
    ...
    // ezsigntemplate_response_v4->s_language_name_x
    cJSON *s_language_name_x = cJSON_GetObjectItemCaseSensitive(ezsigntemplate_response_v4JSON, "sLanguageNameX");
    ...
    // ezsigntemplate_response_v4->s_ezsigntemplate_description
    cJSON *s_ezsigntemplate_description = cJSON_GetObjectItemCaseSensitive(ezsigntemplate_response_v4JSON, "sEzsigntemplateDescription");
    ...
    // ezsigntemplate_response_v4->s_ezsigntemplate_externaldescription
    cJSON *s_ezsigntemplate_externaldescription = cJSON_GetObjectItemCaseSensitive(ezsigntemplate_response_v4JSON, "sEzsigntemplateExternaldescription");
    ...
    // ezsigntemplate_response_v4->t_ezsigntemplate_comment
    cJSON *t_ezsigntemplate_comment = cJSON_GetObjectItemCaseSensitive(ezsigntemplate_response_v4JSON, "tEzsigntemplateComment");
    ...
    // ezsigntemplate_response_v4->e_ezsigntemplate_recognition
    cJSON *e_ezsigntemplate_recognition = cJSON_GetObjectItemCaseSensitive(ezsigntemplate_response_v4JSON, "eEzsigntemplateRecognition");
    ...
    // ezsigntemplate_response_v4->s_ezsigntemplate_filenameregexp
    cJSON *s_ezsigntemplate_filenameregexp = cJSON_GetObjectItemCaseSensitive(ezsigntemplate_response_v4JSON, "sEzsigntemplateFilenameregexp");
    ...
    // ezsigntemplate_response_v4->b_ezsigntemplate_adminonly
    cJSON *b_ezsigntemplate_adminonly = cJSON_GetObjectItemCaseSensitive(ezsigntemplate_response_v4JSON, "bEzsigntemplateAdminonly");
    ...
    *b_ezsigntemplate_adminonly_local_var = b_ezsigntemplate_adminonly->valueint;
    ...
    // ezsigntemplate_response_v4->s_ezsignfoldertype_name_x
    cJSON *s_ezsignfoldertype_name_x = cJSON_GetObjectItemCaseSensitive(ezsigntemplate_response_v4JSON, "sEzsignfoldertypeNameX");
    ...
    // ezsigntemplate_response_v4->obj_audit
    cJSON *obj_audit = cJSON_GetObjectItemCaseSensitive(ezsigntemplate_response_v4JSON, "objAudit");
    ...
    // ezsigntemplate_response_v4->b_ezsigntemplate_editallowed
    cJSON *b_ezsigntemplate_editallowed = cJSON_GetObjectItemCaseSensitive(ezsigntemplate_response_v4JSON, "bEzsigntemplateEditallowed");
    ...
    *b_ezsigntemplate_editallowed_local_var = b_ezsigntemplate_editallowed->valueint;
    ...
    // ezsigntemplate_response_v4->e_ezsigntemplate_type
    cJSON *e_ezsigntemplate_type = cJSON_GetObjectItemCaseSensitive(ezsigntemplate_response_v4JSON, "eEzsigntemplateType");
    ...
    ezsigntemplate_response_v4_local_var = ezsigntemplate_response_v4_create_internal (
