...
static contact_request_compound_v2_t *contact_request_compound_v2_create_internal(
    ...
    memset(contact_request_compound_v2_local_var, 0, sizeof(contact_request_compound_v2_t));
...
__attribute__((deprecated)) contact_request_compound_v2_t *contact_request_compound_v2_create(
    ...
    contact_request_compound_v2_t *result = contact_request_compound_v2_create_internal (
...
void contact_request_compound_v2_free(contact_request_compound_v2_t *contact_request_compound_v2) {
    ...
    if (contact_request_compound_v2->fki_contacttitle_id) {
        free(contact_request_compound_v2->fki_contacttitle_id);
        contact_request_compound_v2->fki_contacttitle_id = NULL;
    }
    if (contact_request_compound_v2->fki_language_id) {
        free(contact_request_compound_v2->fki_language_id);
        contact_request_compound_v2->fki_language_id = NULL;
    }
    ...
    if (contact_request_compound_v2->b_contact_isactive) {
        free(contact_request_compound_v2->b_contact_isactive);
        contact_request_compound_v2->b_contact_isactive = NULL;
    }
...
contact_request_compound_v2_t *contact_request_compound_v2_parseFromJSON(cJSON *contact_request_compound_v2JSON){
    ...
    // define the local variable for contact_request_compound_v2->fki_contacttitle_id
    int *fki_contacttitle_id_local_var = NULL;

    // define the local variable for contact_request_compound_v2->fki_language_id
    ...
    // define the local variable for contact_request_compound_v2->b_contact_isactive
