...
typedef enum  { ezmax_api_definition__full_ezsigntemplatesignature_request_compound__NULL = 0, ezmax_api_definition__full_ezsigntemplatesignature_request_compound__PerCoordinates, ezmax_api_definition__full_ezsigntemplatesignature_request_compound__PerPositioningPattern } ezmax_api_definition__full_ezsigntemplatesignature_request_compound__e;
...
typedef enum  { ezmax_api_definition__full_ezsigntemplatesignature_request_compound__NULL = 0, ezmax_api_definition__full_ezsigntemplatesignature_request_compound__Automatic, ezmax_api_definition__full_ezsigntemplatesignature_request_compound__Manual } ezmax_api_definition__full_ezsigntemplatesignature_request_compound__e;
...
typedef enum  { ezmax_api_definition__full_ezsigntemplatesignature_request_compound__NULL = 0, ezmax_api_definition__full_ezsigntemplatesignature_request_compound__None, ezmax_api_definition__full_ezsigntemplatesignature_request_compound__Date (YYYY_MM_DD), ezmax_api_definition__full_ezsigntemplatesignature_request_compound__Date (MM/DD/YYYY), ezmax_api_definition__full_ezsigntemplatesignature_request_compound__Date (MM/DD/YY), ezmax_api_definition__full_ezsigntemplatesignature_request_compound__Date (DD/MM/YYYY), ezmax_api_definition__full_ezsigntemplatesignature_request_compound__Date (DD/MM/YY), ezmax_api_definition__full_ezsigntemplatesignature_request_compound__Email, ezmax_api_definition__full_ezsigntemplatesignature_request_compound__Letters, ezmax_api_definition__full_ezsigntemplatesignature_request_compound__Numbers, ezmax_api_definition__full_ezsigntemplatesignature_request_compound__Zip, ezmax_api_definition__full_ezsigntemplatesignature_request_compound__Zip+4, ezmax_api_definition__full_ezsigntemplatesignature_request_compound__PostalCode, ezmax_api_definition__full_ezsigntemplatesignature_request_compound__Custom } ezmax_api_definition__full_ezsigntemplatesignature_request_compound__e;
...
typedef enum  { ezmax_api_definition__full_ezsigntemplatesignature_request_compound__NULL = 0, ezmax_api_definition__full_ezsigntemplatesignature_request_compound__AllOf, ezmax_api_definition__full_ezsigntemplatesignature_request_compound__AnyOf } ezmax_api_definition__full_ezsigntemplatesignature_request_compound__e;
...
typedef enum  { ezmax_api_definition__full_ezsigntemplatesignature_request_compound__NULL = 0, ezmax_api_definition__full_ezsigntemplatesignature_request_compound__All, ezmax_api_definition__full_ezsigntemplatesignature_request_compound__First, ezmax_api_definition__full_ezsigntemplatesignature_request_compound__Last } ezmax_api_definition__full_ezsigntemplatesignature_request_compound__e;
