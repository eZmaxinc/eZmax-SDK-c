...
typedef struct user_request_t user_request_t;
...
// Enum  for user_request

typedef enum  { ezmax_api_definition__full_user_request__NULL = 0, ezmax_api_definition__full_user_request__AgentBroker, ezmax_api_definition__full_user_request__Assistant, ezmax_api_definition__full_user_request__Employee, ezmax_api_definition__full_user_request__EzsignUser, ezmax_api_definition__full_user_request__Normal } ezmax_api_definition__full_user_request__e;
...
typedef enum  { ezmax_api_definition__full_user_request__NULL = 0, ezmax_api_definition__full_user_request__Password, ezmax_api_definition__full_user_request__PasswordPhone, ezmax_api_definition__full_user_request__PasswordQuestion } ezmax_api_definition__full_user_request__e;
...
typedef enum  { ezmax_api_definition__full_user_request__NULL = 0, ezmax_api_definition__full_user_request__No, ezmax_api_definition__full_user_request__PaidByOffice, ezmax_api_definition__full_user_request__PerDocument, ezmax_api_definition__full_user_request__Prepaid } ezmax_api_definition__full_user_request__e;
...
typedef struct user_request_t {
    ...
    struct phone_request_t *obj_phone_home; //model
    struct phone_request_t *obj_phone_sms; //model
