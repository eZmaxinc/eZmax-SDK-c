...
static buyercontract_get_list_v1_response_m_payload_t *buyercontract_get_list_v1_response_m_payload_create_internal(
    ...
    memset(buyercontract_get_list_v1_response_m_payload_local_var, 0, sizeof(buyercontract_get_list_v1_response_m_payload_t));
...
__attribute__((deprecated)) buyercontract_get_list_v1_response_m_payload_t *buyercontract_get_list_v1_response_m_payload_create(
    ...
    buyercontract_get_list_v1_response_m_payload_t *result = buyercontract_get_list_v1_response_m_payload_create_internal (
        i_row_returned_copy,
        i_row_filtered_copy,
        a_obj_buyercontract
        );
...
void buyercontract_get_list_v1_response_m_payload_free(buyercontract_get_list_v1_response_m_payload_t *buyercontract_get_list_v1_response_m_payload) {
    ...
    if (buyercontract_get_list_v1_response_m_payload->i_row_returned) {
        free(buyercontract_get_list_v1_response_m_payload->i_row_returned);
        buyercontract_get_list_v1_response_m_payload->i_row_returned = NULL;
    }
    if (buyercontract_get_list_v1_response_m_payload->i_row_filtered) {
        free(buyercontract_get_list_v1_response_m_payload->i_row_filtered);
        buyercontract_get_list_v1_response_m_payload->i_row_filtered = NULL;
    }
...
buyercontract_get_list_v1_response_m_payload_t *buyercontract_get_list_v1_response_m_payload_parseFromJSON(cJSON *buyercontract_get_list_v1_response_m_payloadJSON){
    ...
    // define the local variable for buyercontract_get_list_v1_response_m_payload->i_row_returned
    int *i_row_returned_local_var = NULL;

    // define the local variable for buyercontract_get_list_v1_response_m_payload->i_row_filtered
