...
static discussionmessage_create_object_v1_response_t *discussionmessage_create_object_v1_response_create_internal(
    ...
    memset(discussionmessage_create_object_v1_response_local_var, 0, sizeof(discussionmessage_create_object_v1_response_t));
...
__attribute__((deprecated)) discussionmessage_create_object_v1_response_t *discussionmessage_create_object_v1_response_create(
    ...
    discussionmessage_create_object_v1_response_t *result = discussionmessage_create_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
