...
static systemconfiguration_response_t *systemconfiguration_response_create_internal(
    ...
    systemconfiguration_response_local_var->fki_timezone_id_default = fki_timezone_id_default;
    systemconfiguration_response_local_var->s_timezone_name_default = s_timezone_name_default;
...
cJSON *systemconfiguration_response_convertToJSON(systemconfiguration_response_t *systemconfiguration_response) {
    ...
    if(cJSON_AddStringToObject(item, "sTimezoneNameDefault", systemconfiguration_response->s_timezone_name_default) == NULL) {
    goto fail; //String
    }
...
systemconfiguration_response_t *systemconfiguration_response_parseFromJSON(cJSON *systemconfiguration_responseJSON){
    ...
    // systemconfiguration_response->fki_timezone_id_default
    cJSON *fki_timezone_id_default = cJSON_GetObjectItemCaseSensitive(systemconfiguration_responseJSON, "fkiTimezoneIDDefault");
    ...
    // systemconfiguration_response->i_systemconfiguration_ezsignreminderhoursend
    cJSON *i_systemconfiguration_ezsignreminderhoursend = cJSON_GetObjectItemCaseSensitive(systemconfiguration_responseJSON, "iSystemconfigurationEzsignreminderhoursend");
