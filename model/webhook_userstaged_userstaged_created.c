...
static webhook_userstaged_userstaged_created_t *webhook_userstaged_userstaged_created_create_internal(
    ...
    memset(webhook_userstaged_userstaged_created_local_var, 0, sizeof(webhook_userstaged_userstaged_created_t));
...
__attribute__((deprecated)) webhook_userstaged_userstaged_created_t *webhook_userstaged_userstaged_created_create(
    ...
    webhook_userstaged_userstaged_created_t *result = webhook_userstaged_userstaged_created_create_internal (
        obj_webhook,
        a_obj_attempt,
        obj_userstaged
        );
