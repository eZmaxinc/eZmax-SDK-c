...
static ezmaxinvoicing_get_provisional_v1_response_t *ezmaxinvoicing_get_provisional_v1_response_create_internal(
...
__attribute__((deprecated)) ezmaxinvoicing_get_provisional_v1_response_t *ezmaxinvoicing_get_provisional_v1_response_create(
    common_response_obj_debug_payload_t *obj_debug_payload,
    common_response_obj_debug_t *obj_debug,
    ezmaxinvoicing_get_provisional_v1_response_m_payload_t *m_payload
    ) {
...
void ezmaxinvoicing_get_provisional_v1_response_free(ezmaxinvoicing_get_provisional_v1_response_t *ezmaxinvoicing_get_provisional_v1_response) {
    ...
    if(ezmaxinvoicing_get_provisional_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezmaxinvoicing_get_provisional_v1_response_free");
        return ;
    }
