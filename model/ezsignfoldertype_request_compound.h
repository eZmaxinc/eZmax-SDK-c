...
typedef enum  { ezmax_api_definition__full_ezsignfoldertype_request_compound__NULL = 0, ezmax_api_definition__full_ezsignfoldertype_request_compound__PerEzsigndocument, ezmax_api_definition__full_ezsignfoldertype_request_compound__PerEzsignfolder } ezmax_api_definition__full_ezsignfoldertype_request_compound__e;
