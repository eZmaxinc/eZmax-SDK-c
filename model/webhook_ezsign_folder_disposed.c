...
#include <string.h>
#include <stdio.h>
#include "webhook_ezsign_folder_disposed.h"
...
static webhook_ezsign_folder_disposed_t *webhook_ezsign_folder_disposed_create_internal(
    ...
    webhook_ezsign_folder_disposed_t *webhook_ezsign_folder_disposed_local_var = malloc(sizeof(webhook_ezsign_folder_disposed_t));
    if (!webhook_ezsign_folder_disposed_local_var) {
        return NULL;
    }
    memset(webhook_ezsign_folder_disposed_local_var, 0, sizeof(webhook_ezsign_folder_disposed_t));
    webhook_ezsign_folder_disposed_local_var->_library_owned = 1;
    webhook_ezsign_folder_disposed_local_var->obj_webhook = obj_webhook;
...
__attribute__((deprecated)) webhook_ezsign_folder_disposed_t *webhook_ezsign_folder_disposed_create(
    ...
    webhook_ezsign_folder_disposed_t *result = webhook_ezsign_folder_disposed_create_internal (
        obj_webhook,
        a_obj_attempt,
        obj_ezsignfolder
        );
...
void webhook_ezsign_folder_disposed_free(webhook_ezsign_folder_disposed_t *webhook_ezsign_folder_disposed) {
    ...
    if (webhook_ezsign_folder_disposed->obj_webhook) {
        custom_webhook_response_free(webhook_ezsign_folder_disposed->obj_webhook);
        webhook_ezsign_folder_disposed->obj_webhook = NULL;
    }
    ...
    if (webhook_ezsign_folder_disposed->obj_ezsignfolder) {
        ezsignfolder_response_free(webhook_ezsign_folder_disposed->obj_ezsignfolder);
        webhook_ezsign_folder_disposed->obj_ezsignfolder = NULL;
    }
    free(webhook_ezsign_folder_disposed);
}
...
cJSON *webhook_ezsign_folder_disposed_convertToJSON(webhook_ezsign_folder_disposed_t *webhook_ezsign_folder_disposed) {
    ...
    cJSON *obj_webhook_local_JSON = custom_webhook_response_convertToJSON(webhook_ezsign_folder_disposed->obj_webhook);
    ...
    cJSON *obj_ezsignfolder_local_JSON = ezsignfolder_response_convertToJSON(webhook_ezsign_folder_disposed->obj_ezsignfolder);
...
webhook_ezsign_folder_disposed_t *webhook_ezsign_folder_disposed_parseFromJSON(cJSON *webhook_ezsign_folder_disposedJSON){
    ...
    webhook_ezsign_folder_disposed_t *webhook_ezsign_folder_disposed_local_var = NULL;

    // define the local variable for webhook_ezsign_folder_disposed->obj_webhook
    custom_webhook_response_t *obj_webhook_local_nonprim = NULL;

    // define the local list for webhook_ezsign_folder_disposed->a_obj_attempt
    list_t *a_obj_attemptList = NULL;

    // define the local variable for webhook_ezsign_folder_disposed->obj_ezsignfolder
