...
static supplier_get_list_v1_response_t *supplier_get_list_v1_response_create_internal(
    ...
    memset(supplier_get_list_v1_response_local_var, 0, sizeof(supplier_get_list_v1_response_t));
...
__attribute__((deprecated)) supplier_get_list_v1_response_t *supplier_get_list_v1_response_create(
    ...
    supplier_get_list_v1_response_t *result = supplier_get_list_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
