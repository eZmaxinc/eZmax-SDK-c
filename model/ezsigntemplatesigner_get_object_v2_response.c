...
static ezsigntemplatesigner_get_object_v2_response_t *ezsigntemplatesigner_get_object_v2_response_create_internal(
    ...
    memset(ezsigntemplatesigner_get_object_v2_response_local_var, 0, sizeof(ezsigntemplatesigner_get_object_v2_response_t));
    ezsigntemplatesigner_get_object_v2_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezsigntemplatesigner_get_object_v2_response_t *ezsigntemplatesigner_get_object_v2_response_create(
    ...
    ezsigntemplatesigner_get_object_v2_response_t *result = ezsigntemplatesigner_get_object_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void ezsigntemplatesigner_get_object_v2_response_free(ezsigntemplatesigner_get_object_v2_response_t *ezsigntemplatesigner_get_object_v2_response) {
    ...
    if(ezsigntemplatesigner_get_object_v2_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsigntemplatesigner_get_object_v2_response_free");
        return ;
    }
...
ezsigntemplatesigner_get_object_v2_response_t *ezsigntemplatesigner_get_object_v2_response_parseFromJSON(cJSON *ezsigntemplatesigner_get_object_v2_responseJSON){
    ...
    ezsigntemplatesigner_get_object_v2_response_local_var = ezsigntemplatesigner_get_object_v2_response_create_internal (
