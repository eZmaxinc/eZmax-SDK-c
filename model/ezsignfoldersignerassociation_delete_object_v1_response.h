...
#define _ezsignfoldersignerassociation_delete_object_v1_response_H_
...
typedef struct ezsignfoldersignerassociation_delete_object_v1_response_t ezsignfoldersignerassociation_delete_object_v1_response_t;
...
typedef struct ezsignfoldersignerassociation_delete_object_v1_response_t {
    struct common_response_obj_debug_payload_t *obj_debug_payload; //model
    struct common_response_obj_debug_t *obj_debug; //model

} ezsignfoldersignerassociation_delete_object_v1_response_t;

ezsignfoldersignerassociation_delete_object_v1_response_t *ezsignfoldersignerassociation_delete_object_v1_response_create(
...
#endif /* _ezsignfoldersignerassociation_delete_object_v1_response_H_ */
