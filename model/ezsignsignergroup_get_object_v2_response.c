...
static ezsignsignergroup_get_object_v2_response_t *ezsignsignergroup_get_object_v2_response_create_internal(
    ...
    memset(ezsignsignergroup_get_object_v2_response_local_var, 0, sizeof(ezsignsignergroup_get_object_v2_response_t));
    ezsignsignergroup_get_object_v2_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezsignsignergroup_get_object_v2_response_t *ezsignsignergroup_get_object_v2_response_create(
    common_response_obj_debug_payload_t *obj_debug_payload,
    common_response_obj_debug_t *obj_debug,
    ezsignsignergroup_get_object_v2_response_m_payload_t *m_payload
    ) {
    ezsignsignergroup_get_object_v2_response_t *result = ezsignsignergroup_get_object_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void ezsignsignergroup_get_object_v2_response_free(ezsignsignergroup_get_object_v2_response_t *ezsignsignergroup_get_object_v2_response) {
    ...
    if(ezsignsignergroup_get_object_v2_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsignsignergroup_get_object_v2_response_free");
        return ;
    }
...
ezsignsignergroup_get_object_v2_response_t *ezsignsignergroup_get_object_v2_response_parseFromJSON(cJSON *ezsignsignergroup_get_object_v2_responseJSON){
    ...
    ezsignsignergroup_get_object_v2_response_local_var = ezsignsignergroup_get_object_v2_response_create_internal (
