...
static ezsignfoldertype_edit_object_v3_response_t *ezsignfoldertype_edit_object_v3_response_create_internal(
    ...
    memset(ezsignfoldertype_edit_object_v3_response_local_var, 0, sizeof(ezsignfoldertype_edit_object_v3_response_t));
...
__attribute__((deprecated)) ezsignfoldertype_edit_object_v3_response_t *ezsignfoldertype_edit_object_v3_response_create(
    ...
    ezsignfoldertype_edit_object_v3_response_t *result = ezsignfoldertype_edit_object_v3_response_create_internal (
        obj_debug_payload,
        obj_debug
        );
    if (!result) {
