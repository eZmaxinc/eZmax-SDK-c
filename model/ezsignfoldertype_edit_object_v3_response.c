...
ezsignfoldertype_edit_object_v3_response_t *ezsignfoldertype_edit_object_v3_response_create(
...
ezsignfoldertype_edit_object_v3_response_t *ezsignfoldertype_edit_object_v3_response_parseFromJSON(cJSON *ezsignfoldertype_edit_object_v3_responseJSON){
    ...
    ezsignfoldertype_edit_object_v3_response_local_var = ezsignfoldertype_edit_object_v3_response_create (
