...
char* e_ezsigntemplateformfield_positioningezsigntemplateformfield_response_compound_ToString(ezmax_api_definition__full_ezsigntemplateformfield_response_compound__e e_ezsigntemplateformfield_positioning) {
...
ezmax_api_definition__full_ezsigntemplateformfield_response_compound__e e_ezsigntemplateformfield_positioningezsigntemplateformfield_response_compound_FromString(char* e_ezsigntemplateformfield_positioning){
...
char* e_ezsigntemplateformfield_positioningoccurenceezsigntemplateformfield_response_compound_ToString(ezmax_api_definition__full_ezsigntemplateformfield_response_compound__e e_ezsigntemplateformfield_positioningoccurence) {
...
ezmax_api_definition__full_ezsigntemplateformfield_response_compound__e e_ezsigntemplateformfield_positioningoccurenceezsigntemplateformfield_response_compound_FromString(char* e_ezsigntemplateformfield_positioningoccurence){
    int stringToReturn = 0;
    char *e_ezsigntemplateformfield_positioningoccurenceArray[] =  { "NULL", "All", "First", "Last" };
...
void ezsigntemplateformfield_response_compound_free(ezsigntemplateformfield_response_compound_t *ezsigntemplateformfield_response_compound) {
    ...
    if (ezsigntemplateformfield_response_compound->e_ezsigntemplateformfield_positioning) {
        field_e_ezsigntemplateformfield_positioning_free(ezsigntemplateformfield_response_compound->e_ezsigntemplateformfield_positioning);
        ezsigntemplateformfield_response_compound->e_ezsigntemplateformfield_positioning = NULL;
    }
    ...
    if (ezsigntemplateformfield_response_compound->e_ezsigntemplateformfield_positioningoccurence) {
        field_e_ezsigntemplateformfield_positioningoccurence_free(ezsigntemplateformfield_response_compound->e_ezsigntemplateformfield_positioningoccurence);
        ezsigntemplateformfield_response_compound->e_ezsigntemplateformfield_positioningoccurence = NULL;
    }
...
cJSON *ezsigntemplateformfield_response_compound_convertToJSON(ezsigntemplateformfield_response_compound_t *ezsigntemplateformfield_response_compound) {
    ...
    if(ezsigntemplateformfield_response_compound->e_ezsigntemplateformfield_positioning != ezmax_api_definition__full_ezsigntemplateformfield_response_compound__NULL) {
    ...
    if(ezsigntemplateformfield_response_compound->e_ezsigntemplateformfield_positioningoccurence != ezmax_api_definition__full_ezsigntemplateformfield_response_compound__NULL) {
