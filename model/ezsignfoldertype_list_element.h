...
typedef enum  { ezmax_api_definition_ezsignfoldertype_list_element__NULL = 0, ezmax_api_definition_ezsignfoldertype_list_element__User, ezmax_api_definition_ezsignfoldertype_list_element__Usergroup } ezmax_api_definition_ezsignfoldertype_list_element__e;

char* ezsignfoldertype_list_element_e_ezsignfoldertype_privacylevel_ToString(ezmax_api_definition_ezsignfoldertype_list_element__e e_ezsignfoldertype_privacylevel);

ezmax_api_definition_ezsignfoldertype_list_element__e ezsignfoldertype_list_element_e_ezsignfoldertype_privacylevel_FromString(char* e_ezsignfoldertype_privacylevel);
