...
static ezsigntemplatepackagemembership_request_t *ezsigntemplatepackagemembership_request_create_internal(
    ...
    memset(ezsigntemplatepackagemembership_request_local_var, 0, sizeof(ezsigntemplatepackagemembership_request_t));
...
__attribute__((deprecated)) ezsigntemplatepackagemembership_request_t *ezsigntemplatepackagemembership_request_create(
    ...
    ezsigntemplatepackagemembership_request_t *result = ezsigntemplatepackagemembership_request_create_internal (
...
void ezsigntemplatepackagemembership_request_free(ezsigntemplatepackagemembership_request_t *ezsigntemplatepackagemembership_request) {
    ...
    if (ezsigntemplatepackagemembership_request->pki_ezsigntemplatepackagemembership_id) {
        free(ezsigntemplatepackagemembership_request->pki_ezsigntemplatepackagemembership_id);
        ezsigntemplatepackagemembership_request->pki_ezsigntemplatepackagemembership_id = NULL;
    }
    if (ezsigntemplatepackagemembership_request->fki_ezsigntemplatepackage_id) {
        free(ezsigntemplatepackagemembership_request->fki_ezsigntemplatepackage_id);
        ezsigntemplatepackagemembership_request->fki_ezsigntemplatepackage_id = NULL;
    }
    if (ezsigntemplatepackagemembership_request->fki_ezsigntemplate_id) {
        free(ezsigntemplatepackagemembership_request->fki_ezsigntemplate_id);
        ezsigntemplatepackagemembership_request->fki_ezsigntemplate_id = NULL;
    }
...
ezsigntemplatepackagemembership_request_t *ezsigntemplatepackagemembership_request_parseFromJSON(cJSON *ezsigntemplatepackagemembership_requestJSON){
    ...
    // define the local variable for ezsigntemplatepackagemembership_request->pki_ezsigntemplatepackagemembership_id
    int *pki_ezsigntemplatepackagemembership_id_local_var = NULL;

    // define the local variable for ezsigntemplatepackagemembership_request->fki_ezsigntemplatepackage_id
    int *fki_ezsigntemplatepackage_id_local_var = NULL;

    // define the local variable for ezsigntemplatepackagemembership_request->fki_ezsigntemplate_id
