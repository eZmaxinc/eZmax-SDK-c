...
static ezsignbulksend_delete_object_v1_response_t *ezsignbulksend_delete_object_v1_response_create_internal(
    ...
    memset(ezsignbulksend_delete_object_v1_response_local_var, 0, sizeof(ezsignbulksend_delete_object_v1_response_t));
    ezsignbulksend_delete_object_v1_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezsignbulksend_delete_object_v1_response_t *ezsignbulksend_delete_object_v1_response_create(
    ...
    ezsignbulksend_delete_object_v1_response_t *result = ezsignbulksend_delete_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug
        );
    if (!result) {
...
void ezsignbulksend_delete_object_v1_response_free(ezsignbulksend_delete_object_v1_response_t *ezsignbulksend_delete_object_v1_response) {
    ...
    if(ezsignbulksend_delete_object_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsignbulksend_delete_object_v1_response_free");
        return ;
    }
...
ezsignbulksend_delete_object_v1_response_t *ezsignbulksend_delete_object_v1_response_parseFromJSON(cJSON *ezsignbulksend_delete_object_v1_responseJSON){
    ...
    ezsignbulksend_delete_object_v1_response_local_var = ezsignbulksend_delete_object_v1_response_create_internal (
