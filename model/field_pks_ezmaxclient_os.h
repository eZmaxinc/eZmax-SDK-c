...
typedef enum { ezmax_api_definition__full_field_pks_ezmaxclient_os__NULL = 0, ezmax_api_definition__full_field_pks_ezmaxclient_os__iOS, ezmax_api_definition__full_field_pks_ezmaxclient_os__macOS, ezmax_api_definition__full_field_pks_ezmaxclient_os__Windows } ezmax_api_definition__full_field_pks_ezmaxclient_os__e;
