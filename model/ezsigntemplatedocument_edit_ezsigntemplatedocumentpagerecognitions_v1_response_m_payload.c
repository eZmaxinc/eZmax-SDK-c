...
ezsigntemplatedocument_edit_ezsigntemplatedocumentpagerecognitions_v1_response_m_payload_t *ezsigntemplatedocument_edit_ezsigntemplatedocumentpagerecognitions_v1_response_m_payload_create(
...
ezsigntemplatedocument_edit_ezsigntemplatedocumentpagerecognitions_v1_response_m_payload_t *ezsigntemplatedocument_edit_ezsigntemplatedocumentpagerecognitions_v1_response_m_payload_parseFromJSON(cJSON *ezsigntemplatedocument_edit_ezsigntemplatedocumentpagerecognitions_v1_response_m_payloadJSON){
    ...
    ezsigntemplatedocument_edit_ezsigntemplatedocumentpagerecognitions_v1_response_m_payload_local_var = ezsigntemplatedocument_edit_ezsigntemplatedocumentpagerecognitions_v1_response_m_payload_create (
