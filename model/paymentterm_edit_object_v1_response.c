...
paymentterm_edit_object_v1_response_t *paymentterm_edit_object_v1_response_create(
...
paymentterm_edit_object_v1_response_t *paymentterm_edit_object_v1_response_parseFromJSON(cJSON *paymentterm_edit_object_v1_responseJSON){
    ...
    paymentterm_edit_object_v1_response_local_var = paymentterm_edit_object_v1_response_create (
