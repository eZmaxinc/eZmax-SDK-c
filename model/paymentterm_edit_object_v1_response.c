...
static paymentterm_edit_object_v1_response_t *paymentterm_edit_object_v1_response_create_internal(
    ...
    memset(paymentterm_edit_object_v1_response_local_var, 0, sizeof(paymentterm_edit_object_v1_response_t));
...
__attribute__((deprecated)) paymentterm_edit_object_v1_response_t *paymentterm_edit_object_v1_response_create(
    ...
    paymentterm_edit_object_v1_response_t *result = paymentterm_edit_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug
        );
    if (!result) {
