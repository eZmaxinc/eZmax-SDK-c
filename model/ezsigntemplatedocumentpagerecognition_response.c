...
void ezsigntemplatedocumentpagerecognition_response_free(ezsigntemplatedocumentpagerecognition_response_t *ezsigntemplatedocumentpagerecognition_response) {
    ...
    if (ezsigntemplatedocumentpagerecognition_response->e_ezsigntemplatedocumentpagerecognition_operator) {
        field_e_ezsigntemplatedocumentpagerecognition_operator_free(ezsigntemplatedocumentpagerecognition_response->e_ezsigntemplatedocumentpagerecognition_operator);
        ezsigntemplatedocumentpagerecognition_response->e_ezsigntemplatedocumentpagerecognition_operator = NULL;
    }
    if (ezsigntemplatedocumentpagerecognition_response->e_ezsigntemplatedocumentpagerecognition_section) {
        field_e_ezsigntemplatedocumentpagerecognition_section_free(ezsigntemplatedocumentpagerecognition_response->e_ezsigntemplatedocumentpagerecognition_section);
        ezsigntemplatedocumentpagerecognition_response->e_ezsigntemplatedocumentpagerecognition_section = NULL;
    }
...
cJSON *ezsigntemplatedocumentpagerecognition_response_convertToJSON(ezsigntemplatedocumentpagerecognition_response_t *ezsigntemplatedocumentpagerecognition_response) {
    ...
    if (ezmax_api_definition__full_ezsigntemplatedocumentpagerecognition_response__NULL == ezsigntemplatedocumentpagerecognition_response->e_ezsigntemplatedocumentpagerecognition_operator) {
        goto fail;
    }
    ...
    if (ezmax_api_definition__full_ezsigntemplatedocumentpagerecognition_response__NULL == ezsigntemplatedocumentpagerecognition_response->e_ezsigntemplatedocumentpagerecognition_section) {
        goto fail;
    }
...
ezsigntemplatedocumentpagerecognition_response_t *ezsigntemplatedocumentpagerecognition_response_parseFromJSON(cJSON *ezsigntemplatedocumentpagerecognition_responseJSON){
    ...
    ezsigntemplatedocumentpagerecognition_response_local_var = ezsigntemplatedocumentpagerecognition_response_create (
