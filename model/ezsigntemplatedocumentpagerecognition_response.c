...
static ezsigntemplatedocumentpagerecognition_response_t *ezsigntemplatedocumentpagerecognition_response_create_internal(
    ...
    memset(ezsigntemplatedocumentpagerecognition_response_local_var, 0, sizeof(ezsigntemplatedocumentpagerecognition_response_t));
...
__attribute__((deprecated)) ezsigntemplatedocumentpagerecognition_response_t *ezsigntemplatedocumentpagerecognition_response_create(
    ...
    ezsigntemplatedocumentpagerecognition_response_t *result = ezsigntemplatedocumentpagerecognition_response_create_internal (
...
void ezsigntemplatedocumentpagerecognition_response_free(ezsigntemplatedocumentpagerecognition_response_t *ezsigntemplatedocumentpagerecognition_response) {
    ...
    if (ezsigntemplatedocumentpagerecognition_response->pki_ezsigntemplatedocumentpagerecognition_id) {
        free(ezsigntemplatedocumentpagerecognition_response->pki_ezsigntemplatedocumentpagerecognition_id);
        ezsigntemplatedocumentpagerecognition_response->pki_ezsigntemplatedocumentpagerecognition_id = NULL;
    }
    if (ezsigntemplatedocumentpagerecognition_response->fki_ezsigntemplatedocumentpage_id) {
        free(ezsigntemplatedocumentpagerecognition_response->fki_ezsigntemplatedocumentpage_id);
        ezsigntemplatedocumentpagerecognition_response->fki_ezsigntemplatedocumentpage_id = NULL;
    }
    if (ezsigntemplatedocumentpagerecognition_response->i_ezsigntemplatedocumentpagerecognition_similarpercentage) {
        free(ezsigntemplatedocumentpagerecognition_response->i_ezsigntemplatedocumentpagerecognition_similarpercentage);
        ezsigntemplatedocumentpagerecognition_response->i_ezsigntemplatedocumentpagerecognition_similarpercentage = NULL;
    }
    if (ezsigntemplatedocumentpagerecognition_response->i_ezsigntemplatedocumentpagerecognition_x) {
        free(ezsigntemplatedocumentpagerecognition_response->i_ezsigntemplatedocumentpagerecognition_x);
        ezsigntemplatedocumentpagerecognition_response->i_ezsigntemplatedocumentpagerecognition_x = NULL;
    }
    if (ezsigntemplatedocumentpagerecognition_response->i_ezsigntemplatedocumentpagerecognition_y) {
        free(ezsigntemplatedocumentpagerecognition_response->i_ezsigntemplatedocumentpagerecognition_y);
        ezsigntemplatedocumentpagerecognition_response->i_ezsigntemplatedocumentpagerecognition_y = NULL;
    }
    if (ezsigntemplatedocumentpagerecognition_response->i_ezsigntemplatedocumentpagerecognition_width) {
        free(ezsigntemplatedocumentpagerecognition_response->i_ezsigntemplatedocumentpagerecognition_width);
        ezsigntemplatedocumentpagerecognition_response->i_ezsigntemplatedocumentpagerecognition_width = NULL;
    }
    if (ezsigntemplatedocumentpagerecognition_response->i_ezsigntemplatedocumentpagerecognition_height) {
        free(ezsigntemplatedocumentpagerecognition_response->i_ezsigntemplatedocumentpagerecognition_height);
        ezsigntemplatedocumentpagerecognition_response->i_ezsigntemplatedocumentpagerecognition_height = NULL;
    }
...
ezsigntemplatedocumentpagerecognition_response_t *ezsigntemplatedocumentpagerecognition_response_parseFromJSON(cJSON *ezsigntemplatedocumentpagerecognition_responseJSON){
    ...
    // define the local variable for ezsigntemplatedocumentpagerecognition_response->pki_ezsigntemplatedocumentpagerecognition_id
    int *pki_ezsigntemplatedocumentpagerecognition_id_local_var = NULL;

    // define the local variable for ezsigntemplatedocumentpagerecognition_response->fki_ezsigntemplatedocumentpage_id
    ...
    // define the local variable for ezsigntemplatedocumentpagerecognition_response->i_ezsigntemplatedocumentpagerecognition_similarpercentage
    int *i_ezsigntemplatedocumentpagerecognition_similarpercentage_local_var = NULL;

    // define the local variable for ezsigntemplatedocumentpagerecognition_response->i_ezsigntemplatedocumentpagerecognition_x
    int *i_ezsigntemplatedocumentpagerecognition_x_local_var = NULL;

    // define the local variable for ezsigntemplatedocumentpagerecognition_response->i_ezsigntemplatedocumentpagerecognition_y
    int *i_ezsigntemplatedocumentpagerecognition_y_local_var = NULL;

    // define the local variable for ezsigntemplatedocumentpagerecognition_response->i_ezsigntemplatedocumentpagerecognition_width
    int *i_ezsigntemplatedocumentpagerecognition_width_local_var = NULL;

    // define the local variable for ezsigntemplatedocumentpagerecognition_response->i_ezsigntemplatedocumentpagerecognition_height
