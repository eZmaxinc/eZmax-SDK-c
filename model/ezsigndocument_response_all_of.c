...
ezsigndocument_response_all_of_t *ezsigndocument_response_all_of_create(
    ...
    ezsigndocument_response_all_of_local_var->s_ezsigndocument_filename = s_ezsigndocument_filename;
...
void ezsigndocument_response_all_of_free(ezsigndocument_response_all_of_t *ezsigndocument_response_all_of) {
    ...
    if (ezsigndocument_response_all_of->s_ezsigndocument_filename) {
        free(ezsigndocument_response_all_of->s_ezsigndocument_filename);
        ezsigndocument_response_all_of->s_ezsigndocument_filename = NULL;
    }
...
cJSON *ezsigndocument_response_all_of_convertToJSON(ezsigndocument_response_all_of_t *ezsigndocument_response_all_of) {
    ...
    // ezsigndocument_response_all_of->s_ezsigndocument_filename
    if (!ezsigndocument_response_all_of->s_ezsigndocument_filename) {
        goto fail;
    }
    
    if(cJSON_AddStringToObject(item, "sEzsigndocumentFilename", ezsigndocument_response_all_of->s_ezsigndocument_filename) == NULL) {
    goto fail; //String
    }
...
ezsigndocument_response_all_of_t *ezsigndocument_response_all_of_parseFromJSON(cJSON *ezsigndocument_response_all_ofJSON){
    ...
    // ezsigndocument_response_all_of->s_ezsigndocument_filename
    cJSON *s_ezsigndocument_filename = cJSON_GetObjectItemCaseSensitive(ezsigndocument_response_all_ofJSON, "sEzsigndocumentFilename");
