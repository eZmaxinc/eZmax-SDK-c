...
static ezsigntemplate_request_compound_v3_t *ezsigntemplate_request_compound_v3_create_internal(
    ...
    memset(ezsigntemplate_request_compound_v3_local_var, 0, sizeof(ezsigntemplate_request_compound_v3_t));
    ezsigntemplate_request_compound_v3_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezsigntemplate_request_compound_v3_t *ezsigntemplate_request_compound_v3_create(
    ...
    ezsigntemplate_request_compound_v3_t *result = ezsigntemplate_request_compound_v3_create_internal (
...
void ezsigntemplate_request_compound_v3_free(ezsigntemplate_request_compound_v3_t *ezsigntemplate_request_compound_v3) {
    ...
    if(ezsigntemplate_request_compound_v3->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsigntemplate_request_compound_v3_free");
        return ;
    }
    listEntry_t *listEntry;
    if (ezsigntemplate_request_compound_v3->pki_ezsigntemplate_id) {
        free(ezsigntemplate_request_compound_v3->pki_ezsigntemplate_id);
        ezsigntemplate_request_compound_v3->pki_ezsigntemplate_id = NULL;
    }
    if (ezsigntemplate_request_compound_v3->fki_ezsignfoldertype_id) {
        free(ezsigntemplate_request_compound_v3->fki_ezsignfoldertype_id);
        ezsigntemplate_request_compound_v3->fki_ezsignfoldertype_id = NULL;
    }
    if (ezsigntemplate_request_compound_v3->fki_language_id) {
        free(ezsigntemplate_request_compound_v3->fki_language_id);
        ezsigntemplate_request_compound_v3->fki_language_id = NULL;
    }
    if (ezsigntemplate_request_compound_v3->fki_ezdoctemplatedocument_id) {
        free(ezsigntemplate_request_compound_v3->fki_ezdoctemplatedocument_id);
        ezsigntemplate_request_compound_v3->fki_ezdoctemplatedocument_id = NULL;
    }
    ...
    if (ezsigntemplate_request_compound_v3->b_ezsigntemplate_adminonly) {
        free(ezsigntemplate_request_compound_v3->b_ezsigntemplate_adminonly);
        ezsigntemplate_request_compound_v3->b_ezsigntemplate_adminonly = NULL;
    }
...
cJSON *ezsigntemplate_request_compound_v3_convertToJSON(ezsigntemplate_request_compound_v3_t *ezsigntemplate_request_compound_v3) {
    ...
    if(ezsigntemplate_request_compound_v3->e_ezsigntemplate_recognition != ezmax_api_definition__full_field_e_ezsigntemplate_recognition__NULL) {
    ...
    if (ezmax_api_definition__full_field_e_ezsigntemplate_type__NULL == ezsigntemplate_request_compound_v3->e_ezsigntemplate_type) {
        goto fail;
    }
...
ezsigntemplate_request_compound_v3_t *ezsigntemplate_request_compound_v3_parseFromJSON(cJSON *ezsigntemplate_request_compound_v3JSON){
    ...
    // define the local variable for ezsigntemplate_request_compound_v3->pki_ezsigntemplate_id
    int *pki_ezsigntemplate_id_local_var = NULL;

    // define the local variable for ezsigntemplate_request_compound_v3->fki_ezsignfoldertype_id
    int *fki_ezsignfoldertype_id_local_var = NULL;

    // define the local variable for ezsigntemplate_request_compound_v3->fki_language_id
    int *fki_language_id_local_var = NULL;

    // define the local variable for ezsigntemplate_request_compound_v3->fki_ezdoctemplatedocument_id
    ...
    // define the local variable for ezsigntemplate_request_compound_v3->b_ezsigntemplate_adminonly
    ...
    *b_ezsigntemplate_adminonly_local_var = b_ezsigntemplate_adminonly->valueint;
    ...
    ezsigntemplate_request_compound_v3_local_var = ezsigntemplate_request_compound_v3_create_internal (
