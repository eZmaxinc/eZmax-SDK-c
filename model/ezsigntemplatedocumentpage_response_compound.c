...
static ezsigntemplatedocumentpage_response_compound_t *ezsigntemplatedocumentpage_response_compound_create_internal(
    ...
    memset(ezsigntemplatedocumentpage_response_compound_local_var, 0, sizeof(ezsigntemplatedocumentpage_response_compound_t));
...
__attribute__((deprecated)) ezsigntemplatedocumentpage_response_compound_t *ezsigntemplatedocumentpage_response_compound_create(
    ...
    ezsigntemplatedocumentpage_response_compound_t *result = ezsigntemplatedocumentpage_response_compound_create_internal (
...
void ezsigntemplatedocumentpage_response_compound_free(ezsigntemplatedocumentpage_response_compound_t *ezsigntemplatedocumentpage_response_compound) {
    ...
    if (ezsigntemplatedocumentpage_response_compound->pki_ezsigntemplatedocumentpage_id) {
        free(ezsigntemplatedocumentpage_response_compound->pki_ezsigntemplatedocumentpage_id);
        ezsigntemplatedocumentpage_response_compound->pki_ezsigntemplatedocumentpage_id = NULL;
    }
    if (ezsigntemplatedocumentpage_response_compound->i_ezsigntemplatedocumentpage_widthimage) {
        free(ezsigntemplatedocumentpage_response_compound->i_ezsigntemplatedocumentpage_widthimage);
        ezsigntemplatedocumentpage_response_compound->i_ezsigntemplatedocumentpage_widthimage = NULL;
    }
    if (ezsigntemplatedocumentpage_response_compound->i_ezsigntemplatedocumentpage_heightimage) {
        free(ezsigntemplatedocumentpage_response_compound->i_ezsigntemplatedocumentpage_heightimage);
        ezsigntemplatedocumentpage_response_compound->i_ezsigntemplatedocumentpage_heightimage = NULL;
    }
    if (ezsigntemplatedocumentpage_response_compound->i_ezsigntemplatedocumentpage_widthpdf) {
        free(ezsigntemplatedocumentpage_response_compound->i_ezsigntemplatedocumentpage_widthpdf);
        ezsigntemplatedocumentpage_response_compound->i_ezsigntemplatedocumentpage_widthpdf = NULL;
    }
    if (ezsigntemplatedocumentpage_response_compound->i_ezsigntemplatedocumentpage_heightpdf) {
        free(ezsigntemplatedocumentpage_response_compound->i_ezsigntemplatedocumentpage_heightpdf);
        ezsigntemplatedocumentpage_response_compound->i_ezsigntemplatedocumentpage_heightpdf = NULL;
    }
    if (ezsigntemplatedocumentpage_response_compound->i_ezsigntemplatedocumentpage_pagenumber) {
        free(ezsigntemplatedocumentpage_response_compound->i_ezsigntemplatedocumentpage_pagenumber);
        ezsigntemplatedocumentpage_response_compound->i_ezsigntemplatedocumentpage_pagenumber = NULL;
    }
...
ezsigntemplatedocumentpage_response_compound_t *ezsigntemplatedocumentpage_response_compound_parseFromJSON(cJSON *ezsigntemplatedocumentpage_response_compoundJSON){
    ...
    // define the local variable for ezsigntemplatedocumentpage_response_compound->pki_ezsigntemplatedocumentpage_id
    int *pki_ezsigntemplatedocumentpage_id_local_var = NULL;

    // define the local variable for ezsigntemplatedocumentpage_response_compound->i_ezsigntemplatedocumentpage_widthimage
    int *i_ezsigntemplatedocumentpage_widthimage_local_var = NULL;

    // define the local variable for ezsigntemplatedocumentpage_response_compound->i_ezsigntemplatedocumentpage_heightimage
    int *i_ezsigntemplatedocumentpage_heightimage_local_var = NULL;

    // define the local variable for ezsigntemplatedocumentpage_response_compound->i_ezsigntemplatedocumentpage_widthpdf
    int *i_ezsigntemplatedocumentpage_widthpdf_local_var = NULL;

    // define the local variable for ezsigntemplatedocumentpage_response_compound->i_ezsigntemplatedocumentpage_heightpdf
    int *i_ezsigntemplatedocumentpage_heightpdf_local_var = NULL;

    // define the local variable for ezsigntemplatedocumentpage_response_compound->i_ezsigntemplatedocumentpage_pagenumber
