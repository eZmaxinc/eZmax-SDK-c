...
#include <string.h>
#include <stdio.h>
#include "webhook_get_history_v1_response_m_payload_all_of.h"
...
webhook_get_history_v1_response_m_payload_all_of_t *webhook_get_history_v1_response_m_payload_all_of_create(
    ...
    webhook_get_history_v1_response_m_payload_all_of_t *webhook_get_history_v1_response_m_payload_all_of_local_var = malloc(sizeof(webhook_get_history_v1_response_m_payload_all_of_t));
    if (!webhook_get_history_v1_response_m_payload_all_of_local_var) {
        return NULL;
    }
    webhook_get_history_v1_response_m_payload_all_of_local_var->a_obj_webhooklog = a_obj_webhooklog;

    return webhook_get_history_v1_response_m_payload_all_of_local_var;
}
...
void webhook_get_history_v1_response_m_payload_all_of_free(webhook_get_history_v1_response_m_payload_all_of_t *webhook_get_history_v1_response_m_payload_all_of) {
    if(NULL == webhook_get_history_v1_response_m_payload_all_of){
        return ;
    }
    listEntry_t *listEntry;
    if (webhook_get_history_v1_response_m_payload_all_of->a_obj_webhooklog) {
        list_ForEach(listEntry, webhook_get_history_v1_response_m_payload_all_of->a_obj_webhooklog) {
            custom_webhooklog_response_free(listEntry->data);
        }
        list_freeList(webhook_get_history_v1_response_m_payload_all_of->a_obj_webhooklog);
        webhook_get_history_v1_response_m_payload_all_of->a_obj_webhooklog = NULL;
    }
    free(webhook_get_history_v1_response_m_payload_all_of);
}
...
cJSON *webhook_get_history_v1_response_m_payload_all_of_convertToJSON(webhook_get_history_v1_response_m_payload_all_of_t *webhook_get_history_v1_response_m_payload_all_of) {
    ...
    // webhook_get_history_v1_response_m_payload_all_of->a_obj_webhooklog
    if (!webhook_get_history_v1_response_m_payload_all_of->a_obj_webhooklog) {
        goto fail;
    }
    ...
    if (webhook_get_history_v1_response_m_payload_all_of->a_obj_webhooklog) {
    list_ForEach(a_obj_webhooklogListEntry, webhook_get_history_v1_response_m_payload_all_of->a_obj_webhooklog) {
...
webhook_get_history_v1_response_m_payload_all_of_t *webhook_get_history_v1_response_m_payload_all_of_parseFromJSON(cJSON *webhook_get_history_v1_response_m_payload_all_ofJSON){
    ...
    webhook_get_history_v1_response_m_payload_all_of_t *webhook_get_history_v1_response_m_payload_all_of_local_var = NULL;

    // define the local list for webhook_get_history_v1_response_m_payload_all_of->a_obj_webhooklog
    list_t *a_obj_webhooklogList = NULL;

    // webhook_get_history_v1_response_m_payload_all_of->a_obj_webhooklog
    cJSON *a_obj_webhooklog = cJSON_GetObjectItemCaseSensitive(webhook_get_history_v1_response_m_payload_all_ofJSON, "a_objWebhooklog");
    if (!a_obj_webhooklog) {
        goto end;
    }
    ...
    webhook_get_history_v1_response_m_payload_all_of_local_var = webhook_get_history_v1_response_m_payload_all_of_create (
