/*
 * ezsigntemplate_create_object_v2_response.h
 *
 * Response for POST /2/object/ezsigntemplate
 */

#ifndef _ezsigntemplate_create_object_v2_response_H_
#define _ezsigntemplate_create_object_v2_response_H_
...
typedef struct ezsigntemplate_create_object_v2_response_t ezsigntemplate_create_object_v2_response_t;
...
typedef struct ezsigntemplate_create_object_v2_response_t {
    struct common_response_obj_debug_payload_t *obj_debug_payload; //model
    struct common_response_obj_debug_t *obj_debug; //model
    struct ezsigntemplate_create_object_v2_response_m_payload_t *m_payload; //model
...
#endif /* _ezsigntemplate_create_object_v2_response_H_ */
