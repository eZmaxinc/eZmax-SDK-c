...
static customer_get_object_v2_response_t *customer_get_object_v2_response_create_internal(
    ...
    memset(customer_get_object_v2_response_local_var, 0, sizeof(customer_get_object_v2_response_t));
...
__attribute__((deprecated)) customer_get_object_v2_response_t *customer_get_object_v2_response_create(
    ...
    customer_get_object_v2_response_t *result = customer_get_object_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
