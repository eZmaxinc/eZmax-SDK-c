...
static ezsignsignaturecustomdate_response_t *ezsignsignaturecustomdate_response_create_internal(
    ...
    memset(ezsignsignaturecustomdate_response_local_var, 0, sizeof(ezsignsignaturecustomdate_response_t));
...
__attribute__((deprecated)) ezsignsignaturecustomdate_response_t *ezsignsignaturecustomdate_response_create(
    ...
    ezsignsignaturecustomdate_response_t *result = ezsignsignaturecustomdate_response_create_internal (
...
void ezsignsignaturecustomdate_response_free(ezsignsignaturecustomdate_response_t *ezsignsignaturecustomdate_response) {
    ...
    if (ezsignsignaturecustomdate_response->pki_ezsignsignaturecustomdate_id) {
        free(ezsignsignaturecustomdate_response->pki_ezsignsignaturecustomdate_id);
        ezsignsignaturecustomdate_response->pki_ezsignsignaturecustomdate_id = NULL;
    }
    if (ezsignsignaturecustomdate_response->i_ezsignsignaturecustomdate_x) {
        free(ezsignsignaturecustomdate_response->i_ezsignsignaturecustomdate_x);
        ezsignsignaturecustomdate_response->i_ezsignsignaturecustomdate_x = NULL;
    }
    if (ezsignsignaturecustomdate_response->i_ezsignsignaturecustomdate_y) {
        free(ezsignsignaturecustomdate_response->i_ezsignsignaturecustomdate_y);
        ezsignsignaturecustomdate_response->i_ezsignsignaturecustomdate_y = NULL;
    }
    if (ezsignsignaturecustomdate_response->i_ezsignsignaturecustomdate_offsetx) {
        free(ezsignsignaturecustomdate_response->i_ezsignsignaturecustomdate_offsetx);
        ezsignsignaturecustomdate_response->i_ezsignsignaturecustomdate_offsetx = NULL;
    }
    if (ezsignsignaturecustomdate_response->i_ezsignsignaturecustomdate_offsety) {
        free(ezsignsignaturecustomdate_response->i_ezsignsignaturecustomdate_offsety);
        ezsignsignaturecustomdate_response->i_ezsignsignaturecustomdate_offsety = NULL;
    }
...
ezsignsignaturecustomdate_response_t *ezsignsignaturecustomdate_response_parseFromJSON(cJSON *ezsignsignaturecustomdate_responseJSON){
    ...
    // define the local variable for ezsignsignaturecustomdate_response->pki_ezsignsignaturecustomdate_id
    int *pki_ezsignsignaturecustomdate_id_local_var = NULL;

    // define the local variable for ezsignsignaturecustomdate_response->i_ezsignsignaturecustomdate_x
    int *i_ezsignsignaturecustomdate_x_local_var = NULL;

    // define the local variable for ezsignsignaturecustomdate_response->i_ezsignsignaturecustomdate_y
    int *i_ezsignsignaturecustomdate_y_local_var = NULL;

    // define the local variable for ezsignsignaturecustomdate_response->i_ezsignsignaturecustomdate_offsetx
    int *i_ezsignsignaturecustomdate_offsetx_local_var = NULL;

    // define the local variable for ezsignsignaturecustomdate_response->i_ezsignsignaturecustomdate_offsety
