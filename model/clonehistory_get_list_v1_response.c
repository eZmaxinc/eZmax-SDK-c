...
static clonehistory_get_list_v1_response_t *clonehistory_get_list_v1_response_create_internal(
    ...
    memset(clonehistory_get_list_v1_response_local_var, 0, sizeof(clonehistory_get_list_v1_response_t));
...
__attribute__((deprecated)) clonehistory_get_list_v1_response_t *clonehistory_get_list_v1_response_create(
    ...
    clonehistory_get_list_v1_response_t *result = clonehistory_get_list_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
