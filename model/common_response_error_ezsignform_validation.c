...
char* e_error_codecommon_response_error_ezsignform_validation_ToString(ezmax_api_definition__full_common_response_error_ezsignform_validation__e e_error_code) {
...
ezmax_api_definition__full_common_response_error_ezsignform_validation__e e_error_codecommon_response_error_ezsignform_validation_FromString(char* e_error_code){
