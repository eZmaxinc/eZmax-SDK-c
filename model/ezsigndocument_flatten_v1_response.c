...
static ezsigndocument_flatten_v1_response_t *ezsigndocument_flatten_v1_response_create_internal(
    ...
    memset(ezsigndocument_flatten_v1_response_local_var, 0, sizeof(ezsigndocument_flatten_v1_response_t));
    ezsigndocument_flatten_v1_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezsigndocument_flatten_v1_response_t *ezsigndocument_flatten_v1_response_create(
    common_response_obj_debug_payload_t *obj_debug_payload,
    common_response_obj_debug_t *obj_debug
    ) {
    ezsigndocument_flatten_v1_response_t *result = ezsigndocument_flatten_v1_response_create_internal (
        obj_debug_payload,
        obj_debug
        );
    if (!result) {
...
void ezsigndocument_flatten_v1_response_free(ezsigndocument_flatten_v1_response_t *ezsigndocument_flatten_v1_response) {
    ...
    if(ezsigndocument_flatten_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsigndocument_flatten_v1_response_free");
        return ;
    }
...
ezsigndocument_flatten_v1_response_t *ezsigndocument_flatten_v1_response_parseFromJSON(cJSON *ezsigndocument_flatten_v1_responseJSON){
    ...
    ezsigndocument_flatten_v1_response_local_var = ezsigndocument_flatten_v1_response_create_internal (
