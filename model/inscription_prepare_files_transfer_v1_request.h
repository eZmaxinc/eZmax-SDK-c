/*
 * inscription_prepare_files_transfer_v1_request.h
 *
 * Request for POST /1/object/inscription/{pkiInscriptionID}/prepareFilesTransfer
 */

#ifndef _inscription_prepare_files_transfer_v1_request_H_
#define _inscription_prepare_files_transfer_v1_request_H_
...
typedef struct inscription_prepare_files_transfer_v1_request_t inscription_prepare_files_transfer_v1_request_t;

#include "custom_attachment_prepare_files_transfer_request.h"



typedef struct inscription_prepare_files_transfer_v1_request_t {
    list_t *a_obj_attachment; //nonprimitive container

    int _library_owned; // Is the library responsible for freeing this object?
} inscription_prepare_files_transfer_v1_request_t;
...
#endif /* _inscription_prepare_files_transfer_v1_request_H_ */
