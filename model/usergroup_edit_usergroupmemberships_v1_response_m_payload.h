/*
 * usergroup_edit_usergroupmemberships_v1_response_m_payload.h
 *
 * Response for PUT /1/object/usergroup/{pkiUsergroupID}/editUsergroupmemberships
 */

#ifndef _usergroup_edit_usergroupmemberships_v1_response_m_payload_H_
#define _usergroup_edit_usergroupmemberships_v1_response_m_payload_H_
...
typedef struct usergroup_edit_usergroupmemberships_v1_response_m_payload_t usergroup_edit_usergroupmemberships_v1_response_m_payload_t;




typedef struct usergroup_edit_usergroupmemberships_v1_response_m_payload_t {
    list_t *a_pki_usergroupmembership_id; //primitive container

} usergroup_edit_usergroupmemberships_v1_response_m_payload_t;

usergroup_edit_usergroupmemberships_v1_response_m_payload_t *usergroup_edit_usergroupmemberships_v1_response_m_payload_create(
...
#endif /* _usergroup_edit_usergroupmemberships_v1_response_m_payload_H_ */
