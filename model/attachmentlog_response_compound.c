...
char* e_attachmentlog_typeattachmentlog_response_compound_ToString(ezmax_api_definition__full_attachmentlog_response_compound__e e_attachmentlog_type) {
...
ezmax_api_definition__full_attachmentlog_response_compound__e e_attachmentlog_typeattachmentlog_response_compound_FromString(char* e_attachmentlog_type){
