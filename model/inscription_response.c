...
static inscription_response_t *inscription_response_create_internal(
    ...
    inscription_response_t *inscription_response_local_var = malloc(sizeof(inscription_response_t));
    if (!inscription_response_local_var) {
        return NULL;
    }
    memset(inscription_response_local_var, 0, sizeof(inscription_response_t));
    inscription_response_local_var->_library_owned = 1;
    inscription_response_local_var->pki_inscription_id = pki_inscription_id;
    inscription_response_local_var->fki_company_id = fki_company_id;
    inscription_response_local_var->s_company_name_x = s_company_name_x;
    inscription_response_local_var->fki_department_id = fki_department_id;
    inscription_response_local_var->s_department_name_x = s_department_name_x;
    inscription_response_local_var->fki_realestateboard_id = fki_realestateboard_id;
    inscription_response_local_var->s_realestateboard_name_x = s_realestateboard_name_x;
    inscription_response_local_var->fki_address_id = fki_address_id;
    inscription_response_local_var->s_address = s_address;
    inscription_response_local_var->fki_inscriptionbuildingtype_id = fki_inscriptionbuildingtype_id;
    inscription_response_local_var->s_inscriptionbuildingtype_name_x = s_inscriptionbuildingtype_name_x;
    inscription_response_local_var->fki_inscriptiontype_id = fki_inscriptiontype_id;
    inscription_response_local_var->s_inscriptiontype_name_x = s_inscriptiontype_name_x;
    inscription_response_local_var->fki_inscriptioncategory_id = fki_inscriptioncategory_id;
    inscription_response_local_var->s_inscriptioncategory_name_x = s_inscriptioncategory_name_x;
    inscription_response_local_var->e_inscription_step = e_inscription_step;
    inscription_response_local_var->e_inscription_residence_type = e_inscription_residence_type;
    inscription_response_local_var->s_inscription_civicend = s_inscription_civicend;
    inscription_response_local_var->s_inscription_mls = s_inscription_mls;
    inscription_response_local_var->s_inscription_contract = s_inscription_contract;
    inscription_response_local_var->i_inscription_sellerdeclaration = i_inscription_sellerdeclaration;
    inscription_response_local_var->e_inscription_type = e_inscription_type;
    inscription_response_local_var->d_inscription_initialsaleprice = d_inscription_initialsaleprice;
    inscription_response_local_var->d_inscription_saleprice = d_inscription_saleprice;
    inscription_response_local_var->d_inscription_rentprice = d_inscription_rentprice;
    inscription_response_local_var->e_inscription_remunerationtype = e_inscription_remunerationtype;
    inscription_response_local_var->e_inscription_remunerationinscriptorsellertype = e_inscription_remunerationinscriptorsellertype;
    inscription_response_local_var->e_inscription_remunerationreferencetype = e_inscription_remunerationreferencetype;
    inscription_response_local_var->e_inscription_remunerationtotaltype = e_inscription_remunerationtotaltype;
    inscription_response_local_var->d_inscription_remuneration = d_inscription_remuneration;
    inscription_response_local_var->d_inscription_remunerationinscriptorseller = d_inscription_remunerationinscriptorseller;
    inscription_response_local_var->d_inscription_remunerationreference = d_inscription_remunerationreference;
    inscription_response_local_var->d_inscription_remunerationtotal = d_inscription_remunerationtotal;
    inscription_response_local_var->d_inscription_mortgagesold = d_inscription_mortgagesold;
    inscription_response_local_var->dt_inscription_date = dt_inscription_date;
    inscription_response_local_var->dt_inscription_cancellationdate = dt_inscription_cancellationdate;
    inscription_response_local_var->dt_inscription_initialexpirationdate = dt_inscription_initialexpirationdate;
    inscription_response_local_var->dt_inscription_expirationdate = dt_inscription_expirationdate;
    inscription_response_local_var->dt_inscription_notarydate = dt_inscription_notarydate;
    inscription_response_local_var->dt_inscription_notaryentereddate = dt_inscription_notaryentereddate;
    inscription_response_local_var->t_inscription_cadastre = t_inscription_cadastre;
    inscription_response_local_var->b_inscription_reference = b_inscription_reference;
    inscription_response_local_var->b_inscription_inspection = b_inscription_inspection;
    inscription_response_local_var->b_inscription_isactive = b_inscription_isactive;
    inscription_response_local_var->t_inscription_checklistnote = t_inscription_checklistnote;
    inscription_response_local_var->b_inscription_new = b_inscription_new;
    inscription_response_local_var->b_inscription_homeowner = b_inscription_homeowner;
    inscription_response_local_var->b_inscription_archived = b_inscription_archived;
    inscription_response_local_var->b_inscription_litigation = b_inscription_litigation;
    inscription_response_local_var->b_inscription_repossession = b_inscription_repossession;
    inscription_response_local_var->b_inscription_issolicitation = b_inscription_issolicitation;
    inscription_response_local_var->b_inscription_salebyowner = b_inscription_salebyowner;
    inscription_response_local_var->b_inscription_soldwithoutlegalwarranty = b_inscription_soldwithoutlegalwarranty;
    inscription_response_local_var->i_inscription_constructionyear = i_inscription_constructionyear;
    inscription_response_local_var->i_inscription_unit = i_inscription_unit;
    return inscription_response_local_var;
}
...
__attribute__((deprecated)) inscription_response_t *inscription_response_create(
    ...
    inscription_response_t *result = inscription_response_create_internal (
...
void inscription_response_free(inscription_response_t *inscription_response) {
    if(NULL == inscription_response){
        return ;
    }
    if(inscription_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "inscription_response_free");
        return ;
    }
    listEntry_t *listEntry;
    if (inscription_response->pki_inscription_id) {
        free(inscription_response->pki_inscription_id);
        inscription_response->pki_inscription_id = NULL;
    }
    if (inscription_response->fki_company_id) {
        free(inscription_response->fki_company_id);
        inscription_response->fki_company_id = NULL;
    }
    if (inscription_response->s_company_name_x) {
        free(inscription_response->s_company_name_x);
        inscription_response->s_company_name_x = NULL;
    }
    if (inscription_response->fki_department_id) {
        free(inscription_response->fki_department_id);
        inscription_response->fki_department_id = NULL;
    }
    if (inscription_response->s_department_name_x) {
        free(inscription_response->s_department_name_x);
        inscription_response->s_department_name_x = NULL;
    }
    if (inscription_response->fki_realestateboard_id) {
        free(inscription_response->fki_realestateboard_id);
        inscription_response->fki_realestateboard_id = NULL;
    }
    if (inscription_response->s_realestateboard_name_x) {
        free(inscription_response->s_realestateboard_name_x);
        inscription_response->s_realestateboard_name_x = NULL;
    }
    if (inscription_response->fki_address_id) {
        free(inscription_response->fki_address_id);
        inscription_response->fki_address_id = NULL;
    }
    if (inscription_response->s_address) {
        free(inscription_response->s_address);
        inscription_response->s_address = NULL;
    }
    if (inscription_response->fki_inscriptionbuildingtype_id) {
        free(inscription_response->fki_inscriptionbuildingtype_id);
        inscription_response->fki_inscriptionbuildingtype_id = NULL;
    }
    if (inscription_response->s_inscriptionbuildingtype_name_x) {
        free(inscription_response->s_inscriptionbuildingtype_name_x);
        inscription_response->s_inscriptionbuildingtype_name_x = NULL;
    }
    if (inscription_response->fki_inscriptiontype_id) {
        free(inscription_response->fki_inscriptiontype_id);
        inscription_response->fki_inscriptiontype_id = NULL;
    }
    if (inscription_response->s_inscriptiontype_name_x) {
        free(inscription_response->s_inscriptiontype_name_x);
        inscription_response->s_inscriptiontype_name_x = NULL;
    }
    if (inscription_response->fki_inscriptioncategory_id) {
        free(inscription_response->fki_inscriptioncategory_id);
        inscription_response->fki_inscriptioncategory_id = NULL;
    }
    if (inscription_response->s_inscriptioncategory_name_x) {
        free(inscription_response->s_inscriptioncategory_name_x);
        inscription_response->s_inscriptioncategory_name_x = NULL;
    }
    if (inscription_response->s_inscription_civicend) {
        free(inscription_response->s_inscription_civicend);
        inscription_response->s_inscription_civicend = NULL;
    }
    if (inscription_response->s_inscription_mls) {
        free(inscription_response->s_inscription_mls);
        inscription_response->s_inscription_mls = NULL;
    }
    if (inscription_response->s_inscription_contract) {
        free(inscription_response->s_inscription_contract);
        inscription_response->s_inscription_contract = NULL;
    }
    if (inscription_response->i_inscription_sellerdeclaration) {
        free(inscription_response->i_inscription_sellerdeclaration);
        inscription_response->i_inscription_sellerdeclaration = NULL;
    }
    if (inscription_response->d_inscription_initialsaleprice) {
        free(inscription_response->d_inscription_initialsaleprice);
        inscription_response->d_inscription_initialsaleprice = NULL;
    }
    if (inscription_response->d_inscription_saleprice) {
        free(inscription_response->d_inscription_saleprice);
        inscription_response->d_inscription_saleprice = NULL;
    }
    if (inscription_response->d_inscription_rentprice) {
        free(inscription_response->d_inscription_rentprice);
        inscription_response->d_inscription_rentprice = NULL;
    }
    if (inscription_response->d_inscription_remuneration) {
        free(inscription_response->d_inscription_remuneration);
        inscription_response->d_inscription_remuneration = NULL;
    }
    if (inscription_response->d_inscription_remunerationinscriptorseller) {
        free(inscription_response->d_inscription_remunerationinscriptorseller);
        inscription_response->d_inscription_remunerationinscriptorseller = NULL;
    }
    if (inscription_response->d_inscription_remunerationreference) {
        free(inscription_response->d_inscription_remunerationreference);
        inscription_response->d_inscription_remunerationreference = NULL;
    }
    if (inscription_response->d_inscription_remunerationtotal) {
        free(inscription_response->d_inscription_remunerationtotal);
        inscription_response->d_inscription_remunerationtotal = NULL;
    }
    if (inscription_response->d_inscription_mortgagesold) {
        free(inscription_response->d_inscription_mortgagesold);
        inscription_response->d_inscription_mortgagesold = NULL;
    }
    if (inscription_response->dt_inscription_date) {
        free(inscription_response->dt_inscription_date);
        inscription_response->dt_inscription_date = NULL;
    }
    if (inscription_response->dt_inscription_cancellationdate) {
        free(inscription_response->dt_inscription_cancellationdate);
        inscription_response->dt_inscription_cancellationdate = NULL;
    }
    if (inscription_response->dt_inscription_initialexpirationdate) {
        free(inscription_response->dt_inscription_initialexpirationdate);
        inscription_response->dt_inscription_initialexpirationdate = NULL;
    }
    if (inscription_response->dt_inscription_expirationdate) {
        free(inscription_response->dt_inscription_expirationdate);
        inscription_response->dt_inscription_expirationdate = NULL;
    }
    if (inscription_response->dt_inscription_notarydate) {
        free(inscription_response->dt_inscription_notarydate);
        inscription_response->dt_inscription_notarydate = NULL;
    }
    if (inscription_response->dt_inscription_notaryentereddate) {
        free(inscription_response->dt_inscription_notaryentereddate);
        inscription_response->dt_inscription_notaryentereddate = NULL;
    }
    if (inscription_response->t_inscription_cadastre) {
        free(inscription_response->t_inscription_cadastre);
        inscription_response->t_inscription_cadastre = NULL;
    }
    if (inscription_response->b_inscription_reference) {
        free(inscription_response->b_inscription_reference);
        inscription_response->b_inscription_reference = NULL;
    }
    if (inscription_response->b_inscription_inspection) {
        free(inscription_response->b_inscription_inspection);
        inscription_response->b_inscription_inspection = NULL;
    }
    if (inscription_response->b_inscription_isactive) {
        free(inscription_response->b_inscription_isactive);
        inscription_response->b_inscription_isactive = NULL;
    }
    if (inscription_response->t_inscription_checklistnote) {
        free(inscription_response->t_inscription_checklistnote);
        inscription_response->t_inscription_checklistnote = NULL;
    }
    if (inscription_response->b_inscription_new) {
        free(inscription_response->b_inscription_new);
        inscription_response->b_inscription_new = NULL;
    }
    if (inscription_response->b_inscription_homeowner) {
        free(inscription_response->b_inscription_homeowner);
        inscription_response->b_inscription_homeowner = NULL;
    }
    if (inscription_response->b_inscription_archived) {
        free(inscription_response->b_inscription_archived);
        inscription_response->b_inscription_archived = NULL;
    }
    if (inscription_response->b_inscription_litigation) {
        free(inscription_response->b_inscription_litigation);
        inscription_response->b_inscription_litigation = NULL;
    }
    if (inscription_response->b_inscription_repossession) {
        free(inscription_response->b_inscription_repossession);
        inscription_response->b_inscription_repossession = NULL;
    }
    if (inscription_response->b_inscription_issolicitation) {
        free(inscription_response->b_inscription_issolicitation);
        inscription_response->b_inscription_issolicitation = NULL;
    }
    if (inscription_response->b_inscription_salebyowner) {
        free(inscription_response->b_inscription_salebyowner);
        inscription_response->b_inscription_salebyowner = NULL;
    }
    if (inscription_response->b_inscription_soldwithoutlegalwarranty) {
        free(inscription_response->b_inscription_soldwithoutlegalwarranty);
        inscription_response->b_inscription_soldwithoutlegalwarranty = NULL;
    }
    if (inscription_response->i_inscription_constructionyear) {
        free(inscription_response->i_inscription_constructionyear);
        inscription_response->i_inscription_constructionyear = NULL;
    }
    if (inscription_response->i_inscription_unit) {
        free(inscription_response->i_inscription_unit);
        inscription_response->i_inscription_unit = NULL;
    }
    free(inscription_response);
}

cJSON *inscription_response_convertToJSON(inscription_response_t *inscription_response) {
    cJSON *item = cJSON_CreateObject();

    // inscription_response->pki_inscription_id
    if (!inscription_response->pki_inscription_id) {
        goto fail;
    }
    if(cJSON_AddNumberToObject(item, "pkiInscriptionID", *inscription_response->pki_inscription_id) == NULL) {
    goto fail; //Numeric
    }


    // inscription_response->fki_company_id
    if (!inscription_response->fki_company_id) {
        goto fail;
    }
    if(cJSON_AddNumberToObject(item, "fkiCompanyID", *inscription_response->fki_company_id) == NULL) {
    goto fail; //Numeric
    }


    // inscription_response->s_company_name_x
    if(inscription_response->s_company_name_x) {
    if(cJSON_AddStringToObject(item, "sCompanyNameX", inscription_response->s_company_name_x) == NULL) {
    goto fail; //String
    }
    }


    // inscription_response->fki_department_id
    if (!inscription_response->fki_department_id) {
        goto fail;
    }
    if(cJSON_AddNumberToObject(item, "fkiDepartmentID", *inscription_response->fki_department_id) == NULL) {
    goto fail; //Numeric
    }


    // inscription_response->s_department_name_x
    if(inscription_response->s_department_name_x) {
    if(cJSON_AddStringToObject(item, "sDepartmentNameX", inscription_response->s_department_name_x) == NULL) {
    goto fail; //String
    }
    }


    // inscription_response->fki_realestateboard_id
    if (!inscription_response->fki_realestateboard_id) {
        goto fail;
    }
    if(cJSON_AddNumberToObject(item, "fkiRealestateboardID", *inscription_response->fki_realestateboard_id) == NULL) {
    goto fail; //Numeric
    }


    // inscription_response->s_realestateboard_name_x
    if(inscription_response->s_realestateboard_name_x) {
    if(cJSON_AddStringToObject(item, "sRealestateboardNameX", inscription_response->s_realestateboard_name_x) == NULL) {
    goto fail; //String
    }
    }


    // inscription_response->fki_address_id
    if (!inscription_response->fki_address_id) {
        goto fail;
    }
    if(cJSON_AddNumberToObject(item, "fkiAddressID", *inscription_response->fki_address_id) == NULL) {
    goto fail; //Numeric
    }


    // inscription_response->s_address
    if(inscription_response->s_address) {
    if(cJSON_AddStringToObject(item, "sAddress", inscription_response->s_address) == NULL) {
    goto fail; //String
    }
    }


    // inscription_response->fki_inscriptionbuildingtype_id
    if (!inscription_response->fki_inscriptionbuildingtype_id) {
        goto fail;
    }
    if(cJSON_AddNumberToObject(item, "fkiInscriptionbuildingtypeID", *inscription_response->fki_inscriptionbuildingtype_id) == NULL) {
    goto fail; //Numeric
    }


    // inscription_response->s_inscriptionbuildingtype_name_x
    if(inscription_response->s_inscriptionbuildingtype_name_x) {
    if(cJSON_AddStringToObject(item, "sInscriptionbuildingtypeNameX", inscription_response->s_inscriptionbuildingtype_name_x) == NULL) {
    goto fail; //String
    }
    }


    // inscription_response->fki_inscriptiontype_id
    if (!inscription_response->fki_inscriptiontype_id) {
        goto fail;
    }
    if(cJSON_AddNumberToObject(item, "fkiInscriptiontypeID", *inscription_response->fki_inscriptiontype_id) == NULL) {
    goto fail; //Numeric
    }


    // inscription_response->s_inscriptiontype_name_x
    if(inscription_response->s_inscriptiontype_name_x) {
    if(cJSON_AddStringToObject(item, "sInscriptiontypeNameX", inscription_response->s_inscriptiontype_name_x) == NULL) {
    goto fail; //String
    }
    }


    // inscription_response->fki_inscriptioncategory_id
    if (!inscription_response->fki_inscriptioncategory_id) {
        goto fail;
    }
    if(cJSON_AddNumberToObject(item, "fkiInscriptioncategoryID", *inscription_response->fki_inscriptioncategory_id) == NULL) {
    goto fail; //Numeric
    }


    // inscription_response->s_inscriptioncategory_name_x
    if(inscription_response->s_inscriptioncategory_name_x) {
    if(cJSON_AddStringToObject(item, "sInscriptioncategoryNameX", inscription_response->s_inscriptioncategory_name_x) == NULL) {
    goto fail; //String
    }
    }


    // inscription_response->e_inscription_step
    if (ezmax_api_definition__full_field_e_inscription_step__NULL == inscription_response->e_inscription_step) {
        goto fail;
    }
    cJSON *e_inscription_step_local_JSON = field_e_inscription_step_convertToJSON(inscription_response->e_inscription_step);
    ...
    // inscription_response->e_inscription_residence_type
    if (ezmax_api_definition__full_field_e_inscription_residence_type__NULL == inscription_response->e_inscription_residence_type) {
        goto fail;
    }
    cJSON *e_inscription_residence_type_local_JSON = field_e_inscription_residence_type_convertToJSON(inscription_response->e_inscription_residence_type);
    ...
    // inscription_response->s_inscription_civicend
    if (!inscription_response->s_inscription_civicend) {
        goto fail;
    }
    if(cJSON_AddStringToObject(item, "sInscriptionCivicend", inscription_response->s_inscription_civicend) == NULL) {
    goto fail; //String
    }


    // inscription_response->s_inscription_mls
    if (!inscription_response->s_inscription_mls) {
        goto fail;
    }
    if(cJSON_AddStringToObject(item, "sInscriptionMLS", inscription_response->s_inscription_mls) == NULL) {
    goto fail; //String
    }


    // inscription_response->s_inscription_contract
    if (!inscription_response->s_inscription_contract) {
        goto fail;
    }
    if(cJSON_AddStringToObject(item, "sInscriptionContract", inscription_response->s_inscription_contract) == NULL) {
    goto fail; //String
    }


    // inscription_response->i_inscription_sellerdeclaration
    if (!inscription_response->i_inscription_sellerdeclaration) {
        goto fail;
    }
    if(cJSON_AddNumberToObject(item, "iInscriptionSellerdeclaration", *inscription_response->i_inscription_sellerdeclaration) == NULL) {
    goto fail; //Numeric
    }


    // inscription_response->e_inscription_type
    if (ezmax_api_definition__full_field_e_inscription_type__NULL == inscription_response->e_inscription_type) {
        goto fail;
    }
    cJSON *e_inscription_type_local_JSON = field_e_inscription_type_convertToJSON(inscription_response->e_inscription_type);
    ...
    // inscription_response->d_inscription_initialsaleprice
    if (!inscription_response->d_inscription_initialsaleprice) {
        goto fail;
    }
    if(cJSON_AddStringToObject(item, "dInscriptionInitialsaleprice", inscription_response->d_inscription_initialsaleprice) == NULL) {
    goto fail; //String
    }


    // inscription_response->d_inscription_saleprice
    if (!inscription_response->d_inscription_saleprice) {
        goto fail;
    }
    if(cJSON_AddStringToObject(item, "dInscriptionSaleprice", inscription_response->d_inscription_saleprice) == NULL) {
    goto fail; //String
    }


    // inscription_response->d_inscription_rentprice
    if (!inscription_response->d_inscription_rentprice) {
        goto fail;
    }
    if(cJSON_AddStringToObject(item, "dInscriptionRentprice", inscription_response->d_inscription_rentprice) == NULL) {
    goto fail; //String
    }


    // inscription_response->e_inscription_remunerationtype
    if (ezmax_api_definition__full_field_e_inscription_remunerationtype__NULL == inscription_response->e_inscription_remunerationtype) {
        goto fail;
    }
    cJSON *e_inscription_remunerationtype_local_JSON = field_e_inscription_remunerationtype_convertToJSON(inscription_response->e_inscription_remunerationtype);
    ...
    // inscription_response->e_inscription_remunerationinscriptorsellertype
    if (ezmax_api_definition__full_field_e_inscription_remunerationinscriptorsellertype__NULL == inscription_response->e_inscription_remunerationinscriptorsellertype) {
        goto fail;
    }
    cJSON *e_inscription_remunerationinscriptorsellertype_local_JSON = field_e_inscription_remunerationinscriptorsellertype_convertToJSON(inscription_response->e_inscription_remunerationinscriptorsellertype);
    ...
    // inscription_response->e_inscription_remunerationreferencetype
    if (ezmax_api_definition__full_field_e_inscription_remunerationreferencetype__NULL == inscription_response->e_inscription_remunerationreferencetype) {
        goto fail;
    }
    cJSON *e_inscription_remunerationreferencetype_local_JSON = field_e_inscription_remunerationreferencetype_convertToJSON(inscription_response->e_inscription_remunerationreferencetype);
    ...
    // inscription_response->e_inscription_remunerationtotaltype
    if (ezmax_api_definition__full_field_e_inscription_remunerationtotaltype__NULL == inscription_response->e_inscription_remunerationtotaltype) {
        goto fail;
    }
    cJSON *e_inscription_remunerationtotaltype_local_JSON = field_e_inscription_remunerationtotaltype_convertToJSON(inscription_response->e_inscription_remunerationtotaltype);
    ...
    // inscription_response->d_inscription_remuneration
    if (!inscription_response->d_inscription_remuneration) {
        goto fail;
    }
    if(cJSON_AddStringToObject(item, "dInscriptionRemuneration", inscription_response->d_inscription_remuneration) == NULL) {
    goto fail; //String
    }


    // inscription_response->d_inscription_remunerationinscriptorseller
    if (!inscription_response->d_inscription_remunerationinscriptorseller) {
        goto fail;
    }
    if(cJSON_AddStringToObject(item, "dInscriptionRemunerationinscriptorseller", inscription_response->d_inscription_remunerationinscriptorseller) == NULL) {
    goto fail; //String
    }


    // inscription_response->d_inscription_remunerationreference
    if (!inscription_response->d_inscription_remunerationreference) {
        goto fail;
    }
    if(cJSON_AddStringToObject(item, "dInscriptionRemunerationreference", inscription_response->d_inscription_remunerationreference) == NULL) {
    goto fail; //String
    }


    // inscription_response->d_inscription_remunerationtotal
    if (!inscription_response->d_inscription_remunerationtotal) {
        goto fail;
    }
    if(cJSON_AddStringToObject(item, "dInscriptionRemunerationtotal", inscription_response->d_inscription_remunerationtotal) == NULL) {
    goto fail; //String
    }


    // inscription_response->d_inscription_mortgagesold
    if (!inscription_response->d_inscription_mortgagesold) {
        goto fail;
    }
    if(cJSON_AddStringToObject(item, "dInscriptionMortgagesold", inscription_response->d_inscription_mortgagesold) == NULL) {
    goto fail; //String
    }


    // inscription_response->dt_inscription_date
    if (!inscription_response->dt_inscription_date) {
        goto fail;
    }
    if(cJSON_AddStringToObject(item, "dtInscriptionDate", inscription_response->dt_inscription_date) == NULL) {
    goto fail; //String
    }


    // inscription_response->dt_inscription_cancellationdate
    if (!inscription_response->dt_inscription_cancellationdate) {
        goto fail;
    }
    if(cJSON_AddStringToObject(item, "dtInscriptionCancellationdate", inscription_response->dt_inscription_cancellationdate) == NULL) {
    goto fail; //String
    }


    // inscription_response->dt_inscription_initialexpirationdate
    if (!inscription_response->dt_inscription_initialexpirationdate) {
        goto fail;
    }
    if(cJSON_AddStringToObject(item, "dtInscriptionInitialexpirationdate", inscription_response->dt_inscription_initialexpirationdate) == NULL) {
    goto fail; //String
    }


    // inscription_response->dt_inscription_expirationdate
    if (!inscription_response->dt_inscription_expirationdate) {
        goto fail;
    }
    if(cJSON_AddStringToObject(item, "dtInscriptionExpirationdate", inscription_response->dt_inscription_expirationdate) == NULL) {
    goto fail; //String
    }


    // inscription_response->dt_inscription_notarydate
    if (!inscription_response->dt_inscription_notarydate) {
        goto fail;
    }
    if(cJSON_AddStringToObject(item, "dtInscriptionNotarydate", inscription_response->dt_inscription_notarydate) == NULL) {
    goto fail; //String
    }


    // inscription_response->dt_inscription_notaryentereddate
    if (!inscription_response->dt_inscription_notaryentereddate) {
        goto fail;
    }
    if(cJSON_AddStringToObject(item, "dtInscriptionNotaryentereddate", inscription_response->dt_inscription_notaryentereddate) == NULL) {
    goto fail; //String
    }


    // inscription_response->t_inscription_cadastre
    if (!inscription_response->t_inscription_cadastre) {
        goto fail;
    }
    if(cJSON_AddStringToObject(item, "tInscriptionCadastre", inscription_response->t_inscription_cadastre) == NULL) {
    goto fail; //String
    }


    // inscription_response->b_inscription_reference
    if (!inscription_response->b_inscription_reference) {
        goto fail;
    }
    if(cJSON_AddBoolToObject(item, "bInscriptionReference", *inscription_response->b_inscription_reference) == NULL) {
    goto fail; //Bool
    }


    // inscription_response->b_inscription_inspection
    if (!inscription_response->b_inscription_inspection) {
        goto fail;
    }
    if(cJSON_AddBoolToObject(item, "bInscriptionInspection", *inscription_response->b_inscription_inspection) == NULL) {
    goto fail; //Bool
    }


    // inscription_response->b_inscription_isactive
    if (!inscription_response->b_inscription_isactive) {
        goto fail;
    }
    if(cJSON_AddBoolToObject(item, "bInscriptionIsactive", *inscription_response->b_inscription_isactive) == NULL) {
    goto fail; //Bool
    }


    // inscription_response->t_inscription_checklistnote
    if (!inscription_response->t_inscription_checklistnote) {
        goto fail;
    }
    if(cJSON_AddStringToObject(item, "tInscriptionChecklistnote", inscription_response->t_inscription_checklistnote) == NULL) {
    goto fail; //String
    }


    // inscription_response->b_inscription_new
    if (!inscription_response->b_inscription_new) {
        goto fail;
    }
    if(cJSON_AddBoolToObject(item, "bInscriptionNew", *inscription_response->b_inscription_new) == NULL) {
    goto fail; //Bool
    }


    // inscription_response->b_inscription_homeowner
    if (!inscription_response->b_inscription_homeowner) {
        goto fail;
    }
    if(cJSON_AddBoolToObject(item, "bInscriptionHomeowner", *inscription_response->b_inscription_homeowner) == NULL) {
    goto fail; //Bool
    }


    // inscription_response->b_inscription_archived
    if (!inscription_response->b_inscription_archived) {
        goto fail;
    }
    if(cJSON_AddBoolToObject(item, "bInscriptionArchived", *inscription_response->b_inscription_archived) == NULL) {
    goto fail; //Bool
    }


    // inscription_response->b_inscription_litigation
    if (!inscription_response->b_inscription_litigation) {
        goto fail;
    }
    if(cJSON_AddBoolToObject(item, "bInscriptionLitigation", *inscription_response->b_inscription_litigation) == NULL) {
    goto fail; //Bool
    }


    // inscription_response->b_inscription_repossession
    if (!inscription_response->b_inscription_repossession) {
        goto fail;
    }
    if(cJSON_AddBoolToObject(item, "bInscriptionRepossession", *inscription_response->b_inscription_repossession) == NULL) {
    goto fail; //Bool
    }


    // inscription_response->b_inscription_issolicitation
    if (!inscription_response->b_inscription_issolicitation) {
        goto fail;
    }
    if(cJSON_AddBoolToObject(item, "bInscriptionIssolicitation", *inscription_response->b_inscription_issolicitation) == NULL) {
    goto fail; //Bool
    }


    // inscription_response->b_inscription_salebyowner
    if (!inscription_response->b_inscription_salebyowner) {
        goto fail;
    }
    if(cJSON_AddBoolToObject(item, "bInscriptionSalebyowner", *inscription_response->b_inscription_salebyowner) == NULL) {
    goto fail; //Bool
    }


    // inscription_response->b_inscription_soldwithoutlegalwarranty
    if (!inscription_response->b_inscription_soldwithoutlegalwarranty) {
        goto fail;
    }
    if(cJSON_AddBoolToObject(item, "bInscriptionSoldwithoutlegalwarranty", *inscription_response->b_inscription_soldwithoutlegalwarranty) == NULL) {
    goto fail; //Bool
    }


    // inscription_response->i_inscription_constructionyear
    if (!inscription_response->i_inscription_constructionyear) {
        goto fail;
    }
    if(cJSON_AddNumberToObject(item, "iInscriptionConstructionyear", *inscription_response->i_inscription_constructionyear) == NULL) {
    goto fail; //Numeric
    }


    // inscription_response->i_inscription_unit
    if (!inscription_response->i_inscription_unit) {
        goto fail;
    }
    if(cJSON_AddNumberToObject(item, "iInscriptionUnit", *inscription_response->i_inscription_unit) == NULL) {
    goto fail; //Numeric
    }
...
inscription_response_t *inscription_response_parseFromJSON(cJSON *inscription_responseJSON){
    ...
    inscription_response_t *inscription_response_local_var = NULL;

    // define the local variable for inscription_response->pki_inscription_id
    int *pki_inscription_id_local_var = NULL;

    // define the local variable for inscription_response->fki_company_id
    int *fki_company_id_local_var = NULL;

    char *s_company_name_x_local_str = NULL;

    // define the local variable for inscription_response->fki_department_id
    int *fki_department_id_local_var = NULL;

    char *s_department_name_x_local_str = NULL;

    // define the local variable for inscription_response->fki_realestateboard_id
    int *fki_realestateboard_id_local_var = NULL;

    char *s_realestateboard_name_x_local_str = NULL;

    // define the local variable for inscription_response->fki_address_id
    int *fki_address_id_local_var = NULL;

    char *s_address_local_str = NULL;

    // define the local variable for inscription_response->fki_inscriptionbuildingtype_id
    int *fki_inscriptionbuildingtype_id_local_var = NULL;

    char *s_inscriptionbuildingtype_name_x_local_str = NULL;

    // define the local variable for inscription_response->fki_inscriptiontype_id
    int *fki_inscriptiontype_id_local_var = NULL;

    char *s_inscriptiontype_name_x_local_str = NULL;

    // define the local variable for inscription_response->fki_inscriptioncategory_id
    int *fki_inscriptioncategory_id_local_var = NULL;

    char *s_inscriptioncategory_name_x_local_str = NULL;

    // define the local variable for inscription_response->e_inscription_step
    ezmax_api_definition__full_field_e_inscription_step__e e_inscription_step_local_nonprim = 0;

    // define the local variable for inscription_response->e_inscription_residence_type
    ...
    // define the local variable for inscription_response->i_inscription_sellerdeclaration
    int *i_inscription_sellerdeclaration_local_var = NULL;

    // define the local variable for inscription_response->e_inscription_type
    ...
    // define the local variable for inscription_response->e_inscription_remunerationtype
    ezmax_api_definition__full_field_e_inscription_remunerationtype__e e_inscription_remunerationtype_local_nonprim = 0;

    // define the local variable for inscription_response->e_inscription_remunerationinscriptorsellertype
    ...
    // define the local variable for inscription_response->e_inscription_remunerationreferencetype
    ...
    // define the local variable for inscription_response->e_inscription_remunerationtotaltype
    ...
    // define the local variable for inscription_response->b_inscription_reference
    int *b_inscription_reference_local_var = NULL;

    // define the local variable for inscription_response->b_inscription_inspection
    int *b_inscription_inspection_local_var = NULL;

    // define the local variable for inscription_response->b_inscription_isactive
    int *b_inscription_isactive_local_var = NULL;

    char *t_inscription_checklistnote_local_str = NULL;

    // define the local variable for inscription_response->b_inscription_new
    int *b_inscription_new_local_var = NULL;

    // define the local variable for inscription_response->b_inscription_homeowner
    int *b_inscription_homeowner_local_var = NULL;

    // define the local variable for inscription_response->b_inscription_archived
    int *b_inscription_archived_local_var = NULL;

    // define the local variable for inscription_response->b_inscription_litigation
    int *b_inscription_litigation_local_var = NULL;

    // define the local variable for inscription_response->b_inscription_repossession
    int *b_inscription_repossession_local_var = NULL;

    // define the local variable for inscription_response->b_inscription_issolicitation
    int *b_inscription_issolicitation_local_var = NULL;

    // define the local variable for inscription_response->b_inscription_salebyowner
    int *b_inscription_salebyowner_local_var = NULL;

    // define the local variable for inscription_response->b_inscription_soldwithoutlegalwarranty
    int *b_inscription_soldwithoutlegalwarranty_local_var = NULL;

    // define the local variable for inscription_response->i_inscription_constructionyear
    int *i_inscription_constructionyear_local_var = NULL;

    // define the local variable for inscription_response->i_inscription_unit
    int *i_inscription_unit_local_var = NULL;

    // inscription_response->pki_inscription_id
    cJSON *pki_inscription_id = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "pkiInscriptionID");
    ...
    *pki_inscription_id_local_var = pki_inscription_id->valuedouble;
    ...
    // inscription_response->fki_company_id
    cJSON *fki_company_id = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "fkiCompanyID");
    ...
    *fki_company_id_local_var = fki_company_id->valuedouble;
    ...
    // inscription_response->s_company_name_x
    cJSON *s_company_name_x = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "sCompanyNameX");
    ...
    // inscription_response->fki_department_id
    cJSON *fki_department_id = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "fkiDepartmentID");
    ...
    *fki_department_id_local_var = fki_department_id->valuedouble;
    ...
    // inscription_response->s_department_name_x
    cJSON *s_department_name_x = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "sDepartmentNameX");
    ...
    // inscription_response->fki_realestateboard_id
    cJSON *fki_realestateboard_id = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "fkiRealestateboardID");
    ...
    *fki_realestateboard_id_local_var = fki_realestateboard_id->valuedouble;
    ...
    // inscription_response->s_realestateboard_name_x
    cJSON *s_realestateboard_name_x = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "sRealestateboardNameX");
    ...
    // inscription_response->fki_address_id
    cJSON *fki_address_id = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "fkiAddressID");
    ...
    *fki_address_id_local_var = fki_address_id->valuedouble;
    ...
    // inscription_response->s_address
    cJSON *s_address = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "sAddress");
    ...
    // inscription_response->fki_inscriptionbuildingtype_id
    cJSON *fki_inscriptionbuildingtype_id = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "fkiInscriptionbuildingtypeID");
    ...
    *fki_inscriptionbuildingtype_id_local_var = fki_inscriptionbuildingtype_id->valuedouble;
    ...
    // inscription_response->s_inscriptionbuildingtype_name_x
    cJSON *s_inscriptionbuildingtype_name_x = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "sInscriptionbuildingtypeNameX");
    ...
    // inscription_response->fki_inscriptiontype_id
    cJSON *fki_inscriptiontype_id = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "fkiInscriptiontypeID");
    ...
    *fki_inscriptiontype_id_local_var = fki_inscriptiontype_id->valuedouble;
    ...
    // inscription_response->s_inscriptiontype_name_x
    cJSON *s_inscriptiontype_name_x = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "sInscriptiontypeNameX");
    ...
    // inscription_response->fki_inscriptioncategory_id
    cJSON *fki_inscriptioncategory_id = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "fkiInscriptioncategoryID");
    ...
    *fki_inscriptioncategory_id_local_var = fki_inscriptioncategory_id->valuedouble;
    ...
    // inscription_response->s_inscriptioncategory_name_x
    cJSON *s_inscriptioncategory_name_x = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "sInscriptioncategoryNameX");
    ...
    // inscription_response->e_inscription_step
    cJSON *e_inscription_step = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "eInscriptionStep");
    ...
    // inscription_response->e_inscription_residence_type
    cJSON *e_inscription_residence_type = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "eInscriptionResidenceType");
    ...
    // inscription_response->s_inscription_civicend
    cJSON *s_inscription_civicend = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "sInscriptionCivicend");
    ...
    // inscription_response->s_inscription_mls
    cJSON *s_inscription_mls = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "sInscriptionMLS");
    ...
    // inscription_response->s_inscription_contract
    cJSON *s_inscription_contract = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "sInscriptionContract");
    ...
    // inscription_response->i_inscription_sellerdeclaration
    cJSON *i_inscription_sellerdeclaration = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "iInscriptionSellerdeclaration");
    ...
    *i_inscription_sellerdeclaration_local_var = i_inscription_sellerdeclaration->valuedouble;
    ...
    // inscription_response->e_inscription_type
    cJSON *e_inscription_type = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "eInscriptionType");
    ...
    // inscription_response->d_inscription_initialsaleprice
    cJSON *d_inscription_initialsaleprice = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "dInscriptionInitialsaleprice");
    ...
    // inscription_response->d_inscription_saleprice
    cJSON *d_inscription_saleprice = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "dInscriptionSaleprice");
    ...
    // inscription_response->d_inscription_rentprice
    cJSON *d_inscription_rentprice = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "dInscriptionRentprice");
    ...
    // inscription_response->e_inscription_remunerationtype
    cJSON *e_inscription_remunerationtype = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "eInscriptionRemunerationtype");
    ...
    // inscription_response->e_inscription_remunerationinscriptorsellertype
    cJSON *e_inscription_remunerationinscriptorsellertype = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "eInscriptionRemunerationinscriptorsellertype");
    ...
    // inscription_response->e_inscription_remunerationreferencetype
    cJSON *e_inscription_remunerationreferencetype = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "eInscriptionRemunerationreferencetype");
    ...
    // inscription_response->e_inscription_remunerationtotaltype
    cJSON *e_inscription_remunerationtotaltype = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "eInscriptionRemunerationtotaltype");
    ...
    // inscription_response->d_inscription_remuneration
    cJSON *d_inscription_remuneration = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "dInscriptionRemuneration");
    ...
    // inscription_response->d_inscription_remunerationinscriptorseller
    cJSON *d_inscription_remunerationinscriptorseller = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "dInscriptionRemunerationinscriptorseller");
    ...
    // inscription_response->d_inscription_remunerationreference
    cJSON *d_inscription_remunerationreference = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "dInscriptionRemunerationreference");
    ...
    // inscription_response->d_inscription_remunerationtotal
    cJSON *d_inscription_remunerationtotal = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "dInscriptionRemunerationtotal");
    ...
    // inscription_response->d_inscription_mortgagesold
    cJSON *d_inscription_mortgagesold = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "dInscriptionMortgagesold");
    ...
    // inscription_response->dt_inscription_date
    cJSON *dt_inscription_date = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "dtInscriptionDate");
    ...
    // inscription_response->dt_inscription_cancellationdate
    cJSON *dt_inscription_cancellationdate = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "dtInscriptionCancellationdate");
    ...
    // inscription_response->dt_inscription_initialexpirationdate
    cJSON *dt_inscription_initialexpirationdate = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "dtInscriptionInitialexpirationdate");
    ...
    // inscription_response->dt_inscription_expirationdate
    cJSON *dt_inscription_expirationdate = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "dtInscriptionExpirationdate");
    ...
    // inscription_response->dt_inscription_notarydate
    cJSON *dt_inscription_notarydate = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "dtInscriptionNotarydate");
    ...
    // inscription_response->dt_inscription_notaryentereddate
    cJSON *dt_inscription_notaryentereddate = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "dtInscriptionNotaryentereddate");
    ...
    // inscription_response->t_inscription_cadastre
    cJSON *t_inscription_cadastre = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "tInscriptionCadastre");
    ...
    // inscription_response->b_inscription_reference
    cJSON *b_inscription_reference = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "bInscriptionReference");
    ...
    *b_inscription_reference_local_var = b_inscription_reference->valueint;
    ...
    // inscription_response->b_inscription_inspection
    cJSON *b_inscription_inspection = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "bInscriptionInspection");
    ...
    *b_inscription_inspection_local_var = b_inscription_inspection->valueint;
    ...
    // inscription_response->b_inscription_isactive
    cJSON *b_inscription_isactive = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "bInscriptionIsactive");
    ...
    *b_inscription_isactive_local_var = b_inscription_isactive->valueint;
    ...
    // inscription_response->t_inscription_checklistnote
    cJSON *t_inscription_checklistnote = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "tInscriptionChecklistnote");
    ...
    // inscription_response->b_inscription_new
    cJSON *b_inscription_new = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "bInscriptionNew");
    ...
    *b_inscription_new_local_var = b_inscription_new->valueint;
    ...
    // inscription_response->b_inscription_homeowner
    cJSON *b_inscription_homeowner = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "bInscriptionHomeowner");
    ...
    *b_inscription_homeowner_local_var = b_inscription_homeowner->valueint;
    ...
    // inscription_response->b_inscription_archived
    cJSON *b_inscription_archived = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "bInscriptionArchived");
    ...
    *b_inscription_archived_local_var = b_inscription_archived->valueint;
    ...
    // inscription_response->b_inscription_litigation
    cJSON *b_inscription_litigation = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "bInscriptionLitigation");
    ...
    *b_inscription_litigation_local_var = b_inscription_litigation->valueint;
    ...
    // inscription_response->b_inscription_repossession
    cJSON *b_inscription_repossession = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "bInscriptionRepossession");
    ...
    *b_inscription_repossession_local_var = b_inscription_repossession->valueint;
    ...
    // inscription_response->b_inscription_issolicitation
    cJSON *b_inscription_issolicitation = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "bInscriptionIssolicitation");
    ...
    *b_inscription_issolicitation_local_var = b_inscription_issolicitation->valueint;
    ...
    // inscription_response->b_inscription_salebyowner
    cJSON *b_inscription_salebyowner = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "bInscriptionSalebyowner");
    ...
    *b_inscription_salebyowner_local_var = b_inscription_salebyowner->valueint;
    ...
    // inscription_response->b_inscription_soldwithoutlegalwarranty
    cJSON *b_inscription_soldwithoutlegalwarranty = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "bInscriptionSoldwithoutlegalwarranty");
    ...
    *b_inscription_soldwithoutlegalwarranty_local_var = b_inscription_soldwithoutlegalwarranty->valueint;
    ...
    // inscription_response->i_inscription_constructionyear
    cJSON *i_inscription_constructionyear = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "iInscriptionConstructionyear");
    ...
    *i_inscription_constructionyear_local_var = i_inscription_constructionyear->valuedouble;
    ...
    // inscription_response->i_inscription_unit
    cJSON *i_inscription_unit = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "iInscriptionUnit");
    ...
    *i_inscription_unit_local_var = i_inscription_unit->valuedouble;
    ...
    inscription_response_local_var = inscription_response_create_internal (
