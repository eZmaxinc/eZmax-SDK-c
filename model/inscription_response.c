...
static inscription_response_t *inscription_response_create_internal(
    ...
    inscription_response_local_var->obj_address = obj_address;
    ...
    inscription_response_local_var->obj_audit = obj_audit;
...
void inscription_response_free(inscription_response_t *inscription_response) {
    ...
    if (inscription_response->obj_address) {
        address_response_compound_free(inscription_response->obj_address);
        inscription_response->obj_address = NULL;
    }
    ...
    if (inscription_response->obj_audit) {
        common_audit_free(inscription_response->obj_audit);
        inscription_response->obj_audit = NULL;
    }
...
cJSON *inscription_response_convertToJSON(inscription_response_t *inscription_response) {
    ...
    // inscription_response->obj_address
    if(inscription_response->obj_address) {
    cJSON *obj_address_local_JSON = address_response_compound_convertToJSON(inscription_response->obj_address);
    ...
    // inscription_response->obj_audit
    if(inscription_response->obj_audit) {
    cJSON *obj_audit_local_JSON = common_audit_convertToJSON(inscription_response->obj_audit);
...
inscription_response_t *inscription_response_parseFromJSON(cJSON *inscription_responseJSON){
    ...
    // define the local variable for inscription_response->obj_address
    ...
    // define the local variable for inscription_response->obj_audit
    ...
    *fki_address_id_local_var = fki_address_id->valuedouble;
    ...
    // inscription_response->obj_address
    cJSON *obj_address = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "objAddress");
    ...
    *i_inscription_unit_local_var = i_inscription_unit->valuedouble;
    ...
    // inscription_response->obj_audit
    cJSON *obj_audit = cJSON_GetObjectItemCaseSensitive(inscription_responseJSON, "objAudit");
