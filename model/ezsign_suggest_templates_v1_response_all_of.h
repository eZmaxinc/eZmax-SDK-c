/*
 * ezsign_suggest_templates_v1_response_all_of.h
 *
 * 
 */

#ifndef _ezsign_suggest_templates_v1_response_all_of_H_
#define _ezsign_suggest_templates_v1_response_all_of_H_
...
typedef struct ezsign_suggest_templates_v1_response_all_of_t ezsign_suggest_templates_v1_response_all_of_t;

#include "ezsign_suggest_templates_v1_response_m_payload.h"



typedef struct ezsign_suggest_templates_v1_response_all_of_t {
    struct ezsign_suggest_templates_v1_response_m_payload_t *m_payload; //model

} ezsign_suggest_templates_v1_response_all_of_t;
...
#endif /* _ezsign_suggest_templates_v1_response_all_of_H_ */
