...
void ezsignannotation_request_compound_free(ezsignannotation_request_compound_t *ezsignannotation_request_compound) {
    ...
    if (ezsignannotation_request_compound->e_ezsignannotation_horizontalalignment) {
        enum_horizontalalignment_free(ezsignannotation_request_compound->e_ezsignannotation_horizontalalignment);
        ezsignannotation_request_compound->e_ezsignannotation_horizontalalignment = NULL;
    }
    if (ezsignannotation_request_compound->e_ezsignannotation_verticalalignment) {
        enum_verticalalignment_free(ezsignannotation_request_compound->e_ezsignannotation_verticalalignment);
        ezsignannotation_request_compound->e_ezsignannotation_verticalalignment = NULL;
    }
    if (ezsignannotation_request_compound->e_ezsignannotation_type) {
        field_e_ezsignannotation_type_free(ezsignannotation_request_compound->e_ezsignannotation_type);
        ezsignannotation_request_compound->e_ezsignannotation_type = NULL;
    }
...
cJSON *ezsignannotation_request_compound_convertToJSON(ezsignannotation_request_compound_t *ezsignannotation_request_compound) {
    ...
    if(ezsignannotation_request_compound->e_ezsignannotation_horizontalalignment != ezmax_api_definition__full_ezsignannotation_request_compound__NULL) {
    ...
    if(ezsignannotation_request_compound->e_ezsignannotation_verticalalignment != ezmax_api_definition__full_ezsignannotation_request_compound__NULL) {
    ...
    if (ezmax_api_definition__full_ezsignannotation_request_compound__NULL == ezsignannotation_request_compound->e_ezsignannotation_type) {
        goto fail;
    }
...
ezsignannotation_request_compound_t *ezsignannotation_request_compound_parseFromJSON(cJSON *ezsignannotation_request_compoundJSON){
    ...
    ezsignannotation_request_compound_local_var = ezsignannotation_request_compound_create (
