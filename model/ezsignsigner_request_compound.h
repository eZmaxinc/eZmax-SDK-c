...
typedef enum  { ezmax_api_definition__full_ezsignsigner_request_compound_EEZSIGNSIGNERLOGINTYPE_NULL = 0, ezmax_api_definition__full_ezsignsigner_request_compound_EEZSIGNSIGNERLOGINTYPE_Password, ezmax_api_definition__full_ezsignsigner_request_compound_EEZSIGNSIGNERLOGINTYPE_PasswordPhone, ezmax_api_definition__full_ezsignsigner_request_compound_EEZSIGNSIGNERLOGINTYPE_PasswordQuestion, ezmax_api_definition__full_ezsignsigner_request_compound_EEZSIGNSIGNERLOGINTYPE_InPersonPhone, ezmax_api_definition__full_ezsignsigner_request_compound_EEZSIGNSIGNERLOGINTYPE_InPerson } ezmax_api_definition__full_ezsignsigner_request_compound_EEZSIGNSIGNERLOGINTYPE_e;
...
typedef struct ezsignsigner_request_compound_t {
    ...
    ezmax_api_definition__full_ezsignsigner_request_compound_EEZSIGNSIGNERLOGINTYPE_e e_ezsignsigner_logintype; //enum
