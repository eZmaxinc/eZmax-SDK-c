...
static apikey_get_subnets_v1_response_m_payload_t *apikey_get_subnets_v1_response_m_payload_create_internal(
    ...
    memset(apikey_get_subnets_v1_response_m_payload_local_var, 0, sizeof(apikey_get_subnets_v1_response_m_payload_t));
...
__attribute__((deprecated)) apikey_get_subnets_v1_response_m_payload_t *apikey_get_subnets_v1_response_m_payload_create(
    ...
    apikey_get_subnets_v1_response_m_payload_t *result = apikey_get_subnets_v1_response_m_payload_create_internal (
        a_obj_subnet
        );
    if (!result) {
    }
