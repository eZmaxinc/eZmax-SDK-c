...
static contact_request_compound_t *contact_request_compound_create_internal(
    ...
    memset(contact_request_compound_local_var, 0, sizeof(contact_request_compound_t));
...
__attribute__((deprecated)) contact_request_compound_t *contact_request_compound_create(
    ...
    contact_request_compound_t *result = contact_request_compound_create_internal (
...
void contact_request_compound_free(contact_request_compound_t *contact_request_compound) {
    ...
    if (contact_request_compound->fki_contacttitle_id) {
        free(contact_request_compound->fki_contacttitle_id);
        contact_request_compound->fki_contacttitle_id = NULL;
    }
    if (contact_request_compound->fki_language_id) {
        free(contact_request_compound->fki_language_id);
        contact_request_compound->fki_language_id = NULL;
    }
...
contact_request_compound_t *contact_request_compound_parseFromJSON(cJSON *contact_request_compoundJSON){
    ...
    // define the local variable for contact_request_compound->fki_contacttitle_id
    int *fki_contacttitle_id_local_var = NULL;

    // define the local variable for contact_request_compound->fki_language_id
