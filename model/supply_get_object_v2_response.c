...
static supply_get_object_v2_response_t *supply_get_object_v2_response_create_internal(
    ...
    memset(supply_get_object_v2_response_local_var, 0, sizeof(supply_get_object_v2_response_t));
    supply_get_object_v2_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) supply_get_object_v2_response_t *supply_get_object_v2_response_create(
    common_response_obj_debug_payload_t *obj_debug_payload,
    common_response_obj_debug_t *obj_debug,
    supply_get_object_v2_response_m_payload_t *m_payload
    ) {
    supply_get_object_v2_response_t *result = supply_get_object_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void supply_get_object_v2_response_free(supply_get_object_v2_response_t *supply_get_object_v2_response) {
    ...
    if(supply_get_object_v2_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "supply_get_object_v2_response_free");
        return ;
    }
...
supply_get_object_v2_response_t *supply_get_object_v2_response_parseFromJSON(cJSON *supply_get_object_v2_responseJSON){
    ...
    supply_get_object_v2_response_local_var = supply_get_object_v2_response_create_internal (
