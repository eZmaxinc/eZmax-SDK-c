...
static ezsigntemplatepackage_get_list_v1_response_m_payload_t *ezsigntemplatepackage_get_list_v1_response_m_payload_create_internal(
    ...
    memset(ezsigntemplatepackage_get_list_v1_response_m_payload_local_var, 0, sizeof(ezsigntemplatepackage_get_list_v1_response_m_payload_t));
...
__attribute__((deprecated)) ezsigntemplatepackage_get_list_v1_response_m_payload_t *ezsigntemplatepackage_get_list_v1_response_m_payload_create(
    ...
    ezsigntemplatepackage_get_list_v1_response_m_payload_t *result = ezsigntemplatepackage_get_list_v1_response_m_payload_create_internal (
        i_row_returned_copy,
        i_row_filtered_copy,
...
void ezsigntemplatepackage_get_list_v1_response_m_payload_free(ezsigntemplatepackage_get_list_v1_response_m_payload_t *ezsigntemplatepackage_get_list_v1_response_m_payload) {
    ...
    if (ezsigntemplatepackage_get_list_v1_response_m_payload->i_row_returned) {
        free(ezsigntemplatepackage_get_list_v1_response_m_payload->i_row_returned);
        ezsigntemplatepackage_get_list_v1_response_m_payload->i_row_returned = NULL;
    }
    if (ezsigntemplatepackage_get_list_v1_response_m_payload->i_row_filtered) {
        free(ezsigntemplatepackage_get_list_v1_response_m_payload->i_row_filtered);
        ezsigntemplatepackage_get_list_v1_response_m_payload->i_row_filtered = NULL;
    }
...
ezsigntemplatepackage_get_list_v1_response_m_payload_t *ezsigntemplatepackage_get_list_v1_response_m_payload_parseFromJSON(cJSON *ezsigntemplatepackage_get_list_v1_response_m_payloadJSON){
    ...
    // define the local variable for ezsigntemplatepackage_get_list_v1_response_m_payload->i_row_returned
    int *i_row_returned_local_var = NULL;

    // define the local variable for ezsigntemplatepackage_get_list_v1_response_m_payload->i_row_filtered
