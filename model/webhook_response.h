...
typedef enum  { ezmax_api_definition__full_webhook_response__NULL = 0, ezmax_api_definition__full_webhook_response__DocumentCompleted, ezmax_api_definition__full_webhook_response__DocumentFormCompleted, ezmax_api_definition__full_webhook_response__DocumentUnsent, ezmax_api_definition__full_webhook_response__EzsignsignerAcceptclause, ezmax_api_definition__full_webhook_response__EzsignsignerConnect, ezmax_api_definition__full_webhook_response__FolderCompleted, ezmax_api_definition__full_webhook_response__FolderDisposed, ezmax_api_definition__full_webhook_response__FolderSent, ezmax_api_definition__full_webhook_response__FolderUnsent, ezmax_api_definition__full_webhook_response__SignatureSigned } ezmax_api_definition__full_webhook_response__e;
