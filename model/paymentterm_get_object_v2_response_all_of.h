/*
 * paymentterm_get_object_v2_response_all_of.h
 *
 * 
 */

#ifndef _paymentterm_get_object_v2_response_all_of_H_
#define _paymentterm_get_object_v2_response_all_of_H_
...
typedef struct paymentterm_get_object_v2_response_all_of_t paymentterm_get_object_v2_response_all_of_t;

#include "paymentterm_get_object_v2_response_m_payload.h"



typedef struct paymentterm_get_object_v2_response_all_of_t {
    struct paymentterm_get_object_v2_response_m_payload_t *m_payload; //model

} paymentterm_get_object_v2_response_all_of_t;
...
#endif /* _paymentterm_get_object_v2_response_all_of_H_ */
