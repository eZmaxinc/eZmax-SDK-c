...
#include <string.h>
#include <stdio.h>
#include "communication_create_object_v1_response_m_payload.h"
...
communication_create_object_v1_response_m_payload_t *communication_create_object_v1_response_m_payload_create(
    ...
    communication_create_object_v1_response_m_payload_t *communication_create_object_v1_response_m_payload_local_var = malloc(sizeof(communication_create_object_v1_response_m_payload_t));
    if (!communication_create_object_v1_response_m_payload_local_var) {
        return NULL;
    }
    communication_create_object_v1_response_m_payload_local_var->a_pki_communication_id = a_pki_communication_id;

    return communication_create_object_v1_response_m_payload_local_var;
}
...
void communication_create_object_v1_response_m_payload_free(communication_create_object_v1_response_m_payload_t *communication_create_object_v1_response_m_payload) {
    if(NULL == communication_create_object_v1_response_m_payload){
        return ;
    }
    listEntry_t *listEntry;
    if (communication_create_object_v1_response_m_payload->a_pki_communication_id) {
        list_ForEach(listEntry, communication_create_object_v1_response_m_payload->a_pki_communication_id) {
            free(listEntry->data);
        }
        list_freeList(communication_create_object_v1_response_m_payload->a_pki_communication_id);
        communication_create_object_v1_response_m_payload->a_pki_communication_id = NULL;
    }
    free(communication_create_object_v1_response_m_payload);
}
...
cJSON *communication_create_object_v1_response_m_payload_convertToJSON(communication_create_object_v1_response_m_payload_t *communication_create_object_v1_response_m_payload) {
    ...
    // communication_create_object_v1_response_m_payload->a_pki_communication_id
    if (!communication_create_object_v1_response_m_payload->a_pki_communication_id) {
        goto fail;
    }
    ...
    list_ForEach(a_pki_communication_idListEntry, communication_create_object_v1_response_m_payload->a_pki_communication_id) {
...
communication_create_object_v1_response_m_payload_t *communication_create_object_v1_response_m_payload_parseFromJSON(cJSON *communication_create_object_v1_response_m_payloadJSON){
    ...
    communication_create_object_v1_response_m_payload_t *communication_create_object_v1_response_m_payload_local_var = NULL;

    // define the local list for communication_create_object_v1_response_m_payload->a_pki_communication_id
    list_t *a_pki_communication_idList = NULL;

    // communication_create_object_v1_response_m_payload->a_pki_communication_id
    cJSON *a_pki_communication_id = cJSON_GetObjectItemCaseSensitive(communication_create_object_v1_response_m_payloadJSON, "a_pkiCommunicationID");
    ...
    communication_create_object_v1_response_m_payload_local_var = communication_create_object_v1_response_m_payload_create (
