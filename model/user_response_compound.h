...
typedef enum  { ezmax_api_definition__full_user_response_compound__NULL = 0, ezmax_api_definition__full_user_response_compound__BuiltIn, ezmax_api_definition__full_user_response_compound__External } ezmax_api_definition__full_user_response_compound__e;
...
typedef enum  { ezmax_api_definition__full_user_response_compound__NULL = 0, ezmax_api_definition__full_user_response_compound__AgentBroker, ezmax_api_definition__full_user_response_compound__Assistant, ezmax_api_definition__full_user_response_compound__Employee, ezmax_api_definition__full_user_response_compound__EzsignUser, ezmax_api_definition__full_user_response_compound__Normal } ezmax_api_definition__full_user_response_compound__e;
...
typedef enum  { ezmax_api_definition__full_user_response_compound__NULL = 0, ezmax_api_definition__full_user_response_compound__Password, ezmax_api_definition__full_user_response_compound__PasswordPhone, ezmax_api_definition__full_user_response_compound__PasswordQuestion } ezmax_api_definition__full_user_response_compound__e;
...
typedef enum  { ezmax_api_definition__full_user_response_compound__NULL = 0, ezmax_api_definition__full_user_response_compound__No, ezmax_api_definition__full_user_response_compound__PaidByOffice, ezmax_api_definition__full_user_response_compound__PerDocument, ezmax_api_definition__full_user_response_compound__Prepaid } ezmax_api_definition__full_user_response_compound__e;
