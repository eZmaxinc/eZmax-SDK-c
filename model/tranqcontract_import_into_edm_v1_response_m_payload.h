/*
 * tranqcontract_import_into_edm_v1_response_m_payload.h
 *
 * Payload for POST /1/object/tranqcontract/{pkiTranqcontractID}/importIntoEDM
 */

#ifndef _tranqcontract_import_into_edm_v1_response_m_payload_H_
#define _tranqcontract_import_into_edm_v1_response_m_payload_H_
...
typedef struct tranqcontract_import_into_edm_v1_response_m_payload_t tranqcontract_import_into_edm_v1_response_m_payload_t;

#include "custom_attachment_import_into_edm_response.h"



typedef struct tranqcontract_import_into_edm_v1_response_m_payload_t {
    list_t *a_obj_attachment; //nonprimitive container

    int _library_owned; // Is the library responsible for freeing this object?
} tranqcontract_import_into_edm_v1_response_m_payload_t;
...
#endif /* _tranqcontract_import_into_edm_v1_response_m_payload_H_ */
