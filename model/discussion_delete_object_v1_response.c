...
static discussion_delete_object_v1_response_t *discussion_delete_object_v1_response_create_internal(
    ...
    memset(discussion_delete_object_v1_response_local_var, 0, sizeof(discussion_delete_object_v1_response_t));
...
__attribute__((deprecated)) discussion_delete_object_v1_response_t *discussion_delete_object_v1_response_create(
    ...
    discussion_delete_object_v1_response_t *result = discussion_delete_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug
        );
    if (!result) {
