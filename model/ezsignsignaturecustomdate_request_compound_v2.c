...
static ezsignsignaturecustomdate_request_compound_v2_t *ezsignsignaturecustomdate_request_compound_v2_create_internal(
    ...
    memset(ezsignsignaturecustomdate_request_compound_v2_local_var, 0, sizeof(ezsignsignaturecustomdate_request_compound_v2_t));
...
__attribute__((deprecated)) ezsignsignaturecustomdate_request_compound_v2_t *ezsignsignaturecustomdate_request_compound_v2_create(
    ...
    ezsignsignaturecustomdate_request_compound_v2_t *result = ezsignsignaturecustomdate_request_compound_v2_create_internal (
...
void ezsignsignaturecustomdate_request_compound_v2_free(ezsignsignaturecustomdate_request_compound_v2_t *ezsignsignaturecustomdate_request_compound_v2) {
    ...
    if (ezsignsignaturecustomdate_request_compound_v2->pki_ezsignsignaturecustomdate_id) {
        free(ezsignsignaturecustomdate_request_compound_v2->pki_ezsignsignaturecustomdate_id);
        ezsignsignaturecustomdate_request_compound_v2->pki_ezsignsignaturecustomdate_id = NULL;
    }
    if (ezsignsignaturecustomdate_request_compound_v2->i_ezsignsignaturecustomdate_offsetx) {
        free(ezsignsignaturecustomdate_request_compound_v2->i_ezsignsignaturecustomdate_offsetx);
        ezsignsignaturecustomdate_request_compound_v2->i_ezsignsignaturecustomdate_offsetx = NULL;
    }
    if (ezsignsignaturecustomdate_request_compound_v2->i_ezsignsignaturecustomdate_offsety) {
        free(ezsignsignaturecustomdate_request_compound_v2->i_ezsignsignaturecustomdate_offsety);
        ezsignsignaturecustomdate_request_compound_v2->i_ezsignsignaturecustomdate_offsety = NULL;
    }
...
ezsignsignaturecustomdate_request_compound_v2_t *ezsignsignaturecustomdate_request_compound_v2_parseFromJSON(cJSON *ezsignsignaturecustomdate_request_compound_v2JSON){
    ...
    // define the local variable for ezsignsignaturecustomdate_request_compound_v2->pki_ezsignsignaturecustomdate_id
    int *pki_ezsignsignaturecustomdate_id_local_var = NULL;

    // define the local variable for ezsignsignaturecustomdate_request_compound_v2->i_ezsignsignaturecustomdate_offsetx
    int *i_ezsignsignaturecustomdate_offsetx_local_var = NULL;

    // define the local variable for ezsignsignaturecustomdate_request_compound_v2->i_ezsignsignaturecustomdate_offsety
