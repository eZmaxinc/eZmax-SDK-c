...
static ezsigndocument_create_object_v1_response_m_payload_t *ezsigndocument_create_object_v1_response_m_payload_create_internal(
    ...
    memset(ezsigndocument_create_object_v1_response_m_payload_local_var, 0, sizeof(ezsigndocument_create_object_v1_response_m_payload_t));
    ezsigndocument_create_object_v1_response_m_payload_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezsigndocument_create_object_v1_response_m_payload_t *ezsigndocument_create_object_v1_response_m_payload_create(
    list_t *a_pki_ezsigndocument_id
    ) {
    ezsigndocument_create_object_v1_response_m_payload_t *result = ezsigndocument_create_object_v1_response_m_payload_create_internal (
...
void ezsigndocument_create_object_v1_response_m_payload_free(ezsigndocument_create_object_v1_response_m_payload_t *ezsigndocument_create_object_v1_response_m_payload) {
    ...
    if(ezsigndocument_create_object_v1_response_m_payload->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsigndocument_create_object_v1_response_m_payload_free");
        return ;
    }
...
ezsigndocument_create_object_v1_response_m_payload_t *ezsigndocument_create_object_v1_response_m_payload_parseFromJSON(cJSON *ezsigndocument_create_object_v1_response_m_payloadJSON){
    ...
    // define the local list for ezsigndocument_create_object_v1_response_m_payload->a_pki_ezsigndocument_id
    ...
    ezsigndocument_create_object_v1_response_m_payload_local_var = ezsigndocument_create_object_v1_response_m_payload_create_internal (
