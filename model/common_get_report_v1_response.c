...
static common_get_report_v1_response_t *common_get_report_v1_response_create_internal(
    ...
    memset(common_get_report_v1_response_local_var, 0, sizeof(common_get_report_v1_response_t));
    common_get_report_v1_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) common_get_report_v1_response_t *common_get_report_v1_response_create(
    common_response_obj_debug_payload_t *obj_debug_payload,
    common_response_obj_debug_t *obj_debug,
    common_get_report_v1_response_m_payload_t *m_payload
    ) {
    common_get_report_v1_response_t *result = common_get_report_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void common_get_report_v1_response_free(common_get_report_v1_response_t *common_get_report_v1_response) {
    ...
    if(common_get_report_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "common_get_report_v1_response_free");
        return ;
    }
...
common_get_report_v1_response_t *common_get_report_v1_response_parseFromJSON(cJSON *common_get_report_v1_responseJSON){
    ...
    common_get_report_v1_response_local_var = common_get_report_v1_response_create_internal (
