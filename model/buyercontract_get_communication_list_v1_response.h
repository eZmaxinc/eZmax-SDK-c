/*
 * buyercontract_get_communication_list_v1_response.h
 *
 * Response for GET /1/object/buyercontract/{pkiBuyercontractID}/getCommunicationList
 */

#ifndef _buyercontract_get_communication_list_v1_response_H_
#define _buyercontract_get_communication_list_v1_response_H_
...
typedef struct buyercontract_get_communication_list_v1_response_t buyercontract_get_communication_list_v1_response_t;
...
typedef struct buyercontract_get_communication_list_v1_response_t {
    struct common_response_obj_debug_payload_get_list_t *obj_debug_payload; //model
    struct common_response_obj_debug_t *obj_debug; //model
    struct buyercontract_get_communication_list_v1_response_m_payload_t *m_payload; //model
...
#endif /* _buyercontract_get_communication_list_v1_response_H_ */
