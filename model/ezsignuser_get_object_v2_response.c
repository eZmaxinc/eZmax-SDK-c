...
static ezsignuser_get_object_v2_response_t *ezsignuser_get_object_v2_response_create_internal(
    ...
    memset(ezsignuser_get_object_v2_response_local_var, 0, sizeof(ezsignuser_get_object_v2_response_t));
...
__attribute__((deprecated)) ezsignuser_get_object_v2_response_t *ezsignuser_get_object_v2_response_create(
    ...
    ezsignuser_get_object_v2_response_t *result = ezsignuser_get_object_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
