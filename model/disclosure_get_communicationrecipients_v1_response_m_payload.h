/*
 * disclosure_get_communicationrecipients_v1_response_m_payload.h
 *
 * Response for GET /1/object/disclosure/{pkiDisclosureID}/getCommunicationrecipients
 */

#ifndef _disclosure_get_communicationrecipients_v1_response_m_payload_H_
#define _disclosure_get_communicationrecipients_v1_response_m_payload_H_
...
typedef struct disclosure_get_communicationrecipients_v1_response_m_payload_t disclosure_get_communicationrecipients_v1_response_m_payload_t;

#include "custom_communicationrecipientsgroup_response.h"



typedef struct disclosure_get_communicationrecipients_v1_response_m_payload_t {
    list_t *a_obj_communicationrecipientsgroup; //nonprimitive container

    int _library_owned; // Is the library responsible for freeing this object?
} disclosure_get_communicationrecipients_v1_response_m_payload_t;
...
#endif /* _disclosure_get_communicationrecipients_v1_response_m_payload_H_ */
