...
static discussionmessage_response_t *discussionmessage_response_create_internal(
    ...
    memset(discussionmessage_response_local_var, 0, sizeof(discussionmessage_response_t));
...
__attribute__((deprecated)) discussionmessage_response_t *discussionmessage_response_create(
    ...
    discussionmessage_response_t *result = discussionmessage_response_create_internal (
...
void discussionmessage_response_free(discussionmessage_response_t *discussionmessage_response) {
    ...
    if (discussionmessage_response->pki_discussionmessage_id) {
        free(discussionmessage_response->pki_discussionmessage_id);
        discussionmessage_response->pki_discussionmessage_id = NULL;
    }
    if (discussionmessage_response->fki_discussion_id) {
        free(discussionmessage_response->fki_discussion_id);
        discussionmessage_response->fki_discussion_id = NULL;
    }
    if (discussionmessage_response->fki_discussionmembership_id) {
        free(discussionmessage_response->fki_discussionmembership_id);
        discussionmessage_response->fki_discussionmembership_id = NULL;
    }
    if (discussionmessage_response->fki_discussionmembership_id_actionrequired) {
        free(discussionmessage_response->fki_discussionmembership_id_actionrequired);
        discussionmessage_response->fki_discussionmembership_id_actionrequired = NULL;
    }
...
discussionmessage_response_t *discussionmessage_response_parseFromJSON(cJSON *discussionmessage_responseJSON){
    ...
    // define the local variable for discussionmessage_response->pki_discussionmessage_id
    int *pki_discussionmessage_id_local_var = NULL;

    // define the local variable for discussionmessage_response->fki_discussion_id
    int *fki_discussion_id_local_var = NULL;

    // define the local variable for discussionmessage_response->fki_discussionmembership_id
    int *fki_discussionmembership_id_local_var = NULL;

    // define the local variable for discussionmessage_response->fki_discussionmembership_id_actionrequired
