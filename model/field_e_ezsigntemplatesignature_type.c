...
char* field_e_ezsigntemplatesignature_type_field_e_ezsigntemplatesignature_type_ToString(ezmax_api_definition__full_field_e_ezsigntemplatesignature_type__e field_e_ezsigntemplatesignature_type) {
    char *field_e_ezsigntemplatesignature_typeArray[] =  { "NULL", "Acknowledgement", "Attachments", "City", "Consultation", "Creditcard", "FieldText", "FieldTextarea", "Handwritten", "Initials", "Name", "NameReason", "Signature" };
...
ezmax_api_definition__full_field_e_ezsigntemplatesignature_type__e field_e_ezsigntemplatesignature_type_parseFromJSON(cJSON *field_e_ezsigntemplatesignature_typeJSON) {
    if(!cJSON_IsString(field_e_ezsigntemplatesignature_typeJSON) || (field_e_ezsigntemplatesignature_typeJSON->valuestring == NULL)) {
        return 0;
    }
    return field_e_ezsigntemplatesignature_type_field_e_ezsigntemplatesignature_type_FromString(field_e_ezsigntemplatesignature_typeJSON->valuestring);
}
