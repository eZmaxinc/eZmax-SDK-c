...
static ezmaxpartner_response_t *ezmaxpartner_response_create_internal(
    ...
    ezmaxpartner_response_t *ezmaxpartner_response_local_var = malloc(sizeof(ezmaxpartner_response_t));
    if (!ezmaxpartner_response_local_var) {
        return NULL;
    }
    memset(ezmaxpartner_response_local_var, 0, sizeof(ezmaxpartner_response_t));
    ezmaxpartner_response_local_var->_library_owned = 1;
    ezmaxpartner_response_local_var->e_ezmaxpartner_customdevelopment = e_ezmaxpartner_customdevelopment;
    ezmaxpartner_response_local_var->obj_ezmaxpartner_address = obj_ezmaxpartner_address;
    ezmaxpartner_response_local_var->obj_ezmaxpartner_description = obj_ezmaxpartner_description;
    ezmaxpartner_response_local_var->obj_ezmaxpartner_emailaddress = obj_ezmaxpartner_emailaddress;
    ezmaxpartner_response_local_var->obj_ezmaxpartner_name = obj_ezmaxpartner_name;
    ezmaxpartner_response_local_var->obj_ezmaxpartner_phone_e164 = obj_ezmaxpartner_phone_e164;
    ezmaxpartner_response_local_var->obj_ezmaxpartner_shortdescription = obj_ezmaxpartner_shortdescription;
    ezmaxpartner_response_local_var->obj_ezmaxpartner_url = obj_ezmaxpartner_url;
    ezmaxpartner_response_local_var->b_ezmaxpartner_isactive = b_ezmaxpartner_isactive;
    ezmaxpartner_response_local_var->obj_ezmaxpartner_logourl = obj_ezmaxpartner_logourl;
    return ezmaxpartner_response_local_var;
}
...
__attribute__((deprecated)) ezmaxpartner_response_t *ezmaxpartner_response_create(
    ...
    ezmaxpartner_response_t *result = ezmaxpartner_response_create_internal (
...
void ezmaxpartner_response_free(ezmaxpartner_response_t *ezmaxpartner_response) {
    if(NULL == ezmaxpartner_response){
        return ;
    }
    if(ezmaxpartner_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezmaxpartner_response_free");
        return ;
    }
    listEntry_t *listEntry;
    if (ezmaxpartner_response->obj_ezmaxpartner_address) {
        multilingual_ezmaxpartner_address_free(ezmaxpartner_response->obj_ezmaxpartner_address);
        ezmaxpartner_response->obj_ezmaxpartner_address = NULL;
    }
    if (ezmaxpartner_response->obj_ezmaxpartner_description) {
        multilingual_ezmaxpartner_description_free(ezmaxpartner_response->obj_ezmaxpartner_description);
        ezmaxpartner_response->obj_ezmaxpartner_description = NULL;
    }
    if (ezmaxpartner_response->obj_ezmaxpartner_emailaddress) {
        multilingual_ezmaxpartner_emailaddress_free(ezmaxpartner_response->obj_ezmaxpartner_emailaddress);
        ezmaxpartner_response->obj_ezmaxpartner_emailaddress = NULL;
    }
    if (ezmaxpartner_response->obj_ezmaxpartner_name) {
        multilingual_ezmaxpartner_name_free(ezmaxpartner_response->obj_ezmaxpartner_name);
        ezmaxpartner_response->obj_ezmaxpartner_name = NULL;
    }
    if (ezmaxpartner_response->obj_ezmaxpartner_phone_e164) {
        multilingual_ezmaxpartner_phone_e164_free(ezmaxpartner_response->obj_ezmaxpartner_phone_e164);
        ezmaxpartner_response->obj_ezmaxpartner_phone_e164 = NULL;
    }
    if (ezmaxpartner_response->obj_ezmaxpartner_shortdescription) {
        multilingual_ezmaxpartner_shortdescription_free(ezmaxpartner_response->obj_ezmaxpartner_shortdescription);
        ezmaxpartner_response->obj_ezmaxpartner_shortdescription = NULL;
    }
    if (ezmaxpartner_response->obj_ezmaxpartner_url) {
        multilingual_ezmaxpartner_url_free(ezmaxpartner_response->obj_ezmaxpartner_url);
        ezmaxpartner_response->obj_ezmaxpartner_url = NULL;
    }
    if (ezmaxpartner_response->b_ezmaxpartner_isactive) {
        free(ezmaxpartner_response->b_ezmaxpartner_isactive);
        ezmaxpartner_response->b_ezmaxpartner_isactive = NULL;
    }
    if (ezmaxpartner_response->obj_ezmaxpartner_logourl) {
        multilingual_ezmaxpartner_logourl_free(ezmaxpartner_response->obj_ezmaxpartner_logourl);
        ezmaxpartner_response->obj_ezmaxpartner_logourl = NULL;
    }
    free(ezmaxpartner_response);
}

cJSON *ezmaxpartner_response_convertToJSON(ezmaxpartner_response_t *ezmaxpartner_response) {
    cJSON *item = cJSON_CreateObject();

    // ezmaxpartner_response->e_ezmaxpartner_customdevelopment
    if (ezmax_api_definition__full_field_e_ezmaxpartner_customdevelopment__NULL == ezmaxpartner_response->e_ezmaxpartner_customdevelopment) {
        goto fail;
    }
    cJSON *e_ezmaxpartner_customdevelopment_local_JSON = field_e_ezmaxpartner_customdevelopment_convertToJSON(ezmaxpartner_response->e_ezmaxpartner_customdevelopment);
    ...
    // ezmaxpartner_response->obj_ezmaxpartner_address
    if (!ezmaxpartner_response->obj_ezmaxpartner_address) {
        goto fail;
    }
    cJSON *obj_ezmaxpartner_address_local_JSON = multilingual_ezmaxpartner_address_convertToJSON(ezmaxpartner_response->obj_ezmaxpartner_address);
    ...
    // ezmaxpartner_response->obj_ezmaxpartner_description
    if (!ezmaxpartner_response->obj_ezmaxpartner_description) {
        goto fail;
    }
    cJSON *obj_ezmaxpartner_description_local_JSON = multilingual_ezmaxpartner_description_convertToJSON(ezmaxpartner_response->obj_ezmaxpartner_description);
    ...
    // ezmaxpartner_response->obj_ezmaxpartner_emailaddress
    if (!ezmaxpartner_response->obj_ezmaxpartner_emailaddress) {
        goto fail;
    }
    cJSON *obj_ezmaxpartner_emailaddress_local_JSON = multilingual_ezmaxpartner_emailaddress_convertToJSON(ezmaxpartner_response->obj_ezmaxpartner_emailaddress);
    ...
    // ezmaxpartner_response->obj_ezmaxpartner_name
    if (!ezmaxpartner_response->obj_ezmaxpartner_name) {
        goto fail;
    }
    cJSON *obj_ezmaxpartner_name_local_JSON = multilingual_ezmaxpartner_name_convertToJSON(ezmaxpartner_response->obj_ezmaxpartner_name);
    ...
    // ezmaxpartner_response->obj_ezmaxpartner_phone_e164
    if (!ezmaxpartner_response->obj_ezmaxpartner_phone_e164) {
        goto fail;
    }
    cJSON *obj_ezmaxpartner_phone_e164_local_JSON = multilingual_ezmaxpartner_phone_e164_convertToJSON(ezmaxpartner_response->obj_ezmaxpartner_phone_e164);
    ...
    // ezmaxpartner_response->obj_ezmaxpartner_shortdescription
    if (!ezmaxpartner_response->obj_ezmaxpartner_shortdescription) {
        goto fail;
    }
    cJSON *obj_ezmaxpartner_shortdescription_local_JSON = multilingual_ezmaxpartner_shortdescription_convertToJSON(ezmaxpartner_response->obj_ezmaxpartner_shortdescription);
    ...
    // ezmaxpartner_response->obj_ezmaxpartner_url
    if (!ezmaxpartner_response->obj_ezmaxpartner_url) {
        goto fail;
    }
    cJSON *obj_ezmaxpartner_url_local_JSON = multilingual_ezmaxpartner_url_convertToJSON(ezmaxpartner_response->obj_ezmaxpartner_url);
    ...
    // ezmaxpartner_response->b_ezmaxpartner_isactive
    if(ezmaxpartner_response->b_ezmaxpartner_isactive) {
    if(cJSON_AddBoolToObject(item, "bEzmaxpartnerIsactive", *ezmaxpartner_response->b_ezmaxpartner_isactive) == NULL) {
    goto fail; //Bool
    }
    }


    // ezmaxpartner_response->obj_ezmaxpartner_logourl
    if (!ezmaxpartner_response->obj_ezmaxpartner_logourl) {
        goto fail;
    }
    cJSON *obj_ezmaxpartner_logourl_local_JSON = multilingual_ezmaxpartner_logourl_convertToJSON(ezmaxpartner_response->obj_ezmaxpartner_logourl);
...
ezmaxpartner_response_t *ezmaxpartner_response_parseFromJSON(cJSON *ezmaxpartner_responseJSON){
    ...
    ezmaxpartner_response_t *ezmaxpartner_response_local_var = NULL;

    // define the local variable for ezmaxpartner_response->e_ezmaxpartner_customdevelopment
    ezmax_api_definition__full_field_e_ezmaxpartner_customdevelopment__e e_ezmaxpartner_customdevelopment_local_nonprim = 0;

    // define the local variable for ezmaxpartner_response->obj_ezmaxpartner_address
    multilingual_ezmaxpartner_address_t *obj_ezmaxpartner_address_local_nonprim = NULL;

    // define the local variable for ezmaxpartner_response->obj_ezmaxpartner_description
    multilingual_ezmaxpartner_description_t *obj_ezmaxpartner_description_local_nonprim = NULL;

    // define the local variable for ezmaxpartner_response->obj_ezmaxpartner_emailaddress
    multilingual_ezmaxpartner_emailaddress_t *obj_ezmaxpartner_emailaddress_local_nonprim = NULL;

    // define the local variable for ezmaxpartner_response->obj_ezmaxpartner_name
    multilingual_ezmaxpartner_name_t *obj_ezmaxpartner_name_local_nonprim = NULL;

    // define the local variable for ezmaxpartner_response->obj_ezmaxpartner_phone_e164
    multilingual_ezmaxpartner_phone_e164_t *obj_ezmaxpartner_phone_e164_local_nonprim = NULL;

    // define the local variable for ezmaxpartner_response->obj_ezmaxpartner_shortdescription
    multilingual_ezmaxpartner_shortdescription_t *obj_ezmaxpartner_shortdescription_local_nonprim = NULL;

    // define the local variable for ezmaxpartner_response->obj_ezmaxpartner_url
    multilingual_ezmaxpartner_url_t *obj_ezmaxpartner_url_local_nonprim = NULL;

    // define the local variable for ezmaxpartner_response->b_ezmaxpartner_isactive
    int *b_ezmaxpartner_isactive_local_var = NULL;

    // define the local variable for ezmaxpartner_response->obj_ezmaxpartner_logourl
    multilingual_ezmaxpartner_logourl_t *obj_ezmaxpartner_logourl_local_nonprim = NULL;

    // ezmaxpartner_response->e_ezmaxpartner_customdevelopment
    cJSON *e_ezmaxpartner_customdevelopment = cJSON_GetObjectItemCaseSensitive(ezmaxpartner_responseJSON, "eEzmaxpartnerCustomdevelopment");
    ...
    // ezmaxpartner_response->obj_ezmaxpartner_address
    cJSON *obj_ezmaxpartner_address = cJSON_GetObjectItemCaseSensitive(ezmaxpartner_responseJSON, "objEzmaxpartnerAddress");
    ...
    // ezmaxpartner_response->obj_ezmaxpartner_description
    cJSON *obj_ezmaxpartner_description = cJSON_GetObjectItemCaseSensitive(ezmaxpartner_responseJSON, "objEzmaxpartnerDescription");
    ...
    // ezmaxpartner_response->obj_ezmaxpartner_emailaddress
    cJSON *obj_ezmaxpartner_emailaddress = cJSON_GetObjectItemCaseSensitive(ezmaxpartner_responseJSON, "objEzmaxpartnerEmailaddress");
    ...
    // ezmaxpartner_response->obj_ezmaxpartner_name
    cJSON *obj_ezmaxpartner_name = cJSON_GetObjectItemCaseSensitive(ezmaxpartner_responseJSON, "objEzmaxpartnerName");
    ...
    // ezmaxpartner_response->obj_ezmaxpartner_phone_e164
    cJSON *obj_ezmaxpartner_phone_e164 = cJSON_GetObjectItemCaseSensitive(ezmaxpartner_responseJSON, "objEzmaxpartnerPhoneE164");
    ...
    // ezmaxpartner_response->obj_ezmaxpartner_shortdescription
    cJSON *obj_ezmaxpartner_shortdescription = cJSON_GetObjectItemCaseSensitive(ezmaxpartner_responseJSON, "objEzmaxpartnerShortdescription");
    ...
    // ezmaxpartner_response->obj_ezmaxpartner_url
    cJSON *obj_ezmaxpartner_url = cJSON_GetObjectItemCaseSensitive(ezmaxpartner_responseJSON, "objEzmaxpartnerUrl");
    ...
    // ezmaxpartner_response->b_ezmaxpartner_isactive
    cJSON *b_ezmaxpartner_isactive = cJSON_GetObjectItemCaseSensitive(ezmaxpartner_responseJSON, "bEzmaxpartnerIsactive");
    ...
    *b_ezmaxpartner_isactive_local_var = b_ezmaxpartner_isactive->valueint;
    ...
    // ezmaxpartner_response->obj_ezmaxpartner_logourl
    cJSON *obj_ezmaxpartner_logourl = cJSON_GetObjectItemCaseSensitive(ezmaxpartner_responseJSON, "objEzmaxpartnerLogourl");
    ...
    ezmaxpartner_response_local_var = ezmaxpartner_response_create_internal (
