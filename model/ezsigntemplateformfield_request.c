...
static ezsigntemplateformfield_request_t *ezsigntemplateformfield_request_create_internal(
    ...
    memset(ezsigntemplateformfield_request_local_var, 0, sizeof(ezsigntemplateformfield_request_t));
...
__attribute__((deprecated)) ezsigntemplateformfield_request_t *ezsigntemplateformfield_request_create(
    ...
    ezsigntemplateformfield_request_t *result = ezsigntemplateformfield_request_create_internal (
...
void ezsigntemplateformfield_request_free(ezsigntemplateformfield_request_t *ezsigntemplateformfield_request) {
    ...
    if (ezsigntemplateformfield_request->pki_ezsigntemplateformfield_id) {
        free(ezsigntemplateformfield_request->pki_ezsigntemplateformfield_id);
        ezsigntemplateformfield_request->pki_ezsigntemplateformfield_id = NULL;
    }
    if (ezsigntemplateformfield_request->i_ezsigntemplatedocumentpage_pagenumber) {
        free(ezsigntemplateformfield_request->i_ezsigntemplatedocumentpage_pagenumber);
        ezsigntemplateformfield_request->i_ezsigntemplatedocumentpage_pagenumber = NULL;
    }
    ...
    if (ezsigntemplateformfield_request->i_ezsigntemplateformfield_x) {
        free(ezsigntemplateformfield_request->i_ezsigntemplateformfield_x);
        ezsigntemplateformfield_request->i_ezsigntemplateformfield_x = NULL;
    }
    if (ezsigntemplateformfield_request->i_ezsigntemplateformfield_y) {
        free(ezsigntemplateformfield_request->i_ezsigntemplateformfield_y);
        ezsigntemplateformfield_request->i_ezsigntemplateformfield_y = NULL;
    }
    if (ezsigntemplateformfield_request->i_ezsigntemplateformfield_width) {
        free(ezsigntemplateformfield_request->i_ezsigntemplateformfield_width);
        ezsigntemplateformfield_request->i_ezsigntemplateformfield_width = NULL;
    }
    if (ezsigntemplateformfield_request->i_ezsigntemplateformfield_height) {
        free(ezsigntemplateformfield_request->i_ezsigntemplateformfield_height);
        ezsigntemplateformfield_request->i_ezsigntemplateformfield_height = NULL;
    }
    if (ezsigntemplateformfield_request->b_ezsigntemplateformfield_autocomplete) {
        free(ezsigntemplateformfield_request->b_ezsigntemplateformfield_autocomplete);
        ezsigntemplateformfield_request->b_ezsigntemplateformfield_autocomplete = NULL;
    }
    if (ezsigntemplateformfield_request->b_ezsigntemplateformfield_selected) {
        free(ezsigntemplateformfield_request->b_ezsigntemplateformfield_selected);
        ezsigntemplateformfield_request->b_ezsigntemplateformfield_selected = NULL;
    }
    ...
    if (ezsigntemplateformfield_request->i_ezsigntemplateformfield_positioningoffsetx) {
        free(ezsigntemplateformfield_request->i_ezsigntemplateformfield_positioningoffsetx);
        ezsigntemplateformfield_request->i_ezsigntemplateformfield_positioningoffsetx = NULL;
    }
    if (ezsigntemplateformfield_request->i_ezsigntemplateformfield_positioningoffsety) {
        free(ezsigntemplateformfield_request->i_ezsigntemplateformfield_positioningoffsety);
        ezsigntemplateformfield_request->i_ezsigntemplateformfield_positioningoffsety = NULL;
    }
...
ezsigntemplateformfield_request_t *ezsigntemplateformfield_request_parseFromJSON(cJSON *ezsigntemplateformfield_requestJSON){
    ...
    // define the local variable for ezsigntemplateformfield_request->pki_ezsigntemplateformfield_id
    ...
    // define the local variable for ezsigntemplateformfield_request->i_ezsigntemplatedocumentpage_pagenumber
    ...
    // define the local variable for ezsigntemplateformfield_request->i_ezsigntemplateformfield_x
    int *i_ezsigntemplateformfield_x_local_var = NULL;

    // define the local variable for ezsigntemplateformfield_request->i_ezsigntemplateformfield_y
    int *i_ezsigntemplateformfield_y_local_var = NULL;

    // define the local variable for ezsigntemplateformfield_request->i_ezsigntemplateformfield_width
    int *i_ezsigntemplateformfield_width_local_var = NULL;

    // define the local variable for ezsigntemplateformfield_request->i_ezsigntemplateformfield_height
    int *i_ezsigntemplateformfield_height_local_var = NULL;

    // define the local variable for ezsigntemplateformfield_request->b_ezsigntemplateformfield_autocomplete
    int *b_ezsigntemplateformfield_autocomplete_local_var = NULL;

    // define the local variable for ezsigntemplateformfield_request->b_ezsigntemplateformfield_selected
    ...
    // define the local variable for ezsigntemplateformfield_request->i_ezsigntemplateformfield_positioningoffsetx
    int *i_ezsigntemplateformfield_positioningoffsetx_local_var = NULL;

    // define the local variable for ezsigntemplateformfield_request->i_ezsigntemplateformfield_positioningoffsety
