/*
 * ezsignsignature_create_object_v3_response_m_payload.h
 *
 * Payload for POST /3/object/ezsignsignature
 */

#ifndef _ezsignsignature_create_object_v3_response_m_payload_H_
#define _ezsignsignature_create_object_v3_response_m_payload_H_
...
typedef struct ezsignsignature_create_object_v3_response_m_payload_t ezsignsignature_create_object_v3_response_m_payload_t;




typedef struct ezsignsignature_create_object_v3_response_m_payload_t {
    list_t *a_pki_ezsignsignature_id; //primitive container

} ezsignsignature_create_object_v3_response_m_payload_t;

ezsignsignature_create_object_v3_response_m_payload_t *ezsignsignature_create_object_v3_response_m_payload_create(
...
#endif /* _ezsignsignature_create_object_v3_response_m_payload_H_ */
