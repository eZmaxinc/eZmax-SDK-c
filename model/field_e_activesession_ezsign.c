...
cJSON *field_e_activesession_ezsign_convertToJSON(ezmax_api_definition__full_field_e_activesession_ezsign__e field_e_activesession_ezsign) {
...
ezmax_api_definition__full_field_e_activesession_ezsign__e field_e_activesession_ezsign_parseFromJSON(cJSON *field_e_activesession_ezsignJSON) {
    if(!cJSON_IsString(field_e_activesession_ezsignJSON) || (field_e_activesession_ezsignJSON->valuestring == NULL)) {
        return 0;
    }
    return field_e_activesession_ezsign_field_e_activesession_ezsign_FromString(field_e_activesession_ezsignJSON->valuestring);
}
