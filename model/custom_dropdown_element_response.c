...
static custom_dropdown_element_response_t *custom_dropdown_element_response_create_internal(
    ...
    memset(custom_dropdown_element_response_local_var, 0, sizeof(custom_dropdown_element_response_t));
...
__attribute__((deprecated)) custom_dropdown_element_response_t *custom_dropdown_element_response_create(
    ...
    custom_dropdown_element_response_t *result = custom_dropdown_element_response_create_internal (
        s_label,
        s_value
        );
    if (!result) {
