...
static ezsignpage_consult_v1_response_t *ezsignpage_consult_v1_response_create_internal(
    ...
    memset(ezsignpage_consult_v1_response_local_var, 0, sizeof(ezsignpage_consult_v1_response_t));
    ezsignpage_consult_v1_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezsignpage_consult_v1_response_t *ezsignpage_consult_v1_response_create(
    common_response_obj_debug_payload_t *obj_debug_payload,
    common_response_obj_debug_t *obj_debug
    ) {
    ezsignpage_consult_v1_response_t *result = ezsignpage_consult_v1_response_create_internal (
        obj_debug_payload,
        obj_debug
        );
    if (!result) {
...
void ezsignpage_consult_v1_response_free(ezsignpage_consult_v1_response_t *ezsignpage_consult_v1_response) {
    ...
    if(ezsignpage_consult_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsignpage_consult_v1_response_free");
        return ;
    }
...
ezsignpage_consult_v1_response_t *ezsignpage_consult_v1_response_parseFromJSON(cJSON *ezsignpage_consult_v1_responseJSON){
    ...
    ezsignpage_consult_v1_response_local_var = ezsignpage_consult_v1_response_create_internal (
