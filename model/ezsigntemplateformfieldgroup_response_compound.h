...
typedef enum  { ezmax_api_definition__full_ezsigntemplateformfieldgroup_response_compound__NULL = 0, ezmax_api_definition__full_ezsigntemplateformfieldgroup_response_compound__None, ezmax_api_definition__full_ezsigntemplateformfieldgroup_response_compound__Date (YYYY_MM_DD), ezmax_api_definition__full_ezsigntemplateformfieldgroup_response_compound__Date (MM/DD/YYYY), ezmax_api_definition__full_ezsigntemplateformfieldgroup_response_compound__Date (MM/DD/YY), ezmax_api_definition__full_ezsigntemplateformfieldgroup_response_compound__Date (DD/MM/YYYY), ezmax_api_definition__full_ezsigntemplateformfieldgroup_response_compound__Date (DD/MM/YY), ezmax_api_definition__full_ezsigntemplateformfieldgroup_response_compound__Email, ezmax_api_definition__full_ezsigntemplateformfieldgroup_response_compound__Letters, ezmax_api_definition__full_ezsigntemplateformfieldgroup_response_compound__Numbers, ezmax_api_definition__full_ezsigntemplateformfieldgroup_response_compound__Zip, ezmax_api_definition__full_ezsigntemplateformfieldgroup_response_compound__Zip+4, ezmax_api_definition__full_ezsigntemplateformfieldgroup_response_compound__PostalCode, ezmax_api_definition__full_ezsigntemplateformfieldgroup_response_compound__Custom } ezmax_api_definition__full_ezsigntemplateformfieldgroup_response_compound__e;
