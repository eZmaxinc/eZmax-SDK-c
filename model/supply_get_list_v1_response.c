...
static supply_get_list_v1_response_t *supply_get_list_v1_response_create_internal(
    ...
    memset(supply_get_list_v1_response_local_var, 0, sizeof(supply_get_list_v1_response_t));
...
__attribute__((deprecated)) supply_get_list_v1_response_t *supply_get_list_v1_response_create(
    ...
    supply_get_list_v1_response_t *result = supply_get_list_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
