...
static ezsignfoldertype_response_v4_t *ezsignfoldertype_response_v4_create_internal(
    ...
    memset(ezsignfoldertype_response_v4_local_var, 0, sizeof(ezsignfoldertype_response_v4_t));
    ezsignfoldertype_response_v4_local_var->_library_owned = 1;
    ...
    ezsignfoldertype_response_v4_local_var->e_ezsignfoldertype_signaturedatedisplay = e_ezsignfoldertype_signaturedatedisplay;
    ezsignfoldertype_response_v4_local_var->s_ezsignfoldertype_signaturedatecustomformat = s_ezsignfoldertype_signaturedatecustomformat;
    ...
    ezsignfoldertype_response_v4_local_var->e_ezsignfoldertype_documentmerge = e_ezsignfoldertype_documentmerge;
    ...
    ezsignfoldertype_response_v4_local_var->b_ezsignfoldertype_senddocumentmergetoemail = b_ezsignfoldertype_senddocumentmergetoemail;
    ezsignfoldertype_response_v4_local_var->b_ezsignfoldertype_senddocumentmergetoezsignsigner = b_ezsignfoldertype_senddocumentmergetoezsignsigner;
    ezsignfoldertype_response_v4_local_var->b_ezsignfoldertype_senddocumentmergetoreceivealldocument = b_ezsignfoldertype_senddocumentmergetoreceivealldocument;
    ezsignfoldertype_response_v4_local_var->b_ezsignfoldertype_senddocumentmergetouser = b_ezsignfoldertype_senddocumentmergetouser;
    ...
    ezsignfoldertype_response_v4_local_var->b_ezsignfoldertype_sendsignatureattachmentezsignsigner = b_ezsignfoldertype_sendsignatureattachmentezsignsigner;
    ezsignfoldertype_response_v4_local_var->b_ezsignfoldertype_sendsignatureattachment = b_ezsignfoldertype_sendsignatureattachment;
    ...
    ezsignfoldertype_response_v4_local_var->b_ezsignfoldertype_sendsignatureattachmentuser = b_ezsignfoldertype_sendsignatureattachmentuser;
    ...
    ezsignfoldertype_response_v4_local_var->b_ezsignfoldertype_allowdownloadsignatureattachmentezsignsigner = b_ezsignfoldertype_allowdownloadsignatureattachmentezsignsigner;
    ...
    ezsignfoldertype_response_v4_local_var->b_ezsignfoldertype_sendsignatureattachmentreceivealldocument = b_ezsignfoldertype_sendsignatureattachmentreceivealldocument;
...
__attribute__((deprecated)) ezsignfoldertype_response_v4_t *ezsignfoldertype_response_v4_create(
    ...
    ezsignfoldertype_response_v4_t *result = ezsignfoldertype_response_v4_create_internal (
...
void ezsignfoldertype_response_v4_free(ezsignfoldertype_response_v4_t *ezsignfoldertype_response_v4) {
    ...
    if(ezsignfoldertype_response_v4->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsignfoldertype_response_v4_free");
        return ;
    }
    listEntry_t *listEntry;
    if (ezsignfoldertype_response_v4->pki_ezsignfoldertype_id) {
        free(ezsignfoldertype_response_v4->pki_ezsignfoldertype_id);
        ezsignfoldertype_response_v4->pki_ezsignfoldertype_id = NULL;
    }
    ...
    if (ezsignfoldertype_response_v4->fki_branding_id) {
        free(ezsignfoldertype_response_v4->fki_branding_id);
        ezsignfoldertype_response_v4->fki_branding_id = NULL;
    }
    if (ezsignfoldertype_response_v4->fki_billingentityinternal_id) {
        free(ezsignfoldertype_response_v4->fki_billingentityinternal_id);
        ezsignfoldertype_response_v4->fki_billingentityinternal_id = NULL;
    }
    if (ezsignfoldertype_response_v4->fki_ezsigntsarequirement_id) {
        free(ezsignfoldertype_response_v4->fki_ezsigntsarequirement_id);
        ezsignfoldertype_response_v4->fki_ezsigntsarequirement_id = NULL;
    }
    if (ezsignfoldertype_response_v4->fki_font_id_annotation) {
        free(ezsignfoldertype_response_v4->fki_font_id_annotation);
        ezsignfoldertype_response_v4->fki_font_id_annotation = NULL;
    }
    if (ezsignfoldertype_response_v4->fki_font_id_formfield) {
        free(ezsignfoldertype_response_v4->fki_font_id_formfield);
        ezsignfoldertype_response_v4->fki_font_id_formfield = NULL;
    }
    if (ezsignfoldertype_response_v4->fki_font_id_signature) {
        free(ezsignfoldertype_response_v4->fki_font_id_signature);
        ezsignfoldertype_response_v4->fki_font_id_signature = NULL;
    }
    if (ezsignfoldertype_response_v4->fki_pdfalevel_id_convert) {
        free(ezsignfoldertype_response_v4->fki_pdfalevel_id_convert);
        ezsignfoldertype_response_v4->fki_pdfalevel_id_convert = NULL;
    }
    if (ezsignfoldertype_response_v4->s_ezsignfoldertype_signaturedatecustomformat) {
        free(ezsignfoldertype_response_v4->s_ezsignfoldertype_signaturedatecustomformat);
        ezsignfoldertype_response_v4->s_ezsignfoldertype_signaturedatecustomformat = NULL;
    }
    ...
    if (ezsignfoldertype_response_v4->i_ezsignfoldertype_fontsizeannotation) {
        free(ezsignfoldertype_response_v4->i_ezsignfoldertype_fontsizeannotation);
        ezsignfoldertype_response_v4->i_ezsignfoldertype_fontsizeannotation = NULL;
    }
    if (ezsignfoldertype_response_v4->i_ezsignfoldertype_fontsizeformfield) {
        free(ezsignfoldertype_response_v4->i_ezsignfoldertype_fontsizeformfield);
        ezsignfoldertype_response_v4->i_ezsignfoldertype_fontsizeformfield = NULL;
    }
    if (ezsignfoldertype_response_v4->i_ezsignfoldertype_sendreminderfirstdays) {
        free(ezsignfoldertype_response_v4->i_ezsignfoldertype_sendreminderfirstdays);
        ezsignfoldertype_response_v4->i_ezsignfoldertype_sendreminderfirstdays = NULL;
    }
    if (ezsignfoldertype_response_v4->i_ezsignfoldertype_sendreminderotherdays) {
        free(ezsignfoldertype_response_v4->i_ezsignfoldertype_sendreminderotherdays);
        ezsignfoldertype_response_v4->i_ezsignfoldertype_sendreminderotherdays = NULL;
    }
    if (ezsignfoldertype_response_v4->i_ezsignfoldertype_archivaldays) {
        free(ezsignfoldertype_response_v4->i_ezsignfoldertype_archivaldays);
        ezsignfoldertype_response_v4->i_ezsignfoldertype_archivaldays = NULL;
    }
    if (ezsignfoldertype_response_v4->i_ezsignfoldertype_disposaldays) {
        free(ezsignfoldertype_response_v4->i_ezsignfoldertype_disposaldays);
        ezsignfoldertype_response_v4->i_ezsignfoldertype_disposaldays = NULL;
    }
    if (ezsignfoldertype_response_v4->i_ezsignfoldertype_deadlinedays) {
        free(ezsignfoldertype_response_v4->i_ezsignfoldertype_deadlinedays);
        ezsignfoldertype_response_v4->i_ezsignfoldertype_deadlinedays = NULL;
    }
    if (ezsignfoldertype_response_v4->b_ezsignfoldertype_prematurelyendautomatically) {
        free(ezsignfoldertype_response_v4->b_ezsignfoldertype_prematurelyendautomatically);
        ezsignfoldertype_response_v4->b_ezsignfoldertype_prematurelyendautomatically = NULL;
    }
    if (ezsignfoldertype_response_v4->i_ezsignfoldertype_prematurelyendautomaticallydays) {
        free(ezsignfoldertype_response_v4->i_ezsignfoldertype_prematurelyendautomaticallydays);
        ezsignfoldertype_response_v4->i_ezsignfoldertype_prematurelyendautomaticallydays = NULL;
    }
    if (ezsignfoldertype_response_v4->b_ezsignfoldertype_automaticsignature) {
        free(ezsignfoldertype_response_v4->b_ezsignfoldertype_automaticsignature);
        ezsignfoldertype_response_v4->b_ezsignfoldertype_automaticsignature = NULL;
    }
    if (ezsignfoldertype_response_v4->b_ezsignfoldertype_delegate) {
        free(ezsignfoldertype_response_v4->b_ezsignfoldertype_delegate);
        ezsignfoldertype_response_v4->b_ezsignfoldertype_delegate = NULL;
    }
    if (ezsignfoldertype_response_v4->b_ezsignfoldertype_discussion) {
        free(ezsignfoldertype_response_v4->b_ezsignfoldertype_discussion);
        ezsignfoldertype_response_v4->b_ezsignfoldertype_discussion = NULL;
    }
    if (ezsignfoldertype_response_v4->b_ezsignfoldertype_logrecipientinproof) {
        free(ezsignfoldertype_response_v4->b_ezsignfoldertype_logrecipientinproof);
        ezsignfoldertype_response_v4->b_ezsignfoldertype_logrecipientinproof = NULL;
    }
    if (ezsignfoldertype_response_v4->b_ezsignfoldertype_reassignezsignsigner) {
        free(ezsignfoldertype_response_v4->b_ezsignfoldertype_reassignezsignsigner);
        ezsignfoldertype_response_v4->b_ezsignfoldertype_reassignezsignsigner = NULL;
    }
    if (ezsignfoldertype_response_v4->b_ezsignfoldertype_reassignuser) {
        free(ezsignfoldertype_response_v4->b_ezsignfoldertype_reassignuser);
        ezsignfoldertype_response_v4->b_ezsignfoldertype_reassignuser = NULL;
    }
    if (ezsignfoldertype_response_v4->b_ezsignfoldertype_reassigngroup) {
        free(ezsignfoldertype_response_v4->b_ezsignfoldertype_reassigngroup);
        ezsignfoldertype_response_v4->b_ezsignfoldertype_reassigngroup = NULL;
    }
    if (ezsignfoldertype_response_v4->b_ezsignfoldertype_senddocumentmergetoemail) {
        free(ezsignfoldertype_response_v4->b_ezsignfoldertype_senddocumentmergetoemail);
        ezsignfoldertype_response_v4->b_ezsignfoldertype_senddocumentmergetoemail = NULL;
    }
    if (ezsignfoldertype_response_v4->b_ezsignfoldertype_senddocumentmergetoezsignsigner) {
        free(ezsignfoldertype_response_v4->b_ezsignfoldertype_senddocumentmergetoezsignsigner);
        ezsignfoldertype_response_v4->b_ezsignfoldertype_senddocumentmergetoezsignsigner = NULL;
    }
    if (ezsignfoldertype_response_v4->b_ezsignfoldertype_senddocumentmergetoreceivealldocument) {
        free(ezsignfoldertype_response_v4->b_ezsignfoldertype_senddocumentmergetoreceivealldocument);
        ezsignfoldertype_response_v4->b_ezsignfoldertype_senddocumentmergetoreceivealldocument = NULL;
    }
    if (ezsignfoldertype_response_v4->b_ezsignfoldertype_senddocumentmergetouser) {
        free(ezsignfoldertype_response_v4->b_ezsignfoldertype_senddocumentmergetouser);
        ezsignfoldertype_response_v4->b_ezsignfoldertype_senddocumentmergetouser = NULL;
    }
    if (ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignedtoezsignsigner) {
        free(ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignedtoezsignsigner);
        ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignedtoezsignsigner = NULL;
    }
    if (ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignedtouser) {
        free(ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignedtouser);
        ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignedtouser = NULL;
    }
    if (ezsignfoldertype_response_v4->b_ezsignfoldertype_sendattachmentezsignsigner) {
        free(ezsignfoldertype_response_v4->b_ezsignfoldertype_sendattachmentezsignsigner);
        ezsignfoldertype_response_v4->b_ezsignfoldertype_sendattachmentezsignsigner = NULL;
    }
    if (ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignatureattachmentezsignsigner) {
        free(ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignatureattachmentezsignsigner);
        ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignatureattachmentezsignsigner = NULL;
    }
    if (ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignatureattachment) {
        free(ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignatureattachment);
        ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignatureattachment = NULL;
    }
    if (ezsignfoldertype_response_v4->b_ezsignfoldertype_sendproofezsignsigner) {
        free(ezsignfoldertype_response_v4->b_ezsignfoldertype_sendproofezsignsigner);
        ezsignfoldertype_response_v4->b_ezsignfoldertype_sendproofezsignsigner = NULL;
    }
    if (ezsignfoldertype_response_v4->b_ezsignfoldertype_sendattachmentuser) {
        free(ezsignfoldertype_response_v4->b_ezsignfoldertype_sendattachmentuser);
        ezsignfoldertype_response_v4->b_ezsignfoldertype_sendattachmentuser = NULL;
    }
    if (ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignatureattachmentuser) {
        free(ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignatureattachmentuser);
        ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignatureattachmentuser = NULL;
    }
    if (ezsignfoldertype_response_v4->b_ezsignfoldertype_sendproofuser) {
        free(ezsignfoldertype_response_v4->b_ezsignfoldertype_sendproofuser);
        ezsignfoldertype_response_v4->b_ezsignfoldertype_sendproofuser = NULL;
    }
    if (ezsignfoldertype_response_v4->b_ezsignfoldertype_sendproofemail) {
        free(ezsignfoldertype_response_v4->b_ezsignfoldertype_sendproofemail);
        ezsignfoldertype_response_v4->b_ezsignfoldertype_sendproofemail = NULL;
    }
    if (ezsignfoldertype_response_v4->b_ezsignfoldertype_allowdownloadattachmentezsignsigner) {
        free(ezsignfoldertype_response_v4->b_ezsignfoldertype_allowdownloadattachmentezsignsigner);
        ezsignfoldertype_response_v4->b_ezsignfoldertype_allowdownloadattachmentezsignsigner = NULL;
    }
    if (ezsignfoldertype_response_v4->b_ezsignfoldertype_allowdownloadsignatureattachmentezsignsigner) {
        free(ezsignfoldertype_response_v4->b_ezsignfoldertype_allowdownloadsignatureattachmentezsignsigner);
        ezsignfoldertype_response_v4->b_ezsignfoldertype_allowdownloadsignatureattachmentezsignsigner = NULL;
    }
    if (ezsignfoldertype_response_v4->b_ezsignfoldertype_allowdownloadproofezsignsigner) {
        free(ezsignfoldertype_response_v4->b_ezsignfoldertype_allowdownloadproofezsignsigner);
        ezsignfoldertype_response_v4->b_ezsignfoldertype_allowdownloadproofezsignsigner = NULL;
    }
    if (ezsignfoldertype_response_v4->b_ezsignfoldertype_sendproofreceivealldocument) {
        free(ezsignfoldertype_response_v4->b_ezsignfoldertype_sendproofreceivealldocument);
        ezsignfoldertype_response_v4->b_ezsignfoldertype_sendproofreceivealldocument = NULL;
    }
    if (ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignatureattachmentreceivealldocument) {
        free(ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignatureattachmentreceivealldocument);
        ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignatureattachmentreceivealldocument = NULL;
    }
    if (ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignedtodocumentowner) {
        free(ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignedtodocumentowner);
        ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignedtodocumentowner = NULL;
    }
    if (ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignedtofolderowner) {
        free(ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignedtofolderowner);
        ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignedtofolderowner = NULL;
    }
    if (ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignedtofullgroup) {
        free(ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignedtofullgroup);
        ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignedtofullgroup = NULL;
    }
    if (ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignedtolimitedgroup) {
        free(ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignedtolimitedgroup);
        ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignedtolimitedgroup = NULL;
    }
    if (ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignedtocolleague) {
        free(ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignedtocolleague);
        ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignedtocolleague = NULL;
    }
    if (ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsummarytodocumentowner) {
        free(ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsummarytodocumentowner);
        ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsummarytodocumentowner = NULL;
    }
    if (ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsummarytofolderowner) {
        free(ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsummarytofolderowner);
        ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsummarytofolderowner = NULL;
    }
    if (ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsummarytofullgroup) {
        free(ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsummarytofullgroup);
        ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsummarytofullgroup = NULL;
    }
    if (ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsummarytolimitedgroup) {
        free(ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsummarytolimitedgroup);
        ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsummarytolimitedgroup = NULL;
    }
    if (ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsummarytocolleague) {
        free(ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsummarytocolleague);
        ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsummarytocolleague = NULL;
    }
    if (ezsignfoldertype_response_v4->b_ezsignfoldertype_isactive) {
        free(ezsignfoldertype_response_v4->b_ezsignfoldertype_isactive);
        ezsignfoldertype_response_v4->b_ezsignfoldertype_isactive = NULL;
    }
...
cJSON *ezsignfoldertype_response_v4_convertToJSON(ezsignfoldertype_response_v4_t *ezsignfoldertype_response_v4) {
    ...
    // ezsignfoldertype_response_v4->e_ezsignfoldertype_signaturedatedisplay
    if (ezmax_api_definition__full_field_e_ezsignfoldertype_signaturedatedisplay__NULL == ezsignfoldertype_response_v4->e_ezsignfoldertype_signaturedatedisplay) {
        goto fail;
    }
    cJSON *e_ezsignfoldertype_signaturedatedisplay_local_JSON = field_e_ezsignfoldertype_signaturedatedisplay_convertToJSON(ezsignfoldertype_response_v4->e_ezsignfoldertype_signaturedatedisplay);
    ...
    // ezsignfoldertype_response_v4->s_ezsignfoldertype_signaturedatecustomformat
    if(ezsignfoldertype_response_v4->s_ezsignfoldertype_signaturedatecustomformat) {
    if(cJSON_AddStringToObject(item, "sEzsignfoldertypeSignaturedatecustomformat", ezsignfoldertype_response_v4->s_ezsignfoldertype_signaturedatecustomformat) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(ezsignfoldertype_response_v4->e_ezsignfoldertype_documentdependency != ezmax_api_definition__full_field_e_ezsignfoldertype_documentdependency__NULL) {
    ...
    if(ezsignfoldertype_response_v4->e_ezsignfoldertype_pdfarequirement != ezmax_api_definition__full_field_e_ezsignfoldertype_pdfarequirement__NULL) {
    ...
    if(ezsignfoldertype_response_v4->e_ezsignfoldertype_pdfanoncompliantaction != ezmax_api_definition__full_field_e_ezsignfoldertype_pdfanoncompliantaction__NULL) {
    ...
    if (ezmax_api_definition__full_field_e_ezsignfoldertype_privacylevel__NULL == ezsignfoldertype_response_v4->e_ezsignfoldertype_privacylevel) {
        goto fail;
    }
    ...
    // ezsignfoldertype_response_v4->e_ezsignfoldertype_documentmerge
    if(ezsignfoldertype_response_v4->e_ezsignfoldertype_documentmerge != ezmax_api_definition__full_field_e_ezsignfoldertype_documentmerge__NULL) {
    cJSON *e_ezsignfoldertype_documentmerge_local_JSON = field_e_ezsignfoldertype_documentmerge_convertToJSON(ezsignfoldertype_response_v4->e_ezsignfoldertype_documentmerge);
    ...
    if (ezmax_api_definition__full_field_e_ezsignfoldertype_disposal__NULL == ezsignfoldertype_response_v4->e_ezsignfoldertype_disposal) {
        goto fail;
    }
    ...
    if (ezmax_api_definition__full_field_e_ezsignfoldertype_completion__NULL == ezsignfoldertype_response_v4->e_ezsignfoldertype_completion) {
        goto fail;
    }
    ...
    // ezsignfoldertype_response_v4->b_ezsignfoldertype_senddocumentmergetoemail
    if(ezsignfoldertype_response_v4->b_ezsignfoldertype_senddocumentmergetoemail) {
    if(cJSON_AddBoolToObject(item, "bEzsignfoldertypeSenddocumentmergetoemail", *ezsignfoldertype_response_v4->b_ezsignfoldertype_senddocumentmergetoemail) == NULL) {
    goto fail; //Bool
    }
    }


    // ezsignfoldertype_response_v4->b_ezsignfoldertype_senddocumentmergetoezsignsigner
    if(ezsignfoldertype_response_v4->b_ezsignfoldertype_senddocumentmergetoezsignsigner) {
    if(cJSON_AddBoolToObject(item, "bEzsignfoldertypeSenddocumentmergetoezsignsigner", *ezsignfoldertype_response_v4->b_ezsignfoldertype_senddocumentmergetoezsignsigner) == NULL) {
    goto fail; //Bool
    }
    }


    // ezsignfoldertype_response_v4->b_ezsignfoldertype_senddocumentmergetoreceivealldocument
    if(ezsignfoldertype_response_v4->b_ezsignfoldertype_senddocumentmergetoreceivealldocument) {
    if(cJSON_AddBoolToObject(item, "bEzsignfoldertypeSenddocumentmergetoreceivealldocument", *ezsignfoldertype_response_v4->b_ezsignfoldertype_senddocumentmergetoreceivealldocument) == NULL) {
    goto fail; //Bool
    }
    }


    // ezsignfoldertype_response_v4->b_ezsignfoldertype_senddocumentmergetouser
    if(ezsignfoldertype_response_v4->b_ezsignfoldertype_senddocumentmergetouser) {
    if(cJSON_AddBoolToObject(item, "bEzsignfoldertypeSenddocumentmergetouser", *ezsignfoldertype_response_v4->b_ezsignfoldertype_senddocumentmergetouser) == NULL) {
    goto fail; //Bool
    }
    }
    ...
    // ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignatureattachmentezsignsigner
    if(ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignatureattachmentezsignsigner) {
    if(cJSON_AddBoolToObject(item, "bEzsignfoldertypeSendsignatureattachmentezsignsigner", *ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignatureattachmentezsignsigner) == NULL) {
    goto fail; //Bool
    }
    }


    // ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignatureattachment
    if(ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignatureattachment) {
    if(cJSON_AddBoolToObject(item, "bEzsignfoldertypeSendsignatureattachment", *ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignatureattachment) == NULL) {
    goto fail; //Bool
    }
    }
    ...
    // ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignatureattachmentuser
    if(ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignatureattachmentuser) {
    if(cJSON_AddBoolToObject(item, "bEzsignfoldertypeSendsignatureattachmentuser", *ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignatureattachmentuser) == NULL) {
    goto fail; //Bool
    }
    }
    ...
    // ezsignfoldertype_response_v4->b_ezsignfoldertype_allowdownloadsignatureattachmentezsignsigner
    if(ezsignfoldertype_response_v4->b_ezsignfoldertype_allowdownloadsignatureattachmentezsignsigner) {
    if(cJSON_AddBoolToObject(item, "bEzsignfoldertypeAllowdownloadsignatureattachmentezsignsigner", *ezsignfoldertype_response_v4->b_ezsignfoldertype_allowdownloadsignatureattachmentezsignsigner) == NULL) {
    goto fail; //Bool
    }
    }
    ...
    // ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignatureattachmentreceivealldocument
    if(ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignatureattachmentreceivealldocument) {
    if(cJSON_AddBoolToObject(item, "bEzsignfoldertypeSendsignatureattachmentreceivealldocument", *ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignatureattachmentreceivealldocument) == NULL) {
    goto fail; //Bool
    }
    }
    ...
    if(ezsignfoldertype_response_v4->e_ezsignfoldertype_signeraccess != ezmax_api_definition__full_field_e_ezsignfoldertype_signeraccess__NULL) {
...
ezsignfoldertype_response_v4_t *ezsignfoldertype_response_v4_parseFromJSON(cJSON *ezsignfoldertype_response_v4JSON){
    ...
    // define the local variable for ezsignfoldertype_response_v4->pki_ezsignfoldertype_id
    ...
    // define the local variable for ezsignfoldertype_response_v4->fki_branding_id
    int *fki_branding_id_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->fki_billingentityinternal_id
    int *fki_billingentityinternal_id_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->fki_ezsigntsarequirement_id
    int *fki_ezsigntsarequirement_id_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->fki_font_id_annotation
    int *fki_font_id_annotation_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->fki_font_id_formfield
    int *fki_font_id_formfield_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->fki_font_id_signature
    int *fki_font_id_signature_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->fki_pdfalevel_id_convert
    int *fki_pdfalevel_id_convert_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->e_ezsignfoldertype_signaturedatedisplay
    ...
    // define the local variable for ezsignfoldertype_response_v4->e_ezsignfoldertype_documentmerge
    ezmax_api_definition__full_field_e_ezsignfoldertype_documentmerge__e e_ezsignfoldertype_documentmerge_local_nonprim = 0;

    // define the local variable for ezsignfoldertype_response_v4->i_ezsignfoldertype_fontsizeannotation
    int *i_ezsignfoldertype_fontsizeannotation_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->i_ezsignfoldertype_fontsizeformfield
    int *i_ezsignfoldertype_fontsizeformfield_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->i_ezsignfoldertype_sendreminderfirstdays
    int *i_ezsignfoldertype_sendreminderfirstdays_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->i_ezsignfoldertype_sendreminderotherdays
    int *i_ezsignfoldertype_sendreminderotherdays_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->i_ezsignfoldertype_archivaldays
    ...
    // define the local variable for ezsignfoldertype_response_v4->i_ezsignfoldertype_disposaldays
    int *i_ezsignfoldertype_disposaldays_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->i_ezsignfoldertype_deadlinedays
    int *i_ezsignfoldertype_deadlinedays_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->b_ezsignfoldertype_prematurelyendautomatically
    int *b_ezsignfoldertype_prematurelyendautomatically_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->i_ezsignfoldertype_prematurelyendautomaticallydays
    int *i_ezsignfoldertype_prematurelyendautomaticallydays_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->b_ezsignfoldertype_automaticsignature
    int *b_ezsignfoldertype_automaticsignature_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->b_ezsignfoldertype_delegate
    int *b_ezsignfoldertype_delegate_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->b_ezsignfoldertype_discussion
    int *b_ezsignfoldertype_discussion_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->b_ezsignfoldertype_logrecipientinproof
    int *b_ezsignfoldertype_logrecipientinproof_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->b_ezsignfoldertype_reassignezsignsigner
    int *b_ezsignfoldertype_reassignezsignsigner_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->b_ezsignfoldertype_reassignuser
    int *b_ezsignfoldertype_reassignuser_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->b_ezsignfoldertype_reassigngroup
    int *b_ezsignfoldertype_reassigngroup_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->b_ezsignfoldertype_senddocumentmergetoemail
    int *b_ezsignfoldertype_senddocumentmergetoemail_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->b_ezsignfoldertype_senddocumentmergetoezsignsigner
    int *b_ezsignfoldertype_senddocumentmergetoezsignsigner_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->b_ezsignfoldertype_senddocumentmergetoreceivealldocument
    int *b_ezsignfoldertype_senddocumentmergetoreceivealldocument_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->b_ezsignfoldertype_senddocumentmergetouser
    int *b_ezsignfoldertype_senddocumentmergetouser_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignedtoezsignsigner
    int *b_ezsignfoldertype_sendsignedtoezsignsigner_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignedtouser
    int *b_ezsignfoldertype_sendsignedtouser_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->b_ezsignfoldertype_sendattachmentezsignsigner
    int *b_ezsignfoldertype_sendattachmentezsignsigner_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignatureattachmentezsignsigner
    int *b_ezsignfoldertype_sendsignatureattachmentezsignsigner_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignatureattachment
    int *b_ezsignfoldertype_sendsignatureattachment_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->b_ezsignfoldertype_sendproofezsignsigner
    int *b_ezsignfoldertype_sendproofezsignsigner_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->b_ezsignfoldertype_sendattachmentuser
    int *b_ezsignfoldertype_sendattachmentuser_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignatureattachmentuser
    int *b_ezsignfoldertype_sendsignatureattachmentuser_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->b_ezsignfoldertype_sendproofuser
    int *b_ezsignfoldertype_sendproofuser_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->b_ezsignfoldertype_sendproofemail
    int *b_ezsignfoldertype_sendproofemail_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->b_ezsignfoldertype_allowdownloadattachmentezsignsigner
    int *b_ezsignfoldertype_allowdownloadattachmentezsignsigner_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->b_ezsignfoldertype_allowdownloadsignatureattachmentezsignsigner
    int *b_ezsignfoldertype_allowdownloadsignatureattachmentezsignsigner_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->b_ezsignfoldertype_allowdownloadproofezsignsigner
    int *b_ezsignfoldertype_allowdownloadproofezsignsigner_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->b_ezsignfoldertype_sendproofreceivealldocument
    int *b_ezsignfoldertype_sendproofreceivealldocument_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignatureattachmentreceivealldocument
    int *b_ezsignfoldertype_sendsignatureattachmentreceivealldocument_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignedtodocumentowner
    int *b_ezsignfoldertype_sendsignedtodocumentowner_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignedtofolderowner
    int *b_ezsignfoldertype_sendsignedtofolderowner_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignedtofullgroup
    int *b_ezsignfoldertype_sendsignedtofullgroup_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignedtolimitedgroup
    int *b_ezsignfoldertype_sendsignedtolimitedgroup_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignedtocolleague
    int *b_ezsignfoldertype_sendsignedtocolleague_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsummarytodocumentowner
    int *b_ezsignfoldertype_sendsummarytodocumentowner_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsummarytofolderowner
    int *b_ezsignfoldertype_sendsummarytofolderowner_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsummarytofullgroup
    int *b_ezsignfoldertype_sendsummarytofullgroup_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsummarytolimitedgroup
    int *b_ezsignfoldertype_sendsummarytolimitedgroup_local_var = NULL;

    // define the local variable for ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsummarytocolleague
    ...
    // define the local variable for ezsignfoldertype_response_v4->b_ezsignfoldertype_isactive
    ...
    *fki_pdfalevel_id_convert_local_var = fki_pdfalevel_id_convert->valuedouble;
    ...
    // ezsignfoldertype_response_v4->e_ezsignfoldertype_signaturedatedisplay
    cJSON *e_ezsignfoldertype_signaturedatedisplay = cJSON_GetObjectItemCaseSensitive(ezsignfoldertype_response_v4JSON, "eEzsignfoldertypeSignaturedatedisplay");
    ...
    // ezsignfoldertype_response_v4->s_ezsignfoldertype_signaturedatecustomformat
    cJSON *s_ezsignfoldertype_signaturedatecustomformat = cJSON_GetObjectItemCaseSensitive(ezsignfoldertype_response_v4JSON, "sEzsignfoldertypeSignaturedatecustomformat");
    ...
    // ezsignfoldertype_response_v4->e_ezsignfoldertype_documentmerge
    cJSON *e_ezsignfoldertype_documentmerge = cJSON_GetObjectItemCaseSensitive(ezsignfoldertype_response_v4JSON, "eEzsignfoldertypeDocumentmerge");
    ...
    *b_ezsignfoldertype_reassigngroup_local_var = b_ezsignfoldertype_reassigngroup->valueint;
    ...
    // ezsignfoldertype_response_v4->b_ezsignfoldertype_senddocumentmergetoemail
    cJSON *b_ezsignfoldertype_senddocumentmergetoemail = cJSON_GetObjectItemCaseSensitive(ezsignfoldertype_response_v4JSON, "bEzsignfoldertypeSenddocumentmergetoemail");
    ...
    *b_ezsignfoldertype_senddocumentmergetoemail_local_var = b_ezsignfoldertype_senddocumentmergetoemail->valueint;
    ...
    // ezsignfoldertype_response_v4->b_ezsignfoldertype_senddocumentmergetoezsignsigner
    cJSON *b_ezsignfoldertype_senddocumentmergetoezsignsigner = cJSON_GetObjectItemCaseSensitive(ezsignfoldertype_response_v4JSON, "bEzsignfoldertypeSenddocumentmergetoezsignsigner");
    ...
    *b_ezsignfoldertype_senddocumentmergetoezsignsigner_local_var = b_ezsignfoldertype_senddocumentmergetoezsignsigner->valueint;
    ...
    // ezsignfoldertype_response_v4->b_ezsignfoldertype_senddocumentmergetoreceivealldocument
    cJSON *b_ezsignfoldertype_senddocumentmergetoreceivealldocument = cJSON_GetObjectItemCaseSensitive(ezsignfoldertype_response_v4JSON, "bEzsignfoldertypeSenddocumentmergetoreceivealldocument");
    ...
    *b_ezsignfoldertype_senddocumentmergetoreceivealldocument_local_var = b_ezsignfoldertype_senddocumentmergetoreceivealldocument->valueint;
    ...
    // ezsignfoldertype_response_v4->b_ezsignfoldertype_senddocumentmergetouser
    cJSON *b_ezsignfoldertype_senddocumentmergetouser = cJSON_GetObjectItemCaseSensitive(ezsignfoldertype_response_v4JSON, "bEzsignfoldertypeSenddocumentmergetouser");
    ...
    *b_ezsignfoldertype_sendattachmentezsignsigner_local_var = b_ezsignfoldertype_sendattachmentezsignsigner->valueint;
    ...
    // ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignatureattachmentezsignsigner
    cJSON *b_ezsignfoldertype_sendsignatureattachmentezsignsigner = cJSON_GetObjectItemCaseSensitive(ezsignfoldertype_response_v4JSON, "bEzsignfoldertypeSendsignatureattachmentezsignsigner");
    ...
    *b_ezsignfoldertype_sendsignatureattachmentezsignsigner_local_var = b_ezsignfoldertype_sendsignatureattachmentezsignsigner->valueint;
    ...
    // ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignatureattachment
    cJSON *b_ezsignfoldertype_sendsignatureattachment = cJSON_GetObjectItemCaseSensitive(ezsignfoldertype_response_v4JSON, "bEzsignfoldertypeSendsignatureattachment");
    ...
    *b_ezsignfoldertype_sendattachmentuser_local_var = b_ezsignfoldertype_sendattachmentuser->valueint;
    ...
    // ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignatureattachmentuser
    cJSON *b_ezsignfoldertype_sendsignatureattachmentuser = cJSON_GetObjectItemCaseSensitive(ezsignfoldertype_response_v4JSON, "bEzsignfoldertypeSendsignatureattachmentuser");
    ...
    *b_ezsignfoldertype_allowdownloadattachmentezsignsigner_local_var = b_ezsignfoldertype_allowdownloadattachmentezsignsigner->valueint;
    ...
    // ezsignfoldertype_response_v4->b_ezsignfoldertype_allowdownloadsignatureattachmentezsignsigner
    cJSON *b_ezsignfoldertype_allowdownloadsignatureattachmentezsignsigner = cJSON_GetObjectItemCaseSensitive(ezsignfoldertype_response_v4JSON, "bEzsignfoldertypeAllowdownloadsignatureattachmentezsignsigner");
    ...
    *b_ezsignfoldertype_sendproofreceivealldocument_local_var = b_ezsignfoldertype_sendproofreceivealldocument->valueint;
    ...
    // ezsignfoldertype_response_v4->b_ezsignfoldertype_sendsignatureattachmentreceivealldocument
    cJSON *b_ezsignfoldertype_sendsignatureattachmentreceivealldocument = cJSON_GetObjectItemCaseSensitive(ezsignfoldertype_response_v4JSON, "bEzsignfoldertypeSendsignatureattachmentreceivealldocument");
    ...
    *b_ezsignfoldertype_isactive_local_var = b_ezsignfoldertype_isactive->valueint;
    ...
    ezsignfoldertype_response_v4_local_var = ezsignfoldertype_response_v4_create_internal (
