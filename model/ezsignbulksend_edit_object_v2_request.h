/*
 * ezsignbulksend_edit_object_v2_request.h
 *
 * Request for PUT /2/object/ezsignbulksend/{pkiEzsignbulksendID}
 */

#ifndef _ezsignbulksend_edit_object_v2_request_H_
#define _ezsignbulksend_edit_object_v2_request_H_
...
typedef struct ezsignbulksend_edit_object_v2_request_t ezsignbulksend_edit_object_v2_request_t;

#include "ezsignbulksend_request_compound_v2.h"



typedef struct ezsignbulksend_edit_object_v2_request_t {
    struct ezsignbulksend_request_compound_v2_t *obj_ezsignbulksend; //model

    int _library_owned; // Is the library responsible for freeing this object?
} ezsignbulksend_edit_object_v2_request_t;
...
#endif /* _ezsignbulksend_edit_object_v2_request_H_ */
