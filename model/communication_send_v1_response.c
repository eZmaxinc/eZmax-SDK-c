...
static communication_send_v1_response_t *communication_send_v1_response_create_internal(
    ...
    memset(communication_send_v1_response_local_var, 0, sizeof(communication_send_v1_response_t));
...
__attribute__((deprecated)) communication_send_v1_response_t *communication_send_v1_response_create(
    ...
    communication_send_v1_response_t *result = communication_send_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
