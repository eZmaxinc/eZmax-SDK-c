...
static ezsignbulksenddocumentmapping_create_object_v1_response_t *ezsignbulksenddocumentmapping_create_object_v1_response_create_internal(
    ...
    memset(ezsignbulksenddocumentmapping_create_object_v1_response_local_var, 0, sizeof(ezsignbulksenddocumentmapping_create_object_v1_response_t));
...
__attribute__((deprecated)) ezsignbulksenddocumentmapping_create_object_v1_response_t *ezsignbulksenddocumentmapping_create_object_v1_response_create(
    ...
    ezsignbulksenddocumentmapping_create_object_v1_response_t *result = ezsignbulksenddocumentmapping_create_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
