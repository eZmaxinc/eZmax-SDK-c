...
static ezsignfolder_response_compound_t *ezsignfolder_response_compound_create_internal(
    ...
    memset(ezsignfolder_response_compound_local_var, 0, sizeof(ezsignfolder_response_compound_t));
    ...
    ezsignfolder_response_compound_local_var->e_ezsignfolder_messageorder = e_ezsignfolder_messageorder;
...
__attribute__((deprecated)) ezsignfolder_response_compound_t *ezsignfolder_response_compound_create(
    ...
    ezsignfolder_response_compound_t *result = ezsignfolder_response_compound_create_internal (
...
void ezsignfolder_response_compound_free(ezsignfolder_response_compound_t *ezsignfolder_response_compound) {
    ...
    if (ezsignfolder_response_compound->pki_ezsignfolder_id) {
        free(ezsignfolder_response_compound->pki_ezsignfolder_id);
        ezsignfolder_response_compound->pki_ezsignfolder_id = NULL;
    }
    if (ezsignfolder_response_compound->fki_ezsignfoldertype_id) {
        free(ezsignfolder_response_compound->fki_ezsignfoldertype_id);
        ezsignfolder_response_compound->fki_ezsignfoldertype_id = NULL;
    }
    ...
    if (ezsignfolder_response_compound->fki_timezone_id) {
        free(ezsignfolder_response_compound->fki_timezone_id);
        ezsignfolder_response_compound->fki_timezone_id = NULL;
    }
    ...
    if (ezsignfolder_response_compound->fki_billingentityinternal_id) {
        free(ezsignfolder_response_compound->fki_billingentityinternal_id);
        ezsignfolder_response_compound->fki_billingentityinternal_id = NULL;
    }
    ...
    if (ezsignfolder_response_compound->fki_ezsigntsarequirement_id) {
        free(ezsignfolder_response_compound->fki_ezsigntsarequirement_id);
        ezsignfolder_response_compound->fki_ezsigntsarequirement_id = NULL;
    }
    ...
    if (ezsignfolder_response_compound->b_ezsignfolder_isdisposable) {
        free(ezsignfolder_response_compound->b_ezsignfolder_isdisposable);
        ezsignfolder_response_compound->b_ezsignfolder_isdisposable = NULL;
    }
    if (ezsignfolder_response_compound->i_ezsignfolder_sendreminderfirstdays) {
        free(ezsignfolder_response_compound->i_ezsignfolder_sendreminderfirstdays);
        ezsignfolder_response_compound->i_ezsignfolder_sendreminderfirstdays = NULL;
    }
    if (ezsignfolder_response_compound->i_ezsignfolder_sendreminderotherdays) {
        free(ezsignfolder_response_compound->i_ezsignfolder_sendreminderotherdays);
        ezsignfolder_response_compound->i_ezsignfolder_sendreminderotherdays = NULL;
    }
...
cJSON *ezsignfolder_response_compound_convertToJSON(ezsignfolder_response_compound_t *ezsignfolder_response_compound) {
    ...
    // ezsignfolder_response_compound->e_ezsignfolder_messageorder
    if(ezsignfolder_response_compound->e_ezsignfolder_messageorder != ezmax_api_definition__full_field_e_ezsignfolder_messageorder__NULL) {
    cJSON *e_ezsignfolder_messageorder_local_JSON = field_e_ezsignfolder_messageorder_convertToJSON(ezsignfolder_response_compound->e_ezsignfolder_messageorder);
...
ezsignfolder_response_compound_t *ezsignfolder_response_compound_parseFromJSON(cJSON *ezsignfolder_response_compoundJSON){
    ...
    // define the local variable for ezsignfolder_response_compound->pki_ezsignfolder_id
    int *pki_ezsignfolder_id_local_var = NULL;

    // define the local variable for ezsignfolder_response_compound->fki_ezsignfoldertype_id
    ...
    // define the local variable for ezsignfolder_response_compound->fki_timezone_id
    ...
    // define the local variable for ezsignfolder_response_compound->fki_billingentityinternal_id
    int *fki_billingentityinternal_id_local_var = NULL;

    char *s_billingentityinternal_description_x_local_str = NULL;

    // define the local variable for ezsignfolder_response_compound->fki_ezsigntsarequirement_id
    ...
    // define the local variable for ezsignfolder_response_compound->b_ezsignfolder_isdisposable
    ...
    // define the local variable for ezsignfolder_response_compound->i_ezsignfolder_sendreminderfirstdays
    int *i_ezsignfolder_sendreminderfirstdays_local_var = NULL;

    // define the local variable for ezsignfolder_response_compound->i_ezsignfolder_sendreminderotherdays
    ...
    // define the local variable for ezsignfolder_response_compound->e_ezsignfolder_messageorder
    ...
    *i_ezsignfolder_sendreminderotherdays_local_var = i_ezsignfolder_sendreminderotherdays->valuedouble;
    ...
    // ezsignfolder_response_compound->e_ezsignfolder_messageorder
    cJSON *e_ezsignfolder_messageorder = cJSON_GetObjectItemCaseSensitive(ezsignfolder_response_compoundJSON, "eEzsignfolderMessageorder");
