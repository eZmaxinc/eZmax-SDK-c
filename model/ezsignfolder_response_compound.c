...
char* e_ezsignfolder_sendreminderfrequencyezsignfolder_response_compound_ToString(ezmax_api_definition_ezsignfolder_response_compound__e e_ezsignfolder_sendreminderfrequency) {
...
ezmax_api_definition_ezsignfolder_response_compound__e e_ezsignfolder_sendreminderfrequencyezsignfolder_response_compound_FromString(char* e_ezsignfolder_sendreminderfrequency){
...
char* e_ezsignfolder_stepezsignfolder_response_compound_ToString(ezmax_api_definition_ezsignfolder_response_compound__e e_ezsignfolder_step) {
...
ezmax_api_definition_ezsignfolder_response_compound__e e_ezsignfolder_stepezsignfolder_response_compound_FromString(char* e_ezsignfolder_step){
    int stringToReturn = 0;
    char *e_ezsignfolder_stepArray[] =  { "NULL", "Unsent", "Sent", "PartiallySigned", "Expired", "Completed", "Archived" };
...
ezsignfolder_response_compound_t *ezsignfolder_response_compound_create(
    ...
    ezsignfolder_response_compound_local_var->dt_ezsignfolder_scheduleddestruction = dt_ezsignfolder_scheduleddestruction;
...
void ezsignfolder_response_compound_free(ezsignfolder_response_compound_t *ezsignfolder_response_compound) {
    ...
    if (ezsignfolder_response_compound->dt_ezsignfolder_scheduleddestruction) {
        free(ezsignfolder_response_compound->dt_ezsignfolder_scheduleddestruction);
        ezsignfolder_response_compound->dt_ezsignfolder_scheduleddestruction = NULL;
    }
...
cJSON *ezsignfolder_response_compound_convertToJSON(ezsignfolder_response_compound_t *ezsignfolder_response_compound) {
    ...
    // ezsignfolder_response_compound->dt_ezsignfolder_scheduleddestruction
    if (!ezsignfolder_response_compound->dt_ezsignfolder_scheduleddestruction) {
        goto fail;
    }
    
    if(cJSON_AddStringToObject(item, "dtEzsignfolderScheduleddestruction", ezsignfolder_response_compound->dt_ezsignfolder_scheduleddestruction) == NULL) {
    goto fail; //String
    }
...
ezsignfolder_response_compound_t *ezsignfolder_response_compound_parseFromJSON(cJSON *ezsignfolder_response_compoundJSON){
    ...
    // ezsignfolder_response_compound->dt_ezsignfolder_scheduleddestruction
    cJSON *dt_ezsignfolder_scheduleddestruction = cJSON_GetObjectItemCaseSensitive(ezsignfolder_response_compoundJSON, "dtEzsignfolderScheduleddestruction");
