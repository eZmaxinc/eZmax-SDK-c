...
static user_edit_object_v1_response_t *user_edit_object_v1_response_create_internal(
    ...
    memset(user_edit_object_v1_response_local_var, 0, sizeof(user_edit_object_v1_response_t));
    user_edit_object_v1_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) user_edit_object_v1_response_t *user_edit_object_v1_response_create(
    common_response_obj_debug_payload_t *obj_debug_payload,
    common_response_obj_debug_t *obj_debug
    ) {
    user_edit_object_v1_response_t *result = user_edit_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug
        );
    if (!result) {
...
void user_edit_object_v1_response_free(user_edit_object_v1_response_t *user_edit_object_v1_response) {
    ...
    if(user_edit_object_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "user_edit_object_v1_response_free");
        return ;
    }
...
user_edit_object_v1_response_t *user_edit_object_v1_response_parseFromJSON(cJSON *user_edit_object_v1_responseJSON){
    ...
    user_edit_object_v1_response_local_var = user_edit_object_v1_response_create_internal (
