...
static ezsignbulksend_request_v2_t *ezsignbulksend_request_v2_create_internal(
    ...
    memset(ezsignbulksend_request_v2_local_var, 0, sizeof(ezsignbulksend_request_v2_t));
...
__attribute__((deprecated)) ezsignbulksend_request_v2_t *ezsignbulksend_request_v2_create(
    ...
    ezsignbulksend_request_v2_t *result = ezsignbulksend_request_v2_create_internal (
...
void ezsignbulksend_request_v2_free(ezsignbulksend_request_v2_t *ezsignbulksend_request_v2) {
    ...
    if (ezsignbulksend_request_v2->pki_ezsignbulksend_id) {
        free(ezsignbulksend_request_v2->pki_ezsignbulksend_id);
        ezsignbulksend_request_v2->pki_ezsignbulksend_id = NULL;
    }
    if (ezsignbulksend_request_v2->fki_ezsignfoldertype_id) {
        free(ezsignbulksend_request_v2->fki_ezsignfoldertype_id);
        ezsignbulksend_request_v2->fki_ezsignfoldertype_id = NULL;
    }
    if (ezsignbulksend_request_v2->fki_language_id) {
        free(ezsignbulksend_request_v2->fki_language_id);
        ezsignbulksend_request_v2->fki_language_id = NULL;
    }
    ...
    if (ezsignbulksend_request_v2->b_ezsignbulksend_needvalidation) {
        free(ezsignbulksend_request_v2->b_ezsignbulksend_needvalidation);
        ezsignbulksend_request_v2->b_ezsignbulksend_needvalidation = NULL;
    }
    if (ezsignbulksend_request_v2->b_ezsignbulksend_isactive) {
        free(ezsignbulksend_request_v2->b_ezsignbulksend_isactive);
        ezsignbulksend_request_v2->b_ezsignbulksend_isactive = NULL;
    }
...
ezsignbulksend_request_v2_t *ezsignbulksend_request_v2_parseFromJSON(cJSON *ezsignbulksend_request_v2JSON){
    ...
    // define the local variable for ezsignbulksend_request_v2->pki_ezsignbulksend_id
    int *pki_ezsignbulksend_id_local_var = NULL;

    // define the local variable for ezsignbulksend_request_v2->fki_ezsignfoldertype_id
    int *fki_ezsignfoldertype_id_local_var = NULL;

    // define the local variable for ezsignbulksend_request_v2->fki_language_id
    ...
    // define the local variable for ezsignbulksend_request_v2->b_ezsignbulksend_needvalidation
    int *b_ezsignbulksend_needvalidation_local_var = NULL;

    // define the local variable for ezsignbulksend_request_v2->b_ezsignbulksend_isactive
