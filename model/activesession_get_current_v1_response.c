...
static activesession_get_current_v1_response_t *activesession_get_current_v1_response_create_internal(
    ...
    memset(activesession_get_current_v1_response_local_var, 0, sizeof(activesession_get_current_v1_response_t));
...
__attribute__((deprecated)) activesession_get_current_v1_response_t *activesession_get_current_v1_response_create(
    ...
    activesession_get_current_v1_response_t *result = activesession_get_current_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
