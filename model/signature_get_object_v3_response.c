...
static signature_get_object_v3_response_t *signature_get_object_v3_response_create_internal(
    ...
    memset(signature_get_object_v3_response_local_var, 0, sizeof(signature_get_object_v3_response_t));
    signature_get_object_v3_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) signature_get_object_v3_response_t *signature_get_object_v3_response_create(
    common_response_obj_debug_payload_t *obj_debug_payload,
    common_response_obj_debug_t *obj_debug,
    signature_get_object_v3_response_m_payload_t *m_payload
    ) {
    signature_get_object_v3_response_t *result = signature_get_object_v3_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void signature_get_object_v3_response_free(signature_get_object_v3_response_t *signature_get_object_v3_response) {
    ...
    if(signature_get_object_v3_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "signature_get_object_v3_response_free");
        return ;
    }
...
signature_get_object_v3_response_t *signature_get_object_v3_response_parseFromJSON(cJSON *signature_get_object_v3_responseJSON){
    ...
    signature_get_object_v3_response_local_var = signature_get_object_v3_response_create_internal (
