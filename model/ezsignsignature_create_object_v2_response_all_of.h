/*
 * ezsignsignature_create_object_v2_response_all_of.h
 *
 * 
 */

#ifndef _ezsignsignature_create_object_v2_response_all_of_H_
#define _ezsignsignature_create_object_v2_response_all_of_H_
...
typedef struct ezsignsignature_create_object_v2_response_all_of_t ezsignsignature_create_object_v2_response_all_of_t;

#include "ezsignsignature_create_object_v2_response_m_payload.h"



typedef struct ezsignsignature_create_object_v2_response_all_of_t {
    struct ezsignsignature_create_object_v2_response_m_payload_t *m_payload; //model

} ezsignsignature_create_object_v2_response_all_of_t;
...
#endif /* _ezsignsignature_create_object_v2_response_all_of_H_ */
