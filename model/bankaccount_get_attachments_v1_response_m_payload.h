/*
 * bankaccount_get_attachments_v1_response_m_payload.h
 *
 * Response for GET /1/object/bankaccount/{pkiBankaccountID}/getAttachments
 */

#ifndef _bankaccount_get_attachments_v1_response_m_payload_H_
#define _bankaccount_get_attachments_v1_response_m_payload_H_
...
typedef struct bankaccount_get_attachments_v1_response_m_payload_t bankaccount_get_attachments_v1_response_m_payload_t;

#include "custom_attachmentdocumenttype_response.h"



typedef struct bankaccount_get_attachments_v1_response_m_payload_t {
    list_t *a_obj_attachmentdocumenttype; //nonprimitive container

    int _library_owned; // Is the library responsible for freeing this object?
} bankaccount_get_attachments_v1_response_m_payload_t;
...
#endif /* _bankaccount_get_attachments_v1_response_m_payload_H_ */
