...
static ezsignfoldertype_response_t *ezsignfoldertype_response_create_internal(
    ...
    ezsignfoldertype_response_local_var->b_ezsignfoldertype_sendattachmentreceivecopy = b_ezsignfoldertype_sendattachmentreceivecopy;
...
__attribute__((deprecated)) ezsignfoldertype_response_t *ezsignfoldertype_response_create(
    ...
    return ezsignfoldertype_response_create_internal (
...
cJSON *ezsignfoldertype_response_convertToJSON(ezsignfoldertype_response_t *ezsignfoldertype_response) {
    ...
    // ezsignfoldertype_response->b_ezsignfoldertype_sendattachmentreceivecopy
    if(ezsignfoldertype_response->b_ezsignfoldertype_sendattachmentreceivecopy) {
    if(cJSON_AddBoolToObject(item, "bEzsignfoldertypeSendattachmentreceivecopy", ezsignfoldertype_response->b_ezsignfoldertype_sendattachmentreceivecopy) == NULL) {
    goto fail; //Bool
    }
    }
...
ezsignfoldertype_response_t *ezsignfoldertype_response_parseFromJSON(cJSON *ezsignfoldertype_responseJSON){
    ...
    // ezsignfoldertype_response->b_ezsignfoldertype_sendattachmentreceivecopy
    cJSON *b_ezsignfoldertype_sendattachmentreceivecopy = cJSON_GetObjectItemCaseSensitive(ezsignfoldertype_responseJSON, "bEzsignfoldertypeSendattachmentreceivecopy");
