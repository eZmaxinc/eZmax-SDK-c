...
static ezsignfoldertype_response_t *ezsignfoldertype_response_create_internal(
    ...
    memset(ezsignfoldertype_response_local_var, 0, sizeof(ezsignfoldertype_response_t));
    ezsignfoldertype_response_local_var->_library_owned = 1;
    ...
    ezsignfoldertype_response_local_var->e_ezsignfoldertype_completion = e_ezsignfoldertype_completion;
    ...
    ezsignfoldertype_response_local_var->b_ezsignfoldertype_automaticsignature = b_ezsignfoldertype_automaticsignature;
    ezsignfoldertype_response_local_var->b_ezsignfoldertype_delegate = b_ezsignfoldertype_delegate;
    ezsignfoldertype_response_local_var->b_ezsignfoldertype_discussion = b_ezsignfoldertype_discussion;
    ezsignfoldertype_response_local_var->b_ezsignfoldertype_reassignezsignsigner = b_ezsignfoldertype_reassignezsignsigner;
    ezsignfoldertype_response_local_var->b_ezsignfoldertype_reassignuser = b_ezsignfoldertype_reassignuser;
    ezsignfoldertype_response_local_var->b_ezsignfoldertype_reassigngroup = b_ezsignfoldertype_reassigngroup;
    ezsignfoldertype_response_local_var->b_ezsignfoldertype_sendsignedtoezsignsigner = b_ezsignfoldertype_sendsignedtoezsignsigner;
    ezsignfoldertype_response_local_var->b_ezsignfoldertype_sendsignedtouser = b_ezsignfoldertype_sendsignedtouser;
    ezsignfoldertype_response_local_var->b_ezsignfoldertype_sendattachmentezsignsigner = b_ezsignfoldertype_sendattachmentezsignsigner;
    ezsignfoldertype_response_local_var->b_ezsignfoldertype_sendproofezsignsigner = b_ezsignfoldertype_sendproofezsignsigner;
    ezsignfoldertype_response_local_var->b_ezsignfoldertype_sendattachmentuser = b_ezsignfoldertype_sendattachmentuser;
    ezsignfoldertype_response_local_var->b_ezsignfoldertype_sendproofuser = b_ezsignfoldertype_sendproofuser;
    ezsignfoldertype_response_local_var->b_ezsignfoldertype_sendproofemail = b_ezsignfoldertype_sendproofemail;
    ezsignfoldertype_response_local_var->b_ezsignfoldertype_allowdownloadattachmentezsignsigner = b_ezsignfoldertype_allowdownloadattachmentezsignsigner;
    ezsignfoldertype_response_local_var->b_ezsignfoldertype_allowdownloadproofezsignsigner = b_ezsignfoldertype_allowdownloadproofezsignsigner;
    ezsignfoldertype_response_local_var->b_ezsignfoldertype_sendproofreceivealldocument = b_ezsignfoldertype_sendproofreceivealldocument;
    ...
    ezsignfoldertype_response_local_var->a_obj_userlogintype = a_obj_userlogintype;
...
__attribute__((deprecated)) ezsignfoldertype_response_t *ezsignfoldertype_response_create(
    ...
    int *fki_usergroup_id_restricted_copy = NULL;
    if (fki_usergroup_id_restricted) {
        fki_usergroup_id_restricted_copy = malloc(sizeof(int));
        if (fki_usergroup_id_restricted_copy) *fki_usergroup_id_restricted_copy = *fki_usergroup_id_restricted;
    }
    ...
    ezsignfoldertype_response_t *result = ezsignfoldertype_response_create_internal (
        ...
        fki_usergroup_id_restricted_copy,
    ...
    if (!result) {
        ...
        free(fki_usergroup_id_restricted_copy);
...
void ezsignfoldertype_response_free(ezsignfoldertype_response_t *ezsignfoldertype_response) {
    ...
    if(ezsignfoldertype_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsignfoldertype_response_free");
        return ;
    }
    listEntry_t *listEntry;
    if (ezsignfoldertype_response->pki_ezsignfoldertype_id) {
        free(ezsignfoldertype_response->pki_ezsignfoldertype_id);
        ezsignfoldertype_response->pki_ezsignfoldertype_id = NULL;
    }
    ...
    if (ezsignfoldertype_response->fki_branding_id) {
        free(ezsignfoldertype_response->fki_branding_id);
        ezsignfoldertype_response->fki_branding_id = NULL;
    }
    if (ezsignfoldertype_response->fki_billingentityinternal_id) {
        free(ezsignfoldertype_response->fki_billingentityinternal_id);
        ezsignfoldertype_response->fki_billingentityinternal_id = NULL;
    }
    if (ezsignfoldertype_response->fki_usergroup_id) {
        free(ezsignfoldertype_response->fki_usergroup_id);
        ezsignfoldertype_response->fki_usergroup_id = NULL;
    }
    if (ezsignfoldertype_response->fki_usergroup_id_restricted) {
        free(ezsignfoldertype_response->fki_usergroup_id_restricted);
        ezsignfoldertype_response->fki_usergroup_id_restricted = NULL;
    }
    if (ezsignfoldertype_response->fki_ezsigntsarequirement_id) {
        free(ezsignfoldertype_response->fki_ezsigntsarequirement_id);
        ezsignfoldertype_response->fki_ezsigntsarequirement_id = NULL;
    }
    ...
    if (ezsignfoldertype_response->i_ezsignfoldertype_archivaldays) {
        free(ezsignfoldertype_response->i_ezsignfoldertype_archivaldays);
        ezsignfoldertype_response->i_ezsignfoldertype_archivaldays = NULL;
    }
    if (ezsignfoldertype_response->i_ezsignfoldertype_disposaldays) {
        free(ezsignfoldertype_response->i_ezsignfoldertype_disposaldays);
        ezsignfoldertype_response->i_ezsignfoldertype_disposaldays = NULL;
    }
    if (ezsignfoldertype_response->i_ezsignfoldertype_deadlinedays) {
        free(ezsignfoldertype_response->i_ezsignfoldertype_deadlinedays);
        ezsignfoldertype_response->i_ezsignfoldertype_deadlinedays = NULL;
    }
    if (ezsignfoldertype_response->b_ezsignfoldertype_automaticsignature) {
        free(ezsignfoldertype_response->b_ezsignfoldertype_automaticsignature);
        ezsignfoldertype_response->b_ezsignfoldertype_automaticsignature = NULL;
    }
    if (ezsignfoldertype_response->b_ezsignfoldertype_delegate) {
        free(ezsignfoldertype_response->b_ezsignfoldertype_delegate);
        ezsignfoldertype_response->b_ezsignfoldertype_delegate = NULL;
    }
    if (ezsignfoldertype_response->b_ezsignfoldertype_discussion) {
        free(ezsignfoldertype_response->b_ezsignfoldertype_discussion);
        ezsignfoldertype_response->b_ezsignfoldertype_discussion = NULL;
    }
    if (ezsignfoldertype_response->b_ezsignfoldertype_reassignezsignsigner) {
        free(ezsignfoldertype_response->b_ezsignfoldertype_reassignezsignsigner);
        ezsignfoldertype_response->b_ezsignfoldertype_reassignezsignsigner = NULL;
    }
    if (ezsignfoldertype_response->b_ezsignfoldertype_reassignuser) {
        free(ezsignfoldertype_response->b_ezsignfoldertype_reassignuser);
        ezsignfoldertype_response->b_ezsignfoldertype_reassignuser = NULL;
    }
    if (ezsignfoldertype_response->b_ezsignfoldertype_reassigngroup) {
        free(ezsignfoldertype_response->b_ezsignfoldertype_reassigngroup);
        ezsignfoldertype_response->b_ezsignfoldertype_reassigngroup = NULL;
    }
    if (ezsignfoldertype_response->b_ezsignfoldertype_sendsignedtoezsignsigner) {
        free(ezsignfoldertype_response->b_ezsignfoldertype_sendsignedtoezsignsigner);
        ezsignfoldertype_response->b_ezsignfoldertype_sendsignedtoezsignsigner = NULL;
    }
    if (ezsignfoldertype_response->b_ezsignfoldertype_sendsignedtouser) {
        free(ezsignfoldertype_response->b_ezsignfoldertype_sendsignedtouser);
        ezsignfoldertype_response->b_ezsignfoldertype_sendsignedtouser = NULL;
    }
    if (ezsignfoldertype_response->b_ezsignfoldertype_sendattachmentezsignsigner) {
        free(ezsignfoldertype_response->b_ezsignfoldertype_sendattachmentezsignsigner);
        ezsignfoldertype_response->b_ezsignfoldertype_sendattachmentezsignsigner = NULL;
    }
    if (ezsignfoldertype_response->b_ezsignfoldertype_sendproofezsignsigner) {
        free(ezsignfoldertype_response->b_ezsignfoldertype_sendproofezsignsigner);
        ezsignfoldertype_response->b_ezsignfoldertype_sendproofezsignsigner = NULL;
    }
    if (ezsignfoldertype_response->b_ezsignfoldertype_sendattachmentuser) {
        free(ezsignfoldertype_response->b_ezsignfoldertype_sendattachmentuser);
        ezsignfoldertype_response->b_ezsignfoldertype_sendattachmentuser = NULL;
    }
    if (ezsignfoldertype_response->b_ezsignfoldertype_sendproofuser) {
        free(ezsignfoldertype_response->b_ezsignfoldertype_sendproofuser);
        ezsignfoldertype_response->b_ezsignfoldertype_sendproofuser = NULL;
    }
    if (ezsignfoldertype_response->b_ezsignfoldertype_sendproofemail) {
        free(ezsignfoldertype_response->b_ezsignfoldertype_sendproofemail);
        ezsignfoldertype_response->b_ezsignfoldertype_sendproofemail = NULL;
    }
    if (ezsignfoldertype_response->b_ezsignfoldertype_allowdownloadattachmentezsignsigner) {
        free(ezsignfoldertype_response->b_ezsignfoldertype_allowdownloadattachmentezsignsigner);
        ezsignfoldertype_response->b_ezsignfoldertype_allowdownloadattachmentezsignsigner = NULL;
    }
    if (ezsignfoldertype_response->b_ezsignfoldertype_allowdownloadproofezsignsigner) {
        free(ezsignfoldertype_response->b_ezsignfoldertype_allowdownloadproofezsignsigner);
        ezsignfoldertype_response->b_ezsignfoldertype_allowdownloadproofezsignsigner = NULL;
    }
    if (ezsignfoldertype_response->b_ezsignfoldertype_sendproofreceivealldocument) {
        free(ezsignfoldertype_response->b_ezsignfoldertype_sendproofreceivealldocument);
        ezsignfoldertype_response->b_ezsignfoldertype_sendproofreceivealldocument = NULL;
    }
    if (ezsignfoldertype_response->b_ezsignfoldertype_sendsignedtodocumentowner) {
        free(ezsignfoldertype_response->b_ezsignfoldertype_sendsignedtodocumentowner);
        ezsignfoldertype_response->b_ezsignfoldertype_sendsignedtodocumentowner = NULL;
    }
    if (ezsignfoldertype_response->b_ezsignfoldertype_sendsignedtofolderowner) {
        free(ezsignfoldertype_response->b_ezsignfoldertype_sendsignedtofolderowner);
        ezsignfoldertype_response->b_ezsignfoldertype_sendsignedtofolderowner = NULL;
    }
    if (ezsignfoldertype_response->b_ezsignfoldertype_sendsignedtofullgroup) {
        free(ezsignfoldertype_response->b_ezsignfoldertype_sendsignedtofullgroup);
        ezsignfoldertype_response->b_ezsignfoldertype_sendsignedtofullgroup = NULL;
    }
    if (ezsignfoldertype_response->b_ezsignfoldertype_sendsignedtolimitedgroup) {
        free(ezsignfoldertype_response->b_ezsignfoldertype_sendsignedtolimitedgroup);
        ezsignfoldertype_response->b_ezsignfoldertype_sendsignedtolimitedgroup = NULL;
    }
    if (ezsignfoldertype_response->b_ezsignfoldertype_sendsignedtocolleague) {
        free(ezsignfoldertype_response->b_ezsignfoldertype_sendsignedtocolleague);
        ezsignfoldertype_response->b_ezsignfoldertype_sendsignedtocolleague = NULL;
    }
    if (ezsignfoldertype_response->b_ezsignfoldertype_sendsummarytodocumentowner) {
        free(ezsignfoldertype_response->b_ezsignfoldertype_sendsummarytodocumentowner);
        ezsignfoldertype_response->b_ezsignfoldertype_sendsummarytodocumentowner = NULL;
    }
    if (ezsignfoldertype_response->b_ezsignfoldertype_sendsummarytofolderowner) {
        free(ezsignfoldertype_response->b_ezsignfoldertype_sendsummarytofolderowner);
        ezsignfoldertype_response->b_ezsignfoldertype_sendsummarytofolderowner = NULL;
    }
    if (ezsignfoldertype_response->b_ezsignfoldertype_sendsummarytofullgroup) {
        free(ezsignfoldertype_response->b_ezsignfoldertype_sendsummarytofullgroup);
        ezsignfoldertype_response->b_ezsignfoldertype_sendsummarytofullgroup = NULL;
    }
    if (ezsignfoldertype_response->b_ezsignfoldertype_sendsummarytolimitedgroup) {
        free(ezsignfoldertype_response->b_ezsignfoldertype_sendsummarytolimitedgroup);
        ezsignfoldertype_response->b_ezsignfoldertype_sendsummarytolimitedgroup = NULL;
    }
    if (ezsignfoldertype_response->b_ezsignfoldertype_sendsummarytocolleague) {
        free(ezsignfoldertype_response->b_ezsignfoldertype_sendsummarytocolleague);
        ezsignfoldertype_response->b_ezsignfoldertype_sendsummarytocolleague = NULL;
    }
    if (ezsignfoldertype_response->b_ezsignfoldertype_isactive) {
        free(ezsignfoldertype_response->b_ezsignfoldertype_isactive);
        ezsignfoldertype_response->b_ezsignfoldertype_isactive = NULL;
    }
    if (ezsignfoldertype_response->a_obj_userlogintype) {
        list_ForEach(listEntry, ezsignfoldertype_response->a_obj_userlogintype) {
            userlogintype_response_free(listEntry->data);
        }
        list_freeList(ezsignfoldertype_response->a_obj_userlogintype);
        ezsignfoldertype_response->a_obj_userlogintype = NULL;
    }
...
cJSON *ezsignfoldertype_response_convertToJSON(ezsignfoldertype_response_t *ezsignfoldertype_response) {
    ...
    if (ezmax_api_definition__full_field_e_ezsignfoldertype_privacylevel__NULL == ezsignfoldertype_response->e_ezsignfoldertype_privacylevel) {
        goto fail;
    }
    ...
    if(ezsignfoldertype_response->e_ezsignfoldertype_sendreminderfrequency != ezmax_api_definition__full_field_e_ezsignfoldertype_sendreminderfrequency__NULL) {
    ...
    if (ezmax_api_definition__full_field_e_ezsignfoldertype_disposal__NULL == ezsignfoldertype_response->e_ezsignfoldertype_disposal) {
        goto fail;
    }
    ...
    // ezsignfoldertype_response->e_ezsignfoldertype_completion
    if (ezmax_api_definition__full_field_e_ezsignfoldertype_completion__NULL == ezsignfoldertype_response->e_ezsignfoldertype_completion) {
        goto fail;
    }
    cJSON *e_ezsignfoldertype_completion_local_JSON = field_e_ezsignfoldertype_completion_convertToJSON(ezsignfoldertype_response->e_ezsignfoldertype_completion);
    ...
    // ezsignfoldertype_response->b_ezsignfoldertype_automaticsignature
    if(ezsignfoldertype_response->b_ezsignfoldertype_automaticsignature) {
    if(cJSON_AddBoolToObject(item, "bEzsignfoldertypeAutomaticsignature", *ezsignfoldertype_response->b_ezsignfoldertype_automaticsignature) == NULL) {
    goto fail; //Bool
    }
    }


    // ezsignfoldertype_response->b_ezsignfoldertype_delegate
    if(ezsignfoldertype_response->b_ezsignfoldertype_delegate) {
    if(cJSON_AddBoolToObject(item, "bEzsignfoldertypeDelegate", *ezsignfoldertype_response->b_ezsignfoldertype_delegate) == NULL) {
    goto fail; //Bool
    }
    }


    // ezsignfoldertype_response->b_ezsignfoldertype_discussion
    if(ezsignfoldertype_response->b_ezsignfoldertype_discussion) {
    if(cJSON_AddBoolToObject(item, "bEzsignfoldertypeDiscussion", *ezsignfoldertype_response->b_ezsignfoldertype_discussion) == NULL) {
    goto fail; //Bool
    }
    }


    // ezsignfoldertype_response->b_ezsignfoldertype_reassignezsignsigner
    if(ezsignfoldertype_response->b_ezsignfoldertype_reassignezsignsigner) {
    if(cJSON_AddBoolToObject(item, "bEzsignfoldertypeReassignezsignsigner", *ezsignfoldertype_response->b_ezsignfoldertype_reassignezsignsigner) == NULL) {
    goto fail; //Bool
    }
    }


    // ezsignfoldertype_response->b_ezsignfoldertype_reassignuser
    if(ezsignfoldertype_response->b_ezsignfoldertype_reassignuser) {
    if(cJSON_AddBoolToObject(item, "bEzsignfoldertypeReassignuser", *ezsignfoldertype_response->b_ezsignfoldertype_reassignuser) == NULL) {
    goto fail; //Bool
    }
    }


    // ezsignfoldertype_response->b_ezsignfoldertype_reassigngroup
    if(ezsignfoldertype_response->b_ezsignfoldertype_reassigngroup) {
    if(cJSON_AddBoolToObject(item, "bEzsignfoldertypeReassigngroup", *ezsignfoldertype_response->b_ezsignfoldertype_reassigngroup) == NULL) {
    goto fail; //Bool
    }
    }


    // ezsignfoldertype_response->b_ezsignfoldertype_sendsignedtoezsignsigner
    if(ezsignfoldertype_response->b_ezsignfoldertype_sendsignedtoezsignsigner) {
    if(cJSON_AddBoolToObject(item, "bEzsignfoldertypeSendsignedtoezsignsigner", *ezsignfoldertype_response->b_ezsignfoldertype_sendsignedtoezsignsigner) == NULL) {
    goto fail; //Bool
    }
    }


    // ezsignfoldertype_response->b_ezsignfoldertype_sendsignedtouser
    if(ezsignfoldertype_response->b_ezsignfoldertype_sendsignedtouser) {
    if(cJSON_AddBoolToObject(item, "bEzsignfoldertypeSendsignedtouser", *ezsignfoldertype_response->b_ezsignfoldertype_sendsignedtouser) == NULL) {
    goto fail; //Bool
    }
    }


    // ezsignfoldertype_response->b_ezsignfoldertype_sendattachmentezsignsigner
    if(ezsignfoldertype_response->b_ezsignfoldertype_sendattachmentezsignsigner) {
    if(cJSON_AddBoolToObject(item, "bEzsignfoldertypeSendattachmentezsignsigner", *ezsignfoldertype_response->b_ezsignfoldertype_sendattachmentezsignsigner) == NULL) {
    goto fail; //Bool
    }
    }


    // ezsignfoldertype_response->b_ezsignfoldertype_sendproofezsignsigner
    if(ezsignfoldertype_response->b_ezsignfoldertype_sendproofezsignsigner) {
    if(cJSON_AddBoolToObject(item, "bEzsignfoldertypeSendproofezsignsigner", *ezsignfoldertype_response->b_ezsignfoldertype_sendproofezsignsigner) == NULL) {
    goto fail; //Bool
    }
    }


    // ezsignfoldertype_response->b_ezsignfoldertype_sendattachmentuser
    if(ezsignfoldertype_response->b_ezsignfoldertype_sendattachmentuser) {
    if(cJSON_AddBoolToObject(item, "bEzsignfoldertypeSendattachmentuser", *ezsignfoldertype_response->b_ezsignfoldertype_sendattachmentuser) == NULL) {
    goto fail; //Bool
    }
    }


    // ezsignfoldertype_response->b_ezsignfoldertype_sendproofuser
    if(ezsignfoldertype_response->b_ezsignfoldertype_sendproofuser) {
    if(cJSON_AddBoolToObject(item, "bEzsignfoldertypeSendproofuser", *ezsignfoldertype_response->b_ezsignfoldertype_sendproofuser) == NULL) {
    goto fail; //Bool
    }
    }


    // ezsignfoldertype_response->b_ezsignfoldertype_sendproofemail
    if(ezsignfoldertype_response->b_ezsignfoldertype_sendproofemail) {
    if(cJSON_AddBoolToObject(item, "bEzsignfoldertypeSendproofemail", *ezsignfoldertype_response->b_ezsignfoldertype_sendproofemail) == NULL) {
    goto fail; //Bool
    }
    }


    // ezsignfoldertype_response->b_ezsignfoldertype_allowdownloadattachmentezsignsigner
    if(ezsignfoldertype_response->b_ezsignfoldertype_allowdownloadattachmentezsignsigner) {
    if(cJSON_AddBoolToObject(item, "bEzsignfoldertypeAllowdownloadattachmentezsignsigner", *ezsignfoldertype_response->b_ezsignfoldertype_allowdownloadattachmentezsignsigner) == NULL) {
    goto fail; //Bool
    }
    }


    // ezsignfoldertype_response->b_ezsignfoldertype_allowdownloadproofezsignsigner
    if(ezsignfoldertype_response->b_ezsignfoldertype_allowdownloadproofezsignsigner) {
    if(cJSON_AddBoolToObject(item, "bEzsignfoldertypeAllowdownloadproofezsignsigner", *ezsignfoldertype_response->b_ezsignfoldertype_allowdownloadproofezsignsigner) == NULL) {
    goto fail; //Bool
    }
    }


    // ezsignfoldertype_response->b_ezsignfoldertype_sendproofreceivealldocument
    if(ezsignfoldertype_response->b_ezsignfoldertype_sendproofreceivealldocument) {
    if(cJSON_AddBoolToObject(item, "bEzsignfoldertypeSendproofreceivealldocument", *ezsignfoldertype_response->b_ezsignfoldertype_sendproofreceivealldocument) == NULL) {
    goto fail; //Bool
    }
    }
    ...
    // ezsignfoldertype_response->a_obj_userlogintype
    if (!ezsignfoldertype_response->a_obj_userlogintype) {
        goto fail;
    }
    ...
    if (ezsignfoldertype_response->a_obj_userlogintype) {
    list_ForEach(a_obj_userlogintypeListEntry, ezsignfoldertype_response->a_obj_userlogintype) {
...
ezsignfoldertype_response_t *ezsignfoldertype_response_parseFromJSON(cJSON *ezsignfoldertype_responseJSON){
    ...
    // define the local variable for ezsignfoldertype_response->pki_ezsignfoldertype_id
    ...
    // define the local variable for ezsignfoldertype_response->fki_branding_id
    int *fki_branding_id_local_var = NULL;

    // define the local variable for ezsignfoldertype_response->fki_billingentityinternal_id
    int *fki_billingentityinternal_id_local_var = NULL;

    // define the local variable for ezsignfoldertype_response->fki_usergroup_id
    int *fki_usergroup_id_local_var = NULL;

    // define the local variable for ezsignfoldertype_response->fki_usergroup_id_restricted
    int *fki_usergroup_id_restricted_local_var = NULL;

    // define the local variable for ezsignfoldertype_response->fki_ezsigntsarequirement_id
    ...
    char *s_usergroup_name_x_restricted_local_str = NULL;
    ...
    ezmax_api_definition__full_field_e_ezsignfoldertype_sendreminderfrequency__e e_ezsignfoldertype_sendreminderfrequency_local_nonprim = 0;

    // define the local variable for ezsignfoldertype_response->i_ezsignfoldertype_archivaldays
    ...
    // define the local variable for ezsignfoldertype_response->e_ezsignfoldertype_completion
    ezmax_api_definition__full_field_e_ezsignfoldertype_completion__e e_ezsignfoldertype_completion_local_nonprim = 0;

    // define the local variable for ezsignfoldertype_response->i_ezsignfoldertype_disposaldays
    int *i_ezsignfoldertype_disposaldays_local_var = NULL;

    // define the local variable for ezsignfoldertype_response->i_ezsignfoldertype_deadlinedays
    int *i_ezsignfoldertype_deadlinedays_local_var = NULL;

    // define the local variable for ezsignfoldertype_response->b_ezsignfoldertype_automaticsignature
    int *b_ezsignfoldertype_automaticsignature_local_var = NULL;

    // define the local variable for ezsignfoldertype_response->b_ezsignfoldertype_delegate
    int *b_ezsignfoldertype_delegate_local_var = NULL;

    // define the local variable for ezsignfoldertype_response->b_ezsignfoldertype_discussion
    int *b_ezsignfoldertype_discussion_local_var = NULL;

    // define the local variable for ezsignfoldertype_response->b_ezsignfoldertype_reassignezsignsigner
    int *b_ezsignfoldertype_reassignezsignsigner_local_var = NULL;

    // define the local variable for ezsignfoldertype_response->b_ezsignfoldertype_reassignuser
    int *b_ezsignfoldertype_reassignuser_local_var = NULL;

    // define the local variable for ezsignfoldertype_response->b_ezsignfoldertype_reassigngroup
    int *b_ezsignfoldertype_reassigngroup_local_var = NULL;

    // define the local variable for ezsignfoldertype_response->b_ezsignfoldertype_sendsignedtoezsignsigner
    int *b_ezsignfoldertype_sendsignedtoezsignsigner_local_var = NULL;

    // define the local variable for ezsignfoldertype_response->b_ezsignfoldertype_sendsignedtouser
    int *b_ezsignfoldertype_sendsignedtouser_local_var = NULL;

    // define the local variable for ezsignfoldertype_response->b_ezsignfoldertype_sendattachmentezsignsigner
    int *b_ezsignfoldertype_sendattachmentezsignsigner_local_var = NULL;

    // define the local variable for ezsignfoldertype_response->b_ezsignfoldertype_sendproofezsignsigner
    int *b_ezsignfoldertype_sendproofezsignsigner_local_var = NULL;

    // define the local variable for ezsignfoldertype_response->b_ezsignfoldertype_sendattachmentuser
    int *b_ezsignfoldertype_sendattachmentuser_local_var = NULL;

    // define the local variable for ezsignfoldertype_response->b_ezsignfoldertype_sendproofuser
    int *b_ezsignfoldertype_sendproofuser_local_var = NULL;

    // define the local variable for ezsignfoldertype_response->b_ezsignfoldertype_sendproofemail
    int *b_ezsignfoldertype_sendproofemail_local_var = NULL;

    // define the local variable for ezsignfoldertype_response->b_ezsignfoldertype_allowdownloadattachmentezsignsigner
    int *b_ezsignfoldertype_allowdownloadattachmentezsignsigner_local_var = NULL;

    // define the local variable for ezsignfoldertype_response->b_ezsignfoldertype_allowdownloadproofezsignsigner
    int *b_ezsignfoldertype_allowdownloadproofezsignsigner_local_var = NULL;

    // define the local variable for ezsignfoldertype_response->b_ezsignfoldertype_sendproofreceivealldocument
    int *b_ezsignfoldertype_sendproofreceivealldocument_local_var = NULL;

    // define the local variable for ezsignfoldertype_response->b_ezsignfoldertype_sendsignedtodocumentowner
    int *b_ezsignfoldertype_sendsignedtodocumentowner_local_var = NULL;

    // define the local variable for ezsignfoldertype_response->b_ezsignfoldertype_sendsignedtofolderowner
    int *b_ezsignfoldertype_sendsignedtofolderowner_local_var = NULL;

    // define the local variable for ezsignfoldertype_response->b_ezsignfoldertype_sendsignedtofullgroup
    int *b_ezsignfoldertype_sendsignedtofullgroup_local_var = NULL;

    // define the local variable for ezsignfoldertype_response->b_ezsignfoldertype_sendsignedtolimitedgroup
    int *b_ezsignfoldertype_sendsignedtolimitedgroup_local_var = NULL;

    // define the local variable for ezsignfoldertype_response->b_ezsignfoldertype_sendsignedtocolleague
    int *b_ezsignfoldertype_sendsignedtocolleague_local_var = NULL;

    // define the local variable for ezsignfoldertype_response->b_ezsignfoldertype_sendsummarytodocumentowner
    int *b_ezsignfoldertype_sendsummarytodocumentowner_local_var = NULL;

    // define the local variable for ezsignfoldertype_response->b_ezsignfoldertype_sendsummarytofolderowner
    int *b_ezsignfoldertype_sendsummarytofolderowner_local_var = NULL;

    // define the local variable for ezsignfoldertype_response->b_ezsignfoldertype_sendsummarytofullgroup
    int *b_ezsignfoldertype_sendsummarytofullgroup_local_var = NULL;

    // define the local variable for ezsignfoldertype_response->b_ezsignfoldertype_sendsummarytolimitedgroup
    int *b_ezsignfoldertype_sendsummarytolimitedgroup_local_var = NULL;

    // define the local variable for ezsignfoldertype_response->b_ezsignfoldertype_sendsummarytocolleague
    int *b_ezsignfoldertype_sendsummarytocolleague_local_var = NULL;

    // define the local variable for ezsignfoldertype_response->b_ezsignfoldertype_isactive
    int *b_ezsignfoldertype_isactive_local_var = NULL;

    // define the local list for ezsignfoldertype_response->a_obj_userlogintype
    ...
    *fki_usergroup_id_local_var = fki_usergroup_id->valuedouble;
    ...
    if (cJSON_IsNull(fki_usergroup_id_restricted)) {
        fki_usergroup_id_restricted = NULL;
    }
    if (fki_usergroup_id_restricted) { 
    ...
    fki_usergroup_id_restricted_local_var = malloc(sizeof(int));
    if(!fki_usergroup_id_restricted_local_var)
    {
        goto end;
    }
    *fki_usergroup_id_restricted_local_var = fki_usergroup_id_restricted->valuedouble;
    }
    ...
    *fki_ezsigntsarequirement_id_local_var = fki_ezsigntsarequirement_id->valuedouble;
    ...
    if (cJSON_IsNull(s_usergroup_name_x_restricted)) {
        s_usergroup_name_x_restricted = NULL;
    }
    ...
    if (cJSON_IsNull(e_ezsignfoldertype_sendreminderfrequency)) {
    ...
    *i_ezsignfoldertype_archivaldays_local_var = i_ezsignfoldertype_archivaldays->valuedouble;
    ...
    // ezsignfoldertype_response->e_ezsignfoldertype_completion
    cJSON *e_ezsignfoldertype_completion = cJSON_GetObjectItemCaseSensitive(ezsignfoldertype_responseJSON, "eEzsignfoldertypeCompletion");
    ...
    *i_ezsignfoldertype_deadlinedays_local_var = i_ezsignfoldertype_deadlinedays->valuedouble;
    ...
    // ezsignfoldertype_response->b_ezsignfoldertype_automaticsignature
    cJSON *b_ezsignfoldertype_automaticsignature = cJSON_GetObjectItemCaseSensitive(ezsignfoldertype_responseJSON, "bEzsignfoldertypeAutomaticsignature");
    ...
    *b_ezsignfoldertype_automaticsignature_local_var = b_ezsignfoldertype_automaticsignature->valueint;
    ...
    // ezsignfoldertype_response->b_ezsignfoldertype_delegate
    cJSON *b_ezsignfoldertype_delegate = cJSON_GetObjectItemCaseSensitive(ezsignfoldertype_responseJSON, "bEzsignfoldertypeDelegate");
    ...
    *b_ezsignfoldertype_delegate_local_var = b_ezsignfoldertype_delegate->valueint;
    ...
    // ezsignfoldertype_response->b_ezsignfoldertype_discussion
    cJSON *b_ezsignfoldertype_discussion = cJSON_GetObjectItemCaseSensitive(ezsignfoldertype_responseJSON, "bEzsignfoldertypeDiscussion");
    ...
    *b_ezsignfoldertype_discussion_local_var = b_ezsignfoldertype_discussion->valueint;
    ...
    // ezsignfoldertype_response->b_ezsignfoldertype_reassignezsignsigner
    cJSON *b_ezsignfoldertype_reassignezsignsigner = cJSON_GetObjectItemCaseSensitive(ezsignfoldertype_responseJSON, "bEzsignfoldertypeReassignezsignsigner");
    ...
    *b_ezsignfoldertype_reassignezsignsigner_local_var = b_ezsignfoldertype_reassignezsignsigner->valueint;
    ...
    // ezsignfoldertype_response->b_ezsignfoldertype_reassignuser
    cJSON *b_ezsignfoldertype_reassignuser = cJSON_GetObjectItemCaseSensitive(ezsignfoldertype_responseJSON, "bEzsignfoldertypeReassignuser");
    ...
    *b_ezsignfoldertype_reassignuser_local_var = b_ezsignfoldertype_reassignuser->valueint;
    ...
    // ezsignfoldertype_response->b_ezsignfoldertype_reassigngroup
    cJSON *b_ezsignfoldertype_reassigngroup = cJSON_GetObjectItemCaseSensitive(ezsignfoldertype_responseJSON, "bEzsignfoldertypeReassigngroup");
    ...
    *b_ezsignfoldertype_reassigngroup_local_var = b_ezsignfoldertype_reassigngroup->valueint;
    ...
    // ezsignfoldertype_response->b_ezsignfoldertype_sendsignedtoezsignsigner
    cJSON *b_ezsignfoldertype_sendsignedtoezsignsigner = cJSON_GetObjectItemCaseSensitive(ezsignfoldertype_responseJSON, "bEzsignfoldertypeSendsignedtoezsignsigner");
    ...
    *b_ezsignfoldertype_sendsignedtoezsignsigner_local_var = b_ezsignfoldertype_sendsignedtoezsignsigner->valueint;
    ...
    // ezsignfoldertype_response->b_ezsignfoldertype_sendsignedtouser
    cJSON *b_ezsignfoldertype_sendsignedtouser = cJSON_GetObjectItemCaseSensitive(ezsignfoldertype_responseJSON, "bEzsignfoldertypeSendsignedtouser");
    ...
    *b_ezsignfoldertype_sendsignedtouser_local_var = b_ezsignfoldertype_sendsignedtouser->valueint;
    ...
    // ezsignfoldertype_response->b_ezsignfoldertype_sendattachmentezsignsigner
    cJSON *b_ezsignfoldertype_sendattachmentezsignsigner = cJSON_GetObjectItemCaseSensitive(ezsignfoldertype_responseJSON, "bEzsignfoldertypeSendattachmentezsignsigner");
    ...
    *b_ezsignfoldertype_sendattachmentezsignsigner_local_var = b_ezsignfoldertype_sendattachmentezsignsigner->valueint;
    ...
    // ezsignfoldertype_response->b_ezsignfoldertype_sendproofezsignsigner
    cJSON *b_ezsignfoldertype_sendproofezsignsigner = cJSON_GetObjectItemCaseSensitive(ezsignfoldertype_responseJSON, "bEzsignfoldertypeSendproofezsignsigner");
    ...
    *b_ezsignfoldertype_sendproofezsignsigner_local_var = b_ezsignfoldertype_sendproofezsignsigner->valueint;
    ...
    // ezsignfoldertype_response->b_ezsignfoldertype_sendattachmentuser
    cJSON *b_ezsignfoldertype_sendattachmentuser = cJSON_GetObjectItemCaseSensitive(ezsignfoldertype_responseJSON, "bEzsignfoldertypeSendattachmentuser");
    ...
    *b_ezsignfoldertype_sendattachmentuser_local_var = b_ezsignfoldertype_sendattachmentuser->valueint;
    ...
    // ezsignfoldertype_response->b_ezsignfoldertype_sendproofuser
    cJSON *b_ezsignfoldertype_sendproofuser = cJSON_GetObjectItemCaseSensitive(ezsignfoldertype_responseJSON, "bEzsignfoldertypeSendproofuser");
    ...
    *b_ezsignfoldertype_sendproofuser_local_var = b_ezsignfoldertype_sendproofuser->valueint;
    ...
    // ezsignfoldertype_response->b_ezsignfoldertype_sendproofemail
    cJSON *b_ezsignfoldertype_sendproofemail = cJSON_GetObjectItemCaseSensitive(ezsignfoldertype_responseJSON, "bEzsignfoldertypeSendproofemail");
    ...
    *b_ezsignfoldertype_sendproofemail_local_var = b_ezsignfoldertype_sendproofemail->valueint;
    ...
    // ezsignfoldertype_response->b_ezsignfoldertype_allowdownloadattachmentezsignsigner
    cJSON *b_ezsignfoldertype_allowdownloadattachmentezsignsigner = cJSON_GetObjectItemCaseSensitive(ezsignfoldertype_responseJSON, "bEzsignfoldertypeAllowdownloadattachmentezsignsigner");
    ...
    *b_ezsignfoldertype_allowdownloadattachmentezsignsigner_local_var = b_ezsignfoldertype_allowdownloadattachmentezsignsigner->valueint;
    ...
    // ezsignfoldertype_response->b_ezsignfoldertype_allowdownloadproofezsignsigner
    cJSON *b_ezsignfoldertype_allowdownloadproofezsignsigner = cJSON_GetObjectItemCaseSensitive(ezsignfoldertype_responseJSON, "bEzsignfoldertypeAllowdownloadproofezsignsigner");
    ...
    *b_ezsignfoldertype_allowdownloadproofezsignsigner_local_var = b_ezsignfoldertype_allowdownloadproofezsignsigner->valueint;
    ...
    // ezsignfoldertype_response->b_ezsignfoldertype_sendproofreceivealldocument
    cJSON *b_ezsignfoldertype_sendproofreceivealldocument = cJSON_GetObjectItemCaseSensitive(ezsignfoldertype_responseJSON, "bEzsignfoldertypeSendproofreceivealldocument");
    ...
    *b_ezsignfoldertype_isactive_local_var = b_ezsignfoldertype_isactive->valueint;
    ...
    // ezsignfoldertype_response->a_obj_userlogintype
    cJSON *a_obj_userlogintype = cJSON_GetObjectItemCaseSensitive(ezsignfoldertype_responseJSON, "a_objUserlogintype");
    ...
    if (s_usergroup_name_x_restricted && !cJSON_IsNull(s_usergroup_name_x_restricted)) s_usergroup_name_x_restricted_local_str = strdup(s_usergroup_name_x_restricted->valuestring);

    ezsignfoldertype_response_local_var = ezsignfoldertype_response_create_internal (
        ...
        fki_usergroup_id_restricted_local_var,
        ...
        s_usergroup_name_x_restricted_local_str,
        e_ezsignfoldertype_privacylevel_local_nonprim,
        e_ezsignfoldertype_sendreminderfrequency ? e_ezsignfoldertype_sendreminderfrequency_local_nonprim : 0,
    ...
    if (fki_usergroup_id_restricted_local_var) {
        free(fki_usergroup_id_restricted_local_var);
        fki_usergroup_id_restricted_local_var = NULL;
    }
    if (fki_ezsigntsarequirement_id_local_var) {
    ...
    if (s_usergroup_name_x_restricted_local_str) {
        free(s_usergroup_name_x_restricted_local_str);
        s_usergroup_name_x_restricted_local_str = NULL;
    }
    ...
    if (e_ezsignfoldertype_sendreminderfrequency_local_nonprim) {
        e_ezsignfoldertype_sendreminderfrequency_local_nonprim = 0;
    }
    if (i_ezsignfoldertype_archivaldays_local_var) {
