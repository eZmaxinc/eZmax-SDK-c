...
typedef enum { ezmax_api_definition__full_enum_reportdata_type__NULL = 0, ezmax_api_definition__full_enum_reportdata_type__Date, ezmax_api_definition__full_enum_reportdata_type__FileSize, ezmax_api_definition__full_enum_reportdata_type__Integer, ezmax_api_definition__full_enum_reportdata_type__Money, ezmax_api_definition__full_enum_reportdata_type__Number, ezmax_api_definition__full_enum_reportdata_type__Percentage, ezmax_api_definition__full_enum_reportdata_type__PercentageInt, ezmax_api_definition__full_enum_reportdata_type__Period, ezmax_api_definition__full_enum_reportdata_type__String } ezmax_api_definition__full_enum_reportdata_type__e;
