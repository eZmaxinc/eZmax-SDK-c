...
static invoice_get_communicationsenders_v1_response_t *invoice_get_communicationsenders_v1_response_create_internal(
    ...
    memset(invoice_get_communicationsenders_v1_response_local_var, 0, sizeof(invoice_get_communicationsenders_v1_response_t));
...
__attribute__((deprecated)) invoice_get_communicationsenders_v1_response_t *invoice_get_communicationsenders_v1_response_create(
    ...
    invoice_get_communicationsenders_v1_response_t *result = invoice_get_communicationsenders_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
