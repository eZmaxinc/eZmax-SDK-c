...
static variableexpense_edit_object_v1_response_t *variableexpense_edit_object_v1_response_create_internal(
    ...
    memset(variableexpense_edit_object_v1_response_local_var, 0, sizeof(variableexpense_edit_object_v1_response_t));
...
__attribute__((deprecated)) variableexpense_edit_object_v1_response_t *variableexpense_edit_object_v1_response_create(
    ...
    variableexpense_edit_object_v1_response_t *result = variableexpense_edit_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug
        );
    if (!result) {
