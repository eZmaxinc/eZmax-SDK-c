/*
 * electronicfundstransfer_batch_download_v1_request.h
 *
 * Request for POST /1/object/electronicfundstransfer/{pkiElectronicfundstransferID}/batchDownload
 */

#ifndef _electronicfundstransfer_batch_download_v1_request_H_
#define _electronicfundstransfer_batch_download_v1_request_H_
...
typedef struct electronicfundstransfer_batch_download_v1_request_t electronicfundstransfer_batch_download_v1_request_t;




typedef struct electronicfundstransfer_batch_download_v1_request_t {
    list_t *a_pki_attachment_id; //primitive container

    int _library_owned; // Is the library responsible for freeing this object?
} electronicfundstransfer_batch_download_v1_request_t;
...
#endif /* _electronicfundstransfer_batch_download_v1_request_H_ */
