...
static ezsignsignature_create_object_v2_response_m_payload_t *ezsignsignature_create_object_v2_response_m_payload_create_internal(
    list_t *a_pki_ezsignsignature_id
    ) {
    ezsignsignature_create_object_v2_response_m_payload_t *ezsignsignature_create_object_v2_response_m_payload_local_var = malloc(sizeof(ezsignsignature_create_object_v2_response_m_payload_t));
    if (!ezsignsignature_create_object_v2_response_m_payload_local_var) {
        return NULL;
    }
    memset(ezsignsignature_create_object_v2_response_m_payload_local_var, 0, sizeof(ezsignsignature_create_object_v2_response_m_payload_t));
    ezsignsignature_create_object_v2_response_m_payload_local_var->_library_owned = 1;
    ezsignsignature_create_object_v2_response_m_payload_local_var->a_pki_ezsignsignature_id = a_pki_ezsignsignature_id;
...
__attribute__((deprecated)) ezsignsignature_create_object_v2_response_m_payload_t *ezsignsignature_create_object_v2_response_m_payload_create(
    ...
    ezsignsignature_create_object_v2_response_m_payload_t *result = ezsignsignature_create_object_v2_response_m_payload_create_internal (
...
void ezsignsignature_create_object_v2_response_m_payload_free(ezsignsignature_create_object_v2_response_m_payload_t *ezsignsignature_create_object_v2_response_m_payload) {
    if(NULL == ezsignsignature_create_object_v2_response_m_payload){
        return ;
    }
    if(ezsignsignature_create_object_v2_response_m_payload->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsignsignature_create_object_v2_response_m_payload_free");
        return ;
    }
    listEntry_t *listEntry;
    if (ezsignsignature_create_object_v2_response_m_payload->a_pki_ezsignsignature_id) {
        list_ForEach(listEntry, ezsignsignature_create_object_v2_response_m_payload->a_pki_ezsignsignature_id) {
            free(listEntry->data);
        }
        list_freeList(ezsignsignature_create_object_v2_response_m_payload->a_pki_ezsignsignature_id);
        ezsignsignature_create_object_v2_response_m_payload->a_pki_ezsignsignature_id = NULL;
    }
    free(ezsignsignature_create_object_v2_response_m_payload);
}
...
cJSON *ezsignsignature_create_object_v2_response_m_payload_convertToJSON(ezsignsignature_create_object_v2_response_m_payload_t *ezsignsignature_create_object_v2_response_m_payload) {
    ...
    list_ForEach(a_pki_ezsignsignature_idListEntry, ezsignsignature_create_object_v2_response_m_payload->a_pki_ezsignsignature_id) {
...
ezsignsignature_create_object_v2_response_m_payload_t *ezsignsignature_create_object_v2_response_m_payload_parseFromJSON(cJSON *ezsignsignature_create_object_v2_response_m_payloadJSON){
    ...
    ezsignsignature_create_object_v2_response_m_payload_local_var = ezsignsignature_create_object_v2_response_m_payload_create_internal (
