...
char* ezsigntemplatesignature_request_e_ezsigntemplatesignature_positioning_ToString(ezmax_api_definition__full_ezsigntemplatesignature_request__e e_ezsigntemplatesignature_positioning) {
...
ezmax_api_definition__full_ezsigntemplatesignature_request__e ezsigntemplatesignature_request_e_ezsigntemplatesignature_positioning_FromString(char* e_ezsigntemplatesignature_positioning){
...
char* ezsigntemplatesignature_request_e_ezsigntemplatesignature_consultationtrigger_ToString(ezmax_api_definition__full_ezsigntemplatesignature_request__e e_ezsigntemplatesignature_consultationtrigger) {
...
ezmax_api_definition__full_ezsigntemplatesignature_request__e ezsigntemplatesignature_request_e_ezsigntemplatesignature_consultationtrigger_FromString(char* e_ezsigntemplatesignature_consultationtrigger){
    int stringToReturn = 0;
    char *e_ezsigntemplatesignature_consultationtriggerArray[] =  { "NULL", "Automatic", "Manual" };
...
char* ezsigntemplatesignature_request_e_ezsigntemplatesignature_positioningoccurence_ToString(ezmax_api_definition__full_ezsigntemplatesignature_request__e e_ezsigntemplatesignature_positioningoccurence) {
...
ezmax_api_definition__full_ezsigntemplatesignature_request__e ezsigntemplatesignature_request_e_ezsigntemplatesignature_positioningoccurence_FromString(char* e_ezsigntemplatesignature_positioningoccurence){
    int stringToReturn = 0;
    char *e_ezsigntemplatesignature_positioningoccurenceArray[] =  { "NULL", "All", "First", "Last" };
...
void ezsigntemplatesignature_request_free(ezsigntemplatesignature_request_t *ezsigntemplatesignature_request) {
    ...
    if (ezsigntemplatesignature_request->e_ezsigntemplatesignature_positioning) {
        field_e_ezsigntemplatesignature_positioning_free(ezsigntemplatesignature_request->e_ezsigntemplatesignature_positioning);
        ezsigntemplatesignature_request->e_ezsigntemplatesignature_positioning = NULL;
    }
    ...
    if (ezsigntemplatesignature_request->e_ezsigntemplatesignature_consultationtrigger) {
        field_e_ezsigntemplatesignature_consultationtrigger_free(ezsigntemplatesignature_request->e_ezsigntemplatesignature_consultationtrigger);
        ezsigntemplatesignature_request->e_ezsigntemplatesignature_consultationtrigger = NULL;
    }
    ...
    if (ezsigntemplatesignature_request->e_ezsigntemplatesignature_positioningoccurence) {
        field_e_ezsigntemplatesignature_positioningoccurence_free(ezsigntemplatesignature_request->e_ezsigntemplatesignature_positioningoccurence);
        ezsigntemplatesignature_request->e_ezsigntemplatesignature_positioningoccurence = NULL;
    }
...
cJSON *ezsigntemplatesignature_request_convertToJSON(ezsigntemplatesignature_request_t *ezsigntemplatesignature_request) {
    ...
    if(ezsigntemplatesignature_request->e_ezsigntemplatesignature_positioning != ezmax_api_definition__full_ezsigntemplatesignature_request__NULL) {
    ...
    if(ezsigntemplatesignature_request->e_ezsigntemplatesignature_consultationtrigger != ezmax_api_definition__full_ezsigntemplatesignature_request__NULL) {
    ...
    if(ezsigntemplatesignature_request->e_ezsigntemplatesignature_positioningoccurence != ezmax_api_definition__full_ezsigntemplatesignature_request__NULL) {
