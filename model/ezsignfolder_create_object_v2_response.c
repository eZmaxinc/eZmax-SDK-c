...
static ezsignfolder_create_object_v2_response_t *ezsignfolder_create_object_v2_response_create_internal(
    ...
    memset(ezsignfolder_create_object_v2_response_local_var, 0, sizeof(ezsignfolder_create_object_v2_response_t));
...
__attribute__((deprecated)) ezsignfolder_create_object_v2_response_t *ezsignfolder_create_object_v2_response_create(
    ...
    ezsignfolder_create_object_v2_response_t *result = ezsignfolder_create_object_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
