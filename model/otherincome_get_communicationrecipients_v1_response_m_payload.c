...
void otherincome_get_communicationrecipients_v1_response_m_payload_free(otherincome_get_communicationrecipients_v1_response_m_payload_t *otherincome_get_communicationrecipients_v1_response_m_payload) {
    ...
    if (otherincome_get_communicationrecipients_v1_response_m_payload->a_obj_communicationrecipientsgroup) {
        list_ForEach(listEntry, otherincome_get_communicationrecipients_v1_response_m_payload->a_obj_communicationrecipientsgroup) {
            custom_communicationrecipientsgroup_response_free(listEntry->data);
        }
        list_freeList(otherincome_get_communicationrecipients_v1_response_m_payload->a_obj_communicationrecipientsgroup);
        otherincome_get_communicationrecipients_v1_response_m_payload->a_obj_communicationrecipientsgroup = NULL;
    }
    free(otherincome_get_communicationrecipients_v1_response_m_payload);
}
...
cJSON *otherincome_get_communicationrecipients_v1_response_m_payload_convertToJSON(otherincome_get_communicationrecipients_v1_response_m_payload_t *otherincome_get_communicationrecipients_v1_response_m_payload) {
    ...
    if (otherincome_get_communicationrecipients_v1_response_m_payload->a_obj_communicationrecipientsgroup) {
    list_ForEach(a_obj_communicationrecipientsgroupListEntry, otherincome_get_communicationrecipients_v1_response_m_payload->a_obj_communicationrecipientsgroup) {
...
otherincome_get_communicationrecipients_v1_response_m_payload_t *otherincome_get_communicationrecipients_v1_response_m_payload_parseFromJSON(cJSON *otherincome_get_communicationrecipients_v1_response_m_payloadJSON){
    ...
    otherincome_get_communicationrecipients_v1_response_m_payload_t *otherincome_get_communicationrecipients_v1_response_m_payload_local_var = NULL;

    // define the local list for otherincome_get_communicationrecipients_v1_response_m_payload->a_obj_communicationrecipientsgroup
