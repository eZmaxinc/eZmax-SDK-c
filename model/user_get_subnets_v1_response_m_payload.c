...
static user_get_subnets_v1_response_m_payload_t *user_get_subnets_v1_response_m_payload_create_internal(
    ...
    memset(user_get_subnets_v1_response_m_payload_local_var, 0, sizeof(user_get_subnets_v1_response_m_payload_t));
...
__attribute__((deprecated)) user_get_subnets_v1_response_m_payload_t *user_get_subnets_v1_response_m_payload_create(
    ...
    user_get_subnets_v1_response_m_payload_t *result = user_get_subnets_v1_response_m_payload_create_internal (
        a_obj_subnet
        );
    if (!result) {
    }
