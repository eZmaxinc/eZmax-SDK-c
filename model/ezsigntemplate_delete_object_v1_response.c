...
static ezsigntemplate_delete_object_v1_response_t *ezsigntemplate_delete_object_v1_response_create_internal(
    ...
    memset(ezsigntemplate_delete_object_v1_response_local_var, 0, sizeof(ezsigntemplate_delete_object_v1_response_t));
    ezsigntemplate_delete_object_v1_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezsigntemplate_delete_object_v1_response_t *ezsigntemplate_delete_object_v1_response_create(
    ...
    ezsigntemplate_delete_object_v1_response_t *result = ezsigntemplate_delete_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug
        );
    if (!result) {
...
void ezsigntemplate_delete_object_v1_response_free(ezsigntemplate_delete_object_v1_response_t *ezsigntemplate_delete_object_v1_response) {
    ...
    if(ezsigntemplate_delete_object_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsigntemplate_delete_object_v1_response_free");
        return ;
    }
...
ezsigntemplate_delete_object_v1_response_t *ezsigntemplate_delete_object_v1_response_parseFromJSON(cJSON *ezsigntemplate_delete_object_v1_responseJSON){
    ...
    ezsigntemplate_delete_object_v1_response_local_var = ezsigntemplate_delete_object_v1_response_create_internal (
