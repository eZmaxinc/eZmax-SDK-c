...
static ezsignfolder_get_communicationrecipients_v1_response_m_payload_t *ezsignfolder_get_communicationrecipients_v1_response_m_payload_create_internal(
...
void ezsignfolder_get_communicationrecipients_v1_response_m_payload_free(ezsignfolder_get_communicationrecipients_v1_response_m_payload_t *ezsignfolder_get_communicationrecipients_v1_response_m_payload) {
    ...
    if(ezsignfolder_get_communicationrecipients_v1_response_m_payload->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsignfolder_get_communicationrecipients_v1_response_m_payload_free");
        return ;
    }
