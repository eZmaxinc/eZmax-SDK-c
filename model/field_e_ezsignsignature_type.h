...
typedef enum { ezmax_api_definition__full_field_e_ezsignsignature_type__NULL = 0, ezmax_api_definition__full_field_e_ezsignsignature_type__Acknowledgement, ezmax_api_definition__full_field_e_ezsignsignature_type__Attachments, ezmax_api_definition__full_field_e_ezsignsignature_type__AttachmentsConfirmation, ezmax_api_definition__full_field_e_ezsignsignature_type__City, ezmax_api_definition__full_field_e_ezsignsignature_type__Consultation, ezmax_api_definition__full_field_e_ezsignsignature_type__Creditcard, ezmax_api_definition__full_field_e_ezsignsignature_type__FieldText, ezmax_api_definition__full_field_e_ezsignsignature_type__FieldTextarea, ezmax_api_definition__full_field_e_ezsignsignature_type__Handwritten, ezmax_api_definition__full_field_e_ezsignsignature_type__Initials, ezmax_api_definition__full_field_e_ezsignsignature_type__Name, ezmax_api_definition__full_field_e_ezsignsignature_type__NameReason, ezmax_api_definition__full_field_e_ezsignsignature_type__Signature } ezmax_api_definition__full_field_e_ezsignsignature_type__e;
