...
static ezsignelementdependency_response_compound_t *ezsignelementdependency_response_compound_create_internal(
    ...
    memset(ezsignelementdependency_response_compound_local_var, 0, sizeof(ezsignelementdependency_response_compound_t));
...
__attribute__((deprecated)) ezsignelementdependency_response_compound_t *ezsignelementdependency_response_compound_create(
    ...
    int *fki_ezsignformfield_id_copy = NULL;
    if (fki_ezsignformfield_id) {
        fki_ezsignformfield_id_copy = malloc(sizeof(int));
        if (fki_ezsignformfield_id_copy) *fki_ezsignformfield_id_copy = *fki_ezsignformfield_id;
    }
    ...
    ezsignelementdependency_response_compound_t *result = ezsignelementdependency_response_compound_create_internal (
        pki_ezsignelementdependency_id_copy,
        fki_ezsignformfield_id_copy,
    ...
    if (!result) {
        ...
        free(fki_ezsignformfield_id_copy);
...
void ezsignelementdependency_response_compound_free(ezsignelementdependency_response_compound_t *ezsignelementdependency_response_compound) {
    ...
    if (ezsignelementdependency_response_compound->pki_ezsignelementdependency_id) {
        free(ezsignelementdependency_response_compound->pki_ezsignelementdependency_id);
        ezsignelementdependency_response_compound->pki_ezsignelementdependency_id = NULL;
    }
    if (ezsignelementdependency_response_compound->fki_ezsignformfield_id) {
        free(ezsignelementdependency_response_compound->fki_ezsignformfield_id);
        ezsignelementdependency_response_compound->fki_ezsignformfield_id = NULL;
    }
    if (ezsignelementdependency_response_compound->fki_ezsignsignature_id) {
        free(ezsignelementdependency_response_compound->fki_ezsignsignature_id);
        ezsignelementdependency_response_compound->fki_ezsignsignature_id = NULL;
    }
    if (ezsignelementdependency_response_compound->fki_ezsignformfield_id_validation) {
        free(ezsignelementdependency_response_compound->fki_ezsignformfield_id_validation);
        ezsignelementdependency_response_compound->fki_ezsignformfield_id_validation = NULL;
    }
    if (ezsignelementdependency_response_compound->fki_ezsignformfieldgroup_id_validation) {
        free(ezsignelementdependency_response_compound->fki_ezsignformfieldgroup_id_validation);
        ezsignelementdependency_response_compound->fki_ezsignformfieldgroup_id_validation = NULL;
    }
    if (ezsignelementdependency_response_compound->b_ezsignelementdependency_selected) {
        free(ezsignelementdependency_response_compound->b_ezsignelementdependency_selected);
        ezsignelementdependency_response_compound->b_ezsignelementdependency_selected = NULL;
    }
...
ezsignelementdependency_response_compound_t *ezsignelementdependency_response_compound_parseFromJSON(cJSON *ezsignelementdependency_response_compoundJSON){
    ...
    // define the local variable for ezsignelementdependency_response_compound->pki_ezsignelementdependency_id
    int *pki_ezsignelementdependency_id_local_var = NULL;

    // define the local variable for ezsignelementdependency_response_compound->fki_ezsignformfield_id
    int *fki_ezsignformfield_id_local_var = NULL;

    // define the local variable for ezsignelementdependency_response_compound->fki_ezsignsignature_id
    int *fki_ezsignsignature_id_local_var = NULL;

    // define the local variable for ezsignelementdependency_response_compound->fki_ezsignformfield_id_validation
    int *fki_ezsignformfield_id_validation_local_var = NULL;

    // define the local variable for ezsignelementdependency_response_compound->fki_ezsignformfieldgroup_id_validation
    ...
    // define the local variable for ezsignelementdependency_response_compound->b_ezsignelementdependency_selected
    ...
    *pki_ezsignelementdependency_id_local_var = pki_ezsignelementdependency_id->valuedouble;
    ...
    fki_ezsignformfield_id_local_var = malloc(sizeof(int));
    if(!fki_ezsignformfield_id_local_var)
    {
        goto end;
    }
    *fki_ezsignformfield_id_local_var = fki_ezsignformfield_id->valuedouble;
    }
    ...
    *b_ezsignelementdependency_selected_local_var = b_ezsignelementdependency_selected->valueint;
    ...
    ezsignelementdependency_response_compound_local_var = ezsignelementdependency_response_compound_create_internal (
        ...
        fki_ezsignformfield_id_local_var,
    ...
    if (fki_ezsignformfield_id_local_var) {
        free(fki_ezsignformfield_id_local_var);
        fki_ezsignformfield_id_local_var = NULL;
    }
    if (fki_ezsignsignature_id_local_var) {
