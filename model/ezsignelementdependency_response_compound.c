...
char* e_ezsignelementdependency_validationezsignelementdependency_response_compound_ToString(ezmax_api_definition__full_ezsignelementdependency_response_compound__e e_ezsignelementdependency_validation) {
...
ezmax_api_definition__full_ezsignelementdependency_response_compound__e e_ezsignelementdependency_validationezsignelementdependency_response_compound_FromString(char* e_ezsignelementdependency_validation){
...
char* e_ezsignelementdependency_operatorezsignelementdependency_response_compound_ToString(ezmax_api_definition__full_ezsignelementdependency_response_compound__e e_ezsignelementdependency_operator) {
...
ezmax_api_definition__full_ezsignelementdependency_response_compound__e e_ezsignelementdependency_operatorezsignelementdependency_response_compound_FromString(char* e_ezsignelementdependency_operator){
    int stringToReturn = 0;
    char *e_ezsignelementdependency_operatorArray[] =  { "NULL", "eq", "neq", "gt", "gte", "lt", "lte", "in", "nin", "rg", "like", "between" };
