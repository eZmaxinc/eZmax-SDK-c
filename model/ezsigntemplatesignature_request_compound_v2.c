...
static ezsigntemplatesignature_request_compound_v2_t *ezsigntemplatesignature_request_compound_v2_create_internal(
    ...
    memset(ezsigntemplatesignature_request_compound_v2_local_var, 0, sizeof(ezsigntemplatesignature_request_compound_v2_t));
    ...
    ezsigntemplatesignature_request_compound_v2_local_var->fki_paymentgateway_id = fki_paymentgateway_id;
    ...
    ezsigntemplatesignature_request_compound_v2_local_var->b_ezsigntemplatesignature_creditcardcustomamount = b_ezsigntemplatesignature_creditcardcustomamount;
    ...
    ezsigntemplatesignature_request_compound_v2_local_var->e_ezsigntemplatesignature_signaturepad = e_ezsigntemplatesignature_signaturepad;
    ezsigntemplatesignature_request_compound_v2_local_var->e_ezsigntemplatesignature_signaturepadrequired = e_ezsigntemplatesignature_signaturepadrequired;
    ...
    ezsigntemplatesignature_request_compound_v2_local_var->s_ezsigntemplatesignature_creditcardamountdescription = s_ezsigntemplatesignature_creditcardamountdescription;
    ezsigntemplatesignature_request_compound_v2_local_var->d_ezsigntemplatesignature_creditcardamount = d_ezsigntemplatesignature_creditcardamount;
    ...
    ezsigntemplatesignature_request_compound_v2_local_var->a_obj_ezsigntemplatesignaturepaymentdetail = a_obj_ezsigntemplatesignaturepaymentdetail;
...
__attribute__((deprecated)) ezsigntemplatesignature_request_compound_v2_t *ezsigntemplatesignature_request_compound_v2_create(
    ...
    ezsigntemplatesignature_request_compound_v2_t *result = ezsigntemplatesignature_request_compound_v2_create_internal (
...
void ezsigntemplatesignature_request_compound_v2_free(ezsigntemplatesignature_request_compound_v2_t *ezsigntemplatesignature_request_compound_v2) {
    ...
    if (ezsigntemplatesignature_request_compound_v2->pki_ezsigntemplatesignature_id) {
        free(ezsigntemplatesignature_request_compound_v2->pki_ezsigntemplatesignature_id);
        ezsigntemplatesignature_request_compound_v2->pki_ezsigntemplatesignature_id = NULL;
    }
    if (ezsigntemplatesignature_request_compound_v2->fki_ezsigntemplatedocument_id) {
        free(ezsigntemplatesignature_request_compound_v2->fki_ezsigntemplatedocument_id);
        ezsigntemplatesignature_request_compound_v2->fki_ezsigntemplatedocument_id = NULL;
    }
    if (ezsigntemplatesignature_request_compound_v2->fki_ezsigntemplatesigner_id) {
        free(ezsigntemplatesignature_request_compound_v2->fki_ezsigntemplatesigner_id);
        ezsigntemplatesignature_request_compound_v2->fki_ezsigntemplatesigner_id = NULL;
    }
    if (ezsigntemplatesignature_request_compound_v2->fki_ezsigntemplatesigner_id_validation) {
        free(ezsigntemplatesignature_request_compound_v2->fki_ezsigntemplatesigner_id_validation);
        ezsigntemplatesignature_request_compound_v2->fki_ezsigntemplatesigner_id_validation = NULL;
    }
    if (ezsigntemplatesignature_request_compound_v2->fki_paymentgateway_id) {
        free(ezsigntemplatesignature_request_compound_v2->fki_paymentgateway_id);
        ezsigntemplatesignature_request_compound_v2->fki_paymentgateway_id = NULL;
    }
    if (ezsigntemplatesignature_request_compound_v2->b_ezsigntemplatesignature_handwritten) {
        free(ezsigntemplatesignature_request_compound_v2->b_ezsigntemplatesignature_handwritten);
        ezsigntemplatesignature_request_compound_v2->b_ezsigntemplatesignature_handwritten = NULL;
    }
    if (ezsigntemplatesignature_request_compound_v2->b_ezsigntemplatesignature_reason) {
        free(ezsigntemplatesignature_request_compound_v2->b_ezsigntemplatesignature_reason);
        ezsigntemplatesignature_request_compound_v2->b_ezsigntemplatesignature_reason = NULL;
    }
    if (ezsigntemplatesignature_request_compound_v2->b_ezsigntemplatesignature_creditcardcustomamount) {
        free(ezsigntemplatesignature_request_compound_v2->b_ezsigntemplatesignature_creditcardcustomamount);
        ezsigntemplatesignature_request_compound_v2->b_ezsigntemplatesignature_creditcardcustomamount = NULL;
    }
    if (ezsigntemplatesignature_request_compound_v2->i_ezsigntemplatedocumentpage_pagenumber) {
        free(ezsigntemplatesignature_request_compound_v2->i_ezsigntemplatedocumentpage_pagenumber);
        ezsigntemplatesignature_request_compound_v2->i_ezsigntemplatedocumentpage_pagenumber = NULL;
    }
    if (ezsigntemplatesignature_request_compound_v2->i_ezsigntemplatesignature_x) {
        free(ezsigntemplatesignature_request_compound_v2->i_ezsigntemplatesignature_x);
        ezsigntemplatesignature_request_compound_v2->i_ezsigntemplatesignature_x = NULL;
    }
    if (ezsigntemplatesignature_request_compound_v2->i_ezsigntemplatesignature_y) {
        free(ezsigntemplatesignature_request_compound_v2->i_ezsigntemplatesignature_y);
        ezsigntemplatesignature_request_compound_v2->i_ezsigntemplatesignature_y = NULL;
    }
    if (ezsigntemplatesignature_request_compound_v2->i_ezsigntemplatesignature_width) {
        free(ezsigntemplatesignature_request_compound_v2->i_ezsigntemplatesignature_width);
        ezsigntemplatesignature_request_compound_v2->i_ezsigntemplatesignature_width = NULL;
    }
    if (ezsigntemplatesignature_request_compound_v2->i_ezsigntemplatesignature_height) {
        free(ezsigntemplatesignature_request_compound_v2->i_ezsigntemplatesignature_height);
        ezsigntemplatesignature_request_compound_v2->i_ezsigntemplatesignature_height = NULL;
    }
    if (ezsigntemplatesignature_request_compound_v2->i_ezsigntemplatesignature_step) {
        free(ezsigntemplatesignature_request_compound_v2->i_ezsigntemplatesignature_step);
        ezsigntemplatesignature_request_compound_v2->i_ezsigntemplatesignature_step = NULL;
    }
    ...
    if (ezsigntemplatesignature_request_compound_v2->b_ezsigntemplatesignature_required) {
        free(ezsigntemplatesignature_request_compound_v2->b_ezsigntemplatesignature_required);
        ezsigntemplatesignature_request_compound_v2->b_ezsigntemplatesignature_required = NULL;
    }
    ...
    if (ezsigntemplatesignature_request_compound_v2->i_ezsigntemplatesignature_validationstep) {
        free(ezsigntemplatesignature_request_compound_v2->i_ezsigntemplatesignature_validationstep);
        ezsigntemplatesignature_request_compound_v2->i_ezsigntemplatesignature_validationstep = NULL;
    }
    if (ezsigntemplatesignature_request_compound_v2->i_ezsigntemplatesignature_maxlength) {
        free(ezsigntemplatesignature_request_compound_v2->i_ezsigntemplatesignature_maxlength);
        ezsigntemplatesignature_request_compound_v2->i_ezsigntemplatesignature_maxlength = NULL;
    }
    ...
    if (ezsigntemplatesignature_request_compound_v2->i_ezsigntemplatesignature_positioningoffsetx) {
        free(ezsigntemplatesignature_request_compound_v2->i_ezsigntemplatesignature_positioningoffsetx);
        ezsigntemplatesignature_request_compound_v2->i_ezsigntemplatesignature_positioningoffsetx = NULL;
    }
    if (ezsigntemplatesignature_request_compound_v2->i_ezsigntemplatesignature_positioningoffsety) {
        free(ezsigntemplatesignature_request_compound_v2->i_ezsigntemplatesignature_positioningoffsety);
        ezsigntemplatesignature_request_compound_v2->i_ezsigntemplatesignature_positioningoffsety = NULL;
    }
    if (ezsigntemplatesignature_request_compound_v2->s_ezsigntemplatesignature_creditcardamountdescription) {
        free(ezsigntemplatesignature_request_compound_v2->s_ezsigntemplatesignature_creditcardamountdescription);
        ezsigntemplatesignature_request_compound_v2->s_ezsigntemplatesignature_creditcardamountdescription = NULL;
    }
    if (ezsigntemplatesignature_request_compound_v2->d_ezsigntemplatesignature_creditcardamount) {
        free(ezsigntemplatesignature_request_compound_v2->d_ezsigntemplatesignature_creditcardamount);
        ezsigntemplatesignature_request_compound_v2->d_ezsigntemplatesignature_creditcardamount = NULL;
    }
    if (ezsigntemplatesignature_request_compound_v2->b_ezsigntemplatesignature_customdate) {
        free(ezsigntemplatesignature_request_compound_v2->b_ezsigntemplatesignature_customdate);
        ezsigntemplatesignature_request_compound_v2->b_ezsigntemplatesignature_customdate = NULL;
    }
    ...
    if (ezsigntemplatesignature_request_compound_v2->a_obj_ezsigntemplatesignaturepaymentdetail) {
        list_ForEach(listEntry, ezsigntemplatesignature_request_compound_v2->a_obj_ezsigntemplatesignaturepaymentdetail) {
            ezsigntemplatesignaturepaymentdetail_request_compound_free(listEntry->data);
        }
        list_freeList(ezsigntemplatesignature_request_compound_v2->a_obj_ezsigntemplatesignaturepaymentdetail);
        ezsigntemplatesignature_request_compound_v2->a_obj_ezsigntemplatesignaturepaymentdetail = NULL;
    }
...
cJSON *ezsigntemplatesignature_request_compound_v2_convertToJSON(ezsigntemplatesignature_request_compound_v2_t *ezsigntemplatesignature_request_compound_v2) {
    ...
    // ezsigntemplatesignature_request_compound_v2->fki_paymentgateway_id
    if(ezsigntemplatesignature_request_compound_v2->fki_paymentgateway_id) {
    if(cJSON_AddNumberToObject(item, "fkiPaymentgatewayID", *ezsigntemplatesignature_request_compound_v2->fki_paymentgateway_id) == NULL) {
    goto fail; //Numeric
    }
    }
    ...
    // ezsigntemplatesignature_request_compound_v2->b_ezsigntemplatesignature_creditcardcustomamount
    if(ezsigntemplatesignature_request_compound_v2->b_ezsigntemplatesignature_creditcardcustomamount) {
    if(cJSON_AddBoolToObject(item, "bEzsigntemplatesignatureCreditcardcustomamount", *ezsigntemplatesignature_request_compound_v2->b_ezsigntemplatesignature_creditcardcustomamount) == NULL) {
    goto fail; //Bool
    }
    }
    ...
    // ezsigntemplatesignature_request_compound_v2->e_ezsigntemplatesignature_signaturepad
    if(ezsigntemplatesignature_request_compound_v2->e_ezsigntemplatesignature_signaturepad != ezmax_api_definition__full_field_e_ezsigntemplatesignature_signaturepad__NULL) {
    cJSON *e_ezsigntemplatesignature_signaturepad_local_JSON = field_e_ezsigntemplatesignature_signaturepad_convertToJSON(ezsigntemplatesignature_request_compound_v2->e_ezsigntemplatesignature_signaturepad);
    ...
    // ezsigntemplatesignature_request_compound_v2->e_ezsigntemplatesignature_signaturepadrequired
    if(ezsigntemplatesignature_request_compound_v2->e_ezsigntemplatesignature_signaturepadrequired != ezmax_api_definition__full_field_e_ezsigntemplatesignature_signaturepadrequired__NULL) {
    cJSON *e_ezsigntemplatesignature_signaturepadrequired_local_JSON = field_e_ezsigntemplatesignature_signaturepadrequired_convertToJSON(ezsigntemplatesignature_request_compound_v2->e_ezsigntemplatesignature_signaturepadrequired);
    ...
    // ezsigntemplatesignature_request_compound_v2->s_ezsigntemplatesignature_creditcardamountdescription
    if(ezsigntemplatesignature_request_compound_v2->s_ezsigntemplatesignature_creditcardamountdescription) {
    if(cJSON_AddStringToObject(item, "sEzsigntemplatesignatureCreditcardamountdescription", ezsigntemplatesignature_request_compound_v2->s_ezsigntemplatesignature_creditcardamountdescription) == NULL) {
    goto fail; //String
    }
    }


    // ezsigntemplatesignature_request_compound_v2->d_ezsigntemplatesignature_creditcardamount
    if(ezsigntemplatesignature_request_compound_v2->d_ezsigntemplatesignature_creditcardamount) {
    if(cJSON_AddStringToObject(item, "dEzsigntemplatesignatureCreditcardamount", ezsigntemplatesignature_request_compound_v2->d_ezsigntemplatesignature_creditcardamount) == NULL) {
    goto fail; //String
    }
    }
    ...
    // ezsigntemplatesignature_request_compound_v2->a_obj_ezsigntemplatesignaturepaymentdetail
    if(ezsigntemplatesignature_request_compound_v2->a_obj_ezsigntemplatesignaturepaymentdetail) {
    ...
    if (ezsigntemplatesignature_request_compound_v2->a_obj_ezsigntemplatesignaturepaymentdetail) {
    list_ForEach(a_obj_ezsigntemplatesignaturepaymentdetailListEntry, ezsigntemplatesignature_request_compound_v2->a_obj_ezsigntemplatesignaturepaymentdetail) {
...
ezsigntemplatesignature_request_compound_v2_t *ezsigntemplatesignature_request_compound_v2_parseFromJSON(cJSON *ezsigntemplatesignature_request_compound_v2JSON){
    ...
    // define the local variable for ezsigntemplatesignature_request_compound_v2->pki_ezsigntemplatesignature_id
    int *pki_ezsigntemplatesignature_id_local_var = NULL;

    // define the local variable for ezsigntemplatesignature_request_compound_v2->fki_ezsigntemplatedocument_id
    int *fki_ezsigntemplatedocument_id_local_var = NULL;

    // define the local variable for ezsigntemplatesignature_request_compound_v2->fki_ezsigntemplatesigner_id
    int *fki_ezsigntemplatesigner_id_local_var = NULL;

    // define the local variable for ezsigntemplatesignature_request_compound_v2->fki_ezsigntemplatesigner_id_validation
    int *fki_ezsigntemplatesigner_id_validation_local_var = NULL;

    // define the local variable for ezsigntemplatesignature_request_compound_v2->fki_paymentgateway_id
    int *fki_paymentgateway_id_local_var = NULL;

    // define the local variable for ezsigntemplatesignature_request_compound_v2->b_ezsigntemplatesignature_handwritten
    int *b_ezsigntemplatesignature_handwritten_local_var = NULL;

    // define the local variable for ezsigntemplatesignature_request_compound_v2->b_ezsigntemplatesignature_reason
    int *b_ezsigntemplatesignature_reason_local_var = NULL;

    // define the local variable for ezsigntemplatesignature_request_compound_v2->b_ezsigntemplatesignature_creditcardcustomamount
    ...
    // define the local variable for ezsigntemplatesignature_request_compound_v2->i_ezsigntemplatedocumentpage_pagenumber
    int *i_ezsigntemplatedocumentpage_pagenumber_local_var = NULL;

    // define the local variable for ezsigntemplatesignature_request_compound_v2->i_ezsigntemplatesignature_x
    int *i_ezsigntemplatesignature_x_local_var = NULL;

    // define the local variable for ezsigntemplatesignature_request_compound_v2->i_ezsigntemplatesignature_y
    int *i_ezsigntemplatesignature_y_local_var = NULL;

    // define the local variable for ezsigntemplatesignature_request_compound_v2->i_ezsigntemplatesignature_width
    int *i_ezsigntemplatesignature_width_local_var = NULL;

    // define the local variable for ezsigntemplatesignature_request_compound_v2->i_ezsigntemplatesignature_height
    int *i_ezsigntemplatesignature_height_local_var = NULL;

    // define the local variable for ezsigntemplatesignature_request_compound_v2->i_ezsigntemplatesignature_step
    ...
    // define the local variable for ezsigntemplatesignature_request_compound_v2->e_ezsigntemplatesignature_signaturepad
    ...
    // define the local variable for ezsigntemplatesignature_request_compound_v2->e_ezsigntemplatesignature_signaturepadrequired
    ...
    // define the local variable for ezsigntemplatesignature_request_compound_v2->b_ezsigntemplatesignature_required
    ...
    // define the local variable for ezsigntemplatesignature_request_compound_v2->i_ezsigntemplatesignature_validationstep
    int *i_ezsigntemplatesignature_validationstep_local_var = NULL;

    // define the local variable for ezsigntemplatesignature_request_compound_v2->i_ezsigntemplatesignature_maxlength
    ...
    // define the local variable for ezsigntemplatesignature_request_compound_v2->i_ezsigntemplatesignature_positioningoffsetx
    int *i_ezsigntemplatesignature_positioningoffsetx_local_var = NULL;

    // define the local variable for ezsigntemplatesignature_request_compound_v2->i_ezsigntemplatesignature_positioningoffsety
    ...
    // define the local variable for ezsigntemplatesignature_request_compound_v2->b_ezsigntemplatesignature_customdate
    ...
    // define the local list for ezsigntemplatesignature_request_compound_v2->a_obj_ezsigntemplatesignaturepaymentdetail
    ...
    *fki_ezsigntemplatesigner_id_validation_local_var = fki_ezsigntemplatesigner_id_validation->valuedouble;
    ...
    // ezsigntemplatesignature_request_compound_v2->fki_paymentgateway_id
    cJSON *fki_paymentgateway_id = cJSON_GetObjectItemCaseSensitive(ezsigntemplatesignature_request_compound_v2JSON, "fkiPaymentgatewayID");
    ...
    *b_ezsigntemplatesignature_reason_local_var = b_ezsigntemplatesignature_reason->valueint;
    ...
    // ezsigntemplatesignature_request_compound_v2->b_ezsigntemplatesignature_creditcardcustomamount
    cJSON *b_ezsigntemplatesignature_creditcardcustomamount = cJSON_GetObjectItemCaseSensitive(ezsigntemplatesignature_request_compound_v2JSON, "bEzsigntemplatesignatureCreditcardcustomamount");
    ...
    *i_ezsigntemplatesignature_step_local_var = i_ezsigntemplatesignature_step->valuedouble;
    ...
    // ezsigntemplatesignature_request_compound_v2->e_ezsigntemplatesignature_signaturepad
    cJSON *e_ezsigntemplatesignature_signaturepad = cJSON_GetObjectItemCaseSensitive(ezsigntemplatesignature_request_compound_v2JSON, "eEzsigntemplatesignatureSignaturepad");
    ...
    // ezsigntemplatesignature_request_compound_v2->e_ezsigntemplatesignature_signaturepadrequired
    cJSON *e_ezsigntemplatesignature_signaturepadrequired = cJSON_GetObjectItemCaseSensitive(ezsigntemplatesignature_request_compound_v2JSON, "eEzsigntemplatesignatureSignaturepadrequired");
    ...
    *i_ezsigntemplatesignature_positioningoffsety_local_var = i_ezsigntemplatesignature_positioningoffsety->valuedouble;
    ...
    // ezsigntemplatesignature_request_compound_v2->s_ezsigntemplatesignature_creditcardamountdescription
    cJSON *s_ezsigntemplatesignature_creditcardamountdescription = cJSON_GetObjectItemCaseSensitive(ezsigntemplatesignature_request_compound_v2JSON, "sEzsigntemplatesignatureCreditcardamountdescription");
    ...
    // ezsigntemplatesignature_request_compound_v2->d_ezsigntemplatesignature_creditcardamount
    cJSON *d_ezsigntemplatesignature_creditcardamount = cJSON_GetObjectItemCaseSensitive(ezsigntemplatesignature_request_compound_v2JSON, "dEzsigntemplatesignatureCreditcardamount");
    ...
    *b_ezsigntemplatesignature_customdate_local_var = b_ezsigntemplatesignature_customdate->valueint;
    ...
    // ezsigntemplatesignature_request_compound_v2->a_obj_ezsigntemplatesignaturepaymentdetail
    cJSON *a_obj_ezsigntemplatesignaturepaymentdetail = cJSON_GetObjectItemCaseSensitive(ezsigntemplatesignature_request_compound_v2JSON, "a_objEzsigntemplatesignaturepaymentdetail");
