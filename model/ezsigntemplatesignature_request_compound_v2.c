...
void ezsigntemplatesignature_request_compound_v2_free(ezsigntemplatesignature_request_compound_v2_t *ezsigntemplatesignature_request_compound_v2) {
    ...
    if (ezsigntemplatesignature_request_compound_v2->e_ezsigntemplatesignature_positioning) {
        field_e_ezsigntemplatesignature_positioning_free(ezsigntemplatesignature_request_compound_v2->e_ezsigntemplatesignature_positioning);
        ezsigntemplatesignature_request_compound_v2->e_ezsigntemplatesignature_positioning = NULL;
    }
    if (ezsigntemplatesignature_request_compound_v2->e_ezsigntemplatesignature_type) {
        field_e_ezsigntemplatesignature_type_free(ezsigntemplatesignature_request_compound_v2->e_ezsigntemplatesignature_type);
        ezsigntemplatesignature_request_compound_v2->e_ezsigntemplatesignature_type = NULL;
    }
    if (ezsigntemplatesignature_request_compound_v2->e_ezsigntemplatesignature_consultationtrigger) {
        field_e_ezsigntemplatesignature_consultationtrigger_free(ezsigntemplatesignature_request_compound_v2->e_ezsigntemplatesignature_consultationtrigger);
        ezsigntemplatesignature_request_compound_v2->e_ezsigntemplatesignature_consultationtrigger = NULL;
    }
    ...
    if (ezsigntemplatesignature_request_compound_v2->e_ezsigntemplatesignature_tooltipposition) {
        field_e_ezsigntemplatesignature_tooltipposition_free(ezsigntemplatesignature_request_compound_v2->e_ezsigntemplatesignature_tooltipposition);
        ezsigntemplatesignature_request_compound_v2->e_ezsigntemplatesignature_tooltipposition = NULL;
    }
    if (ezsigntemplatesignature_request_compound_v2->e_ezsigntemplatesignature_font) {
        field_e_ezsigntemplatesignature_font_free(ezsigntemplatesignature_request_compound_v2->e_ezsigntemplatesignature_font);
        ezsigntemplatesignature_request_compound_v2->e_ezsigntemplatesignature_font = NULL;
    }
    if (ezsigntemplatesignature_request_compound_v2->e_ezsigntemplatesignature_attachmentnamesource) {
        field_e_ezsigntemplatesignature_attachmentnamesource_free(ezsigntemplatesignature_request_compound_v2->e_ezsigntemplatesignature_attachmentnamesource);
        ezsigntemplatesignature_request_compound_v2->e_ezsigntemplatesignature_attachmentnamesource = NULL;
    }
    ...
    if (ezsigntemplatesignature_request_compound_v2->e_ezsigntemplatesignature_textvalidation) {
        enum_textvalidation_free(ezsigntemplatesignature_request_compound_v2->e_ezsigntemplatesignature_textvalidation);
        ezsigntemplatesignature_request_compound_v2->e_ezsigntemplatesignature_textvalidation = NULL;
    }
    ...
    if (ezsigntemplatesignature_request_compound_v2->e_ezsigntemplatesignature_dependencyrequirement) {
        field_e_ezsigntemplatesignature_dependencyrequirement_free(ezsigntemplatesignature_request_compound_v2->e_ezsigntemplatesignature_dependencyrequirement);
        ezsigntemplatesignature_request_compound_v2->e_ezsigntemplatesignature_dependencyrequirement = NULL;
    }
    ...
    if (ezsigntemplatesignature_request_compound_v2->e_ezsigntemplatesignature_positioningoccurence) {
        field_e_ezsigntemplatesignature_positioningoccurence_free(ezsigntemplatesignature_request_compound_v2->e_ezsigntemplatesignature_positioningoccurence);
        ezsigntemplatesignature_request_compound_v2->e_ezsigntemplatesignature_positioningoccurence = NULL;
    }
    if (ezsigntemplatesignature_request_compound_v2->a_obj_ezsigntemplatesignaturecustomdate) {
        list_ForEach(listEntry, ezsigntemplatesignature_request_compound_v2->a_obj_ezsigntemplatesignaturecustomdate) {
            ezsigntemplatesignaturecustomdate_request_v2_free(listEntry->data);
        }
...
cJSON *ezsigntemplatesignature_request_compound_v2_convertToJSON(ezsigntemplatesignature_request_compound_v2_t *ezsigntemplatesignature_request_compound_v2) {
    ...
    if(ezsigntemplatesignature_request_compound_v2->e_ezsigntemplatesignature_positioning != ezmax_api_definition__full_ezsigntemplatesignature_request_compound_v2__NULL) {
    ...
    if (ezmax_api_definition__full_ezsigntemplatesignature_request_compound_v2__NULL == ezsigntemplatesignature_request_compound_v2->e_ezsigntemplatesignature_type) {
        goto fail;
    }
    ...
    if(ezsigntemplatesignature_request_compound_v2->e_ezsigntemplatesignature_consultationtrigger != ezmax_api_definition__full_ezsigntemplatesignature_request_compound_v2__NULL) {
    ...
    if(ezsigntemplatesignature_request_compound_v2->e_ezsigntemplatesignature_tooltipposition != ezmax_api_definition__full_ezsigntemplatesignature_request_compound_v2__NULL) {
    ...
    if(ezsigntemplatesignature_request_compound_v2->e_ezsigntemplatesignature_font != ezmax_api_definition__full_ezsigntemplatesignature_request_compound_v2__NULL) {
    ...
    if(ezsigntemplatesignature_request_compound_v2->e_ezsigntemplatesignature_attachmentnamesource != ezmax_api_definition__full_ezsigntemplatesignature_request_compound_v2__NULL) {
    ...
    if(ezsigntemplatesignature_request_compound_v2->e_ezsigntemplatesignature_textvalidation != ezmax_api_definition__full_ezsigntemplatesignature_request_compound_v2__NULL) {
    ...
    if(ezsigntemplatesignature_request_compound_v2->e_ezsigntemplatesignature_dependencyrequirement != ezmax_api_definition__full_ezsigntemplatesignature_request_compound_v2__NULL) {
    ...
    if(ezsigntemplatesignature_request_compound_v2->e_ezsigntemplatesignature_positioningoccurence != ezmax_api_definition__full_ezsigntemplatesignature_request_compound_v2__NULL) {
    ...
    cJSON *itemLocal = ezsigntemplatesignaturecustomdate_request_v2_convertToJSON(a_obj_ezsigntemplatesignaturecustomdateListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
...
ezsigntemplatesignature_request_compound_v2_t *ezsigntemplatesignature_request_compound_v2_parseFromJSON(cJSON *ezsigntemplatesignature_request_compound_v2JSON){
    ...
    cJSON_ArrayForEach(a_obj_ezsigntemplatesignaturecustomdate_local_nonprimitive,a_obj_ezsigntemplatesignaturecustomdate )
    {
        ...
        ezsigntemplatesignaturecustomdate_request_v2_t *a_obj_ezsigntemplatesignaturecustomdateItem = ezsigntemplatesignaturecustomdate_request_v2_parseFromJSON(a_obj_ezsigntemplatesignaturecustomdate_local_nonprimitive);
    ...
    ezsigntemplatesignature_request_compound_v2_local_var = ezsigntemplatesignature_request_compound_v2_create (
