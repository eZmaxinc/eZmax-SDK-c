...
ezmax_api_definition__full_field_e_contact_type__e field_e_contact_type_field_e_contact_type_parseFromJSON(cJSON *field_e_contact_typeJSON) {
    ezmax_api_definition__full_field_e_contact_type__e *field_e_contact_type = NULL;
    ezmax_api_definition__full_field_e_contact_type__e field_e_contact_typeVariable;
    cJSON *field_e_contact_typeVar = cJSON_GetObjectItemCaseSensitive(field_e_contact_typeJSON, "field_e_contact_type");
    if(!cJSON_IsString(field_e_contact_typeVar) || (field_e_contact_typeVar->valuestring == NULL)){
        goto end;
    }
    field_e_contact_typeVariable = field_e_contact_type_field_e_contact_type_FromString(field_e_contact_typeVar->valuestring);
    return field_e_contact_typeVariable;
end:
    return 0;
}
