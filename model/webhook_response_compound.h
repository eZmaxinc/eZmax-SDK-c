...
typedef enum  { ezmax_api_definition__full_webhook_response_compound__NULL = 0, ezmax_api_definition__full_webhook_response_compound__DocumentCompleted, ezmax_api_definition__full_webhook_response_compound__FolderCompleted } ezmax_api_definition__full_webhook_response_compound__e;
...
typedef enum  { ezmax_api_definition__full_webhook_response_compound__NULL = 0, ezmax_api_definition__full_webhook_response_compound__UserCreated } ezmax_api_definition__full_webhook_response_compound__e;
