...
void ezsigndocumentlog_response_free(ezsigndocumentlog_response_t *ezsigndocumentlog_response) {
    ...
    if(ezsigndocumentlog_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsigndocumentlog_response_free");
        return ;
    }
...
cJSON *ezsigndocumentlog_response_convertToJSON(ezsigndocumentlog_response_t *ezsigndocumentlog_response) {
    ...
    if (ezmax_api_definition__full_field_e_ezsigndocumentlog_type__NULL == ezsigndocumentlog_response->e_ezsigndocumentlog_type) {
        goto fail;
    }
