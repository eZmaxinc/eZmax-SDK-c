/*
 * externalbroker_get_communicationsenders_v1_response_m_payload.h
 *
 * Response for GET /1/object/externalbroker/{pkiExternalbrokerID}/getCommunicationsenders
 */

#ifndef _externalbroker_get_communicationsenders_v1_response_m_payload_H_
#define _externalbroker_get_communicationsenders_v1_response_m_payload_H_
...
typedef struct externalbroker_get_communicationsenders_v1_response_m_payload_t externalbroker_get_communicationsenders_v1_response_m_payload_t;

#include "custom_communicationsender_response.h"



typedef struct externalbroker_get_communicationsenders_v1_response_m_payload_t {
    list_t *a_obj_communicationsenders; //nonprimitive container

    int _library_owned; // Is the library responsible for freeing this object?
} externalbroker_get_communicationsenders_v1_response_m_payload_t;
...
#endif /* _externalbroker_get_communicationsenders_v1_response_m_payload_H_ */
