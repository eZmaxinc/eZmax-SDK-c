...
static ezsignfoldersignerassociation_create_embedded_url_v2_request_t *ezsignfoldersignerassociation_create_embedded_url_v2_request_create_internal(
    ...
    memset(ezsignfoldersignerassociation_create_embedded_url_v2_request_local_var, 0, sizeof(ezsignfoldersignerassociation_create_embedded_url_v2_request_t));
...
__attribute__((deprecated)) ezsignfoldersignerassociation_create_embedded_url_v2_request_t *ezsignfoldersignerassociation_create_embedded_url_v2_request_create(
    ...
    ezsignfoldersignerassociation_create_embedded_url_v2_request_t *result = ezsignfoldersignerassociation_create_embedded_url_v2_request_create_internal (
        s_return_url,
        s_iframe_origin
        );
    if (!result) {
...
ezsignfoldersignerassociation_create_embedded_url_v2_request_t *ezsignfoldersignerassociation_create_embedded_url_v2_request_parseFromJSON(cJSON *ezsignfoldersignerassociation_create_embedded_url_v2_requestJSON){
    ...
    char *s_iframe_origin_local_str = NULL;
    ...
    if (s_iframe_origin && !cJSON_IsNull(s_iframe_origin)) s_iframe_origin_local_str = strdup(s_iframe_origin->valuestring);
    ...
    if (s_iframe_origin_local_str) {
        free(s_iframe_origin_local_str);
        s_iframe_origin_local_str = NULL;
    }
    return NULL;
