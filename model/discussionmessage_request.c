...
static discussionmessage_request_t *discussionmessage_request_create_internal(
    ...
    memset(discussionmessage_request_local_var, 0, sizeof(discussionmessage_request_t));
    discussionmessage_request_local_var->_library_owned = 1;
...
__attribute__((deprecated)) discussionmessage_request_t *discussionmessage_request_create(
    int *pki_discussionmessage_id,
    int *fki_discussion_id,
    int *fki_discussionmembership_id_actionrequired,
    char *t_discussionmessage_content
    ...
    discussionmessage_request_t *result = discussionmessage_request_create_internal (
...
void discussionmessage_request_free(discussionmessage_request_t *discussionmessage_request) {
    ...
    if(discussionmessage_request->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "discussionmessage_request_free");
        return ;
    }
    listEntry_t *listEntry;
    if (discussionmessage_request->pki_discussionmessage_id) {
        free(discussionmessage_request->pki_discussionmessage_id);
        discussionmessage_request->pki_discussionmessage_id = NULL;
    }
    if (discussionmessage_request->fki_discussion_id) {
        free(discussionmessage_request->fki_discussion_id);
        discussionmessage_request->fki_discussion_id = NULL;
    }
    if (discussionmessage_request->fki_discussionmembership_id_actionrequired) {
        free(discussionmessage_request->fki_discussionmembership_id_actionrequired);
        discussionmessage_request->fki_discussionmembership_id_actionrequired = NULL;
    }
...
discussionmessage_request_t *discussionmessage_request_parseFromJSON(cJSON *discussionmessage_requestJSON){
    ...
    // define the local variable for discussionmessage_request->pki_discussionmessage_id
    int *pki_discussionmessage_id_local_var = NULL;

    // define the local variable for discussionmessage_request->fki_discussion_id
    int *fki_discussion_id_local_var = NULL;

    // define the local variable for discussionmessage_request->fki_discussionmembership_id_actionrequired
    ...
    *fki_discussionmembership_id_actionrequired_local_var = fki_discussionmembership_id_actionrequired->valuedouble;
    ...
    discussionmessage_request_local_var = discussionmessage_request_create_internal (
