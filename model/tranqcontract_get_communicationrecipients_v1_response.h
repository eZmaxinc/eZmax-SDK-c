/*
 * tranqcontract_get_communicationrecipients_v1_response.h
 *
 * Response for GET /1/object/tranqcontract/{pkiTranqcontractID}/getCommunicationrecipients
 */

#ifndef _tranqcontract_get_communicationrecipients_v1_response_H_
#define _tranqcontract_get_communicationrecipients_v1_response_H_
...
typedef struct tranqcontract_get_communicationrecipients_v1_response_t tranqcontract_get_communicationrecipients_v1_response_t;
...
typedef struct tranqcontract_get_communicationrecipients_v1_response_t {
    struct common_response_obj_debug_payload_t *obj_debug_payload; //model
    struct common_response_obj_debug_t *obj_debug; //model
    struct tranqcontract_get_communicationrecipients_v1_response_m_payload_t *m_payload; //model
...
#endif /* _tranqcontract_get_communicationrecipients_v1_response_H_ */
