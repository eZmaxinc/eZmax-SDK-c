...
static ezsignsignaturecustomdate_response_compound_t *ezsignsignaturecustomdate_response_compound_create_internal(
    ...
    memset(ezsignsignaturecustomdate_response_compound_local_var, 0, sizeof(ezsignsignaturecustomdate_response_compound_t));
...
__attribute__((deprecated)) ezsignsignaturecustomdate_response_compound_t *ezsignsignaturecustomdate_response_compound_create(
    ...
    ezsignsignaturecustomdate_response_compound_t *result = ezsignsignaturecustomdate_response_compound_create_internal (
...
void ezsignsignaturecustomdate_response_compound_free(ezsignsignaturecustomdate_response_compound_t *ezsignsignaturecustomdate_response_compound) {
    ...
    if (ezsignsignaturecustomdate_response_compound->pki_ezsignsignaturecustomdate_id) {
        free(ezsignsignaturecustomdate_response_compound->pki_ezsignsignaturecustomdate_id);
        ezsignsignaturecustomdate_response_compound->pki_ezsignsignaturecustomdate_id = NULL;
    }
    if (ezsignsignaturecustomdate_response_compound->i_ezsignsignaturecustomdate_x) {
        free(ezsignsignaturecustomdate_response_compound->i_ezsignsignaturecustomdate_x);
        ezsignsignaturecustomdate_response_compound->i_ezsignsignaturecustomdate_x = NULL;
    }
    if (ezsignsignaturecustomdate_response_compound->i_ezsignsignaturecustomdate_y) {
        free(ezsignsignaturecustomdate_response_compound->i_ezsignsignaturecustomdate_y);
        ezsignsignaturecustomdate_response_compound->i_ezsignsignaturecustomdate_y = NULL;
    }
    if (ezsignsignaturecustomdate_response_compound->i_ezsignsignaturecustomdate_offsetx) {
        free(ezsignsignaturecustomdate_response_compound->i_ezsignsignaturecustomdate_offsetx);
        ezsignsignaturecustomdate_response_compound->i_ezsignsignaturecustomdate_offsetx = NULL;
    }
    if (ezsignsignaturecustomdate_response_compound->i_ezsignsignaturecustomdate_offsety) {
        free(ezsignsignaturecustomdate_response_compound->i_ezsignsignaturecustomdate_offsety);
        ezsignsignaturecustomdate_response_compound->i_ezsignsignaturecustomdate_offsety = NULL;
    }
...
ezsignsignaturecustomdate_response_compound_t *ezsignsignaturecustomdate_response_compound_parseFromJSON(cJSON *ezsignsignaturecustomdate_response_compoundJSON){
    ...
    // define the local variable for ezsignsignaturecustomdate_response_compound->pki_ezsignsignaturecustomdate_id
    int *pki_ezsignsignaturecustomdate_id_local_var = NULL;

    // define the local variable for ezsignsignaturecustomdate_response_compound->i_ezsignsignaturecustomdate_x
    int *i_ezsignsignaturecustomdate_x_local_var = NULL;

    // define the local variable for ezsignsignaturecustomdate_response_compound->i_ezsignsignaturecustomdate_y
    int *i_ezsignsignaturecustomdate_y_local_var = NULL;

    // define the local variable for ezsignsignaturecustomdate_response_compound->i_ezsignsignaturecustomdate_offsetx
    int *i_ezsignsignaturecustomdate_offsetx_local_var = NULL;

    // define the local variable for ezsignsignaturecustomdate_response_compound->i_ezsignsignaturecustomdate_offsety
