...
static ezsignformfieldgroup_edit_object_v1_response_t *ezsignformfieldgroup_edit_object_v1_response_create_internal(
    ...
    memset(ezsignformfieldgroup_edit_object_v1_response_local_var, 0, sizeof(ezsignformfieldgroup_edit_object_v1_response_t));
...
__attribute__((deprecated)) ezsignformfieldgroup_edit_object_v1_response_t *ezsignformfieldgroup_edit_object_v1_response_create(
    ...
    ezsignformfieldgroup_edit_object_v1_response_t *result = ezsignformfieldgroup_edit_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug
        );
    if (!result) {
