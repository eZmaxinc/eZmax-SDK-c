/*
 * company_get_autocomplete_v2_response_all_of.h
 *
 * 
 */

#ifndef _company_get_autocomplete_v2_response_all_of_H_
#define _company_get_autocomplete_v2_response_all_of_H_
...
typedef struct company_get_autocomplete_v2_response_all_of_t company_get_autocomplete_v2_response_all_of_t;

#include "company_get_autocomplete_v2_response_m_payload.h"



typedef struct company_get_autocomplete_v2_response_all_of_t {
    struct company_get_autocomplete_v2_response_m_payload_t *m_payload; //model

} company_get_autocomplete_v2_response_all_of_t;
...
#endif /* _company_get_autocomplete_v2_response_all_of_H_ */
