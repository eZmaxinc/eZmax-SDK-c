/*
 * ezsigndocument_edit_ezsignsignatures_v1_response_m_payload.h
 *
 * Payload for PUT /1/object/ezsigndocument/{pkiEzsigndocumentID}/editEzsignsignatures
 */

#ifndef _ezsigndocument_edit_ezsignsignatures_v1_response_m_payload_H_
#define _ezsigndocument_edit_ezsignsignatures_v1_response_m_payload_H_
...
typedef struct ezsigndocument_edit_ezsignsignatures_v1_response_m_payload_t ezsigndocument_edit_ezsignsignatures_v1_response_m_payload_t;




typedef struct ezsigndocument_edit_ezsignsignatures_v1_response_m_payload_t {
    list_t *a_pki_ezsignsignature_id; //primitive container

} ezsigndocument_edit_ezsignsignatures_v1_response_m_payload_t;

ezsigndocument_edit_ezsignsignatures_v1_response_m_payload_t *ezsigndocument_edit_ezsignsignatures_v1_response_m_payload_create(
...
#endif /* _ezsigndocument_edit_ezsignsignatures_v1_response_m_payload_H_ */
