/*
 * user_get_subnets_v1_response_m_payload.h
 *
 * Response for GET /1/object/user/{pkiUserID}/getSubnets
 */

#ifndef _user_get_subnets_v1_response_m_payload_H_
#define _user_get_subnets_v1_response_m_payload_H_
...
typedef struct user_get_subnets_v1_response_m_payload_t user_get_subnets_v1_response_m_payload_t;

#include "subnet_response_compound.h"



typedef struct user_get_subnets_v1_response_m_payload_t {
    list_t *a_obj_subnet; //nonprimitive container

} user_get_subnets_v1_response_m_payload_t;

user_get_subnets_v1_response_m_payload_t *user_get_subnets_v1_response_m_payload_create(
    list_t *a_obj_subnet
);
...
#endif /* _user_get_subnets_v1_response_m_payload_H_ */
