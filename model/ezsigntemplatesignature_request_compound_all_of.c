...
ezsigntemplatesignature_request_compound_all_of_t *ezsigntemplatesignature_request_compound_all_of_create(
    ...
    ezsigntemplatesignature_request_compound_all_of_t *ezsigntemplatesignature_request_compound_all_of_local_var = malloc(sizeof(ezsigntemplatesignature_request_compound_all_of_t));
    if (!ezsigntemplatesignature_request_compound_all_of_local_var) {
        return NULL;
    }
    ezsigntemplatesignature_request_compound_all_of_local_var->b_ezsigntemplatesignature_customdate = b_ezsigntemplatesignature_customdate;
    ezsigntemplatesignature_request_compound_all_of_local_var->a_obj_ezsigntemplatesignaturecustomdate = a_obj_ezsigntemplatesignaturecustomdate;

    return ezsigntemplatesignature_request_compound_all_of_local_var;
}
...
void ezsigntemplatesignature_request_compound_all_of_free(ezsigntemplatesignature_request_compound_all_of_t *ezsigntemplatesignature_request_compound_all_of) {
    if(NULL == ezsigntemplatesignature_request_compound_all_of){
        return ;
    }
    listEntry_t *listEntry;
    if (ezsigntemplatesignature_request_compound_all_of->a_obj_ezsigntemplatesignaturecustomdate) {
        list_ForEach(listEntry, ezsigntemplatesignature_request_compound_all_of->a_obj_ezsigntemplatesignaturecustomdate) {
            ezsigntemplatesignaturecustomdate_request_compound_free(listEntry->data);
        }
        list_freeList(ezsigntemplatesignature_request_compound_all_of->a_obj_ezsigntemplatesignaturecustomdate);
        ezsigntemplatesignature_request_compound_all_of->a_obj_ezsigntemplatesignaturecustomdate = NULL;
    }
    free(ezsigntemplatesignature_request_compound_all_of);
}
...
cJSON *ezsigntemplatesignature_request_compound_all_of_convertToJSON(ezsigntemplatesignature_request_compound_all_of_t *ezsigntemplatesignature_request_compound_all_of) {
    ...
    // ezsigntemplatesignature_request_compound_all_of->b_ezsigntemplatesignature_customdate
    if(ezsigntemplatesignature_request_compound_all_of->b_ezsigntemplatesignature_customdate) {
    if(cJSON_AddBoolToObject(item, "bEzsigntemplatesignatureCustomdate", ezsigntemplatesignature_request_compound_all_of->b_ezsigntemplatesignature_customdate) == NULL) {
    goto fail; //Bool
    }
    }


    // ezsigntemplatesignature_request_compound_all_of->a_obj_ezsigntemplatesignaturecustomdate
    if(ezsigntemplatesignature_request_compound_all_of->a_obj_ezsigntemplatesignaturecustomdate) {
    ...
    if (ezsigntemplatesignature_request_compound_all_of->a_obj_ezsigntemplatesignaturecustomdate) {
    list_ForEach(a_obj_ezsigntemplatesignaturecustomdateListEntry, ezsigntemplatesignature_request_compound_all_of->a_obj_ezsigntemplatesignaturecustomdate) {
...
ezsigntemplatesignature_request_compound_all_of_t *ezsigntemplatesignature_request_compound_all_of_parseFromJSON(cJSON *ezsigntemplatesignature_request_compound_all_ofJSON){
    ...
    ezsigntemplatesignature_request_compound_all_of_t *ezsigntemplatesignature_request_compound_all_of_local_var = NULL;

    // define the local list for ezsigntemplatesignature_request_compound_all_of->a_obj_ezsigntemplatesignaturecustomdate
    list_t *a_obj_ezsigntemplatesignaturecustomdateList = NULL;

    // ezsigntemplatesignature_request_compound_all_of->b_ezsigntemplatesignature_customdate
    cJSON *b_ezsigntemplatesignature_customdate = cJSON_GetObjectItemCaseSensitive(ezsigntemplatesignature_request_compound_all_ofJSON, "bEzsigntemplatesignatureCustomdate");
    ...
    // ezsigntemplatesignature_request_compound_all_of->a_obj_ezsigntemplatesignaturecustomdate
    cJSON *a_obj_ezsigntemplatesignaturecustomdate = cJSON_GetObjectItemCaseSensitive(ezsigntemplatesignature_request_compound_all_ofJSON, "a_objEzsigntemplatesignaturecustomdate");
    ...
    ezsigntemplatesignature_request_compound_all_of_local_var = ezsigntemplatesignature_request_compound_all_of_create (
