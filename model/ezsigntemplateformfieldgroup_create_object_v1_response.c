...
static ezsigntemplateformfieldgroup_create_object_v1_response_t *ezsigntemplateformfieldgroup_create_object_v1_response_create_internal(
    ...
    memset(ezsigntemplateformfieldgroup_create_object_v1_response_local_var, 0, sizeof(ezsigntemplateformfieldgroup_create_object_v1_response_t));
...
__attribute__((deprecated)) ezsigntemplateformfieldgroup_create_object_v1_response_t *ezsigntemplateformfieldgroup_create_object_v1_response_create(
    ...
    ezsigntemplateformfieldgroup_create_object_v1_response_t *result = ezsigntemplateformfieldgroup_create_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
