...
ezsignsigningreason_request_compound_t *ezsignsigningreason_request_compound_create(
...
ezsignsigningreason_request_compound_t *ezsignsigningreason_request_compound_parseFromJSON(cJSON *ezsignsigningreason_request_compoundJSON){
    ...
    ezsignsigningreason_request_compound_local_var = ezsignsigningreason_request_compound_create (
