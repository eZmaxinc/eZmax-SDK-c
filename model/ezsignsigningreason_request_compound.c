...
static ezsignsigningreason_request_compound_t *ezsignsigningreason_request_compound_create_internal(
    ...
    memset(ezsignsigningreason_request_compound_local_var, 0, sizeof(ezsignsigningreason_request_compound_t));
...
__attribute__((deprecated)) ezsignsigningreason_request_compound_t *ezsignsigningreason_request_compound_create(
    ...
    ezsignsigningreason_request_compound_t *result = ezsignsigningreason_request_compound_create_internal (
...
void ezsignsigningreason_request_compound_free(ezsignsigningreason_request_compound_t *ezsignsigningreason_request_compound) {
    ...
    if (ezsignsigningreason_request_compound->pki_ezsignsigningreason_id) {
        free(ezsignsigningreason_request_compound->pki_ezsignsigningreason_id);
        ezsignsigningreason_request_compound->pki_ezsignsigningreason_id = NULL;
    }
    ...
    if (ezsignsigningreason_request_compound->b_ezsignsigningreason_isactive) {
        free(ezsignsigningreason_request_compound->b_ezsignsigningreason_isactive);
        ezsignsigningreason_request_compound->b_ezsignsigningreason_isactive = NULL;
    }
...
ezsignsigningreason_request_compound_t *ezsignsigningreason_request_compound_parseFromJSON(cJSON *ezsignsigningreason_request_compoundJSON){
    ...
    // define the local variable for ezsignsigningreason_request_compound->pki_ezsignsigningreason_id
    ...
    // define the local variable for ezsignsigningreason_request_compound->b_ezsignsigningreason_isactive
