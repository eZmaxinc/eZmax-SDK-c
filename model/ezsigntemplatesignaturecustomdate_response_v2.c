...
static ezsigntemplatesignaturecustomdate_response_v2_t *ezsigntemplatesignaturecustomdate_response_v2_create_internal(
    ...
    memset(ezsigntemplatesignaturecustomdate_response_v2_local_var, 0, sizeof(ezsigntemplatesignaturecustomdate_response_v2_t));
    ezsigntemplatesignaturecustomdate_response_v2_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezsigntemplatesignaturecustomdate_response_v2_t *ezsigntemplatesignaturecustomdate_response_v2_create(
    int *pki_ezsigntemplatesignaturecustomdate_id,
    int *i_ezsigntemplatesignaturecustomdate_offsetx,
    int *i_ezsigntemplatesignaturecustomdate_offsety,
    char *s_ezsigntemplatesignaturecustomdate_format
    ...
    ezsigntemplatesignaturecustomdate_response_v2_t *result = ezsigntemplatesignaturecustomdate_response_v2_create_internal (
...
void ezsigntemplatesignaturecustomdate_response_v2_free(ezsigntemplatesignaturecustomdate_response_v2_t *ezsigntemplatesignaturecustomdate_response_v2) {
    ...
    if(ezsigntemplatesignaturecustomdate_response_v2->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsigntemplatesignaturecustomdate_response_v2_free");
        return ;
    }
    listEntry_t *listEntry;
    if (ezsigntemplatesignaturecustomdate_response_v2->pki_ezsigntemplatesignaturecustomdate_id) {
        free(ezsigntemplatesignaturecustomdate_response_v2->pki_ezsigntemplatesignaturecustomdate_id);
        ezsigntemplatesignaturecustomdate_response_v2->pki_ezsigntemplatesignaturecustomdate_id = NULL;
    }
    if (ezsigntemplatesignaturecustomdate_response_v2->i_ezsigntemplatesignaturecustomdate_offsetx) {
        free(ezsigntemplatesignaturecustomdate_response_v2->i_ezsigntemplatesignaturecustomdate_offsetx);
        ezsigntemplatesignaturecustomdate_response_v2->i_ezsigntemplatesignaturecustomdate_offsetx = NULL;
    }
    if (ezsigntemplatesignaturecustomdate_response_v2->i_ezsigntemplatesignaturecustomdate_offsety) {
        free(ezsigntemplatesignaturecustomdate_response_v2->i_ezsigntemplatesignaturecustomdate_offsety);
        ezsigntemplatesignaturecustomdate_response_v2->i_ezsigntemplatesignaturecustomdate_offsety = NULL;
    }
...
ezsigntemplatesignaturecustomdate_response_v2_t *ezsigntemplatesignaturecustomdate_response_v2_parseFromJSON(cJSON *ezsigntemplatesignaturecustomdate_response_v2JSON){
    ...
    // define the local variable for ezsigntemplatesignaturecustomdate_response_v2->pki_ezsigntemplatesignaturecustomdate_id
    int *pki_ezsigntemplatesignaturecustomdate_id_local_var = NULL;

    // define the local variable for ezsigntemplatesignaturecustomdate_response_v2->i_ezsigntemplatesignaturecustomdate_offsetx
    int *i_ezsigntemplatesignaturecustomdate_offsetx_local_var = NULL;

    // define the local variable for ezsigntemplatesignaturecustomdate_response_v2->i_ezsigntemplatesignaturecustomdate_offsety
    ...
    *i_ezsigntemplatesignaturecustomdate_offsety_local_var = i_ezsigntemplatesignaturecustomdate_offsety->valuedouble;
    ...
    ezsigntemplatesignaturecustomdate_response_v2_local_var = ezsigntemplatesignaturecustomdate_response_v2_create_internal (
