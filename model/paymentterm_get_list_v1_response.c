...
static paymentterm_get_list_v1_response_t *paymentterm_get_list_v1_response_create_internal(
    ...
    memset(paymentterm_get_list_v1_response_local_var, 0, sizeof(paymentterm_get_list_v1_response_t));
...
__attribute__((deprecated)) paymentterm_get_list_v1_response_t *paymentterm_get_list_v1_response_create(
    ...
    paymentterm_get_list_v1_response_t *result = paymentterm_get_list_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
