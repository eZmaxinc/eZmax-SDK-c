/*
 * attachmentrejectreason_get_autocomplete_v2_response_m_payload.h
 *
 * Payload for POST /2/object/attachmentrejectreason/getAutocomplete
 */

#ifndef _attachmentrejectreason_get_autocomplete_v2_response_m_payload_H_
#define _attachmentrejectreason_get_autocomplete_v2_response_m_payload_H_
...
typedef struct attachmentrejectreason_get_autocomplete_v2_response_m_payload_t attachmentrejectreason_get_autocomplete_v2_response_m_payload_t;

#include "attachmentrejectreason_autocomplete_element_response.h"



typedef struct attachmentrejectreason_get_autocomplete_v2_response_m_payload_t {
    list_t *a_obj_attachmentrejectreason; //nonprimitive container

    int _library_owned; // Is the library responsible for freeing this object?
} attachmentrejectreason_get_autocomplete_v2_response_m_payload_t;
...
#endif /* _attachmentrejectreason_get_autocomplete_v2_response_m_payload_H_ */
