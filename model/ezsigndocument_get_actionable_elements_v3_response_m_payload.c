...
#include <string.h>
#include <stdio.h>
#include "ezsigndocument_get_actionable_elements_v3_response_m_payload.h"



static ezsigndocument_get_actionable_elements_v3_response_m_payload_t *ezsigndocument_get_actionable_elements_v3_response_m_payload_create_internal(
    list_t *a_obj_ezsignsignature,
    list_t *a_obj_ezsignformfieldgroup
    ) {
    ezsigndocument_get_actionable_elements_v3_response_m_payload_t *ezsigndocument_get_actionable_elements_v3_response_m_payload_local_var = malloc(sizeof(ezsigndocument_get_actionable_elements_v3_response_m_payload_t));
...
__attribute__((deprecated)) ezsigndocument_get_actionable_elements_v3_response_m_payload_t *ezsigndocument_get_actionable_elements_v3_response_m_payload_create(
    list_t *a_obj_ezsignsignature,
    list_t *a_obj_ezsignformfieldgroup
    ) {
...
void ezsigndocument_get_actionable_elements_v3_response_m_payload_free(ezsigndocument_get_actionable_elements_v3_response_m_payload_t *ezsigndocument_get_actionable_elements_v3_response_m_payload) {
    if(NULL == ezsigndocument_get_actionable_elements_v3_response_m_payload){
        return ;
    }
    if(ezsigndocument_get_actionable_elements_v3_response_m_payload->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsigndocument_get_actionable_elements_v3_response_m_payload_free");
        return ;
    }
    listEntry_t *listEntry;
    if (ezsigndocument_get_actionable_elements_v3_response_m_payload->a_obj_ezsignsignature) {
        list_ForEach(listEntry, ezsigndocument_get_actionable_elements_v3_response_m_payload->a_obj_ezsignsignature) {
            ezsignsignature_response_compound_free(listEntry->data);
        }
        list_freeList(ezsigndocument_get_actionable_elements_v3_response_m_payload->a_obj_ezsignsignature);
        ezsigndocument_get_actionable_elements_v3_response_m_payload->a_obj_ezsignsignature = NULL;
    }
    if (ezsigndocument_get_actionable_elements_v3_response_m_payload->a_obj_ezsignformfieldgroup) {
        list_ForEach(listEntry, ezsigndocument_get_actionable_elements_v3_response_m_payload->a_obj_ezsignformfieldgroup) {
            ezsignformfieldgroup_response_compound_free(listEntry->data);
        }
        list_freeList(ezsigndocument_get_actionable_elements_v3_response_m_payload->a_obj_ezsignformfieldgroup);
        ezsigndocument_get_actionable_elements_v3_response_m_payload->a_obj_ezsignformfieldgroup = NULL;
    }
    free(ezsigndocument_get_actionable_elements_v3_response_m_payload);
}

cJSON *ezsigndocument_get_actionable_elements_v3_response_m_payload_convertToJSON(ezsigndocument_get_actionable_elements_v3_response_m_payload_t *ezsigndocument_get_actionable_elements_v3_response_m_payload) {
    cJSON *item = cJSON_CreateObject();

    // ezsigndocument_get_actionable_elements_v3_response_m_payload->a_obj_ezsignsignature
    if (!ezsigndocument_get_actionable_elements_v3_response_m_payload->a_obj_ezsignsignature) {
        goto fail;
    }
    ...
    if (ezsigndocument_get_actionable_elements_v3_response_m_payload->a_obj_ezsignsignature) {
    list_ForEach(a_obj_ezsignsignatureListEntry, ezsigndocument_get_actionable_elements_v3_response_m_payload->a_obj_ezsignsignature) {
    ...
    // ezsigndocument_get_actionable_elements_v3_response_m_payload->a_obj_ezsignformfieldgroup
    if (!ezsigndocument_get_actionable_elements_v3_response_m_payload->a_obj_ezsignformfieldgroup) {
        goto fail;
    }
    ...
    if (ezsigndocument_get_actionable_elements_v3_response_m_payload->a_obj_ezsignformfieldgroup) {
    list_ForEach(a_obj_ezsignformfieldgroupListEntry, ezsigndocument_get_actionable_elements_v3_response_m_payload->a_obj_ezsignformfieldgroup) {
...
ezsigndocument_get_actionable_elements_v3_response_m_payload_t *ezsigndocument_get_actionable_elements_v3_response_m_payload_parseFromJSON(cJSON *ezsigndocument_get_actionable_elements_v3_response_m_payloadJSON){

    ezsigndocument_get_actionable_elements_v3_response_m_payload_t *ezsigndocument_get_actionable_elements_v3_response_m_payload_local_var = NULL;

    // define the local list for ezsigndocument_get_actionable_elements_v3_response_m_payload->a_obj_ezsignsignature
    list_t *a_obj_ezsignsignatureList = NULL;

    // define the local list for ezsigndocument_get_actionable_elements_v3_response_m_payload->a_obj_ezsignformfieldgroup
    list_t *a_obj_ezsignformfieldgroupList = NULL;

    // ezsigndocument_get_actionable_elements_v3_response_m_payload->a_obj_ezsignsignature
    cJSON *a_obj_ezsignsignature = cJSON_GetObjectItemCaseSensitive(ezsigndocument_get_actionable_elements_v3_response_m_payloadJSON, "a_objEzsignsignature");
    ...
    // ezsigndocument_get_actionable_elements_v3_response_m_payload->a_obj_ezsignformfieldgroup
    cJSON *a_obj_ezsignformfieldgroup = cJSON_GetObjectItemCaseSensitive(ezsigndocument_get_actionable_elements_v3_response_m_payloadJSON, "a_objEzsignformfieldgroup");
