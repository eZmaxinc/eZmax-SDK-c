...
static ezsigndocument_request_compound_t *ezsigndocument_request_compound_create_internal(
    ...
    memset(ezsigndocument_request_compound_local_var, 0, sizeof(ezsigndocument_request_compound_t));
    ...
    ezsigndocument_request_compound_local_var->fki_ezsignimportdocument_id = fki_ezsignimportdocument_id;
...
__attribute__((deprecated)) ezsigndocument_request_compound_t *ezsigndocument_request_compound_create(
    ...
    ezsigndocument_request_compound_t *result = ezsigndocument_request_compound_create_internal (
...
void ezsigndocument_request_compound_free(ezsigndocument_request_compound_t *ezsigndocument_request_compound) {
    ...
    if (ezsigndocument_request_compound->pki_ezsigndocument_id) {
        free(ezsigndocument_request_compound->pki_ezsigndocument_id);
        ezsigndocument_request_compound->pki_ezsigndocument_id = NULL;
    }
    if (ezsigndocument_request_compound->fki_ezsignfolder_id) {
        free(ezsigndocument_request_compound->fki_ezsignfolder_id);
        ezsigndocument_request_compound->fki_ezsignfolder_id = NULL;
    }
    if (ezsigndocument_request_compound->fki_ezsigntemplate_id) {
        free(ezsigndocument_request_compound->fki_ezsigntemplate_id);
        ezsigndocument_request_compound->fki_ezsigntemplate_id = NULL;
    }
    if (ezsigndocument_request_compound->fki_ezsignfoldersignerassociation_id) {
        free(ezsigndocument_request_compound->fki_ezsignfoldersignerassociation_id);
        ezsigndocument_request_compound->fki_ezsignfoldersignerassociation_id = NULL;
    }
    if (ezsigndocument_request_compound->fki_ezsignimportdocument_id) {
        free(ezsigndocument_request_compound->fki_ezsignimportdocument_id);
        ezsigndocument_request_compound->fki_ezsignimportdocument_id = NULL;
    }
    if (ezsigndocument_request_compound->fki_language_id) {
        free(ezsigndocument_request_compound->fki_language_id);
        ezsigndocument_request_compound->fki_language_id = NULL;
    }
    ...
    if (ezsigndocument_request_compound->b_ezsigndocument_forcerepair) {
        free(ezsigndocument_request_compound->b_ezsigndocument_forcerepair);
        ezsigndocument_request_compound->b_ezsigndocument_forcerepair = NULL;
    }
...
cJSON *ezsigndocument_request_compound_convertToJSON(ezsigndocument_request_compound_t *ezsigndocument_request_compound) {
    ...
    // ezsigndocument_request_compound->fki_ezsignimportdocument_id
    if(ezsigndocument_request_compound->fki_ezsignimportdocument_id) {
    if(cJSON_AddNumberToObject(item, "fkiEzsignimportdocumentID", *ezsigndocument_request_compound->fki_ezsignimportdocument_id) == NULL) {
    goto fail; //Numeric
    }
    }
...
ezsigndocument_request_compound_t *ezsigndocument_request_compound_parseFromJSON(cJSON *ezsigndocument_request_compoundJSON){
    ...
    // define the local variable for ezsigndocument_request_compound->pki_ezsigndocument_id
    int *pki_ezsigndocument_id_local_var = NULL;

    // define the local variable for ezsigndocument_request_compound->fki_ezsignfolder_id
    int *fki_ezsignfolder_id_local_var = NULL;

    // define the local variable for ezsigndocument_request_compound->fki_ezsigntemplate_id
    int *fki_ezsigntemplate_id_local_var = NULL;

    // define the local variable for ezsigndocument_request_compound->fki_ezsignfoldersignerassociation_id
    int *fki_ezsignfoldersignerassociation_id_local_var = NULL;

    // define the local variable for ezsigndocument_request_compound->fki_ezsignimportdocument_id
    int *fki_ezsignimportdocument_id_local_var = NULL;

    // define the local variable for ezsigndocument_request_compound->fki_language_id
    ...
    // define the local variable for ezsigndocument_request_compound->b_ezsigndocument_forcerepair
    ...
    *fki_ezsignfoldersignerassociation_id_local_var = fki_ezsignfoldersignerassociation_id->valuedouble;
    ...
    // ezsigndocument_request_compound->fki_ezsignimportdocument_id
    cJSON *fki_ezsignimportdocument_id = cJSON_GetObjectItemCaseSensitive(ezsigndocument_request_compoundJSON, "fkiEzsignimportdocumentID");
