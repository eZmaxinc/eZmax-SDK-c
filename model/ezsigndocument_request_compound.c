...
ezsigndocument_request_compound_t *ezsigndocument_request_compound_create(
    ...
    ezsigndocument_request_compound_local_var->s_ezsigndocument_filename = s_ezsigndocument_filename;
...
void ezsigndocument_request_compound_free(ezsigndocument_request_compound_t *ezsigndocument_request_compound) {
    ...
    if (ezsigndocument_request_compound->s_ezsigndocument_filename) {
        free(ezsigndocument_request_compound->s_ezsigndocument_filename);
        ezsigndocument_request_compound->s_ezsigndocument_filename = NULL;
    }
...
cJSON *ezsigndocument_request_compound_convertToJSON(ezsigndocument_request_compound_t *ezsigndocument_request_compound) {
    ...
    // ezsigndocument_request_compound->s_ezsigndocument_filename
    if (!ezsigndocument_request_compound->s_ezsigndocument_filename) {
        goto fail;
    }
    
    if(cJSON_AddStringToObject(item, "sEzsigndocumentFilename", ezsigndocument_request_compound->s_ezsigndocument_filename) == NULL) {
    goto fail; //String
    }
...
ezsigndocument_request_compound_t *ezsigndocument_request_compound_parseFromJSON(cJSON *ezsigndocument_request_compoundJSON){
    ...
    // ezsigndocument_request_compound->s_ezsigndocument_filename
    cJSON *s_ezsigndocument_filename = cJSON_GetObjectItemCaseSensitive(ezsigndocument_request_compoundJSON, "sEzsigndocumentFilename");
