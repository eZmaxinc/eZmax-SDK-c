...
static authenticationexternal_reset_authorization_v1_response_t *authenticationexternal_reset_authorization_v1_response_create_internal(
    ...
    memset(authenticationexternal_reset_authorization_v1_response_local_var, 0, sizeof(authenticationexternal_reset_authorization_v1_response_t));
...
__attribute__((deprecated)) authenticationexternal_reset_authorization_v1_response_t *authenticationexternal_reset_authorization_v1_response_create(
    ...
    authenticationexternal_reset_authorization_v1_response_t *result = authenticationexternal_reset_authorization_v1_response_create_internal (
        obj_debug_payload,
        obj_debug
        );
    if (!result) {
