/*
 * websocket_response_get_websocket_id_v1_m_payload.h
 *
 * Payload for Websocket GetWebsocketID V1
 */

#ifndef _websocket_response_get_websocket_id_v1_m_payload_H_
#define _websocket_response_get_websocket_id_v1_m_payload_H_
...
typedef struct websocket_response_get_websocket_id_v1_m_payload_t websocket_response_get_websocket_id_v1_m_payload_t;




typedef struct websocket_response_get_websocket_id_v1_m_payload_t {
    char *s_websocket_id; // string

} websocket_response_get_websocket_id_v1_m_payload_t;
...
#endif /* _websocket_response_get_websocket_id_v1_m_payload_H_ */
