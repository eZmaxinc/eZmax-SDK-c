...
static ezsignfoldersignerassociation_patch_object_v1_response_t *ezsignfoldersignerassociation_patch_object_v1_response_create_internal(
    ...
    memset(ezsignfoldersignerassociation_patch_object_v1_response_local_var, 0, sizeof(ezsignfoldersignerassociation_patch_object_v1_response_t));
    ezsignfoldersignerassociation_patch_object_v1_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezsignfoldersignerassociation_patch_object_v1_response_t *ezsignfoldersignerassociation_patch_object_v1_response_create(
    common_response_obj_debug_payload_t *obj_debug_payload,
    common_response_obj_debug_t *obj_debug
    ) {
    ezsignfoldersignerassociation_patch_object_v1_response_t *result = ezsignfoldersignerassociation_patch_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug
        );
    if (!result) {
...
void ezsignfoldersignerassociation_patch_object_v1_response_free(ezsignfoldersignerassociation_patch_object_v1_response_t *ezsignfoldersignerassociation_patch_object_v1_response) {
    ...
    if(ezsignfoldersignerassociation_patch_object_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsignfoldersignerassociation_patch_object_v1_response_free");
        return ;
    }
...
ezsignfoldersignerassociation_patch_object_v1_response_t *ezsignfoldersignerassociation_patch_object_v1_response_parseFromJSON(cJSON *ezsignfoldersignerassociation_patch_object_v1_responseJSON){
    ...
    ezsignfoldersignerassociation_patch_object_v1_response_local_var = ezsignfoldersignerassociation_patch_object_v1_response_create_internal (
