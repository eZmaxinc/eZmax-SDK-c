...
static ezsignbulksend_response_compound_t *ezsignbulksend_response_compound_create_internal(
    ...
    memset(ezsignbulksend_response_compound_local_var, 0, sizeof(ezsignbulksend_response_compound_t));
    ezsignbulksend_response_compound_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezsignbulksend_response_compound_t *ezsignbulksend_response_compound_create(
    ...
    ezsignbulksend_response_compound_t *result = ezsignbulksend_response_compound_create_internal (
...
void ezsignbulksend_response_compound_free(ezsignbulksend_response_compound_t *ezsignbulksend_response_compound) {
    ...
    if(ezsignbulksend_response_compound->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsignbulksend_response_compound_free");
        return ;
    }
    listEntry_t *listEntry;
    if (ezsignbulksend_response_compound->pki_ezsignbulksend_id) {
        free(ezsignbulksend_response_compound->pki_ezsignbulksend_id);
        ezsignbulksend_response_compound->pki_ezsignbulksend_id = NULL;
    }
    if (ezsignbulksend_response_compound->fki_ezsignfoldertype_id) {
        free(ezsignbulksend_response_compound->fki_ezsignfoldertype_id);
        ezsignbulksend_response_compound->fki_ezsignfoldertype_id = NULL;
    }
    if (ezsignbulksend_response_compound->fki_language_id) {
        free(ezsignbulksend_response_compound->fki_language_id);
        ezsignbulksend_response_compound->fki_language_id = NULL;
    }
    ...
    if (ezsignbulksend_response_compound->b_ezsignbulksend_needvalidation) {
        free(ezsignbulksend_response_compound->b_ezsignbulksend_needvalidation);
        ezsignbulksend_response_compound->b_ezsignbulksend_needvalidation = NULL;
    }
    if (ezsignbulksend_response_compound->b_ezsignbulksend_isactive) {
        free(ezsignbulksend_response_compound->b_ezsignbulksend_isactive);
        ezsignbulksend_response_compound->b_ezsignbulksend_isactive = NULL;
    }
...
cJSON *ezsignbulksend_response_compound_convertToJSON(ezsignbulksend_response_compound_t *ezsignbulksend_response_compound) {
    ...
    if (ezmax_api_definition__full_field_e_ezsignfoldertype_privacylevel__NULL == ezsignbulksend_response_compound->e_ezsignfoldertype_privacylevel) {
        goto fail;
    }
...
ezsignbulksend_response_compound_t *ezsignbulksend_response_compound_parseFromJSON(cJSON *ezsignbulksend_response_compoundJSON){
    ...
    // define the local variable for ezsignbulksend_response_compound->pki_ezsignbulksend_id
    int *pki_ezsignbulksend_id_local_var = NULL;

    // define the local variable for ezsignbulksend_response_compound->fki_ezsignfoldertype_id
    int *fki_ezsignfoldertype_id_local_var = NULL;

    // define the local variable for ezsignbulksend_response_compound->fki_language_id
    ...
    // define the local variable for ezsignbulksend_response_compound->b_ezsignbulksend_needvalidation
    int *b_ezsignbulksend_needvalidation_local_var = NULL;

    // define the local variable for ezsignbulksend_response_compound->b_ezsignbulksend_isactive
    ...
    *b_ezsignbulksend_isactive_local_var = b_ezsignbulksend_isactive->valueint;
    ...
    ezsignbulksend_response_compound_local_var = ezsignbulksend_response_compound_create_internal (
