...
void ezsignelementdependency_request_compound_free(ezsignelementdependency_request_compound_t *ezsignelementdependency_request_compound) {
    ...
    if (ezsignelementdependency_request_compound->e_ezsignelementdependency_validation) {
        field_e_ezsignelementdependency_validation_free(ezsignelementdependency_request_compound->e_ezsignelementdependency_validation);
        ezsignelementdependency_request_compound->e_ezsignelementdependency_validation = NULL;
    }
    if (ezsignelementdependency_request_compound->e_ezsignelementdependency_operator) {
        field_e_ezsignelementdependency_operator_free(ezsignelementdependency_request_compound->e_ezsignelementdependency_operator);
        ezsignelementdependency_request_compound->e_ezsignelementdependency_operator = NULL;
    }
...
cJSON *ezsignelementdependency_request_compound_convertToJSON(ezsignelementdependency_request_compound_t *ezsignelementdependency_request_compound) {
    ...
    if (ezmax_api_definition__full_ezsignelementdependency_request_compound__NULL == ezsignelementdependency_request_compound->e_ezsignelementdependency_validation) {
        goto fail;
    }
    ...
    if(ezsignelementdependency_request_compound->e_ezsignelementdependency_operator != ezmax_api_definition__full_ezsignelementdependency_request_compound__NULL) {
...
ezsignelementdependency_request_compound_t *ezsignelementdependency_request_compound_parseFromJSON(cJSON *ezsignelementdependency_request_compoundJSON){
    ...
    ezsignelementdependency_request_compound_local_var = ezsignelementdependency_request_compound_create (
