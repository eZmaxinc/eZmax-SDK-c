...
ezsigntemplatepublic_edit_object_v1_request_t *ezsigntemplatepublic_edit_object_v1_request_create(
...
ezsigntemplatepublic_edit_object_v1_request_t *ezsigntemplatepublic_edit_object_v1_request_parseFromJSON(cJSON *ezsigntemplatepublic_edit_object_v1_requestJSON){
    ...
    ezsigntemplatepublic_edit_object_v1_request_local_var = ezsigntemplatepublic_edit_object_v1_request_create (
