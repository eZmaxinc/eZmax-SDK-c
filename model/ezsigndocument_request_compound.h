...
typedef enum  { ezmax_api_definition_ezsigndocument_request_compound_EEZSIGNDOCUMENTSOURCE_NULL = 0, ezmax_api_definition_ezsigndocument_request_compound_EEZSIGNDOCUMENTSOURCE_Base64 } ezmax_api_definition_ezsigndocument_request_compound_EEZSIGNDOCUMENTSOURCE_e;
