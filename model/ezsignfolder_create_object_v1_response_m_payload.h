/*
 * ezsignfolder_create_object_v1_response_m_payload.h
 *
 * Payload for POST /1/object/ezsignfolder
 */

#ifndef _ezsignfolder_create_object_v1_response_m_payload_H_
#define _ezsignfolder_create_object_v1_response_m_payload_H_
...
typedef struct ezsignfolder_create_object_v1_response_m_payload_t ezsignfolder_create_object_v1_response_m_payload_t;




typedef struct ezsignfolder_create_object_v1_response_m_payload_t {
    list_t *a_pki_ezsignfolder_id; //primitive container

} ezsignfolder_create_object_v1_response_m_payload_t;
...
#endif /* _ezsignfolder_create_object_v1_response_m_payload_H_ */
