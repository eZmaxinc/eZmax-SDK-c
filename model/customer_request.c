...
static customer_request_t *customer_request_create_internal(
    ...
    customer_request_local_var->s_customer_note = s_customer_note;
...
void customer_request_free(customer_request_t *customer_request) {
    ...
    if (customer_request->s_customer_note) {
        free(customer_request->s_customer_note);
        customer_request->s_customer_note = NULL;
    }
...
cJSON *customer_request_convertToJSON(customer_request_t *customer_request) {
    ...
    // customer_request->s_customer_note
    if(customer_request->s_customer_note) {
    if(cJSON_AddStringToObject(item, "sCustomerNote", customer_request->s_customer_note) == NULL) {
    goto fail; //String
    }
    }
...
customer_request_t *customer_request_parseFromJSON(cJSON *customer_requestJSON){
    ...
    // customer_request->s_customer_note
    cJSON *s_customer_note = cJSON_GetObjectItemCaseSensitive(customer_requestJSON, "sCustomerNote");
