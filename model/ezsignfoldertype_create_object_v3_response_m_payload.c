...
static ezsignfoldertype_create_object_v3_response_m_payload_t *ezsignfoldertype_create_object_v3_response_m_payload_create_internal(
    ...
    if (!ezsignfoldertype_create_object_v3_response_m_payload_local_var) {
        return NULL;
    }
    memset(ezsignfoldertype_create_object_v3_response_m_payload_local_var, 0, sizeof(ezsignfoldertype_create_object_v3_response_m_payload_t));
...
__attribute__((deprecated)) ezsignfoldertype_create_object_v3_response_m_payload_t *ezsignfoldertype_create_object_v3_response_m_payload_create(
    ...
    ezsignfoldertype_create_object_v3_response_m_payload_t *result = ezsignfoldertype_create_object_v3_response_m_payload_create_internal (
...
void ezsignfoldertype_create_object_v3_response_m_payload_free(ezsignfoldertype_create_object_v3_response_m_payload_t *ezsignfoldertype_create_object_v3_response_m_payload) {
    ...
    if (ezsignfoldertype_create_object_v3_response_m_payload->a_pki_ezsignfoldertype_id) {
        list_ForEach(listEntry, ezsignfoldertype_create_object_v3_response_m_payload->a_pki_ezsignfoldertype_id) {
            free(listEntry->data);
        }
        list_freeList(ezsignfoldertype_create_object_v3_response_m_payload->a_pki_ezsignfoldertype_id);
        ezsignfoldertype_create_object_v3_response_m_payload->a_pki_ezsignfoldertype_id = NULL;
    }
    free(ezsignfoldertype_create_object_v3_response_m_payload);
}
...
cJSON *ezsignfoldertype_create_object_v3_response_m_payload_convertToJSON(ezsignfoldertype_create_object_v3_response_m_payload_t *ezsignfoldertype_create_object_v3_response_m_payload) {
    ...
    list_ForEach(a_pki_ezsignfoldertype_idListEntry, ezsignfoldertype_create_object_v3_response_m_payload->a_pki_ezsignfoldertype_id) {
...
ezsignfoldertype_create_object_v3_response_m_payload_t *ezsignfoldertype_create_object_v3_response_m_payload_parseFromJSON(cJSON *ezsignfoldertype_create_object_v3_response_m_payloadJSON){
    ...
    ezsignfoldertype_create_object_v3_response_m_payload_t *ezsignfoldertype_create_object_v3_response_m_payload_local_var = NULL;

    // define the local list for ezsignfoldertype_create_object_v3_response_m_payload->a_pki_ezsignfoldertype_id
