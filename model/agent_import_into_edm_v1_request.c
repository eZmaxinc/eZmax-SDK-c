...
static agent_import_into_edm_v1_request_t *agent_import_into_edm_v1_request_create_internal(
    ...
    memset(agent_import_into_edm_v1_request_local_var, 0, sizeof(agent_import_into_edm_v1_request_t));
...
__attribute__((deprecated)) agent_import_into_edm_v1_request_t *agent_import_into_edm_v1_request_create(
    ...
    agent_import_into_edm_v1_request_t *result = agent_import_into_edm_v1_request_create_internal (
        a_obj_attachment
        );
    if (!result) {
    }
