...
static ezsigntemplatepublic_response_t *ezsigntemplatepublic_response_create_internal(
    ...
    memset(ezsigntemplatepublic_response_local_var, 0, sizeof(ezsigntemplatepublic_response_t));
...
__attribute__((deprecated)) ezsigntemplatepublic_response_t *ezsigntemplatepublic_response_create(
    ...
    ezsigntemplatepublic_response_t *result = ezsigntemplatepublic_response_create_internal (
...
void ezsigntemplatepublic_response_free(ezsigntemplatepublic_response_t *ezsigntemplatepublic_response) {
    ...
    if (ezsigntemplatepublic_response->pki_ezsigntemplatepublic_id) {
        free(ezsigntemplatepublic_response->pki_ezsigntemplatepublic_id);
        ezsigntemplatepublic_response->pki_ezsigntemplatepublic_id = NULL;
    }
    if (ezsigntemplatepublic_response->fki_ezsignfoldertype_id) {
        free(ezsigntemplatepublic_response->fki_ezsignfoldertype_id);
        ezsigntemplatepublic_response->fki_ezsignfoldertype_id = NULL;
    }
    ...
    if (ezsigntemplatepublic_response->fki_userlogintype_id) {
        free(ezsigntemplatepublic_response->fki_userlogintype_id);
        ezsigntemplatepublic_response->fki_userlogintype_id = NULL;
    }
    ...
    if (ezsigntemplatepublic_response->fki_ezsigntemplate_id) {
        free(ezsigntemplatepublic_response->fki_ezsigntemplate_id);
        ezsigntemplatepublic_response->fki_ezsigntemplate_id = NULL;
    }
    if (ezsigntemplatepublic_response->fki_ezsigntemplatepackage_id) {
        free(ezsigntemplatepublic_response->fki_ezsigntemplatepackage_id);
        ezsigntemplatepublic_response->fki_ezsigntemplatepackage_id = NULL;
    }
    ...
    if (ezsigntemplatepublic_response->b_ezsigntemplatepublic_isactive) {
        free(ezsigntemplatepublic_response->b_ezsigntemplatepublic_isactive);
        ezsigntemplatepublic_response->b_ezsigntemplatepublic_isactive = NULL;
    }
    ...
    if (ezsigntemplatepublic_response->i_ezsigntemplatepublic_limit) {
        free(ezsigntemplatepublic_response->i_ezsigntemplatepublic_limit);
        ezsigntemplatepublic_response->i_ezsigntemplatepublic_limit = NULL;
    }
    if (ezsigntemplatepublic_response->i_ezsigntemplatepublic_limitexceeded) {
        free(ezsigntemplatepublic_response->i_ezsigntemplatepublic_limitexceeded);
        ezsigntemplatepublic_response->i_ezsigntemplatepublic_limitexceeded = NULL;
    }
...
ezsigntemplatepublic_response_t *ezsigntemplatepublic_response_parseFromJSON(cJSON *ezsigntemplatepublic_responseJSON){
    ...
    // define the local variable for ezsigntemplatepublic_response->pki_ezsigntemplatepublic_id
    int *pki_ezsigntemplatepublic_id_local_var = NULL;

    // define the local variable for ezsigntemplatepublic_response->fki_ezsignfoldertype_id
    int *fki_ezsignfoldertype_id_local_var = NULL;

    char *s_ezsignfoldertype_name_x_local_str = NULL;

    // define the local variable for ezsigntemplatepublic_response->fki_userlogintype_id
    int *fki_userlogintype_id_local_var = NULL;

    char *s_userlogintype_description_x_local_str = NULL;

    // define the local variable for ezsigntemplatepublic_response->fki_ezsigntemplate_id
    int *fki_ezsigntemplate_id_local_var = NULL;

    // define the local variable for ezsigntemplatepublic_response->fki_ezsigntemplatepackage_id
    ...
    // define the local variable for ezsigntemplatepublic_response->b_ezsigntemplatepublic_isactive
    ...
    // define the local variable for ezsigntemplatepublic_response->i_ezsigntemplatepublic_limit
    int *i_ezsigntemplatepublic_limit_local_var = NULL;

    // define the local variable for ezsigntemplatepublic_response->i_ezsigntemplatepublic_limitexceeded
