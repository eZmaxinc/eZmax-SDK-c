...
static otherincome_get_communicationrecipients_v1_response_t *otherincome_get_communicationrecipients_v1_response_create_internal(
    ...
    memset(otherincome_get_communicationrecipients_v1_response_local_var, 0, sizeof(otherincome_get_communicationrecipients_v1_response_t));
    otherincome_get_communicationrecipients_v1_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) otherincome_get_communicationrecipients_v1_response_t *otherincome_get_communicationrecipients_v1_response_create(
    ...
    otherincome_get_communicationrecipients_v1_response_t *result = otherincome_get_communicationrecipients_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void otherincome_get_communicationrecipients_v1_response_free(otherincome_get_communicationrecipients_v1_response_t *otherincome_get_communicationrecipients_v1_response) {
    ...
    if(otherincome_get_communicationrecipients_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "otherincome_get_communicationrecipients_v1_response_free");
        return ;
    }
...
otherincome_get_communicationrecipients_v1_response_t *otherincome_get_communicationrecipients_v1_response_parseFromJSON(cJSON *otherincome_get_communicationrecipients_v1_responseJSON){
    ...
    otherincome_get_communicationrecipients_v1_response_local_var = otherincome_get_communicationrecipients_v1_response_create_internal (
