...
static ezsignfolder_send_v1_response_t *ezsignfolder_send_v1_response_create_internal(
    ...
    ezsignfolder_send_v1_response_t *ezsignfolder_send_v1_response_local_var = malloc(sizeof(ezsignfolder_send_v1_response_t));
    if (!ezsignfolder_send_v1_response_local_var) {
        return NULL;
    }
    memset(ezsignfolder_send_v1_response_local_var, 0, sizeof(ezsignfolder_send_v1_response_t));
...
__attribute__((deprecated)) ezsignfolder_send_v1_response_t *ezsignfolder_send_v1_response_create(
    ...
    ezsignfolder_send_v1_response_t *result = ezsignfolder_send_v1_response_create_internal (
        obj_debug_payload,
        obj_debug
        );
    if (!result) {
...
void ezsignfolder_send_v1_response_free(ezsignfolder_send_v1_response_t *ezsignfolder_send_v1_response) {
    ...
    if (ezsignfolder_send_v1_response->obj_debug_payload) {
        common_response_obj_debug_payload_free(ezsignfolder_send_v1_response->obj_debug_payload);
        ezsignfolder_send_v1_response->obj_debug_payload = NULL;
    }
    if (ezsignfolder_send_v1_response->obj_debug) {
        common_response_obj_debug_free(ezsignfolder_send_v1_response->obj_debug);
        ezsignfolder_send_v1_response->obj_debug = NULL;
    }
    free(ezsignfolder_send_v1_response);
}
...
cJSON *ezsignfolder_send_v1_response_convertToJSON(ezsignfolder_send_v1_response_t *ezsignfolder_send_v1_response) {
    ...
    cJSON *obj_debug_payload_local_JSON = common_response_obj_debug_payload_convertToJSON(ezsignfolder_send_v1_response->obj_debug_payload);
    ...
    if(ezsignfolder_send_v1_response->obj_debug) {
    cJSON *obj_debug_local_JSON = common_response_obj_debug_convertToJSON(ezsignfolder_send_v1_response->obj_debug);
...
ezsignfolder_send_v1_response_t *ezsignfolder_send_v1_response_parseFromJSON(cJSON *ezsignfolder_send_v1_responseJSON){
    ...
    ezsignfolder_send_v1_response_t *ezsignfolder_send_v1_response_local_var = NULL;

    // define the local variable for ezsignfolder_send_v1_response->obj_debug_payload
    common_response_obj_debug_payload_t *obj_debug_payload_local_nonprim = NULL;

    // define the local variable for ezsignfolder_send_v1_response->obj_debug
