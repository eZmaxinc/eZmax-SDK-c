...
static branding_get_object_v3_response_t *branding_get_object_v3_response_create_internal(
    ...
    memset(branding_get_object_v3_response_local_var, 0, sizeof(branding_get_object_v3_response_t));
    branding_get_object_v3_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) branding_get_object_v3_response_t *branding_get_object_v3_response_create(
    ...
    branding_get_object_v3_response_t *result = branding_get_object_v3_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void branding_get_object_v3_response_free(branding_get_object_v3_response_t *branding_get_object_v3_response) {
    ...
    if(branding_get_object_v3_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "branding_get_object_v3_response_free");
        return ;
    }
...
branding_get_object_v3_response_t *branding_get_object_v3_response_parseFromJSON(cJSON *branding_get_object_v3_responseJSON){
    ...
    branding_get_object_v3_response_local_var = branding_get_object_v3_response_create_internal (
