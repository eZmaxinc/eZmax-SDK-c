...
static variableexpense_request_compound_t *variableexpense_request_compound_create_internal(
    ...
    memset(variableexpense_request_compound_local_var, 0, sizeof(variableexpense_request_compound_t));
    variableexpense_request_compound_local_var->_library_owned = 1;
...
__attribute__((deprecated)) variableexpense_request_compound_t *variableexpense_request_compound_create(
    ...
    variableexpense_request_compound_t *result = variableexpense_request_compound_create_internal (
...
void variableexpense_request_compound_free(variableexpense_request_compound_t *variableexpense_request_compound) {
    ...
    if(variableexpense_request_compound->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "variableexpense_request_compound_free");
        return ;
    }
    listEntry_t *listEntry;
    if (variableexpense_request_compound->pki_variableexpense_id) {
        free(variableexpense_request_compound->pki_variableexpense_id);
        variableexpense_request_compound->pki_variableexpense_id = NULL;
    }
    ...
    if (variableexpense_request_compound->b_variableexpense_isactive) {
        free(variableexpense_request_compound->b_variableexpense_isactive);
        variableexpense_request_compound->b_variableexpense_isactive = NULL;
    }
...
cJSON *variableexpense_request_compound_convertToJSON(variableexpense_request_compound_t *variableexpense_request_compound) {
    ...
    if (ezmax_api_definition__full_field_e_variableexpense_taxable__NULL == variableexpense_request_compound->e_variableexpense_taxable) {
        goto fail;
    }
...
variableexpense_request_compound_t *variableexpense_request_compound_parseFromJSON(cJSON *variableexpense_request_compoundJSON){
    ...
    // define the local variable for variableexpense_request_compound->pki_variableexpense_id
    ...
    // define the local variable for variableexpense_request_compound->b_variableexpense_isactive
    ...
    *b_variableexpense_isactive_local_var = b_variableexpense_isactive->valueint;
    ...
    variableexpense_request_compound_local_var = variableexpense_request_compound_create_internal (
