/*
 * usergroup_edit_permissions_v1_response_all_of.h
 *
 * 
 */

#ifndef _usergroup_edit_permissions_v1_response_all_of_H_
#define _usergroup_edit_permissions_v1_response_all_of_H_
...
typedef struct usergroup_edit_permissions_v1_response_all_of_t usergroup_edit_permissions_v1_response_all_of_t;

#include "usergroup_edit_permissions_v1_response_m_payload.h"



typedef struct usergroup_edit_permissions_v1_response_all_of_t {
    struct usergroup_edit_permissions_v1_response_m_payload_t *m_payload; //model

} usergroup_edit_permissions_v1_response_all_of_t;
...
#endif /* _usergroup_edit_permissions_v1_response_all_of_H_ */
