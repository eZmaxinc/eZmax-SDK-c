...
void ezsigntemplateformfield_request_compound_free(ezsigntemplateformfield_request_compound_t *ezsigntemplateformfield_request_compound) {
    ...
    if (ezsigntemplateformfield_request_compound->e_ezsigntemplateformfield_positioning) {
        field_e_ezsigntemplateformfield_positioning_free(ezsigntemplateformfield_request_compound->e_ezsigntemplateformfield_positioning);
        ezsigntemplateformfield_request_compound->e_ezsigntemplateformfield_positioning = NULL;
    }
    ...
    if (ezsigntemplateformfield_request_compound->e_ezsigntemplateformfield_dependencyrequirement) {
        field_e_ezsigntemplateformfield_dependencyrequirement_free(ezsigntemplateformfield_request_compound->e_ezsigntemplateformfield_dependencyrequirement);
        ezsigntemplateformfield_request_compound->e_ezsigntemplateformfield_dependencyrequirement = NULL;
    }
...
cJSON *ezsigntemplateformfield_request_compound_convertToJSON(ezsigntemplateformfield_request_compound_t *ezsigntemplateformfield_request_compound) {
    ...
    if(ezsigntemplateformfield_request_compound->e_ezsigntemplateformfield_positioning != ezmax_api_definition__full_ezsigntemplateformfield_request_compound__NULL) {
    ...
    if(ezsigntemplateformfield_request_compound->e_ezsigntemplateformfield_dependencyrequirement != ezmax_api_definition__full_ezsigntemplateformfield_request_compound__NULL) {
    ...
    if(ezsigntemplateformfield_request_compound->e_ezsigntemplateformfield_positioningoccurence != ezmax_api_definition__full_ezsigntemplateformfield_request_compound__NULL) {
