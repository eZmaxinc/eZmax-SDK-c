...
static ezsigntemplateformfield_request_compound_t *ezsigntemplateformfield_request_compound_create_internal(
    ...
    memset(ezsigntemplateformfield_request_compound_local_var, 0, sizeof(ezsigntemplateformfield_request_compound_t));
    ezsigntemplateformfield_request_compound_local_var->_library_owned = 1;
    ezsigntemplateformfield_request_compound_local_var->pki_ezsigntemplateformfield_id = pki_ezsigntemplateformfield_id;
    ezsigntemplateformfield_request_compound_local_var->e_ezsigntemplateformfield_positioning = e_ezsigntemplateformfield_positioning;
    ...
    ezsigntemplateformfield_request_compound_local_var->b_ezsigntemplateformfield_autocomplete = b_ezsigntemplateformfield_autocomplete;
    ezsigntemplateformfield_request_compound_local_var->b_ezsigntemplateformfield_selected = b_ezsigntemplateformfield_selected;
    ezsigntemplateformfield_request_compound_local_var->e_ezsigntemplateformfield_dependencyrequirement = e_ezsigntemplateformfield_dependencyrequirement;
    ezsigntemplateformfield_request_compound_local_var->s_ezsigntemplateformfield_positioningpattern = s_ezsigntemplateformfield_positioningpattern;
...
__attribute__((deprecated)) ezsigntemplateformfield_request_compound_t *ezsigntemplateformfield_request_compound_create(
    ...
    int *pki_ezsigntemplateformfield_id_copy = NULL;
    if (pki_ezsigntemplateformfield_id) {
        pki_ezsigntemplateformfield_id_copy = malloc(sizeof(int));
        if (pki_ezsigntemplateformfield_id_copy) *pki_ezsigntemplateformfield_id_copy = *pki_ezsigntemplateformfield_id;
    }
    ...
    int *i_ezsigntemplateformfield_x_copy = NULL;
    if (i_ezsigntemplateformfield_x) {
        i_ezsigntemplateformfield_x_copy = malloc(sizeof(int));
        if (i_ezsigntemplateformfield_x_copy) *i_ezsigntemplateformfield_x_copy = *i_ezsigntemplateformfield_x;
    }
    int *i_ezsigntemplateformfield_y_copy = NULL;
    if (i_ezsigntemplateformfield_y) {
        i_ezsigntemplateformfield_y_copy = malloc(sizeof(int));
        if (i_ezsigntemplateformfield_y_copy) *i_ezsigntemplateformfield_y_copy = *i_ezsigntemplateformfield_y;
    }
    int *i_ezsigntemplateformfield_width_copy = NULL;
    if (i_ezsigntemplateformfield_width) {
        i_ezsigntemplateformfield_width_copy = malloc(sizeof(int));
        if (i_ezsigntemplateformfield_width_copy) *i_ezsigntemplateformfield_width_copy = *i_ezsigntemplateformfield_width;
    }
    int *i_ezsigntemplateformfield_height_copy = NULL;
    if (i_ezsigntemplateformfield_height) {
        i_ezsigntemplateformfield_height_copy = malloc(sizeof(int));
        if (i_ezsigntemplateformfield_height_copy) *i_ezsigntemplateformfield_height_copy = *i_ezsigntemplateformfield_height;
    }
    int *b_ezsigntemplateformfield_autocomplete_copy = NULL;
    if (b_ezsigntemplateformfield_autocomplete) {
        b_ezsigntemplateformfield_autocomplete_copy = malloc(sizeof(int));
        if (b_ezsigntemplateformfield_autocomplete_copy) *b_ezsigntemplateformfield_autocomplete_copy = *b_ezsigntemplateformfield_autocomplete;
    }
    int *b_ezsigntemplateformfield_selected_copy = NULL;
    if (b_ezsigntemplateformfield_selected) {
        b_ezsigntemplateformfield_selected_copy = malloc(sizeof(int));
        if (b_ezsigntemplateformfield_selected_copy) *b_ezsigntemplateformfield_selected_copy = *b_ezsigntemplateformfield_selected;
    }
    int *i_ezsigntemplateformfield_positioningoffsetx_copy = NULL;
    if (i_ezsigntemplateformfield_positioningoffsetx) {
        i_ezsigntemplateformfield_positioningoffsetx_copy = malloc(sizeof(int));
        if (i_ezsigntemplateformfield_positioningoffsetx_copy) *i_ezsigntemplateformfield_positioningoffsetx_copy = *i_ezsigntemplateformfield_positioningoffsetx;
    }
    int *i_ezsigntemplateformfield_positioningoffsety_copy = NULL;
    if (i_ezsigntemplateformfield_positioningoffsety) {
        i_ezsigntemplateformfield_positioningoffsety_copy = malloc(sizeof(int));
        if (i_ezsigntemplateformfield_positioningoffsety_copy) *i_ezsigntemplateformfield_positioningoffsety_copy = *i_ezsigntemplateformfield_positioningoffsety;
    }
    ezsigntemplateformfield_request_compound_t *result = ezsigntemplateformfield_request_compound_create_internal (
        pki_ezsigntemplateformfield_id_copy,
        ...
        i_ezsigntemplateformfield_x_copy,
        i_ezsigntemplateformfield_y_copy,
        i_ezsigntemplateformfield_width_copy,
        i_ezsigntemplateformfield_height_copy,
        b_ezsigntemplateformfield_autocomplete_copy,
        b_ezsigntemplateformfield_selected_copy,
        e_ezsigntemplateformfield_dependencyrequirement,
        s_ezsigntemplateformfield_positioningpattern,
        i_ezsigntemplateformfield_positioningoffsetx_copy,
        i_ezsigntemplateformfield_positioningoffsety_copy,
    ...
    if (!result) {
        free(pki_ezsigntemplateformfield_id_copy);
        free(i_ezsigntemplatedocumentpage_pagenumber_copy);
        free(i_ezsigntemplateformfield_x_copy);
        free(i_ezsigntemplateformfield_y_copy);
        free(i_ezsigntemplateformfield_width_copy);
        free(i_ezsigntemplateformfield_height_copy);
        free(b_ezsigntemplateformfield_autocomplete_copy);
        free(b_ezsigntemplateformfield_selected_copy);
        free(i_ezsigntemplateformfield_positioningoffsetx_copy);
        free(i_ezsigntemplateformfield_positioningoffsety_copy);
    }
    return result;
}
...
void ezsigntemplateformfield_request_compound_free(ezsigntemplateformfield_request_compound_t *ezsigntemplateformfield_request_compound) {
    ...
    if(ezsigntemplateformfield_request_compound->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsigntemplateformfield_request_compound_free");
        return ;
    }
    listEntry_t *listEntry;
    if (ezsigntemplateformfield_request_compound->pki_ezsigntemplateformfield_id) {
        free(ezsigntemplateformfield_request_compound->pki_ezsigntemplateformfield_id);
        ezsigntemplateformfield_request_compound->pki_ezsigntemplateformfield_id = NULL;
    }
    if (ezsigntemplateformfield_request_compound->i_ezsigntemplatedocumentpage_pagenumber) {
        free(ezsigntemplateformfield_request_compound->i_ezsigntemplatedocumentpage_pagenumber);
        ezsigntemplateformfield_request_compound->i_ezsigntemplatedocumentpage_pagenumber = NULL;
    }
    ...
    if (ezsigntemplateformfield_request_compound->i_ezsigntemplateformfield_x) {
        free(ezsigntemplateformfield_request_compound->i_ezsigntemplateformfield_x);
        ezsigntemplateformfield_request_compound->i_ezsigntemplateformfield_x = NULL;
    }
    if (ezsigntemplateformfield_request_compound->i_ezsigntemplateformfield_y) {
        free(ezsigntemplateformfield_request_compound->i_ezsigntemplateformfield_y);
        ezsigntemplateformfield_request_compound->i_ezsigntemplateformfield_y = NULL;
    }
    if (ezsigntemplateformfield_request_compound->i_ezsigntemplateformfield_width) {
        free(ezsigntemplateformfield_request_compound->i_ezsigntemplateformfield_width);
        ezsigntemplateformfield_request_compound->i_ezsigntemplateformfield_width = NULL;
    }
    if (ezsigntemplateformfield_request_compound->i_ezsigntemplateformfield_height) {
        free(ezsigntemplateformfield_request_compound->i_ezsigntemplateformfield_height);
        ezsigntemplateformfield_request_compound->i_ezsigntemplateformfield_height = NULL;
    }
    if (ezsigntemplateformfield_request_compound->b_ezsigntemplateformfield_autocomplete) {
        free(ezsigntemplateformfield_request_compound->b_ezsigntemplateformfield_autocomplete);
        ezsigntemplateformfield_request_compound->b_ezsigntemplateformfield_autocomplete = NULL;
    }
    if (ezsigntemplateformfield_request_compound->b_ezsigntemplateformfield_selected) {
        free(ezsigntemplateformfield_request_compound->b_ezsigntemplateformfield_selected);
        ezsigntemplateformfield_request_compound->b_ezsigntemplateformfield_selected = NULL;
    }
    if (ezsigntemplateformfield_request_compound->s_ezsigntemplateformfield_positioningpattern) {
        free(ezsigntemplateformfield_request_compound->s_ezsigntemplateformfield_positioningpattern);
        ezsigntemplateformfield_request_compound->s_ezsigntemplateformfield_positioningpattern = NULL;
    }
    if (ezsigntemplateformfield_request_compound->i_ezsigntemplateformfield_positioningoffsetx) {
        free(ezsigntemplateformfield_request_compound->i_ezsigntemplateformfield_positioningoffsetx);
        ezsigntemplateformfield_request_compound->i_ezsigntemplateformfield_positioningoffsetx = NULL;
    }
    if (ezsigntemplateformfield_request_compound->i_ezsigntemplateformfield_positioningoffsety) {
        free(ezsigntemplateformfield_request_compound->i_ezsigntemplateformfield_positioningoffsety);
        ezsigntemplateformfield_request_compound->i_ezsigntemplateformfield_positioningoffsety = NULL;
    }
...
cJSON *ezsigntemplateformfield_request_compound_convertToJSON(ezsigntemplateformfield_request_compound_t *ezsigntemplateformfield_request_compound) {
    ...
    // ezsigntemplateformfield_request_compound->e_ezsigntemplateformfield_positioning
    if(ezsigntemplateformfield_request_compound->e_ezsigntemplateformfield_positioning != ezmax_api_definition__full_field_e_ezsigntemplateformfield_positioning__NULL) {
    cJSON *e_ezsigntemplateformfield_positioning_local_JSON = field_e_ezsigntemplateformfield_positioning_convertToJSON(ezsigntemplateformfield_request_compound->e_ezsigntemplateformfield_positioning);
    ...
    // ezsigntemplateformfield_request_compound->b_ezsigntemplateformfield_autocomplete
    if(ezsigntemplateformfield_request_compound->b_ezsigntemplateformfield_autocomplete) {
    if(cJSON_AddBoolToObject(item, "bEzsigntemplateformfieldAutocomplete", *ezsigntemplateformfield_request_compound->b_ezsigntemplateformfield_autocomplete) == NULL) {
    goto fail; //Bool
    }
    }
    ...
    // ezsigntemplateformfield_request_compound->e_ezsigntemplateformfield_dependencyrequirement
    if(ezsigntemplateformfield_request_compound->e_ezsigntemplateformfield_dependencyrequirement != ezmax_api_definition__full_field_e_ezsigntemplateformfield_dependencyrequirement__NULL) {
    cJSON *e_ezsigntemplateformfield_dependencyrequirement_local_JSON = field_e_ezsigntemplateformfield_dependencyrequirement_convertToJSON(ezsigntemplateformfield_request_compound->e_ezsigntemplateformfield_dependencyrequirement);
    ...
    // ezsigntemplateformfield_request_compound->s_ezsigntemplateformfield_positioningpattern
    if(ezsigntemplateformfield_request_compound->s_ezsigntemplateformfield_positioningpattern) {
    if(cJSON_AddStringToObject(item, "sEzsigntemplateformfieldPositioningpattern", ezsigntemplateformfield_request_compound->s_ezsigntemplateformfield_positioningpattern) == NULL) {
    goto fail; //String
    }
    }


    // ezsigntemplateformfield_request_compound->i_ezsigntemplateformfield_positioningoffsetx
    if(ezsigntemplateformfield_request_compound->i_ezsigntemplateformfield_positioningoffsetx) {
    if(cJSON_AddNumberToObject(item, "iEzsigntemplateformfieldPositioningoffsetx", *ezsigntemplateformfield_request_compound->i_ezsigntemplateformfield_positioningoffsetx) == NULL) {
    goto fail; //Numeric
    }
    }


    // ezsigntemplateformfield_request_compound->i_ezsigntemplateformfield_positioningoffsety
    if(ezsigntemplateformfield_request_compound->i_ezsigntemplateformfield_positioningoffsety) {
    if(cJSON_AddNumberToObject(item, "iEzsigntemplateformfieldPositioningoffsety", *ezsigntemplateformfield_request_compound->i_ezsigntemplateformfield_positioningoffsety) == NULL) {
    goto fail; //Numeric
    }
    }


    // ezsigntemplateformfield_request_compound->e_ezsigntemplateformfield_positioningoccurence
    if(ezsigntemplateformfield_request_compound->e_ezsigntemplateformfield_positioningoccurence != ezmax_api_definition__full_field_e_ezsigntemplateformfield_positioningoccurence__NULL) {
    cJSON *e_ezsigntemplateformfield_positioningoccurence_local_JSON = field_e_ezsigntemplateformfield_positioningoccurence_convertToJSON(ezsigntemplateformfield_request_compound->e_ezsigntemplateformfield_positioningoccurence);
    ...
    if(ezsigntemplateformfield_request_compound->e_ezsigntemplateformfield_horizontalalignment != ezmax_api_definition__full_enum_horizontalalignment__NULL) {
...
ezsigntemplateformfield_request_compound_t *ezsigntemplateformfield_request_compound_parseFromJSON(cJSON *ezsigntemplateformfield_request_compoundJSON){
    ...
    // define the local variable for ezsigntemplateformfield_request_compound->pki_ezsigntemplateformfield_id
    int *pki_ezsigntemplateformfield_id_local_var = NULL;

    // define the local variable for ezsigntemplateformfield_request_compound->e_ezsigntemplateformfield_positioning
    ...
    // define the local variable for ezsigntemplateformfield_request_compound->i_ezsigntemplatedocumentpage_pagenumber
    int *i_ezsigntemplatedocumentpage_pagenumber_local_var = NULL;

    char *s_ezsigntemplateformfield_label_local_str = NULL;

    char *s_ezsigntemplateformfield_value_local_str = NULL;

    // define the local variable for ezsigntemplateformfield_request_compound->i_ezsigntemplateformfield_x
    int *i_ezsigntemplateformfield_x_local_var = NULL;

    // define the local variable for ezsigntemplateformfield_request_compound->i_ezsigntemplateformfield_y
    int *i_ezsigntemplateformfield_y_local_var = NULL;

    // define the local variable for ezsigntemplateformfield_request_compound->i_ezsigntemplateformfield_width
    int *i_ezsigntemplateformfield_width_local_var = NULL;

    // define the local variable for ezsigntemplateformfield_request_compound->i_ezsigntemplateformfield_height
    int *i_ezsigntemplateformfield_height_local_var = NULL;

    // define the local variable for ezsigntemplateformfield_request_compound->b_ezsigntemplateformfield_autocomplete
    int *b_ezsigntemplateformfield_autocomplete_local_var = NULL;

    // define the local variable for ezsigntemplateformfield_request_compound->b_ezsigntemplateformfield_selected
    int *b_ezsigntemplateformfield_selected_local_var = NULL;

    // define the local variable for ezsigntemplateformfield_request_compound->e_ezsigntemplateformfield_dependencyrequirement
    ...
    char *s_ezsigntemplateformfield_positioningpattern_local_str = NULL;

    // define the local variable for ezsigntemplateformfield_request_compound->i_ezsigntemplateformfield_positioningoffsetx
    int *i_ezsigntemplateformfield_positioningoffsetx_local_var = NULL;

    // define the local variable for ezsigntemplateformfield_request_compound->i_ezsigntemplateformfield_positioningoffsety
    int *i_ezsigntemplateformfield_positioningoffsety_local_var = NULL;
    ...
    pki_ezsigntemplateformfield_id_local_var = malloc(sizeof(int));
    if(!pki_ezsigntemplateformfield_id_local_var)
    {
        goto end;
    }
    *pki_ezsigntemplateformfield_id_local_var = pki_ezsigntemplateformfield_id->valuedouble;
    }

    // ezsigntemplateformfield_request_compound->e_ezsigntemplateformfield_positioning
    cJSON *e_ezsigntemplateformfield_positioning = cJSON_GetObjectItemCaseSensitive(ezsigntemplateformfield_request_compoundJSON, "eEzsigntemplateformfieldPositioning");
    ...
    *i_ezsigntemplatedocumentpage_pagenumber_local_var = i_ezsigntemplatedocumentpage_pagenumber->valuedouble;
    ...
    i_ezsigntemplateformfield_x_local_var = malloc(sizeof(int));
    if(!i_ezsigntemplateformfield_x_local_var)
    {
        goto end;
    }
    *i_ezsigntemplateformfield_x_local_var = i_ezsigntemplateformfield_x->valuedouble;
    }
    ...
    i_ezsigntemplateformfield_y_local_var = malloc(sizeof(int));
    if(!i_ezsigntemplateformfield_y_local_var)
    {
        goto end;
    }
    *i_ezsigntemplateformfield_y_local_var = i_ezsigntemplateformfield_y->valuedouble;
    }
    ...
    i_ezsigntemplateformfield_width_local_var = malloc(sizeof(int));
    if(!i_ezsigntemplateformfield_width_local_var)
    {
        goto end;
    }
    *i_ezsigntemplateformfield_width_local_var = i_ezsigntemplateformfield_width->valuedouble;
    ...
    i_ezsigntemplateformfield_height_local_var = malloc(sizeof(int));
    if(!i_ezsigntemplateformfield_height_local_var)
    {
        goto end;
    }
    *i_ezsigntemplateformfield_height_local_var = i_ezsigntemplateformfield_height->valuedouble;

    // ezsigntemplateformfield_request_compound->b_ezsigntemplateformfield_autocomplete
    cJSON *b_ezsigntemplateformfield_autocomplete = cJSON_GetObjectItemCaseSensitive(ezsigntemplateformfield_request_compoundJSON, "bEzsigntemplateformfieldAutocomplete");
    ...
    b_ezsigntemplateformfield_autocomplete_local_var = malloc(sizeof(int));
    if(!b_ezsigntemplateformfield_autocomplete_local_var)
    {
        goto end;
    }
    *b_ezsigntemplateformfield_autocomplete_local_var = b_ezsigntemplateformfield_autocomplete->valueint;
    }
    ...
    b_ezsigntemplateformfield_selected_local_var = malloc(sizeof(int));
    if(!b_ezsigntemplateformfield_selected_local_var)
    {
        goto end;
    }
    *b_ezsigntemplateformfield_selected_local_var = b_ezsigntemplateformfield_selected->valueint;
    }

    // ezsigntemplateformfield_request_compound->e_ezsigntemplateformfield_dependencyrequirement
    cJSON *e_ezsigntemplateformfield_dependencyrequirement = cJSON_GetObjectItemCaseSensitive(ezsigntemplateformfield_request_compoundJSON, "eEzsigntemplateformfieldDependencyrequirement");
    ...
    // ezsigntemplateformfield_request_compound->s_ezsigntemplateformfield_positioningpattern
    cJSON *s_ezsigntemplateformfield_positioningpattern = cJSON_GetObjectItemCaseSensitive(ezsigntemplateformfield_request_compoundJSON, "sEzsigntemplateformfieldPositioningpattern");
    ...
    // ezsigntemplateformfield_request_compound->i_ezsigntemplateformfield_positioningoffsetx
    cJSON *i_ezsigntemplateformfield_positioningoffsetx = cJSON_GetObjectItemCaseSensitive(ezsigntemplateformfield_request_compoundJSON, "iEzsigntemplateformfieldPositioningoffsetx");
    ...
    i_ezsigntemplateformfield_positioningoffsetx_local_var = malloc(sizeof(int));
    if(!i_ezsigntemplateformfield_positioningoffsetx_local_var)
    {
        goto end;
    }
    *i_ezsigntemplateformfield_positioningoffsetx_local_var = i_ezsigntemplateformfield_positioningoffsetx->valuedouble;
    }

    // ezsigntemplateformfield_request_compound->i_ezsigntemplateformfield_positioningoffsety
    cJSON *i_ezsigntemplateformfield_positioningoffsety = cJSON_GetObjectItemCaseSensitive(ezsigntemplateformfield_request_compoundJSON, "iEzsigntemplateformfieldPositioningoffsety");
    ...
    i_ezsigntemplateformfield_positioningoffsety_local_var = malloc(sizeof(int));
    if(!i_ezsigntemplateformfield_positioningoffsety_local_var)
    {
        goto end;
    }
    *i_ezsigntemplateformfield_positioningoffsety_local_var = i_ezsigntemplateformfield_positioningoffsety->valuedouble;
    }

    // ezsigntemplateformfield_request_compound->e_ezsigntemplateformfield_positioningoccurence
    cJSON *e_ezsigntemplateformfield_positioningoccurence = cJSON_GetObjectItemCaseSensitive(ezsigntemplateformfield_request_compoundJSON, "eEzsigntemplateformfieldPositioningoccurence");
    ...
    if (s_ezsigntemplateformfield_label && !cJSON_IsNull(s_ezsigntemplateformfield_label)) s_ezsigntemplateformfield_label_local_str = strdup(s_ezsigntemplateformfield_label->valuestring);
    if (s_ezsigntemplateformfield_value && !cJSON_IsNull(s_ezsigntemplateformfield_value)) s_ezsigntemplateformfield_value_local_str = strdup(s_ezsigntemplateformfield_value->valuestring);
    if (s_ezsigntemplateformfield_positioningpattern && !cJSON_IsNull(s_ezsigntemplateformfield_positioningpattern)) s_ezsigntemplateformfield_positioningpattern_local_str = strdup(s_ezsigntemplateformfield_positioningpattern->valuestring);

    ezsigntemplateformfield_request_compound_local_var = ezsigntemplateformfield_request_compound_create_internal (
        pki_ezsigntemplateformfield_id_local_var,
        ...
        s_ezsigntemplateformfield_label_local_str,
        s_ezsigntemplateformfield_value_local_str,
        i_ezsigntemplateformfield_x_local_var,
        i_ezsigntemplateformfield_y_local_var,
        i_ezsigntemplateformfield_width_local_var,
        i_ezsigntemplateformfield_height_local_var,
        b_ezsigntemplateformfield_autocomplete_local_var,
        b_ezsigntemplateformfield_selected_local_var,
        e_ezsigntemplateformfield_dependencyrequirement ? e_ezsigntemplateformfield_dependencyrequirement_local_nonprim : 0,
        s_ezsigntemplateformfield_positioningpattern_local_str,
        i_ezsigntemplateformfield_positioningoffsetx_local_var,
        i_ezsigntemplateformfield_positioningoffsety_local_var,
    ...
    if (pki_ezsigntemplateformfield_id_local_var) {
        free(pki_ezsigntemplateformfield_id_local_var);
        pki_ezsigntemplateformfield_id_local_var = NULL;
    }
    ...
    if (s_ezsigntemplateformfield_label_local_str) {
        free(s_ezsigntemplateformfield_label_local_str);
        s_ezsigntemplateformfield_label_local_str = NULL;
    }
    if (s_ezsigntemplateformfield_value_local_str) {
        free(s_ezsigntemplateformfield_value_local_str);
        s_ezsigntemplateformfield_value_local_str = NULL;
    }
    if (i_ezsigntemplateformfield_x_local_var) {
        free(i_ezsigntemplateformfield_x_local_var);
        i_ezsigntemplateformfield_x_local_var = NULL;
    }
    if (i_ezsigntemplateformfield_y_local_var) {
        free(i_ezsigntemplateformfield_y_local_var);
        i_ezsigntemplateformfield_y_local_var = NULL;
    }
    if (i_ezsigntemplateformfield_width_local_var) {
        free(i_ezsigntemplateformfield_width_local_var);
        i_ezsigntemplateformfield_width_local_var = NULL;
    }
    if (i_ezsigntemplateformfield_height_local_var) {
        free(i_ezsigntemplateformfield_height_local_var);
        i_ezsigntemplateformfield_height_local_var = NULL;
    }
    if (b_ezsigntemplateformfield_autocomplete_local_var) {
        free(b_ezsigntemplateformfield_autocomplete_local_var);
        b_ezsigntemplateformfield_autocomplete_local_var = NULL;
    }
    if (b_ezsigntemplateformfield_selected_local_var) {
        free(b_ezsigntemplateformfield_selected_local_var);
        b_ezsigntemplateformfield_selected_local_var = NULL;
    }
    ...
    if (s_ezsigntemplateformfield_positioningpattern_local_str) {
        free(s_ezsigntemplateformfield_positioningpattern_local_str);
        s_ezsigntemplateformfield_positioningpattern_local_str = NULL;
    }
    if (i_ezsigntemplateformfield_positioningoffsetx_local_var) {
        free(i_ezsigntemplateformfield_positioningoffsetx_local_var);
        i_ezsigntemplateformfield_positioningoffsetx_local_var = NULL;
    }
    if (i_ezsigntemplateformfield_positioningoffsety_local_var) {
        free(i_ezsigntemplateformfield_positioningoffsety_local_var);
        i_ezsigntemplateformfield_positioningoffsety_local_var = NULL;
    }
