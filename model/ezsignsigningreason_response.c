...
static ezsignsigningreason_response_t *ezsignsigningreason_response_create_internal(
    ...
    memset(ezsignsigningreason_response_local_var, 0, sizeof(ezsignsigningreason_response_t));
...
__attribute__((deprecated)) ezsignsigningreason_response_t *ezsignsigningreason_response_create(
    ...
    ezsignsigningreason_response_t *result = ezsignsigningreason_response_create_internal (
...
void ezsignsigningreason_response_free(ezsignsigningreason_response_t *ezsignsigningreason_response) {
    ...
    if (ezsignsigningreason_response->pki_ezsignsigningreason_id) {
        free(ezsignsigningreason_response->pki_ezsignsigningreason_id);
        ezsignsigningreason_response->pki_ezsignsigningreason_id = NULL;
    }
    ...
    if (ezsignsigningreason_response->b_ezsignsigningreason_isactive) {
        free(ezsignsigningreason_response->b_ezsignsigningreason_isactive);
        ezsignsigningreason_response->b_ezsignsigningreason_isactive = NULL;
    }
...
ezsignsigningreason_response_t *ezsignsigningreason_response_parseFromJSON(cJSON *ezsignsigningreason_responseJSON){
    ...
    // define the local variable for ezsignsigningreason_response->pki_ezsignsigningreason_id
    ...
    // define the local variable for ezsignsigningreason_response->b_ezsignsigningreason_isactive
