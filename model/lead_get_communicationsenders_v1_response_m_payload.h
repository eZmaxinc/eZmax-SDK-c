/*
 * lead_get_communicationsenders_v1_response_m_payload.h
 *
 * Response for GET /1/object/lead/{pkiLeadID}/getCommunicationsenders
 */

#ifndef _lead_get_communicationsenders_v1_response_m_payload_H_
#define _lead_get_communicationsenders_v1_response_m_payload_H_
...
typedef struct lead_get_communicationsenders_v1_response_m_payload_t lead_get_communicationsenders_v1_response_m_payload_t;

#include "custom_communicationsender_response.h"



typedef struct lead_get_communicationsenders_v1_response_m_payload_t {
    list_t *a_obj_communicationsenders; //nonprimitive container

    int _library_owned; // Is the library responsible for freeing this object?
} lead_get_communicationsenders_v1_response_m_payload_t;
...
#endif /* _lead_get_communicationsenders_v1_response_m_payload_H_ */
