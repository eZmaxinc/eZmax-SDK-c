/*
 * field_e_ezsigntemplatesignature_signaturepad.h
 *
 * The type of signature pad required.
 */

#ifndef _field_e_ezsigntemplatesignature_signaturepad_H_
#define _field_e_ezsigntemplatesignature_signaturepad_H_
...
typedef struct field_e_ezsigntemplatesignature_signaturepad_t field_e_ezsigntemplatesignature_signaturepad_t;


// Enum  for field_e_ezsigntemplatesignature_signaturepad

typedef enum { ezmax_api_definition__full_field_e_ezsigntemplatesignature_signaturepad__NULL = 0, ezmax_api_definition__full_field_e_ezsigntemplatesignature_signaturepad__Topaz } ezmax_api_definition__full_field_e_ezsigntemplatesignature_signaturepad__e;
...
#endif /* _field_e_ezsigntemplatesignature_signaturepad_H_ */
