...
static inscription_get_communication_list_v1_response_t *inscription_get_communication_list_v1_response_create_internal(
    ...
    memset(inscription_get_communication_list_v1_response_local_var, 0, sizeof(inscription_get_communication_list_v1_response_t));
...
__attribute__((deprecated)) inscription_get_communication_list_v1_response_t *inscription_get_communication_list_v1_response_create(
    ...
    inscription_get_communication_list_v1_response_t *result = inscription_get_communication_list_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
