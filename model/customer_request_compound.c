...
static customer_request_compound_t *customer_request_compound_create_internal(
    int pki_customer_id,
    int fki_company_id,
    ...
    customer_request_compound_local_var->_library_owned = 1;
    return customer_request_compound_local_var;
}

__attribute__((deprecated)) customer_request_compound_t *customer_request_compound_create(
    int pki_customer_id,
    int fki_company_id,
    int fki_customergroup_id,
    char *s_customer_name,
    ...
    return customer_request_compound_create_internal (
        pki_customer_id,
        fki_company_id,
...
void customer_request_compound_free(customer_request_compound_t *customer_request_compound) {
    ...
    if(customer_request_compound->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "customer_request_compound_free");
        return ;
    }
...
cJSON *customer_request_compound_convertToJSON(customer_request_compound_t *customer_request_compound) {
    ...
    if (ezmax_api_definition__full_field_e_customer_type__NULL == customer_request_compound->e_customer_type) {
        goto fail;
    }
    ...
    if (ezmax_api_definition__full_field_e_customer_marketingcorrespondence__NULL == customer_request_compound->e_customer_marketingcorrespondence) {
        goto fail;
    }
...
customer_request_compound_t *customer_request_compound_parseFromJSON(cJSON *customer_request_compoundJSON){
    ...
    customer_request_compound_local_var = customer_request_compound_create_internal (
