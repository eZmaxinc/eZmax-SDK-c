...
char* e_ezsigndocument_stepezsigndocument_response_compound_ToString(ezmax_api_definition_ezsigndocument_response_compound__e e_ezsigndocument_step) {
...
ezmax_api_definition_ezsigndocument_response_compound__e e_ezsigndocument_stepezsigndocument_response_compound_FromString(char* e_ezsigndocument_step){
...
ezsigndocument_response_compound_t *ezsigndocument_response_compound_create(
    ...
    ezsigndocument_response_compound_local_var->s_ezsigndocument_filename = s_ezsigndocument_filename;
...
void ezsigndocument_response_compound_free(ezsigndocument_response_compound_t *ezsigndocument_response_compound) {
    ...
    if (ezsigndocument_response_compound->s_ezsigndocument_filename) {
        free(ezsigndocument_response_compound->s_ezsigndocument_filename);
        ezsigndocument_response_compound->s_ezsigndocument_filename = NULL;
    }
...
cJSON *ezsigndocument_response_compound_convertToJSON(ezsigndocument_response_compound_t *ezsigndocument_response_compound) {
    ...
    // ezsigndocument_response_compound->s_ezsigndocument_filename
    if (!ezsigndocument_response_compound->s_ezsigndocument_filename) {
        goto fail;
    }
    
    if(cJSON_AddStringToObject(item, "sEzsigndocumentFilename", ezsigndocument_response_compound->s_ezsigndocument_filename) == NULL) {
    goto fail; //String
    }
...
ezsigndocument_response_compound_t *ezsigndocument_response_compound_parseFromJSON(cJSON *ezsigndocument_response_compoundJSON){
    ...
    // ezsigndocument_response_compound->s_ezsigndocument_filename
    cJSON *s_ezsigndocument_filename = cJSON_GetObjectItemCaseSensitive(ezsigndocument_response_compoundJSON, "sEzsigndocumentFilename");
