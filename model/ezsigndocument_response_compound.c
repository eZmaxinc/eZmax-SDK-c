...
static ezsigndocument_response_compound_t *ezsigndocument_response_compound_create_internal(
    ...
    memset(ezsigndocument_response_compound_local_var, 0, sizeof(ezsigndocument_response_compound_t));
    ezsigndocument_response_compound_local_var->_library_owned = 1;
    ...
    ezsigndocument_response_compound_local_var->i_ezsigndocument_formfieldtotal = i_ezsigndocument_formfieldtotal;
    ...
    ezsigndocument_response_compound_local_var->a_obj_ezsigndocumentdependency = a_obj_ezsigndocumentdependency;
...
__attribute__((deprecated)) ezsigndocument_response_compound_t *ezsigndocument_response_compound_create(
    ...
    int *i_ezsigndocument_stepformtotal_copy = NULL;
    if (i_ezsigndocument_stepformtotal) {
        i_ezsigndocument_stepformtotal_copy = malloc(sizeof(int));
        if (i_ezsigndocument_stepformtotal_copy) *i_ezsigndocument_stepformtotal_copy = *i_ezsigndocument_stepformtotal;
    }
    int *i_ezsigndocument_stepformcurrent_copy = NULL;
    if (i_ezsigndocument_stepformcurrent) {
        i_ezsigndocument_stepformcurrent_copy = malloc(sizeof(int));
        if (i_ezsigndocument_stepformcurrent_copy) *i_ezsigndocument_stepformcurrent_copy = *i_ezsigndocument_stepformcurrent;
    }
    int *i_ezsigndocument_stepsignaturetotal_copy = NULL;
    if (i_ezsigndocument_stepsignaturetotal) {
        i_ezsigndocument_stepsignaturetotal_copy = malloc(sizeof(int));
        if (i_ezsigndocument_stepsignaturetotal_copy) *i_ezsigndocument_stepsignaturetotal_copy = *i_ezsigndocument_stepsignaturetotal;
    }
    int *i_ezsigndocument_stepsignature_current_copy = NULL;
    if (i_ezsigndocument_stepsignature_current) {
        i_ezsigndocument_stepsignature_current_copy = malloc(sizeof(int));
        if (i_ezsigndocument_stepsignature_current_copy) *i_ezsigndocument_stepsignature_current_copy = *i_ezsigndocument_stepsignature_current;
    }
    ezsigndocument_response_compound_t *result = ezsigndocument_response_compound_create_internal (
        ...
        i_ezsigndocument_stepformtotal_copy,
        i_ezsigndocument_stepformcurrent_copy,
        i_ezsigndocument_stepsignaturetotal_copy,
        i_ezsigndocument_stepsignature_current_copy,
    ...
    if (!result) {
        ...
        free(i_ezsigndocument_stepformtotal_copy);
        free(i_ezsigndocument_stepformcurrent_copy);
        free(i_ezsigndocument_stepsignaturetotal_copy);
        free(i_ezsigndocument_stepsignature_current_copy);
    }
    return result;
}
...
void ezsigndocument_response_compound_free(ezsigndocument_response_compound_t *ezsigndocument_response_compound) {
    ...
    if(ezsigndocument_response_compound->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsigndocument_response_compound_free");
        return ;
    }
    listEntry_t *listEntry;
    if (ezsigndocument_response_compound->pki_ezsigndocument_id) {
        free(ezsigndocument_response_compound->pki_ezsigndocument_id);
        ezsigndocument_response_compound->pki_ezsigndocument_id = NULL;
    }
    if (ezsigndocument_response_compound->fki_ezsignfolder_id) {
        free(ezsigndocument_response_compound->fki_ezsignfolder_id);
        ezsigndocument_response_compound->fki_ezsignfolder_id = NULL;
    }
    if (ezsigndocument_response_compound->fki_ezsignfoldersignerassociation_id_declinedtosign) {
        free(ezsigndocument_response_compound->fki_ezsignfoldersignerassociation_id_declinedtosign);
        ezsigndocument_response_compound->fki_ezsignfoldersignerassociation_id_declinedtosign = NULL;
    }
    ...
    if (ezsigndocument_response_compound->fki_language_id) {
        free(ezsigndocument_response_compound->fki_language_id);
        ezsigndocument_response_compound->fki_language_id = NULL;
    }
    ...
    if (ezsigndocument_response_compound->i_ezsigndocument_order) {
        free(ezsigndocument_response_compound->i_ezsigndocument_order);
        ezsigndocument_response_compound->i_ezsigndocument_order = NULL;
    }
    if (ezsigndocument_response_compound->i_ezsigndocument_pagetotal) {
        free(ezsigndocument_response_compound->i_ezsigndocument_pagetotal);
        ezsigndocument_response_compound->i_ezsigndocument_pagetotal = NULL;
    }
    if (ezsigndocument_response_compound->i_ezsigndocument_signaturesigned) {
        free(ezsigndocument_response_compound->i_ezsigndocument_signaturesigned);
        ezsigndocument_response_compound->i_ezsigndocument_signaturesigned = NULL;
    }
    if (ezsigndocument_response_compound->i_ezsigndocument_signaturetotal) {
        free(ezsigndocument_response_compound->i_ezsigndocument_signaturetotal);
        ezsigndocument_response_compound->i_ezsigndocument_signaturetotal = NULL;
    }
    if (ezsigndocument_response_compound->i_ezsigndocument_formfieldtotal) {
        free(ezsigndocument_response_compound->i_ezsigndocument_formfieldtotal);
        ezsigndocument_response_compound->i_ezsigndocument_formfieldtotal = NULL;
    }
    ...
    if (ezsigndocument_response_compound->b_ezsigndocument_ezsignform) {
        free(ezsigndocument_response_compound->b_ezsigndocument_ezsignform);
        ezsigndocument_response_compound->b_ezsigndocument_ezsignform = NULL;
    }
    if (ezsigndocument_response_compound->b_ezsigndocument_hassignedsignatures) {
        free(ezsigndocument_response_compound->b_ezsigndocument_hassignedsignatures);
        ezsigndocument_response_compound->b_ezsigndocument_hassignedsignatures = NULL;
    }
    if (ezsigndocument_response_compound->b_ezsigndocument_sendtoged) {
        free(ezsigndocument_response_compound->b_ezsigndocument_sendtoged);
        ezsigndocument_response_compound->b_ezsigndocument_sendtoged = NULL;
    }
    ...
    if (ezsigndocument_response_compound->i_ezsigndocument_ezsignsignatureattachmenttotal) {
        free(ezsigndocument_response_compound->i_ezsigndocument_ezsignsignatureattachmenttotal);
        ezsigndocument_response_compound->i_ezsigndocument_ezsignsignatureattachmenttotal = NULL;
    }
    if (ezsigndocument_response_compound->i_ezsigndocument_ezsigndiscussiontotal) {
        free(ezsigndocument_response_compound->i_ezsigndocument_ezsigndiscussiontotal);
        ezsigndocument_response_compound->i_ezsigndocument_ezsigndiscussiontotal = NULL;
    }
    if (ezsigndocument_response_compound->i_ezsigndocument_stepformtotal) {
        free(ezsigndocument_response_compound->i_ezsigndocument_stepformtotal);
        ezsigndocument_response_compound->i_ezsigndocument_stepformtotal = NULL;
    }
    if (ezsigndocument_response_compound->i_ezsigndocument_stepformcurrent) {
        free(ezsigndocument_response_compound->i_ezsigndocument_stepformcurrent);
        ezsigndocument_response_compound->i_ezsigndocument_stepformcurrent = NULL;
    }
    if (ezsigndocument_response_compound->i_ezsigndocument_stepsignaturetotal) {
        free(ezsigndocument_response_compound->i_ezsigndocument_stepsignaturetotal);
        ezsigndocument_response_compound->i_ezsigndocument_stepsignaturetotal = NULL;
    }
    if (ezsigndocument_response_compound->i_ezsigndocument_stepsignature_current) {
        free(ezsigndocument_response_compound->i_ezsigndocument_stepsignature_current);
        ezsigndocument_response_compound->i_ezsigndocument_stepsignature_current = NULL;
    }
    ...
    if (ezsigndocument_response_compound->a_obj_ezsigndocumentdependency) {
        list_ForEach(listEntry, ezsigndocument_response_compound->a_obj_ezsigndocumentdependency) {
            ezsigndocumentdependency_response_free(listEntry->data);
        }
        list_freeList(ezsigndocument_response_compound->a_obj_ezsigndocumentdependency);
        ezsigndocument_response_compound->a_obj_ezsigndocumentdependency = NULL;
    }
...
cJSON *ezsigndocument_response_compound_convertToJSON(ezsigndocument_response_compound_t *ezsigndocument_response_compound) {
    ...
    if (ezmax_api_definition__full_field_e_ezsigndocument_step__NULL == ezsigndocument_response_compound->e_ezsigndocument_step) {
        goto fail;
    }
    ...
    // ezsigndocument_response_compound->i_ezsigndocument_formfieldtotal
    if (!ezsigndocument_response_compound->i_ezsigndocument_formfieldtotal) {
        goto fail;
    }
    if(cJSON_AddNumberToObject(item, "iEzsigndocumentFormfieldtotal", *ezsigndocument_response_compound->i_ezsigndocument_formfieldtotal) == NULL) {
    goto fail; //Numeric
    }
    ...
    if (ezmax_api_definition__full_computed_e_ezsigndocument_steptype__NULL == ezsigndocument_response_compound->e_ezsigndocument_steptype) {
        goto fail;
    }
    ...
    // ezsigndocument_response_compound->a_obj_ezsigndocumentdependency
    if(ezsigndocument_response_compound->a_obj_ezsigndocumentdependency) {
    ...
    if (ezsigndocument_response_compound->a_obj_ezsigndocumentdependency) {
    list_ForEach(a_obj_ezsigndocumentdependencyListEntry, ezsigndocument_response_compound->a_obj_ezsigndocumentdependency) {
...
ezsigndocument_response_compound_t *ezsigndocument_response_compound_parseFromJSON(cJSON *ezsigndocument_response_compoundJSON){
    ...
    // define the local variable for ezsigndocument_response_compound->pki_ezsigndocument_id
    int *pki_ezsigndocument_id_local_var = NULL;

    // define the local variable for ezsigndocument_response_compound->fki_ezsignfolder_id
    int *fki_ezsignfolder_id_local_var = NULL;

    // define the local variable for ezsigndocument_response_compound->fki_ezsignfoldersignerassociation_id_declinedtosign
    ...
    // define the local variable for ezsigndocument_response_compound->fki_language_id
    ...
    // define the local variable for ezsigndocument_response_compound->i_ezsigndocument_order
    int *i_ezsigndocument_order_local_var = NULL;

    // define the local variable for ezsigndocument_response_compound->i_ezsigndocument_pagetotal
    int *i_ezsigndocument_pagetotal_local_var = NULL;

    // define the local variable for ezsigndocument_response_compound->i_ezsigndocument_signaturesigned
    int *i_ezsigndocument_signaturesigned_local_var = NULL;

    // define the local variable for ezsigndocument_response_compound->i_ezsigndocument_signaturetotal
    int *i_ezsigndocument_signaturetotal_local_var = NULL;

    // define the local variable for ezsigndocument_response_compound->i_ezsigndocument_formfieldtotal
    ...
    // define the local variable for ezsigndocument_response_compound->b_ezsigndocument_ezsignform
    int *b_ezsigndocument_ezsignform_local_var = NULL;

    // define the local variable for ezsigndocument_response_compound->b_ezsigndocument_hassignedsignatures
    int *b_ezsigndocument_hassignedsignatures_local_var = NULL;

    // define the local variable for ezsigndocument_response_compound->b_ezsigndocument_sendtoged
    ...
    // define the local variable for ezsigndocument_response_compound->i_ezsigndocument_ezsignsignatureattachmenttotal
    int *i_ezsigndocument_ezsignsignatureattachmenttotal_local_var = NULL;

    // define the local variable for ezsigndocument_response_compound->i_ezsigndocument_ezsigndiscussiontotal
    ...
    // define the local variable for ezsigndocument_response_compound->i_ezsigndocument_stepformtotal
    int *i_ezsigndocument_stepformtotal_local_var = NULL;

    // define the local variable for ezsigndocument_response_compound->i_ezsigndocument_stepformcurrent
    int *i_ezsigndocument_stepformcurrent_local_var = NULL;

    // define the local variable for ezsigndocument_response_compound->i_ezsigndocument_stepsignaturetotal
    int *i_ezsigndocument_stepsignaturetotal_local_var = NULL;

    // define the local variable for ezsigndocument_response_compound->i_ezsigndocument_stepsignature_current
    int *i_ezsigndocument_stepsignature_current_local_var = NULL;
    ...
    // define the local list for ezsigndocument_response_compound->a_obj_ezsigndocumentdependency
    ...
    *i_ezsigndocument_signaturetotal_local_var = i_ezsigndocument_signaturetotal->valuedouble;
    ...
    // ezsigndocument_response_compound->i_ezsigndocument_formfieldtotal
    cJSON *i_ezsigndocument_formfieldtotal = cJSON_GetObjectItemCaseSensitive(ezsigndocument_response_compoundJSON, "iEzsigndocumentFormfieldtotal");
    ...
    *i_ezsigndocument_ezsigndiscussiontotal_local_var = i_ezsigndocument_ezsigndiscussiontotal->valuedouble;
    ...
    i_ezsigndocument_stepformtotal_local_var = malloc(sizeof(int));
    if(!i_ezsigndocument_stepformtotal_local_var)
    {
        goto end;
    }
    *i_ezsigndocument_stepformtotal_local_var = i_ezsigndocument_stepformtotal->valuedouble;
    ...
    i_ezsigndocument_stepformcurrent_local_var = malloc(sizeof(int));
    if(!i_ezsigndocument_stepformcurrent_local_var)
    {
        goto end;
    }
    *i_ezsigndocument_stepformcurrent_local_var = i_ezsigndocument_stepformcurrent->valuedouble;
    ...
    i_ezsigndocument_stepsignaturetotal_local_var = malloc(sizeof(int));
    if(!i_ezsigndocument_stepsignaturetotal_local_var)
    {
        goto end;
    }
    *i_ezsigndocument_stepsignaturetotal_local_var = i_ezsigndocument_stepsignaturetotal->valuedouble;
    ...
    i_ezsigndocument_stepsignature_current_local_var = malloc(sizeof(int));
    if(!i_ezsigndocument_stepsignature_current_local_var)
    {
        goto end;
    }
    *i_ezsigndocument_stepsignature_current_local_var = i_ezsigndocument_stepsignature_current->valuedouble;
    ...
    // ezsigndocument_response_compound->a_obj_ezsigndocumentdependency
    cJSON *a_obj_ezsigndocumentdependency = cJSON_GetObjectItemCaseSensitive(ezsigndocument_response_compoundJSON, "a_objEzsigndocumentdependency");
    ...
    ezsigndocument_response_compound_local_var = ezsigndocument_response_compound_create_internal (
        ...
        i_ezsigndocument_stepformtotal_local_var,
        i_ezsigndocument_stepformcurrent_local_var,
        i_ezsigndocument_stepsignaturetotal_local_var,
        i_ezsigndocument_stepsignature_current_local_var,
    ...
    if (i_ezsigndocument_stepformtotal_local_var) {
        free(i_ezsigndocument_stepformtotal_local_var);
        i_ezsigndocument_stepformtotal_local_var = NULL;
    }
    if (i_ezsigndocument_stepformcurrent_local_var) {
        free(i_ezsigndocument_stepformcurrent_local_var);
        i_ezsigndocument_stepformcurrent_local_var = NULL;
    }
    if (i_ezsigndocument_stepsignaturetotal_local_var) {
        free(i_ezsigndocument_stepsignaturetotal_local_var);
        i_ezsigndocument_stepsignaturetotal_local_var = NULL;
    }
    if (i_ezsigndocument_stepsignature_current_local_var) {
        free(i_ezsigndocument_stepsignature_current_local_var);
        i_ezsigndocument_stepsignature_current_local_var = NULL;
    }
