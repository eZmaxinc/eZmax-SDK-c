...
typedef enum { ezmax_api_definition__full_field_e_ezsignfoldersignerassociation_role__NULL = 0, ezmax_api_definition__full_field_e_ezsignfoldersignerassociation_role__CC, ezmax_api_definition__full_field_e_ezsignfoldersignerassociation_role__CCDeleted, ezmax_api_definition__full_field_e_ezsignfoldersignerassociation_role__Signer, ezmax_api_definition__full_field_e_ezsignfoldersignerassociation_role__SignerAndCC } ezmax_api_definition__full_field_e_ezsignfoldersignerassociation_role__e;
