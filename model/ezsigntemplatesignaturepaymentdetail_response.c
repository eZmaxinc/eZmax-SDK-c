...
static ezsigntemplatesignaturepaymentdetail_response_t *ezsigntemplatesignaturepaymentdetail_response_create_internal(
    ...
    memset(ezsigntemplatesignaturepaymentdetail_response_local_var, 0, sizeof(ezsigntemplatesignaturepaymentdetail_response_t));
...
__attribute__((deprecated)) ezsigntemplatesignaturepaymentdetail_response_t *ezsigntemplatesignaturepaymentdetail_response_create(
    ...
    ezsigntemplatesignaturepaymentdetail_response_t *result = ezsigntemplatesignaturepaymentdetail_response_create_internal (
...
void ezsigntemplatesignaturepaymentdetail_response_free(ezsigntemplatesignaturepaymentdetail_response_t *ezsigntemplatesignaturepaymentdetail_response) {
    ...
    if (ezsigntemplatesignaturepaymentdetail_response->pki_ezsigntemplatesignaturepaymentdetail_id) {
        free(ezsigntemplatesignaturepaymentdetail_response->pki_ezsigntemplatesignaturepaymentdetail_id);
        ezsigntemplatesignaturepaymentdetail_response->pki_ezsigntemplatesignaturepaymentdetail_id = NULL;
    }
    if (ezsigntemplatesignaturepaymentdetail_response->fki_glaccountcontainer_id) {
        free(ezsigntemplatesignaturepaymentdetail_response->fki_glaccountcontainer_id);
        ezsigntemplatesignaturepaymentdetail_response->fki_glaccountcontainer_id = NULL;
    }
...
ezsigntemplatesignaturepaymentdetail_response_t *ezsigntemplatesignaturepaymentdetail_response_parseFromJSON(cJSON *ezsigntemplatesignaturepaymentdetail_responseJSON){
    ...
    // define the local variable for ezsigntemplatesignaturepaymentdetail_response->pki_ezsigntemplatesignaturepaymentdetail_id
    int *pki_ezsigntemplatesignaturepaymentdetail_id_local_var = NULL;

    // define the local variable for ezsigntemplatesignaturepaymentdetail_response->fki_glaccountcontainer_id
