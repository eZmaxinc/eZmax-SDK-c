/*
 * employee_get_communicationrecipients_v1_response_m_payload.h
 *
 * Response for GET /1/object/employee/{pkiEmployeeID}/getCommunicationrecipients
 */

#ifndef _employee_get_communicationrecipients_v1_response_m_payload_H_
#define _employee_get_communicationrecipients_v1_response_m_payload_H_
...
typedef struct employee_get_communicationrecipients_v1_response_m_payload_t employee_get_communicationrecipients_v1_response_m_payload_t;

#include "custom_communicationrecipientsgroup_response.h"



typedef struct employee_get_communicationrecipients_v1_response_m_payload_t {
    list_t *a_obj_communicationrecipientsgroup; //nonprimitive container

    int _library_owned; // Is the library responsible for freeing this object?
} employee_get_communicationrecipients_v1_response_m_payload_t;
...
#endif /* _employee_get_communicationrecipients_v1_response_m_payload_H_ */
