...
#include <string.h>
#include <stdio.h>
#include "ezsigndocument_edit_ezsignformfieldgroups_v1_response.h"



static ezsigndocument_edit_ezsignformfieldgroups_v1_response_t *ezsigndocument_edit_ezsignformfieldgroups_v1_response_create_internal(
    common_response_obj_debug_payload_t *obj_debug_payload,
    common_response_obj_debug_t *obj_debug,
    ezsigndocument_edit_ezsignformfieldgroups_v1_response_m_payload_t *m_payload
    ) {
    ezsigndocument_edit_ezsignformfieldgroups_v1_response_t *ezsigndocument_edit_ezsignformfieldgroups_v1_response_local_var = malloc(sizeof(ezsigndocument_edit_ezsignformfieldgroups_v1_response_t));
    if (!ezsigndocument_edit_ezsignformfieldgroups_v1_response_local_var) {
        return NULL;
    }
    memset(ezsigndocument_edit_ezsignformfieldgroups_v1_response_local_var, 0, sizeof(ezsigndocument_edit_ezsignformfieldgroups_v1_response_t));
    ezsigndocument_edit_ezsignformfieldgroups_v1_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezsigndocument_edit_ezsignformfieldgroups_v1_response_t *ezsigndocument_edit_ezsignformfieldgroups_v1_response_create(
    common_response_obj_debug_payload_t *obj_debug_payload,
    common_response_obj_debug_t *obj_debug,
    ezsigndocument_edit_ezsignformfieldgroups_v1_response_m_payload_t *m_payload
    ) {
    ezsigndocument_edit_ezsignformfieldgroups_v1_response_t *result = ezsigndocument_edit_ezsignformfieldgroups_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void ezsigndocument_edit_ezsignformfieldgroups_v1_response_free(ezsigndocument_edit_ezsignformfieldgroups_v1_response_t *ezsigndocument_edit_ezsignformfieldgroups_v1_response) {
    if(NULL == ezsigndocument_edit_ezsignformfieldgroups_v1_response){
        return ;
    }
    if(ezsigndocument_edit_ezsignformfieldgroups_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsigndocument_edit_ezsignformfieldgroups_v1_response_free");
        return ;
    }
    ...
    if (ezsigndocument_edit_ezsignformfieldgroups_v1_response->obj_debug) {
        common_response_obj_debug_free(ezsigndocument_edit_ezsignformfieldgroups_v1_response->obj_debug);
        ezsigndocument_edit_ezsignformfieldgroups_v1_response->obj_debug = NULL;
    }
    ...
    free(ezsigndocument_edit_ezsignformfieldgroups_v1_response);
}
...
ezsigndocument_edit_ezsignformfieldgroups_v1_response_t *ezsigndocument_edit_ezsignformfieldgroups_v1_response_parseFromJSON(cJSON *ezsigndocument_edit_ezsignformfieldgroups_v1_responseJSON){
    ...
    // ezsigndocument_edit_ezsignformfieldgroups_v1_response->obj_debug
    cJSON *obj_debug = cJSON_GetObjectItemCaseSensitive(ezsigndocument_edit_ezsignformfieldgroups_v1_responseJSON, "objDebug");
    ...
    ezsigndocument_edit_ezsignformfieldgroups_v1_response_local_var = ezsigndocument_edit_ezsignformfieldgroups_v1_response_create_internal (
