...
static ezsignfolder_get_list_v1_response_t *ezsignfolder_get_list_v1_response_create_internal(
    ...
    memset(ezsignfolder_get_list_v1_response_local_var, 0, sizeof(ezsignfolder_get_list_v1_response_t));
    ezsignfolder_get_list_v1_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezsignfolder_get_list_v1_response_t *ezsignfolder_get_list_v1_response_create(
    common_response_obj_debug_payload_get_list_t *obj_debug_payload,
    common_response_obj_debug_t *obj_debug,
    ezsignfolder_get_list_v1_response_m_payload_t *m_payload
    ) {
    ezsignfolder_get_list_v1_response_t *result = ezsignfolder_get_list_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void ezsignfolder_get_list_v1_response_free(ezsignfolder_get_list_v1_response_t *ezsignfolder_get_list_v1_response) {
    ...
    if(ezsignfolder_get_list_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsignfolder_get_list_v1_response_free");
        return ;
    }
...
ezsignfolder_get_list_v1_response_t *ezsignfolder_get_list_v1_response_parseFromJSON(cJSON *ezsignfolder_get_list_v1_responseJSON){
    ...
    ezsignfolder_get_list_v1_response_local_var = ezsignfolder_get_list_v1_response_create_internal (
