...
static webhook_create_object_v2_response_m_payload_t *webhook_create_object_v2_response_m_payload_create_internal(
    ...
    memset(webhook_create_object_v2_response_m_payload_local_var, 0, sizeof(webhook_create_object_v2_response_m_payload_t));
...
__attribute__((deprecated)) webhook_create_object_v2_response_m_payload_t *webhook_create_object_v2_response_m_payload_create(
    ...
    webhook_create_object_v2_response_m_payload_t *result = webhook_create_object_v2_response_m_payload_create_internal (
        a_obj_webhook
        );
    if (!result) {
    }
