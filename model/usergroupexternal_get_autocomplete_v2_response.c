...
static usergroupexternal_get_autocomplete_v2_response_t *usergroupexternal_get_autocomplete_v2_response_create_internal(
    ...
    memset(usergroupexternal_get_autocomplete_v2_response_local_var, 0, sizeof(usergroupexternal_get_autocomplete_v2_response_t));
    usergroupexternal_get_autocomplete_v2_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) usergroupexternal_get_autocomplete_v2_response_t *usergroupexternal_get_autocomplete_v2_response_create(
    ...
    usergroupexternal_get_autocomplete_v2_response_t *result = usergroupexternal_get_autocomplete_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void usergroupexternal_get_autocomplete_v2_response_free(usergroupexternal_get_autocomplete_v2_response_t *usergroupexternal_get_autocomplete_v2_response) {
    ...
    if(usergroupexternal_get_autocomplete_v2_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "usergroupexternal_get_autocomplete_v2_response_free");
        return ;
    }
...
usergroupexternal_get_autocomplete_v2_response_t *usergroupexternal_get_autocomplete_v2_response_parseFromJSON(cJSON *usergroupexternal_get_autocomplete_v2_responseJSON){
    ...
    usergroupexternal_get_autocomplete_v2_response_local_var = usergroupexternal_get_autocomplete_v2_response_create_internal (
