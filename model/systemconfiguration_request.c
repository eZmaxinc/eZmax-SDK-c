...
void systemconfiguration_request_free(systemconfiguration_request_t *systemconfiguration_request) {
    ...
    if (systemconfiguration_request->e_systemconfiguration_ezsignofficeplan) {
        field_e_systemconfiguration_ezsignofficeplan_free(systemconfiguration_request->e_systemconfiguration_ezsignofficeplan);
        systemconfiguration_request->e_systemconfiguration_ezsignofficeplan = NULL;
    }
...
cJSON *systemconfiguration_request_convertToJSON(systemconfiguration_request_t *systemconfiguration_request) {
    ...
    if(systemconfiguration_request->e_systemconfiguration_ezsignofficeplan != ezmax_api_definition__full_systemconfiguration_request__NULL) {
