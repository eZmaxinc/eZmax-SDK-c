...
static systemconfiguration_request_t *systemconfiguration_request_create_internal(
    ...
    systemconfiguration_request_local_var->e_systemconfiguration_ezsignofficeplan = e_systemconfiguration_ezsignofficeplan;
    systemconfiguration_request_local_var->b_systemconfiguration_ezsignpaidbyoffice = b_systemconfiguration_ezsignpaidbyoffice;
    ...
    systemconfiguration_request_local_var->_library_owned = 1;
...
__attribute__((deprecated)) systemconfiguration_request_t *systemconfiguration_request_create(
    ...
    return systemconfiguration_request_create_internal (
...
void systemconfiguration_request_free(systemconfiguration_request_t *systemconfiguration_request) {
    ...
    if(systemconfiguration_request->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "systemconfiguration_request_free");
        return ;
    }
...
cJSON *systemconfiguration_request_convertToJSON(systemconfiguration_request_t *systemconfiguration_request) {
    ...
    if (ezmax_api_definition__full_field_e_systemconfiguration_newexternaluseraction__NULL == systemconfiguration_request->e_systemconfiguration_newexternaluseraction) {
        goto fail;
    }
    ...
    if (ezmax_api_definition__full_field_e_systemconfiguration_language1__NULL == systemconfiguration_request->e_systemconfiguration_language1) {
        goto fail;
    }
    ...
    if (ezmax_api_definition__full_field_e_systemconfiguration_language2__NULL == systemconfiguration_request->e_systemconfiguration_language2) {
        goto fail;
    }
    ...
    if(systemconfiguration_request->e_systemconfiguration_ezsign != ezmax_api_definition__full_field_e_systemconfiguration_ezsign__NULL) {
    ...
    // systemconfiguration_request->e_systemconfiguration_ezsignofficeplan
    if(systemconfiguration_request->e_systemconfiguration_ezsignofficeplan != ezmax_api_definition__full_field_e_systemconfiguration_ezsignofficeplan__NULL) {
    cJSON *e_systemconfiguration_ezsignofficeplan_local_JSON = field_e_systemconfiguration_ezsignofficeplan_convertToJSON(systemconfiguration_request->e_systemconfiguration_ezsignofficeplan);
    ...
    // systemconfiguration_request->b_systemconfiguration_ezsignpaidbyoffice
    if(systemconfiguration_request->b_systemconfiguration_ezsignpaidbyoffice) {
    if(cJSON_AddBoolToObject(item, "bSystemconfigurationEzsignpaidbyoffice", systemconfiguration_request->b_systemconfiguration_ezsignpaidbyoffice) == NULL) {
    goto fail; //Bool
    }
    }
...
systemconfiguration_request_t *systemconfiguration_request_parseFromJSON(cJSON *systemconfiguration_requestJSON){
    ...
    // define the local variable for systemconfiguration_request->e_systemconfiguration_ezsignofficeplan
    ...
    // systemconfiguration_request->e_systemconfiguration_ezsignofficeplan
    cJSON *e_systemconfiguration_ezsignofficeplan = cJSON_GetObjectItemCaseSensitive(systemconfiguration_requestJSON, "eSystemconfigurationEzsignofficeplan");
    ...
    // systemconfiguration_request->b_systemconfiguration_ezsignpaidbyoffice
    cJSON *b_systemconfiguration_ezsignpaidbyoffice = cJSON_GetObjectItemCaseSensitive(systemconfiguration_requestJSON, "bSystemconfigurationEzsignpaidbyoffice");
    ...
    systemconfiguration_request_local_var = systemconfiguration_request_create_internal (
