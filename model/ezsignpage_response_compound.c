...
static ezsignpage_response_compound_t *ezsignpage_response_compound_create_internal(
    ...
    memset(ezsignpage_response_compound_local_var, 0, sizeof(ezsignpage_response_compound_t));
...
__attribute__((deprecated)) ezsignpage_response_compound_t *ezsignpage_response_compound_create(
    ...
    ezsignpage_response_compound_t *result = ezsignpage_response_compound_create_internal (
...
void ezsignpage_response_compound_free(ezsignpage_response_compound_t *ezsignpage_response_compound) {
    ...
    if (ezsignpage_response_compound->pki_ezsignpage_id) {
        free(ezsignpage_response_compound->pki_ezsignpage_id);
        ezsignpage_response_compound->pki_ezsignpage_id = NULL;
    }
    if (ezsignpage_response_compound->i_ezsignpage_widthimage) {
        free(ezsignpage_response_compound->i_ezsignpage_widthimage);
        ezsignpage_response_compound->i_ezsignpage_widthimage = NULL;
    }
    if (ezsignpage_response_compound->i_ezsignpage_heightimage) {
        free(ezsignpage_response_compound->i_ezsignpage_heightimage);
        ezsignpage_response_compound->i_ezsignpage_heightimage = NULL;
    }
    if (ezsignpage_response_compound->i_ezsignpage_widthpdf) {
        free(ezsignpage_response_compound->i_ezsignpage_widthpdf);
        ezsignpage_response_compound->i_ezsignpage_widthpdf = NULL;
    }
    if (ezsignpage_response_compound->i_ezsignpage_heightpdf) {
        free(ezsignpage_response_compound->i_ezsignpage_heightpdf);
        ezsignpage_response_compound->i_ezsignpage_heightpdf = NULL;
    }
    if (ezsignpage_response_compound->i_ezsignpage_pagenumber) {
        free(ezsignpage_response_compound->i_ezsignpage_pagenumber);
        ezsignpage_response_compound->i_ezsignpage_pagenumber = NULL;
    }
...
ezsignpage_response_compound_t *ezsignpage_response_compound_parseFromJSON(cJSON *ezsignpage_response_compoundJSON){
    ...
    // define the local variable for ezsignpage_response_compound->pki_ezsignpage_id
    int *pki_ezsignpage_id_local_var = NULL;

    // define the local variable for ezsignpage_response_compound->i_ezsignpage_widthimage
    int *i_ezsignpage_widthimage_local_var = NULL;

    // define the local variable for ezsignpage_response_compound->i_ezsignpage_heightimage
    int *i_ezsignpage_heightimage_local_var = NULL;

    // define the local variable for ezsignpage_response_compound->i_ezsignpage_widthpdf
    int *i_ezsignpage_widthpdf_local_var = NULL;

    // define the local variable for ezsignpage_response_compound->i_ezsignpage_heightpdf
    int *i_ezsignpage_heightpdf_local_var = NULL;

    // define the local variable for ezsignpage_response_compound->i_ezsignpage_pagenumber
