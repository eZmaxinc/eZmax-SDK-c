...
static ezsignannotation_delete_object_v1_response_t *ezsignannotation_delete_object_v1_response_create_internal(
    ...
    memset(ezsignannotation_delete_object_v1_response_local_var, 0, sizeof(ezsignannotation_delete_object_v1_response_t));
    ezsignannotation_delete_object_v1_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezsignannotation_delete_object_v1_response_t *ezsignannotation_delete_object_v1_response_create(
    ...
    ezsignannotation_delete_object_v1_response_t *result = ezsignannotation_delete_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug
        );
    if (!result) {
...
void ezsignannotation_delete_object_v1_response_free(ezsignannotation_delete_object_v1_response_t *ezsignannotation_delete_object_v1_response) {
    ...
    if(ezsignannotation_delete_object_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsignannotation_delete_object_v1_response_free");
        return ;
    }
...
ezsignannotation_delete_object_v1_response_t *ezsignannotation_delete_object_v1_response_parseFromJSON(cJSON *ezsignannotation_delete_object_v1_responseJSON){
    ...
    ezsignannotation_delete_object_v1_response_local_var = ezsignannotation_delete_object_v1_response_create_internal (
