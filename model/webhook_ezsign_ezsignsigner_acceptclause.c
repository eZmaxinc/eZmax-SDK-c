...
static webhook_ezsign_ezsignsigner_acceptclause_t *webhook_ezsign_ezsignsigner_acceptclause_create_internal(
    ...
    memset(webhook_ezsign_ezsignsigner_acceptclause_local_var, 0, sizeof(webhook_ezsign_ezsignsigner_acceptclause_t));
...
__attribute__((deprecated)) webhook_ezsign_ezsignsigner_acceptclause_t *webhook_ezsign_ezsignsigner_acceptclause_create(
    ...
    webhook_ezsign_ezsignsigner_acceptclause_t *result = webhook_ezsign_ezsignsigner_acceptclause_create_internal (
        obj_webhook,
        a_obj_attempt,
        obj_ezsignfolder,
