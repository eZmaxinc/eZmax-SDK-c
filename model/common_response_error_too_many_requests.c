...
char* e_error_codecommon_response_error_too_many_requests_ToString(ezmax_api_definition__full_common_response_error_too_many_requests__e e_error_code) {
...
ezmax_api_definition__full_common_response_error_too_many_requests__e e_error_codecommon_response_error_too_many_requests_FromString(char* e_error_code){
