...
static common_response_error_too_many_requests_t *common_response_error_too_many_requests_create_internal(
    ...
    memset(common_response_error_too_many_requests_local_var, 0, sizeof(common_response_error_too_many_requests_t));
    common_response_error_too_many_requests_local_var->_library_owned = 1;
...
__attribute__((deprecated)) common_response_error_too_many_requests_t *common_response_error_too_many_requests_create(
    ...
    common_response_error_too_many_requests_t *result = common_response_error_too_many_requests_create_internal (
        s_error_message,
        e_error_code,
...
void common_response_error_too_many_requests_free(common_response_error_too_many_requests_t *common_response_error_too_many_requests) {
    ...
    if(common_response_error_too_many_requests->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "common_response_error_too_many_requests_free");
        return ;
    }
...
cJSON *common_response_error_too_many_requests_convertToJSON(common_response_error_too_many_requests_t *common_response_error_too_many_requests) {
    ...
    if (ezmax_api_definition__full_field_e_error_code__NULL == common_response_error_too_many_requests->e_error_code) {
        goto fail;
    }
...
common_response_error_too_many_requests_t *common_response_error_too_many_requests_parseFromJSON(cJSON *common_response_error_too_many_requestsJSON){
    ...
    common_response_error_too_many_requests_local_var = common_response_error_too_many_requests_create_internal (
