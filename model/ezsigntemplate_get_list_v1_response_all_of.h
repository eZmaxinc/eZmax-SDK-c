/*
 * ezsigntemplate_get_list_v1_response_all_of.h
 *
 * 
 */

#ifndef _ezsigntemplate_get_list_v1_response_all_of_H_
#define _ezsigntemplate_get_list_v1_response_all_of_H_
...
typedef struct ezsigntemplate_get_list_v1_response_all_of_t ezsigntemplate_get_list_v1_response_all_of_t;

#include "ezsigntemplate_get_list_v1_response_m_payload.h"



typedef struct ezsigntemplate_get_list_v1_response_all_of_t {
    struct ezsigntemplate_get_list_v1_response_m_payload_t *m_payload; //model

} ezsigntemplate_get_list_v1_response_all_of_t;
...
#endif /* _ezsigntemplate_get_list_v1_response_all_of_H_ */
