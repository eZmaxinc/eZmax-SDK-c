...
static ezsigntemplate_edit_object_v3_response_t *ezsigntemplate_edit_object_v3_response_create_internal(
    ...
    memset(ezsigntemplate_edit_object_v3_response_local_var, 0, sizeof(ezsigntemplate_edit_object_v3_response_t));
...
__attribute__((deprecated)) ezsigntemplate_edit_object_v3_response_t *ezsigntemplate_edit_object_v3_response_create(
    ...
    ezsigntemplate_edit_object_v3_response_t *result = ezsigntemplate_edit_object_v3_response_create_internal (
        obj_debug_payload,
        obj_debug
        );
    if (!result) {
