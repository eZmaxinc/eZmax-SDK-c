...
static ezmaxinvoicingsummaryinternal_response_compound_t *ezmaxinvoicingsummaryinternal_response_compound_create_internal(
    ...
    memset(ezmaxinvoicingsummaryinternal_response_compound_local_var, 0, sizeof(ezmaxinvoicingsummaryinternal_response_compound_t));
    ezmaxinvoicingsummaryinternal_response_compound_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezmaxinvoicingsummaryinternal_response_compound_t *ezmaxinvoicingsummaryinternal_response_compound_create(
    ...
    int *pki_ezmaxinvoicingsummaryinternal_id_copy = NULL;
    if (pki_ezmaxinvoicingsummaryinternal_id) {
        pki_ezmaxinvoicingsummaryinternal_id_copy = malloc(sizeof(int));
        if (pki_ezmaxinvoicingsummaryinternal_id_copy) *pki_ezmaxinvoicingsummaryinternal_id_copy = *pki_ezmaxinvoicingsummaryinternal_id;
    }
    ...
    ezmaxinvoicingsummaryinternal_response_compound_t *result = ezmaxinvoicingsummaryinternal_response_compound_create_internal (
        pki_ezmaxinvoicingsummaryinternal_id_copy,
    ...
    if (!result) {
        free(pki_ezmaxinvoicingsummaryinternal_id_copy);
...
void ezmaxinvoicingsummaryinternal_response_compound_free(ezmaxinvoicingsummaryinternal_response_compound_t *ezmaxinvoicingsummaryinternal_response_compound) {
    ...
    if(ezmaxinvoicingsummaryinternal_response_compound->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezmaxinvoicingsummaryinternal_response_compound_free");
        return ;
    }
    listEntry_t *listEntry;
    if (ezmaxinvoicingsummaryinternal_response_compound->pki_ezmaxinvoicingsummaryinternal_id) {
        free(ezmaxinvoicingsummaryinternal_response_compound->pki_ezmaxinvoicingsummaryinternal_id);
        ezmaxinvoicingsummaryinternal_response_compound->pki_ezmaxinvoicingsummaryinternal_id = NULL;
    }
    ...
    if (ezmaxinvoicingsummaryinternal_response_compound->fki_ezmaxinvoicing_id) {
        free(ezmaxinvoicingsummaryinternal_response_compound->fki_ezmaxinvoicing_id);
        ezmaxinvoicingsummaryinternal_response_compound->fki_ezmaxinvoicing_id = NULL;
    }
    if (ezmaxinvoicingsummaryinternal_response_compound->fki_billingentityinternal_id) {
        free(ezmaxinvoicingsummaryinternal_response_compound->fki_billingentityinternal_id);
        ezmaxinvoicingsummaryinternal_response_compound->fki_billingentityinternal_id = NULL;
    }
...
ezmaxinvoicingsummaryinternal_response_compound_t *ezmaxinvoicingsummaryinternal_response_compound_parseFromJSON(cJSON *ezmaxinvoicingsummaryinternal_response_compoundJSON){
    ...
    // define the local variable for ezmaxinvoicingsummaryinternal_response_compound->pki_ezmaxinvoicingsummaryinternal_id
    int *pki_ezmaxinvoicingsummaryinternal_id_local_var = NULL;
    ...
    char *s_ezmaxinvoicingsummaryinternal_description_x_local_str = NULL;

    // define the local variable for ezmaxinvoicingsummaryinternal_response_compound->fki_ezmaxinvoicing_id
    int *fki_ezmaxinvoicing_id_local_var = NULL;

    // define the local variable for ezmaxinvoicingsummaryinternal_response_compound->fki_billingentityinternal_id
    ...
    pki_ezmaxinvoicingsummaryinternal_id_local_var = malloc(sizeof(int));
    if(!pki_ezmaxinvoicingsummaryinternal_id_local_var)
    {
        goto end;
    }
    *pki_ezmaxinvoicingsummaryinternal_id_local_var = pki_ezmaxinvoicingsummaryinternal_id->valuedouble;
    }
    ...
    *fki_billingentityinternal_id_local_var = fki_billingentityinternal_id->valuedouble;
    ...
    if (cJSON_IsNull(a_obj_ezmaxinvoicingsummaryinternaldetail)) {
    ...
    if (s_ezmaxinvoicingsummaryinternal_description_x && !cJSON_IsNull(s_ezmaxinvoicingsummaryinternal_description_x)) s_ezmaxinvoicingsummaryinternal_description_x_local_str = strdup(s_ezmaxinvoicingsummaryinternal_description_x->valuestring);
    ...
    ezmaxinvoicingsummaryinternal_response_compound_local_var = ezmaxinvoicingsummaryinternal_response_compound_create_internal (
        pki_ezmaxinvoicingsummaryinternal_id_local_var,
        obj_ezmaxinvoicingsummaryinternal_description_local_nonprim,
        s_ezmaxinvoicingsummaryinternal_description_x_local_str,
    ...
    if (pki_ezmaxinvoicingsummaryinternal_id_local_var) {
        free(pki_ezmaxinvoicingsummaryinternal_id_local_var);
        pki_ezmaxinvoicingsummaryinternal_id_local_var = NULL;
    }
    ...
    if (s_ezmaxinvoicingsummaryinternal_description_x_local_str) {
        free(s_ezmaxinvoicingsummaryinternal_description_x_local_str);
        s_ezmaxinvoicingsummaryinternal_description_x_local_str = NULL;
    }
    if (fki_ezmaxinvoicing_id_local_var) {
