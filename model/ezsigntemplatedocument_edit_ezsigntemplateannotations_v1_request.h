/*
 * ezsigntemplatedocument_edit_ezsigntemplateannotations_v1_request.h
 *
 * Request for PUT /1/object/ezsigntemplatedocument/{pkiEzsigntemplatedocumentID}/editEzsigntemplateannotations
 */

#ifndef _ezsigntemplatedocument_edit_ezsigntemplateannotations_v1_request_H_
#define _ezsigntemplatedocument_edit_ezsigntemplateannotations_v1_request_H_
...
typedef struct ezsigntemplatedocument_edit_ezsigntemplateannotations_v1_request_t ezsigntemplatedocument_edit_ezsigntemplateannotations_v1_request_t;

#include "ezsigntemplateannotation_request_compound.h"



typedef struct ezsigntemplatedocument_edit_ezsigntemplateannotations_v1_request_t {
    list_t *a_obj_ezsigntemplateannotation; //nonprimitive container

    int _library_owned; // Is the library responsible for freeing this object?
} ezsigntemplatedocument_edit_ezsigntemplateannotations_v1_request_t;
...
#endif /* _ezsigntemplatedocument_edit_ezsigntemplateannotations_v1_request_H_ */
