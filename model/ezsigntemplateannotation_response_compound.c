...
static ezsigntemplateannotation_response_compound_t *ezsigntemplateannotation_response_compound_create_internal(
    ...
    ezsigntemplateannotation_response_compound_local_var->fki_ezsigntemplatedocumentpage_id = fki_ezsigntemplatedocumentpage_id;
    ...
    ezsigntemplateannotation_response_compound_local_var->s_ezsigntemplateannotationn_dropdownvalues = s_ezsigntemplateannotationn_dropdownvalues;
...
__attribute__((deprecated)) ezsigntemplateannotation_response_compound_t *ezsigntemplateannotation_response_compound_create(
    ...
    return ezsigntemplateannotation_response_compound_create_internal (
...
void ezsigntemplateannotation_response_compound_free(ezsigntemplateannotation_response_compound_t *ezsigntemplateannotation_response_compound) {
    ...
    if (ezsigntemplateannotation_response_compound->s_ezsigntemplateannotationn_dropdownvalues) {
        free(ezsigntemplateannotation_response_compound->s_ezsigntemplateannotationn_dropdownvalues);
        ezsigntemplateannotation_response_compound->s_ezsigntemplateannotationn_dropdownvalues = NULL;
    }
...
cJSON *ezsigntemplateannotation_response_compound_convertToJSON(ezsigntemplateannotation_response_compound_t *ezsigntemplateannotation_response_compound) {
    ...
    // ezsigntemplateannotation_response_compound->fki_ezsigntemplatedocumentpage_id
    if (!ezsigntemplateannotation_response_compound->fki_ezsigntemplatedocumentpage_id) {
        goto fail;
    }
    if(cJSON_AddNumberToObject(item, "fkiEzsigntemplatedocumentpageID", ezsigntemplateannotation_response_compound->fki_ezsigntemplatedocumentpage_id) == NULL) {
    goto fail; //Numeric
    }
    ...
    // ezsigntemplateannotation_response_compound->s_ezsigntemplateannotationn_dropdownvalues
    if (!ezsigntemplateannotation_response_compound->s_ezsigntemplateannotationn_dropdownvalues) {
        goto fail;
    }
    if(cJSON_AddStringToObject(item, "sEzsigntemplateannotationnDropdownvalues", ezsigntemplateannotation_response_compound->s_ezsigntemplateannotationn_dropdownvalues) == NULL) {
    goto fail; //String
    }
...
ezsigntemplateannotation_response_compound_t *ezsigntemplateannotation_response_compound_parseFromJSON(cJSON *ezsigntemplateannotation_response_compoundJSON){
    ...
    // ezsigntemplateannotation_response_compound->fki_ezsigntemplatedocumentpage_id
    cJSON *fki_ezsigntemplatedocumentpage_id = cJSON_GetObjectItemCaseSensitive(ezsigntemplateannotation_response_compoundJSON, "fkiEzsigntemplatedocumentpageID");
    ...
    // ezsigntemplateannotation_response_compound->s_ezsigntemplateannotationn_dropdownvalues
    cJSON *s_ezsigntemplateannotationn_dropdownvalues = cJSON_GetObjectItemCaseSensitive(ezsigntemplateannotation_response_compoundJSON, "sEzsigntemplateannotationnDropdownvalues");
