...
static cors_get_object_v2_response_t *cors_get_object_v2_response_create_internal(
    ...
    memset(cors_get_object_v2_response_local_var, 0, sizeof(cors_get_object_v2_response_t));
...
__attribute__((deprecated)) cors_get_object_v2_response_t *cors_get_object_v2_response_create(
    ...
    cors_get_object_v2_response_t *result = cors_get_object_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
