...
static usergroupdelegation_edit_object_v1_response_t *usergroupdelegation_edit_object_v1_response_create_internal(
    ...
    memset(usergroupdelegation_edit_object_v1_response_local_var, 0, sizeof(usergroupdelegation_edit_object_v1_response_t));
...
__attribute__((deprecated)) usergroupdelegation_edit_object_v1_response_t *usergroupdelegation_edit_object_v1_response_create(
    ...
    usergroupdelegation_edit_object_v1_response_t *result = usergroupdelegation_edit_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug
        );
    if (!result) {
