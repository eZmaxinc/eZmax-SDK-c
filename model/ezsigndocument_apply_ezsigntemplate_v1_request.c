...
#include <string.h>
#include <stdio.h>
#include "ezsigndocument_apply_ezsigntemplate_v1_request.h"



static ezsigndocument_apply_ezsigntemplate_v1_request_t *ezsigndocument_apply_ezsigntemplate_v1_request_create_internal(
    int *fki_ezsigntemplate_id,
    list_t *a_s_ezsigntemplatesigner,
    list_t *a_pki_ezsignfoldersignerassociation_id
    ) {
    ezsigndocument_apply_ezsigntemplate_v1_request_t *ezsigndocument_apply_ezsigntemplate_v1_request_local_var = malloc(sizeof(ezsigndocument_apply_ezsigntemplate_v1_request_t));
    if (!ezsigndocument_apply_ezsigntemplate_v1_request_local_var) {
        return NULL;
    }
    memset(ezsigndocument_apply_ezsigntemplate_v1_request_local_var, 0, sizeof(ezsigndocument_apply_ezsigntemplate_v1_request_t));
    ezsigndocument_apply_ezsigntemplate_v1_request_local_var->_library_owned = 1;
    ezsigndocument_apply_ezsigntemplate_v1_request_local_var->fki_ezsigntemplate_id = fki_ezsigntemplate_id;
    ezsigndocument_apply_ezsigntemplate_v1_request_local_var->a_s_ezsigntemplatesigner = a_s_ezsigntemplatesigner;
    ezsigndocument_apply_ezsigntemplate_v1_request_local_var->a_pki_ezsignfoldersignerassociation_id = a_pki_ezsignfoldersignerassociation_id;
    return ezsigndocument_apply_ezsigntemplate_v1_request_local_var;
}
...
__attribute__((deprecated)) ezsigndocument_apply_ezsigntemplate_v1_request_t *ezsigndocument_apply_ezsigntemplate_v1_request_create(
    ...
    ezsigndocument_apply_ezsigntemplate_v1_request_t *result = ezsigndocument_apply_ezsigntemplate_v1_request_create_internal (
...
void ezsigndocument_apply_ezsigntemplate_v1_request_free(ezsigndocument_apply_ezsigntemplate_v1_request_t *ezsigndocument_apply_ezsigntemplate_v1_request) {
    if(NULL == ezsigndocument_apply_ezsigntemplate_v1_request){
        return ;
    }
    if(ezsigndocument_apply_ezsigntemplate_v1_request->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsigndocument_apply_ezsigntemplate_v1_request_free");
        return ;
    }
    listEntry_t *listEntry;
    if (ezsigndocument_apply_ezsigntemplate_v1_request->fki_ezsigntemplate_id) {
        free(ezsigndocument_apply_ezsigntemplate_v1_request->fki_ezsigntemplate_id);
        ezsigndocument_apply_ezsigntemplate_v1_request->fki_ezsigntemplate_id = NULL;
    }
    if (ezsigndocument_apply_ezsigntemplate_v1_request->a_s_ezsigntemplatesigner) {
...
cJSON *ezsigndocument_apply_ezsigntemplate_v1_request_convertToJSON(ezsigndocument_apply_ezsigntemplate_v1_request_t *ezsigndocument_apply_ezsigntemplate_v1_request) {
    ...
    // ezsigndocument_apply_ezsigntemplate_v1_request->fki_ezsigntemplate_id
    if (!ezsigndocument_apply_ezsigntemplate_v1_request->fki_ezsigntemplate_id) {
        goto fail;
    }
    if(cJSON_AddNumberToObject(item, "fkiEzsigntemplateID", *ezsigndocument_apply_ezsigntemplate_v1_request->fki_ezsigntemplate_id) == NULL) {
    goto fail; //Numeric
    }


    // ezsigndocument_apply_ezsigntemplate_v1_request->a_s_ezsigntemplatesigner
    if (!ezsigndocument_apply_ezsigntemplate_v1_request->a_s_ezsigntemplatesigner) {
        goto fail;
    }
    ...
    list_ForEach(a_s_ezsigntemplatesignerListEntry, ezsigndocument_apply_ezsigntemplate_v1_request->a_s_ezsigntemplatesigner) {
    ...
    // ezsigndocument_apply_ezsigntemplate_v1_request->a_pki_ezsignfoldersignerassociation_id
    if (!ezsigndocument_apply_ezsigntemplate_v1_request->a_pki_ezsignfoldersignerassociation_id) {
        goto fail;
    }
    ...
    list_ForEach(a_pki_ezsignfoldersignerassociation_idListEntry, ezsigndocument_apply_ezsigntemplate_v1_request->a_pki_ezsignfoldersignerassociation_id) {
...
ezsigndocument_apply_ezsigntemplate_v1_request_t *ezsigndocument_apply_ezsigntemplate_v1_request_parseFromJSON(cJSON *ezsigndocument_apply_ezsigntemplate_v1_requestJSON){
    ...
    ezsigndocument_apply_ezsigntemplate_v1_request_t *ezsigndocument_apply_ezsigntemplate_v1_request_local_var = NULL;

    // define the local variable for ezsigndocument_apply_ezsigntemplate_v1_request->fki_ezsigntemplate_id
    int *fki_ezsigntemplate_id_local_var = NULL;

    // define the local list for ezsigndocument_apply_ezsigntemplate_v1_request->a_s_ezsigntemplatesigner
    list_t *a_s_ezsigntemplatesignerList = NULL;

    // define the local list for ezsigndocument_apply_ezsigntemplate_v1_request->a_pki_ezsignfoldersignerassociation_id
    list_t *a_pki_ezsignfoldersignerassociation_idList = NULL;

    // ezsigndocument_apply_ezsigntemplate_v1_request->fki_ezsigntemplate_id
    cJSON *fki_ezsigntemplate_id = cJSON_GetObjectItemCaseSensitive(ezsigndocument_apply_ezsigntemplate_v1_requestJSON, "fkiEzsigntemplateID");
    ...
    *fki_ezsigntemplate_id_local_var = fki_ezsigntemplate_id->valuedouble;
    ...
    // ezsigndocument_apply_ezsigntemplate_v1_request->a_s_ezsigntemplatesigner
    cJSON *a_s_ezsigntemplatesigner = cJSON_GetObjectItemCaseSensitive(ezsigndocument_apply_ezsigntemplate_v1_requestJSON, "a_sEzsigntemplatesigner");
    ...
    // ezsigndocument_apply_ezsigntemplate_v1_request->a_pki_ezsignfoldersignerassociation_id
    cJSON *a_pki_ezsignfoldersignerassociation_id = cJSON_GetObjectItemCaseSensitive(ezsigndocument_apply_ezsigntemplate_v1_requestJSON, "a_pkiEzsignfoldersignerassociationID");
    ...
    ezsigndocument_apply_ezsigntemplate_v1_request_local_var = ezsigndocument_apply_ezsigntemplate_v1_request_create_internal (
