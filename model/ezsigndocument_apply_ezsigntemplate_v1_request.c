...
ezsigndocument_apply_ezsigntemplate_v1_request_t *ezsigndocument_apply_ezsigntemplate_v1_request_create(
...
ezsigndocument_apply_ezsigntemplate_v1_request_t *ezsigndocument_apply_ezsigntemplate_v1_request_parseFromJSON(cJSON *ezsigndocument_apply_ezsigntemplate_v1_requestJSON){
    ...
    ezsigndocument_apply_ezsigntemplate_v1_request_local_var = ezsigndocument_apply_ezsigntemplate_v1_request_create (
