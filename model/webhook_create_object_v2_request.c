...
#include <string.h>
#include <stdio.h>
#include "webhook_create_object_v2_request.h"
...
static webhook_create_object_v2_request_t *webhook_create_object_v2_request_create_internal(
    ...
    if (!webhook_create_object_v2_request_local_var) {
        return NULL;
    }
    memset(webhook_create_object_v2_request_local_var, 0, sizeof(webhook_create_object_v2_request_t));
...
__attribute__((deprecated)) webhook_create_object_v2_request_t *webhook_create_object_v2_request_create(
    ...
    webhook_create_object_v2_request_t *result = webhook_create_object_v2_request_create_internal (
        a_obj_webhook
        );
    if (!result) {
    }
...
void webhook_create_object_v2_request_free(webhook_create_object_v2_request_t *webhook_create_object_v2_request) {
    ...
    if (webhook_create_object_v2_request->a_obj_webhook) {
        list_ForEach(listEntry, webhook_create_object_v2_request->a_obj_webhook) {
            webhook_request_compound_free(listEntry->data);
        }
        list_freeList(webhook_create_object_v2_request->a_obj_webhook);
        webhook_create_object_v2_request->a_obj_webhook = NULL;
    }
    free(webhook_create_object_v2_request);
}
...
cJSON *webhook_create_object_v2_request_convertToJSON(webhook_create_object_v2_request_t *webhook_create_object_v2_request) {
    ...
    if (webhook_create_object_v2_request->a_obj_webhook) {
    list_ForEach(a_obj_webhookListEntry, webhook_create_object_v2_request->a_obj_webhook) {
...
webhook_create_object_v2_request_t *webhook_create_object_v2_request_parseFromJSON(cJSON *webhook_create_object_v2_requestJSON){
    ...
    webhook_create_object_v2_request_t *webhook_create_object_v2_request_local_var = NULL;

    // define the local list for webhook_create_object_v2_request->a_obj_webhook
