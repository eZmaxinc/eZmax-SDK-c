...
cJSON *field_e_ezsigntemplateformfield_dependencyrequirement_convertToJSON(ezmax_api_definition__full_field_e_ezsigntemplateformfield_dependencyrequirement__e field_e_ezsigntemplateformfield_dependencyrequirement) {
...
ezmax_api_definition__full_field_e_ezsigntemplateformfield_dependencyrequirement__e field_e_ezsigntemplateformfield_dependencyrequirement_parseFromJSON(cJSON *field_e_ezsigntemplateformfield_dependencyrequirementJSON) {
    if(!cJSON_IsString(field_e_ezsigntemplateformfield_dependencyrequirementJSON) || (field_e_ezsigntemplateformfield_dependencyrequirementJSON->valuestring == NULL)) {
        return 0;
    }
    return field_e_ezsigntemplateformfield_dependencyrequirement_field_e_ezsigntemplateformfield_dependencyrequirement_FromString(field_e_ezsigntemplateformfield_dependencyrequirementJSON->valuestring);
}
