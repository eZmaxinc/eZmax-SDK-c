/*
 * notary_get_communication_list_v1_response_m_payload.h
 *
 * Response for GET /1/object/notary/{pkiNotaryID}/getCommunicationList
 */

#ifndef _notary_get_communication_list_v1_response_m_payload_H_
#define _notary_get_communication_list_v1_response_m_payload_H_
...
typedef struct notary_get_communication_list_v1_response_m_payload_t notary_get_communication_list_v1_response_m_payload_t;

#include "custom_communication_list_element_response.h"



typedef struct notary_get_communication_list_v1_response_m_payload_t {
    list_t *a_obj_communication; //nonprimitive container

    int _library_owned; // Is the library responsible for freeing this object?
} notary_get_communication_list_v1_response_m_payload_t;
...
#endif /* _notary_get_communication_list_v1_response_m_payload_H_ */
