...
void ezsignformfieldgroup_request_compound_free(ezsignformfieldgroup_request_compound_t *ezsignformfieldgroup_request_compound) {
    ...
    if (ezsignformfieldgroup_request_compound->e_ezsignformfieldgroup_textvalidation) {
        enum_textvalidation_free(ezsignformfieldgroup_request_compound->e_ezsignformfieldgroup_textvalidation);
        ezsignformfieldgroup_request_compound->e_ezsignformfieldgroup_textvalidation = NULL;
    }
...
cJSON *ezsignformfieldgroup_request_compound_convertToJSON(ezsignformfieldgroup_request_compound_t *ezsignformfieldgroup_request_compound) {
    ...
    if(ezsignformfieldgroup_request_compound->e_ezsignformfieldgroup_signerrequirement != ezmax_api_definition__full_ezsignformfieldgroup_request_compound__NULL) {
    ...
    if(ezsignformfieldgroup_request_compound->e_ezsignformfieldgroup_textvalidation != ezmax_api_definition__full_ezsignformfieldgroup_request_compound__NULL) {
