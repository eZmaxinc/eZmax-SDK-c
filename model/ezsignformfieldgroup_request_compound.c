...
char* e_ezsignformfieldgroup_typeezsignformfieldgroup_request_compound_ToString(ezmax_api_definition_ezsignformfieldgroup_request_compound__e e_ezsignformfieldgroup_type) {
...
ezmax_api_definition_ezsignformfieldgroup_request_compound__e e_ezsignformfieldgroup_typeezsignformfieldgroup_request_compound_FromString(char* e_ezsignformfieldgroup_type){
...
char* e_ezsignformfieldgroup_signerrequirementezsignformfieldgroup_request_compound_ToString(ezmax_api_definition_ezsignformfieldgroup_request_compound__e e_ezsignformfieldgroup_signerrequirement) {
...
ezmax_api_definition_ezsignformfieldgroup_request_compound__e e_ezsignformfieldgroup_signerrequirementezsignformfieldgroup_request_compound_FromString(char* e_ezsignformfieldgroup_signerrequirement){
    int stringToReturn = 0;
    char *e_ezsignformfieldgroup_signerrequirementArray[] =  { "NULL", "All", "One" };
...
char* e_ezsignformfieldgroup_tooltippositionezsignformfieldgroup_request_compound_ToString(ezmax_api_definition_ezsignformfieldgroup_request_compound__e e_ezsignformfieldgroup_tooltipposition) {
...
ezmax_api_definition_ezsignformfieldgroup_request_compound__e e_ezsignformfieldgroup_tooltippositionezsignformfieldgroup_request_compound_FromString(char* e_ezsignformfieldgroup_tooltipposition){
    int stringToReturn = 0;
    char *e_ezsignformfieldgroup_tooltippositionArray[] =  { "NULL", "TopLeft", "TopCenter", "TopRight", "MiddleLeft", "MiddleCenter", "MiddleRight", "BottomLeft", "BottomCenter", "BottomRight" };
