...
static ezsignbulksendsignermapping_create_object_v1_response_t *ezsignbulksendsignermapping_create_object_v1_response_create_internal(
    ...
    memset(ezsignbulksendsignermapping_create_object_v1_response_local_var, 0, sizeof(ezsignbulksendsignermapping_create_object_v1_response_t));
...
__attribute__((deprecated)) ezsignbulksendsignermapping_create_object_v1_response_t *ezsignbulksendsignermapping_create_object_v1_response_create(
    ...
    ezsignbulksendsignermapping_create_object_v1_response_t *result = ezsignbulksendsignermapping_create_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
