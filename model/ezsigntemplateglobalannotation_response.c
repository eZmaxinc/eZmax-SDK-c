...
static ezsigntemplateglobalannotation_response_t *ezsigntemplateglobalannotation_response_create_internal(
    ...
    ezsigntemplateglobalannotation_response_local_var->fki_ezsigntemplateglobaldocumentpage_id = fki_ezsigntemplateglobaldocumentpage_id;
...
__attribute__((deprecated)) ezsigntemplateglobalannotation_response_t *ezsigntemplateglobalannotation_response_create(
    ...
    return ezsigntemplateglobalannotation_response_create_internal (
...
cJSON *ezsigntemplateglobalannotation_response_convertToJSON(ezsigntemplateglobalannotation_response_t *ezsigntemplateglobalannotation_response) {
    ...
    // ezsigntemplateglobalannotation_response->fki_ezsigntemplateglobaldocumentpage_id
    if (!ezsigntemplateglobalannotation_response->fki_ezsigntemplateglobaldocumentpage_id) {
        goto fail;
    }
    if(cJSON_AddNumberToObject(item, "fkiEzsigntemplateglobaldocumentpageID", ezsigntemplateglobalannotation_response->fki_ezsigntemplateglobaldocumentpage_id) == NULL) {
    goto fail; //Numeric
    }
...
ezsigntemplateglobalannotation_response_t *ezsigntemplateglobalannotation_response_parseFromJSON(cJSON *ezsigntemplateglobalannotation_responseJSON){
    ...
    // ezsigntemplateglobalannotation_response->fki_ezsigntemplateglobaldocumentpage_id
    cJSON *fki_ezsigntemplateglobaldocumentpage_id = cJSON_GetObjectItemCaseSensitive(ezsigntemplateglobalannotation_responseJSON, "fkiEzsigntemplateglobaldocumentpageID");
