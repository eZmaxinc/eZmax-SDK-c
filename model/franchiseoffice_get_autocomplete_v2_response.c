...
static franchiseoffice_get_autocomplete_v2_response_t *franchiseoffice_get_autocomplete_v2_response_create_internal(
    ...
    memset(franchiseoffice_get_autocomplete_v2_response_local_var, 0, sizeof(franchiseoffice_get_autocomplete_v2_response_t));
...
__attribute__((deprecated)) franchiseoffice_get_autocomplete_v2_response_t *franchiseoffice_get_autocomplete_v2_response_create(
    ...
    franchiseoffice_get_autocomplete_v2_response_t *result = franchiseoffice_get_autocomplete_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
