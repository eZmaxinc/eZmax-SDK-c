...
static ezsignsignature_sign_v1_response_t *ezsignsignature_sign_v1_response_create_internal(
    ...
    memset(ezsignsignature_sign_v1_response_local_var, 0, sizeof(ezsignsignature_sign_v1_response_t));
    ezsignsignature_sign_v1_response_local_var->_library_owned = 1;
    ...
    ezsignsignature_sign_v1_response_local_var->m_payload = m_payload;
...
__attribute__((deprecated)) ezsignsignature_sign_v1_response_t *ezsignsignature_sign_v1_response_create(
    ...
    ezsignsignature_sign_v1_response_t *result = ezsignsignature_sign_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void ezsignsignature_sign_v1_response_free(ezsignsignature_sign_v1_response_t *ezsignsignature_sign_v1_response) {
    ...
    if(ezsignsignature_sign_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsignsignature_sign_v1_response_free");
        return ;
    }
    ...
    if (ezsignsignature_sign_v1_response->m_payload) {
        ezsignsignature_sign_v1_response_m_payload_free(ezsignsignature_sign_v1_response->m_payload);
        ezsignsignature_sign_v1_response->m_payload = NULL;
    }
...
cJSON *ezsignsignature_sign_v1_response_convertToJSON(ezsignsignature_sign_v1_response_t *ezsignsignature_sign_v1_response) {
    ...
    // ezsignsignature_sign_v1_response->m_payload
    if (!ezsignsignature_sign_v1_response->m_payload) {
        goto fail;
    }
    cJSON *m_payload_local_JSON = ezsignsignature_sign_v1_response_m_payload_convertToJSON(ezsignsignature_sign_v1_response->m_payload);
...
ezsignsignature_sign_v1_response_t *ezsignsignature_sign_v1_response_parseFromJSON(cJSON *ezsignsignature_sign_v1_responseJSON){
    ...
    // define the local variable for ezsignsignature_sign_v1_response->m_payload
    ezsignsignature_sign_v1_response_m_payload_t *m_payload_local_nonprim = NULL;
    ...
    // ezsignsignature_sign_v1_response->m_payload
    cJSON *m_payload = cJSON_GetObjectItemCaseSensitive(ezsignsignature_sign_v1_responseJSON, "mPayload");
    ...
    m_payload_local_nonprim = ezsignsignature_sign_v1_response_m_payload_parseFromJSON(m_payload); //nonprimitive



    ezsignsignature_sign_v1_response_local_var = ezsignsignature_sign_v1_response_create_internal (
    ...
    if (m_payload_local_nonprim) {
        ezsignsignature_sign_v1_response_m_payload_free(m_payload_local_nonprim);
