...
static authenticationexternal_response_compound_t *authenticationexternal_response_compound_create_internal(
    ...
    memset(authenticationexternal_response_compound_local_var, 0, sizeof(authenticationexternal_response_compound_t));
...
__attribute__((deprecated)) authenticationexternal_response_compound_t *authenticationexternal_response_compound_create(
    ...
    authenticationexternal_response_compound_t *result = authenticationexternal_response_compound_create_internal (
...
void authenticationexternal_response_compound_free(authenticationexternal_response_compound_t *authenticationexternal_response_compound) {
    ...
    if (authenticationexternal_response_compound->pki_authenticationexternal_id) {
        free(authenticationexternal_response_compound->pki_authenticationexternal_id);
        authenticationexternal_response_compound->pki_authenticationexternal_id = NULL;
    }
    ...
    if (authenticationexternal_response_compound->b_authenticationexternal_connected) {
        free(authenticationexternal_response_compound->b_authenticationexternal_connected);
        authenticationexternal_response_compound->b_authenticationexternal_connected = NULL;
    }
...
authenticationexternal_response_compound_t *authenticationexternal_response_compound_parseFromJSON(cJSON *authenticationexternal_response_compoundJSON){
    ...
    // define the local variable for authenticationexternal_response_compound->pki_authenticationexternal_id
    ...
    // define the local variable for authenticationexternal_response_compound->b_authenticationexternal_connected
    int *b_authenticationexternal_connected_local_var = NULL;

    char *s_authenticationexternal_authorizationurl_local_str = NULL;
    ...
    *b_authenticationexternal_connected_local_var = b_authenticationexternal_connected->valueint;
    ...
    if (s_authenticationexternal_authorizationurl && !cJSON_IsNull(s_authenticationexternal_authorizationurl)) s_authenticationexternal_authorizationurl_local_str = strdup(s_authenticationexternal_authorizationurl->valuestring);
    ...
    authenticationexternal_response_compound_local_var = authenticationexternal_response_compound_create_internal (
        ...
        s_authenticationexternal_authorizationurl_local_str,
    ...
    if (s_authenticationexternal_authorizationurl_local_str) {
        free(s_authenticationexternal_authorizationurl_local_str);
        s_authenticationexternal_authorizationurl_local_str = NULL;
    }
