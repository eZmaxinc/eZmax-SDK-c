...
static timezone_get_autocomplete_v2_response_t *timezone_get_autocomplete_v2_response_create_internal(
    ...
    memset(timezone_get_autocomplete_v2_response_local_var, 0, sizeof(timezone_get_autocomplete_v2_response_t));
    timezone_get_autocomplete_v2_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) timezone_get_autocomplete_v2_response_t *timezone_get_autocomplete_v2_response_create(
    ...
    timezone_get_autocomplete_v2_response_t *result = timezone_get_autocomplete_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void timezone_get_autocomplete_v2_response_free(timezone_get_autocomplete_v2_response_t *timezone_get_autocomplete_v2_response) {
    ...
    if(timezone_get_autocomplete_v2_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "timezone_get_autocomplete_v2_response_free");
        return ;
    }
...
timezone_get_autocomplete_v2_response_t *timezone_get_autocomplete_v2_response_parseFromJSON(cJSON *timezone_get_autocomplete_v2_responseJSON){
    ...
    timezone_get_autocomplete_v2_response_local_var = timezone_get_autocomplete_v2_response_create_internal (
