/*
 * paymentmethod_get_autocomplete_v2_response_m_payload.h
 *
 * Payload for POST /2/object/paymentmethod/getAutocomplete
 */

#ifndef _paymentmethod_get_autocomplete_v2_response_m_payload_H_
#define _paymentmethod_get_autocomplete_v2_response_m_payload_H_
...
typedef struct paymentmethod_get_autocomplete_v2_response_m_payload_t paymentmethod_get_autocomplete_v2_response_m_payload_t;

#include "paymentmethod_autocomplete_element_response.h"



typedef struct paymentmethod_get_autocomplete_v2_response_m_payload_t {
    list_t *a_obj_paymentmethod; //nonprimitive container

    int _library_owned; // Is the library responsible for freeing this object?
} paymentmethod_get_autocomplete_v2_response_m_payload_t;
...
#endif /* _paymentmethod_get_autocomplete_v2_response_m_payload_H_ */
