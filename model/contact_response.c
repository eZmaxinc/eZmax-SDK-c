...
static contact_response_t *contact_response_create_internal(
    ...
    memset(contact_response_local_var, 0, sizeof(contact_response_t));
...
__attribute__((deprecated)) contact_response_t *contact_response_create(
    ...
    contact_response_t *result = contact_response_create_internal (
        pki_contact_id_copy,
...
void contact_response_free(contact_response_t *contact_response) {
    ...
    if (contact_response->pki_contact_id) {
        free(contact_response->pki_contact_id);
        contact_response->pki_contact_id = NULL;
    }
    if (contact_response->fki_language_id) {
        free(contact_response->fki_language_id);
        contact_response->fki_language_id = NULL;
    }
    if (contact_response->fki_contacttitle_id) {
        free(contact_response->fki_contacttitle_id);
        contact_response->fki_contacttitle_id = NULL;
    }
    if (contact_response->fki_contactinformations_id) {
        free(contact_response->fki_contactinformations_id);
        contact_response->fki_contactinformations_id = NULL;
    }
    ...
    if (contact_response->b_contact_isactive) {
        free(contact_response->b_contact_isactive);
        contact_response->b_contact_isactive = NULL;
    }
...
contact_response_t *contact_response_parseFromJSON(cJSON *contact_responseJSON){
    ...
    // define the local variable for contact_response->pki_contact_id
    int *pki_contact_id_local_var = NULL;

    // define the local variable for contact_response->fki_language_id
    int *fki_language_id_local_var = NULL;

    // define the local variable for contact_response->fki_contacttitle_id
    int *fki_contacttitle_id_local_var = NULL;

    // define the local variable for contact_response->fki_contactinformations_id
    ...
    // define the local variable for contact_response->b_contact_isactive
