/*
 * folder_get_communicationsenders_v1_response_m_payload.h
 *
 * Response for GET /1/object/folder/{pkiFolderID}/getCommunicationsenders
 */

#ifndef _folder_get_communicationsenders_v1_response_m_payload_H_
#define _folder_get_communicationsenders_v1_response_m_payload_H_
...
typedef struct folder_get_communicationsenders_v1_response_m_payload_t folder_get_communicationsenders_v1_response_m_payload_t;

#include "custom_communicationsender_response.h"



typedef struct folder_get_communicationsenders_v1_response_m_payload_t {
    list_t *a_obj_communicationsenders; //nonprimitive container

    int _library_owned; // Is the library responsible for freeing this object?
} folder_get_communicationsenders_v1_response_m_payload_t;
...
#endif /* _folder_get_communicationsenders_v1_response_m_payload_H_ */
