...
static supply_delete_object_v1_response_t *supply_delete_object_v1_response_create_internal(
    ...
    memset(supply_delete_object_v1_response_local_var, 0, sizeof(supply_delete_object_v1_response_t));
    supply_delete_object_v1_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) supply_delete_object_v1_response_t *supply_delete_object_v1_response_create(
    ...
    supply_delete_object_v1_response_t *result = supply_delete_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug
        );
    if (!result) {
...
void supply_delete_object_v1_response_free(supply_delete_object_v1_response_t *supply_delete_object_v1_response) {
    ...
    if(supply_delete_object_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "supply_delete_object_v1_response_free");
        return ;
    }
...
supply_delete_object_v1_response_t *supply_delete_object_v1_response_parseFromJSON(cJSON *supply_delete_object_v1_responseJSON){
    ...
    supply_delete_object_v1_response_local_var = supply_delete_object_v1_response_create_internal (
