...
typedef enum  { ezmax_api_definition__full_user_request_v2__NULL = 0, ezmax_api_definition__full_user_request_v2__AgentBroker, ezmax_api_definition__full_user_request_v2__Assistant, ezmax_api_definition__full_user_request_v2__Employee, ezmax_api_definition__full_user_request_v2__EzsignUser, ezmax_api_definition__full_user_request_v2__Normal } ezmax_api_definition__full_user_request_v2__e;
...
typedef enum  { ezmax_api_definition__full_user_request_v2__NULL = 0, ezmax_api_definition__full_user_request_v2__Password, ezmax_api_definition__full_user_request_v2__PasswordPhone, ezmax_api_definition__full_user_request_v2__PasswordQuestion } ezmax_api_definition__full_user_request_v2__e;
...
typedef enum  { ezmax_api_definition__full_user_request_v2__NULL = 0, ezmax_api_definition__full_user_request_v2__No, ezmax_api_definition__full_user_request_v2__PaidByOffice, ezmax_api_definition__full_user_request_v2__PerDocument, ezmax_api_definition__full_user_request_v2__Prepaid } ezmax_api_definition__full_user_request_v2__e;
