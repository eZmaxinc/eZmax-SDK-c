...
static ezdoctemplatedocument_get_object_v2_response_t *ezdoctemplatedocument_get_object_v2_response_create_internal(
    ...
    memset(ezdoctemplatedocument_get_object_v2_response_local_var, 0, sizeof(ezdoctemplatedocument_get_object_v2_response_t));
...
__attribute__((deprecated)) ezdoctemplatedocument_get_object_v2_response_t *ezdoctemplatedocument_get_object_v2_response_create(
    ...
    ezdoctemplatedocument_get_object_v2_response_t *result = ezdoctemplatedocument_get_object_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
