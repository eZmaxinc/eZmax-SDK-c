/*
 * otherincome_get_attachments_v1_response_m_payload.h
 *
 * Response for GET /1/object/otherincome/{pkiOtherincomeID}/getAttachments
 */

#ifndef _otherincome_get_attachments_v1_response_m_payload_H_
#define _otherincome_get_attachments_v1_response_m_payload_H_
...
typedef struct otherincome_get_attachments_v1_response_m_payload_t otherincome_get_attachments_v1_response_m_payload_t;

#include "custom_attachmentdocumenttype_response.h"



typedef struct otherincome_get_attachments_v1_response_m_payload_t {
    list_t *a_obj_attachmentdocumenttype; //nonprimitive container

    int _library_owned; // Is the library responsible for freeing this object?
} otherincome_get_attachments_v1_response_m_payload_t;
...
#endif /* _otherincome_get_attachments_v1_response_m_payload_H_ */
