...
static ezsigntemplatepackagesigner_create_object_v1_response_t *ezsigntemplatepackagesigner_create_object_v1_response_create_internal(
    ...
    memset(ezsigntemplatepackagesigner_create_object_v1_response_local_var, 0, sizeof(ezsigntemplatepackagesigner_create_object_v1_response_t));
    ezsigntemplatepackagesigner_create_object_v1_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezsigntemplatepackagesigner_create_object_v1_response_t *ezsigntemplatepackagesigner_create_object_v1_response_create(
    ...
    ezsigntemplatepackagesigner_create_object_v1_response_t *result = ezsigntemplatepackagesigner_create_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void ezsigntemplatepackagesigner_create_object_v1_response_free(ezsigntemplatepackagesigner_create_object_v1_response_t *ezsigntemplatepackagesigner_create_object_v1_response) {
    ...
    if(ezsigntemplatepackagesigner_create_object_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsigntemplatepackagesigner_create_object_v1_response_free");
        return ;
    }
...
ezsigntemplatepackagesigner_create_object_v1_response_t *ezsigntemplatepackagesigner_create_object_v1_response_parseFromJSON(cJSON *ezsigntemplatepackagesigner_create_object_v1_responseJSON){
    ...
    ezsigntemplatepackagesigner_create_object_v1_response_local_var = ezsigntemplatepackagesigner_create_object_v1_response_create_internal (
