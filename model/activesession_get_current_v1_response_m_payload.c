...
static activesession_get_current_v1_response_m_payload_t *activesession_get_current_v1_response_m_payload_create_internal(
    ...
    memset(activesession_get_current_v1_response_m_payload_local_var, 0, sizeof(activesession_get_current_v1_response_m_payload_t));
    ...
    activesession_get_current_v1_response_m_payload_local_var->b_user_ezsigntemplaterolegrouping = b_user_ezsigntemplaterolegrouping;
    ...
    activesession_get_current_v1_response_m_payload_local_var->dt_user_npsrequest = dt_user_npsrequest;
    ...
    activesession_get_current_v1_response_m_payload_local_var->b_activesession_maillinglistrequest = b_activesession_maillinglistrequest;
...
__attribute__((deprecated)) activesession_get_current_v1_response_m_payload_t *activesession_get_current_v1_response_m_payload_create(
    ...
    activesession_get_current_v1_response_m_payload_t *result = activesession_get_current_v1_response_m_payload_create_internal (
...
void activesession_get_current_v1_response_m_payload_free(activesession_get_current_v1_response_m_payload_t *activesession_get_current_v1_response_m_payload) {
    ...
    if (activesession_get_current_v1_response_m_payload->fki_language_id) {
        free(activesession_get_current_v1_response_m_payload->fki_language_id);
        activesession_get_current_v1_response_m_payload->fki_language_id = NULL;
    }
    ...
    if (activesession_get_current_v1_response_m_payload->b_activesession_debug) {
        free(activesession_get_current_v1_response_m_payload->b_activesession_debug);
        activesession_get_current_v1_response_m_payload->b_activesession_debug = NULL;
    }
    if (activesession_get_current_v1_response_m_payload->b_activesession_issuperadmin) {
        free(activesession_get_current_v1_response_m_payload->b_activesession_issuperadmin);
        activesession_get_current_v1_response_m_payload->b_activesession_issuperadmin = NULL;
    }
    if (activesession_get_current_v1_response_m_payload->b_activesession_attachment) {
        free(activesession_get_current_v1_response_m_payload->b_activesession_attachment);
        activesession_get_current_v1_response_m_payload->b_activesession_attachment = NULL;
    }
    if (activesession_get_current_v1_response_m_payload->b_activesession_canafe) {
        free(activesession_get_current_v1_response_m_payload->b_activesession_canafe);
        activesession_get_current_v1_response_m_payload->b_activesession_canafe = NULL;
    }
    if (activesession_get_current_v1_response_m_payload->b_activesession_financial) {
        free(activesession_get_current_v1_response_m_payload->b_activesession_financial);
        activesession_get_current_v1_response_m_payload->b_activesession_financial = NULL;
    }
    if (activesession_get_current_v1_response_m_payload->b_activesession_realestatecompleted) {
        free(activesession_get_current_v1_response_m_payload->b_activesession_realestatecompleted);
        activesession_get_current_v1_response_m_payload->b_activesession_realestatecompleted = NULL;
    }
    ...
    if (activesession_get_current_v1_response_m_payload->fki_systemconfigurationtype_id) {
        free(activesession_get_current_v1_response_m_payload->fki_systemconfigurationtype_id);
        activesession_get_current_v1_response_m_payload->fki_systemconfigurationtype_id = NULL;
    }
    if (activesession_get_current_v1_response_m_payload->fki_signature_id) {
        free(activesession_get_current_v1_response_m_payload->fki_signature_id);
        activesession_get_current_v1_response_m_payload->fki_signature_id = NULL;
    }
    if (activesession_get_current_v1_response_m_payload->fki_ezsignuser_id) {
        free(activesession_get_current_v1_response_m_payload->fki_ezsignuser_id);
        activesession_get_current_v1_response_m_payload->fki_ezsignuser_id = NULL;
    }
    if (activesession_get_current_v1_response_m_payload->b_systemconfiguration_ezsignpaidbyoffice) {
        free(activesession_get_current_v1_response_m_payload->b_systemconfiguration_ezsignpaidbyoffice);
        activesession_get_current_v1_response_m_payload->b_systemconfiguration_ezsignpaidbyoffice = NULL;
    }
    if (activesession_get_current_v1_response_m_payload->b_user_ezsigntrial) {
        free(activesession_get_current_v1_response_m_payload->b_user_ezsigntrial);
        activesession_get_current_v1_response_m_payload->b_user_ezsigntrial = NULL;
    }
    if (activesession_get_current_v1_response_m_payload->b_user_ezsigntemplaterolegrouping) {
        free(activesession_get_current_v1_response_m_payload->b_user_ezsigntemplaterolegrouping);
        activesession_get_current_v1_response_m_payload->b_user_ezsigntemplaterolegrouping = NULL;
    }
    ...
    if (activesession_get_current_v1_response_m_payload->dt_user_npsrequest) {
        free(activesession_get_current_v1_response_m_payload->dt_user_npsrequest);
        activesession_get_current_v1_response_m_payload->dt_user_npsrequest = NULL;
    }
    ...
    if (activesession_get_current_v1_response_m_payload->b_activesession_maillinglistrequest) {
        free(activesession_get_current_v1_response_m_payload->b_activesession_maillinglistrequest);
        activesession_get_current_v1_response_m_payload->b_activesession_maillinglistrequest = NULL;
    }
...
cJSON *activesession_get_current_v1_response_m_payload_convertToJSON(activesession_get_current_v1_response_m_payload_t *activesession_get_current_v1_response_m_payload) {
    ...
    // activesession_get_current_v1_response_m_payload->b_user_ezsigntemplaterolegrouping
    if(activesession_get_current_v1_response_m_payload->b_user_ezsigntemplaterolegrouping) {
    if(cJSON_AddBoolToObject(item, "bUserEzsigntemplaterolegrouping", *activesession_get_current_v1_response_m_payload->b_user_ezsigntemplaterolegrouping) == NULL) {
    goto fail; //Bool
    }
    }
    ...
    // activesession_get_current_v1_response_m_payload->dt_user_npsrequest
    if(activesession_get_current_v1_response_m_payload->dt_user_npsrequest) {
    if(cJSON_AddStringToObject(item, "dtUserNpsrequest", activesession_get_current_v1_response_m_payload->dt_user_npsrequest) == NULL) {
    goto fail; //String
    }
    }
    ...
    // activesession_get_current_v1_response_m_payload->b_activesession_maillinglistrequest
    if(activesession_get_current_v1_response_m_payload->b_activesession_maillinglistrequest) {
    if(cJSON_AddBoolToObject(item, "bActivesessionMaillinglistrequest", *activesession_get_current_v1_response_m_payload->b_activesession_maillinglistrequest) == NULL) {
    goto fail; //Bool
    }
    }
...
activesession_get_current_v1_response_m_payload_t *activesession_get_current_v1_response_m_payload_parseFromJSON(cJSON *activesession_get_current_v1_response_m_payloadJSON){
    ...
    // define the local variable for activesession_get_current_v1_response_m_payload->fki_language_id
    ...
    // define the local variable for activesession_get_current_v1_response_m_payload->b_activesession_debug
    int *b_activesession_debug_local_var = NULL;

    // define the local variable for activesession_get_current_v1_response_m_payload->b_activesession_issuperadmin
    int *b_activesession_issuperadmin_local_var = NULL;

    // define the local variable for activesession_get_current_v1_response_m_payload->b_activesession_attachment
    int *b_activesession_attachment_local_var = NULL;

    // define the local variable for activesession_get_current_v1_response_m_payload->b_activesession_canafe
    int *b_activesession_canafe_local_var = NULL;

    // define the local variable for activesession_get_current_v1_response_m_payload->b_activesession_financial
    int *b_activesession_financial_local_var = NULL;

    // define the local variable for activesession_get_current_v1_response_m_payload->b_activesession_realestatecompleted
    ...
    // define the local variable for activesession_get_current_v1_response_m_payload->fki_systemconfigurationtype_id
    int *fki_systemconfigurationtype_id_local_var = NULL;

    // define the local variable for activesession_get_current_v1_response_m_payload->fki_signature_id
    int *fki_signature_id_local_var = NULL;

    // define the local variable for activesession_get_current_v1_response_m_payload->fki_ezsignuser_id
    int *fki_ezsignuser_id_local_var = NULL;

    // define the local variable for activesession_get_current_v1_response_m_payload->b_systemconfiguration_ezsignpaidbyoffice
    ...
    // define the local variable for activesession_get_current_v1_response_m_payload->b_user_ezsigntrial
    int *b_user_ezsigntrial_local_var = NULL;

    // define the local variable for activesession_get_current_v1_response_m_payload->b_user_ezsigntemplaterolegrouping
    ...
    // define the local variable for activesession_get_current_v1_response_m_payload->b_activesession_maillinglistrequest
    ...
    *b_user_ezsigntrial_local_var = b_user_ezsigntrial->valueint;
    ...
    // activesession_get_current_v1_response_m_payload->b_user_ezsigntemplaterolegrouping
    cJSON *b_user_ezsigntemplaterolegrouping = cJSON_GetObjectItemCaseSensitive(activesession_get_current_v1_response_m_payloadJSON, "bUserEzsigntemplaterolegrouping");
    ...
    *b_user_ezsigntemplaterolegrouping_local_var = b_user_ezsigntemplaterolegrouping->valueint;
    ...
    // activesession_get_current_v1_response_m_payload->dt_user_npsrequest
    cJSON *dt_user_npsrequest = cJSON_GetObjectItemCaseSensitive(activesession_get_current_v1_response_m_payloadJSON, "dtUserNpsrequest");
    ...
    // activesession_get_current_v1_response_m_payload->b_activesession_maillinglistrequest
    cJSON *b_activesession_maillinglistrequest = cJSON_GetObjectItemCaseSensitive(activesession_get_current_v1_response_m_payloadJSON, "bActivesessionMaillinglistrequest");
