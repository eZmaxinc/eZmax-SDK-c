...
static ezsigndocument_edit_ezsignannotations_v1_response_t *ezsigndocument_edit_ezsignannotations_v1_response_create_internal(
    ...
    memset(ezsigndocument_edit_ezsignannotations_v1_response_local_var, 0, sizeof(ezsigndocument_edit_ezsignannotations_v1_response_t));
    ezsigndocument_edit_ezsignannotations_v1_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezsigndocument_edit_ezsignannotations_v1_response_t *ezsigndocument_edit_ezsignannotations_v1_response_create(
    common_response_obj_debug_payload_t *obj_debug_payload,
    common_response_obj_debug_t *obj_debug,
    ezsigndocument_edit_ezsignannotations_v1_response_m_payload_t *m_payload
    ) {
    ezsigndocument_edit_ezsignannotations_v1_response_t *result = ezsigndocument_edit_ezsignannotations_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void ezsigndocument_edit_ezsignannotations_v1_response_free(ezsigndocument_edit_ezsignannotations_v1_response_t *ezsigndocument_edit_ezsignannotations_v1_response) {
    ...
    if(ezsigndocument_edit_ezsignannotations_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsigndocument_edit_ezsignannotations_v1_response_free");
        return ;
    }
...
ezsigndocument_edit_ezsignannotations_v1_response_t *ezsigndocument_edit_ezsignannotations_v1_response_parseFromJSON(cJSON *ezsigndocument_edit_ezsignannotations_v1_responseJSON){
    ...
    ezsigndocument_edit_ezsignannotations_v1_response_local_var = ezsigndocument_edit_ezsignannotations_v1_response_create_internal (
