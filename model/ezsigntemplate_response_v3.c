...
void ezsigntemplate_response_v3_free(ezsigntemplate_response_v3_t *ezsigntemplate_response_v3) {
    ...
    if (ezsigntemplate_response_v3->e_ezsigntemplate_recognition) {
        field_e_ezsigntemplate_recognition_free(ezsigntemplate_response_v3->e_ezsigntemplate_recognition);
        ezsigntemplate_response_v3->e_ezsigntemplate_recognition = NULL;
    }
    ...
    if (ezsigntemplate_response_v3->e_ezsigntemplate_type) {
        field_e_ezsigntemplate_type_free(ezsigntemplate_response_v3->e_ezsigntemplate_type);
        ezsigntemplate_response_v3->e_ezsigntemplate_type = NULL;
    }
...
cJSON *ezsigntemplate_response_v3_convertToJSON(ezsigntemplate_response_v3_t *ezsigntemplate_response_v3) {
    ...
    if(ezsigntemplate_response_v3->e_ezsigntemplate_recognition != ezmax_api_definition__full_ezsigntemplate_response_v3__NULL) {
    ...
    if(ezsigntemplate_response_v3->e_ezsigntemplate_type != ezmax_api_definition__full_ezsigntemplate_response_v3__NULL) {
...
ezsigntemplate_response_v3_t *ezsigntemplate_response_v3_parseFromJSON(cJSON *ezsigntemplate_response_v3JSON){
    ...
    ezsigntemplate_response_v3_local_var = ezsigntemplate_response_v3_create (
