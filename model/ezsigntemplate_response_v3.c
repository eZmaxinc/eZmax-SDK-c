...
static ezsigntemplate_response_v3_t *ezsigntemplate_response_v3_create_internal(
    ...
    memset(ezsigntemplate_response_v3_local_var, 0, sizeof(ezsigntemplate_response_v3_t));
    ...
    ezsigntemplate_response_v3_local_var->obj_ezsignfoldertype = obj_ezsignfoldertype;
...
__attribute__((deprecated)) ezsigntemplate_response_v3_t *ezsigntemplate_response_v3_create(
    ...
    ezsigntemplate_response_v3_t *result = ezsigntemplate_response_v3_create_internal (
...
void ezsigntemplate_response_v3_free(ezsigntemplate_response_v3_t *ezsigntemplate_response_v3) {
    ...
    if (ezsigntemplate_response_v3->pki_ezsigntemplate_id) {
        free(ezsigntemplate_response_v3->pki_ezsigntemplate_id);
        ezsigntemplate_response_v3->pki_ezsigntemplate_id = NULL;
    }
    if (ezsigntemplate_response_v3->fki_ezsigntemplatedocument_id) {
        free(ezsigntemplate_response_v3->fki_ezsigntemplatedocument_id);
        ezsigntemplate_response_v3->fki_ezsigntemplatedocument_id = NULL;
    }
    if (ezsigntemplate_response_v3->fki_ezsignfoldertype_id) {
        free(ezsigntemplate_response_v3->fki_ezsignfoldertype_id);
        ezsigntemplate_response_v3->fki_ezsignfoldertype_id = NULL;
    }
    if (ezsigntemplate_response_v3->obj_ezsignfoldertype) {
        custom_ezsignfoldertype_template_response_free(ezsigntemplate_response_v3->obj_ezsignfoldertype);
        ezsigntemplate_response_v3->obj_ezsignfoldertype = NULL;
    }
    if (ezsigntemplate_response_v3->fki_language_id) {
        free(ezsigntemplate_response_v3->fki_language_id);
        ezsigntemplate_response_v3->fki_language_id = NULL;
    }
    if (ezsigntemplate_response_v3->fki_ezdoctemplatedocument_id) {
        free(ezsigntemplate_response_v3->fki_ezdoctemplatedocument_id);
        ezsigntemplate_response_v3->fki_ezdoctemplatedocument_id = NULL;
    }
    ...
    if (ezsigntemplate_response_v3->b_ezsigntemplate_adminonly) {
        free(ezsigntemplate_response_v3->b_ezsigntemplate_adminonly);
        ezsigntemplate_response_v3->b_ezsigntemplate_adminonly = NULL;
    }
    ...
    if (ezsigntemplate_response_v3->b_ezsigntemplate_editallowed) {
        free(ezsigntemplate_response_v3->b_ezsigntemplate_editallowed);
        ezsigntemplate_response_v3->b_ezsigntemplate_editallowed = NULL;
    }
...
cJSON *ezsigntemplate_response_v3_convertToJSON(ezsigntemplate_response_v3_t *ezsigntemplate_response_v3) {
    ...
    // ezsigntemplate_response_v3->obj_ezsignfoldertype
    if(ezsigntemplate_response_v3->obj_ezsignfoldertype) {
    cJSON *obj_ezsignfoldertype_local_JSON = custom_ezsignfoldertype_template_response_convertToJSON(ezsigntemplate_response_v3->obj_ezsignfoldertype);
...
ezsigntemplate_response_v3_t *ezsigntemplate_response_v3_parseFromJSON(cJSON *ezsigntemplate_response_v3JSON){
    ...
    // define the local variable for ezsigntemplate_response_v3->pki_ezsigntemplate_id
    int *pki_ezsigntemplate_id_local_var = NULL;

    // define the local variable for ezsigntemplate_response_v3->fki_ezsigntemplatedocument_id
    int *fki_ezsigntemplatedocument_id_local_var = NULL;

    // define the local variable for ezsigntemplate_response_v3->fki_ezsignfoldertype_id
    int *fki_ezsignfoldertype_id_local_var = NULL;

    // define the local variable for ezsigntemplate_response_v3->obj_ezsignfoldertype
    custom_ezsignfoldertype_template_response_t *obj_ezsignfoldertype_local_nonprim = NULL;

    // define the local variable for ezsigntemplate_response_v3->fki_language_id
    int *fki_language_id_local_var = NULL;

    // define the local variable for ezsigntemplate_response_v3->fki_ezdoctemplatedocument_id
    ...
    // define the local variable for ezsigntemplate_response_v3->b_ezsigntemplate_adminonly
    ...
    // define the local variable for ezsigntemplate_response_v3->b_ezsigntemplate_editallowed
    ...
    *fki_ezsignfoldertype_id_local_var = fki_ezsignfoldertype_id->valuedouble;
    ...
    // ezsigntemplate_response_v3->obj_ezsignfoldertype
    cJSON *obj_ezsignfoldertype = cJSON_GetObjectItemCaseSensitive(ezsigntemplate_response_v3JSON, "objEzsignfoldertype");
