...
char* e_variableexpense_taxablevariableexpense_response_ToString(ezmax_api_definition__full_variableexpense_response__e e_variableexpense_taxable) {
    char* e_variableexpense_taxableArray[] =  { "NULL", "Yes", "No", "Included" };
    return e_variableexpense_taxableArray[e_variableexpense_taxable];
}

ezmax_api_definition__full_variableexpense_response__e e_variableexpense_taxablevariableexpense_response_FromString(char* e_variableexpense_taxable){
...
void variableexpense_response_free(variableexpense_response_t *variableexpense_response) {
    ...
    if (variableexpense_response->e_variableexpense_taxable) {
        field_e_variableexpense_taxable_free(variableexpense_response->e_variableexpense_taxable);
        variableexpense_response->e_variableexpense_taxable = NULL;
    }
...
cJSON *variableexpense_response_convertToJSON(variableexpense_response_t *variableexpense_response) {
    ...
    if(variableexpense_response->e_variableexpense_taxable != ezmax_api_definition__full_variableexpense_response__NULL) {
...
variableexpense_response_t *variableexpense_response_parseFromJSON(cJSON *variableexpense_responseJSON){
    ...
    variableexpense_response_local_var = variableexpense_response_create (
