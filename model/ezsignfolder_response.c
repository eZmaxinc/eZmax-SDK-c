...
void ezsignfolder_response_free(ezsignfolder_response_t *ezsignfolder_response) {
    ...
    if (ezsignfolder_response->obj_ezsignfoldertype) {
        object_free(ezsignfolder_response->obj_ezsignfoldertype);
...
cJSON *ezsignfolder_response_convertToJSON(ezsignfolder_response_t *ezsignfolder_response) {
    ...
    if(ezsignfolder_response->obj_ezsignfoldertype) {
    cJSON *obj_ezsignfoldertype_local_JSON = object_convertToJSON(ezsignfolder_response->obj_ezsignfoldertype);
    ...
    if (ezmax_api_definition__full_ezsignfolder_response__NULL == ezsignfolder_response->e_ezsignfolder_completion) {
        goto fail;
    }
