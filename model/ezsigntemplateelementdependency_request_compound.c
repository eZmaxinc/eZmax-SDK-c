...
static ezsigntemplateelementdependency_request_compound_t *ezsigntemplateelementdependency_request_compound_create_internal(
    ...
    memset(ezsigntemplateelementdependency_request_compound_local_var, 0, sizeof(ezsigntemplateelementdependency_request_compound_t));
...
__attribute__((deprecated)) ezsigntemplateelementdependency_request_compound_t *ezsigntemplateelementdependency_request_compound_create(
    ...
    ezsigntemplateelementdependency_request_compound_t *result = ezsigntemplateelementdependency_request_compound_create_internal (
...
void ezsigntemplateelementdependency_request_compound_free(ezsigntemplateelementdependency_request_compound_t *ezsigntemplateelementdependency_request_compound) {
    ...
    if (ezsigntemplateelementdependency_request_compound->pki_ezsigntemplateelementdependency_id) {
        free(ezsigntemplateelementdependency_request_compound->pki_ezsigntemplateelementdependency_id);
        ezsigntemplateelementdependency_request_compound->pki_ezsigntemplateelementdependency_id = NULL;
    }
    if (ezsigntemplateelementdependency_request_compound->fki_ezsigntemplateformfield_id_validation) {
        free(ezsigntemplateelementdependency_request_compound->fki_ezsigntemplateformfield_id_validation);
        ezsigntemplateelementdependency_request_compound->fki_ezsigntemplateformfield_id_validation = NULL;
    }
    if (ezsigntemplateelementdependency_request_compound->fki_ezsigntemplateformfieldgroup_id_validation) {
        free(ezsigntemplateelementdependency_request_compound->fki_ezsigntemplateformfieldgroup_id_validation);
        ezsigntemplateelementdependency_request_compound->fki_ezsigntemplateformfieldgroup_id_validation = NULL;
    }
    ...
    if (ezsigntemplateelementdependency_request_compound->b_ezsigntemplateelementdependency_selected) {
        free(ezsigntemplateelementdependency_request_compound->b_ezsigntemplateelementdependency_selected);
        ezsigntemplateelementdependency_request_compound->b_ezsigntemplateelementdependency_selected = NULL;
    }
...
ezsigntemplateelementdependency_request_compound_t *ezsigntemplateelementdependency_request_compound_parseFromJSON(cJSON *ezsigntemplateelementdependency_request_compoundJSON){
    ...
    // define the local variable for ezsigntemplateelementdependency_request_compound->pki_ezsigntemplateelementdependency_id
    int *pki_ezsigntemplateelementdependency_id_local_var = NULL;

    // define the local variable for ezsigntemplateelementdependency_request_compound->fki_ezsigntemplateformfield_id_validation
    int *fki_ezsigntemplateformfield_id_validation_local_var = NULL;

    // define the local variable for ezsigntemplateelementdependency_request_compound->fki_ezsigntemplateformfieldgroup_id_validation
    int *fki_ezsigntemplateformfieldgroup_id_validation_local_var = NULL;

    char *s_ezsigntemplateelementdependency_ezsigntemplateformfieldgrouplabel_local_str = NULL;

    char *s_ezsigntemplateelementdependency_ezsigntemplateformfieldlabel_local_str = NULL;
    ...
    // define the local variable for ezsigntemplateelementdependency_request_compound->b_ezsigntemplateelementdependency_selected
    ...
    *b_ezsigntemplateelementdependency_selected_local_var = b_ezsigntemplateelementdependency_selected->valueint;
    ...
    if (s_ezsigntemplateelementdependency_ezsigntemplateformfieldgrouplabel && !cJSON_IsNull(s_ezsigntemplateelementdependency_ezsigntemplateformfieldgrouplabel)) s_ezsigntemplateelementdependency_ezsigntemplateformfieldgrouplabel_local_str = strdup(s_ezsigntemplateelementdependency_ezsigntemplateformfieldgrouplabel->valuestring);
    if (s_ezsigntemplateelementdependency_ezsigntemplateformfieldlabel && !cJSON_IsNull(s_ezsigntemplateelementdependency_ezsigntemplateformfieldlabel)) s_ezsigntemplateelementdependency_ezsigntemplateformfieldlabel_local_str = strdup(s_ezsigntemplateelementdependency_ezsigntemplateformfieldlabel->valuestring);
    ...
    ezsigntemplateelementdependency_request_compound_local_var = ezsigntemplateelementdependency_request_compound_create_internal (
        ...
        s_ezsigntemplateelementdependency_ezsigntemplateformfieldgrouplabel_local_str,
        s_ezsigntemplateelementdependency_ezsigntemplateformfieldlabel_local_str,
    ...
    if (s_ezsigntemplateelementdependency_ezsigntemplateformfieldgrouplabel_local_str) {
        free(s_ezsigntemplateelementdependency_ezsigntemplateformfieldgrouplabel_local_str);
        s_ezsigntemplateelementdependency_ezsigntemplateformfieldgrouplabel_local_str = NULL;
    }
    if (s_ezsigntemplateelementdependency_ezsigntemplateformfieldlabel_local_str) {
        free(s_ezsigntemplateelementdependency_ezsigntemplateformfieldlabel_local_str);
        s_ezsigntemplateelementdependency_ezsigntemplateformfieldlabel_local_str = NULL;
    }
