...
static subnet_get_object_v2_response_t *subnet_get_object_v2_response_create_internal(
    ...
    memset(subnet_get_object_v2_response_local_var, 0, sizeof(subnet_get_object_v2_response_t));
    subnet_get_object_v2_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) subnet_get_object_v2_response_t *subnet_get_object_v2_response_create(
    ...
    subnet_get_object_v2_response_t *result = subnet_get_object_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void subnet_get_object_v2_response_free(subnet_get_object_v2_response_t *subnet_get_object_v2_response) {
    ...
    if(subnet_get_object_v2_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "subnet_get_object_v2_response_free");
        return ;
    }
...
subnet_get_object_v2_response_t *subnet_get_object_v2_response_parseFromJSON(cJSON *subnet_get_object_v2_responseJSON){
    ...
    subnet_get_object_v2_response_local_var = subnet_get_object_v2_response_create_internal (
