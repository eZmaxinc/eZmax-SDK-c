...
static ezsignsignergroupmembership_request_compound_t *ezsignsignergroupmembership_request_compound_create_internal(
    ...
    memset(ezsignsignergroupmembership_request_compound_local_var, 0, sizeof(ezsignsignergroupmembership_request_compound_t));
...
__attribute__((deprecated)) ezsignsignergroupmembership_request_compound_t *ezsignsignergroupmembership_request_compound_create(
    ...
    ezsignsignergroupmembership_request_compound_t *result = ezsignsignergroupmembership_request_compound_create_internal (
...
void ezsignsignergroupmembership_request_compound_free(ezsignsignergroupmembership_request_compound_t *ezsignsignergroupmembership_request_compound) {
    ...
    if (ezsignsignergroupmembership_request_compound->pki_ezsignsignergroupmembership_id) {
        free(ezsignsignergroupmembership_request_compound->pki_ezsignsignergroupmembership_id);
        ezsignsignergroupmembership_request_compound->pki_ezsignsignergroupmembership_id = NULL;
    }
    if (ezsignsignergroupmembership_request_compound->fki_ezsignsignergroup_id) {
        free(ezsignsignergroupmembership_request_compound->fki_ezsignsignergroup_id);
        ezsignsignergroupmembership_request_compound->fki_ezsignsignergroup_id = NULL;
    }
    if (ezsignsignergroupmembership_request_compound->fki_ezsignsigner_id) {
        free(ezsignsignergroupmembership_request_compound->fki_ezsignsigner_id);
        ezsignsignergroupmembership_request_compound->fki_ezsignsigner_id = NULL;
    }
    if (ezsignsignergroupmembership_request_compound->fki_user_id) {
        free(ezsignsignergroupmembership_request_compound->fki_user_id);
        ezsignsignergroupmembership_request_compound->fki_user_id = NULL;
    }
    if (ezsignsignergroupmembership_request_compound->fki_usergroup_id) {
        free(ezsignsignergroupmembership_request_compound->fki_usergroup_id);
        ezsignsignergroupmembership_request_compound->fki_usergroup_id = NULL;
    }
...
ezsignsignergroupmembership_request_compound_t *ezsignsignergroupmembership_request_compound_parseFromJSON(cJSON *ezsignsignergroupmembership_request_compoundJSON){
    ...
    // define the local variable for ezsignsignergroupmembership_request_compound->pki_ezsignsignergroupmembership_id
    int *pki_ezsignsignergroupmembership_id_local_var = NULL;

    // define the local variable for ezsignsignergroupmembership_request_compound->fki_ezsignsignergroup_id
    int *fki_ezsignsignergroup_id_local_var = NULL;

    // define the local variable for ezsignsignergroupmembership_request_compound->fki_ezsignsigner_id
    int *fki_ezsignsigner_id_local_var = NULL;

    // define the local variable for ezsignsignergroupmembership_request_compound->fki_user_id
    int *fki_user_id_local_var = NULL;

    // define the local variable for ezsignsignergroupmembership_request_compound->fki_usergroup_id
