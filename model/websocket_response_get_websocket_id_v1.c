...
#include <string.h>
#include <stdio.h>
#include "websocket_response_get_websocket_id_v1.h"


char* websocket_response_get_websocket_id_v1_e_websocket_messagetype_ToString(ezmax_api_definition__full_websocket_response_get_websocket_id_v1_EWEBSOCKETMESSAGETYPE_e e_websocket_messagetype) {
...
ezmax_api_definition__full_websocket_response_get_websocket_id_v1_EWEBSOCKETMESSAGETYPE_e websocket_response_get_websocket_id_v1_e_websocket_messagetype_FromString(char* e_websocket_messagetype){
...
websocket_response_get_websocket_id_v1_t *websocket_response_get_websocket_id_v1_create(
    ...
    websocket_response_get_websocket_id_v1_t *websocket_response_get_websocket_id_v1_local_var = malloc(sizeof(websocket_response_get_websocket_id_v1_t));
...
void websocket_response_get_websocket_id_v1_free(websocket_response_get_websocket_id_v1_t *websocket_response_get_websocket_id_v1) {
    ...
    if (websocket_response_get_websocket_id_v1->m_payload) {
        websocket_response_get_websocket_id_v1_m_payload_free(websocket_response_get_websocket_id_v1->m_payload);
        websocket_response_get_websocket_id_v1->m_payload = NULL;
    }
    free(websocket_response_get_websocket_id_v1);
}

cJSON *websocket_response_get_websocket_id_v1_convertToJSON(websocket_response_get_websocket_id_v1_t *websocket_response_get_websocket_id_v1) {
    ...
    cJSON *m_payload_local_JSON = websocket_response_get_websocket_id_v1_m_payload_convertToJSON(websocket_response_get_websocket_id_v1->m_payload);
...
websocket_response_get_websocket_id_v1_t *websocket_response_get_websocket_id_v1_parseFromJSON(cJSON *websocket_response_get_websocket_id_v1JSON){

    websocket_response_get_websocket_id_v1_t *websocket_response_get_websocket_id_v1_local_var = NULL;

    // define the local variable for websocket_response_get_websocket_id_v1->m_payload
    websocket_response_get_websocket_id_v1_m_payload_t *m_payload_local_nonprim = NULL;
    ...
    ezmax_api_definition__full_websocket_response_get_websocket_id_v1_EWEBSOCKETMESSAGETYPE_e e_websocket_messagetypeVariable;
    
    if(!cJSON_IsString(e_websocket_messagetype))
    {
    goto end; //Enum
    }
    e_websocket_messagetypeVariable = websocket_response_get_websocket_id_v1_e_websocket_messagetype_FromString(e_websocket_messagetype->valuestring);
    ...
    if (m_payload_local_nonprim) {
        websocket_response_get_websocket_id_v1_m_payload_free(m_payload_local_nonprim);
