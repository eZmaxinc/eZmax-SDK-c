...
static ezsignformfield_response_t *ezsignformfield_response_create_internal(
    ...
    memset(ezsignformfield_response_local_var, 0, sizeof(ezsignformfield_response_t));
...
__attribute__((deprecated)) ezsignformfield_response_t *ezsignformfield_response_create(
    ...
    ezsignformfield_response_t *result = ezsignformfield_response_create_internal (
...
void ezsignformfield_response_free(ezsignformfield_response_t *ezsignformfield_response) {
    ...
    if (ezsignformfield_response->pki_ezsignformfield_id) {
        free(ezsignformfield_response->pki_ezsignformfield_id);
        ezsignformfield_response->pki_ezsignformfield_id = NULL;
    }
    if (ezsignformfield_response->i_ezsignpage_pagenumber) {
        free(ezsignformfield_response->i_ezsignpage_pagenumber);
        ezsignformfield_response->i_ezsignpage_pagenumber = NULL;
    }
    ...
    if (ezsignformfield_response->i_ezsignformfield_x) {
        free(ezsignformfield_response->i_ezsignformfield_x);
        ezsignformfield_response->i_ezsignformfield_x = NULL;
    }
    if (ezsignformfield_response->i_ezsignformfield_y) {
        free(ezsignformfield_response->i_ezsignformfield_y);
        ezsignformfield_response->i_ezsignformfield_y = NULL;
    }
    if (ezsignformfield_response->i_ezsignformfield_width) {
        free(ezsignformfield_response->i_ezsignformfield_width);
        ezsignformfield_response->i_ezsignformfield_width = NULL;
    }
    if (ezsignformfield_response->i_ezsignformfield_height) {
        free(ezsignformfield_response->i_ezsignformfield_height);
        ezsignformfield_response->i_ezsignformfield_height = NULL;
    }
    if (ezsignformfield_response->b_ezsignformfield_autocomplete) {
        free(ezsignformfield_response->b_ezsignformfield_autocomplete);
        ezsignformfield_response->b_ezsignformfield_autocomplete = NULL;
    }
    if (ezsignformfield_response->b_ezsignformfield_selected) {
        free(ezsignformfield_response->b_ezsignformfield_selected);
        ezsignformfield_response->b_ezsignformfield_selected = NULL;
    }
...
ezsignformfield_response_t *ezsignformfield_response_parseFromJSON(cJSON *ezsignformfield_responseJSON){
    ...
    // define the local variable for ezsignformfield_response->pki_ezsignformfield_id
    int *pki_ezsignformfield_id_local_var = NULL;

    // define the local variable for ezsignformfield_response->i_ezsignpage_pagenumber
    ...
    // define the local variable for ezsignformfield_response->i_ezsignformfield_x
    int *i_ezsignformfield_x_local_var = NULL;

    // define the local variable for ezsignformfield_response->i_ezsignformfield_y
    int *i_ezsignformfield_y_local_var = NULL;

    // define the local variable for ezsignformfield_response->i_ezsignformfield_width
    int *i_ezsignformfield_width_local_var = NULL;

    // define the local variable for ezsignformfield_response->i_ezsignformfield_height
    int *i_ezsignformfield_height_local_var = NULL;

    // define the local variable for ezsignformfield_response->b_ezsignformfield_autocomplete
    int *b_ezsignformfield_autocomplete_local_var = NULL;

    // define the local variable for ezsignformfield_response->b_ezsignformfield_selected
