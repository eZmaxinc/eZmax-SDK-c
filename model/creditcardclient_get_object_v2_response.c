...
static creditcardclient_get_object_v2_response_t *creditcardclient_get_object_v2_response_create_internal(
    ...
    memset(creditcardclient_get_object_v2_response_local_var, 0, sizeof(creditcardclient_get_object_v2_response_t));
    creditcardclient_get_object_v2_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) creditcardclient_get_object_v2_response_t *creditcardclient_get_object_v2_response_create(
    common_response_obj_debug_payload_t *obj_debug_payload,
    common_response_obj_debug_t *obj_debug,
    creditcardclient_get_object_v2_response_m_payload_t *m_payload
    ) {
    creditcardclient_get_object_v2_response_t *result = creditcardclient_get_object_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void creditcardclient_get_object_v2_response_free(creditcardclient_get_object_v2_response_t *creditcardclient_get_object_v2_response) {
    ...
    if(creditcardclient_get_object_v2_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "creditcardclient_get_object_v2_response_free");
        return ;
    }
...
creditcardclient_get_object_v2_response_t *creditcardclient_get_object_v2_response_parseFromJSON(cJSON *creditcardclient_get_object_v2_responseJSON){
    ...
    creditcardclient_get_object_v2_response_local_var = creditcardclient_get_object_v2_response_create_internal (
