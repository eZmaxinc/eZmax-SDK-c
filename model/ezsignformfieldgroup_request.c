...
static ezsignformfieldgroup_request_t *ezsignformfieldgroup_request_create_internal(
    ...
    memset(ezsignformfieldgroup_request_local_var, 0, sizeof(ezsignformfieldgroup_request_t));
...
__attribute__((deprecated)) ezsignformfieldgroup_request_t *ezsignformfieldgroup_request_create(
    ...
    ezsignformfieldgroup_request_t *result = ezsignformfieldgroup_request_create_internal (
...
void ezsignformfieldgroup_request_free(ezsignformfieldgroup_request_t *ezsignformfieldgroup_request) {
    ...
    if (ezsignformfieldgroup_request->pki_ezsignformfieldgroup_id) {
        free(ezsignformfieldgroup_request->pki_ezsignformfieldgroup_id);
        ezsignformfieldgroup_request->pki_ezsignformfieldgroup_id = NULL;
    }
    if (ezsignformfieldgroup_request->fki_ezsigndocument_id) {
        free(ezsignformfieldgroup_request->fki_ezsigndocument_id);
        ezsignformfieldgroup_request->fki_ezsigndocument_id = NULL;
    }
    ...
    if (ezsignformfieldgroup_request->i_ezsignformfieldgroup_step) {
        free(ezsignformfieldgroup_request->i_ezsignformfieldgroup_step);
        ezsignformfieldgroup_request->i_ezsignformfieldgroup_step = NULL;
    }
    ...
    if (ezsignformfieldgroup_request->i_ezsignformfieldgroup_filledmin) {
        free(ezsignformfieldgroup_request->i_ezsignformfieldgroup_filledmin);
        ezsignformfieldgroup_request->i_ezsignformfieldgroup_filledmin = NULL;
    }
    if (ezsignformfieldgroup_request->i_ezsignformfieldgroup_filledmax) {
        free(ezsignformfieldgroup_request->i_ezsignformfieldgroup_filledmax);
        ezsignformfieldgroup_request->i_ezsignformfieldgroup_filledmax = NULL;
    }
    if (ezsignformfieldgroup_request->b_ezsignformfieldgroup_readonly) {
        free(ezsignformfieldgroup_request->b_ezsignformfieldgroup_readonly);
        ezsignformfieldgroup_request->b_ezsignformfieldgroup_readonly = NULL;
    }
    if (ezsignformfieldgroup_request->i_ezsignformfieldgroup_maxlength) {
        free(ezsignformfieldgroup_request->i_ezsignformfieldgroup_maxlength);
        ezsignformfieldgroup_request->i_ezsignformfieldgroup_maxlength = NULL;
    }
    if (ezsignformfieldgroup_request->b_ezsignformfieldgroup_encrypted) {
        free(ezsignformfieldgroup_request->b_ezsignformfieldgroup_encrypted);
        ezsignformfieldgroup_request->b_ezsignformfieldgroup_encrypted = NULL;
    }
...
ezsignformfieldgroup_request_t *ezsignformfieldgroup_request_parseFromJSON(cJSON *ezsignformfieldgroup_requestJSON){
    ...
    // define the local variable for ezsignformfieldgroup_request->pki_ezsignformfieldgroup_id
    int *pki_ezsignformfieldgroup_id_local_var = NULL;

    // define the local variable for ezsignformfieldgroup_request->fki_ezsigndocument_id
    ...
    // define the local variable for ezsignformfieldgroup_request->i_ezsignformfieldgroup_step
    int *i_ezsignformfieldgroup_step_local_var = NULL;

    char *s_ezsignformfieldgroup_defaultvalue_local_str = NULL;

    // define the local variable for ezsignformfieldgroup_request->i_ezsignformfieldgroup_filledmin
    int *i_ezsignformfieldgroup_filledmin_local_var = NULL;

    // define the local variable for ezsignformfieldgroup_request->i_ezsignformfieldgroup_filledmax
    int *i_ezsignformfieldgroup_filledmax_local_var = NULL;

    // define the local variable for ezsignformfieldgroup_request->b_ezsignformfieldgroup_readonly
    int *b_ezsignformfieldgroup_readonly_local_var = NULL;

    // define the local variable for ezsignformfieldgroup_request->i_ezsignformfieldgroup_maxlength
    int *i_ezsignformfieldgroup_maxlength_local_var = NULL;

    // define the local variable for ezsignformfieldgroup_request->b_ezsignformfieldgroup_encrypted
