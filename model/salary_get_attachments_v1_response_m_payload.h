/*
 * salary_get_attachments_v1_response_m_payload.h
 *
 * Response for GET /1/object/salary/{pkiSalaryID}/getAttachments
 */

#ifndef _salary_get_attachments_v1_response_m_payload_H_
#define _salary_get_attachments_v1_response_m_payload_H_
...
typedef struct salary_get_attachments_v1_response_m_payload_t salary_get_attachments_v1_response_m_payload_t;

#include "custom_attachmentdocumenttype_response.h"



typedef struct salary_get_attachments_v1_response_m_payload_t {
    list_t *a_obj_attachmentdocumenttype; //nonprimitive container

    int _library_owned; // Is the library responsible for freeing this object?
} salary_get_attachments_v1_response_m_payload_t;
...
#endif /* _salary_get_attachments_v1_response_m_payload_H_ */
