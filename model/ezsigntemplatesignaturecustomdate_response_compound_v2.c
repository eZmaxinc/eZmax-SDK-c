...
ezsigntemplatesignaturecustomdate_response_compound_v2_t *ezsigntemplatesignaturecustomdate_response_compound_v2_create(
...
ezsigntemplatesignaturecustomdate_response_compound_v2_t *ezsigntemplatesignaturecustomdate_response_compound_v2_parseFromJSON(cJSON *ezsigntemplatesignaturecustomdate_response_compound_v2JSON){
    ...
    ezsigntemplatesignaturecustomdate_response_compound_v2_local_var = ezsigntemplatesignaturecustomdate_response_compound_v2_create (
