...
static ezsigntemplatesignaturecustomdate_response_compound_v2_t *ezsigntemplatesignaturecustomdate_response_compound_v2_create_internal(
    ...
    memset(ezsigntemplatesignaturecustomdate_response_compound_v2_local_var, 0, sizeof(ezsigntemplatesignaturecustomdate_response_compound_v2_t));
...
__attribute__((deprecated)) ezsigntemplatesignaturecustomdate_response_compound_v2_t *ezsigntemplatesignaturecustomdate_response_compound_v2_create(
    ...
    ezsigntemplatesignaturecustomdate_response_compound_v2_t *result = ezsigntemplatesignaturecustomdate_response_compound_v2_create_internal (
...
void ezsigntemplatesignaturecustomdate_response_compound_v2_free(ezsigntemplatesignaturecustomdate_response_compound_v2_t *ezsigntemplatesignaturecustomdate_response_compound_v2) {
    ...
    if (ezsigntemplatesignaturecustomdate_response_compound_v2->pki_ezsigntemplatesignaturecustomdate_id) {
        free(ezsigntemplatesignaturecustomdate_response_compound_v2->pki_ezsigntemplatesignaturecustomdate_id);
        ezsigntemplatesignaturecustomdate_response_compound_v2->pki_ezsigntemplatesignaturecustomdate_id = NULL;
    }
    if (ezsigntemplatesignaturecustomdate_response_compound_v2->i_ezsigntemplatesignaturecustomdate_offsetx) {
        free(ezsigntemplatesignaturecustomdate_response_compound_v2->i_ezsigntemplatesignaturecustomdate_offsetx);
        ezsigntemplatesignaturecustomdate_response_compound_v2->i_ezsigntemplatesignaturecustomdate_offsetx = NULL;
    }
    if (ezsigntemplatesignaturecustomdate_response_compound_v2->i_ezsigntemplatesignaturecustomdate_offsety) {
        free(ezsigntemplatesignaturecustomdate_response_compound_v2->i_ezsigntemplatesignaturecustomdate_offsety);
        ezsigntemplatesignaturecustomdate_response_compound_v2->i_ezsigntemplatesignaturecustomdate_offsety = NULL;
    }
...
ezsigntemplatesignaturecustomdate_response_compound_v2_t *ezsigntemplatesignaturecustomdate_response_compound_v2_parseFromJSON(cJSON *ezsigntemplatesignaturecustomdate_response_compound_v2JSON){
    ...
    // define the local variable for ezsigntemplatesignaturecustomdate_response_compound_v2->pki_ezsigntemplatesignaturecustomdate_id
    int *pki_ezsigntemplatesignaturecustomdate_id_local_var = NULL;

    // define the local variable for ezsigntemplatesignaturecustomdate_response_compound_v2->i_ezsigntemplatesignaturecustomdate_offsetx
    int *i_ezsigntemplatesignaturecustomdate_offsetx_local_var = NULL;

    // define the local variable for ezsigntemplatesignaturecustomdate_response_compound_v2->i_ezsigntemplatesignaturecustomdate_offsety
