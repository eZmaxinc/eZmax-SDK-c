/*
 * usergroup_get_usergroupdelegations_v1_response_m_payload.h
 *
 * Response for GET /1/object/usergroup/{pkiUsergroupID}/getUsergroupdelegations
 */

#ifndef _usergroup_get_usergroupdelegations_v1_response_m_payload_H_
#define _usergroup_get_usergroupdelegations_v1_response_m_payload_H_
...
typedef struct usergroup_get_usergroupdelegations_v1_response_m_payload_t usergroup_get_usergroupdelegations_v1_response_m_payload_t;

#include "usergroupdelegation_response_compound.h"



typedef struct usergroup_get_usergroupdelegations_v1_response_m_payload_t {
    list_t *a_obj_usergroupdelegation; //nonprimitive container

} usergroup_get_usergroupdelegations_v1_response_m_payload_t;

usergroup_get_usergroupdelegations_v1_response_m_payload_t *usergroup_get_usergroupdelegations_v1_response_m_payload_create(
...
#endif /* _usergroup_get_usergroupdelegations_v1_response_m_payload_H_ */
