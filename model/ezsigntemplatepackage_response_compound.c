...
static ezsigntemplatepackage_response_compound_t *ezsigntemplatepackage_response_compound_create_internal(
    ...
    memset(ezsigntemplatepackage_response_compound_local_var, 0, sizeof(ezsigntemplatepackage_response_compound_t));
...
__attribute__((deprecated)) ezsigntemplatepackage_response_compound_t *ezsigntemplatepackage_response_compound_create(
    ...
    ezsigntemplatepackage_response_compound_t *result = ezsigntemplatepackage_response_compound_create_internal (
...
void ezsigntemplatepackage_response_compound_free(ezsigntemplatepackage_response_compound_t *ezsigntemplatepackage_response_compound) {
    ...
    if (ezsigntemplatepackage_response_compound->pki_ezsigntemplatepackage_id) {
        free(ezsigntemplatepackage_response_compound->pki_ezsigntemplatepackage_id);
        ezsigntemplatepackage_response_compound->pki_ezsigntemplatepackage_id = NULL;
    }
    if (ezsigntemplatepackage_response_compound->fki_ezsignfoldertype_id) {
        free(ezsigntemplatepackage_response_compound->fki_ezsignfoldertype_id);
        ezsigntemplatepackage_response_compound->fki_ezsignfoldertype_id = NULL;
    }
    if (ezsigntemplatepackage_response_compound->fki_ezdoctemplatedocument_id) {
        free(ezsigntemplatepackage_response_compound->fki_ezdoctemplatedocument_id);
        ezsigntemplatepackage_response_compound->fki_ezdoctemplatedocument_id = NULL;
    }
    if (ezsigntemplatepackage_response_compound->fki_language_id) {
        free(ezsigntemplatepackage_response_compound->fki_language_id);
        ezsigntemplatepackage_response_compound->fki_language_id = NULL;
    }
    ...
    if (ezsigntemplatepackage_response_compound->b_ezsigntemplatepackage_adminonly) {
        free(ezsigntemplatepackage_response_compound->b_ezsigntemplatepackage_adminonly);
        ezsigntemplatepackage_response_compound->b_ezsigntemplatepackage_adminonly = NULL;
    }
    if (ezsigntemplatepackage_response_compound->b_ezsigntemplatepackage_needvalidation) {
        free(ezsigntemplatepackage_response_compound->b_ezsigntemplatepackage_needvalidation);
        ezsigntemplatepackage_response_compound->b_ezsigntemplatepackage_needvalidation = NULL;
    }
    if (ezsigntemplatepackage_response_compound->b_ezsigntemplatepackage_isactive) {
        free(ezsigntemplatepackage_response_compound->b_ezsigntemplatepackage_isactive);
        ezsigntemplatepackage_response_compound->b_ezsigntemplatepackage_isactive = NULL;
    }
    ...
    if (ezsigntemplatepackage_response_compound->b_ezsigntemplatepackage_editallowed) {
        free(ezsigntemplatepackage_response_compound->b_ezsigntemplatepackage_editallowed);
        ezsigntemplatepackage_response_compound->b_ezsigntemplatepackage_editallowed = NULL;
    }
...
ezsigntemplatepackage_response_compound_t *ezsigntemplatepackage_response_compound_parseFromJSON(cJSON *ezsigntemplatepackage_response_compoundJSON){
    ...
    // define the local variable for ezsigntemplatepackage_response_compound->pki_ezsigntemplatepackage_id
    int *pki_ezsigntemplatepackage_id_local_var = NULL;

    // define the local variable for ezsigntemplatepackage_response_compound->fki_ezsignfoldertype_id
    int *fki_ezsignfoldertype_id_local_var = NULL;

    // define the local variable for ezsigntemplatepackage_response_compound->fki_ezdoctemplatedocument_id
    int *fki_ezdoctemplatedocument_id_local_var = NULL;

    // define the local variable for ezsigntemplatepackage_response_compound->fki_language_id
    ...
    // define the local variable for ezsigntemplatepackage_response_compound->b_ezsigntemplatepackage_adminonly
    int *b_ezsigntemplatepackage_adminonly_local_var = NULL;

    // define the local variable for ezsigntemplatepackage_response_compound->b_ezsigntemplatepackage_needvalidation
    int *b_ezsigntemplatepackage_needvalidation_local_var = NULL;

    // define the local variable for ezsigntemplatepackage_response_compound->b_ezsigntemplatepackage_isactive
    int *b_ezsigntemplatepackage_isactive_local_var = NULL;

    char *s_ezsignfoldertype_name_x_local_str = NULL;

    // define the local variable for ezsigntemplatepackage_response_compound->b_ezsigntemplatepackage_editallowed
