...
static ezsignsignature_create_object_v2_response_t *ezsignsignature_create_object_v2_response_create_internal(
    ...
    memset(ezsignsignature_create_object_v2_response_local_var, 0, sizeof(ezsignsignature_create_object_v2_response_t));
    ezsignsignature_create_object_v2_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezsignsignature_create_object_v2_response_t *ezsignsignature_create_object_v2_response_create(
    common_response_obj_debug_payload_t *obj_debug_payload,
    common_response_obj_debug_t *obj_debug,
    ezsignsignature_create_object_v2_response_m_payload_t *m_payload
    ) {
    ezsignsignature_create_object_v2_response_t *result = ezsignsignature_create_object_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void ezsignsignature_create_object_v2_response_free(ezsignsignature_create_object_v2_response_t *ezsignsignature_create_object_v2_response) {
    ...
    if(ezsignsignature_create_object_v2_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsignsignature_create_object_v2_response_free");
        return ;
    }
...
ezsignsignature_create_object_v2_response_t *ezsignsignature_create_object_v2_response_parseFromJSON(cJSON *ezsignsignature_create_object_v2_responseJSON){
    ...
    ezsignsignature_create_object_v2_response_local_var = ezsignsignature_create_object_v2_response_create_internal (
