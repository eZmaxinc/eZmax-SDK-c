...
static ezsignfolder_response_compound_v3_t *ezsignfolder_response_compound_v3_create_internal(
    ...
    memset(ezsignfolder_response_compound_v3_local_var, 0, sizeof(ezsignfolder_response_compound_v3_t));
    ...
    ezsignfolder_response_compound_v3_local_var->i_ezsignfolder_stepcurrent = i_ezsignfolder_stepcurrent;
    ezsignfolder_response_compound_v3_local_var->dt_ezsignfolder_close = dt_ezsignfolder_close;
    ezsignfolder_response_compound_v3_local_var->dt_ezsignfolder_archive = dt_ezsignfolder_archive;
    ezsignfolder_response_compound_v3_local_var->dt_ezsignfolder_dispose = dt_ezsignfolder_dispose;
    ezsignfolder_response_compound_v3_local_var->t_ezsignfolder_message = t_ezsignfolder_message;
    ezsignfolder_response_compound_v3_local_var->e_ezsignfolder_messageorder = e_ezsignfolder_messageorder;
...
__attribute__((deprecated)) ezsignfolder_response_compound_v3_t *ezsignfolder_response_compound_v3_create(
    ...
    ezsignfolder_response_compound_v3_t *result = ezsignfolder_response_compound_v3_create_internal (
...
void ezsignfolder_response_compound_v3_free(ezsignfolder_response_compound_v3_t *ezsignfolder_response_compound_v3) {
    ...
    if (ezsignfolder_response_compound_v3->pki_ezsignfolder_id) {
        free(ezsignfolder_response_compound_v3->pki_ezsignfolder_id);
        ezsignfolder_response_compound_v3->pki_ezsignfolder_id = NULL;
    }
    if (ezsignfolder_response_compound_v3->fki_ezsignfoldertype_id) {
        free(ezsignfolder_response_compound_v3->fki_ezsignfoldertype_id);
        ezsignfolder_response_compound_v3->fki_ezsignfoldertype_id = NULL;
    }
    ...
    if (ezsignfolder_response_compound_v3->fki_timezone_id) {
        free(ezsignfolder_response_compound_v3->fki_timezone_id);
        ezsignfolder_response_compound_v3->fki_timezone_id = NULL;
    }
    ...
    if (ezsignfolder_response_compound_v3->fki_billingentityinternal_id) {
        free(ezsignfolder_response_compound_v3->fki_billingentityinternal_id);
        ezsignfolder_response_compound_v3->fki_billingentityinternal_id = NULL;
    }
    ...
    if (ezsignfolder_response_compound_v3->fki_ezsigntsarequirement_id) {
        free(ezsignfolder_response_compound_v3->fki_ezsigntsarequirement_id);
        ezsignfolder_response_compound_v3->fki_ezsigntsarequirement_id = NULL;
    }
    ...
    if (ezsignfolder_response_compound_v3->b_ezsignfolder_isdisposable) {
        free(ezsignfolder_response_compound_v3->b_ezsignfolder_isdisposable);
        ezsignfolder_response_compound_v3->b_ezsignfolder_isdisposable = NULL;
    }
    if (ezsignfolder_response_compound_v3->i_ezsignfolder_sendreminderfirstdays) {
        free(ezsignfolder_response_compound_v3->i_ezsignfolder_sendreminderfirstdays);
        ezsignfolder_response_compound_v3->i_ezsignfolder_sendreminderfirstdays = NULL;
    }
    if (ezsignfolder_response_compound_v3->i_ezsignfolder_sendreminderotherdays) {
        free(ezsignfolder_response_compound_v3->i_ezsignfolder_sendreminderotherdays);
        ezsignfolder_response_compound_v3->i_ezsignfolder_sendreminderotherdays = NULL;
    }
    ...
    if (ezsignfolder_response_compound_v3->i_ezsignfolder_stepcurrent) {
        free(ezsignfolder_response_compound_v3->i_ezsignfolder_stepcurrent);
        ezsignfolder_response_compound_v3->i_ezsignfolder_stepcurrent = NULL;
    }
    ...
    if (ezsignfolder_response_compound_v3->dt_ezsignfolder_archive) {
        free(ezsignfolder_response_compound_v3->dt_ezsignfolder_archive);
        ezsignfolder_response_compound_v3->dt_ezsignfolder_archive = NULL;
    }
    if (ezsignfolder_response_compound_v3->dt_ezsignfolder_dispose) {
        free(ezsignfolder_response_compound_v3->dt_ezsignfolder_dispose);
        ezsignfolder_response_compound_v3->dt_ezsignfolder_dispose = NULL;
    }
...
cJSON *ezsignfolder_response_compound_v3_convertToJSON(ezsignfolder_response_compound_v3_t *ezsignfolder_response_compound_v3) {
    ...
    // ezsignfolder_response_compound_v3->i_ezsignfolder_stepcurrent
    if(ezsignfolder_response_compound_v3->i_ezsignfolder_stepcurrent) {
    if(cJSON_AddNumberToObject(item, "iEzsignfolderStepcurrent", *ezsignfolder_response_compound_v3->i_ezsignfolder_stepcurrent) == NULL) {
    goto fail; //Numeric
    }
    }
    ...
    // ezsignfolder_response_compound_v3->dt_ezsignfolder_archive
    if(ezsignfolder_response_compound_v3->dt_ezsignfolder_archive) {
    if(cJSON_AddStringToObject(item, "dtEzsignfolderArchive", ezsignfolder_response_compound_v3->dt_ezsignfolder_archive) == NULL) {
    goto fail; //String
    }
    }


    // ezsignfolder_response_compound_v3->dt_ezsignfolder_dispose
    if(ezsignfolder_response_compound_v3->dt_ezsignfolder_dispose) {
    if(cJSON_AddStringToObject(item, "dtEzsignfolderDispose", ezsignfolder_response_compound_v3->dt_ezsignfolder_dispose) == NULL) {
    goto fail; //String
    }
    }
    ...
    // ezsignfolder_response_compound_v3->e_ezsignfolder_messageorder
    if(ezsignfolder_response_compound_v3->e_ezsignfolder_messageorder != ezmax_api_definition__full_field_e_ezsignfolder_messageorder__NULL) {
    cJSON *e_ezsignfolder_messageorder_local_JSON = field_e_ezsignfolder_messageorder_convertToJSON(ezsignfolder_response_compound_v3->e_ezsignfolder_messageorder);
...
ezsignfolder_response_compound_v3_t *ezsignfolder_response_compound_v3_parseFromJSON(cJSON *ezsignfolder_response_compound_v3JSON){
    ...
    // define the local variable for ezsignfolder_response_compound_v3->pki_ezsignfolder_id
    int *pki_ezsignfolder_id_local_var = NULL;

    // define the local variable for ezsignfolder_response_compound_v3->fki_ezsignfoldertype_id
    ...
    // define the local variable for ezsignfolder_response_compound_v3->fki_timezone_id
    ...
    // define the local variable for ezsignfolder_response_compound_v3->fki_billingentityinternal_id
    int *fki_billingentityinternal_id_local_var = NULL;

    char *s_billingentityinternal_description_x_local_str = NULL;

    // define the local variable for ezsignfolder_response_compound_v3->fki_ezsigntsarequirement_id
    ...
    // define the local variable for ezsignfolder_response_compound_v3->b_ezsignfolder_isdisposable
    int *b_ezsignfolder_isdisposable_local_var = NULL;

    // define the local variable for ezsignfolder_response_compound_v3->i_ezsignfolder_sendreminderfirstdays
    int *i_ezsignfolder_sendreminderfirstdays_local_var = NULL;

    // define the local variable for ezsignfolder_response_compound_v3->i_ezsignfolder_sendreminderotherdays
    ...
    // define the local variable for ezsignfolder_response_compound_v3->i_ezsignfolder_stepcurrent
    ...
    // define the local variable for ezsignfolder_response_compound_v3->e_ezsignfolder_messageorder
    ...
    *i_ezsignfolder_sendreminderotherdays_local_var = i_ezsignfolder_sendreminderotherdays->valuedouble;
    ...
    // ezsignfolder_response_compound_v3->i_ezsignfolder_stepcurrent
    cJSON *i_ezsignfolder_stepcurrent = cJSON_GetObjectItemCaseSensitive(ezsignfolder_response_compound_v3JSON, "iEzsignfolderStepcurrent");
    ...
    *i_ezsignfolder_stepcurrent_local_var = i_ezsignfolder_stepcurrent->valuedouble;
    ...
    // ezsignfolder_response_compound_v3->dt_ezsignfolder_archive
    cJSON *dt_ezsignfolder_archive = cJSON_GetObjectItemCaseSensitive(ezsignfolder_response_compound_v3JSON, "dtEzsignfolderArchive");
    ...
    // ezsignfolder_response_compound_v3->dt_ezsignfolder_dispose
    cJSON *dt_ezsignfolder_dispose = cJSON_GetObjectItemCaseSensitive(ezsignfolder_response_compound_v3JSON, "dtEzsignfolderDispose");
    ...
    // ezsignfolder_response_compound_v3->e_ezsignfolder_messageorder
    cJSON *e_ezsignfolder_messageorder = cJSON_GetObjectItemCaseSensitive(ezsignfolder_response_compound_v3JSON, "eEzsignfolderMessageorder");
