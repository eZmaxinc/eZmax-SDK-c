/*
 * webhook_get_list_v1_response_m_payload_all_of.h
 *
 * 
 */

#ifndef _webhook_get_list_v1_response_m_payload_all_of_H_
#define _webhook_get_list_v1_response_m_payload_all_of_H_
...
typedef struct webhook_get_list_v1_response_m_payload_all_of_t webhook_get_list_v1_response_m_payload_all_of_t;

#include "webhook_list_element.h"



typedef struct webhook_get_list_v1_response_m_payload_all_of_t {
    list_t *a_obj_webhook; //nonprimitive container

} webhook_get_list_v1_response_m_payload_all_of_t;
...
#endif /* _webhook_get_list_v1_response_m_payload_all_of_H_ */
