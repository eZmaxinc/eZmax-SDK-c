/*
 * inscription_get_communication_list_v1_response.h
 *
 * Response for GET /1/object/inscription/{pkiInscriptionID}/getCommunicationList
 */

#ifndef _inscription_get_communication_list_v1_response_H_
#define _inscription_get_communication_list_v1_response_H_
...
typedef struct inscription_get_communication_list_v1_response_t inscription_get_communication_list_v1_response_t;
...
typedef struct inscription_get_communication_list_v1_response_t {
    struct common_response_obj_debug_payload_get_list_t *obj_debug_payload; //model
    struct common_response_obj_debug_t *obj_debug; //model
    struct inscription_get_communication_list_v1_response_m_payload_t *m_payload; //model

} inscription_get_communication_list_v1_response_t;

inscription_get_communication_list_v1_response_t *inscription_get_communication_list_v1_response_create(
...
#endif /* _inscription_get_communication_list_v1_response_H_ */
