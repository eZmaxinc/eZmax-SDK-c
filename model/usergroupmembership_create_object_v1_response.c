...
static usergroupmembership_create_object_v1_response_t *usergroupmembership_create_object_v1_response_create_internal(
    ...
    memset(usergroupmembership_create_object_v1_response_local_var, 0, sizeof(usergroupmembership_create_object_v1_response_t));
    usergroupmembership_create_object_v1_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) usergroupmembership_create_object_v1_response_t *usergroupmembership_create_object_v1_response_create(
    ...
    usergroupmembership_create_object_v1_response_t *result = usergroupmembership_create_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void usergroupmembership_create_object_v1_response_free(usergroupmembership_create_object_v1_response_t *usergroupmembership_create_object_v1_response) {
    ...
    if(usergroupmembership_create_object_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "usergroupmembership_create_object_v1_response_free");
        return ;
    }
...
usergroupmembership_create_object_v1_response_t *usergroupmembership_create_object_v1_response_parseFromJSON(cJSON *usergroupmembership_create_object_v1_responseJSON){
    ...
    usergroupmembership_create_object_v1_response_local_var = usergroupmembership_create_object_v1_response_create_internal (
