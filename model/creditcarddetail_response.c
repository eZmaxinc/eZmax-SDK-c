...
creditcarddetail_response_t *creditcarddetail_response_create(
    ...
    creditcarddetail_response_local_var->s_creditcarddetail_numbermasked = s_creditcarddetail_numbermasked;
...
void creditcarddetail_response_free(creditcarddetail_response_t *creditcarddetail_response) {
    ...
    if (creditcarddetail_response->s_creditcarddetail_numbermasked) {
        free(creditcarddetail_response->s_creditcarddetail_numbermasked);
        creditcarddetail_response->s_creditcarddetail_numbermasked = NULL;
    }
...
cJSON *creditcarddetail_response_convertToJSON(creditcarddetail_response_t *creditcarddetail_response) {
    ...
    // creditcarddetail_response->s_creditcarddetail_numbermasked
    if (!creditcarddetail_response->s_creditcarddetail_numbermasked) {
        goto fail;
    }
    if(cJSON_AddStringToObject(item, "sCreditcarddetailNumbermasked", creditcarddetail_response->s_creditcarddetail_numbermasked) == NULL) {
    goto fail; //String
    }
...
creditcarddetail_response_t *creditcarddetail_response_parseFromJSON(cJSON *creditcarddetail_responseJSON){
    ...
    // creditcarddetail_response->s_creditcarddetail_numbermasked
    cJSON *s_creditcarddetail_numbermasked = cJSON_GetObjectItemCaseSensitive(creditcarddetail_responseJSON, "sCreditcarddetailNumbermasked");
