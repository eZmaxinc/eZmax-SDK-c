/*
 * ezsigntemplatesigner_edit_object_v2_request.h
 *
 * Request for PUT /2/object/ezsigntemplatesigner/{pkiEzsigntemplatesignerID}
 */

#ifndef _ezsigntemplatesigner_edit_object_v2_request_H_
#define _ezsigntemplatesigner_edit_object_v2_request_H_
...
typedef struct ezsigntemplatesigner_edit_object_v2_request_t ezsigntemplatesigner_edit_object_v2_request_t;

#include "ezsigntemplatesigner_request_compound_v2.h"



typedef struct ezsigntemplatesigner_edit_object_v2_request_t {
    struct ezsigntemplatesigner_request_compound_v2_t *obj_ezsigntemplatesigner; //model

    int _library_owned; // Is the library responsible for freeing this object?
} ezsigntemplatesigner_edit_object_v2_request_t;
...
#endif /* _ezsigntemplatesigner_edit_object_v2_request_H_ */
