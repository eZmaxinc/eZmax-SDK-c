...
static inscriptionnotauthenticated_get_communicationsenders_v1_response_m_payload_t *inscriptionnotauthenticated_get_communicationsenders_v1_response_m_payload_create_internal(
...
void inscriptionnotauthenticated_get_communicationsenders_v1_response_m_payload_free(inscriptionnotauthenticated_get_communicationsenders_v1_response_m_payload_t *inscriptionnotauthenticated_get_communicationsenders_v1_response_m_payload) {
    ...
    if(inscriptionnotauthenticated_get_communicationsenders_v1_response_m_payload->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "inscriptionnotauthenticated_get_communicationsenders_v1_response_m_payload_free");
        return ;
    }
