/*
 * apikey_edit_object_v1_response.h
 *
 * Response for PUT /1/object/apikey/{pkiApikeyID}
 */

#ifndef _apikey_edit_object_v1_response_H_
#define _apikey_edit_object_v1_response_H_
...
typedef struct apikey_edit_object_v1_response_t apikey_edit_object_v1_response_t;
...
typedef struct apikey_edit_object_v1_response_t {
    struct common_response_obj_debug_payload_t *obj_debug_payload; //model
    struct common_response_obj_debug_t *obj_debug; //model

} apikey_edit_object_v1_response_t;

apikey_edit_object_v1_response_t *apikey_edit_object_v1_response_create(
...
#endif /* _apikey_edit_object_v1_response_H_ */
