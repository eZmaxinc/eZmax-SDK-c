...
typedef enum  { ezmax_api_definition__full_ezsignfolder_request__NULL = 0, ezmax_api_definition__full_ezsignfolder_request__None, ezmax_api_definition__full_ezsignfolder_request__Daily, ezmax_api_definition__full_ezsignfolder_request__Weekly } ezmax_api_definition__full_ezsignfolder_request__e;
