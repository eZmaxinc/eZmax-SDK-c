...
static ezsigndiscussion_get_object_v2_response_t *ezsigndiscussion_get_object_v2_response_create_internal(
    ...
    memset(ezsigndiscussion_get_object_v2_response_local_var, 0, sizeof(ezsigndiscussion_get_object_v2_response_t));
    ezsigndiscussion_get_object_v2_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezsigndiscussion_get_object_v2_response_t *ezsigndiscussion_get_object_v2_response_create(
    ...
    ezsigndiscussion_get_object_v2_response_t *result = ezsigndiscussion_get_object_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void ezsigndiscussion_get_object_v2_response_free(ezsigndiscussion_get_object_v2_response_t *ezsigndiscussion_get_object_v2_response) {
    ...
    if(ezsigndiscussion_get_object_v2_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsigndiscussion_get_object_v2_response_free");
        return ;
    }
...
ezsigndiscussion_get_object_v2_response_t *ezsigndiscussion_get_object_v2_response_parseFromJSON(cJSON *ezsigndiscussion_get_object_v2_responseJSON){
    ...
    ezsigndiscussion_get_object_v2_response_local_var = ezsigndiscussion_get_object_v2_response_create_internal (
