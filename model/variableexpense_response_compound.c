...
static variableexpense_response_compound_t *variableexpense_response_compound_create_internal(
    ...
    memset(variableexpense_response_compound_local_var, 0, sizeof(variableexpense_response_compound_t));
...
__attribute__((deprecated)) variableexpense_response_compound_t *variableexpense_response_compound_create(
    ...
    variableexpense_response_compound_t *result = variableexpense_response_compound_create_internal (
...
void variableexpense_response_compound_free(variableexpense_response_compound_t *variableexpense_response_compound) {
    ...
    if (variableexpense_response_compound->pki_variableexpense_id) {
        free(variableexpense_response_compound->pki_variableexpense_id);
        variableexpense_response_compound->pki_variableexpense_id = NULL;
    }
    ...
    if (variableexpense_response_compound->b_variableexpense_isactive) {
        free(variableexpense_response_compound->b_variableexpense_isactive);
        variableexpense_response_compound->b_variableexpense_isactive = NULL;
    }
...
variableexpense_response_compound_t *variableexpense_response_compound_parseFromJSON(cJSON *variableexpense_response_compoundJSON){
    ...
    // define the local variable for variableexpense_response_compound->pki_variableexpense_id
    ...
    // define the local variable for variableexpense_response_compound->b_variableexpense_isactive
