...
typedef enum { ezmax_api_definition__full_field_e_ezsignformfieldgroup_signerrequirement__NULL = 0, ezmax_api_definition__full_field_e_ezsignformfieldgroup_signerrequirement__All, ezmax_api_definition__full_field_e_ezsignformfieldgroup_signerrequirement__One } ezmax_api_definition__full_field_e_ezsignformfieldgroup_signerrequirement__e;
