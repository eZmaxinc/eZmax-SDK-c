...
static billingentityexternal_get_autocomplete_v2_response_t *billingentityexternal_get_autocomplete_v2_response_create_internal(
    ...
    memset(billingentityexternal_get_autocomplete_v2_response_local_var, 0, sizeof(billingentityexternal_get_autocomplete_v2_response_t));
...
__attribute__((deprecated)) billingentityexternal_get_autocomplete_v2_response_t *billingentityexternal_get_autocomplete_v2_response_create(
    ...
    billingentityexternal_get_autocomplete_v2_response_t *result = billingentityexternal_get_autocomplete_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
