...
ezsigntemplate_get_object_v1_response_m_payload_t *ezsigntemplate_get_object_v1_response_m_payload_create(
    ...
    ezsigntemplate_get_object_v1_response_m_payload_local_var->s_ezsigntemplate_filenamepattern = s_ezsigntemplate_filenamepattern;
    ...
    ezsigntemplate_get_object_v1_response_m_payload_local_var->obj_audit = obj_audit;
    ezsigntemplate_get_object_v1_response_m_payload_local_var->b_ezsigntemplate_editallowed = b_ezsigntemplate_editallowed;
    ezsigntemplate_get_object_v1_response_m_payload_local_var->e_ezsigntemplate_type = e_ezsigntemplate_type;
...
void ezsigntemplate_get_object_v1_response_m_payload_free(ezsigntemplate_get_object_v1_response_m_payload_t *ezsigntemplate_get_object_v1_response_m_payload) {
    ...
    if (ezsigntemplate_get_object_v1_response_m_payload->s_ezsigntemplate_filenamepattern) {
        free(ezsigntemplate_get_object_v1_response_m_payload->s_ezsigntemplate_filenamepattern);
        ezsigntemplate_get_object_v1_response_m_payload->s_ezsigntemplate_filenamepattern = NULL;
    }
    ...
    if (ezsigntemplate_get_object_v1_response_m_payload->obj_audit) {
        common_audit_free(ezsigntemplate_get_object_v1_response_m_payload->obj_audit);
        ezsigntemplate_get_object_v1_response_m_payload->obj_audit = NULL;
    }
    if (ezsigntemplate_get_object_v1_response_m_payload->e_ezsigntemplate_type) {
        field_e_ezsigntemplate_type_free(ezsigntemplate_get_object_v1_response_m_payload->e_ezsigntemplate_type);
        ezsigntemplate_get_object_v1_response_m_payload->e_ezsigntemplate_type = NULL;
    }
...
cJSON *ezsigntemplate_get_object_v1_response_m_payload_convertToJSON(ezsigntemplate_get_object_v1_response_m_payload_t *ezsigntemplate_get_object_v1_response_m_payload) {
    ...
    // ezsigntemplate_get_object_v1_response_m_payload->s_ezsigntemplate_filenamepattern
    if(ezsigntemplate_get_object_v1_response_m_payload->s_ezsigntemplate_filenamepattern) {
    if(cJSON_AddStringToObject(item, "sEzsigntemplateFilenamepattern", ezsigntemplate_get_object_v1_response_m_payload->s_ezsigntemplate_filenamepattern) == NULL) {
    goto fail; //String
    }
    }
    ...
    // ezsigntemplate_get_object_v1_response_m_payload->obj_audit
    if (!ezsigntemplate_get_object_v1_response_m_payload->obj_audit) {
        goto fail;
    }
    cJSON *obj_audit_local_JSON = common_audit_convertToJSON(ezsigntemplate_get_object_v1_response_m_payload->obj_audit);
    ...
    // ezsigntemplate_get_object_v1_response_m_payload->b_ezsigntemplate_editallowed
    if (!ezsigntemplate_get_object_v1_response_m_payload->b_ezsigntemplate_editallowed) {
        goto fail;
    }
    if(cJSON_AddBoolToObject(item, "bEzsigntemplateEditallowed", ezsigntemplate_get_object_v1_response_m_payload->b_ezsigntemplate_editallowed) == NULL) {
    goto fail; //Bool
    }


    // ezsigntemplate_get_object_v1_response_m_payload->e_ezsigntemplate_type
    if(ezsigntemplate_get_object_v1_response_m_payload->e_ezsigntemplate_type != ezmax_api_definition__full_ezsigntemplate_get_object_v1_response_m_payload__NULL) {
    cJSON *e_ezsigntemplate_type_local_JSON = field_e_ezsigntemplate_type_convertToJSON(ezsigntemplate_get_object_v1_response_m_payload->e_ezsigntemplate_type);
...
ezsigntemplate_get_object_v1_response_m_payload_t *ezsigntemplate_get_object_v1_response_m_payload_parseFromJSON(cJSON *ezsigntemplate_get_object_v1_response_m_payloadJSON){
    ...
    // define the local variable for ezsigntemplate_get_object_v1_response_m_payload->obj_audit
    common_audit_t *obj_audit_local_nonprim = NULL;

    // define the local variable for ezsigntemplate_get_object_v1_response_m_payload->e_ezsigntemplate_type
    ...
    // ezsigntemplate_get_object_v1_response_m_payload->s_ezsigntemplate_filenamepattern
    cJSON *s_ezsigntemplate_filenamepattern = cJSON_GetObjectItemCaseSensitive(ezsigntemplate_get_object_v1_response_m_payloadJSON, "sEzsigntemplateFilenamepattern");
    ...
    // ezsigntemplate_get_object_v1_response_m_payload->obj_audit
    cJSON *obj_audit = cJSON_GetObjectItemCaseSensitive(ezsigntemplate_get_object_v1_response_m_payloadJSON, "objAudit");
    if (!obj_audit) {
        goto end;
    }
    ...
    // ezsigntemplate_get_object_v1_response_m_payload->b_ezsigntemplate_editallowed
    cJSON *b_ezsigntemplate_editallowed = cJSON_GetObjectItemCaseSensitive(ezsigntemplate_get_object_v1_response_m_payloadJSON, "bEzsigntemplateEditallowed");
    ...
    // ezsigntemplate_get_object_v1_response_m_payload->e_ezsigntemplate_type
    cJSON *e_ezsigntemplate_type = cJSON_GetObjectItemCaseSensitive(ezsigntemplate_get_object_v1_response_m_payloadJSON, "eEzsigntemplateType");
