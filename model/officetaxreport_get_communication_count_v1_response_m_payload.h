/*
 * officetaxreport_get_communication_count_v1_response_m_payload.h
 *
 * Response for GET /1/object/officetaxreport/{pkiOfficetaxreportID}/getCommunicationCount
 */

#ifndef _officetaxreport_get_communication_count_v1_response_m_payload_H_
#define _officetaxreport_get_communication_count_v1_response_m_payload_H_
...
typedef struct officetaxreport_get_communication_count_v1_response_m_payload_t officetaxreport_get_communication_count_v1_response_m_payload_t;




typedef struct officetaxreport_get_communication_count_v1_response_m_payload_t {
    int *i_communication_count; //numeric

    int _library_owned; // Is the library responsible for freeing this object?
} officetaxreport_get_communication_count_v1_response_m_payload_t;
...
#endif /* _officetaxreport_get_communication_count_v1_response_m_payload_H_ */
