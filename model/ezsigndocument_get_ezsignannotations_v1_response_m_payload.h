/*
 * ezsigndocument_get_ezsignannotations_v1_response_m_payload.h
 *
 * Payload for GET /1/object/ezsigndocument/{pkiEzsigndocument}/getEzsignannotations
 */

#ifndef _ezsigndocument_get_ezsignannotations_v1_response_m_payload_H_
#define _ezsigndocument_get_ezsignannotations_v1_response_m_payload_H_
...
typedef struct ezsigndocument_get_ezsignannotations_v1_response_m_payload_t ezsigndocument_get_ezsignannotations_v1_response_m_payload_t;

#include "ezsignannotation_response_compound.h"



typedef struct ezsigndocument_get_ezsignannotations_v1_response_m_payload_t {
    list_t *a_obj_ezsignannotation; //nonprimitive container

    int _library_owned; // Is the library responsible for freeing this object?
} ezsigndocument_get_ezsignannotations_v1_response_m_payload_t;
...
#endif /* _ezsigndocument_get_ezsignannotations_v1_response_m_payload_H_ */
