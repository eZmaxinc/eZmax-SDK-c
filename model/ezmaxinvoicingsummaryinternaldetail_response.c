...
static ezmaxinvoicingsummaryinternaldetail_response_t *ezmaxinvoicingsummaryinternaldetail_response_create_internal(
    ...
    memset(ezmaxinvoicingsummaryinternaldetail_response_local_var, 0, sizeof(ezmaxinvoicingsummaryinternaldetail_response_t));
    ezmaxinvoicingsummaryinternaldetail_response_local_var->_library_owned = 1;
    ezmaxinvoicingsummaryinternaldetail_response_local_var->pki_ezmaxinvoicingsummaryinternaldetail_id = pki_ezmaxinvoicingsummaryinternaldetail_id;
    ezmaxinvoicingsummaryinternaldetail_response_local_var->fki_ezmaxinvoicingsummaryinternal_id = fki_ezmaxinvoicingsummaryinternal_id;
    ezmaxinvoicingsummaryinternaldetail_response_local_var->fki_ezmaxproduct_id = fki_ezmaxproduct_id;
    ezmaxinvoicingsummaryinternaldetail_response_local_var->s_ezmaxproduct_description_x = s_ezmaxproduct_description_x;
    ezmaxinvoicingsummaryinternaldetail_response_local_var->fki_billingentityexternal_id = fki_billingentityexternal_id;
    ezmaxinvoicingsummaryinternaldetail_response_local_var->s_billingentityexternal_description = s_billingentityexternal_description;
    ezmaxinvoicingsummaryinternaldetail_response_local_var->d_ezmaxinvoicingsummaryinternaldetail_countreal = d_ezmaxinvoicingsummaryinternaldetail_countreal;
    ezmaxinvoicingsummaryinternaldetail_response_local_var->d_ezmaxinvoicingsummaryinternaldetail_subtotal = d_ezmaxinvoicingsummaryinternaldetail_subtotal;
...
__attribute__((deprecated)) ezmaxinvoicingsummaryinternaldetail_response_t *ezmaxinvoicingsummaryinternaldetail_response_create(
    ...
    ezmaxinvoicingsummaryinternaldetail_response_t *result = ezmaxinvoicingsummaryinternaldetail_response_create_internal (
...
void ezmaxinvoicingsummaryinternaldetail_response_free(ezmaxinvoicingsummaryinternaldetail_response_t *ezmaxinvoicingsummaryinternaldetail_response) {
    ...
    if (ezmaxinvoicingsummaryinternaldetail_response->pki_ezmaxinvoicingsummaryinternaldetail_id) {
        free(ezmaxinvoicingsummaryinternaldetail_response->pki_ezmaxinvoicingsummaryinternaldetail_id);
        ezmaxinvoicingsummaryinternaldetail_response->pki_ezmaxinvoicingsummaryinternaldetail_id = NULL;
    }
    if (ezmaxinvoicingsummaryinternaldetail_response->fki_ezmaxinvoicingsummaryinternal_id) {
        free(ezmaxinvoicingsummaryinternaldetail_response->fki_ezmaxinvoicingsummaryinternal_id);
        ezmaxinvoicingsummaryinternaldetail_response->fki_ezmaxinvoicingsummaryinternal_id = NULL;
    }
    if (ezmaxinvoicingsummaryinternaldetail_response->fki_ezmaxproduct_id) {
        free(ezmaxinvoicingsummaryinternaldetail_response->fki_ezmaxproduct_id);
        ezmaxinvoicingsummaryinternaldetail_response->fki_ezmaxproduct_id = NULL;
    }
    if (ezmaxinvoicingsummaryinternaldetail_response->s_ezmaxproduct_description_x) {
        free(ezmaxinvoicingsummaryinternaldetail_response->s_ezmaxproduct_description_x);
        ezmaxinvoicingsummaryinternaldetail_response->s_ezmaxproduct_description_x = NULL;
    }
    if (ezmaxinvoicingsummaryinternaldetail_response->fki_billingentityexternal_id) {
        free(ezmaxinvoicingsummaryinternaldetail_response->fki_billingentityexternal_id);
        ezmaxinvoicingsummaryinternaldetail_response->fki_billingentityexternal_id = NULL;
    }
    if (ezmaxinvoicingsummaryinternaldetail_response->s_billingentityexternal_description) {
        free(ezmaxinvoicingsummaryinternaldetail_response->s_billingentityexternal_description);
        ezmaxinvoicingsummaryinternaldetail_response->s_billingentityexternal_description = NULL;
    }
    if (ezmaxinvoicingsummaryinternaldetail_response->d_ezmaxinvoicingsummaryinternaldetail_countreal) {
        free(ezmaxinvoicingsummaryinternaldetail_response->d_ezmaxinvoicingsummaryinternaldetail_countreal);
        ezmaxinvoicingsummaryinternaldetail_response->d_ezmaxinvoicingsummaryinternaldetail_countreal = NULL;
    }
    if (ezmaxinvoicingsummaryinternaldetail_response->d_ezmaxinvoicingsummaryinternaldetail_subtotal) {
        free(ezmaxinvoicingsummaryinternaldetail_response->d_ezmaxinvoicingsummaryinternaldetail_subtotal);
        ezmaxinvoicingsummaryinternaldetail_response->d_ezmaxinvoicingsummaryinternaldetail_subtotal = NULL;
    }
    if (ezmaxinvoicingsummaryinternaldetail_response->d_ezmaxinvoicingsummaryinternaldetail_rebate) {
        free(ezmaxinvoicingsummaryinternaldetail_response->d_ezmaxinvoicingsummaryinternaldetail_rebate);
        ezmaxinvoicingsummaryinternaldetail_response->d_ezmaxinvoicingsummaryinternaldetail_rebate = NULL;
    }
    ...
    if (ezmaxinvoicingsummaryinternaldetail_response->b_ezmaxinvoicingsummaryinternaldetail_adjustment) {
        free(ezmaxinvoicingsummaryinternaldetail_response->b_ezmaxinvoicingsummaryinternaldetail_adjustment);
        ezmaxinvoicingsummaryinternaldetail_response->b_ezmaxinvoicingsummaryinternaldetail_adjustment = NULL;
    }
...
cJSON *ezmaxinvoicingsummaryinternaldetail_response_convertToJSON(ezmaxinvoicingsummaryinternaldetail_response_t *ezmaxinvoicingsummaryinternaldetail_response) {
    ...
    if(ezmaxinvoicingsummaryinternaldetail_response->pki_ezmaxinvoicingsummaryinternaldetail_id) {
    if(cJSON_AddNumberToObject(item, "pkiEzmaxinvoicingsummaryinternaldetailID", *ezmaxinvoicingsummaryinternaldetail_response->pki_ezmaxinvoicingsummaryinternaldetail_id) == NULL) {
    goto fail; //Numeric
    }
    }
    ...
    if(ezmaxinvoicingsummaryinternaldetail_response->fki_ezmaxinvoicingsummaryinternal_id) {
    if(cJSON_AddNumberToObject(item, "fkiEzmaxinvoicingsummaryinternalID", *ezmaxinvoicingsummaryinternaldetail_response->fki_ezmaxinvoicingsummaryinternal_id) == NULL) {
    goto fail; //Numeric
    }
    }
    ...
    if(cJSON_AddNumberToObject(item, "fkiEzmaxproductID", *ezmaxinvoicingsummaryinternaldetail_response->fki_ezmaxproduct_id) == NULL) {
    goto fail; //Numeric
    }
    ...
    if(cJSON_AddStringToObject(item, "sEzmaxproductDescriptionX", ezmaxinvoicingsummaryinternaldetail_response->s_ezmaxproduct_description_x) == NULL) {
    goto fail; //String
    }
    ...
    if(cJSON_AddNumberToObject(item, "fkiBillingentityexternalID", *ezmaxinvoicingsummaryinternaldetail_response->fki_billingentityexternal_id) == NULL) {
    goto fail; //Numeric
    }
    ...
    if(cJSON_AddStringToObject(item, "sBillingentityexternalDescription", ezmaxinvoicingsummaryinternaldetail_response->s_billingentityexternal_description) == NULL) {
    goto fail; //String
    }
    ...
    if(cJSON_AddStringToObject(item, "dEzmaxinvoicingsummaryinternaldetailCountreal", ezmaxinvoicingsummaryinternaldetail_response->d_ezmaxinvoicingsummaryinternaldetail_countreal) == NULL) {
    goto fail; //String
    }
    ...
    if(cJSON_AddStringToObject(item, "dEzmaxinvoicingsummaryinternaldetailSubtotal", ezmaxinvoicingsummaryinternaldetail_response->d_ezmaxinvoicingsummaryinternaldetail_subtotal) == NULL) {
    goto fail; //String
    }
    ...
    if(cJSON_AddStringToObject(item, "dEzmaxinvoicingsummaryinternaldetailRebate", ezmaxinvoicingsummaryinternaldetail_response->d_ezmaxinvoicingsummaryinternaldetail_rebate) == NULL) {
    goto fail; //String
    }
    ...
    if(cJSON_AddStringToObject(item, "dEzmaxinvoicingsummaryinternaldetailTotal", ezmaxinvoicingsummaryinternaldetail_response->d_ezmaxinvoicingsummaryinternaldetail_total) == NULL) {
    goto fail; //String
    }
...
ezmaxinvoicingsummaryinternaldetail_response_t *ezmaxinvoicingsummaryinternaldetail_response_parseFromJSON(cJSON *ezmaxinvoicingsummaryinternaldetail_responseJSON){
    ...
    ezmaxinvoicingsummaryinternaldetail_response_t *ezmaxinvoicingsummaryinternaldetail_response_local_var = NULL;

    // define the local variable for ezmaxinvoicingsummaryinternaldetail_response->pki_ezmaxinvoicingsummaryinternaldetail_id
    int *pki_ezmaxinvoicingsummaryinternaldetail_id_local_var = NULL;

    // define the local variable for ezmaxinvoicingsummaryinternaldetail_response->fki_ezmaxinvoicingsummaryinternal_id
    int *fki_ezmaxinvoicingsummaryinternal_id_local_var = NULL;

    // define the local variable for ezmaxinvoicingsummaryinternaldetail_response->fki_ezmaxproduct_id
    int *fki_ezmaxproduct_id_local_var = NULL;

    char *s_ezmaxproduct_description_x_local_str = NULL;

    // define the local variable for ezmaxinvoicingsummaryinternaldetail_response->fki_billingentityexternal_id
    ...
    // define the local variable for ezmaxinvoicingsummaryinternaldetail_response->b_ezmaxinvoicingsummaryinternaldetail_adjustment
