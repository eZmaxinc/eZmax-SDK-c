/*
 * ezsignsigningreason_get_object_v2_response.h
 *
 * Response for GET /2/object/ezsignsigningreason/{pkiEzsignsigningreasonID}
 */

#ifndef _ezsignsigningreason_get_object_v2_response_H_
#define _ezsignsigningreason_get_object_v2_response_H_
...
typedef struct ezsignsigningreason_get_object_v2_response_t ezsignsigningreason_get_object_v2_response_t;
...
typedef struct ezsignsigningreason_get_object_v2_response_t {
    struct common_response_obj_debug_payload_t *obj_debug_payload; //model
    struct common_response_obj_debug_t *obj_debug; //model
    struct ezsignsigningreason_get_object_v2_response_m_payload_t *m_payload; //model
...
#endif /* _ezsignsigningreason_get_object_v2_response_H_ */
