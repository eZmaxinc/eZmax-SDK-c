...
static rejectedoffertopurchase_get_communication_list_v1_response_t *rejectedoffertopurchase_get_communication_list_v1_response_create_internal(
    ...
    memset(rejectedoffertopurchase_get_communication_list_v1_response_local_var, 0, sizeof(rejectedoffertopurchase_get_communication_list_v1_response_t));
...
__attribute__((deprecated)) rejectedoffertopurchase_get_communication_list_v1_response_t *rejectedoffertopurchase_get_communication_list_v1_response_create(
    ...
    rejectedoffertopurchase_get_communication_list_v1_response_t *result = rejectedoffertopurchase_get_communication_list_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
