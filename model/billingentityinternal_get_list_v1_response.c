...
static billingentityinternal_get_list_v1_response_t *billingentityinternal_get_list_v1_response_create_internal(
    ...
    memset(billingentityinternal_get_list_v1_response_local_var, 0, sizeof(billingentityinternal_get_list_v1_response_t));
    billingentityinternal_get_list_v1_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) billingentityinternal_get_list_v1_response_t *billingentityinternal_get_list_v1_response_create(
    common_response_obj_debug_payload_get_list_t *obj_debug_payload,
    common_response_obj_debug_t *obj_debug,
    billingentityinternal_get_list_v1_response_m_payload_t *m_payload
    ) {
    billingentityinternal_get_list_v1_response_t *result = billingentityinternal_get_list_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void billingentityinternal_get_list_v1_response_free(billingentityinternal_get_list_v1_response_t *billingentityinternal_get_list_v1_response) {
    ...
    if(billingentityinternal_get_list_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "billingentityinternal_get_list_v1_response_free");
        return ;
    }
...
billingentityinternal_get_list_v1_response_t *billingentityinternal_get_list_v1_response_parseFromJSON(cJSON *billingentityinternal_get_list_v1_responseJSON){
    ...
    billingentityinternal_get_list_v1_response_local_var = billingentityinternal_get_list_v1_response_create_internal (
