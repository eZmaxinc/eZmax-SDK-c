...
ezsigntemplatesignature_create_object_v2_response_t *ezsigntemplatesignature_create_object_v2_response_create(
...
ezsigntemplatesignature_create_object_v2_response_t *ezsigntemplatesignature_create_object_v2_response_parseFromJSON(cJSON *ezsigntemplatesignature_create_object_v2_responseJSON){
    ...
    ezsigntemplatesignature_create_object_v2_response_local_var = ezsigntemplatesignature_create_object_v2_response_create (
