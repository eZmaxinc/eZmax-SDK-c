...
static ezsigntemplatesignature_create_object_v2_response_t *ezsigntemplatesignature_create_object_v2_response_create_internal(
    ...
    memset(ezsigntemplatesignature_create_object_v2_response_local_var, 0, sizeof(ezsigntemplatesignature_create_object_v2_response_t));
...
__attribute__((deprecated)) ezsigntemplatesignature_create_object_v2_response_t *ezsigntemplatesignature_create_object_v2_response_create(
    ...
    ezsigntemplatesignature_create_object_v2_response_t *result = ezsigntemplatesignature_create_object_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
