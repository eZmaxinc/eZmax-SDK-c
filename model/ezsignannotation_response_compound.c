...
static ezsignannotation_response_compound_t *ezsignannotation_response_compound_create_internal(
    ...
    memset(ezsignannotation_response_compound_local_var, 0, sizeof(ezsignannotation_response_compound_t));
...
__attribute__((deprecated)) ezsignannotation_response_compound_t *ezsignannotation_response_compound_create(
    ...
    ezsignannotation_response_compound_t *result = ezsignannotation_response_compound_create_internal (
...
void ezsignannotation_response_compound_free(ezsignannotation_response_compound_t *ezsignannotation_response_compound) {
    ...
    if (ezsignannotation_response_compound->pki_ezsignannotation_id) {
        free(ezsignannotation_response_compound->pki_ezsignannotation_id);
        ezsignannotation_response_compound->pki_ezsignannotation_id = NULL;
    }
    if (ezsignannotation_response_compound->fki_ezsigndocument_id) {
        free(ezsignannotation_response_compound->fki_ezsigndocument_id);
        ezsignannotation_response_compound->fki_ezsigndocument_id = NULL;
    }
    if (ezsignannotation_response_compound->i_ezsignannotation_x) {
        free(ezsignannotation_response_compound->i_ezsignannotation_x);
        ezsignannotation_response_compound->i_ezsignannotation_x = NULL;
    }
    if (ezsignannotation_response_compound->i_ezsignannotation_y) {
        free(ezsignannotation_response_compound->i_ezsignannotation_y);
        ezsignannotation_response_compound->i_ezsignannotation_y = NULL;
    }
    if (ezsignannotation_response_compound->i_ezsignannotation_width) {
        free(ezsignannotation_response_compound->i_ezsignannotation_width);
        ezsignannotation_response_compound->i_ezsignannotation_width = NULL;
    }
    if (ezsignannotation_response_compound->i_ezsignannotation_height) {
        free(ezsignannotation_response_compound->i_ezsignannotation_height);
        ezsignannotation_response_compound->i_ezsignannotation_height = NULL;
    }
    ...
    if (ezsignannotation_response_compound->i_ezsignpage_pagenumber) {
        free(ezsignannotation_response_compound->i_ezsignpage_pagenumber);
        ezsignannotation_response_compound->i_ezsignpage_pagenumber = NULL;
    }
...
ezsignannotation_response_compound_t *ezsignannotation_response_compound_parseFromJSON(cJSON *ezsignannotation_response_compoundJSON){
    ...
    // define the local variable for ezsignannotation_response_compound->pki_ezsignannotation_id
    int *pki_ezsignannotation_id_local_var = NULL;

    // define the local variable for ezsignannotation_response_compound->fki_ezsigndocument_id
    ...
    // define the local variable for ezsignannotation_response_compound->i_ezsignannotation_x
    int *i_ezsignannotation_x_local_var = NULL;

    // define the local variable for ezsignannotation_response_compound->i_ezsignannotation_y
    int *i_ezsignannotation_y_local_var = NULL;

    // define the local variable for ezsignannotation_response_compound->i_ezsignannotation_width
    int *i_ezsignannotation_width_local_var = NULL;

    // define the local variable for ezsignannotation_response_compound->i_ezsignannotation_height
    int *i_ezsignannotation_height_local_var = NULL;

    char *s_ezsignannotation_text_local_str = NULL;

    // define the local variable for ezsignannotation_response_compound->i_ezsignpage_pagenumber
