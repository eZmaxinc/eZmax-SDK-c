...
static ezsigntemplatedocument_edit_ezsigntemplatesignatures_v1_response_m_payload_t *ezsigntemplatedocument_edit_ezsigntemplatesignatures_v1_response_m_payload_create_internal(
    ...
    memset(ezsigntemplatedocument_edit_ezsigntemplatesignatures_v1_response_m_payload_local_var, 0, sizeof(ezsigntemplatedocument_edit_ezsigntemplatesignatures_v1_response_m_payload_t));
    ezsigntemplatedocument_edit_ezsigntemplatesignatures_v1_response_m_payload_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezsigntemplatedocument_edit_ezsigntemplatesignatures_v1_response_m_payload_t *ezsigntemplatedocument_edit_ezsigntemplatesignatures_v1_response_m_payload_create(
    ...
    ezsigntemplatedocument_edit_ezsigntemplatesignatures_v1_response_m_payload_t *result = ezsigntemplatedocument_edit_ezsigntemplatesignatures_v1_response_m_payload_create_internal (
...
void ezsigntemplatedocument_edit_ezsigntemplatesignatures_v1_response_m_payload_free(ezsigntemplatedocument_edit_ezsigntemplatesignatures_v1_response_m_payload_t *ezsigntemplatedocument_edit_ezsigntemplatesignatures_v1_response_m_payload) {
    ...
    if(ezsigntemplatedocument_edit_ezsigntemplatesignatures_v1_response_m_payload->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsigntemplatedocument_edit_ezsigntemplatesignatures_v1_response_m_payload_free");
        return ;
    }
...
ezsigntemplatedocument_edit_ezsigntemplatesignatures_v1_response_m_payload_t *ezsigntemplatedocument_edit_ezsigntemplatesignatures_v1_response_m_payload_parseFromJSON(cJSON *ezsigntemplatedocument_edit_ezsigntemplatesignatures_v1_response_m_payloadJSON){
    ...
    ezsigntemplatedocument_edit_ezsigntemplatesignatures_v1_response_m_payload_local_var = ezsigntemplatedocument_edit_ezsigntemplatesignatures_v1_response_m_payload_create_internal (
