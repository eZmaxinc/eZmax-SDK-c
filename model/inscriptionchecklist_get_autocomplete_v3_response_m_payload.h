/*
 * inscriptionchecklist_get_autocomplete_v3_response_m_payload.h
 *
 * Payload for POST /3/object/inscriptionchecklist/getAutocomplete
 */

#ifndef _inscriptionchecklist_get_autocomplete_v3_response_m_payload_H_
#define _inscriptionchecklist_get_autocomplete_v3_response_m_payload_H_
...
typedef struct inscriptionchecklist_get_autocomplete_v3_response_m_payload_t inscriptionchecklist_get_autocomplete_v3_response_m_payload_t;

#include "inscriptionchecklist_autocomplete_element_response.h"



typedef struct inscriptionchecklist_get_autocomplete_v3_response_m_payload_t {
    list_t *a_obj_inscriptionchecklist; //nonprimitive container

    int _library_owned; // Is the library responsible for freeing this object?
} inscriptionchecklist_get_autocomplete_v3_response_m_payload_t;
...
#endif /* _inscriptionchecklist_get_autocomplete_v3_response_m_payload_H_ */
