...
static apikey_edit_object_v1_response_t *apikey_edit_object_v1_response_create_internal(
    ...
    memset(apikey_edit_object_v1_response_local_var, 0, sizeof(apikey_edit_object_v1_response_t));
...
__attribute__((deprecated)) apikey_edit_object_v1_response_t *apikey_edit_object_v1_response_create(
    ...
    apikey_edit_object_v1_response_t *result = apikey_edit_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug
        );
    if (!result) {
