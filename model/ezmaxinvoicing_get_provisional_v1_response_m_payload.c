...
static ezmaxinvoicing_get_provisional_v1_response_m_payload_t *ezmaxinvoicing_get_provisional_v1_response_m_payload_create_internal(
    ...
    memset(ezmaxinvoicing_get_provisional_v1_response_m_payload_local_var, 0, sizeof(ezmaxinvoicing_get_provisional_v1_response_m_payload_t));
    ezmaxinvoicing_get_provisional_v1_response_m_payload_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezmaxinvoicing_get_provisional_v1_response_m_payload_t *ezmaxinvoicing_get_provisional_v1_response_m_payload_create(
    ...
    ezmaxinvoicing_get_provisional_v1_response_m_payload_t *result = ezmaxinvoicing_get_provisional_v1_response_m_payload_create_internal (
...
void ezmaxinvoicing_get_provisional_v1_response_m_payload_free(ezmaxinvoicing_get_provisional_v1_response_m_payload_t *ezmaxinvoicing_get_provisional_v1_response_m_payload) {
    ...
    if(ezmaxinvoicing_get_provisional_v1_response_m_payload->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezmaxinvoicing_get_provisional_v1_response_m_payload_free");
        return ;
    }
    listEntry_t *listEntry;
    if (ezmaxinvoicing_get_provisional_v1_response_m_payload->pki_ezmaxinvoicing_id) {
        free(ezmaxinvoicing_get_provisional_v1_response_m_payload->pki_ezmaxinvoicing_id);
        ezmaxinvoicing_get_provisional_v1_response_m_payload->pki_ezmaxinvoicing_id = NULL;
    }
    if (ezmaxinvoicing_get_provisional_v1_response_m_payload->fki_ezmaxinvoicingcontract_id) {
        free(ezmaxinvoicing_get_provisional_v1_response_m_payload->fki_ezmaxinvoicingcontract_id);
        ezmaxinvoicing_get_provisional_v1_response_m_payload->fki_ezmaxinvoicingcontract_id = NULL;
    }
    if (ezmaxinvoicing_get_provisional_v1_response_m_payload->fki_ezmaxpricing_id) {
        free(ezmaxinvoicing_get_provisional_v1_response_m_payload->fki_ezmaxpricing_id);
        ezmaxinvoicing_get_provisional_v1_response_m_payload->fki_ezmaxpricing_id = NULL;
    }
    if (ezmaxinvoicing_get_provisional_v1_response_m_payload->fki_systemconfigurationtype_id) {
        free(ezmaxinvoicing_get_provisional_v1_response_m_payload->fki_systemconfigurationtype_id);
        ezmaxinvoicing_get_provisional_v1_response_m_payload->fki_systemconfigurationtype_id = NULL;
    }
    ...
    if (ezmaxinvoicing_get_provisional_v1_response_m_payload->i_ezmaxinvoicing_days) {
        free(ezmaxinvoicing_get_provisional_v1_response_m_payload->i_ezmaxinvoicing_days);
        ezmaxinvoicing_get_provisional_v1_response_m_payload->i_ezmaxinvoicing_days = NULL;
    }
    ...
    if (ezmaxinvoicing_get_provisional_v1_response_m_payload->i_ezmaxinvoicing_contractlength) {
        free(ezmaxinvoicing_get_provisional_v1_response_m_payload->i_ezmaxinvoicing_contractlength);
        ezmaxinvoicing_get_provisional_v1_response_m_payload->i_ezmaxinvoicing_contractlength = NULL;
    }
    ...
    if (ezmaxinvoicing_get_provisional_v1_response_m_payload->b_ezmaxinvoicing_rebate_ezsignallagents) {
        free(ezmaxinvoicing_get_provisional_v1_response_m_payload->b_ezmaxinvoicing_rebate_ezsignallagents);
        ezmaxinvoicing_get_provisional_v1_response_m_payload->b_ezmaxinvoicing_rebate_ezsignallagents = NULL;
    }
...
cJSON *ezmaxinvoicing_get_provisional_v1_response_m_payload_convertToJSON(ezmaxinvoicing_get_provisional_v1_response_m_payload_t *ezmaxinvoicing_get_provisional_v1_response_m_payload) {
    ...
    if (ezmax_api_definition__full_field_e_ezmaxinvoicing_paymenttype__NULL == ezmaxinvoicing_get_provisional_v1_response_m_payload->e_ezmaxinvoicing_paymenttype) {
        goto fail;
    }
...
ezmaxinvoicing_get_provisional_v1_response_m_payload_t *ezmaxinvoicing_get_provisional_v1_response_m_payload_parseFromJSON(cJSON *ezmaxinvoicing_get_provisional_v1_response_m_payloadJSON){
    ...
    // define the local variable for ezmaxinvoicing_get_provisional_v1_response_m_payload->pki_ezmaxinvoicing_id
    int *pki_ezmaxinvoicing_id_local_var = NULL;

    // define the local variable for ezmaxinvoicing_get_provisional_v1_response_m_payload->fki_ezmaxinvoicingcontract_id
    int *fki_ezmaxinvoicingcontract_id_local_var = NULL;

    // define the local variable for ezmaxinvoicing_get_provisional_v1_response_m_payload->fki_ezmaxpricing_id
    int *fki_ezmaxpricing_id_local_var = NULL;

    // define the local variable for ezmaxinvoicing_get_provisional_v1_response_m_payload->fki_systemconfigurationtype_id
    ...
    // define the local variable for ezmaxinvoicing_get_provisional_v1_response_m_payload->i_ezmaxinvoicing_days
    ...
    // define the local variable for ezmaxinvoicing_get_provisional_v1_response_m_payload->i_ezmaxinvoicing_contractlength
    int *i_ezmaxinvoicing_contractlength_local_var = NULL;

    char *d_ezmaxinvoicing_rebatecontractlength_local_str = NULL;

    // define the local variable for ezmaxinvoicing_get_provisional_v1_response_m_payload->b_ezmaxinvoicing_rebate_ezsignallagents
    ...
    *b_ezmaxinvoicing_rebate_ezsignallagents_local_var = b_ezmaxinvoicing_rebate_ezsignallagents->valueint;
    ...
    ezmaxinvoicing_get_provisional_v1_response_m_payload_local_var = ezmaxinvoicing_get_provisional_v1_response_m_payload_create_internal (
