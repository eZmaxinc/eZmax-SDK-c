...
static ezsigntemplateglobal_get_object_v2_response_t *ezsigntemplateglobal_get_object_v2_response_create_internal(
    ...
    memset(ezsigntemplateglobal_get_object_v2_response_local_var, 0, sizeof(ezsigntemplateglobal_get_object_v2_response_t));
...
__attribute__((deprecated)) ezsigntemplateglobal_get_object_v2_response_t *ezsigntemplateglobal_get_object_v2_response_create(
    ...
    ezsigntemplateglobal_get_object_v2_response_t *result = ezsigntemplateglobal_get_object_v2_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
