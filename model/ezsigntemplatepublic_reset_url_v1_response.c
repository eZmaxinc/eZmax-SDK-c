...
static ezsigntemplatepublic_reset_url_v1_response_t *ezsigntemplatepublic_reset_url_v1_response_create_internal(
    ...
    memset(ezsigntemplatepublic_reset_url_v1_response_local_var, 0, sizeof(ezsigntemplatepublic_reset_url_v1_response_t));
    ezsigntemplatepublic_reset_url_v1_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezsigntemplatepublic_reset_url_v1_response_t *ezsigntemplatepublic_reset_url_v1_response_create(
    common_response_obj_debug_payload_t *obj_debug_payload,
    common_response_obj_debug_t *obj_debug,
    ezsigntemplatepublic_reset_url_v1_response_m_payload_t *m_payload
    ) {
    ezsigntemplatepublic_reset_url_v1_response_t *result = ezsigntemplatepublic_reset_url_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void ezsigntemplatepublic_reset_url_v1_response_free(ezsigntemplatepublic_reset_url_v1_response_t *ezsigntemplatepublic_reset_url_v1_response) {
    ...
    if(ezsigntemplatepublic_reset_url_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsigntemplatepublic_reset_url_v1_response_free");
        return ;
    }
...
ezsigntemplatepublic_reset_url_v1_response_t *ezsigntemplatepublic_reset_url_v1_response_parseFromJSON(cJSON *ezsigntemplatepublic_reset_url_v1_responseJSON){
    ...
    ezsigntemplatepublic_reset_url_v1_response_local_var = ezsigntemplatepublic_reset_url_v1_response_create_internal (
