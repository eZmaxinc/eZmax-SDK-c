...
static ezsigntemplatedocument_request_compound_t *ezsigntemplatedocument_request_compound_create_internal(
    ...
    memset(ezsigntemplatedocument_request_compound_local_var, 0, sizeof(ezsigntemplatedocument_request_compound_t));
    ezsigntemplatedocument_request_compound_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezsigntemplatedocument_request_compound_t *ezsigntemplatedocument_request_compound_create(
    ...
    ezsigntemplatedocument_request_compound_t *result = ezsigntemplatedocument_request_compound_create_internal (
...
void ezsigntemplatedocument_request_compound_free(ezsigntemplatedocument_request_compound_t *ezsigntemplatedocument_request_compound) {
    ...
    if(ezsigntemplatedocument_request_compound->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsigntemplatedocument_request_compound_free");
        return ;
    }
    listEntry_t *listEntry;
    if (ezsigntemplatedocument_request_compound->pki_ezsigntemplatedocument_id) {
        free(ezsigntemplatedocument_request_compound->pki_ezsigntemplatedocument_id);
        ezsigntemplatedocument_request_compound->pki_ezsigntemplatedocument_id = NULL;
    }
    if (ezsigntemplatedocument_request_compound->fki_ezsigntemplate_id) {
        free(ezsigntemplatedocument_request_compound->fki_ezsigntemplate_id);
        ezsigntemplatedocument_request_compound->fki_ezsigntemplate_id = NULL;
    }
    if (ezsigntemplatedocument_request_compound->fki_ezsigndocument_id) {
        free(ezsigntemplatedocument_request_compound->fki_ezsigndocument_id);
        ezsigntemplatedocument_request_compound->fki_ezsigndocument_id = NULL;
    }
    if (ezsigntemplatedocument_request_compound->fki_ezsigntemplatesigner_id) {
        free(ezsigntemplatedocument_request_compound->fki_ezsigntemplatesigner_id);
        ezsigntemplatedocument_request_compound->fki_ezsigntemplatesigner_id = NULL;
    }
    ...
    if (ezsigntemplatedocument_request_compound->b_ezsigntemplatedocument_forcerepair) {
        free(ezsigntemplatedocument_request_compound->b_ezsigntemplatedocument_forcerepair);
        ezsigntemplatedocument_request_compound->b_ezsigntemplatedocument_forcerepair = NULL;
    }
...
cJSON *ezsigntemplatedocument_request_compound_convertToJSON(ezsigntemplatedocument_request_compound_t *ezsigntemplatedocument_request_compound) {
    ...
    if(cJSON_AddStringToObject(item, "eEzsigntemplatedocumentSource", ezsigntemplatedocument_request_compound_e_ezsigntemplatedocument_source_ToString(ezsigntemplatedocument_request_compound->e_ezsigntemplatedocument_source)) == NULL)
    {
    goto fail; //Enum
    }
    ...
    if(cJSON_AddStringToObject(item, "eEzsigntemplatedocumentFormat", ezsigntemplatedocument_request_compound_e_ezsigntemplatedocument_format_ToString(ezsigntemplatedocument_request_compound->e_ezsigntemplatedocument_format)) == NULL)
    {
    goto fail; //Enum
    }
    }
    ...
    if(cJSON_AddStringToObject(item, "eEzsigntemplatedocumentForm", ezsigntemplatedocument_request_compound_e_ezsigntemplatedocument_form_ToString(ezsigntemplatedocument_request_compound->e_ezsigntemplatedocument_form)) == NULL)
    {
    goto fail; //Enum
    }
    }
...
ezsigntemplatedocument_request_compound_t *ezsigntemplatedocument_request_compound_parseFromJSON(cJSON *ezsigntemplatedocument_request_compoundJSON){
    ...
    // define the local variable for ezsigntemplatedocument_request_compound->pki_ezsigntemplatedocument_id
    int *pki_ezsigntemplatedocument_id_local_var = NULL;

    // define the local variable for ezsigntemplatedocument_request_compound->fki_ezsigntemplate_id
    int *fki_ezsigntemplate_id_local_var = NULL;

    // define the local variable for ezsigntemplatedocument_request_compound->fki_ezsigndocument_id
    int *fki_ezsigndocument_id_local_var = NULL;

    // define the local variable for ezsigntemplatedocument_request_compound->fki_ezsigntemplatesigner_id
    ...
    // define the local variable for ezsigntemplatedocument_request_compound->b_ezsigntemplatedocument_forcerepair
    ...
    *b_ezsigntemplatedocument_forcerepair_local_var = b_ezsigntemplatedocument_forcerepair->valueint;
    ...
    ezsigntemplatedocument_request_compound_local_var = ezsigntemplatedocument_request_compound_create_internal (
