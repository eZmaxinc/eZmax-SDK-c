/*
 * communication_get_count_v1_response_all_of.h
 *
 * 
 */

#ifndef _communication_get_count_v1_response_all_of_H_
#define _communication_get_count_v1_response_all_of_H_
...
typedef struct communication_get_count_v1_response_all_of_t communication_get_count_v1_response_all_of_t;

#include "communication_get_count_v1_response_m_payload.h"



typedef struct communication_get_count_v1_response_all_of_t {
    struct communication_get_count_v1_response_m_payload_t *m_payload; //model

} communication_get_count_v1_response_all_of_t;
...
#endif /* _communication_get_count_v1_response_all_of_H_ */
