...
static ezsigntemplateannotation_request_t *ezsigntemplateannotation_request_create_internal(
    ...
    memset(ezsigntemplateannotation_request_local_var, 0, sizeof(ezsigntemplateannotation_request_t));
    ...
    ezsigntemplateannotation_request_local_var->fki_ezsigntemplatedocument_id = fki_ezsigntemplatedocument_id;
    ...
    ezsigntemplateannotation_request_local_var->i_ezsigntemplatedocumentpage_pagenumber = i_ezsigntemplatedocumentpage_pagenumber;
    ...
    ezsigntemplateannotation_request_local_var->s_ezsigntemplateannotation_dropdownvalues = s_ezsigntemplateannotation_dropdownvalues;
    ezsigntemplateannotation_request_local_var->obj_textstylestatic = obj_textstylestatic;
...
__attribute__((deprecated)) ezsigntemplateannotation_request_t *ezsigntemplateannotation_request_create(
    ...
    ezsigntemplateannotation_request_t *result = ezsigntemplateannotation_request_create_internal (
...
void ezsigntemplateannotation_request_free(ezsigntemplateannotation_request_t *ezsigntemplateannotation_request) {
    ...
    if (ezsigntemplateannotation_request->pki_ezsigntemplateannotation_id) {
        free(ezsigntemplateannotation_request->pki_ezsigntemplateannotation_id);
        ezsigntemplateannotation_request->pki_ezsigntemplateannotation_id = NULL;
    }
    if (ezsigntemplateannotation_request->fki_ezsigntemplatedocument_id) {
        free(ezsigntemplateannotation_request->fki_ezsigntemplatedocument_id);
        ezsigntemplateannotation_request->fki_ezsigntemplatedocument_id = NULL;
    }
    if (ezsigntemplateannotation_request->i_ezsigntemplateannotation_x) {
        free(ezsigntemplateannotation_request->i_ezsigntemplateannotation_x);
        ezsigntemplateannotation_request->i_ezsigntemplateannotation_x = NULL;
    }
    if (ezsigntemplateannotation_request->i_ezsigntemplateannotation_y) {
        free(ezsigntemplateannotation_request->i_ezsigntemplateannotation_y);
        ezsigntemplateannotation_request->i_ezsigntemplateannotation_y = NULL;
    }
    if (ezsigntemplateannotation_request->i_ezsigntemplateannotation_width) {
        free(ezsigntemplateannotation_request->i_ezsigntemplateannotation_width);
        ezsigntemplateannotation_request->i_ezsigntemplateannotation_width = NULL;
    }
    if (ezsigntemplateannotation_request->i_ezsigntemplateannotation_height) {
        free(ezsigntemplateannotation_request->i_ezsigntemplateannotation_height);
        ezsigntemplateannotation_request->i_ezsigntemplateannotation_height = NULL;
    }
    if (ezsigntemplateannotation_request->i_ezsigntemplatedocumentpage_pagenumber) {
        free(ezsigntemplateannotation_request->i_ezsigntemplatedocumentpage_pagenumber);
        ezsigntemplateannotation_request->i_ezsigntemplatedocumentpage_pagenumber = NULL;
    }
    ...
    if (ezsigntemplateannotation_request->s_ezsigntemplateannotation_dropdownvalues) {
        free(ezsigntemplateannotation_request->s_ezsigntemplateannotation_dropdownvalues);
        ezsigntemplateannotation_request->s_ezsigntemplateannotation_dropdownvalues = NULL;
    }
    if (ezsigntemplateannotation_request->obj_textstylestatic) {
        textstylestatic_request_compound_free(ezsigntemplateannotation_request->obj_textstylestatic);
        ezsigntemplateannotation_request->obj_textstylestatic = NULL;
    }
...
cJSON *ezsigntemplateannotation_request_convertToJSON(ezsigntemplateannotation_request_t *ezsigntemplateannotation_request) {
    ...
    // ezsigntemplateannotation_request->fki_ezsigntemplatedocument_id
    if (!ezsigntemplateannotation_request->fki_ezsigntemplatedocument_id) {
        goto fail;
    }
    if(cJSON_AddNumberToObject(item, "fkiEzsigntemplatedocumentID", *ezsigntemplateannotation_request->fki_ezsigntemplatedocument_id) == NULL) {
    goto fail; //Numeric
    }
    ...
    // ezsigntemplateannotation_request->i_ezsigntemplatedocumentpage_pagenumber
    if (!ezsigntemplateannotation_request->i_ezsigntemplatedocumentpage_pagenumber) {
        goto fail;
    }
    if(cJSON_AddNumberToObject(item, "iEzsigntemplatedocumentpagePagenumber", *ezsigntemplateannotation_request->i_ezsigntemplatedocumentpage_pagenumber) == NULL) {
    goto fail; //Numeric
    }
    ...
    // ezsigntemplateannotation_request->s_ezsigntemplateannotation_dropdownvalues
    if (!ezsigntemplateannotation_request->s_ezsigntemplateannotation_dropdownvalues) {
        goto fail;
    }
    if(cJSON_AddStringToObject(item, "sEzsigntemplateannotationDropdownvalues", ezsigntemplateannotation_request->s_ezsigntemplateannotation_dropdownvalues) == NULL) {
    goto fail; //String
    }


    // ezsigntemplateannotation_request->obj_textstylestatic
    if(ezsigntemplateannotation_request->obj_textstylestatic) {
    cJSON *obj_textstylestatic_local_JSON = textstylestatic_request_compound_convertToJSON(ezsigntemplateannotation_request->obj_textstylestatic);
...
ezsigntemplateannotation_request_t *ezsigntemplateannotation_request_parseFromJSON(cJSON *ezsigntemplateannotation_requestJSON){
    ...
    // define the local variable for ezsigntemplateannotation_request->pki_ezsigntemplateannotation_id
    int *pki_ezsigntemplateannotation_id_local_var = NULL;

    // define the local variable for ezsigntemplateannotation_request->fki_ezsigntemplatedocument_id
    ...
    // define the local variable for ezsigntemplateannotation_request->i_ezsigntemplateannotation_x
    int *i_ezsigntemplateannotation_x_local_var = NULL;

    // define the local variable for ezsigntemplateannotation_request->i_ezsigntemplateannotation_y
    int *i_ezsigntemplateannotation_y_local_var = NULL;

    // define the local variable for ezsigntemplateannotation_request->i_ezsigntemplateannotation_width
    int *i_ezsigntemplateannotation_width_local_var = NULL;

    // define the local variable for ezsigntemplateannotation_request->i_ezsigntemplateannotation_height
    int *i_ezsigntemplateannotation_height_local_var = NULL;

    // define the local variable for ezsigntemplateannotation_request->i_ezsigntemplatedocumentpage_pagenumber
    ...
    // define the local variable for ezsigntemplateannotation_request->obj_textstylestatic
    ...
    *pki_ezsigntemplateannotation_id_local_var = pki_ezsigntemplateannotation_id->valuedouble;
    ...
    // ezsigntemplateannotation_request->fki_ezsigntemplatedocument_id
    cJSON *fki_ezsigntemplatedocument_id = cJSON_GetObjectItemCaseSensitive(ezsigntemplateannotation_requestJSON, "fkiEzsigntemplatedocumentID");
    ...
    *i_ezsigntemplateannotation_height_local_var = i_ezsigntemplateannotation_height->valuedouble;
    ...
    // ezsigntemplateannotation_request->i_ezsigntemplatedocumentpage_pagenumber
    cJSON *i_ezsigntemplatedocumentpage_pagenumber = cJSON_GetObjectItemCaseSensitive(ezsigntemplateannotation_requestJSON, "iEzsigntemplatedocumentpagePagenumber");
    ...
    *i_ezsigntemplatedocumentpage_pagenumber_local_var = i_ezsigntemplatedocumentpage_pagenumber->valuedouble;
    ...
    // ezsigntemplateannotation_request->s_ezsigntemplateannotation_dropdownvalues
    cJSON *s_ezsigntemplateannotation_dropdownvalues = cJSON_GetObjectItemCaseSensitive(ezsigntemplateannotation_requestJSON, "sEzsigntemplateannotationDropdownvalues");
    ...
    // ezsigntemplateannotation_request->obj_textstylestatic
    cJSON *obj_textstylestatic = cJSON_GetObjectItemCaseSensitive(ezsigntemplateannotation_requestJSON, "objTextstylestatic");
