...
static ezsigndiscussion_response_compound_t *ezsigndiscussion_response_compound_create_internal(
    ...
    memset(ezsigndiscussion_response_compound_local_var, 0, sizeof(ezsigndiscussion_response_compound_t));
    ezsigndiscussion_response_compound_local_var->_library_owned = 1;
...
__attribute__((deprecated)) ezsigndiscussion_response_compound_t *ezsigndiscussion_response_compound_create(
    ...
    ezsigndiscussion_response_compound_t *result = ezsigndiscussion_response_compound_create_internal (
...
void ezsigndiscussion_response_compound_free(ezsigndiscussion_response_compound_t *ezsigndiscussion_response_compound) {
    ...
    if(ezsigndiscussion_response_compound->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "ezsigndiscussion_response_compound_free");
        return ;
    }
    listEntry_t *listEntry;
    if (ezsigndiscussion_response_compound->pki_ezsigndiscussion_id) {
        free(ezsigndiscussion_response_compound->pki_ezsigndiscussion_id);
        ezsigndiscussion_response_compound->pki_ezsigndiscussion_id = NULL;
    }
    if (ezsigndiscussion_response_compound->fki_ezsignpage_id) {
        free(ezsigndiscussion_response_compound->fki_ezsignpage_id);
        ezsigndiscussion_response_compound->fki_ezsignpage_id = NULL;
    }
    if (ezsigndiscussion_response_compound->fki_discussion_id) {
        free(ezsigndiscussion_response_compound->fki_discussion_id);
        ezsigndiscussion_response_compound->fki_discussion_id = NULL;
    }
    if (ezsigndiscussion_response_compound->i_ezsigndiscussion_x) {
        free(ezsigndiscussion_response_compound->i_ezsigndiscussion_x);
        ezsigndiscussion_response_compound->i_ezsigndiscussion_x = NULL;
    }
    if (ezsigndiscussion_response_compound->i_ezsigndiscussion_y) {
        free(ezsigndiscussion_response_compound->i_ezsigndiscussion_y);
        ezsigndiscussion_response_compound->i_ezsigndiscussion_y = NULL;
    }
    if (ezsigndiscussion_response_compound->i_ezsigndiscussion_pagenumber) {
        free(ezsigndiscussion_response_compound->i_ezsigndiscussion_pagenumber);
        ezsigndiscussion_response_compound->i_ezsigndiscussion_pagenumber = NULL;
    }
...
ezsigndiscussion_response_compound_t *ezsigndiscussion_response_compound_parseFromJSON(cJSON *ezsigndiscussion_response_compoundJSON){
    ...
    // define the local variable for ezsigndiscussion_response_compound->pki_ezsigndiscussion_id
    int *pki_ezsigndiscussion_id_local_var = NULL;

    // define the local variable for ezsigndiscussion_response_compound->fki_ezsignpage_id
    int *fki_ezsignpage_id_local_var = NULL;

    // define the local variable for ezsigndiscussion_response_compound->fki_discussion_id
    int *fki_discussion_id_local_var = NULL;

    // define the local variable for ezsigndiscussion_response_compound->i_ezsigndiscussion_x
    int *i_ezsigndiscussion_x_local_var = NULL;

    // define the local variable for ezsigndiscussion_response_compound->i_ezsigndiscussion_y
    int *i_ezsigndiscussion_y_local_var = NULL;

    // define the local variable for ezsigndiscussion_response_compound->i_ezsigndiscussion_pagenumber
    ...
    *i_ezsigndiscussion_pagenumber_local_var = i_ezsigndiscussion_pagenumber->valuedouble;
    ...
    ezsigndiscussion_response_compound_local_var = ezsigndiscussion_response_compound_create_internal (
