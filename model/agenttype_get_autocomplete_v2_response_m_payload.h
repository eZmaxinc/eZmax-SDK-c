/*
 * agenttype_get_autocomplete_v2_response_m_payload.h
 *
 * Payload for POST /2/object/agenttype/getAutocomplete
 */

#ifndef _agenttype_get_autocomplete_v2_response_m_payload_H_
#define _agenttype_get_autocomplete_v2_response_m_payload_H_
...
typedef struct agenttype_get_autocomplete_v2_response_m_payload_t agenttype_get_autocomplete_v2_response_m_payload_t;

#include "agenttype_autocomplete_element_response.h"



typedef struct agenttype_get_autocomplete_v2_response_m_payload_t {
    list_t *a_obj_agenttype; //nonprimitive container

    int _library_owned; // Is the library responsible for freeing this object?
} agenttype_get_autocomplete_v2_response_m_payload_t;
...
#endif /* _agenttype_get_autocomplete_v2_response_m_payload_H_ */
