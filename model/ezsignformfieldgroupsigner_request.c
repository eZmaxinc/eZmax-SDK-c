...
static ezsignformfieldgroupsigner_request_t *ezsignformfieldgroupsigner_request_create_internal(
    ...
    memset(ezsignformfieldgroupsigner_request_local_var, 0, sizeof(ezsignformfieldgroupsigner_request_t));
...
__attribute__((deprecated)) ezsignformfieldgroupsigner_request_t *ezsignformfieldgroupsigner_request_create(
    ...
    ezsignformfieldgroupsigner_request_t *result = ezsignformfieldgroupsigner_request_create_internal (
...
void ezsignformfieldgroupsigner_request_free(ezsignformfieldgroupsigner_request_t *ezsignformfieldgroupsigner_request) {
    ...
    if (ezsignformfieldgroupsigner_request->pki_ezsignformfieldgroupsigner_id) {
        free(ezsignformfieldgroupsigner_request->pki_ezsignformfieldgroupsigner_id);
        ezsignformfieldgroupsigner_request->pki_ezsignformfieldgroupsigner_id = NULL;
    }
    if (ezsignformfieldgroupsigner_request->fki_ezsignfoldersignerassociation_id) {
        free(ezsignformfieldgroupsigner_request->fki_ezsignfoldersignerassociation_id);
        ezsignformfieldgroupsigner_request->fki_ezsignfoldersignerassociation_id = NULL;
    }
...
ezsignformfieldgroupsigner_request_t *ezsignformfieldgroupsigner_request_parseFromJSON(cJSON *ezsignformfieldgroupsigner_requestJSON){
    ...
    // define the local variable for ezsignformfieldgroupsigner_request->pki_ezsignformfieldgroupsigner_id
    int *pki_ezsignformfieldgroupsigner_id_local_var = NULL;

    // define the local variable for ezsignformfieldgroupsigner_request->fki_ezsignfoldersignerassociation_id
