...
void ezsigntemplate_request_v3_free(ezsigntemplate_request_v3_t *ezsigntemplate_request_v3) {
    ...
    if (ezsigntemplate_request_v3->e_ezsigntemplate_recognition) {
        field_e_ezsigntemplate_recognition_free(ezsigntemplate_request_v3->e_ezsigntemplate_recognition);
        ezsigntemplate_request_v3->e_ezsigntemplate_recognition = NULL;
    }
    ...
    if (ezsigntemplate_request_v3->e_ezsigntemplate_type) {
        field_e_ezsigntemplate_type_free(ezsigntemplate_request_v3->e_ezsigntemplate_type);
        ezsigntemplate_request_v3->e_ezsigntemplate_type = NULL;
    }
...
cJSON *ezsigntemplate_request_v3_convertToJSON(ezsigntemplate_request_v3_t *ezsigntemplate_request_v3) {
    ...
    if(ezsigntemplate_request_v3->e_ezsigntemplate_recognition != ezmax_api_definition__full_ezsigntemplate_request_v3__NULL) {
    ...
    if (ezmax_api_definition__full_ezsigntemplate_request_v3__NULL == ezsigntemplate_request_v3->e_ezsigntemplate_type) {
        goto fail;
    }
...
ezsigntemplate_request_v3_t *ezsigntemplate_request_v3_parseFromJSON(cJSON *ezsigntemplate_request_v3JSON){
    ...
    ezsigntemplate_request_v3_local_var = ezsigntemplate_request_v3_create (
