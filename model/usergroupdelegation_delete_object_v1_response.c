...
static usergroupdelegation_delete_object_v1_response_t *usergroupdelegation_delete_object_v1_response_create_internal(
    ...
    memset(usergroupdelegation_delete_object_v1_response_local_var, 0, sizeof(usergroupdelegation_delete_object_v1_response_t));
    usergroupdelegation_delete_object_v1_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) usergroupdelegation_delete_object_v1_response_t *usergroupdelegation_delete_object_v1_response_create(
    ...
    usergroupdelegation_delete_object_v1_response_t *result = usergroupdelegation_delete_object_v1_response_create_internal (
        obj_debug_payload,
        obj_debug
        );
    if (!result) {
...
void usergroupdelegation_delete_object_v1_response_free(usergroupdelegation_delete_object_v1_response_t *usergroupdelegation_delete_object_v1_response) {
    ...
    if(usergroupdelegation_delete_object_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "usergroupdelegation_delete_object_v1_response_free");
        return ;
    }
...
usergroupdelegation_delete_object_v1_response_t *usergroupdelegation_delete_object_v1_response_parseFromJSON(cJSON *usergroupdelegation_delete_object_v1_responseJSON){
    ...
    usergroupdelegation_delete_object_v1_response_local_var = usergroupdelegation_delete_object_v1_response_create_internal (
