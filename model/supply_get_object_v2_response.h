/*
 * supply_get_object_v2_response.h
 *
 * Response for GET /2/object/supply/{pkiSupplyID}
 */

#ifndef _supply_get_object_v2_response_H_
#define _supply_get_object_v2_response_H_
...
typedef struct supply_get_object_v2_response_t supply_get_object_v2_response_t;
...
typedef struct supply_get_object_v2_response_t {
    struct common_response_obj_debug_payload_t *obj_debug_payload; //model
    struct common_response_obj_debug_t *obj_debug; //model
    struct supply_get_object_v2_response_m_payload_t *m_payload; //model
...
#endif /* _supply_get_object_v2_response_H_ */
