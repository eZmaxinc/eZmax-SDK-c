...
static inscriptionnotauthenticated_get_communicationrecipients_v1_response_t *inscriptionnotauthenticated_get_communicationrecipients_v1_response_create_internal(
    ...
    memset(inscriptionnotauthenticated_get_communicationrecipients_v1_response_local_var, 0, sizeof(inscriptionnotauthenticated_get_communicationrecipients_v1_response_t));
    inscriptionnotauthenticated_get_communicationrecipients_v1_response_local_var->_library_owned = 1;
...
__attribute__((deprecated)) inscriptionnotauthenticated_get_communicationrecipients_v1_response_t *inscriptionnotauthenticated_get_communicationrecipients_v1_response_create(
    common_response_obj_debug_payload_t *obj_debug_payload,
    common_response_obj_debug_t *obj_debug,
    inscriptionnotauthenticated_get_communicationrecipients_v1_response_m_payload_t *m_payload
    ) {
    inscriptionnotauthenticated_get_communicationrecipients_v1_response_t *result = inscriptionnotauthenticated_get_communicationrecipients_v1_response_create_internal (
        obj_debug_payload,
        obj_debug,
        m_payload
        );
...
void inscriptionnotauthenticated_get_communicationrecipients_v1_response_free(inscriptionnotauthenticated_get_communicationrecipients_v1_response_t *inscriptionnotauthenticated_get_communicationrecipients_v1_response) {
    ...
    if(inscriptionnotauthenticated_get_communicationrecipients_v1_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "inscriptionnotauthenticated_get_communicationrecipients_v1_response_free");
        return ;
    }
...
inscriptionnotauthenticated_get_communicationrecipients_v1_response_t *inscriptionnotauthenticated_get_communicationrecipients_v1_response_parseFromJSON(cJSON *inscriptionnotauthenticated_get_communicationrecipients_v1_responseJSON){
    ...
    inscriptionnotauthenticated_get_communicationrecipients_v1_response_local_var = inscriptionnotauthenticated_get_communicationrecipients_v1_response_create_internal (
