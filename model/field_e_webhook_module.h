...
typedef enum { ezmax_api_definition__full_field_e_webhook_module__NULL = 0, ezmax_api_definition__full_field_e_webhook_module__Ezmaxpartner, ezmax_api_definition__full_field_e_webhook_module__Ezsign, ezmax_api_definition__full_field_e_webhook_module__Management, ezmax_api_definition__full_field_e_webhook_module__Realestate } ezmax_api_definition__full_field_e_webhook_module__e;
