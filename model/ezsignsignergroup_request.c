...
static ezsignsignergroup_request_t *ezsignsignergroup_request_create_internal(
    ...
    memset(ezsignsignergroup_request_local_var, 0, sizeof(ezsignsignergroup_request_t));
...
__attribute__((deprecated)) ezsignsignergroup_request_t *ezsignsignergroup_request_create(
    ...
    ezsignsignergroup_request_t *result = ezsignsignergroup_request_create_internal (
...
void ezsignsignergroup_request_free(ezsignsignergroup_request_t *ezsignsignergroup_request) {
    ...
    if (ezsignsignergroup_request->pki_ezsignsignergroup_id) {
        free(ezsignsignergroup_request->pki_ezsignsignergroup_id);
        ezsignsignergroup_request->pki_ezsignsignergroup_id = NULL;
    }
    if (ezsignsignergroup_request->fki_ezsignfolder_id) {
        free(ezsignsignergroup_request->fki_ezsignfolder_id);
        ezsignsignergroup_request->fki_ezsignfolder_id = NULL;
    }
...
ezsignsignergroup_request_t *ezsignsignergroup_request_parseFromJSON(cJSON *ezsignsignergroup_requestJSON){
    ...
    // define the local variable for ezsignsignergroup_request->pki_ezsignsignergroup_id
    int *pki_ezsignsignergroup_id_local_var = NULL;

    // define the local variable for ezsignsignergroup_request->fki_ezsignfolder_id
