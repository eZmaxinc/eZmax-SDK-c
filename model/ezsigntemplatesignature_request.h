...
typedef enum  { ezmax_api_definition__full_ezsigntemplatesignature_request__NULL = 0, ezmax_api_definition__full_ezsigntemplatesignature_request__PerCoordinates, ezmax_api_definition__full_ezsigntemplatesignature_request__PerPositioningPattern } ezmax_api_definition__full_ezsigntemplatesignature_request__e;
...
typedef enum  { ezmax_api_definition__full_ezsigntemplatesignature_request__NULL = 0, ezmax_api_definition__full_ezsigntemplatesignature_request__Automatic, ezmax_api_definition__full_ezsigntemplatesignature_request__Manual } ezmax_api_definition__full_ezsigntemplatesignature_request__e;
...
typedef enum  { ezmax_api_definition__full_ezsigntemplatesignature_request__NULL = 0, ezmax_api_definition__full_ezsigntemplatesignature_request__All, ezmax_api_definition__full_ezsigntemplatesignature_request__First, ezmax_api_definition__full_ezsigntemplatesignature_request__Last } ezmax_api_definition__full_ezsigntemplatesignature_request__e;
