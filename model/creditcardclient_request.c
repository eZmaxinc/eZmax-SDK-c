...
creditcardclient_request_t *creditcardclient_request_create(
    ...
    creditcardclient_request_local_var->b_creditcardclient_isactive = b_creditcardclient_isactive;
    creditcardclient_request_local_var->b_creditcardclient_allowedagencypayment = b_creditcardclient_allowedagencypayment;
    creditcardclient_request_local_var->b_creditcardclient_allowedroyallepageprotection = b_creditcardclient_allowedroyallepageprotection;
...
cJSON *creditcardclient_request_convertToJSON(creditcardclient_request_t *creditcardclient_request) {
    ...
    // creditcardclient_request->b_creditcardclient_isactive
    if (!creditcardclient_request->b_creditcardclient_isactive) {
        goto fail;
    }
    if(cJSON_AddBoolToObject(item, "bCreditcardclientIsactive", creditcardclient_request->b_creditcardclient_isactive) == NULL) {
    goto fail; //Bool
    }


    // creditcardclient_request->b_creditcardclient_allowedagencypayment
    if (!creditcardclient_request->b_creditcardclient_allowedagencypayment) {
        goto fail;
    }
    if(cJSON_AddBoolToObject(item, "bCreditcardclientAllowedagencypayment", creditcardclient_request->b_creditcardclient_allowedagencypayment) == NULL) {
    goto fail; //Bool
    }


    // creditcardclient_request->b_creditcardclient_allowedroyallepageprotection
    if (!creditcardclient_request->b_creditcardclient_allowedroyallepageprotection) {
        goto fail;
    }
    if(cJSON_AddBoolToObject(item, "bCreditcardclientAllowedroyallepageprotection", creditcardclient_request->b_creditcardclient_allowedroyallepageprotection) == NULL) {
    goto fail; //Bool
    }
...
creditcardclient_request_t *creditcardclient_request_parseFromJSON(cJSON *creditcardclient_requestJSON){
    ...
    // creditcardclient_request->b_creditcardclient_isactive
    cJSON *b_creditcardclient_isactive = cJSON_GetObjectItemCaseSensitive(creditcardclient_requestJSON, "bCreditcardclientIsactive");
    ...
    // creditcardclient_request->b_creditcardclient_allowedagencypayment
    cJSON *b_creditcardclient_allowedagencypayment = cJSON_GetObjectItemCaseSensitive(creditcardclient_requestJSON, "bCreditcardclientAllowedagencypayment");
    ...
    // creditcardclient_request->b_creditcardclient_allowedroyallepageprotection
    cJSON *b_creditcardclient_allowedroyallepageprotection = cJSON_GetObjectItemCaseSensitive(creditcardclient_requestJSON, "bCreditcardclientAllowedroyallepageprotection");
