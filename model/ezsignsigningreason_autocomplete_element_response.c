...
ezsignsigningreason_autocomplete_element_response_t *ezsignsigningreason_autocomplete_element_response_create(
...
ezsignsigningreason_autocomplete_element_response_t *ezsignsigningreason_autocomplete_element_response_parseFromJSON(cJSON *ezsignsigningreason_autocomplete_element_responseJSON){
    ...
    ezsignsigningreason_autocomplete_element_response_local_var = ezsignsigningreason_autocomplete_element_response_create (
