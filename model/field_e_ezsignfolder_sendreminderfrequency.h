...
typedef enum { ezmax_api_definition__full_field_e_ezsignfolder_sendreminderfrequency__NULL = 0, ezmax_api_definition__full_field_e_ezsignfolder_sendreminderfrequency__None, ezmax_api_definition__full_field_e_ezsignfolder_sendreminderfrequency__Daily, ezmax_api_definition__full_field_e_ezsignfolder_sendreminderfrequency__Weekly } ezmax_api_definition__full_field_e_ezsignfolder_sendreminderfrequency__e;
