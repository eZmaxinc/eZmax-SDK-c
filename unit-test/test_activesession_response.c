...
activesession_response_t* instantiate_activesession_response(int include_optional) {
  ...
  if (include_optional) {
    activesession_response = activesession_response_create(
      ...
      false,
      false,
      ezmax_api_definition__full_activesession_response__"Full",
      ezmax_api_definition__full_activesession_response__"Prepaid",
      ezmax_api_definition__full_activesession_response__"Basic",
      ezmax_api_definition__full_activesession_response__"Create",
      "demo",
      28,
      12
    );
