...
activesession_response_compound_t* instantiate_activesession_response_compound(int include_optional) {
  ...
  if (include_optional) {
    activesession_response_compound = activesession_response_compound_create(
      ...
      false,
      false,
      ezmax_api_definition__full_activesession_response_compound__"Full",
      ezmax_api_definition__full_activesession_response_compound__"Prepaid",
      ezmax_api_definition__full_activesession_response_compound__"Basic",
      ezmax_api_definition__full_activesession_response_compound__"Create",
      "demo",
      28,
      12,
      94,
