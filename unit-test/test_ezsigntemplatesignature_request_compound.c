...
ezsigntemplatesignature_request_compound_t* instantiate_ezsigntemplatesignature_request_compound(int include_optional) {
  ...
  if (include_optional) {
    ezsigntemplatesignature_request_compound = ezsigntemplatesignature_request_compound_create(
      ...
      1,
      1,
      ezmax_api_definition__full_ezsigntemplatesignature_request_compound__"PerCoordinates",
      1,
      200,
      300,
      200,
      200,
      1,
      ezmax_api_definition__full_ezsigntemplatesignature_request_compound__"Signature",
      ezmax_api_definition__full_ezsigntemplatesignature_request_compound__"Manual",
      "Please sign here if you agree to the terms",
      ezmax_api_definition__full_ezsigntemplatesignature_request_compound__"TopLeft",
      ezmax_api_definition__full_ezsigntemplatesignature_request_compound__"Normal",
      1,
      ...
      "Phone number",
      ezmax_api_definition__full_ezsigntemplatesignature_request_compound__"AllOf",
      "Signature",
      200,
      200,
      ezmax_api_definition__full_ezsigntemplatesignature_request_compound__"All",
      1,
      list_createList(),
      list_createList()
    );
