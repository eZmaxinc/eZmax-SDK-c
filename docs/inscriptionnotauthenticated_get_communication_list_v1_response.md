...
**m_payload** | [**inscriptionnotauthenticated_get_communication_list_v1_response_m_payload_t**](inscriptionnotauthenticated_get_communication_list_v1_response_m_payload.md) \* |  | 
