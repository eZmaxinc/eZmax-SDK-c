...
**s_address** | **char \*** | The complete address in a single line | [optional] 
...
**s_inscription_mls** | **char \*** | The mls of the Inscription | 
...
**d_inscription_initialsaleprice** | **char \*** | The initialsaleprice of the Inscription | 
...
**d_inscription_remuneration** | **char \*** | The remuneration of the Inscription | 
**d_inscription_remunerationinscriptorseller** | **char \*** | The remunerationinscriptorseller of the Inscription | 
**d_inscription_remunerationreference** | **char \*** | The remunerationreference of the Inscription | 
**d_inscription_remunerationtotal** | **char \*** | The remunerationtotal of the Inscription | 
**d_inscription_mortgagesold** | **char \*** | The mortgagesold of the Inscription | 
**dt_inscription_date** | **char \*** | The date of the Inscription | 
**dt_inscription_cancellationdate** | **char \*** | The cancellationdate of the Inscription | 
**dt_inscription_initialexpirationdate** | **char \*** | The initialexpirationdate of the Inscription | 
**dt_inscription_expirationdate** | **char \*** | The expirationdate of the Inscription | 
**dt_inscription_notarydate** | **char \*** | The notarydate of the Inscription | 
**dt_inscription_notaryentereddate** | **char \*** | The notaryentereddate of the Inscription | 
...
**t_inscription_checklistnote** | **char \*** | The checklistnote of the Inscription | 
...
**b_inscription_issolicitation** | **int** | Whether if it&#39;s an issolicitation | 
**b_inscription_salebyowner** | **int** | Whether if it&#39;s an salebyowner | 
**b_inscription_soldwithoutlegalwarranty** | **int** | Whether if it&#39;s an soldwithoutlegalwarranty | 
