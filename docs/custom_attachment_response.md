...
**fki_documenttypechecklist_id** | **int** | The unique ID of the Documenttypechecklist | [optional] 
**s_documenttype_name_x** | **char \*** | The name of the Documenttype in the language of the requester | [optional] 
...
**obj_attachment_proof** | [**attachment_response_compound_t**](attachment_response_compound.md) \* |  | [optional] 
**obj_attachment_proofdocument** | [**attachment_response_compound_t**](attachment_response_compound.md) \* |  | [optional] 
**a_obj_attachment_attachment** | [**list_t**](attachment_response_compound.md) \* |  | [optional] 
**a_obj_attachment_version** | [**list_t**](attachment_response_compound.md) \* |  | [optional] 
