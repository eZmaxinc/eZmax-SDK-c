...
**m_payload** | [**electronicfundstransfer_get_communication_list_v1_response_m_payload_t**](electronicfundstransfer_get_communication_list_v1_response_m_payload.md) \* |  | 
