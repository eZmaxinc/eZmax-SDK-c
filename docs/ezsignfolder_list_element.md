...
**dt_ezsignfolder_sentdate** | [**one_ofstringnull_t**](one_ofstringnull.md) \* |  | 
**dt_due_date** | [**one_ofstringnull_t**](one_ofstringnull.md) \* | The date at which no more signature will be accepted on the folder | 
