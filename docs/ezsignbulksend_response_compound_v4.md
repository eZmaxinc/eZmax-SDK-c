...
**e_ezsignbulksend_ezsignformfieldorder** | **field_e_ezsignbulksend_ezsignformfieldorder_t \*** |  | 
...
**a_obj_ezsignbulksenddocumentmapping** | [**list_t**](ezsignbulksenddocumentmapping_response_compound_v3.md) \* |  | 
**a_obj_ezsignbulksendsignermapping** | [**list_t**](ezsignbulksendsignermapping_response_v3.md) \* |  | 
