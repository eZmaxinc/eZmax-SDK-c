...
**e_webhook_emittype** | **ezmax_api_definition__full_custom_webhook_response_EWEBHOOKEMITTYPE_e** | Wheter the webhook received is a manual test or a real event | [optional] 
