...
**b_ezsigndocument_sendtoged** | **int** | Whether the Ezsigndocument was copied to EDM | [optional] 
...
**a_obj_ezsignfoldersignerassociationstatus** | [**list_t**](custom_ezsignfoldersignerassociationstatus_response_v3.md) \* |  | 
