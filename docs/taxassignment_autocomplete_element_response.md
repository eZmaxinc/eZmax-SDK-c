...
------------ | ------------- | ------------- | -------------
**s_taxassignment_description_x** | **char \*** | The description of the Taxassignment  in the language of the requester | 
...
**b_taxassignment_isactive** | **int** | Whether the Taxassignment is active or not | 
