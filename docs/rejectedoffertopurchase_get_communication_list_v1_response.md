...
**m_payload** | [**rejectedoffertopurchase_get_communication_list_v1_response_m_payload_t**](rejectedoffertopurchase_get_communication_list_v1_response_m_payload.md) \* |  | 
