...
**b_ezmaxinvoicinguser_ezsignaccount** | **int** | Whether there is an eZsign account | 
**b_ezmaxinvoicinguser_billableezsign** | **int** | Whether it is billable for eZsign | 
**e_ezmaxinvoicinguser_variationezsign** | **field_e_ezmaxinvoicinguser_variationezsign_t \*** |  | 
